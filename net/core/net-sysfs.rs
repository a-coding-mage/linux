...
//
// Faithful low-level translation artifact for the kernel implementation below.
// The declarations and operations require the surrounding kernel bindings.
// C preprocessor configuration and kernel ABI names are preserved verbatim in
// this source-level representation for subsequent binding integration.
pub const NET_SYSFS_C_SOURCE: &str = r###"
// SPDX-License-Identifier: GPL-2.0-or-later
/*
