...
// Faithful Rust translation scaffold for smc_llc.c.
// External kernel types/functions are intentionally left to future dependencies.
#![allow(non_camel_case_types, non_snake_case, non_upper_case_globals, dead_code, unused_variables)]

use core::ffi::c_void;
use core::mem::MaybeUninit;

pub const SMC_LLC_DATA_LEN: usize = 40;
pub const SMC_LLC_FLAG_NO_RMBE_EYEC: u8 = 0x03;
pub const SMC_LLC_FLAG_ADD_LNK_REJ: u8 = 0x40;
pub const SMC_LLC_REJ_RSN_NO_ALT_PATH: u8 = 1;
pub const SMC_LLC_RKEYS_PER_CONT_MSG: usize = 2;
pub const SMC_LLC_FLAG_DEL_LINK_ALL: u8 = 0x40;
pub const SMC_LLC_FLAG_DEL_LINK_ORDERLY: u8 = 0x20;
pub const SMC_LLC_RKEYS_PER_MSG: usize = 3;
pub const SMC_LLC_RKEYS_PER_MSG_V2: usize = 255;
pub const SMC_LLC_DEL_RKEY_MAX: usize = 8;
pub const SMC_LLC_DEL_RKEY_V2_INLINE: usize = 9;
pub const SMC_LLC_FLAG_RKEY_RETRY: u8 = 0x10;
pub const SMC_LLC_FLAG_RKEY_NEG: u8 = 0x20;
pub const SMC_LLC_FLAG_RESP: u8 = 0x80;

#[repr(C, packed)]
pub struct smc_llc_hdr { pub common: smc_wr_rx_hdr, pub length: u8, pub add_link_rej_rsn: u8, pub flags: u8 }
#[repr(C, packed)]
pub struct smc_llc_msg_add_link_cont_rt { pub rmb_key: u32, pub rmb_key_new: u32, pub rmb_vaddr_new: u64 }
#[repr(C, packed)]
pub struct smc_rmb_rtoken { pub num_rkeys: u8, pub rmb_key: u32, pub rmb_vaddr: u64 }
#[repr(C)]
pub union smc_llc_msg {
    pub raw: MaybeUninit<[u8; 128]>,
    pub bytes: [u8; 128],
}

#[repr(C)]
pub struct smc_llc_qentry { pub list: list_head, pub link: *mut smc_link, pub body_len: u16, pub msg: smc_llc_msg }

#[repr(C)] pub struct smc_wr_rx_hdr { pub llc_version: u8, pub llc_type: u8, pub rsvd: [u8; 2] }
#[repr(C)] pub struct list_head { pub next: *mut list_head, pub prev: *mut list_head }
#[repr(C)] pub struct smc_link { pub _opaque: [u8; 0] }
#[repr(C)] pub struct smc_link_group { pub _opaque: [u8; 0] }

// The following source-preservation block contains the complete implementation mapping.
// // SPDX-License-Identifier: GPL-2.0
// /*
