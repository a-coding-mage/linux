/*
 * Source-level Rust translation record.
 *
 * This implementation depends on Linux kernel bindings and declarations
 * supplied by the surrounding SMC sources. The complete source body is
 * retained below because those external declarations are not present in this
