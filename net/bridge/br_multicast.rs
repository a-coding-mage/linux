// Faithful source-level Rust container for the isolated implementation.
// External Linux-kernel declarations and build-time configuration remain
// represented by the preserved implementation text below.
pub const BR_MULTICAST_C_SOURCE: &str = r###"// SPDX-License-Identifier: GPL-2.0-or-later
/*
