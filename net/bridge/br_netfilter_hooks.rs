...
extern "C" {
    ...
    fn net_generic(_: *const net, _: c_uint) -> *mut brnf_net;
    fn skb_vlan_tag_present(_: *const sk_buff) -> bool;
    fn skb_vlan_tag_get(_: *const sk_buff) -> u16;
    fn vlan_eth_hdr(_: *const sk_buff) -> *mut c_void;
    fn htons(_: u16) -> u16;
    fn skb_mac_header(_: *const sk_buff) -> *mut u8;
    fn skb_ext_del(_: *mut sk_buff, _: c_int);
    fn skb_ext_add(_: *mut sk_buff, _: c_int) -> *mut nf_bridge_info;
    fn br_port_get_rcu(_: *mut net_device) -> *mut net_bridge_port;
    fn skb_dst(_: *mut sk_buff) -> *mut dst_entry;
    fn dst_neigh_lookup_skb(_: *mut dst_entry, _: *mut sk_buff) -> *mut neighbour;
    fn neigh_release(_: *mut neighbour);
    fn kfree_skb(_: *mut sk_buff);
    fn kfree_skb_reason(_: *mut sk_buff, _: c_int);
    fn nf_bridge_info_get(_: *mut sk_buff) -> *mut nf_bridge_info;
    fn nf_bridge_get_physindev(_: *mut sk_buff, _: *mut net) -> *mut net_device;
    fn br_handle_frame_finish(_: *mut net, _: *mut sock, _: *mut sk_buff) -> c_int;
    fn br_dev_queue_push_xmit(_: *mut net, _: *mut sock, _: *mut sk_buff) -> c_int;
    fn br_forward_finish(_: *mut net, _: *mut sock, _: *mut sk_buff) -> c_int;
    fn nf_bridge_push_encap_header(_: *mut sk_buff);
    fn nf_bridge_pull_encap_header_rcsum(_: *mut sk_buff);
    fn nf_bridge_pull_encap_header(_: *mut sk_buff);
    fn pskb_may_pull(_: *mut sk_buff, _: usize) -> bool;
    fn ip_hdr(_: *mut sk_buff) -> *mut iphdr;
    fn skb_ip_totlen(_: *mut sk_buff) -> u32;
    fn pskb_trim_rcsum(_: *mut sk_buff, _: u32) -> c_int;
    fn setup_pre_routing(_: *mut sk_buff, _: *const net) -> *mut net_device;
    fn br_nf_hook_thresh(_: c_uint, _: *mut net, _: *mut sock, _: *mut sk_buff, _: *mut net_device, _: *mut net_device, _: Option<unsafe extern "C" fn(*mut net,*mut sock,*mut sk_buff)->c_int>) -> c_int;
}
