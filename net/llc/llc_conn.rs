...
extern "C" { fn skb_get(_: *mut sk_buff); fn skb_queue_tail(_: *mut sk_buff_head,_: *mut sk_buff); fn skb_dequeue(_: *mut sk_buff_head)->*mut sk_buff; fn skb_peek(_: *mut sk_buff_head)->*mut sk_buff; fn skb_queue_len(_: *mut sk_buff_head)->i32; fn skb_queue_purge(_: *mut sk_buff_head); fn kfree_skb(_: *mut sk_buff); fn skb_clone(_: *mut sk_buff,_: u32)->*mut sk_buff; fn dev_queue_xmit(_: *mut sk_buff); fn llc_save_primitive(_: *mut sock,_: *mut sk_buff,_: i32); fn sock_queue_rcv_skb(_: *mut sock,_: *mut sk_buff)->i32; fn sock_hold(_: *mut sock); fn sock_put(_: *mut sock); fn sock_net(_: *mut sock)->*mut net; fn net_eq(_: *mut net,_: *const net)->bool; fn ether_addr_equal(_: *const u8,_: *const u8)->bool; fn llc_sk_laddr_hashfn(_: *mut llc_sap,_: *mut llc_addr)->i32; fn local_bh_disable(); fn local_bh_enable(); fn bh_lock_sock(_: *mut sock); fn bh_unlock_sock(_: *mut sock); fn sock_set_flag(_: *mut sock,_: i32); fn llc_sap_hold(_: *mut llc_sap); fn llc_sap_put(_: *mut llc_sap); }
