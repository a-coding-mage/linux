...
extern "C" {
    ...
    fn llc_sk(_: *mut sock) -> *mut llc_sock;
    fn llc_sap_find(_: u8) -> *mut llc_sap; fn llc_sap_open(_: u8,_: *mut c_void)->*mut llc_sap; fn llc_sap_put(_: *mut llc_sap); fn llc_sap_hold(_: *mut llc_sap);
    fn llc_sap_add_socket(_: *mut llc_sap,_: *mut sock); fn llc_sap_remove_socket(_: *mut llc_sap,_: *mut sock); fn llc_lookup_established(_: *mut llc_sap,_: *mut llc_addr,_: *mut llc_addr,_: *mut net)->*mut sock;
    fn llc_establish_connection(_: *mut sock,_: *mut u8,_: *const u8,_: u8)->c_int; fn llc_send_disc(_: *mut sock)->c_int; fn llc_build_and_send_pkt(_: *mut sock,_: *mut sk_buff)->c_int;
    fn llc_build_and_send_ui_pkt(_: *mut llc_sap,_: *mut sk_buff,_: *const u8,_: u8); fn llc_build_and_send_test_pkt(_: *mut llc_sap,_: *mut sk_buff,_: *const u8,_: u8); fn llc_build_and_send_xid_pkt(_: *mut llc_sap,_: *mut sk_buff,_: *const u8,_: u8);
    fn llc_data_accept_state(_: c_int)->bool; fn llc_pdu_decode_dsap(_: *mut sk_buff,_: *mut u8); fn llc_pdu_decode_da(_: *mut sk_buff,_: *mut u8); fn llc_ui_skb_cb(_: *mut sk_buff)->*mut sockaddr_llc;
    fn llc_sap_handler(); fn llc_conn_handler(); fn llc_build_offset_table(); fn llc_station_init(); fn llc_station_exit(); fn llc_proc_init()->c_int; fn llc_proc_exit(); fn llc_sysctl_init()->c_int; fn llc_sysctl_exit(); fn llc_add_pack(_: c_int, _: unsafe extern "C" fn()); fn llc_remove_pack(_: c_int);
    fn llc_sk_alloc(_: *mut net,_: c_int,_: c_int,_: *mut proto,_: c_int)->*mut sock; fn llc_sk_free(_: *mut sock); fn sock_graft(_: *mut sock,_: *mut socket); fn sock_hold(_: *mut sock); fn sock_put(_: *mut sock); fn sock_orphan(_: *mut sock); fn lock_sock(_: *mut sock); fn release_sock(_: *mut sock);
    fn sock_flag(_: *mut sock,_: c_int)->bool; fn sock_reset_flag(_: *mut sock,_: c_int); fn sock_sndtimeo(_: *mut sock,_: c_int)->i64; fn sock_rcvtimeo(_: *mut sock,_: c_int)->i64; fn sock_intr_errno(_: i64)->c_int; fn sock_error(_: *mut sock)->c_int; fn signal_pending(_: *mut c_void)->bool; fn sk_wait_event(_: *mut sock,_: *mut i64,_: bool,_: *mut c_void)->bool; fn sk_wait_data(_: *mut sock,_: *mut i64,_: *mut c_void)->bool;
    fn dev_get_by_index(_: *mut net,_: c_int)->*mut net_device; fn dev_getfirstbyhwtype(_: *mut net,_: u16)->*mut net_device; fn dev_get_by_index_rcu(_: *mut net,_: c_int)->*mut net_device; fn dev_getbyhwaddr_rcu(_: *mut net,_: u16,_: *const u8)->*mut net_device; fn dev_put(_: *mut net_device); fn dev_hold(_: *mut net_device); fn netdev_put(_: *mut net_device,_: *mut c_void); fn netdev_tracker_alloc(_: *mut net_device,_: *mut c_void,_: c_int);
    fn skb_queue_empty(_: *mut c_void)->bool; fn skb_peek(_: *mut c_void)->*mut sk_buff; fn skb_dequeue(_: *mut c_void)->*mut sk_buff; fn skb_unlink(_: *mut sk_buff,_: *mut c_void); fn kfree_skb(_: *mut sk_buff); fn sock_alloc_send_skb(_: *mut sock,_: usize,_: c_int,_: *mut c_int)->*mut sk_buff; fn skb_reserve(_: *mut sk_buff,_: usize); fn skb_put(_: *mut sk_buff,_: usize)->*mut u8; fn skb_copy_datagram_msg(_: *mut sk_buff,_: usize,_: *mut msghdr,_: usize)->c_int; fn memcpy_from_msg(_: *mut u8,_: *mut msghdr,_: usize)->c_int;
    fn put_cmsg(_: *mut msghdr,_: c_int,_: c_int,_: usize,_: *mut c_void); fn copy_safe_from_sockptr(_: *mut c_void,_: usize,_: sockptr_t,_: u32)->c_int; fn copy_to_iter(_: *mut c_void,_: usize,_: *mut c_void)->usize;
    fn proto_register(_: *mut proto,_: c_int)->c_int; fn proto_unregister(_: *mut proto); fn sock_register(_: *const net_proto_family)->c_int; fn sock_unregister(_: c_int); fn sk_acceptq_removed(_: *mut sock);
}
