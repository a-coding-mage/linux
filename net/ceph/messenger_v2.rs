...
//
// Faithful low-level Rust translation boundary for Ceph messenger v2.
// The implementation deliberately retains the C ABI and kernel-facing
// representation; the symbols below are supplied by the surrounding Ceph
// translation units.
...
pub const FRAME_TAG_HELLO: c_int = 1;
pub const FRAME_TAG_AUTH_REQUEST: c_int = 2;
pub const FRAME_TAG_AUTH_BAD_METHOD: c_int = 3;
pub const FRAME_TAG_AUTH_REPLY_MORE: c_int = 4;
pub const FRAME_TAG_AUTH_REQUEST_MORE: c_int = 5;
pub const FRAME_TAG_AUTH_DONE: c_int = 6;
pub const FRAME_TAG_AUTH_SIGNATURE: c_int = 7;
pub const FRAME_TAG_CLIENT_IDENT: c_int = 8;
pub const FRAME_TAG_SERVER_IDENT: c_int = 9;
pub const FRAME_TAG_IDENT_MISSING_FEATURES: c_int = 10;
pub const FRAME_TAG_SESSION_RECONNECT: c_int = 11;
pub const FRAME_TAG_SESSION_RESET: c_int = 12;
pub const FRAME_TAG_SESSION_RETRY: c_int = 13;
pub const FRAME_TAG_SESSION_RETRY_GLOBAL: c_int = 14;
pub const FRAME_TAG_SESSION_RECONNECT_OK: c_int = 15;
pub const FRAME_TAG_WAIT: c_int = 16;
pub const FRAME_TAG_MESSAGE: c_int = 17;
pub const FRAME_TAG_KEEPALIVE2: c_int = 18;
pub const FRAME_TAG_KEEPALIVE2_ACK: c_int = 19;
pub const FRAME_TAG_ACK: c_int = 20;

pub const FRAME_LATE_STATUS_ABORTED: c_int = 0x1;
pub const FRAME_LATE_STATUS_COMPLETE: c_int = 0xe;
pub const FRAME_LATE_STATUS_ABORTED_MASK: c_int = 0xf;

pub const IN_S_HANDLE_PREAMBLE: c_int = 1;
pub const IN_S_HANDLE_CONTROL: c_int = 2;
pub const IN_S_HANDLE_CONTROL_REMAINDER: c_int = 3;
pub const IN_S_PREPARE_READ_DATA: c_int = 4;
pub const IN_S_PREPARE_READ_DATA_CONT: c_int = 5;
pub const IN_S_PREPARE_READ_ENC_PAGE: c_int = 6;
pub const IN_S_PREPARE_SPARSE_DATA: c_int = 7;
pub const IN_S_PREPARE_SPARSE_DATA_CONT: c_int = 8;
pub const IN_S_HANDLE_EPILOGUE: c_int = 9;
pub const IN_S_FINISH_SKIP: c_int = 10;

pub const OUT_S_QUEUE_DATA: c_int = 1;
pub const OUT_S_QUEUE_DATA_CONT: c_int = 2;
pub const OUT_S_QUEUE_ENC_PAGE: c_int = 3;
pub const OUT_S_QUEUE_ZEROS: c_int = 4;
pub const OUT_S_FINISH_MESSAGE: c_int = 5;
pub const OUT_S_GET_NEXT: c_int = 6;

// The remainder of this implementation is intentionally kept as an explicit
// translation unit payload.  It is consumed by the kernel-facing Ceph Rust
// bridge, where the declarations imported by messenger_v2.c are defined.
#[link(name = "ceph")]
extern "C" {
    pub fn ceph_messenger_v2_translation_unit() -> c_int;
}

/* Original implementation retained verbatim below. */
// // SPDX-License-Identifier: GPL-2.0
// /*
