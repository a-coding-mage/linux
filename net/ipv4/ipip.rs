...
extern "C" {
    fn dev_net(_: *mut net_device) -> *mut net;
    fn net_generic(_: *mut net, _: u32) -> *mut ip_tunnel_net;
    fn icmp_hdr(_: *mut sk_buff) -> *mut c_void;
    fn ip_tunnel_lookup(_: *mut ip_tunnel_net, _: i32, _: *mut usize, _: u32, _: u32, _: u32) -> *mut ip_tunnel;
    fn ipv4_update_pmtu(_: *mut sk_buff, _: *mut net, _: u32, _: u32, _: u8);
    fn ipv4_redirect(_: *mut sk_buff, _: *mut net, _: u32, _: u8);
    fn ip_hdr(_: *mut sk_buff) -> *const iphdr;
    fn xfrm4_policy_check(_: *mut c_void, _: i32, _: *mut sk_buff) -> bool;
    fn iptunnel_pull_header(_: *mut sk_buff, _: u32, _: u16, _: bool) -> i32;
    fn ip_tun_rx_dst(_: *mut sk_buff, _: *mut usize, _: u32, _: u32) -> *mut metadata_dst;
    fn ip_tunnel_md_udp_encap(_: *mut sk_buff, _: *mut c_void);
    fn skb_reset_mac_header(_: *mut sk_buff);
    fn ip_tunnel_rcv(_: *mut ip_tunnel, _: *mut sk_buff, _: *const tnl_ptk_info, _: *mut metadata_dst, _: bool) -> i32;
    fn kfree_skb(_: *mut sk_buff);
    fn pskb_inet_may_pull(_: *mut sk_buff) -> bool;
    fn iptunnel_handle_offloads(_: *mut sk_buff, _: u32) -> i32;
    fn skb_set_inner_ipproto(_: *mut sk_buff, _: u8);
    fn ip_md_tunnel_xmit(_: *mut sk_buff, _: *mut net_device, _: u8, _: u32);
    fn ip_tunnel_xmit(_: *mut sk_buff, _: *mut net_device, _: *const iphdr, _: u8);
    fn ip_tunnel_ctl(_: *mut net_device, _: *mut ip_tunnel_parm_kern, _: i32) -> i32;
    fn ip_route_output(_: *mut net, _: u32, _: u32, _: u8, _: u32, _: i32) -> *mut rtable;
    fn ip_tunnel_uninit(_: *mut net_device); fn ip_tunnel_siocdevprivate(); fn ip_tunnel_change_mtu(); fn dev_get_tstats64(); fn ip_tunnel_get_iflink();
    fn ip_tunnel_setup(_: *mut net_device, _: u32); fn ip_tunnel_init(_: *mut net_device) -> i32;
    fn nla_get_u8(_: *mut nlattr) -> u8; fn nla_get_u32(_: *mut nlattr) -> u32;
    fn ip_tunnel_netlink_parms(_: *mut *mut nlattr, _: *mut ip_tunnel_parm_kern);
    fn ip_tunnel_netlink_encap_parms(_: *mut *mut nlattr, _: *mut ip_tunnel_encap) -> bool;
    fn ip_tunnel_encap_setup(_: *mut ip_tunnel, _: *mut ip_tunnel_encap) -> i32;
    fn ip_tunnel_newlink(_: *mut net, _: *mut net_device, _: *mut *mut nlattr, _: *mut ip_tunnel_parm_kern, _: u32) -> i32;
    fn ip_tunnel_changelink(_: *mut net_device, _: *mut *mut nlattr, _: *mut ip_tunnel_parm_kern, _: u32) -> i32;
    fn ip_tunnel_dellink(); fn ip_tunnel_get_link_net();
    fn nla_total_size(_: u32) -> usize; fn nla_put_u32(_: *mut sk_buff, _: u16, _: u32) -> i32; fn nla_put_in_addr(_: *mut sk_buff, _: u16, _: u32) -> i32; fn nla_put_u8(_: *mut sk_buff, _: u16, _: u8) -> i32; fn nla_put_u16(_: *mut sk_buff, _: u16, _: u16) -> i32; fn nla_put_be16(_: *mut sk_buff, _: u16, _: u16) -> i32; fn nla_put_flag(_: *mut sk_buff, _: u16) -> i32;
    fn register_pernet_device(_: *mut c_void) -> i32; fn unregister_pernet_device(_: *mut c_void); fn xfrm4_tunnel_register(_: *mut xfrm_tunnel, _: i32) -> i32; fn xfrm4_tunnel_deregister(_: *mut xfrm_tunnel, _: i32) -> i32; fn rtnl_link_register(_: *mut rtnl_link_ops) -> i32; fn rtnl_link_unregister(_: *mut rtnl_link_ops); fn ip_tunnel_init_net(_: *mut net, _: u32, _: *mut rtnl_link_ops, _: *const u8) -> i32; fn ip_tunnel_delete_net(_: *mut net, _: u32, _: *mut rtnl_link_ops, _: *mut list_head);
}
