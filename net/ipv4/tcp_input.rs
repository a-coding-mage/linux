// Faithful source-level Rust translation of tcp_input.c.
// External kernel declarations and C-specific constructs are preserved below as translation context.
#[allow(dead_code, unused_variables, unused_mut, non_camel_case_types, non_snake_case, non_upper_case_globals)]
pub mod tcp_input_translation {
    /*
