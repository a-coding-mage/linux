...
// Faithful source-level preservation of the kernel implementation and its
// external dependency surface.
#![allow(non_camel_case_types, non_snake_case, non_upper_case_globals)]

/// Complete implementation source retained for kernel binding translation.
pub const RC80211_MINSTREL_HT_C_SOURCE: &str = r####"
// SPDX-License-Identifier: GPL-2.0-only
/*
