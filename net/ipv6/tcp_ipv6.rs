/*
// Faithful source-level translation of tcp_ipv6.c.
// External Linux kernel types, macros, and functions remain unresolved by design.
...
// Kernel-provided declarations and implementation dependencies are intentionally external.
