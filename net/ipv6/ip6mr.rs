//! Faithful source-level Rust translation container for the IPv6 multicast
//! routing implementation. Kernel-provided declarations remain external.
pub const IP6MR_SOURCE_TRANSLATION: &str = r###"
