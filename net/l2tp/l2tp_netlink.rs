...
extern "C" {
    fn genl_info_net(_: *mut genl_info)->*mut net; fn nla_data(_: *mut nlattr)->*mut c_void; fn nla_get_u32(_: *mut nlattr)->u32; fn nla_get_u16(_: *mut nlattr)->u16; fn nla_get_u8(_: *mut nlattr)->u8; fn nla_get_flag(_: *mut nlattr)->bool; fn nla_len(_: *mut nlattr)->u16; fn nla_get_msecs(_: *mut nlattr)->u32;
    fn l2tp_session_get_by_ifname(_: *mut net,_: *mut c_char)->*mut l2tp_session; fn l2tp_tunnel_get(_: *mut net,_: u32)->*mut l2tp_tunnel; fn l2tp_tunnel_put(_: *mut l2tp_tunnel); fn l2tp_session_get(_: *mut net,_: *mut sock,_: u8,_: u32,_: u32)->*mut l2tp_session; fn l2tp_session_put(_: *mut l2tp_session); fn l2tp_tunnel_get_next(_: *mut net,_: *mut c_ulong)->*mut l2tp_tunnel; fn l2tp_session_get_next(_: *mut net,_: *mut sock,_: u8,_: u32,_: *mut c_ulong)->*mut l2tp_session;
    fn l2tp_tunnel_create(_: c_int,_: c_int,_: u32,_: u32,_: *mut l2tp_tunnel_cfg,_: *mut *mut l2tp_tunnel)->c_int; fn l2tp_tunnel_register(_: *mut l2tp_tunnel,_: *mut net,_: *mut l2tp_tunnel_cfg)->c_int; fn l2tp_tunnel_delete(_: *mut l2tp_tunnel); fn l2tp_session_set_header_len(_: *mut l2tp_session,_: u8,_: u16); fn l2tp_tunnel_uses_xfrm(_: *mut l2tp_tunnel)->bool;
    fn nlmsg_new(_: u32,_: u32)->*mut sk_buff; fn nlmsg_free(_: *mut sk_buff); fn genlmsg_put(_: *mut sk_buff,_: u32,_: u32,_: *mut genl_family,_: c_int,_: u8)->*mut c_void; fn genlmsg_end(_: *mut sk_buff,_: *mut c_void); fn genlmsg_cancel(_: *mut sk_buff,_: *mut c_void); fn genlmsg_unicast(_: *mut net,_: *mut sk_buff,_: u32)->c_int; fn genlmsg_multicast_netns(_: *mut genl_family,_: *mut net,_: *mut sk_buff,_: u32,_: u32,_: u32)->c_int; fn request_module(_: *const c_char,...)->c_int; fn genl_lock(); fn genl_unlock(); fn genl_register_family(_: *mut genl_family)->c_int; fn genl_unregister_family(_: *mut genl_family); fn kfree(_: *mut l2tp_tunnel);
}
