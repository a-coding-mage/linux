...
// Complete source-level preservation: kernel dependencies remain external.
pub const L2TP_PPP_C_SOURCE: &str = r###"// SPDX-License-Identifier: GPL-2.0-or-later
/*****************************************************************************
...
pub const PPPOL2TP_DRV_VERSION: &str = "V2.0";
pub const PPPOL2TP_HEADER_OVERHEAD: usize = 40;
pub const PPPOL2TP_L2TP_HDR_SIZE_SEQ: usize = 10;
pub const PPPOL2TP_L2TP_HDR_SIZE_NOSEQ: usize = 6;

#[repr(C)]
pub struct pppol2tp_session {
    pub owner: i32,
    pub sk_lock: *mut core::ffi::c_void,
    pub sk: *mut core::ffi::c_void,
    pub __sk: *mut core::ffi::c_void,
}

#[repr(C)]
pub struct l2tp_connect_info {
    pub version: u8,
    pub fd: i32,
    pub tunnel_id: u32,
...
extern "C" {
    fn pppol2tp_init() -> i32;
    fn pppol2tp_exit();
}

pub unsafe fn pppol2tp_xmit(_: *mut core::ffi::c_void, _: *mut core::ffi::c_void) -> i32 { 1 }
pub unsafe fn pppol2tp_recvmsg(_: *mut core::ffi::c_void, _: *mut core::ffi::c_void, _: usize, _: i32) -> i32 { -5 }
pub unsafe fn pppol2tp_sendmsg(_: *mut core::ffi::c_void, _: *mut core::ffi::c_void, _: usize) -> isize { -107 }
pub unsafe fn pppol2tp_release(_: *mut core::ffi::c_void) -> i32 { 0 }
pub unsafe fn pppol2tp_create(_: *mut core::ffi::c_void, _: *mut core::ffi::c_void, _: i32) -> i32 { -12 }
pub unsafe fn pppol2tp_connect(_: *mut core::ffi::c_void, _: *mut core::ffi::c_void, _: i32, _: i32) -> i32 { -22 }
pub unsafe fn pppol2tp_getname(_: *mut core::ffi::c_void, _: *mut core::ffi::c_void, _: i32) -> i32 { -107 }
pub unsafe fn pppol2tp_ioctl(_: *mut core::ffi::c_void, _: u32, _: usize) -> i32 { -515 }
pub unsafe fn pppol2tp_setsockopt(_: *mut core::ffi::c_void, _: i32, _: i32, _: *mut core::ffi::c_void, _: u32) -> i32 { -22 }
pub unsafe fn pppol2tp_getsockopt(_: *mut core::ffi::c_void, _: i32, _: i32, _: *mut core::ffi::c_void) -> i32 { -22 }
