...
extern "C" { fn skb_queue_purge(_: *mut c_void); fn module_put(_: *mut c_void); fn try_module_get(_: *mut c_void)->bool; fn request_module(_: *const c_char,...)->c_int; fn sk_alloc(_: *mut net,_: c_int,_: c_int,_: *mut c_void,_: c_int)->*mut sock; fn sock_init_data(_: *mut socket,_: *mut sock); fn sock_orphan(_: *mut sock); fn sock_put(_: *mut sock); fn sock_prot_inuse_add(_: *mut net,_: *mut c_void,_: c_int); fn skb_clone(_: *mut sk_buff,_: c_int)->*mut sk_buff; fn kfree_skb(_: *mut sk_buff); fn dev_queue_xmit(_: *mut sk_buff)->c_int; fn netif_rx(_: *mut sk_buff)->c_int; fn consume_skb(_: *mut sk_buff); fn kmem_cache_alloc(_: *mut c_void,_: c_int)->*mut receiver; fn kmem_cache_free(_: *mut c_void,_: *mut receiver); fn hlist_add_head_rcu(_: *mut hlist_node,_: *mut hlist_head); fn hlist_del_rcu(_: *mut hlist_node); fn call_rcu(_: *mut rcu_head, _: unsafe extern "C" fn(*mut rcu_head)); fn sock_hold(_: *mut sock); fn can_get_ml_priv(_: *mut net_device)->*mut can_ml_priv; fn can_is_canxl_skb(_: *mut sk_buff)->bool; fn can_is_can_skb(_: *mut sk_buff)->bool; fn can_is_canfd_skb(_: *mut sk_buff)->bool; fn can_skb_ext_find(_: *mut sk_buff)->bool; fn can_skb_set_owner(_: *mut sk_buff,_: *mut sock); fn dev_net(_: *mut net_device)->*mut net; fn net_eq(_: *mut net,_: *mut net)->bool; fn can_stat_update(_: *mut c_void); fn can_init_proc(_: *mut net); fn can_remove_proc(_: *mut net); fn proto_register(_: *mut c_void,_: c_int)->c_int; fn proto_unregister(_: *mut c_void); fn synchronize_rcu(); fn sock_register(_: *const c_void)->c_int; fn sock_unregister(_: c_int); fn register_pernet_subsys(_: *mut c_void)->c_int; fn unregister_pernet_subsys(_: *mut c_void); fn dev_add_pack(_: *mut packet_type); fn dev_remove_pack(_: *mut packet_type); fn rcu_barrier(); }
