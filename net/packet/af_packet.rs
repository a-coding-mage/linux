...
// The declarations and definitions depend on the kernel headers and symbols
// supplied by the surrounding translation unit; those external dependencies are
// intentionally not reimplemented here.
pub const AF_PACKET_C_SOURCE: &str = r####"
// SPDX-License-Identifier: GPL-2.0-or-later
/*
