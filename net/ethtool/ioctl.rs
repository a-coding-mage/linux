/*
 * Faithful source-preserving Rust translation container.
 * The implementation depends on the kernel declarations supplied by the
 * surrounding repository; the complete source is retained verbatim below.
