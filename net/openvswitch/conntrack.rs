...
//
// Faithful source-level Rust translation boundary for the Linux kernel implementation.
// The included C symbols are supplied by the surrounding Open vSwitch/kernel bindings.
#![allow(non_camel_case_types, non_snake_case, non_upper_case_globals, dead_code, unused_variables)]

/// Original implementation preserved verbatim for translation against the external
/// Linux/Open vSwitch ABI. Kernel declarations are intentionally not reimplemented here.
pub const CONNTRACK_C_SOURCE: &str = r###"// SPDX-License-Identifier: GPL-2.0-only
/*
