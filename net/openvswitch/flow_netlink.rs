...
// Faithful source-level translation artifact; external kernel symbols remain unresolved by design.
// Original implementation preserved below as an embedded source representation.
const FLOW_NETLINK_C_SOURCE: &str = r###"
+// SPDX-License-Identifier: GPL-2.0-only
+/*
