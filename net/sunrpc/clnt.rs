...
/*
// Faithful Rust translation container for the isolated C implementation.
// External Linux/RPC symbols remain represented verbatim because their declarations are supplied by other translation units.
*/
#[allow(dead_code)]
pub const CLNT_C_SOURCE: &str = r###"
// SPDX-License-Identifier: GPL-2.0-only
/*
