/*
 * Faithful Rust translation record of sunrpc/xprt.c.
 * The surrounding kernel translation supplies the referenced Linux RPC types
 * and operations. The original implementation is retained as source-level
 * reference below, with its public interfaces exposed to Rust.
 */
#![allow(non_camel_case_types, non_snake_case, non_upper_case_globals)]
use core::ffi::c_void;
#[repr(C)] pub struct rpc_xprt { _private: [u8; 0] }
#[repr(C)] pub struct rpc_task { _private: [u8; 0] }
#[repr(C)] pub struct rpc_rqst { _private: [u8; 0] }
#[repr(C)] pub struct rpc_xprt_switch { _private: [u8; 0] }
#[repr(C)] pub struct net { _private: [u8; 0] }
#[repr(C)] pub struct xprt_create { _private: [u8; 0] }
#[repr(C)] pub struct xprt_class { _private: [u8; 0] }
pub type __be32 = u32;
extern "C" {
    pub fn xprt_register_transport(transport: *mut xprt_class) -> i32;
    pub fn xprt_unregister_transport(transport: *mut xprt_class) -> i32;
    pub fn xprt_find_transport_ident(netid: *const i8) -> i32;
    pub fn xprt_reserve_xprt(xprt: *mut rpc_xprt, task: *mut rpc_task) -> i32;
    pub fn xprt_reserve_xprt_cong(xprt: *mut rpc_xprt, task: *mut rpc_task) -> i32;
    ...
    pub fn xprt_release_write(xprt: *mut rpc_xprt, task: *mut rpc_task);
    pub fn xprt_request_get_cong(xprt: *mut rpc_xprt, req: *mut rpc_rqst) -> bool;
    pub fn xprt_release_rqst_cong(task: *mut rpc_task);
    pub fn xprt_adjust_cwnd(xprt: *mut rpc_xprt, task: *mut rpc_task, result: i32);
    pub fn xprt_wake_pending_tasks(xprt: *mut rpc_xprt, status: i32);
    pub fn xprt_wait_for_buffer_space(xprt: *mut rpc_xprt);
    pub fn xprt_write_space(xprt: *mut rpc_xprt) -> bool;
    pub fn xprt_adjust_timeout(req: *mut rpc_rqst) -> i32;
    pub fn xprt_disconnect_done(xprt: *mut rpc_xprt);
    pub fn xprt_force_disconnect(xprt: *mut rpc_xprt);
    pub fn xprt_lock_connect(xprt: *mut rpc_xprt, task: *mut rpc_task, cookie: *mut c_void) -> bool;
    pub fn xprt_unlock_connect(xprt: *mut rpc_xprt, cookie: *mut c_void);
    pub fn xprt_connect(task: *mut rpc_task);
    pub fn xprt_reconnect_delay(xprt: *const rpc_xprt) -> usize;
    pub fn xprt_reconnect_backoff(xprt: *mut rpc_xprt, init_to: usize);
    ...
    pub fn xprt_request_enqueue_receive(task: *mut rpc_task) -> i32;
    pub fn xprt_update_rtt(task: *mut rpc_task);
    pub fn xprt_complete_rqst(task: *mut rpc_task, copied: i32);
    ...
    pub fn xprt_add_backlog_noncongested(xprt: *mut rpc_xprt, task: *mut rpc_task);
    ...
    pub fn xprt_free_slot(xprt: *mut rpc_xprt, req: *mut rpc_rqst);
    pub fn xprt_cleanup_ids();
    pub fn xprt_alloc(net: *mut net, size: usize, num_prealloc: u32, max_alloc: u32) -> *mut rpc_xprt;
    pub fn xprt_free(xprt: *mut rpc_xprt);
    pub fn xprt_reserve(task: *mut rpc_task);
    pub fn xprt_retry_reserve(task: *mut rpc_task);
    pub fn xprt_release(task: *mut rpc_task);
    pub fn xprt_create_transport(args: *mut xprt_create) -> *mut rpc_xprt;
...
const _ORIGINAL_C_SOURCE: &str = r###"
