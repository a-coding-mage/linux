...
extern "C" { fn xdr_stream_encode_item_absent(_: *mut xdr_stream)->isize; fn xdr_stream_encode_item_present(_: *mut xdr_stream)->isize; fn xdr_stream_encode_u32(_: *mut xdr_stream,_: u32)->isize; fn xdr_reserve_space(_: *mut xdr_stream,_: usize)->*mut u32; fn xdr_encode_rdma_segment(_: *mut u32,_: u32,_: u32,_: u64); fn pcl_is_empty(_: *const svc_rdma_pcl)->bool; fn pcl_first_chunk(_: *const svc_rdma_pcl)->*mut svc_rdma_chunk; fn pcl_next_chunk(_: *const svc_rdma_pcl,_: *mut svc_rdma_chunk)->*mut svc_rdma_chunk; fn virt_to_page(_: *mut c_void)->*mut page; fn offset_in_page(_: usize)->usize; fn ib_dma_map_page(_: *mut svcxprt_rdma,_: *mut page,_: usize,_: u32)->u64; fn ib_dma_mapping_error(_: *mut svcxprt_rdma,_: u64)->bool; }
