// Faithful source-level preservation of the isolated implementation.
// External kernel types, symbols, and build-time configuration are supplied by
// the surrounding kernel translation units.
#[allow(dead_code)]
pub const XPRTSOCK_C_SOURCE: &str = r###"// SPDX-License-Identifier: GPL-2.0
/*
