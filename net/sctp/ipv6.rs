...
// Faithful source-level Rust translation. Linux kernel/SCTP types and APIs are
// supplied by the surrounding translation unit and are intentionally external.
//
// The original implementation is retained below as a precise semantic record;
// declarations expose the externally visible entry points in Rust form.
...
extern "C" {
    ...
    pub fn sctp_v6_protosw_init() -> ::core::ffi::c_int;
    pub fn sctp_v6_protosw_exit();
    pub fn sctp_v6_add_protocol() -> ::core::ffi::c_int;
