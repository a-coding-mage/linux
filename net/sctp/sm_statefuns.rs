...
// Faithful low-level translation of the isolated SCTP state-function source.
// External kernel types, functions, constants, and macros are intentionally
// left unresolved for the surrounding translation unit to provide.
pub const _SM_STATEFUNS_C_SOURCE: &str = r###"// SPDX-License-Identifier: GPL-2.0-or-later
