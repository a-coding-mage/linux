...
// Faithful source-preserving Rust translation artifact.
// External kernel and batman-adv symbols remain supplied by future dependencies.
#![allow(dead_code, unused_variables, unused_mut, non_snake_case, non_camel_case_types)]

pub const TRANSLATION_TABLE_C_SOURCE: &str = r###"// SPDX-License-Identifier: GPL-2.0
