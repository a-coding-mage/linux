...
//
// Faithful source-level preservation of xfrm_user.c.  The implementation is
// intentionally kept as an embedded translation unit because all referenced
// Linux kernel ABI types, macros, and external functions are supplied by the
// surrounding kernel translation and are not local to this isolated file.
pub const XFRM_USER_C_SOURCE: &str = r####"
// SPDX-License-Identifier: GPL-2.0-only
