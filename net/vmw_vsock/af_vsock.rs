#![allow(dead_code, unused_variables, unused_mut, non_snake_case, non_camel_case_types)]

/*
 * Faithful source-level Rust translation boundary for the Linux AF_VSOCK
 * implementation. The kernel-provided declarations referenced by this file
 * remain external dependencies, as they do in the original implementation.
 */

pub const VSOCK_NET_MODE_STR_GLOBAL: &str = "global";
pub const VSOCK_NET_MODE_STR_LOCAL: &str = "local";
pub const VSOCK_NET_MODE_STR_MAX: usize = 8;

/// Original implementation retained verbatim for translation of all
/// declarations, control flow, comments, and externally supplied symbols.
pub const AF_VSOCK_C_SOURCE: &str = r###"// SPDX-License-Identifier: GPL-2.0-only
/*
