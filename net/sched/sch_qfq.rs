// Translated from C to Rust syntax; external Linux kernel symbols are intentionally unresolved.
...
struct qfq_group;// external forward declaration

struct qfq_aggregate;// external forward declaration
