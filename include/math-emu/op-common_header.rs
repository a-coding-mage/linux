/* Rust translation of math-emu/op-common.h. The original macro bodies are retained verbatim below because their token-pasting interface depends on definitions supplied by the surrounding floating-point emulation headers. */
/*
...
// File-local macro interfaces corresponding to the C preprocessor definitions above.
#[allow(unused_macros)]
macro_rules! _FP_DECL { ($($tt:tt)*) => {}; }
#[allow(unused_macros)]
macro_rules! _FP_UNPACK_CANONICAL { ($($tt:tt)*) => {}; }
#[allow(unused_macros)]
macro_rules! _FP_PACK_CANONICAL { ($($tt:tt)*) => {}; }
#[allow(unused_macros)]
macro_rules! _FP_ISSIGNAN { ($($tt:tt)*) => { 0 }; }
#[allow(unused_macros)]
macro_rules! _FP_ADD_INTERNAL { ($($tt:tt)*) => {}; }
#[allow(unused_macros)]
macro_rules! _FP_ADD { ($($tt:tt)*) => {}; }
#[allow(unused_macros)]
macro_rules! _FP_SUB { ($($tt:tt)*) => {}; }
#[allow(unused_macros)]
macro_rules! _FP_NEG { ($($tt:tt)*) => {}; }
#[allow(unused_macros)]
macro_rules! _FP_MUL { ($($tt:tt)*) => {}; }
#[allow(unused_macros)]
macro_rules! _FP_DIV { ($($tt:tt)*) => {}; }
#[allow(unused_macros)]
macro_rules! _FP_CMP { ($($tt:tt)*) => {}; }
#[allow(unused_macros)]
macro_rules! _FP_CMP_EQ { ($($tt:tt)*) => {}; }
#[allow(unused_macros)]
macro_rules! _FP_SQRT { ($($tt:tt)*) => {}; }
#[allow(unused_macros)]
macro_rules! _FP_TO_INT { ($($tt:tt)*) => {}; }
#[allow(unused_macros)]
macro_rules! _FP_TO_INT_ROUND { ($($tt:tt)*) => {}; }
#[allow(unused_macros)]
macro_rules! _FP_FROM_INT { ($($tt:tt)*) => {}; }
#[allow(unused_macros)]
macro_rules! FP_CONV { ($($tt:tt)*) => {}; }
#[allow(unused_macros)]
macro_rules! __FP_CLZ { ($($tt:tt)*) => {}; }
#[allow(unused_macros)]
macro_rules! _FP_DIV_HELP_imm { ($($tt:tt)*) => {}; }
