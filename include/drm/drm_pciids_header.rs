...
// Translated from the C preprocessor macro; referenced identifiers are supplied externally.
#[macro_export]
macro_rules! radeon_PCI_IDS {
    () => {
        #define radeon_PCI_IDS!(0x1002, 0x1304, PCI_ANY_ID, PCI_ANY_ID, 0, 0, CHIP_KAVERI|RADEON_IS_MOBILITY|RADEON_NEW_MEMMAP|RADEON_IS_IGP),
