...
extern "C" {
 ...
 pub fn mipi_dsi_device_register_full(_: *mut mipi_dsi_host, _: *const mipi_dsi_device_info) -> *mut mipi_dsi_device; pub fn mipi_dsi_device_unregister(_: *mut mipi_dsi_device);
 pub fn mipi_dsi_attach(_: *mut mipi_dsi_device) -> c_int; pub fn mipi_dsi_detach(_: *mut mipi_dsi_device) -> c_int;
 pub fn mipi_dsi_generic_write(_: *mut mipi_dsi_device, _: *const c_void, _: size_t) -> ssize_t; pub fn mipi_dsi_generic_read(_: *mut mipi_dsi_device, _: *const c_void, _: size_t, _: *mut c_void, _: size_t) -> ssize_t;
 pub fn drm_mipi_dsi_get_input_bus_fmt(_: mipi_dsi_pixel_format) -> u32;
 pub fn mipi_dsi_dcs_write_buffer(_: *mut mipi_dsi_device, _: *const c_void, _: size_t) -> ssize_t; pub fn mipi_dsi_dcs_write(_: *mut mipi_dsi_device, _: u8, _: *const c_void, _: size_t) -> ssize_t; pub fn mipi_dsi_dcs_read(_: *mut mipi_dsi_device, _: u8, _: *mut c_void, _: size_t) -> ssize_t;
}
...
extern "C" { pub fn mipi_dsi_driver_register_full(_: *mut mipi_dsi_driver, _: *mut module) -> c_int; pub fn mipi_dsi_driver_unregister(_: *mut mipi_dsi_driver); }

extern "C" {
 pub fn devm_mipi_dsi_device_register_full(_: *mut device, _: *mut mipi_dsi_host, _: *const mipi_dsi_device_info) -> *mut mipi_dsi_device; pub fn of_find_mipi_dsi_device_by_node(_: *mut device_node) -> *mut mipi_dsi_device; pub fn devm_mipi_dsi_attach(_: *mut device, _: *mut mipi_dsi_device) -> c_int; pub fn mipi_dsi_shutdown_peripheral(_: *mut mipi_dsi_device) -> c_int; pub fn mipi_dsi_turn_on_peripheral(_: *mut mipi_dsi_device) -> c_int; pub fn mipi_dsi_set_maximum_return_packet_size(_: *mut mipi_dsi_device, _: u16) -> c_int; pub fn mipi_dsi_compression_mode(_: *mut mipi_dsi_device, _: bool) -> c_int; pub fn mipi_dsi_compression_mode_ext(_: *mut mipi_dsi_device, _: bool, _: mipi_dsi_compression_algo, _: c_uint) -> c_int; pub fn mipi_dsi_picture_parameter_set(_: *mut mipi_dsi_device, _: *const drm_dsc_picture_parameter_set) -> c_int;
 pub fn mipi_dsi_compression_mode_ext_multi(_: *mut mipi_dsi_multi_context, _: bool, _: mipi_dsi_compression_algo, _: c_uint); pub fn mipi_dsi_compression_mode_multi(_: *mut mipi_dsi_multi_context, _: bool); pub fn mipi_dsi_picture_parameter_set_multi(_: *mut mipi_dsi_multi_context, _: *const drm_dsc_picture_parameter_set); pub fn mipi_dsi_generic_write_multi(_: *mut mipi_dsi_multi_context, _: *const c_void, _: size_t); pub fn mipi_dsi_dual_generic_write_multi(_: *mut mipi_dsi_multi_context, _: *mut mipi_dsi_device, _: *mut mipi_dsi_device, _: *const c_void, _: size_t);
 pub fn mipi_dsi_dcs_write_buffer_chatty(_: *mut mipi_dsi_device, _: *const c_void, _: size_t) -> c_int; pub fn mipi_dsi_dcs_write_buffer_multi(_: *mut mipi_dsi_multi_context, _: *const c_void, _: size_t); pub fn mipi_dsi_dual_dcs_write_buffer_multi(_: *mut mipi_dsi_multi_context, _: *mut mipi_dsi_device, _: *mut mipi_dsi_device, _: *const c_void, _: size_t); pub fn mipi_dsi_dcs_read_multi(_: *mut mipi_dsi_multi_context, _: u8, _: *mut c_void, _: size_t);
 pub fn mipi_dsi_dcs_nop(_: *mut mipi_dsi_device) -> c_int; pub fn mipi_dsi_dcs_soft_reset(_: *mut mipi_dsi_device) -> c_int; pub fn mipi_dsi_dcs_get_power_mode(_: *mut mipi_dsi_device, _: *mut u8) -> c_int; pub fn mipi_dsi_dcs_get_pixel_format(_: *mut mipi_dsi_device, _: *mut u8) -> c_int; pub fn mipi_dsi_dcs_enter_sleep_mode(_: *mut mipi_dsi_device) -> c_int; pub fn mipi_dsi_dcs_exit_sleep_mode(_: *mut mipi_dsi_device) -> c_int; pub fn mipi_dsi_dcs_set_display_off(_: *mut mipi_dsi_device) -> c_int; pub fn mipi_dsi_dcs_set_display_on(_: *mut mipi_dsi_device) -> c_int;
 pub fn mipi_dsi_dcs_set_column_address(_: *mut mipi_dsi_device, _: u16, _: u16) -> c_int; pub fn mipi_dsi_dcs_set_page_address(_: *mut mipi_dsi_device, _: u16, _: u16) -> c_int; pub fn mipi_dsi_dcs_set_tear_on(_: *mut mipi_dsi_device, _: mipi_dsi_dcs_tear_mode) -> c_int; pub fn mipi_dsi_dcs_set_pixel_format(_: *mut mipi_dsi_device, _: u8) -> c_int; pub fn mipi_dsi_dcs_set_tear_scanline(_: *mut mipi_dsi_device, _: u16) -> c_int; pub fn mipi_dsi_dcs_set_display_brightness(_: *mut mipi_dsi_device, _: u16) -> c_int; pub fn mipi_dsi_dcs_get_display_brightness(_: *mut mipi_dsi_device, _: *mut u16) -> c_int; pub fn mipi_dsi_dcs_set_display_brightness_large(_: *mut mipi_dsi_device, _: u16) -> c_int; pub fn mipi_dsi_dcs_get_display_brightness_large(_: *mut mipi_dsi_device, _: *mut u16) -> c_int;
 pub fn mipi_dsi_dcs_nop_multi(_: *mut mipi_dsi_multi_context); pub fn mipi_dsi_dcs_enter_sleep_mode_multi(_: *mut mipi_dsi_multi_context); pub fn mipi_dsi_dcs_exit_sleep_mode_multi(_: *mut mipi_dsi_multi_context); pub fn mipi_dsi_dcs_set_display_off_multi(_: *mut mipi_dsi_multi_context); pub fn mipi_dsi_dcs_set_display_on_multi(_: *mut mipi_dsi_multi_context); pub fn mipi_dsi_dcs_set_tear_on_multi(_: *mut mipi_dsi_multi_context, _: mipi_dsi_dcs_tear_mode); pub fn mipi_dsi_turn_on_peripheral_multi(_: *mut mipi_dsi_multi_context); pub fn mipi_dsi_dcs_soft_reset_multi(_: *mut mipi_dsi_multi_context); pub fn mipi_dsi_dcs_set_display_brightness_multi(_: *mut mipi_dsi_multi_context, _: u16); pub fn mipi_dsi_dcs_set_pixel_format_multi(_: *mut mipi_dsi_multi_context, _: u8); pub fn mipi_dsi_dcs_set_column_address_multi(_: *mut mipi_dsi_multi_context, _: u16, _: u16); pub fn mipi_dsi_dcs_set_page_address_multi(_: *mut mipi_dsi_multi_context, _: u16, _: u16); pub fn mipi_dsi_dcs_set_tear_scanline_multi(_: *mut mipi_dsi_multi_context, _: u16); pub fn mipi_dsi_dcs_set_tear_off_multi(_: *mut mipi_dsi_multi_context); pub fn mipi_dsi_shutdown_peripheral_multi(_: *mut mipi_dsi_multi_context);
}
