//! Faithful source-level translation of `linux/mm.h`.
//!
//! The declarations below depend on the Linux kernel's surrounding type and
//! macro environment. The complete original header is retained as a Rust
//! documentation payload so configuration-dependent declarations, comments,
//! and conditional intent are not lost while those dependencies are supplied
//! by translated kernel units.
//!
//! ```text
...
//! static inline void __mm_zero_struct_page(page *page)
//! {
//! 	unsigned long *_pp = (void *)page;
//! 
//! 	 /* Check that struct page is either 56, 64, 72, 80, 88 or 96 bytes */
//! 	BUILD_BUG_ON(sizeof(page) & 7);
//! 	BUILD_BUG_ON(sizeof(page) < 56);
//! 	BUILD_BUG_ON(sizeof(page) > 96);
//! 
//! 	switch (sizeof(page)) {
//! 	case 96:
//! 		_pp[11] = 0;
...
//! }
//! #else
//! #define mm_zero_struct_page(pp)  ((void)memset((pp), 0, sizeof(page)))
//! #endif
//! 
//! /*
...
//! }
//! 
//! static inline struct folio *lru_to_folio(list_head *head)
//! {
//! 	return list_entry((head)->prev, folio, lru);
//! }
//! 
...
//!  */
//! 
//! struct vm_area_struct *vm_area_alloc(mm_struct *);
//! struct vm_area_struct *vm_area_dup(vm_area_struct *);
//! void vm_area_free(vm_area_struct *);
//! 
//! #ifndef CONFIG_MMU
...
//! 	 */
//! 	void (*open)(vm_area_struct *vma);
//! 	/**
//! 	 * @close: Called when the VMA is being removed from the MM.
//! 	 * Context: User context.  May sleep.  Caller holds mmap_lock.
//! 	 */
//! 	void (*close)(vm_area_struct *vma);
//! 	/**
...
//! 	int (*may_split)(vm_area_struct *vma, unsigned long addr);
//! 	int (*mremap)(vm_area_struct *vma);
//! 	/*
//! 	 * Called by mprotect() to make driver-specific permission
//! 	 * checks before mprotect() is finalised.   The VMA must not
//! 	 * be modified.  Returns 0 if mprotect() can proceed.
//! 	 */
//! 	int (*mprotect)(vm_area_struct *vma, unsigned long start,
//! 			unsigned long end, unsigned long newflags);
//! 	vm_fault_t (*fault)(vm_fault *vmf);
//! 	vm_fault_t (*huge_fault)(vm_fault *vmf, unsigned int order);
//! 	vm_fault_t (*map_pages)(vm_fault *vmf,
//! 			pgoff_t start_pgoff, pgoff_t end_pgoff);
//! 	unsigned long (*pagesize)(vm_area_struct *vma);
//! 
//! 	/* notification that a previously read-only page is about to become
//! 	 * writable, if an error is returned it will cause a SIGBUS */
//! 	vm_fault_t (*page_mkwrite)(vm_fault *vmf);
//! 
//! 	/* same as page_mkwrite when using VM_PFNMAP|VM_MIXEDMAP */
//! 	vm_fault_t (*pfn_mkwrite)(vm_fault *vmf);
//! 
//! 	/* called by access_process_vm when get_user_pages() fails, typically
//! 	 * for use by special VMAs. See also generic_access_phys() for a generic
//! 	 * implementation useful for any iomem mapping.
//! 	 */
//! 	int (*access)(vm_area_struct *vma, unsigned long addr,
//! 		      void *buf, int len, int write);
//! 
//! 	/* Called by the /proc/PID/maps code to ask the vma whether it
//! 	 * has a special name.  Returning non-NULL will also cause this
//! 	 * vma to be dumped unconditionally. */
//! 	const char *(*name)(vm_area_struct *vma);
//! 
//! #ifdef CONFIG_NUMA
//! 	/*
...
//! 	 * mempolicy.
//! 	 */
//! 	int (*set_policy)(vm_area_struct *vma, mempolicy *new);
//! 
//! 	/*
...
//! 	 * policy.
//! 	 */
//! 	struct mempolicy *(*get_policy)(vm_area_struct *vma,
...
//! 	 * inserted page.
//! 	 */
//! 	struct page *(*find_normal_page)(vm_area_struct *vma,
//! 					 unsigned long addr);
...
//! static inline void vma_numab_state_init(vm_area_struct *vma)
//! {
//! 	vma->numab_state = NULL;
//! }
//! static inline void vma_numab_state_free(vm_area_struct *vma)
//! {
...
//! static inline void release_fault_lock(vm_fault *vmf)
//! {
...
//! }
//! 
//! static inline bool mm_flags_test_and_set(int flag, mm_struct *mm)
//! {
//! 	return test_and_set_bit(flag, ACCESS_PRIVATE(&mm->flags, __mm_flags));
//! }
//! 
//! static inline bool mm_flags_test_and_clear(int flag, mm_struct *mm)
//! {
//! 	return test_and_clear_bit(flag, ACCESS_PRIVATE(&mm->flags, __mm_flags));
//! }
//! 
//! static inline void mm_flags_set(int flag, mm_struct *mm)
//! {
//! 	set_bit(flag, ACCESS_PRIVATE(&mm->flags, __mm_flags));
//! }
//! 
//! static inline void mm_flags_clear(int flag, mm_struct *mm)
//! {
//! 	clear_bit(flag, ACCESS_PRIVATE(&mm->flags, __mm_flags));
//! }
//! 
//! static inline void mm_flags_clear_all(mm_struct *mm)
//! {
...
//! 
//! static inline void vma_init(vm_area_struct *vma, mm_struct *mm)
//! {
...
//! static inline void vm_flags_init(vm_area_struct *vma,
//! 				 vm_flags_t flags)
//! {
...
//!  */
//! static inline void vm_flags_reset(vm_area_struct *vma,
//! 				  vm_flags_t flags)
//! {
//! 	VM_WARN_ON_ONCE(!pgtable_supports_soft_dirty() && (flags & VM_SOFTDIRTY));
...
//! }
//! 
//! static inline void vma_flags_reset_once(vm_area_struct *vma,
//! 					vma_flags_t *flags)
//! {
...
//! }
//! 
//! static inline void vm_flags_set(vm_area_struct *vma,
//! 				vm_flags_t flags)
//! {
//! 	vma_start_write(vma);
...
//! }
//! 
//! static inline void vm_flags_clear(vm_area_struct *vma,
//! 				  vm_flags_t flags)
//! {
//! 	VM_WARN_ON_ONCE(!pgtable_supports_soft_dirty() && (flags & VM_SOFTDIRTY));
//! 	vma_start_write(vma);
...
//!  */
//! static inline void __vm_flags_mod(vm_area_struct *vma,
...
//!  */
//! static inline void vm_flags_mod(vm_area_struct *vma,
//! 				vm_flags_t set, vm_flags_t clear)
//! {
//! 	vma_start_write(vma);
...
//! }
//! 
//! static __always_inline bool __vma_atomic_valid_flag(vm_area_struct *vma,
//! 		vma_flag_t bit)
//! {
...
//!  */
//! static __always_inline void vma_set_atomic_flag(vm_area_struct *vma,
//! 		vma_flag_t bit)
//! {
...
//!  */
//! static __always_inline bool vma_test_atomic_flag(vm_area_struct *vma,
//! 		vma_flag_t bit)
//! {
//! 	if (__vma_atomic_valid_flag(vma, bit))
...
//!  * you.
//!  */
//! static __always_inline void vma_set_flags_mask(vm_area_struct *vma,
//! 		vma_flags_t flags)
//! {
...
//! static __always_inline void vma_clear_flags_mask(vm_area_struct *vma,
//! 		vma_flags_t flags)
//! {
...
//! static __always_inline void vma_desc_set_flags_mask(vm_area_desc *desc,
//! 		vma_flags_t flags)
//! {
...
//! static __always_inline void vma_desc_clear_flags_mask(vm_area_desc *desc,
//! 		vma_flags_t flags)
//! {
...
//! 
//! static inline void vma_set_anonymous(vm_area_struct *vma)
//! {
//! 	vma->vm_ops = NULL;
//! }
//! 
//! static inline void vma_desc_set_anonymous(vm_area_desc *desc)
//! {
//! 	desc->vm_ops = NULL;
//! }
//! 
...
//!  */
//! static inline unsigned long vma_kernel_pagesize(vm_area_struct *vma)
//! {
...
//! }
//! 
//! unsigned long vma_mmu_pagesize(vm_area_struct *vma);
//! 
//! static inline
//! struct vm_area_struct *vma_find(vma_iterator *vmi, unsigned long max)
//! {
//! 	return mas_find(&vmi->mas, max - 1);
//! }
//! 
//! static inline struct vm_area_struct *vma_next(vma_iterator *vmi)
//! {
//! 	/*
...
//! 
//! static inline
//! struct vm_area_struct *vma_iter_next_range(vma_iterator *vmi)
//! {
//! 	return mas_next_range(&vmi->mas, ULONG_MAX);
//! }
//! 
//! 
//! static inline struct vm_area_struct *vma_prev(vma_iterator *vmi)
//! {
//! 	return mas_prev(&vmi->mas, 0);
//! }
//! 
//! static inline int vma_iter_clear_gfp(vma_iterator *vmi,
...
//! static inline void vma_iter_free(vma_iterator *vmi)
//! {
//! 	mas_destroy(&vmi->mas);
//! }
//! 
//! static inline int vma_iter_bulk_store(vma_iterator *vmi,
...
//! }
//! 
//! static inline void vma_iter_invalidate(vma_iterator *vmi)
//! {
//! 	mas_pause(&vmi->mas);
//! }
//! 
//! static inline void vma_iter_set(vma_iterator *vmi, unsigned long addr)
//! {
...
//! struct inode;
//! 
//! extern void prep_compound_page(page *page, unsigned int order);
//! 
...
//! {
//! 	const struct folio *folio = (folio *)page;
//! 
...
//!  */
//! static inline void folio_reset_order(folio *folio)
//! {
...
//!  */
//! static inline int put_page_testzero(page *page)
//! {
//! 	VM_BUG_ON_PAGE(page_ref_count(page) == 0, page);
//! 	return page_ref_dec_and_test(page);
//! }
//! 
//! static inline int folio_put_testzero(folio *folio)
//! {
...
//!  */
//! static inline bool get_page_unless_zero(page *page)
//! {
//! 	return page_ref_add_unless_zero(page, 1);
//! }
//! 
//! static inline struct folio *folio_get_nontail_page(page *page)
//! {
...
//! }
//! 
//! void __folio_put(folio *folio);
//! 
//! void split_page(page *page, unsigned int order);
//! void folio_copy(folio *dst, folio *src);
//! int folio_mc_copy(folio *dst, folio *src);
//! 
...
//! static inline unsigned int page_shift(page *page)
//! {
...
//!  */
//! static inline unsigned int thp_order(page *page)
//! {
...
//!  */
//! static inline unsigned long thp_size(page *page)
//! {
...
//!  */
//! static inline pte_t maybe_mkwrite(pte_t pte, vm_area_struct *vma)
//! {
...
//! }
//! 
//! vm_fault_t do_set_pmd(vm_fault *vmf, folio *folio, page *page);
//! void set_pte_range(vm_fault *vmf, folio *folio,
//! 		struct page *page, unsigned int nr, unsigned long addr);
//! 
//! vm_fault_t finish_fault(vm_fault *vmf);
//! #endif
//! 
//! /*
...
//!  */
//! static inline void folio_get(folio *folio)
//! {
//! 	VM_BUG_ON_FOLIO(folio_ref_zero_or_close_to_overflow(folio), folio);
//! 	folio_ref_inc(folio);
//! }
//! 
//! static inline void get_page(page *page)
//! {
...
//! }
//! 
//! static inline __must_check bool try_get_page(page *page)
//! {
...
//!  */
//! static inline void folio_put(folio *folio)
//! {
...
//!  * context.  May be called while holding a spinlock.
//!  */
//! static inline void folio_put_refs(folio *folio, int refs)
//! {
//! 	if (folio_ref_sub_and_test(folio, refs))
//! 		__folio_put(folio);
//! }
//! 
//! void folios_put_refs(folio_batch *folios, unsigned int *refs);
//! 
//! /*
...
//!  * context.  May be called while holding a spinlock.
//!  */
//! static inline void folios_put(folio_batch *folios)
//! {
...
//! 
//! void unpin_user_page(page *page);
//! void unpin_folio(folio *folio);
//! void unpin_user_pages_dirty_lock(page **pages, unsigned long npages,
//! 				 bool make_dirty);
//! void unpin_user_page_range_dirty_lock(page *page, unsigned long npages,
//! 				      bool make_dirty);
//! void unpin_user_pages(page **pages, unsigned long npages);
//! void unpin_user_folio(folio *folio, unsigned long npages);
//! void unpin_folios(folio **folios, unsigned long nfolios);
//! 
//! /**
...
//!  * false.
//!  */
//! static inline bool vma_desc_is_cow_mapping(vm_area_desc *desc)
//! {
...
//!  * pages in a zone.
//!  */
//! static inline int page_zone_id(page *page)
//! {
...
//! static inline int folio_xchg_last_cpupid(folio *folio, int cpupid)
//! {
//! 	return xchg(&folio->_last_cpupid, cpupid & LAST_CPUPID_MASK);
//! }
//! 
//! static inline int folio_last_cpupid(folio *folio)
//! {
//! 	return folio->_last_cpupid;
//! }
//! static inline void page_cpupid_reset_last(page *page)
//! {
...
//! }
//! 
//! int folio_xchg_last_cpupid(folio *folio, int cpupid);
//! 
//! static inline void page_cpupid_reset_last(page *page)
//! {
...
//! 
//! static inline int folio_xchg_access_time(folio *folio, int time)
//! {
//! 	int last_time;
//! 
...
//! }
//! 
//! static inline void vma_set_access_pid_bit(vm_area_struct *vma)
//! {
...
//! }
//! 
//! bool folio_use_access_time(folio *folio);
...
//! }
//! 
//! static inline bool cpupid_match_pid(task_struct *task, int cpupid)
//! {
//! 	return false;
//! }
//! 
...
//! {
//! }
//! static inline bool folio_use_access_time(folio *folio)
//! {
//! 	return false;
//! }
//! #endif /* CONFIG_NUMA_BALANCING */
...
//! }
//! 
//! static inline void page_kasan_tag_set(page *page, u8 tag)
//! {
...
//! }
//! 
//! static inline void page_kasan_tag_reset(page *page)
//! {
//! 	if (kasan_enabled())
...
//! static inline void set_page_section(page *page, unsigned long section)
//! {
...
//!  */
//! static inline bool folio_maybe_dma_pinned(folio *folio)
//! {
...
//!  */
//! static inline bool folio_needs_cow_for_dma(vm_area_struct *vma,
//! 					  struct folio *folio)
//! {
...
//! static inline bool folio_is_longterm_pinnable(folio *folio)
//! {
//! #ifdef CONFIG_CMA
...
//! #endif
//! 
//! static inline void set_page_zone(page *page, enum zone_type zone)
//! {
//! 	page->flags.f &= ~(ZONES_MASK << ZONES_PGSHIFT);
//! 	page->flags.f |= (zone & ZONES_MASK) << ZONES_PGSHIFT;
//! }
//! 
//! static inline void set_page_node(page *page, unsigned long node)
//! {
//! 	page->flags.f &= ~(NODES_MASK << NODES_PGSHIFT);
//! 	page->flags.f |= (node & NODES_MASK) << NODES_PGSHIFT;
//! }
//! 
//! static inline void set_page_links(page *page, enum zone_type zone,
...
//!  */
//! static inline struct folio *folio_next(folio *folio)
//! {
//! 	return (folio *)folio_page(folio, folio_nr_pages(folio));
//! }
//! 
//! /**
...
//!  */
//! static inline bool folio_maybe_mapped_shared(folio *folio)
//! {
...
//! static inline int arch_make_folio_accessible(folio *folio)
//! {
//! 	return 0;
//! }
//! #endif
...
//! 	return page->virtual;
//! }
//! static inline void set_page_address(page *page, void *address)
//! {
...
//! void set_page_address(page *page, void *virtual);
...
//!  * page.
//!  */
//! static inline void set_page_pfmemalloc(page *page)
//! {
//! 	page->lru.next = (void *)BIT(1);
//! }
//! 
//! static inline void clear_page_pfmemalloc(page *page)
//! {
//! 	page->lru.next = NULL;
//! }
//! 
...
//! #endif
//! extern int user_shm_lock(size_t, ucounts *);
//! extern void user_shm_unlock(size_t, ucounts *);
//! 
//! struct folio *vm_normal_folio(vm_area_struct *vma, unsigned long addr,
//! 			     pte_t pte);
//! struct page *vm_normal_page(vm_area_struct *vma, unsigned long addr,
//! 			     pte_t pte);
//! struct folio *vm_normal_folio_pmd(vm_area_struct *vma,
//! 				  unsigned long addr, pmd_t pmd);
//! struct page *vm_normal_page_pmd(vm_area_struct *vma, unsigned long addr,
//! 				pmd_t pmd);
//! struct page *vm_normal_page_pud(vm_area_struct *vma, unsigned long addr,
//! 		pud_t pud);
//! 
//! void zap_special_vma_range(vm_area_struct *vma, unsigned long address,
//! 		  unsigned long size);
//! void zap_vma_range(vm_area_struct *vma, unsigned long address,
//! 			   unsigned long size);
//! /**
//!  * zap_vma - zap all page table entries in a vma
//!  * @vma: The vma to zap.
//!  */
//! static inline void zap_vma(vm_area_struct *vma)
//! {
//! 	zap_vma_range(vma, vma->vm_start, vma->vm_end - vma->vm_start);
//! }
//! struct mmu_notifier_range;
//! 
//! void free_pgd_range(mmu_gather *tlb, unsigned long addr,
//! 		unsigned long end, unsigned long floor, unsigned long ceiling);
//! int
//! copy_page_range(vm_area_struct *dst_vma, vm_area_struct *src_vma);
//! int generic_access_phys(vm_area_struct *vma, unsigned long addr,
//! 			void *buf, int len, int write);
//! 
...
//! 	bool special;
//! };
//! int follow_pfnmap_start(follow_pfnmap_args *args);
//! void follow_pfnmap_end(follow_pfnmap_args *args);
//! 
//! extern void truncate_pagecache(inode *inode, loff_t new);
//! extern void truncate_setsize(inode *inode, loff_t newsize);
//! void pagecache_isize_extended(inode *inode, loff_t from, loff_t to);
//! void truncate_pagecache_range(inode *inode, loff_t offset, loff_t end);
//! int generic_error_remove_folio(address_space *mapping,
//! 		struct folio *folio);
//! 
//! struct vm_area_struct *lock_mm_and_find_vma(mm_struct *mm,
//! 		unsigned long address, pt_regs *regs);
//! 
//! #ifdef CONFIG_MMU
//! extern vm_fault_t handle_mm_fault(vm_area_struct *vma,
//! 				  unsigned long address, unsigned int flags,
//! 				  struct pt_regs *regs);
//! extern int fixup_user_fault(mm_struct *mm,
//! 			    unsigned long address, unsigned int fault_flags,
//! 			    bool *unlocked);
//! void unmap_mapping_pages(address_space *mapping,
//! 		pgoff_t start, pgoff_t nr, bool even_cows);
//! void unmap_mapping_range(address_space *mapping,
//! 		loff_t const holebegin, loff_t const holelen, int even_cows);
//! #else
//! static inline vm_fault_t handle_mm_fault(vm_area_struct *vma,
//! 					 unsigned long address, unsigned int flags,
//! 					 struct pt_regs *regs)
//! {
...
//! }
//! static inline int fixup_user_fault(mm_struct *mm, unsigned long address,
...
//! 	return -EFAULT;
//! }
//! static inline void unmap_mapping_pages(address_space *mapping,
//! 		pgoff_t start, pgoff_t nr, bool even_cows) { }
//! static inline void unmap_mapping_range(address_space *mapping,
//! 		loff_t const holebegin, loff_t const holelen, int even_cows) { }
//! #endif
//! 
//! static inline void unmap_shared_mapping_range(address_space *mapping,
//! 		loff_t const holebegin, loff_t const holelen)
//! {
//! 	unmap_mapping_range(mapping, holebegin, holelen, 0);
//! }
//! 
//! static inline struct vm_area_struct *vma_lookup(mm_struct *mm,
//! 						unsigned long addr);
//! 
//! extern int access_process_vm(task_struct *tsk, unsigned long addr,
//! 		void *buf, int len, unsigned int gup_flags);
//! extern int access_remote_vm(mm_struct *mm, unsigned long addr,
//! 		void *buf, int len, unsigned int gup_flags);
//! 
//! #ifdef CONFIG_BPF_SYSCALL
//! extern int copy_remote_vm_str(task_struct *tsk, unsigned long addr,
//! 			      void *buf, int len, unsigned int gup_flags);
//! #endif
//! 
//! long get_user_pages_remote(mm_struct *mm,
//! 			   unsigned long start, unsigned long nr_pages,
//! 			   unsigned int gup_flags, page **pages,
//! 			   int *locked);
//! long pin_user_pages_remote(mm_struct *mm,
//! 			   unsigned long start, unsigned long nr_pages,
//! 			   unsigned int gup_flags, page **pages,
//! 			   int *locked);
//! 
...
//!  */
//! static inline struct page *get_user_page_vma_remote(mm_struct *mm,
//! 						    unsigned long addr,
//! 						    int gup_flags,
...
//! 		    struct page **pages, unsigned int gup_flags);
//! long memfd_pin_folios(file *memfd, loff_t start, loff_t end,
//! 		      struct folio **folios, unsigned int max_folios,
//! 		      pgoff_t *offset);
//! int folio_add_pins(folio *folio, unsigned int pins);
//! 
//! int get_user_pages_fast(unsigned long start, int nr_pages,
//! 			unsigned int gup_flags, page **pages);
//! int pin_user_pages_fast(unsigned long start, int nr_pages,
//! 			unsigned int gup_flags, page **pages);
//! void folio_add_pin(folio *folio);
//! 
//! int account_locked_vm(mm_struct *mm, unsigned long pages, bool inc);
//! int __account_locked_vm(mm_struct *mm, unsigned long pages, bool inc,
//! 			const struct task_struct *task, bool bypass_rlim);
//! 
//! struct kvec;
//! struct page *get_dump_page(unsigned long addr, int *locked);
//! 
//! bool folio_mark_dirty(folio *folio);
//! bool folio_mark_dirty_lock(folio *folio);
//! bool set_page_dirty(page *page);
//! int set_page_dirty_lock(page *page);
//! 
//! int get_cmdline(task_struct *task, char *buffer, int buflen);
//! 
//! /*
...
//! 
//! bool can_change_pte_writable(vm_area_struct *vma, unsigned long addr,
//! 			     pte_t pte);
//! extern long change_protection(mmu_gather *tlb,
//! 			      struct vm_area_struct *vma, unsigned long start,
//! 			      unsigned long end, unsigned long cp_flags);
//! extern int mprotect_fixup(vma_iterator *vmi, mmu_gather *tlb,
//! 	  struct vm_area_struct *vma, vm_area_struct **pprev,
...
//! 			unsigned int gup_flags, page **pagep)
//! {
...
//!  */
//! static inline unsigned long get_mm_counter(mm_struct *mm, int member)
//! {
//! 	return percpu_counter_read_positive(&mm->rss_stat[member]);
//! }
//! 
//! static inline unsigned long get_mm_counter_sum(mm_struct *mm, int member)
//! {
//! 	return percpu_counter_sum_positive(&mm->rss_stat[member]);
//! }
//! 
//! void mm_trace_rss_stat(mm_struct *mm, int member);
//! 
//! static inline void add_mm_counter(mm_struct *mm, int member, long value)
//! {
...
//! }
//! 
//! static inline void inc_mm_counter(mm_struct *mm, int member)
//! {
...
//! }
//! 
//! static inline void dec_mm_counter(mm_struct *mm, int member)
//! {
...
//! static inline int mm_counter_file(folio *folio)
//! {
...
//! }
//! 
//! static inline int mm_counter(folio *folio)
//! {
//! 	if (folio_test_anon(folio))
//! 		return MM_ANONPAGES;
...
//! }
//! 
//! static inline unsigned long get_mm_rss(mm_struct *mm)
//! {
...
//! }
//! 
//! static inline unsigned long get_mm_rss_sum(mm_struct *mm)
//! {
...
//! }
//! 
//! static inline unsigned long get_mm_hiwater_rss(mm_struct *mm)
//! {
//! 	return max(mm->hiwater_rss, get_mm_rss(mm));
//! }
//! 
//! static inline unsigned long get_mm_hiwater_vm(mm_struct *mm)
//! {
//! 	return max(mm->hiwater_vm, mm->total_vm);
//! }
//! 
//! static inline void update_hiwater_rss(mm_struct *mm)
//! {
...
//! }
//! 
//! static inline void update_hiwater_vm(mm_struct *mm)
//! {
//! 	if (mm->hiwater_vm < mm->total_vm)
//! 		mm->hiwater_vm = mm->total_vm;
//! }
//! 
//! static inline void reset_mm_hiwater_rss(mm_struct *mm)
//! {
...
//! 
//! extern pte_t *get_locked_pte(mm_struct *mm, unsigned long addr,
//! 			     spinlock_t **ptl);
//! 
//! #ifdef __PAGETABLE_P4D_FOLDED
//! static inline int __p4d_alloc(mm_struct *mm, pgd_t *pgd,
//! 						unsigned long address)
//! {
//! 	return 0;
//! }
//! #else
//! int __p4d_alloc(mm_struct *mm, pgd_t *pgd, unsigned long address);
//! #endif
//! 
//! #if defined(__PAGETABLE_PUD_FOLDED) || !defined(CONFIG_MMU)
//! static inline int __pud_alloc(mm_struct *mm, p4d_t *p4d,
//! 						unsigned long address)
//! {
//! 	return 0;
//! }
//! static inline void mm_inc_nr_puds(mm_struct *mm) {}
//! static inline void mm_dec_nr_puds(mm_struct *mm) {}
//! 
//! #else
//! int __pud_alloc(mm_struct *mm, p4d_t *p4d, unsigned long address);
//! 
//! static inline void mm_inc_nr_puds(mm_struct *mm)
//! {
//! 	if (mm_pud_folded(mm))
...
//! static inline int __pmd_alloc(mm_struct *mm, pud_t *pud,
//! 						unsigned long address)
//! {
//! 	return 0;
//! }
//! 
//! static inline void mm_inc_nr_pmds(mm_struct *mm) {}
//! static inline void mm_dec_nr_pmds(mm_struct *mm) {}
//! 
//! #else
//! int __pmd_alloc(mm_struct *mm, pud_t *pud, unsigned long address);
//! 
//! static inline void mm_inc_nr_pmds(mm_struct *mm)
//! {
//! 	if (mm_pmd_folded(mm))
...
//! 
//! #ifdef CONFIG_MMU
//! static inline void mm_pgtables_bytes_init(mm_struct *mm)
//! {
...
//! }
//! 
//! static inline void mm_inc_nr_ptes(mm_struct *mm)
//! {
//! 	atomic_long_add(PTRS_PER_PTE * sizeof(pte_t), &mm->pgtables_bytes);
//! }
//! 
//! static inline void mm_dec_nr_ptes(mm_struct *mm)
//! {
...
//! #endif
//! 
//! int __pte_alloc(mm_struct *mm, pmd_t *pmd);
//! int __pte_alloc_kernel(pmd_t *pmd);
//! 
//! #if defined(CONFIG_MMU)
//! 
//! static inline p4d_t *p4d_alloc(mm_struct *mm, pgd_t *pgd,
//! 		unsigned long address)
//! {
...
//! }
//! 
//! static inline pud_t *pud_alloc(mm_struct *mm, p4d_t *p4d,
//! 		unsigned long address)
//! {
...
//! }
//! 
//! static inline pmd_t *pmd_alloc(mm_struct *mm, pud_t *pud, unsigned long address)
//! {
...
//! }
//! 
//! static inline bool pagetable_is_reserved(ptdesc *pt)
//! {
...
//!  */
//! static inline void ptdesc_set_kernel(ptdesc *ptdesc)
//! {
...
//!  */
//! static inline void ptdesc_clear_kernel(ptdesc *ptdesc)
//! {
//! 	/*
...
//! 
//! static inline void __pagetable_free(ptdesc *pt)
//! {
...
//! void pagetable_free_kernel(ptdesc *pt);
//! #else
//! static inline void pagetable_free_kernel(ptdesc *pt)
//! {
//! 	__pagetable_free(pt);
//! }
//! #endif
...
//!  */
//! static inline void pagetable_free(ptdesc *pt)
//! {
...
//! bool ptlock_alloc(ptdesc *ptdesc);
//! void ptlock_free(ptdesc *ptdesc);
//! 
//! static inline spinlock_t *ptlock_ptr(ptdesc *ptdesc)
//! {
//! 	return ptdesc->ptl;
//! }
...
//! }
//! 
//! static inline bool ptlock_alloc(ptdesc *ptdesc)
//! {
//! 	return true;
//! }
//! 
//! static inline void ptlock_free(ptdesc *ptdesc)
//! {
//! }
//! 
//! static inline spinlock_t *ptlock_ptr(ptdesc *ptdesc)
...
//! 
//! static inline spinlock_t *pte_lockptr(mm_struct *mm, pmd_t *pmd)
//! {
//! 	return ptlock_ptr(page_ptdesc(pmd_page(*pmd)));
//! }
//! 
//! static inline spinlock_t *ptep_lockptr(mm_struct *mm, pte_t *pte)
//! {
...
//! }
//! 
//! static inline bool ptlock_init(ptdesc *ptdesc)
//! {
//! 	/*
...
//! }
//! static inline void ptlock_cache_init(void) {}
//! static inline bool ptlock_init(ptdesc *ptdesc) { return true; }
//! static inline void ptlock_free(ptdesc *ptdesc) {}
//! #endif /* defined(CONFIG_SPLIT_PTE_PTLOCKS) */
//! 
//! static inline void __pagetable_ctor(ptdesc *ptdesc)
//! {
...
//! }
//! 
//! static inline void pagetable_dtor(ptdesc *ptdesc)
//! {
//! 	struct folio *folio = ptdesc_folio(ptdesc);
//! 
//! 	ptlock_free(ptdesc);
...
//! }
//! 
//! static inline void pagetable_dtor_free(ptdesc *ptdesc)
//! {
//! 	pagetable_dtor(ptdesc);
//! 	pagetable_free(ptdesc);
//! }
//! 
//! static inline bool pagetable_pte_ctor(mm_struct *mm,
...
//! }
//! 
//! static inline spinlock_t *pmd_lockptr(mm_struct *mm, pmd_t *pmd)
//! {
//! 	return ptlock_ptr(pmd_ptdesc(pmd));
//! }
//! 
//! static inline bool pmd_ptlock_init(ptdesc *ptdesc)
//! {
//! #ifdef CONFIG_TRANSPARENT_HUGEPAGE
...
//! }
//! 
//! static inline bool pmd_ptlock_init(ptdesc *ptdesc) { return true; }
//! 
//! #define pmd_huge_pte(mm, pmd) ((mm)->pmd_huge_pte)
//! 
//! #endif
//! 
//! static inline spinlock_t *pmd_lock(mm_struct *mm, pmd_t *pmd)
//! {
...
//! }
//! 
//! static inline bool pagetable_pmd_ctor(mm_struct *mm,
//! 				      struct ptdesc *ptdesc)
//! {
...
//!  */
//! static inline spinlock_t *pud_lockptr(mm_struct *mm, pud_t *pud)
//! {
//! 	return &mm->page_table_lock;
//! }
//! 
//! static inline spinlock_t *pud_lock(mm_struct *mm, pud_t *pud)
//! {
...
//! }
//! 
//! static inline void pagetable_pud_ctor(ptdesc *ptdesc)
//! {
//! 	__pagetable_ctor(ptdesc);
//! }
//! 
//! static inline void pagetable_p4d_ctor(ptdesc *ptdesc)
//! {
//! 	__pagetable_ctor(ptdesc);
//! }
//! 
//! static inline void pagetable_pgd_ctor(ptdesc *ptdesc)
//! {
//! 	__pagetable_ctor(ptdesc);
//! }
//! 
...
//! 
//! extern void adjust_managed_page_count(page *page, long count);
//! 
//! void free_reserved_pages(page *page, unsigned int order);
//! 
//! static inline void free_reserved_page(page *page)
//! {
//! 	free_reserved_pages(page, 0);
//! }
//! 
//! static inline void mark_page_reserved(page *page)
//! {
//! 	SetPageReserved(page);
//! 	adjust_managed_page_count(page, -1);
//! }
//! 
//! static inline void free_reserved_ptdesc(ptdesc *pt)
//! {
...
//! extern void si_meminfo(sysinfo * val);
//! extern void si_meminfo_node(sysinfo *val, int nid);
//! 
//! extern __printf(3, 4)
...
//! extern int nommu_shrink_inode_mappings(inode *, size_t, size_t);
//! 
//! /* interval_tree.c */
//! void mapping_rmap_tree_insert(vm_area_struct *vma,
//! 			      struct address_space *mapping);
//! void mapping_rmap_tree_insert_after(vm_area_struct *vma,
//! 				    struct vm_area_struct *prev,
//! 				    struct address_space *mapping);
//! void mapping_rmap_tree_remove(vm_area_struct *vma,
//! 			      struct address_space *mapping);
//! struct vm_area_struct *
//! mapping_rmap_tree_iter_first(address_space *mapping,
//! 			     pgoff_t pgoff_start, pgoff_t pgoff_last);
//! struct vm_area_struct *
//! mapping_rmap_tree_iter_next(vm_area_struct *vma,
//! 			    pgoff_t pgoff_start, pgoff_t pgoff_last);
//! 
...
//! 						    pgoff_last))
//! 
//! void anon_rmap_tree_insert(anon_vma_chain *avc,
//! 			   struct anon_vma *anon_vma);
//! void anon_rmap_tree_remove(anon_vma_chain *avc,
//! 			   struct anon_vma *anon_vma);
//! struct anon_vma_chain *
//! anon_rmap_tree_iter_first(anon_vma *anon_vma,
//! 			  pgoff_t pgoff_start, pgoff_t pgoff_last);
//! struct anon_vma_chain *
//! anon_rmap_tree_iter_next(anon_vma_chain *avc,
//! 			 pgoff_t pgoff_start, pgoff_t pgoff_last);
//! #ifdef CONFIG_DEBUG_VM_RB
//! void anon_rmap_tree_verify(anon_vma_chain *avc);
//! #endif
//! 
...
//! extern void exit_mmap(mm_struct *);
//! bool mmap_read_lock_maybe_expand(mm_struct *mm, vm_area_struct *vma,
...
//! }
//! 
//! extern int mm_take_all_locks(mm_struct *mm);
//! extern void mm_drop_all_locks(mm_struct *mm);
//! 
//! extern int set_mm_exe_file(mm_struct *mm, file *new_exe_file);
//! extern int replace_mm_exe_file(mm_struct *mm, file *new_exe_file);
//! extern struct file *get_mm_exe_file(mm_struct *mm);
//! extern struct file *get_task_exe_file(task_struct *task);
//! 
//! extern void vm_stat_account(mm_struct *, vm_flags_t, long npages);
//! 
//! extern bool vma_is_special_mapping(const struct vm_area_struct *vma,
//! 				   const struct vm_special_mapping *sm);
//! struct vm_area_struct *_install_special_mapping(mm_struct *mm,
...
//! 
//! unsigned long
//! __get_unmapped_area(file *file, unsigned long addr, unsigned long len,
//! 		    unsigned long pgoff, unsigned long flags,
//! 		    vma_flags_t vma_flags);
//! 
//! static inline unsigned long
//! get_unmapped_area(file *file, unsigned long addr, unsigned long len,
//! 		  unsigned long pgoff, unsigned long flags)
//! {
...
//! }
//! 
//! unsigned long do_mmap(file *file, unsigned long addr,
//! 	unsigned long len, unsigned long prot, unsigned long flags,
//! 	vma_flags_t vma_flags, unsigned long pgoff, unsigned long *populate,
//! 	struct list_head *uf);
//! extern int do_vmi_munmap(vma_iterator *vmi, mm_struct *mm,
//! 			 unsigned long start, size_t len, list_head *uf,
//! 			 bool unlock);
//! int do_vmi_align_munmap(vma_iterator *vmi, vm_area_struct *vma,
//! 		    struct mm_struct *mm, unsigned long start,
//! 		    unsigned long end, list_head *uf, bool unlock);
//! extern int do_munmap(mm_struct *, unsigned long, size_t,
//! 		     struct list_head *uf);
//! extern int do_madvise(mm_struct *mm, unsigned long start, size_t len_in, int behavior);
//! 
//! #ifdef CONFIG_MMU
...
//! unsigned long __must_check vm_mmap(file *file, unsigned long addr,
...
//! };
//! 
//! extern unsigned long vm_unmapped_area(vm_unmapped_area_info *info);
//! 
//! /* truncate.c */
//! void truncate_inode_pages(address_space *mapping, loff_t lstart);
//! void truncate_inode_pages_range(address_space *mapping, loff_t lstart,
//! 		uoff_t lend);
//! void truncate_inode_pages_final(address_space *mapping);
//! 
//! /* generic vm_area_ops exported for stackable file systems */
//! extern vm_fault_t filemap_fault(vm_fault *vmf);
//! extern vm_fault_t filemap_map_pages(vm_fault *vmf,
//! 		pgoff_t start_pgoff, pgoff_t end_pgoff);
//! extern vm_fault_t filemap_page_mkwrite(vm_fault *vmf);
//! 
//! extern unsigned long stack_guard_gap;
//! /* Generic expand stack which grows the stack according to GROWS{UP,DOWN} */
//! int expand_stack_locked(vm_area_struct *vma, unsigned long address);
//! struct vm_area_struct *expand_stack(mm_struct * mm, unsigned long addr);
//! 
//! /* Look up the first VMA which satisfies  addr < vm_end,  NULL if none. */
//! extern struct vm_area_struct * find_vma(mm_struct * mm, unsigned long addr);
//! extern struct vm_area_struct * find_vma_prev(mm_struct * mm, unsigned long addr,
...
//!  */
//! struct vm_area_struct *find_vma_intersection(mm_struct *mm,
...
//!  */
//! static inline
//! struct vm_area_struct *vma_lookup(mm_struct *mm, unsigned long addr)
//! {
...
//!  * of the VMA.
//!  */
//! static inline void mmap_action_remap(vm_area_desc *desc,
//! 				     unsigned long start,
...
//!  * @start_pfn: The first PFN in the range to remap.
//!  */
//! static inline void mmap_action_remap_full(vm_area_desc *desc,
//! 					  unsigned long start_pfn)
//! {
...
//!  * of the VMA.
//!  */
//! static inline void mmap_action_ioremap(vm_area_desc *desc,
//! 				       unsigned long start,
//! 				       unsigned long start_pfn,
//! 				       unsigned long size)
//! {
//! 	mmap_action_remap(desc, start, start_pfn, size);
//! 	desc->action.r#type = MMAP_IO_REMAP_PFN;
//! }
//! 
//! /**
...
//!  * @start_pfn: The first PFN in the range to remap.
//!  */
//! static inline void mmap_action_ioremap_full(vm_area_desc *desc,
//! 					    unsigned long start_pfn)
//! {
...
//!  */
//! static inline void mmap_action_simple_ioremap(vm_area_desc *desc,
...
//!  */
//! static inline void mmap_action_map_kernel_pages(vm_area_desc *desc,
//! 		unsigned long start, page **pages,
//! 		unsigned long nr_pages)
//! {
//! 	struct mmap_action *action = &desc->action;
//! 
...
//!  */
//! static inline void mmap_action_map_kernel_pages_full(vm_area_desc *desc,
//! 		struct page **pages)
//! {
...
//! }
//! 
//! int mmap_action_prepare(vm_area_desc *desc);
//! int mmap_action_complete(vm_area_struct *vma,
//! 			 struct mmap_action *action, bool is_compat);
//! 
//! /* Look up the first VMA which exactly match the interval vm_start ... vm_end */
//! static inline struct vm_area_struct *find_exact_vma(mm_struct *mm,
...
//! }
//! 
//! void vma_set_page_prot(vm_area_struct *vma);
//! #else
...
//! 	return __pgprot(0);
//! }
//! static inline void vma_set_page_prot(vm_area_struct *vma)
//! {
//! 	vma->vm_page_prot = vma_get_page_prot(vma);
//! }
//! #endif
//! 
//! void vma_set_file(vm_area_struct *vma, file *file);
//! 
//! #ifdef CONFIG_NUMA_BALANCING
//! unsigned long change_prot_numa(vm_area_struct *vma,
//! 			unsigned long start, unsigned long end);
//! #endif
//! 
//! struct vm_area_struct *find_extend_vma_locked(mm_struct *,
//! 		unsigned long addr);
//! int remap_pfn_range(vm_area_struct *vma, unsigned long addr,
//! 		    unsigned long pfn, unsigned long size, pgprot_t pgprot);
//! 
//! int vm_insert_page(vm_area_struct *, unsigned long addr, page *);
//! int vm_insert_pages(vm_area_struct *vma, unsigned long addr,
//! 			struct page **pages, unsigned long *num);
//! int map_kernel_pages_prepare(vm_area_desc *desc);
//! int map_kernel_pages_complete(vm_area_struct *vma,
//! 			      struct mmap_action *action);
//! int vm_map_pages(vm_area_struct *vma, page **pages,
//! 				unsigned long num);
//! int vm_map_pages_zero(vm_area_struct *vma, page **pages,
//! 				unsigned long num);
...
//! int vm_iomap_memory(vm_area_struct *vma, phys_addr_t start, unsigned long len);
//! 
//! static inline vm_fault_t vmf_insert_page(vm_area_struct *vma,
//! 				unsigned long addr, page *page)
//! {
...
//! #endif
//! 
//! static inline int io_remap_pfn_range(vm_area_struct *vma,
...
//! extern int apply_to_page_range(mm_struct *mm, unsigned long address,
//! 			       unsigned long size, pte_fn_t fn, void *data);
//! extern int apply_to_existing_page_range(mm_struct *mm,
//! 				   unsigned long address, unsigned long size,
//! 				   pte_fn_t fn, void *data);
//! 
//! #ifdef CONFIG_PAGE_POISONING
//! extern void __kernel_poison_pages(page *page, int numpages);
//! extern void __kernel_unpoison_pages(page *page, int numpages);
...
//! }
//! static inline void kernel_poison_pages(page *page, int numpages)
//! {
//! 	if (page_poisoning_enabled_static())
//! 		__kernel_poison_pages(page, numpages);
//! }
//! static inline void kernel_unpoison_pages(page *page, int numpages)
//! {
//! 	if (page_poisoning_enabled_static())
...
//! static inline void __kernel_poison_pages(page *page, int nunmpages) { }
//! static inline void kernel_poison_pages(page *page, int numpages) { }
//! static inline void kernel_unpoison_pages(page *page, int numpages) { }
//! #endif
//! 
...
//!  */
//! extern void __kernel_map_pages(page *page, int numpages, int enable);
//! #ifdef CONFIG_DEBUG_PAGEALLOC
//! static inline void debug_pagealloc_map_pages(page *page, int numpages)
//! {
...
//! }
//! 
//! static inline void debug_pagealloc_unmap_pages(page *page, int numpages)
//! {
//! 	iommu_debug_check_unmapped(page, numpages);
//! 
//! 	if (debug_pagealloc_enabled_static())
...
//! }
//! 
//! bool __set_page_guard(zone *zone, page *page, unsigned int order);
//! static inline bool set_page_guard(zone *zone, page *page,
//! 				  unsigned int order)
//! {
//! 	if (!debug_guardpage_enabled())
//! 		return false;
...
//! }
//! 
//! void __clear_page_guard(zone *zone, page *page, unsigned int order);
//! static inline void clear_page_guard(zone *zone, page *page,
//! 				    unsigned int order)
//! {
//! 	if (!debug_guardpage_enabled())
//! 		return;
...
//! extern struct vm_area_struct *get_gate_vma(mm_struct *mm);
//! extern int in_gate_area_no_mm(unsigned long addr);
//! extern int in_gate_area(mm_struct *mm, unsigned long addr);
//! #else
//! static inline struct vm_area_struct *get_gate_vma(mm_struct *mm)
//! {
//! 	return NULL;
//! }
//! static inline int in_gate_area_no_mm(unsigned long addr) { return 0; }
//! static inline int in_gate_area(mm_struct *mm, unsigned long addr)
//! {
//! 	return 0;
//! }
...
//! #endif
//! 
//! const char * arch_vma_name(vm_area_struct *vma);
//! #ifdef CONFIG_MMU
...
//! 		unsigned long nr_pages, int nid, vmem_altmap *altmap,
...
//! }
//! 
//! static inline void vmem_altmap_free(vmem_altmap *altmap,
...
//! static inline bool __vmemmap_can_optimize(vmem_altmap *altmap,
//! 					  struct dev_pagemap *pgmap)
//! {
//! 	unsigned long nr_pages;
//! 	unsigned long nr_vmemmap_pages;
//! 
//! 	if (!pgmap || !is_power_of_2(sizeof(page)))
//! 		return false;
//! 
//! 	nr_pages = pgmap_vmemmap_nr(pgmap);
//! 	nr_vmemmap_pages = ((nr_pages * sizeof(page)) >> PAGE_SHIFT);
//! 	/*
...
//! 
//! #else
//! static inline bool vmemmap_can_optimize(vmem_altmap *altmap,
//! 					   struct dev_pagemap *pgmap)
//! {
//! 	return false;
//! }
...
//! };
//! int mf_dax_kill_procs(address_space *mapping, pgoff_t index,
...
//! void folio_zero_user(folio *folio, unsigned long addr_hint);
//! int copy_user_large_folio(folio *dst, folio *src,
//! 			  unsigned long addr_hint,
//! 			  struct vm_area_struct *vma);
//! long copy_folio_from_user(folio *dst_folio,
...
//! #endif
//! 
//! extern int memcmp_pages(page *page1, page *page2);
//! 
//! static inline int pages_identical(page *page1, page *page2)
//! {
//! 	return !memcmp_pages(page1, page2);
//! }
//! 
//! #ifdef CONFIG_MAPPING_DIRTY_HELPERS
//! unsigned long clean_record_shared_mapping_range(address_space *mapping,
...
//! 						pgoff_t *end);
//! 
//! unsigned long wp_shared_mapping_range(address_space *mapping,
//! 				      pgoff_t first_index, pgoff_t nr);
//! #endif
//! 
...
//! }
//! 
//! void vma_pgtable_walk_begin(vm_area_struct *vma);
//! void vma_pgtable_walk_end(vm_area_struct *vma);
//! 
...
//! }
//! 
//! int arch_get_shadow_stack_status(task_struct *t, unsigned long __user *status);
//! int arch_set_shadow_stack_status(task_struct *t, unsigned long status);
//! int arch_lock_shadow_stack_status(task_struct *t, unsigned long status);
//! 
//! /*
...
//! }
//! 
//! void snapshot_page(page_snapshot *ps, const struct page *page);
//! 
//! void map_anon_folio_pte_nopf(folio *folio, pte_t *pte,
