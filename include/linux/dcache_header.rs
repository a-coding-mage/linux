...
extern "C" {
    ...
    pub fn d_instantiate(_: *mut dentry, _: *mut inode); pub fn d_instantiate_new(_: *mut dentry, _: *mut inode); pub fn __d_drop(_: *mut dentry); pub fn d_drop(_: *mut dentry); pub fn d_delete(_: *mut dentry);
    pub fn d_alloc(_: *mut dentry, _: *const qstr) -> *mut dentry; pub fn d_alloc_anon(_: *mut super_block) -> *mut dentry; pub fn d_alloc_parallel(_: *mut dentry, _: *const qstr) -> *mut dentry; pub fn d_splice_alias(_: *mut inode, _: *mut dentry) -> *mut dentry; pub fn d_splice_alias_ops(_: *mut inode, _: *mut dentry, _: *const dentry_operations) -> *mut dentry; pub fn d_add_ci(_: *mut dentry, _: *mut inode, _: *mut qstr) -> *mut dentry;
    pub fn d_same_name(_: *const dentry, _: *const dentry, _: *const qstr) -> bool; pub fn d_find_any_alias(_: *mut inode) -> *mut dentry; pub fn d_obtain_alias(_: *mut inode) -> *mut dentry; pub fn d_obtain_root(_: *mut inode) -> *mut dentry; pub fn shrink_dcache_sb(_: *mut super_block); pub fn shrink_dcache_parent(_: *mut dentry); pub fn d_invalidate(_: *mut dentry);
    pub fn d_make_root(_: *mut inode) -> *mut dentry; pub fn d_mark_tmpfile(_: *mut file, _: *mut inode); pub fn d_mark_tmpfile_name(_: *mut file, _: *const qstr) -> c_int; pub fn d_tmpfile(_: *mut file, _: *mut inode);
    pub fn d_find_alias(_: *mut inode) -> *mut dentry; pub fn d_prune_aliases(_: *mut inode); pub fn __move_to_shrink_list(_: *mut dentry, _: *mut list_head) -> bool; pub fn shrink_dentry_list(_: *mut list_head); pub fn d_find_alias_rcu(_: *mut inode) -> *mut dentry; pub fn path_has_submounts(_: *const path) -> c_int; pub fn d_rehash(_: *mut dentry); pub fn d_add(_: *mut dentry, _: *mut inode); pub fn d_move(_: *mut dentry, _: *mut dentry); pub fn d_exchange(_: *mut dentry, _: *mut dentry); pub fn d_ancestor(_: *mut dentry, _: *mut dentry) -> *mut dentry; pub fn d_lookup(_: *const dentry, _: *const qstr) -> *mut dentry;
    pub fn d_parent_ino(_: *mut dentry) -> u64; pub fn dynamic_dname(_: *mut c_char, _: c_int, _: *const c_char, ...) -> *mut c_char; pub fn __d_path(_: *const path, _: *const path, _: *mut c_char, _: c_int) -> *mut c_char; pub fn d_absolute_path(_: *const path, _: *mut c_char, _: c_int) -> *mut c_char; pub fn d_path(_: *const path, _: *mut c_char, _: c_int) -> *mut c_char; pub fn dentry_path_raw(_: *const dentry, _: *mut c_char, _: c_int) -> *mut c_char; pub fn dentry_path(_: *const dentry, _: *mut c_char, _: c_int) -> *mut c_char;
    pub fn dget_parent(_: *mut dentry) -> *mut dentry; pub fn __d_lookup_unhash_wake(_: *mut dentry); pub fn dput(_: *mut dentry); pub fn vfs_pressure_ratio(_: c_ulong) -> c_ulong; pub fn take_dentry_name_snapshot(_: *mut name_snapshot, _: *mut dentry); pub fn release_dentry_name_snapshot(_: *mut name_snapshot); pub fn set_default_d_op(_: *mut super_block, _: *const dentry_operations); pub fn d_make_persistent(_: *mut dentry, _: *mut inode) -> *mut dentry; pub fn d_make_discardable(_: *mut dentry);
}
...
extern "C" { fn lockref_get(_: *mut lockref); }
