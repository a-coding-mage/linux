...
// Translated from the C header. The original includes target byte-order
// definitions from <asm/byteorder.h>.
...
// When CONFIG_HAVE_ARCH_LIBGCC_H is enabled, the original header includes
// target-specific declarations from <asm/libgcc.h>.
