...
extern "C" {
 pub fn mtd_ooblayout_ecc(_: *mut mtd_info, _:i32, _: *mut mtd_oob_region)->i32; pub fn mtd_ooblayout_find_eccregion(_: *mut mtd_info, _:i32, _: *mut i32, _: *mut mtd_oob_region)->i32; pub fn mtd_ooblayout_get_eccbytes(_: *mut mtd_info,_: *mut u8,_: *const u8,_: i32,_: i32)->i32; pub fn mtd_ooblayout_set_eccbytes(_: *mut mtd_info,_: *const u8,_: *mut u8,_: i32,_: i32)->i32; pub fn mtd_ooblayout_free(_: *mut mtd_info, _:i32, _: *mut mtd_oob_region)->i32; pub fn mtd_ooblayout_get_databytes(_: *mut mtd_info,_: *mut u8,_: *const u8,_: i32,_: i32)->i32; pub fn mtd_ooblayout_set_databytes(_: *mut mtd_info,_: *const u8,_: *mut u8,_: i32,_: i32)->i32; pub fn mtd_ooblayout_count_freebytes(_: *mut mtd_info)->i32; pub fn mtd_ooblayout_count_eccbytes(_: *mut mtd_info)->i32;
 pub fn mtd_wunit_to_pairing_info(_: *mut mtd_info,_: i32,_: *mut mtd_pairing_info)->i32; pub fn mtd_pairing_info_to_wunit(_: *mut mtd_info,_: *const mtd_pairing_info)->i32; pub fn mtd_pairing_groups(_: *mut mtd_info)->i32; pub fn mtd_erase(_: *mut mtd_info, _: *mut erase_info)->i32; pub fn mtd_point(_: *mut mtd_info,_: i64,_: usize,_: *mut usize,_: *mut *mut core::ffi::c_void,_: *mut ResourceSize)->i32; pub fn mtd_unpoint(_: *mut mtd_info,_: i64,_: usize)->i32; pub fn mtd_read(_: *mut mtd_info,_: i64,_: usize,_: *mut usize,_: *mut u8)->i32; pub fn mtd_write(_: *mut mtd_info,_: i64,_: usize,_: *mut usize,_: *const u8)->i32; pub fn mtd_panic_write(_: *mut mtd_info,_: i64,_: usize,_: *mut usize,_: *const u8)->i32; pub fn mtd_read_oob(_: *mut mtd_info,_: i64,_: *mut mtd_oob_ops)->i32; pub fn mtd_write_oob(_: *mut mtd_info,_: i64,_: *mut mtd_oob_ops)->i32;
 pub fn mtd_lock(_: *mut mtd_info,_: i64,_: u64)->i32; pub fn mtd_unlock(_: *mut mtd_info,_: i64,_: u64)->i32; pub fn mtd_is_locked(_: *mut mtd_info,_: i64,_: u64)->i32; pub fn mtd_block_isreserved(_: *mut mtd_info,_: i64)->i32; pub fn mtd_block_isbad(_: *mut mtd_info,_: i64)->i32; pub fn mtd_block_markbad(_: *mut mtd_info,_: i64)->i32; pub fn mtd_mmap_capabilities(_: *mut mtd_info)->u32; pub fn register_mtd_user(_: *mut mtd_notifier); pub fn unregister_mtd_user(_: *mut mtd_notifier)->i32; pub fn mtd_kmalloc_up_to(_: *const mtd_info,_: *mut usize)->*mut core::ffi::c_void;
 pub fn mtd_device_parse_register(_: *mut mtd_info,_: *const *const i8,_: *mut mtd_part_parser_data,_: *const mtd_partition,_: i32)->i32; pub fn mtd_device_unregister(_: *mut mtd_info)->i32; pub fn get_mtd_device(_: *mut mtd_info,_: i32)->*mut mtd_info; pub fn __get_mtd_device(_: *mut mtd_info)->i32; pub fn __put_mtd_device(_: *mut mtd_info); pub fn of_get_mtd_device_by_node(_: *mut device_node)->*mut mtd_info; pub fn get_mtd_device_nm(_: *const i8)->*mut mtd_info; pub fn put_mtd_device(_: *mut mtd_info);
}
