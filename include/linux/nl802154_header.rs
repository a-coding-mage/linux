...
// Dependency supplied by the surrounding netlink bindings: `nla_policy`.

pub const IEEE802154_NL_NAME: &str = "802.15.4 MAC";
pub const IEEE802154_MCAST_COORD_NAME: &str = "coordinator";
pub const IEEE802154_MCAST_BEACON_NAME: &str = "beacon";

#[repr(i32)]
#[derive(Copy, Clone, Debug, PartialEq, Eq)]
pub enum Ieee802154Attr {
    __IEEE802154_ATTR_INVALID = 0,
...
pub const IEEE802154_ATTR_MAX: i32 = Ieee802154Attr::__IEEE802154_ATTR_MAX as i32 - 1;

extern "C" {
    pub static ieee802154_policy: [nla_policy; 0];
}
...
pub enum Ieee802154Command {
    __IEEE802154_COMMAND_INVALID = 0,
...
pub const IEEE802154_CMD_MAX: i32 = Ieee802154Command::__IEEE802154_CMD_MAX as i32 - 1;

#[repr(i32)]
#[derive(Copy, Clone, Debug, PartialEq, Eq)]
pub enum Ieee802154Dev {
