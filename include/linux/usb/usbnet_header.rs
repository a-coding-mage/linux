...
extern "C" {
    pub fn usbnet_probe(_: *mut usb_interface, _: *const usb_device_id) -> core::ffi::c_int;
    pub fn usbnet_suspend(_: *mut usb_interface, _: pm_message_t) -> core::ffi::c_int;
    pub fn usbnet_resume(_: *mut usb_interface) -> core::ffi::c_int;
    pub fn usbnet_disconnect(_: *mut usb_interface);
    pub fn usbnet_device_suggests_idle(_: *mut usbnet);
    pub fn usbnet_read_cmd(_: *mut usbnet, _: u8, _: u8, _: u16, _: u16, _: *mut core::ffi::c_void, _: u16) -> core::ffi::c_int;
    pub fn usbnet_write_cmd(_: *mut usbnet, _: u8, _: u8, _: u16, _: u16, _: *const core::ffi::c_void, _: u16) -> core::ffi::c_int;
    pub fn usbnet_read_cmd_nopm(_: *mut usbnet, _: u8, _: u8, _: u16, _: u16, _: *mut core::ffi::c_void, _: u16) -> core::ffi::c_int;
    pub fn usbnet_write_cmd_nopm(_: *mut usbnet, _: u8, _: u8, _: u16, _: u16, _: *const core::ffi::c_void, _: u16) -> core::ffi::c_int;
    pub fn usbnet_write_cmd_async(_: *mut usbnet, _: u8, _: u8, _: u16, _: u16, _: *const core::ffi::c_void, _: u16) -> core::ffi::c_int;
    pub fn usbnet_cdc_update_filter(_: *mut usbnet);
    pub fn usbnet_generic_cdc_bind(_: *mut usbnet, _: *mut usb_interface) -> core::ffi::c_int;
    pub fn usbnet_ether_cdc_bind(_: *mut usbnet, _: *mut usb_interface) -> core::ffi::c_int;
    pub fn usbnet_cdc_bind(_: *mut usbnet, _: *mut usb_interface) -> core::ffi::c_int;
    pub fn usbnet_cdc_unbind(_: *mut usbnet, _: *mut usb_interface);
    pub fn usbnet_cdc_status(_: *mut usbnet, _: *mut urb);
    pub fn usbnet_cdc_zte_rx_fixup(_: *mut usbnet, _: *mut sk_buff) -> core::ffi::c_int;
    pub fn usbnet_open(_: *mut net_device) -> core::ffi::c_int;
    pub fn usbnet_stop(_: *mut net_device) -> core::ffi::c_int;
    pub fn usbnet_start_xmit(_: *mut sk_buff, _: *mut net_device) -> netdev_tx_t;
    pub fn usbnet_tx_timeout(_: *mut net_device, _: u32);
    pub fn usbnet_change_mtu(_: *mut net_device, _: core::ffi::c_int) -> core::ffi::c_int;
    pub fn usbnet_get_endpoints(_: *mut usbnet, _: *mut usb_interface) -> core::ffi::c_int;
    pub fn usbnet_get_ethernet_addr(_: *mut usbnet, _: core::ffi::c_int) -> core::ffi::c_int;
    pub fn usbnet_defer_kevent(_: *mut usbnet, _: core::ffi::c_int);
    ...
    pub fn usbnet_get_link_ksettings_mii(_: *mut net_device, _: *mut ethtool_link_ksettings) -> core::ffi::c_int;
    pub fn usbnet_set_link_ksettings_mii(_: *mut net_device, _: *const ethtool_link_ksettings) -> core::ffi::c_int;
    pub fn usbnet_get_link_ksettings_internal(_: *mut net_device, _: *mut ethtool_link_ksettings) -> core::ffi::c_int;
    ...
    pub fn usbnet_mii_ioctl(_: *mut net_device, _: *mut ifreq, _: core::ffi::c_int) -> core::ffi::c_int;
    pub fn usbnet_nway_reset(_: *mut net_device) -> core::ffi::c_int;
    pub fn usbnet_manage_power(_: *mut usbnet, _: core::ffi::c_int) -> core::ffi::c_int;
    pub fn usbnet_link_change(_: *mut usbnet, _: bool, _: bool);
    pub fn usbnet_status_start(_: *mut usbnet, _: gfp_t) -> core::ffi::c_int;
