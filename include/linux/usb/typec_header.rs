...
extern "C" {
    pub fn typec_partner_set_identity(_: *mut typec_partner) -> i32;
    pub fn typec_cable_set_identity(_: *mut typec_cable) -> i32;
    pub fn typec_partner_set_pd_revision(_: *mut typec_partner, _: u16);
    pub fn typec_partner_set_num_altmodes(_: *mut typec_partner, _: i32) -> i32;
    pub fn typec_partner_register_altmode(_: *mut typec_partner, _: *const typec_altmode_desc) -> *mut typec_altmode;
    ...
    pub fn typec_altmode_update_active(_: *mut typec_altmode, _: bool);
    pub fn typec_altmode_set_ops(_: *mut typec_altmode, _: *const typec_altmode_ops);
    pub fn typec_register_port(_: *mut device, _: *const typec_capability) -> *mut typec_port;
    pub fn typec_unregister_port(_: *mut typec_port);
    pub fn typec_register_partner(_: *mut typec_port, _: *mut typec_partner_desc) -> *mut typec_partner;
    pub fn typec_unregister_partner(_: *mut typec_partner);
    pub fn typec_register_cable(_: *mut typec_port, _: *mut typec_cable_desc) -> *mut typec_cable;
    pub fn typec_unregister_cable(_: *mut typec_cable);
    pub fn typec_cable_get(_: *mut typec_port) -> *mut typec_cable;
    pub fn typec_cable_put(_: *mut typec_cable);
    pub fn typec_cable_is_active(_: *mut typec_cable) -> i32;
    pub fn typec_cable_altmode_unsupported(_: *mut typec_altmode) -> bool;
    pub fn typec_register_plug(_: *mut typec_cable, _: *mut typec_plug_desc) -> *mut typec_plug;
    pub fn typec_unregister_plug(_: *mut typec_plug);
    pub fn typec_set_data_role(_: *mut typec_port, _: typec_data_role);
    pub fn typec_get_data_role(_: *mut typec_port) -> typec_data_role;
    pub fn typec_set_pwr_role(_: *mut typec_port, _: typec_role);
    pub fn typec_set_vconn_role(_: *mut typec_port, _: typec_role);
    pub fn typec_set_pwr_opmode(_: *mut typec_port, _: typec_pwr_opmode);
    ...
    pub fn typec_cable_set_svdm_version(_: *mut typec_cable, _: usb_pd_svdm_ver);
    pub fn typec_partner_usb_power_delivery_register(_: *mut typec_partner, _: *mut usb_power_delivery_desc) -> *mut usb_power_delivery;
    pub fn typec_port_set_usb_power_delivery(_: *mut typec_port, _: *mut usb_power_delivery) -> i32;
    pub fn typec_partner_set_usb_power_delivery(_: *mut typec_partner, _: *mut usb_power_delivery) -> i32;
    pub fn typec_partner_set_usb_mode(_: *mut typec_partner, _: usb_mode);
    pub fn typec_port_set_usb_mode(_: *mut typec_port, _: usb_mode);
}
