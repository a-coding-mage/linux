...
#[cfg(CONFIG_CGROUPS)]
#[repr(C)]
pub struct cgroup_base_stat { pub cputime: task_cputime, #[cfg(CONFIG_SCHED_CORE)] pub forceidle_sum: u64, pub ntime: u64 }
...
pub struct cgroup {
    ...
    #[cfg(CONFIG_BPF_SYSCALL)] pub bpf_cgrp_storage: *mut bpf_local_storage,
    #[cfg(CONFIG_EXT_SUB_SCHED)] pub scx_sched: *mut scx_sched,
...
pub struct sock_cgroup_data {
    ...
    #[cfg(CONFIG_CGROUP_NET_CLASSID)] pub classid: u32,
    #[cfg(CONFIG_CGROUP_NET_PRIO)] pub prioidx: u16,
}
#[cfg(not(CONFIG_SOCK_CGROUP_DATA))]
#[repr(C)]
pub struct sock_cgroup_data {}
...
#[cfg(all(CONFIG_SOCK_CGROUP_DATA, CONFIG_CGROUP_NET_CLASSID))]
pub unsafe fn sock_cgroup_classid(skcd: *const sock_cgroup_data) -> u32 {
    core::ptr::read_volatile(&(*skcd).classid)
}
#[cfg(all(CONFIG_SOCK_CGROUP_DATA, CONFIG_CGROUP_NET_PRIO))]
