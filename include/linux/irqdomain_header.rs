...
pub struct irq_domain {
    ...
    #[cfg(CONFIG_IRQ_DOMAIN_HIERARCHY)] pub parent: *mut irq_domain,
    #[cfg(CONFIG_GENERIC_MSI_IRQ)] pub msi_parent_ops: *const msi_parent_ops,
...
#[repr(C)] pub struct irq_domain_info {
    ...
    pub dev: *mut device, #[cfg(CONFIG_IRQ_DOMAIN_HIERARCHY)] pub parent: *mut irq_domain,
...
extern "C" {
    pub fn of_phandle_args_to_fwspec(_: *mut device_node, _: *const u32, _: u32, _: *mut irq_fwspec);
    pub fn irq_domain_instantiate(_: *const irq_domain_info) -> *mut irq_domain;
    pub fn devm_irq_domain_instantiate(_: *mut device, _: *const irq_domain_info) -> *mut irq_domain;
    pub fn __irq_domain_alloc_fwnode(_: u32, _: core::ffi::c_int, _: *const core::ffi::c_char, _: *mut phys_addr_t, _: *mut fwnode_handle) -> *mut fwnode_handle;
    pub fn irq_domain_free_fwnode(_: *mut fwnode_handle);
    pub fn irq_domain_remove(_: *mut irq_domain);
    pub fn irq_domain_associate(_: *mut irq_domain, _: u32, _: irq_hw_number_t) -> core::ffi::c_int;
    pub fn irq_domain_associate_many(_: *mut irq_domain, _: u32, _: irq_hw_number_t, _: core::ffi::c_int);
    pub fn irq_create_mapping_affinity(_: *mut irq_domain, _: irq_hw_number_t, _: *const irq_affinity_desc) -> u32;
    pub fn irq_create_fwspec_mapping(_: *mut irq_fwspec) -> u32;
    pub fn irq_dispose_mapping(_: u32);
    pub fn __irq_resolve_mapping(_: *mut irq_domain, _: irq_hw_number_t, _: *mut u32) -> *mut irq_desc;
    pub fn irq_domain_xlate_onecell(_: *mut irq_domain,_: *mut device_node,_: *const u32,_: u32,_: *mut irq_hw_number_t,_: *mut u32)->core::ffi::c_int;
    pub fn irq_domain_xlate_twocell(_: *mut irq_domain,_: *mut device_node,_: *const u32,_: u32,_: *mut irq_hw_number_t,_: *mut u32)->core::ffi::c_int;
    pub fn irq_domain_xlate_onetwocell(_: *mut irq_domain,_: *mut device_node,_: *const u32,_: u32,_: *mut irq_hw_number_t,_: *mut u32)->core::ffi::c_int;
    pub fn irq_domain_xlate_twothreecell(_: *mut irq_domain,_: *mut device_node,_: *const u32,_: u32,_: *mut irq_hw_number_t,_: *mut u32)->core::ffi::c_int;
    pub fn irq_domain_translate_onecell(_: *mut irq_domain,_: *mut irq_fwspec,_: *mut usize,_: *mut u32)->core::ffi::c_int;
    pub fn irq_domain_translate_twocell(_: *mut irq_domain,_: *mut irq_fwspec,_: *mut usize,_: *mut u32)->core::ffi::c_int;
    pub fn irq_domain_translate_twothreecell(_: *mut irq_domain,_: *mut irq_fwspec,_: *mut usize,_: *mut u32)->core::ffi::c_int;
}
