...
// Dependency intent: symbols supplied by <asm/processor.h> remain external
...
#[macro_export]
macro_rules! spin_begin {
    () => {};
}

#[macro_export]
macro_rules! spin_cpu_relax {
    () => {
        cpu_relax()
    };
}
