...
extern "C" { pub fn disk_report_zone(_: *mut gendisk,_: *mut blk_zone,_: u32,_: *mut blk_report_zones_args)->i32; pub fn blkdev_get_zone_info(_: *mut block_device,_: sector_t,_: *mut blk_zone)->i32; pub fn blkdev_report_zones(_: *mut block_device,_: sector_t,_: u32,_: Option<unsafe extern "C" fn(*mut blk_zone,u32,*mut core::ffi::c_void)->i32>,*mut core::ffi::c_void)->i32; pub fn blkdev_zone_mgmt(_: *mut block_device,_: req_op,_: sector_t,_: sector_t)->i32; pub fn put_disk(_: *mut gendisk); pub fn set_capacity(_: *mut gendisk,_: sector_t); pub fn submit_bio_noacct(_: *mut bio); pub fn blk_status_to_errno(_: blk_status_t)->i32; pub fn errno_to_blk_status(_: i32)->blk_status_t; }
