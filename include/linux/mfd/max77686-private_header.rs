...
pub const MAX77686_REG_INVALID: u8 = 0xff;

/* MAX77686 PMIC registers */
#[repr(i32)]
pub enum max77686_pmic_reg {
...
pub const MAX77686_INT1_PWRONF_MSK: u8 = 1u8 << 0;
pub const MAX77686_INT1_PWRONR_MSK: u8 = 1u8 << 1;
pub const MAX77686_INT1_JIGONBF_MSK: u8 = 1u8 << 2;
pub const MAX77686_INT1_JIGONBR_MSK: u8 = 1u8 << 3;
pub const MAX77686_INT1_ACOKBF_MSK: u8 = 1u8 << 4;
pub const MAX77686_INT1_ACOKBR_MSK: u8 = 1u8 << 5;
pub const MAX77686_INT1_ONKEY1S_MSK: u8 = 1u8 << 6;
pub const MAX77686_INT1_MRSTB_MSK: u8 = 1u8 << 7;

pub const MAX77686_INT2_140C_MSK: u8 = 1u8 << 0;
pub const MAX77686_INT2_120C_MSK: u8 = 1u8 << 1;

pub const MAX77686_RTCINT_RTC60S_MSK: u8 = 1u8 << 0;
pub const MAX77686_RTCINT_RTCA1_MSK: u8 = 1u8 << 1;
pub const MAX77686_RTCINT_RTCA2_MSK: u8 = 1u8 << 2;
pub const MAX77686_RTCINT_SMPL_MSK: u8 = 1u8 << 3;
pub const MAX77686_RTCINT_RTC1S_MSK: u8 = 1u8 << 4;
pub const MAX77686_RTCINT_WTSR_MSK: u8 = 1u8 << 5;

#[repr(C)]
pub struct max77686_dev {
	pub dev: *mut device,
