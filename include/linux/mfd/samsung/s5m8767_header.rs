...
pub const S5M8767_ENCTRL_SHIFT: i32 = 6;
pub const S5M8767_ENCTRL_MASK: i32 = 0x3 << S5M8767_ENCTRL_SHIFT;

/*
 * LDO_EN/BUCK_EN register value for controlling this Buck or LDO
 * by GPIO (PWREN, BUCKEN).
 */
pub const S5M8767_ENCTRL_USE_GPIO: i32 = 0x1;
 ...
 */
#[repr(i32)]
pub enum s5m8767_dvs_buck_ramp_values {
...
pub const S5M8767_DVS_BUCK_RAMP_SHIFT: i32 = 4;
pub const S5M8767_DVS_BUCK_RAMP_MASK: i32 = 0xf << S5M8767_DVS_BUCK_RAMP_SHIFT;
