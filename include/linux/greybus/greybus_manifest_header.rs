...
// Dependencies supplied by the surrounding translation environment:
// linux/bits.h and linux/types.h
...
pub const GREYBUS_INTERFACE_FEATURE_TIMESYNC: u32 = 1u32 << 0;
...
pub struct greybus_descriptor_interface {
    pub vendor_stringid: u8,
    pub product_stringid: u8,
    pub features: u8,
    pub pad: u8,
}
...
pub struct greybus_descriptor_bundle {
    pub id: u8, /* interface-relative id (0..) */
    pub class: u8,
    pub pad: [u8; 2],
}
...
pub struct greybus_descriptor_cport {
    pub id: u16,
    pub bundle: u8,
    pub protocol_id: u8, /* enum greybus_protocol */
}

#[repr(C, packed)]
pub struct greybus_descriptor_header {
    pub size: u16,
    pub type_: u8, /* enum greybus_descriptor_type */
    pub pad: u8,
}

#[repr(C, packed)]
pub union greybus_descriptor_payload {
...
pub struct greybus_descriptor {
    ...
    pub payload: greybus_descriptor_payload,
}
...
pub struct greybus_manifest {
    ...
    pub descriptors: [greybus_descriptor; 0],
}
