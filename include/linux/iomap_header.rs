...
extern "C" {
 pub fn iomap_file_buffered_write(_: *mut kiocb,_: *mut iov_iter,_: *const iomap_ops,_: *const iomap_write_ops,_: *mut c_void)->ssize_t; pub fn iomap_fsverity_write(_: *mut file,_: loff_t,_: usize,_: *const c_void,_: *const iomap_ops,_: *const iomap_write_ops)->i32; pub fn iomap_read_folio(_: *const iomap_ops,_: *mut iomap_read_folio_ctx,_: *mut c_void); pub fn iomap_readahead(_: *const iomap_ops,_: *mut iomap_read_folio_ctx,_: *mut c_void); pub fn iomap_is_partially_uptodate(_: *mut folio,_: usize,_: usize)->bool; pub fn iomap_get_folio(_: *mut iomap_iter,_: loff_t,_: usize)->*mut folio; pub fn iomap_release_folio(_: *mut folio,_: gfp_t)->bool; pub fn iomap_invalidate_folio(_: *mut folio,_: usize,_: usize); pub fn iomap_dirty_folio(_: *mut address_space,_: *mut folio)->bool; pub fn iomap_folio_mark_uptodate(_: *mut folio); pub fn iomap_file_unshare(_: *mut inode,_: loff_t,_: loff_t,_: *const iomap_ops,_: *const iomap_write_ops)->i32; pub fn iomap_fill_dirty_folios(_: *mut iomap_iter,_: *mut loff_t,_: loff_t,_: *mut u32)->u32; pub fn iomap_zero_range(_: *mut inode,_: loff_t,_: loff_t,_: *mut bool,_: *const iomap_ops,_: *const iomap_write_ops,_: *mut c_void)->i32; pub fn iomap_truncate_page(_: *mut inode,_: loff_t,_: *mut bool,_: *const iomap_ops,_: *const iomap_write_ops,_: *mut c_void)->i32; pub fn iomap_page_mkwrite(_: *mut vm_fault,_: *const iomap_ops,_: *mut c_void)->vm_fault_t;
 pub fn iomap_fiemap(_: *mut inode,_: *mut fiemap_extent_info,_: u64,_: u64,_: *const iomap_ops)->i32; pub fn iomap_seek_hole(_: *mut inode,_: loff_t,_: *const iomap_ops)->loff_t; pub fn iomap_seek_data(_: *mut inode,_: loff_t,_: *const iomap_ops)->loff_t; pub fn iomap_bmap(_: *mut address_space,_: sector_t,_: *const iomap_ops)->sector_t;
}
...
extern "C" { pub fn iomap_init_ioend(_: *mut inode,_: *mut bio,_: loff_t,_: u16)->*mut iomap_ioend; pub fn iomap_split_ioend(_: *mut iomap_ioend,_: u32,_: bool)->*mut iomap_ioend; pub fn iomap_finish_ioends(_: *mut iomap_ioend,_: i32); pub fn iomap_ioend_try_merge(_: *mut iomap_ioend,_: *mut list_head); pub fn iomap_sort_ioends(_: *mut list_head); pub fn iomap_add_to_ioend(_: *mut iomap_writepage_ctx,_: *mut folio,_: loff_t,_: loff_t,_: u32)->ssize_t; pub fn iomap_ioend_writeback_submit(_: *mut iomap_writepage_ctx,_: i32)->i32; pub fn iomap_finish_folio_read(_: *mut folio,_: usize,_: usize,_: i32); pub fn iomap_finish_folio_write(_: *mut inode,_: *mut folio,_: usize); pub fn iomap_writeback_folio(_: *mut iomap_writepage_ctx,_: *mut folio)->i32; pub fn iomap_writepages(_: *mut iomap_writepage_ctx)->i32; }
...
extern "C" { pub fn iomap_dio_rw(_: *mut kiocb,_: *mut iov_iter,_: *const iomap_ops,_: *const iomap_dio_ops,_: u32,_: *mut c_void,_: usize)->ssize_t; pub fn __iomap_dio_rw(_: *mut kiocb,_: *mut iov_iter,_: *const iomap_ops,_: *const iomap_dio_ops,_: u32,_: *mut c_void,_: usize)->*mut iomap_dio; pub fn iomap_dio_complete(_: *mut iomap_dio)->ssize_t; pub fn iomap_dio_bio_end_io(_: *mut bio); pub fn __iomap_dio_read_simple(_: *mut kiocb,_: *mut iov_iter,_: *mut iomap_iter)->ssize_t; }

pub type iomap_punch_t = unsafe extern "C" fn(*mut inode,loff_t,loff_t,*mut iomap);
extern "C" { pub fn iomap_write_delalloc_release(_: *mut inode,_: loff_t,_: loff_t,_: u32,_: *mut iomap,_: Option<iomap_punch_t>); }
