...
// linux/auxiliary_bus.h, linux/dma-mapping.h, linux/types.h, and
// linux/firmware/qcom/qcom_scm.h.
...
unsafe extern "C" {
    pub fn qcom_scm_qseecom_app_send(
        app_id: u32,
 ...
 */
#[inline]
pub unsafe fn qcom_qseecom_app_send(
    client: *mut qseecom_client,
    req: *mut core::ffi::c_void,
    req_size: usize,
    rsp: *mut core::ffi::c_void,
    rsp_size: usize,
) -> core::ffi::c_int {
    qcom_scm_qseecom_app_send((*client).app_id, req, req_size, rsp, rsp_size)
}
