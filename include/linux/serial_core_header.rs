...
extern "C" { pub fn uart_write_wakeup(_: *mut uart_port); pub fn uart_update_timeout(_: *mut uart_port,_: c_uint,_: c_uint); pub fn uart_get_baud_rate(_: *mut uart_port,_: *mut ktermios,_: *const ktermios,_: c_uint,_: c_uint)->c_uint; pub fn uart_get_divisor(_: *mut uart_port,_: c_uint)->c_uint; pub fn uart_register_driver(_: *mut uart_driver)->c_int; pub fn uart_unregister_driver(_: *mut uart_driver); pub fn uart_add_one_port(_: *mut uart_driver,_: *mut uart_port)->c_int; pub fn uart_remove_one_port(_: *mut uart_driver,_: *mut uart_port); pub fn uart_suspend_port(_: *mut uart_driver,_: *mut uart_port)->c_int; pub fn uart_resume_port(_: *mut uart_driver,_: *mut uart_port)->c_int; }
