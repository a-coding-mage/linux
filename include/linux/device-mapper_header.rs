...
#[cfg(CONFIG_BLK_DEV_ZONED)] pub type dm_report_zones_fn=unsafe extern "C" fn(*mut dm_target,*mut dm_report_zones_args,u32)->c_int;
#[cfg(not(CONFIG_BLK_DEV_ZONED))] pub type dm_report_zones_fn=unsafe extern "C" fn(*mut dm_target)->c_int;
...
#[cfg(CONFIG_BLK_DEV_ZONED)] #[repr(C)] pub struct dm_report_zones_args_full { pub tgt:*mut dm_target,pub disk:*mut gendisk,pub next_sector:sector_t,pub zone_idx:u32,pub rep_args:*mut blk_report_zones_args,pub cb:report_zones_cb,pub data:*mut c_void,pub start:sector_t }
...
extern "C" {
 ...
 #[cfg(CONFIG_BLK_DEV_ZONED)] pub fn dm_report_zones(bdev:*mut block_device,start:sector_t,sector:sector_t,args:*mut dm_report_zones_args,nr_zones:u32)->c_int;
}
