...
extern "C" { pub fn fb_set_var(_: *mut fb_info,_: *mut fb_var_screeninfo)->i32; pub fn fb_pan_display(_: *mut fb_info,_: *mut fb_var_screeninfo)->i32; pub fn fb_blank(_: *mut fb_info,_: i32)->i32; pub fn register_framebuffer(_: *mut fb_info)->i32; pub fn unregister_framebuffer(_: *mut fb_info); pub fn framebuffer_alloc(_: usize,_: *mut device)->*mut fb_info; pub fn framebuffer_release(_: *mut fb_info); }
extern "C" {
 pub fn fb_set_var_from_user(_: *mut fb_info,_: *mut fb_var_screeninfo)->i32;
 pub fn cfb_fillrect(_: *mut fb_info,_: *const fb_fillrect); pub fn cfb_copyarea(_: *mut fb_info,_: *const fb_copyarea); pub fn cfb_imageblit(_: *mut fb_info,_: *const fb_image);
 pub fn fb_io_read(_: *mut fb_info,_: *mut i8,_: usize,_: *mut loff_t)->isize; pub fn fb_io_write(_: *mut fb_info,_: *const i8,_: usize,_: *mut loff_t)->isize; pub fn fb_io_mmap(_: *mut fb_info,_: *mut vm_area_struct)->i32;
 pub fn sys_fillrect(_: *mut fb_info,_: *const fb_fillrect); pub fn sys_copyarea(_: *mut fb_info,_: *const fb_copyarea); pub fn sys_imageblit(_: *mut fb_info,_: *const fb_image);
 pub fn fb_sys_read(_: *mut fb_info,_: *mut i8,_: usize,_: *mut loff_t)->isize; pub fn fb_sys_write(_: *mut fb_info,_: *const i8,_: usize,_: *mut loff_t)->isize;
 pub fn devm_register_framebuffer(_: *mut device,_: *mut fb_info)->i32; pub fn fb_get_buffer_offset(_: *mut fb_info,_: *mut fb_pixmap,_: u32)->*mut i8;
 pub fn fb_pad_unaligned_buffer(_: *mut u8,_: u32,_: *const u8,_: u32,_: u32,_: u32,_: u32,_: u32); pub fn fb_pad_aligned_buffer(_: *mut u8,_: u32,_: *const u8,_: u32,_: u32);
 pub fn fb_set_suspend(_: *mut fb_info,_: i32); pub fn fb_switch_outputs(_: *mut fb_info); pub fn fb_get_color_depth(_: *mut fb_var_screeninfo,_: *mut fb_fix_screeninfo)->i32; pub fn fb_get_options(_: *const i8,_: *mut *mut i8)->i32; pub fn fb_new_modelist(_: *mut fb_info)->i32;
 pub fn fb_deferred_io_mmap(_: *mut fb_info,_: *mut vm_area_struct)->i32; pub fn fb_deferred_io_init(_: *mut fb_info)->i32; pub fn fb_deferred_io_open(_: *mut fb_info,_: *mut inode,_: *mut file); pub fn fb_deferred_io_release(_: *mut fb_info); pub fn fb_deferred_io_cleanup(_: *mut fb_info); pub fn fb_deferred_io_fsync(_: *mut file,_: loff_t,_: loff_t,_: i32)->i32;
 pub fn fbmon_dpms(_: *const fb_info)->i32; pub fn fb_get_mode(_: i32,_: u32,_: *mut fb_var_screeninfo,_: *mut fb_info)->i32; pub fn fb_validate_mode(_: *const fb_var_screeninfo,_: *mut fb_info)->i32; pub fn fb_parse_edid(_: *mut u8,_: *mut fb_var_screeninfo)->i32; pub fn fb_firmware_edid(_: *mut device)->*const u8; pub fn fb_edid_to_monspecs(_: *mut u8,_: *mut fb_monspecs); pub fn fb_destroy_modedb(_: *mut fb_videomode); pub fn fb_find_mode_cvt(_: *mut fb_videomode,_: i32,_: i32)->i32; pub fn fb_ddc_read(_: *mut i2c_adapter)->*mut u8;
 pub fn fb_alloc_cmap(_: *mut fb_cmap,_: i32,_: i32)->i32; pub fn fb_alloc_cmap_gfp(_: *mut fb_cmap,_: i32,_: i32,_: gfp_t)->i32; pub fn fb_dealloc_cmap(_: *mut fb_cmap); pub fn fb_copy_cmap(_: *const fb_cmap,_: *mut fb_cmap)->i32; pub fn fb_cmap_to_user(_: *const fb_cmap,_: *mut fb_cmap_user)->i32; pub fn fb_set_cmap(_: *mut fb_cmap,_: *mut fb_info)->i32; pub fn fb_set_user_cmap(_: *mut fb_cmap_user,_: *mut fb_info)->i32; pub fn fb_default_cmap(_: i32)->*const fb_cmap; pub fn fb_invert_cmaps();
 pub fn fb_find_mode(_: *mut fb_var_screeninfo,_: *mut fb_info,_: *const i8,_: *const fb_videomode,_: *const fb_videomode,_: u32,_: u32)->i32; pub fn fb_modesetting_disabled(_: *const i8)->bool;
}
