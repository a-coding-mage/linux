...
extern "C" { pub fn iio_enum_available_read(_: *mut iio_dev, _: uintptr_t,_: *const iio_chan_spec,_: *mut c_char)->ssize_t; pub fn iio_enum_read(_: *mut iio_dev, _: uintptr_t,_: *const iio_chan_spec,_: *mut c_char)->ssize_t; pub fn iio_enum_write(_: *mut iio_dev, _: uintptr_t,_: *const iio_chan_spec,_: *const c_char,_: size_t)->ssize_t; pub fn iio_show_mount_matrix(_: *mut iio_dev,_: uintptr_t,_: *const iio_chan_spec,_: *mut c_char)->ssize_t; pub fn iio_read_mount_matrix(_: *mut device,_: *mut iio_mount_matrix)->i32; pub fn iio_get_time_ns(_: *const iio_dev)->s64; pub fn iio_device_id(_: *mut iio_dev)->i32; pub fn iio_device_get_current_mode(_: *mut iio_dev)->i32; pub fn iio_buffer_enabled(_: *mut iio_dev)->bool; pub fn iio_device_alloc(_: *mut device,_: i32)->*mut iio_dev; pub fn iio_device_free(_: *mut iio_dev); pub fn iio_device_suspend_triggering(_: *mut iio_dev)->i32; pub fn iio_device_resume_triggering(_: *mut iio_dev)->i32; pub fn iio_format_value(_: *mut c_char,_: u32,_: i32,_: *mut i32)->ssize_t; pub fn iio_str_to_fixpoint(_: *const c_char,_: i32,_: *mut i32,_: *mut i32)->i32 }
