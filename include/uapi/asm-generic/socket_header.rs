...
// Translated from asm-generic/socket.h.
// C dependencies: linux/posix_types.h and asm/sockios.h.
...
// SO_PASSCRED and SO_PEERCRED are omitted on powerpc when supplied there.
...
pub const SCM_INQ: i32 = SO_INQ;
pub const SO_RIGHTS_NOTRUNC: i32 = 85;

/* Non-kernel timestamp/timeval selection.  The C fallback depends on time_t
 * and __kernel_long_t sizes; those external types are intentionally not
 * redefined here. */
