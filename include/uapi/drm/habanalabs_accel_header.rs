...
pub const HABANALABS_H_: u64 = #include <drm/drm.h>;
/*
 * Defines that are asic-specific but constitutes as ABI between kernel driver
 * and userspace
 */
pub const GOYA_KMD_SRAM_RESERVED_SIZE_FROM_START: u64 = 0x8000	/* 32KB */;
pub const GAUDI_DRIVER_SRAM_RESERVED_SIZE_FROM_START: u64 = 0x80	/* 128 bytes */;
/*
 * 128 SOBs reserved for collective wait
 * 16 SOBs reserved for sync stream
 */
pub const GAUDI_FIRST_AVAILABLE_W_S_SYNC_OBJECT: u64 = 144;
/*
 * 64 monitors reserved for collective wait
 * 8 monitors reserved for sync stream
 */
pub const GAUDI_FIRST_AVAILABLE_W_S_MONITOR: u64 = 72;
/* Max number of elements in timestamps registration buffers */
pub const TS_MAX_ELEMENTS_NUM: u64 = (1 << 20) /* 1MB */;
/*
 ...
 * Engine Numbering
 *
 * Used in the "busy_engines_mask" field in `hl_info_hw_idle'
 */
#[repr(C)]
#[derive(Copy, Clone, Debug, Eq, PartialEq)]
pub enum goya_engine_id {
 ...
 * The enums need to be used as an index in hl_pll_frequency_info.
 */
#[repr(C)]
#[derive(Copy, Clone, Debug, Eq, PartialEq)]
pub enum hl_goya_pll_index {
    HL_GOYA_CPU_PLL = 0,
	HL_GOYA_IC_PLL,
	HL_GOYA_MC_PLL,
	HL_GOYA_MME_PLL,
...
#[repr(C)]
#[derive(Copy, Clone, Debug, Eq, PartialEq)]
pub enum hl_goya_dma_direction {
	HL_DMA_HOST_TO_DRAM,
	HL_DMA_HOST_TO_SRAM,
	HL_DMA_DRAM_TO_SRAM,
	HL_DMA_SRAM_TO_DRAM,
 ...
 *                                        HW reset
 */
pub const HL_NOTIFIER_EVENT_TPC_ASSERT: u64 = (1u64 << 0u64);
pub const HL_NOTIFIER_EVENT_UNDEFINED_OPCODE: u64 = (1u64 << 1u64);
pub const HL_NOTIFIER_EVENT_DEVICE_RESET: u64 = (1u64 << 2u64);
pub const HL_NOTIFIER_EVENT_CS_TIMEOUT: u64 = (1u64 << 3u64);
pub const HL_NOTIFIER_EVENT_DEVICE_UNAVAILABLE: u64 = (1u64 << 4u64);
pub const HL_NOTIFIER_EVENT_USER_ENGINE_ERR: u64 = (1u64 << 5u64);
pub const HL_NOTIFIER_EVENT_GENERAL_HW_ERR: u64 = (1u64 << 6u64);
pub const HL_NOTIFIER_EVENT_RAZWI: u64 = (1u64 << 7u64);
pub const HL_NOTIFIER_EVENT_PAGE_FAULT: u64 = (1u64 << 8u64);
pub const HL_NOTIFIER_EVENT_CRITICL_HW_ERR: u64 = (1u64 << 9u64);
pub const HL_NOTIFIER_EVENT_CRITICL_FW_ERR: u64 = (1u64 << 10u64);
 ...
 */
pub const HL_INFO_HW_IP_INFO: u64 = 0;
pub const HL_INFO_HW_EVENTS: u64 = 1;
pub const HL_INFO_DRAM_USAGE: u64 = 2;
pub const HL_INFO_HW_IDLE: u64 = 3;
pub const HL_INFO_DEVICE_STATUS: u64 = 4;
pub const HL_INFO_DEVICE_UTILIZATION: u64 = 6;
pub const HL_INFO_HW_EVENTS_AGGREGATE: u64 = 7;
pub const HL_INFO_CLK_RATE: u64 = 8;
pub const HL_INFO_RESET_COUNT: u64 = 9;
pub const HL_INFO_TIME_SYNC: u64 = 10;
pub const HL_INFO_CS_COUNTERS: u64 = 11;
pub const HL_INFO_PCI_COUNTERS: u64 = 12;
pub const HL_INFO_CLK_THROTTLE_REASON: u64 = 13;
pub const HL_INFO_SYNC_MANAGER: u64 = 14;
pub const HL_INFO_TOTAL_ENERGY: u64 = 15;
pub const HL_INFO_PLL_FREQUENCY: u64 = 16;
pub const HL_INFO_POWER: u64 = 17;
pub const HL_INFO_OPEN_STATS: u64 = 18;
pub const HL_INFO_DRAM_REPLACED_ROWS: u64 = 21;
pub const HL_INFO_DRAM_PENDING_ROWS: u64 = 22;
pub const HL_INFO_LAST_ERR_OPEN_DEV_TIME: u64 = 23;
pub const HL_INFO_CS_TIMEOUT_EVENT: u64 = 24;
pub const HL_INFO_RAZWI_EVENT: u64 = 25;
pub const HL_INFO_DEV_MEM_ALLOC_PAGE_SIZES: u64 = 26;
pub const HL_INFO_SECURED_ATTESTATION: u64 = 27;
pub const HL_INFO_REGISTER_EVENTFD: u64 = 28;
pub const HL_INFO_UNREGISTER_EVENTFD: u64 = 29;
pub const HL_INFO_GET_EVENTS: u64 = 30;
pub const HL_INFO_UNDEFINED_OPCODE_EVENT: u64 = 31;
pub const HL_INFO_ENGINE_STATUS: u64 = 32;
pub const HL_INFO_PAGE_FAULT_EVENT: u64 = 33;
pub const HL_INFO_USER_MAPPINGS: u64 = 34;
pub const HL_INFO_FW_GENERIC_REQ: u64 = 35;
pub const HL_INFO_HW_ERR_EVENT: u64 = 36;
pub const HL_INFO_FW_ERR_EVENT: u64 = 37;
pub const HL_INFO_USER_ENGINE_ERR_EVENT: u64 = 38;
pub const HL_INFO_DEV_SIGNED: u64 = 40;
pub const HL_INFO_VERSION_MAX_LEN: u64 = 128;
pub const HL_INFO_CARD_NAME_MAX_LEN: u64 = 16;
/* Maximum buffer size for retrieving engines status */
pub const HL_ENGINES_DATA_MAX_SIZE: u64 = 1048576;
/**
 * hl_info_hw_ip_info - hardware information on various IPs in the ASIC
...
pub hl_info_hw_ip_info {
	...
	u16 first_available_interrupt_id;
	u16 server_type;
	u32 cpld_version;
	u32 psoc_pci_pll_nr;
	u32 psoc_pci_pll_nf;
	...
	u8 cpucp_version[HL_INFO_VERSION_MAX_LEN];
	u8 card_name[HL_INFO_CARD_NAME_MAX_LEN];
	u64 tpc_enabled_mask_ext;
	u64 dram_page_size;
	u32 edma_enabled_mask;
	u16 number_of_user_interrupts;
	u8 reserved1;
	u8 reserved2;
	u64 reserved3;
	u64 device_mem_alloc_default_page_size;
	u64 reserved4;
	u64 reserved5;
	u32 reserved6;
	u8 reserved7;
	...
	u64 reserved_dram_size;
};
#[repr(C)]
pub hl_info_dram_usage {
	u64 dram_free_mem;
	u64 ctx_dram_mem;
};
pub const HL_BUSY_ENGINES_MASK_EXT_SIZE: u64 = 4;
#[repr(C)]
pub hl_info_hw_idle {
	u32 is_idle;
	/*
	 ...
	 */
	u32 busy_engines_mask;
	/*
	 * Extended Bitmask of busy engines.
	 * Bits definition is according to `enum <chip>_engine_id'.
	 */
	u64 busy_engines_mask_ext[HL_BUSY_ENGINES_MASK_EXT_SIZE];
};
#[repr(C)]
pub hl_info_device_status {
	u32 status;
	u32 pad;
};
#[repr(C)]
pub hl_info_device_utilization {
	u32 utilization;
	u32 pad;
};
#[repr(C)]
pub hl_info_clk_rate {
	u32 cur_clk_rate_mhz;
	u32 max_clk_rate_mhz;
};
#[repr(C)]
pub hl_info_reset_count {
	u32 hard_reset_cnt;
	u32 soft_reset_cnt;
};
#[repr(C)]
pub hl_info_time_sync {
	u64 device_time;
	u64 host_time;
	u64 tsc_time;
};
/**
 * hl_info_pci_counters - pci counters
 * @rx_throughput: PCI rx throughput KBps
 * @tx_throughput: PCI tx throughput KBps
 * @replay_cnt: PCI replay counter
 */
#[repr(C)]
pub hl_info_pci_counters {
	u64 rx_throughput;
	u64 tx_throughput;
	u64 replay_cnt;
};
#[repr(C)]
#[derive(Copy, Clone, Debug, Eq, PartialEq)]
pub enum hl_clk_throttling_type {
	HL_CLK_THROTTLE_TYPE_POWER,
	HL_CLK_THROTTLE_TYPE_THERMAL,
	HL_CLK_THROTTLE_TYPE_MAX
};
/* clk_throttling_reason masks */
pub const HL_CLK_THROTTLE_POWER: u64 = (1 << HL_CLK_THROTTLE_TYPE_POWER);
pub const HL_CLK_THROTTLE_THERMAL: u64 = (1 << HL_CLK_THROTTLE_TYPE_THERMAL);
/**
 * hl_info_clk_throttle - clock throttling reason
 ...
 */
#[repr(C)]
pub hl_info_clk_throttle {
	u32 clk_throttling_reason;
	u32 pad;
	u64 clk_throttling_timestamp_us[HL_CLK_THROTTLE_TYPE_MAX];
	u64 clk_throttling_duration_ns[HL_CLK_THROTTLE_TYPE_MAX];
};
/**
 * hl_info_energy - device energy information
 * @total_energy_consumption: total device energy consumption
 */
#[repr(C)]
pub hl_info_energy {
	u64 total_energy_consumption;
};
pub const HL_PLL_NUM_OUTPUTS: u64 = 4;
#[repr(C)]
pub hl_pll_frequency_info {
	u16 output[HL_PLL_NUM_OUTPUTS];
};
/**
 * hl_open_stats_info - device open statistics information
 ...
 */
#[repr(C)]
pub hl_open_stats_info {
	u64 open_counter;
	u64 last_open_period_ms;
	u8 is_compute_ctx_active;
	u8 compute_ctx_in_release;
	u8 pad[6];
};
/**
 * hl_power_info - power information
...
/**
 * hl_info_sync_manager - sync manager information
 * @first_available_sync_object: first available sob
 * @first_available_monitor: first available monitor
 * @first_available_cq: first available cq
 */
#[repr(C)]
pub hl_info_sync_manager {
	u32 first_available_sync_object;
	u32 first_available_monitor;
	u32 first_available_cq;
	u32 reserved;
};
/**
 * hl_info_cs_counters - command submission counters
 ...
 */
#[repr(C)]
pub hl_info_cs_counters {
	u64 total_out_of_mem_drop_cnt;
	u64 ctx_out_of_mem_drop_cnt;
	u64 total_parsing_drop_cnt;
	u64 ctx_parsing_drop_cnt;
	u64 total_queue_full_drop_cnt;
	u64 ctx_queue_full_drop_cnt;
	u64 total_device_in_reset_drop_cnt;
	u64 ctx_device_in_reset_drop_cnt;
	u64 total_max_cs_in_flight_drop_cnt;
	u64 ctx_max_cs_in_flight_drop_cnt;
	u64 total_validation_drop_cnt;
	u64 ctx_validation_drop_cnt;
};
/**
 * hl_info_last_err_open_dev_time - last error boot information.
 * @timestamp: timestamp of last time the device was opened and error occurred.
 */
#[repr(C)]
pub hl_info_last_err_open_dev_time {
	i64 timestamp;
};
/**
 * hl_info_cs_timeout_event - last CS timeout information.
 * @timestamp: timestamp when last CS timeout event occurred.
 * @seq: sequence number of last CS timeout event.
 */
#[repr(C)]
pub hl_info_cs_timeout_event {
	i64 timestamp;
	u64 seq;
};
pub const HL_RAZWI_NA_ENG_ID: u64 = u16::MAX;
pub const HL_RAZWI_MAX_NUM_OF_ENGINES_PER_RTR: u64 = 128;
pub const HL_RAZWI_READ: u64 = (1u64 << 0);
pub const HL_RAZWI_WRITE: u64 = (1u64 << 1);
pub const HL_RAZWI_LBW: u64 = (1u64 << 2);
pub const HL_RAZWI_HBW: u64 = (1u64 << 3);
pub const HL_RAZWI_RR: u64 = (1u64 << 4);
pub const HL_RAZWI_ADDR_DEC: u64 = (1u64 << 5);
/**
 * hl_info_razwi_event - razwi information.
 ...
 */
#[repr(C)]
pub hl_info_razwi_event {
	i64 timestamp;
	u64 addr;
	u16 engine_id[HL_RAZWI_MAX_NUM_OF_ENGINES_PER_RTR];
	u16 num_of_possible_engines;
	u8 flags;
	u8 pad[5];
};
pub const MAX_QMAN_STREAMS_INFO: u64 = 4;
pub const OPCODE_INFO_MAX_ADDR_SIZE: u64 = 8;
/**
 * hl_info_undefined_opcode_event - info about last undefined opcode error
 ...
 */
#[repr(C)]
pub hl_info_undefined_opcode_event {
	i64 timestamp;
...
/**
 * hl_info_hw_err_event - info about HW error
 ...
 */
#[repr(C)]
pub hl_info_hw_err_event {
	i64 timestamp;
	u16 event_id;
	u16 pad[3];
};
/* FW error definition for event_type in hl_info_fw_err_event */
#[repr(C)]
#[derive(Copy, Clone, Debug, Eq, PartialEq)]
pub enum hl_info_fw_err_type {
	HL_INFO_FW_HEARTBEAT_ERR,
	HL_INFO_FW_REPORTED_ERR,
};
/**
 * hl_info_fw_err_event - info about FW error
...
/**
 * hl_info_engine_err_event - engine error info
 * @timestamp: time-stamp of error occurrence
...
/**
 * hl_info_dev_memalloc_page_sizes - valid page sizes in device mem alloc information.
 * @page_order_bitmask: bitmap in which a set bit represents the order of the supported page size
 *                      (e.g. 0x2100000 means that 1MB and 32MB pages are supported).
 */
#[repr(C)]
pub hl_info_dev_memalloc_page_sizes {
	u64 page_order_bitmask;
};
pub const SEC_PCR_DATA_BUF_SZ: u64 = 256;
pub const SEC_PCR_QUOTE_BUF_SZ: u64 = 510	/* (512 - 2) 2 bytes used for size */;
pub const SEC_SIGNATURE_BUF_SZ: u64 = 255	/* (256 - 1) 1 byte used for size */;
pub const SEC_PUB_DATA_BUF_SZ: u64 = 510	/* (512 - 2) 2 bytes used for size */;
pub const SEC_CERTIFICATE_BUF_SZ: u64 = 2046	/* (2048 - 2) 2 bytes used for size */;
pub const SEC_DEV_INFO_BUF_SZ: u64 = 5120;
/*
 * hl_info_sec_attest - attestation report of the boot
...
pub hl_info_sec_attest {
	...
	u8 pcr_reg_len;
	u8 quote_sig_len;
	u8 pcr_data[SEC_PCR_DATA_BUF_SZ];
	u8 pcr_quote[SEC_PCR_QUOTE_BUF_SZ];
	u8 quote_sig[SEC_SIGNATURE_BUF_SZ];
	u8 public_data[SEC_PUB_DATA_BUF_SZ];
	u8 certificate[SEC_CERTIFICATE_BUF_SZ];
	u8 pad0[2];
};
/*
 * hl_info_signed - device information signed by a secured device.
 * @nonce: number only used once. random number provided by host. this also passed to the quote
 *         command as a qualifying data.
 * @pub_data_len: length of the public data(bytes)
 * @certificate_len: length of the certificate(bytes)
...
pub hl_info_signed {
	...
	u8 public_data[SEC_PUB_DATA_BUF_SZ];
	u8 certificate[SEC_CERTIFICATE_BUF_SZ];
	u8 info_sig[SEC_SIGNATURE_BUF_SZ];
	u16 dev_info_len;
	u8 dev_info[SEC_DEV_INFO_BUF_SZ];
	u8 pad[2];
};
/**
 * hl_page_fault_info - page fault information.
...
/**
 * hl_user_mapping - user mapping information.
...
/**
 * hl_info_args - Main structure to retrieve device related information.
 ...
 *               hl_info_hw_ip_info.num_of_events * sizeof(u32).
...
pub const HL_CB_OP_CREATE: u64 = 0;
/* Opcode to destroy previously created command buffer */
pub const HL_CB_OP_DESTROY: u64 = 1;
/* Opcode to retrieve information about a command buffer */
pub const HL_CB_OP_INFO: u64 = 2;
/* 2MB minus 32 bytes for 2xMSG_PROT */
pub const HL_MAX_CB_SIZE: u64 = (0x200000 - 32);
/* Indicates whether the command buffer should be mapped to the device's MMU */
pub const HL_CB_FLAGS_MAP: u64 = 0x1;
/* Used with HL_CB_OP_INFO opcode to get the device va address for kernel mapped CB */
pub const HL_CB_FLAGS_GET_DEVICE_VA: u64 = 0x2;
#[repr(C)]
pub hl_cb_in {
 ...
 */
pub const HL_CS_CHUNK_FLAGS_USER_ALLOC_CB: u64 = 0x1;
/*
...
pub const HL_CS_FLAGS_FORCE_RESTORE: u64 = 0x1;
pub const HL_CS_FLAGS_SIGNAL: u64 = 0x2;
pub const HL_CS_FLAGS_WAIT: u64 = 0x4;
pub const HL_CS_FLAGS_COLLECTIVE_WAIT: u64 = 0x8;
pub const HL_CS_FLAGS_TIMESTAMP: u64 = 0x20;
pub const HL_CS_FLAGS_STAGED_SUBMISSION: u64 = 0x40;
pub const HL_CS_FLAGS_STAGED_SUBMISSION_FIRST: u64 = 0x80;
pub const HL_CS_FLAGS_STAGED_SUBMISSION_LAST: u64 = 0x100;
pub const HL_CS_FLAGS_CUSTOM_TIMEOUT: u64 = 0x200;
pub const HL_CS_FLAGS_SKIP_RESET_ON_TIMEOUT: u64 = 0x400;
/*
 ...
 */
pub const HL_CS_FLAGS_ENCAP_SIGNALS: u64 = 0x800;
pub const HL_CS_FLAGS_RESERVE_SIGNALS_ONLY: u64 = 0x1000;
pub const HL_CS_FLAGS_UNRESERVE_SIGNALS_ONLY: u64 = 0x2000;
/*
 * The engine cores CS is merged into the existing CS ioctls.
 * Use it to control the engine cores mode.
 */
pub const HL_CS_FLAGS_ENGINE_CORE_COMMAND: u64 = 0x4000;
/*
 ...
 */
pub const HL_CS_FLAGS_FLUSH_PCI_HBW_WRITES: u64 = 0x8000;
/*
 * The engines CS is merged into the existing CS ioctls.
 * Use it to control engines modes.
 */
pub const HL_CS_FLAGS_ENGINES_COMMAND: u64 = 0x10000;
pub const HL_CS_STATUS_SUCCESS: u64 = 0;
pub const HL_MAX_JOBS_PER_CS: u64 = 512;
/*
...
pub hl_cs_in {
	...
	union {
		 ...
		 */
		u32 encaps_sig_handle_id;
		/* Valid only when HL_CS_FLAGS_RESERVE_SIGNALS_ONLY is set */
		struct {
			/* Encapsulated signals number */
			u32 encaps_signals_count;
			/* Encapsulated signals queue index(stream) */
			u32 encaps_signals_q_idx;
		};
	};
	/* Number of chunks in restore phase array. Maximum number is
	 * HL_MAX_JOBS_PER_CS
	 */
	u32 num_chunks_restore;
	/* Number of chunks in execution array. Maximum number is
	 * HL_MAX_JOBS_PER_CS
	 */
	u32 num_chunks_execute;
...
pub hl_cs_out {
	 ...
	 */
	u16 sob_count_before_submission;
	u16 pad[3];
};
#[repr(C)]
pub hl_cs_args {
...
pub const HL_WAIT_CS_FLAGS_INTERRUPT: u64 = 0x2;
pub const HL_WAIT_CS_FLAGS_INTERRUPT_MASK: u64 = 0xFFF00000;
pub const HL_WAIT_CS_FLAGS_ANY_CQ_INTERRUPT: u64 = 0xFFF00000;
pub const HL_WAIT_CS_FLAGS_ANY_DEC_INTERRUPT: u64 = 0xFFE00000;
pub const HL_WAIT_CS_FLAGS_MULTI_CS: u64 = 0x4;
pub const HL_WAIT_CS_FLAGS_INTERRUPT_KERNEL_CQ: u64 = 0x10;
pub const HL_WAIT_CS_FLAGS_REGISTER_INTERRUPT: u64 = 0x20;
pub const HL_WAIT_MULTI_CS_LIST_MAX_LEN: u64 = 32;
#[repr(C)]
pub hl_wait_cs_in {
	union {
		struct {
...
pub const HL_WAIT_CS_STATUS_COMPLETED: u64 = 0;
pub const HL_WAIT_CS_STATUS_BUSY: u64 = 1;
pub const HL_WAIT_CS_STATUS_TIMEDOUT: u64 = 2;
pub const HL_WAIT_CS_STATUS_ABORTED: u64 = 3;
pub const HL_WAIT_CS_STATUS_FLAG_GONE: u64 = 0x1;
pub const HL_WAIT_CS_STATUS_FLAG_TIMESTAMP_VLD: u64 = 0x2;
#[repr(C)]
pub hl_wait_cs_out {
	/* HL_WAIT_CS_STATUS_* */
	u32 status;
...
pub const HL_MEM_OP_ALLOC: u64 = 0;
/* Opcode to free previously allocated device memory */
pub const HL_MEM_OP_FREE: u64 = 1;
/* Opcode to map host and device memory */
pub const HL_MEM_OP_MAP: u64 = 2;
/* Opcode to unmap previously mapped host and device memory */
pub const HL_MEM_OP_UNMAP: u64 = 3;
/* Opcode to map a hw block */
pub const HL_MEM_OP_MAP_BLOCK: u64 = 4;
/* Opcode to create DMA-BUF object for an existing device memory allocation
 * and to export an FD of that DMA-BUF back to the caller
 */
pub const HL_MEM_OP_EXPORT_DMABUF_FD: u64 = 5;
 ...
 */
pub const HL_MEM_OP_TS_ALLOC: u64 = 6;
/* Memory flags */
pub const HL_MEM_CONTIGUOUS: u64 = 0x1;
pub const HL_MEM_SHARED: u64 = 0x2;
pub const HL_MEM_USERPTR: u64 = 0x4;
pub const HL_MEM_FORCE_HINT: u64 = 0x8;
pub const HL_MEM_PREFETCH: u64 = 0x40;
/**
 * structure hl_mem_in - structure that handle input args for memory IOCTL
 * @arg: of structures to be used based on the input operation
...
pub const HL_DEBUG_MAX_AUX_VALUES: u64 = 10;
#[repr(C)]
pub hl_debug_params_etr {
...
#[repr(C)]
pub hl_debug_params_spmu {
	/* Event types selection */
	u64 event_types[HL_DEBUG_MAX_AUX_VALUES];
	/* Number of event types selection */
	u32 event_types_num;
	/* TRC configuration register values */
	u32 pmtrc_val;
	u32 trc_ctrl_host_val;
	u32 trc_en_host_val;
};
/* Opcode for ETR component */
pub const HL_DEBUG_OP_ETR: u64 = 0;
/* Opcode for ETF component */
pub const HL_DEBUG_OP_ETF: u64 = 1;
/* Opcode for STM component */
pub const HL_DEBUG_OP_STM: u64 = 2;
/* Opcode for FUNNEL component */
pub const HL_DEBUG_OP_FUNNEL: u64 = 3;
/* Opcode for BMON component */
pub const HL_DEBUG_OP_BMON: u64 = 4;
/* Opcode for SPMU component */
pub const HL_DEBUG_OP_SPMU: u64 = 5;
/* Opcode for timestamp(deprecated) */
pub const HL_DEBUG_OP_TIMESTAMP: u64 = 6;
/* Opcode for setting the device into or out of debug mode. The enable
 * variable should be 1 for enabling debug mode and 0 for disabling it
 */
pub const HL_DEBUG_OP_SET_MODE: u64 = 7;
#[repr(C)]
pub hl_debug_args {
	/*
...
pub const HL_IOCTL_INFO: u64 = 0x00;
pub const HL_IOCTL_CB: u64 = 0x01;
pub const HL_IOCTL_CS: u64 = 0x02;
pub const HL_IOCTL_WAIT_CS: u64 = 0x03;
pub const HL_IOCTL_MEMORY: u64 = 0x04;
pub const HL_IOCTL_DEBUG: u64 = 0x05;
/*
 ...
 */
pub const DRM_IOCTL_HL_INFO: u64 = 0;
/*
 * Command Buffer
 ...
 *
 */
pub const DRM_IOCTL_HL_CB: u64 = 0;
/*
 * Command Submission
 *
 ...
 * queues).
 */
pub const DRM_IOCTL_HL_CS: u64 = 0;
/*
 ...
 */
pub const DRM_IOCTL_HL_WAIT_CS: u64 = 0;
/*
 * Memory
 ...
 *
 */
pub const DRM_IOCTL_HL_MEMORY: u64 = 0;
/*
 * Debug
 ...
 *
 */
pub const DRM_IOCTL_HL_DEBUG: u64 = 0;
pub const HL_COMMAND_START: u64 = (0 + HL_IOCTL_INFO);
pub const HL_COMMAND_END: u64 = (0 + HL_IOCTL_DEBUG + 1);
