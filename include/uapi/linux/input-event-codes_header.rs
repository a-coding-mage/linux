...
pub const INPUT_PROP_POINTER: u32 = 0x00 /* needs a pointer */;
pub const INPUT_PROP_DIRECT: u32 = 0x01 /* direct input devices */;
pub const INPUT_PROP_BUTTONPAD: u32 = 0x02 /* has button(s) under pad */;
pub const INPUT_PROP_SEMI_MT: u32 = 0x03 /* touch rectangle only */;
pub const INPUT_PROP_TOPBUTTONPAD: u32 = 0x04 /* softbuttons at top of pad */;
pub const INPUT_PROP_POINTING_STICK: u32 = 0x05 /* is a pointing stick */;
pub const INPUT_PROP_ACCELEROMETER: u32 = 0x06 /* has accelerometer */;
pub const INPUT_PROP_PRESSUREPAD: u32 = 0x07 /* pressure triggers clicks */;
...
pub const KEY_ALL_APPLICATIONS: u32 = 204 /* AC Desktop Show All Applications */;
...
pub const KEY_FULL_SCREEN: u32 = 0x174 /* AC View Toggle */;
pub const KEY_ZOOM: u32 = KEY_FULL_SCREEN;
pub const KEY_MODE: u32 = 0x175;
pub const KEY_KEYBOARD: u32 = 0x176;
pub const KEY_ASPECT_RATIO: u32 = 0x177 /* HUTRR37: Aspect */;
...
pub const KEY_NOTIFICATION_CENTER: u32 = 0x1bc /* Show/hide the notification center */;
pub const KEY_PICKUP_PHONE: u32 = 0x1bd /* Answer incoming call */;
pub const KEY_HANGUP_PHONE: u32 = 0x1be /* Decline incoming call */;
pub const KEY_LINK_PHONE: u32 = 0x1bf /* AL Phone Syncing */;
...
pub const KEY_ROTATE_LOCK_TOGGLE: u32 = 0x231 /* Display rotation lock */;
pub const KEY_REFRESH_RATE_TOGGLE: u32 = 0x232 /* Display refresh rate toggle */;
...
pub const KEY_ASSISTANT: u32 = 0x247 /* AL Context-aware desktop assistant */;
pub const KEY_KBD_LAYOUT_NEXT: u32 = 0x248 /* AC Next Keyboard Layout Select */;
pub const KEY_EMOJI_PICKER: u32 = 0x249 /* Show/hide emoji picker (HUTRR101) */;
pub const KEY_DICTATE: u32 = 0x24a /* Start or Stop Voice Dictation Session (HUTRR99) */;
pub const KEY_CAMERA_ACCESS_ENABLE: u32 = 0x24b /* Enables programmatic access to camera devices. (HUTRR72) */;
pub const KEY_CAMERA_ACCESS_DISABLE: u32 = 0x24c /* Disables programmatic access to camera devices. (HUTRR72) */;
pub const KEY_CAMERA_ACCESS_TOGGLE: u32 = 0x24d /* Toggles the current state of the camera access control. (HUTRR72) */;
pub const KEY_ACCESSIBILITY: u32 = 0x24e /* Toggles the system bound accessibility UI/command (HUTRR116) */;
pub const KEY_DO_NOT_DISTURB: u32 = 0x24f /* Toggles the system-wide "Do Not Disturb" control (HUTRR94)*/;
...
pub const KEY_ACTION_ON_SELECTION: u32 = 0x254 /* AL Action on Selection (HUTRR119) */;
pub const KEY_CONTEXTUAL_INSERT: u32 = 0x255 /* AL Contextual Insertion (HUTRR119) */;
pub const KEY_CONTEXTUAL_QUERY: u32 = 0x256 /* AL Contextual Query (HUTRR119) */;
...
pub const ABS_MT_SLOT: u32 = 0x2f /* MT slot being modified */;
pub const ABS_MT_TOUCH_MAJOR: u32 = 0x30 /* Major axis of touching ellipse */;
pub const ABS_MT_TOUCH_MINOR: u32 = 0x31 /* Minor axis (omit if circular) */;
pub const ABS_MT_WIDTH_MAJOR: u32 = 0x32 /* Major axis of approaching ellipse */;
pub const ABS_MT_WIDTH_MINOR: u32 = 0x33 /* Minor axis (omit if circular) */;
pub const ABS_MT_ORIENTATION: u32 = 0x34 /* Ellipse orientation */;
pub const ABS_MT_POSITION_X: u32 = 0x35 /* Center X touch position */;
pub const ABS_MT_POSITION_Y: u32 = 0x36 /* Center Y touch position */;
pub const ABS_MT_TOOL_TYPE: u32 = 0x37 /* Type of touching device */;
pub const ABS_MT_BLOB_ID: u32 = 0x38 /* Group a set of packets as a blob */;
pub const ABS_MT_TRACKING_ID: u32 = 0x39 /* Unique ID of initiated contact */;
pub const ABS_MT_PRESSURE: u32 = 0x3a /* Pressure on contact area */;
pub const ABS_MT_DISTANCE: u32 = 0x3b /* Contact hover distance */;
pub const ABS_MT_TOOL_X: u32 = 0x3c /* Center X tool position */;
pub const ABS_MT_TOOL_Y: u32 = 0x3d /* Center Y tool position */;
...
pub const SW_LID: u32 = 0x00 /* set = lid shut */;
pub const SW_TABLET_MODE: u32 = 0x01 /* set = tablet mode */;
pub const SW_HEADPHONE_INSERT: u32 = 0x02 /* set = inserted */;
pub const SW_RFKILL_ALL: u32 = 0x03 /* rfkill master switch, type "any";
					 set = radio enabled */
pub const SW_RADIO: u32 = SW_RFKILL_ALL /* deprecated */;
pub const SW_MICROPHONE_INSERT: u32 = 0x04 /* set = inserted */;
pub const SW_DOCK: u32 = 0x05 /* set = plugged into dock */;
pub const SW_LINEOUT_INSERT: u32 = 0x06 /* set = inserted */;
pub const SW_JACK_PHYSICAL_INSERT: u32 = 0x07 /* set = mechanical switch set */;
pub const SW_VIDEOOUT_INSERT: u32 = 0x08 /* set = inserted */;
pub const SW_CAMERA_LENS_COVER: u32 = 0x09 /* set = lens covered */;
pub const SW_KEYPAD_SLIDE: u32 = 0x0a /* set = keypad slide out */;
pub const SW_FRONT_PROXIMITY: u32 = 0x0b /* set = front proximity sensor active */;
pub const SW_ROTATE_LOCK: u32 = 0x0c /* set = rotate locked/disabled */;
pub const SW_LINEIN_INSERT: u32 = 0x0d /* set = inserted */;
pub const SW_MUTE_DEVICE: u32 = 0x0e /* set = device disabled */;
pub const SW_PEN_INSERTED: u32 = 0x0f /* set = pen inserted */;
pub const SW_MACHINE_COVER: u32 = 0x10 /* set = cover closed */;
pub const SW_USB_INSERT: u32 = 0x11 /* set = USB audio device connected */;
