...
// Translated from the Linux UAPI generic netlink header.
// Dependencies from <linux/types.h> and <linux/netlink.h> are supplied externally.

pub const GENL_NAMSIZ: usize = 16; /* length of family name */

pub const GENL_MIN_ID: u16 = NLMSG_MIN_TYPE;
...
pub const GENL_ID_VFS_DQUOT: u16 = NLMSG_MIN_TYPE + 1;
pub const GENL_ID_PMCRAID: u16 = NLMSG_MIN_TYPE + 2;
/* must be last reserved + 1 */
pub const GENL_START_ALLOC: u16 = NLMSG_MIN_TYPE + 3;
...
pub const CTRL_ATTR_POLICY_MAX: u32 = CTRL_ATTR_POLICY_DUMP_MAX - 1;
