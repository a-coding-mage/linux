...
pub const FALLOC_FL_ALLOCATE_RANGE: i32 = 0x00; /* allocate range */
pub const FALLOC_FL_KEEP_SIZE: i32 = 0x01; /* default is extend size */
pub const FALLOC_FL_PUNCH_HOLE: i32 = 0x02; /* de-allocates range */
pub const FALLOC_FL_NO_HIDE_STALE: i32 = 0x04; /* reserved codepoint */
 ...
 * boundaries, but this boundary may be larger or smaller depending on the
 * filesystem and/or the configuration of the filesystem or file.
 *
 ...
 * block size boundaries, but this boundary may be larger or smaller depending
