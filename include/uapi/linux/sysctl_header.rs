...
pub const INOTIFY_MAX_USER_INSTANCES: i32 = 1; /* max instances per user */
pub const INOTIFY_MAX_USER_WATCHES: i32 = 2; /* max watches per user */
pub const INOTIFY_MAX_QUEUED_EVENTS: i32 = 3; /* max queued events per instance */

/* CTL_KERN names: */

pub const KERN_OSTYPE: i32 = 1; /* string: system version */
pub const KERN_OSRELEASE: i32 = 2; /* string: system release */
pub const KERN_OSREV: i32 = 3; /* int: system revision */
pub const KERN_VERSION: i32 = 4; /* string: compile time info */
pub const KERN_SECUREMASK: i32 = 5; /* struct: maximum rights mask */
pub const KERN_PROF: i32 = 6; /* table: profiling information */
pub const KERN_NODENAME: i32 = 7; /* string: hostname */
pub const KERN_DOMAINNAME: i32 = 8; /* string: domainname */
pub const KERN_PANIC: i32 = 15; /* int: panic timeout */
pub const KERN_SPARC_REBOOT: i32 = 21; /* reboot command on Sparc */
pub const KERN_CTLALTDEL: i32 = 22; /* int: allow ctl-alt-del to reboot */
pub const KERN_PRINTK: i32 = 23; /* struct: control printk logging parameters */
pub const KERN_NAMETRANS: i32 = 24; /* Name translation */
pub const KERN_PPC_HTABRECLAIM: i32 = 25; /* turn htab reclaimation on/off on PPC */
pub const KERN_PPC_ZEROPAGED: i32 = 26; /* turn idle page zeroing on/off on PPC */
pub const KERN_PPC_POWERSAVE_NAP: i32 = 27; /* use nap mode for power saving */
pub const KERN_MODPROBE: i32 = 28; /* string: modprobe path */
pub const KERN_SG_BIG_BUFF: i32 = 29; /* int: sg driver reserved buffer size */
pub const KERN_ACCT: i32 = 30; /* BSD process accounting parameters */
pub const KERN_PPC_L2CR: i32 = 31; /* l2cr register on PPC */
pub const KERN_RTSIGNR: i32 = 32; /* Number of rt sigs queued */
pub const KERN_RTSIGMAX: i32 = 33; /* Max queuable */
pub const KERN_SHMMAX: i32 = 34; /* long: Maximum shared memory segment */
pub const KERN_MSGMAX: i32 = 35; /* int: Maximum size of a messege */
pub const KERN_MSGMNB: i32 = 36; /* int: Maximum message queue size */
pub const KERN_MSGPOOL: i32 = 37; /* int: Maximum system message pool size */
pub const KERN_SYSRQ: i32 = 38; /* int: Sysreq enable */
pub const KERN_MAX_THREADS: i32 = 39; /* int: Maximum nr of threads in the system */
pub const KERN_RANDOM: i32 = 40; /* Random driver */
pub const KERN_SHMALL: i32 = 41; /* int: Maximum size of shared memory */
pub const KERN_MSGMNI: i32 = 42; /* int: msg queue identifiers */
pub const KERN_SEM: i32 = 43; /* struct: sysv semaphore limits */
pub const KERN_SPARC_STOP_A: i32 = 44; /* int: Sparc Stop-A enable */
pub const KERN_SHMMNI: i32 = 45; /* int: shm array identifiers */
pub const KERN_OVERFLOWUID: i32 = 46; /* int: overflow UID */
pub const KERN_OVERFLOWGID: i32 = 47; /* int: overflow GID */
pub const KERN_SHMPATH: i32 = 48; /* string: path to shm fs */
pub const KERN_HOTPLUG: i32 = 49; /* string: path to uevent helper (deprecated) */
pub const KERN_IEEE_EMULATION_WARNINGS: i32 = 50; /* int: unimplemented ieee instructions */
pub const KERN_S390_USER_DEBUG_LOGGING: i32 = 51; /* int: dumps of user faults */
pub const KERN_CORE_USES_PID: i32 = 52; /* int: use core or core.%pid */
pub const KERN_TAINTED: i32 = 53; /* int: various kernel tainted flags */
pub const KERN_CADPID: i32 = 54; /* int: PID of the process to notify on CAD */
pub const KERN_PIDMAX: i32 = 55; /* int: PID # limit */
pub const KERN_CORE_PATTERN: i32 = 56; /* string: pattern for core-file names */
pub const KERN_PANIC_ON_OOPS: i32 = 57; /* int: whether we will panic on an oops */
pub const KERN_HPPA_PWRSW: i32 = 58; /* int: hppa soft-power enable */
pub const KERN_HPPA_UNALIGNED: i32 = 59; /* int: hppa unaligned-trap enable */
pub const KERN_PRINTK_RATELIMIT: i32 = 60; /* int: tune printk ratelimiting */
pub const KERN_PRINTK_RATELIMIT_BURST: i32 = 61; /* int: tune printk ratelimiting */
pub const KERN_PTY: i32 = 62; /* dir: pty driver */
pub const KERN_NGROUPS_MAX: i32 = 63; /* int: NGROUPS_MAX */
pub const KERN_SPARC_SCONS_PWROFF: i32 = 64; /* int: serial console power-off halt */
pub const KERN_HZ_TIMER: i32 = 65; /* int: hz timer on or off */
pub const KERN_UNKNOWN_NMI_PANIC: i32 = 66; /* int: unknown nmi panic flag */
pub const KERN_BOOTLOADER_TYPE: i32 = 67; /* int: boot loader type */
pub const KERN_RANDOMIZE: i32 = 68; /* int: randomize virtual address space */
pub const KERN_SETUID_DUMPABLE: i32 = 69; /* int: behaviour of dumps for setuid core */
pub const KERN_SPIN_RETRY: i32 = 70; /* int: number of spinlock retries */
pub const KERN_ACPI_VIDEO_FLAGS: i32 = 71; /* int: flags for setting up video after ACPI sleep */
pub const KERN_IA64_UNALIGNED: i32 = 72; /* int: ia64 unaligned userland trap enable */
pub const KERN_COMPAT_LOG: i32 = 73; /* int: print compat layer  messages */
pub const KERN_MAX_LOCK_DEPTH: i32 = 74; /* int: rtmutex's maximum lock depth */
pub const KERN_NMI_WATCHDOG: i32 = 75; /* int: enable/disable nmi watchdog */
pub const KERN_PANIC_ON_NMI: i32 = 76; /* int: whether we will panic on an unrecovered */
pub const KERN_PANIC_ON_WARN: i32 = 77; /* int: call panic() in WARN() functions */
pub const KERN_PANIC_PRINT: i32 = 78; /* ulong: bitmask to print system info on panic */

/* CTL_VM names: */

pub const VM_UNUSED1: i32 = 1; /* was: struct: Set vm swapping control */
pub const VM_UNUSED2: i32 = 2; /* was; int: Linear or sqrt() swapout for hogs */
pub const VM_UNUSED3: i32 = 3; /* was: struct: Set free page thresholds */
pub const VM_UNUSED4: i32 = 4; /* Spare */
pub const VM_OVERCOMMIT_MEMORY: i32 = 5; /* Turn off the virtual memory safety limit */
pub const VM_UNUSED5: i32 = 6; /* was: struct: Set buffer memory thresholds */
pub const VM_UNUSED7: i32 = 7; /* was: struct: Set cache memory thresholds */
pub const VM_UNUSED8: i32 = 8; /* was: struct: Control kswapd behaviour */
pub const VM_UNUSED9: i32 = 9; /* was: struct: Set page table cache parameters */
pub const VM_PAGE_CLUSTER: i32 = 10; /* int: set number of pages to swap together */
pub const VM_DIRTY_BACKGROUND: i32 = 11; /* dirty_background_ratio */
pub const VM_DIRTY_RATIO: i32 = 12; /* dirty_ratio */
pub const VM_DIRTY_WB_CS: i32 = 13; /* dirty_writeback_centisecs */
pub const VM_DIRTY_EXPIRE_CS: i32 = 14; /* dirty_expire_centisecs */
pub const VM_NR_PDFLUSH_THREADS: i32 = 15; /* nr_pdflush_threads */
pub const VM_OVERCOMMIT_RATIO: i32 = 16; /* percent of RAM to allow overcommit in */
pub const VM_PAGEBUF: i32 = 17; /* struct: Control pagebuf parameters */
pub const VM_HUGETLB_PAGES: i32 = 18; /* int: Number of available Huge Pages */
pub const VM_SWAPPINESS: i32 = 19; /* Tendency to steal mapped memory */
pub const VM_LOWMEM_RESERVE_RATIO: i32 = 20; /* reservation ratio for lower memory zones */
pub const VM_MIN_FREE_KBYTES: i32 = 21; /* Minimum free kilobytes to maintain */
pub const VM_MAX_MAP_COUNT: i32 = 22; /* int: Maximum number of mmaps/address-space */
pub const VM_BLOCK_DUMP: i32 = 24; /* block dump mode */
pub const VM_HUGETLB_GROUP: i32 = 25; /* permitted hugetlb group */
pub const VM_VFS_CACHE_PRESSURE: i32 = 26; /* dcache/icache reclaim pressure */
pub const VM_LEGACY_VA_LAYOUT: i32 = 27; /* legacy/compatibility virtual address space layout */
pub const VM_SWAP_TOKEN_TIMEOUT: i32 = 28; /* default time for token time out */
pub const VM_DROP_PAGECACHE: i32 = 29; /* int: nuke lots of pagecache */
pub const VM_PERCPU_PAGELIST_FRACTION: i32 = 30; /* int: fraction of pages in each percpu_pagelist */
pub const VM_ZONE_RECLAIM_MODE: i32 = 31; /* reclaim local zone memory before going off node */
pub const VM_MIN_UNMAPPED: i32 = 32; /* Set min percent of unmapped pages */
pub const VM_PANIC_ON_OOM: i32 = 33; /* panic at out-of-memory */
pub const VM_VDSO_ENABLED: i32 = 34; /* map VDSO into new processes? */
pub const VM_MIN_SLAB: i32 = 35; /* Percent pages ignored by node reclaim */
...
pub const NET_CORE_RMEM_DEFAULT: i32 = 4; /* was	NET_CORE_DESTROY_DELAY */
...
pub const NET_IPV4_DYNADDR: i32 = 9; pub const NET_IPV4_CONF: i32 = 16; 
pub const NET_IPV4_NEIGH: i32 = 17; 
pub const NET_IPV4_ROUTE: i32 = 18; 
pub const NET_IPV4_FIB_HASH: i32 = 19; 
pub const NET_IPV4_NETFILTER: i32 = 20; pub const NET_IPV4_TCP_TIMESTAMPS: i32 = 33; 
...
pub const NET_IPV4_ROUTE_MIN_DELAY: i32 = 2; /* obsolete since 2.6.25 */
pub const NET_IPV4_ROUTE_MAX_DELAY: i32 = 3; /* obsolete since 2.6.25 */
...
pub const NET_IPV4_ROUTE_GC_INTERVAL: i32 = 8; /* obsolete since 2.6.38 */
...
pub const NET_PROTO_CONF_DEFAULT: i32 = -3; /* And device ifindices ... */
...
pub const NET_IPV4_CONF_ARP_EVICT_NOCARRIER: i32 = 23; 
...
pub const NET_IPV6_RA_DEFRTR_METRIC: i32 = 28; 
pub const NET_IPV6_FORCE_FORWARDING: i32 = 29; 
	pub const __NET_IPV6_MAX: i32 = 30;
...
pub const NET_NEIGH_INTERVAL_PROBE_TIME_MS: i32 = 19; 
...
pub const NET_DECNET_CONF_ETHER: i32 = -7; /* ... and ifindex of devices */
...
pub const FS_NRINODE: i32 = 1; /* int:current number of allocated inodes */
pub const FS_STATINODE: i32 = 2; 
pub const FS_MAXINODE: i32 = 3; /* int:maximum number of inodes that can be allocated */
pub const FS_NRDQUOT: i32 = 4; /* int:current number of allocated dquots */
pub const FS_MAXDQUOT: i32 = 5; /* int:maximum number of dquots that can be allocated */
pub const FS_NRFILE: i32 = 6; /* int:current number of allocated filedescriptors */
pub const FS_MAXFILE: i32 = 7; /* int:maximum number of filedescriptors that can be allocated */
pub const FS_DENTRY: i32 = 8; 
pub const FS_NRSUPER: i32 = 9; /* int:current number of allocated super_blocks */
pub const FS_MAXSUPER: i32 = 10; /* int:maximum number of super_blocks that can be allocated */
pub const FS_OVERFLOWUID: i32 = 11; /* int: overflow UID */
pub const FS_OVERFLOWGID: i32 = 12; /* int: overflow GID */
pub const FS_LEASES: i32 = 13; /* int: leases enabled */
pub const FS_DIR_NOTIFY: i32 = 14; /* int: directory notification enabled */
pub const FS_LEASE_TIME: i32 = 15; /* int: maximum time to wait for a lease break */
pub const FS_DQSTATS: i32 = 16; /* disc quota usage statistics and control */
pub const FS_XFS: i32 = 17; /* struct: control xfs parameters */
pub const FS_AIO_NR: i32 = 18; /* current system-wide number of aio requests */
pub const FS_AIO_MAX_NR: i32 = 19; /* system-wide maximum number of aio requests */
pub const FS_INOTIFY: i32 = 20; /* inotify submenu */
pub const FS_OCFS2: i32 = 988; /* ocfs2 */
...
pub const ABI_DEFHANDLER_COFF: i32 = 1; /* default handler for coff binaries */
pub const ABI_DEFHANDLER_ELF: i32 = 2; /* default handler for ELF binaries */
pub const ABI_DEFHANDLER_LCALL7: i32 = 3; /* default handler for procs using lcall7 */
pub const ABI_DEFHANDLER_LIBCSO: i32 = 4; /* default handler for an libc.so ELF interp */
pub const ABI_TRACE: i32 = 5; /* tracing flags */
pub const ABI_FAKE_UTSNAME: i32 = 6; /* fake target utsname information */
