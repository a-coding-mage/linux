...
// dependency: #include <linux/const.h>
// dependency: #include <linux/typelimits.h>
// dependency: #include <linux/types.h>
// dependency: #include <linux/if_ether.h>
...
/**
 * ethtool_cmd - DEPRECATED, link control and status
 * This structure is DEPRECATED, please use ethtool_link_settings.
...
tunable_id {
	 ...
	 * tunable_strings[0] in net/ethtool/common.c
	 */
...
phy_tunable_id {
	 ...
	 * phy_tunable_strings[0] in net/ethtool/common.c
	 */
	__ETHTOOL_PHY_TUNABLE_COUNT,
};

/**
 * ethtool_regs - hardware register dump
...
/**
 * ethtool_eee - Energy Efficient Ethernet information
...
/**
 * ethtool_modinfo - plugin module eeprom information
...
/**
 * ethtool_coalesce - coalescing parameters for IRQs and stats updates
...
/**
 * ethtool_ringparam - RX/TX ring parameters
...
/**
 * ethtool_channels - configuring number of network channel
...
/**
 * ethtool_pauseparam - Ethernet pause(flow control) parameters
 ...
 * advertising field of &ethtool_cmd.
 *
...
/**
 * ethtool_mac_stats_src - source of ethtool MAC statistics
...
/**
 * ethtool_module_power_mode_policy - plug-in module power mode policy
...
/**
 * ethtool_module_power_mode - plug-in module power mode
 * @ETHTOOL_MODULE_POWER_MODE_LOW: Module is in low power mode.
 * @ETHTOOL_MODULE_POWER_MODE_HIGH: Module is in high power mode.
 */
ethtool_module_power_mode {
	ETHTOOL_MODULE_POWER_MODE_LOW = 1,
	ETHTOOL_MODULE_POWER_MODE_HIGH,
};

/**
 * ethtool_c33_pse_ext_state - groups of PSE extended states
...
/**
 * ethtool_c33_pse_ext_substate_mr_mps_valid - mr_mps_valid states
 *      functions. IEEE 802.3-2022 33.2.4.4 Variables
 *
...
/**
 * ethtool_c33_pse_ext_substate_mr_pse_enable - mr_pse_enable states
 *      functions. IEEE 802.3-2022 33.2.4.4 Variables
 *
...
/**
 * ethtool_c33_pse_ext_substate_option_detect_ted - option_detect_ted
...
/**
 * ethtool_c33_pse_ext_substate_option_vport_lim - option_vport_lim states
 *      functions. IEEE 802.3-2022 33.2.4.4 Variables
 *
...
/**
 * ethtool_c33_pse_ext_substate_ovld_detected - ovld_detected states
 *      functions. IEEE 802.3-2022 33.2.4.4 Variables
 *
...
/**
 * ethtool_c33_pse_ext_substate_power_not_available - power_not_available
 *	states functions. IEEE 802.3-2022 33.2.4.4 Variables
 *
...
/**
 * ethtool_c33_pse_ext_substate_short_detected - short_detected states
 *      functions. IEEE 802.3-2022 33.2.4.4 Variables
 *
...
/**
 * ethtool_pse_types - Types of PSE controller.
...
/**
 * ethtool_c33_pse_admin_state - operational state of the PoDL PSE
...
/**
 * ethtool_c33_pse_pw_d_status - power detection status of the PSE.
...
/**
 * ethtool_podl_pse_admin_state - operational state of the PoDL PSE
...
/**
 * ethtool_podl_pse_pw_d_status - power detection status of the PoDL PSE.
...
/**
 * ethtool_mm_verify_status - status of MAC Merge Verify function
...
/**
 * ethtool_module_fw_flash_status - plug-in module firmware flashing status
...
/**
 * ethtool_gstrings - string set for data tagging
...
/**
 * ethtool_sset_info - string set information
 * @cmd: Command number = %ETHTOOL_GSSET_INFO
 * @reserved: Reserved for future use; see the note on reserved space.
 * @sset_mask: On entry, a bitmask of string sets to query, with bits
 *	numbered according to &ethtool_stringset.  On return, a
...
/**
 * ethtool_test_flags - flags definition of ethtool_test
...
/**
 * ethtool_test - device self-test invocation
...
/**
 * ethtool_stats - device-specific statistics
...
/**
 * ethtool_perm_addr - permanent hardware address
...
/**
 * ethtool_tcpip4_spec - flow specification for TCP/IPv4 etc.
 * @ip4src: Source host
...
/**
 * ethtool_ah_espip4_spec - flow specification for IPsec/IPv4
 * @ip4src: Source host
 * @ip4dst: Destination host
...
/**
 * ethtool_tcpip6_spec - flow specification for TCP/IPv6 etc.
 * @ip6src: Source host
...
/**
 * ethtool_ah_espip6_spec - flow specification for IPsec/IPv6
 * @ip6src: Source host
 * @ip6dst: Destination host
 * @spi: Security parameters index
 * @tclass: Traffic Class
...
/**
 * ethtool_usrip6_spec - general flow specification for IPv6
 * @ip6src: Source host
 * @ip6dst: Destination host
 * @l4_4_bytes: First 4 bytes of transport(layer 4) header
 * @tclass: Traffic Class
...
ethtool_flow_union {
	ethtool_tcpip4_spec		tcp_ip4_spec;
	ethtool_tcpip4_spec		udp_ip4_spec;
	ethtool_tcpip4_spec		sctp_ip4_spec;
	ethtool_ah_espip4_spec		ah_ip4_spec;
	ethtool_ah_espip4_spec		esp_ip4_spec;
	ethtool_usrip4_spec		usr_ip4_spec;
	ethtool_tcpip6_spec		tcp_ip6_spec;
	ethtool_tcpip6_spec		udp_ip6_spec;
	ethtool_tcpip6_spec		sctp_ip6_spec;
	ethtool_ah_espip6_spec		ah_ip6_spec;
	ethtool_ah_espip6_spec		esp_ip6_spec;
...
/**
 * ethtool_flow_ext - additional RX flow fields
 ...
 * is set in &ethtool_rx_flow_spec @flow_type.
...
/**
 * ethtool_rx_flow_spec - classification rule for RX flows
...
ethtool_rx_flow_spec {
	u32		flow_type;
	ethtool_flow_union h_u;
	ethtool_flow_ext h_ext;
	ethtool_flow_union m_u;
	ethtool_flow_ext m_ext;
	u64		ring_cookie;
	u32		location;
};
...
/**
 * ethtool_rxnfc - command to get or set RX flow classification rules
...
/**
 * ethtool_rxfh_indir - command to get or set RX flow hash indirection
...
/**
 * ethtool_rxfh - command to get/set RX flow hash indir or/and hash key.
 ...
 *	of @indir_size u32 elements, followed by hash key of @key_size
 *	bytes.
 *
...
/**
 * ethtool_rx_ntuple - command to set or clear RX flow filter
...
/**
 * ethtool_dump - used for retrieving, setting device dump
...
/**
 * ethtool_get_features_block - block with state of 32 features
...
/**
 * ethtool_gfeatures - command to get state of device's features
 * @cmd: command number = %ETHTOOL_GFEATURES
 * @size: On entry, the number of elements in the features[0] array;
 *	on return, the number of elements in features[0] needed to hold
 *	all features
...
ethtool_gfeatures {
	u32	cmd;
	u32	size;
	ethtool_get_features_block features[0];
};

/**
 * ethtool_set_features_block - block with request for 32 features
...
/**
 * ethtool_sfeatures - command to request change in device's features
 * @cmd: command number = %ETHTOOL_SFEATURES
 * @size: array size of the features[0] array
 * @features: feature change masks
 */
ethtool_sfeatures {
	u32	cmd;
	u32	size;
	ethtool_set_features_block features[0];
};

/**
 * ethtool_ts_info - holds a device's timestamping and PHC association
...
/*
 * %ETHTOOL_SFEATURES changes features present in features[0].valid to the
 * values of corresponding bits in features[0].requested. Bits in .requested
 ...
 *	changeable(not present in %ETHTOOL_GFEATURES' features[0].available)
...
/**
 * ethtool_fecparam - Ethernet Forward Error Correction parameters
 ...
 *
 * See ethtool_fec_config_bits for definition of valid bits for both
 * @fec and @active_fec.
 */
ethtool_fecparam {
	u32   cmd;
...
/**
 * ethtool_fec_config_bits - flags definition of ethtool_fec_configuration
...
pub const ETHTOOL_FEC_NONE: _ = ((1 << ETHTOOL_FEC_NONE_BIT));
pub const ETHTOOL_FEC_AUTO: _ = ((1 << ETHTOOL_FEC_AUTO_BIT));
pub const ETHTOOL_FEC_OFF: _ = ((1 << ETHTOOL_FEC_OFF_BIT));
pub const ETHTOOL_FEC_RS: _ = ((1 << ETHTOOL_FEC_RS_BIT));
pub const ETHTOOL_FEC_BASER: _ = ((1 << ETHTOOL_FEC_BASER_BIT));
pub const ETHTOOL_FEC_LLRS: _ = ((1 << ETHTOOL_FEC_LLRS_BIT));

/* CMDs currently supported */
pub const ETHTOOL_GSET: _ = 0x00000001 /* DEPRECATED, Get settings.;
...
pub const SPARC_ETH_SSET: _ = ETHTOOL_SSET;
...
/**
 * ethtool_link_settings - link control and status
 *
...
ethtool_link_settings {
	 ...
	 */
	u32	link_mode_masks[0];
	/* layout of link_mode_masks fields:
	 * u32 map_supported[link_mode_masks_nwords];
	 * u32 map_advertising[link_mode_masks_nwords];
	 * u32 map_lp_advertising[link_mode_masks_nwords];
	 */
#endif
};

/**
 * phy_upstream - Represents the upstream component a given PHY device
