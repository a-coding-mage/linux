 ...
 */
pub type v4l2_isp_params_version = v4l2_isp_version;
pub const V4L2_ISP_PARAMS_VERSION_V0: v4l2_isp_version = v4l2_isp_version::V4L2_ISP_VERSION_V0;
pub const V4L2_ISP_PARAMS_VERSION_V1: v4l2_isp_version = v4l2_isp_version::V4L2_ISP_VERSION_V1;

pub const V4L2_ISP_PARAMS_FL_BLOCK_DISABLE: u32 = 1u32 << 0;
pub const V4L2_ISP_PARAMS_FL_BLOCK_ENABLE: u32 = 1u32 << 1;
 ...
 */
#[inline]
pub const fn V4L2_ISP_FL_DRIVER_FLAGS(n: u32) -> u32 {
    n + 8
}
 ...
 */
pub type v4l2_isp_params_block_header = v4l2_isp_block_header;
...
pub struct v4l2_isp_buffer {
    pub version: u32,
    pub data_size: u32,
    /* C flexible array member: __u8 data[] __counted_by(data_size); */
    pub data: [u8; 0],
}
 ...
 */
pub type v4l2_isp_params_buffer = v4l2_isp_buffer;
