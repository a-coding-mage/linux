...
pub enum dpll_mode {
    ...
    DPLL_MODE_AUTOMATIC,
    __DPLL_MODE_MAX,
    DPLL_MODE_MAX = __DPLL_MODE_MAX as isize - 1,
}
...
pub enum dpll_lock_status {
    ...
    DPLL_LOCK_STATUS_MAX = __DPLL_LOCK_STATUS_MAX as isize - 1,
}
...
pub enum dpll_lock_status_error {
    ...
    DPLL_LOCK_STATUS_ERROR_MAX = __DPLL_LOCK_STATUS_ERROR_MAX as isize - 1,
}
...
pub enum dpll_clock_quality_level {
    ...
    DPLL_CLOCK_QUALITY_LEVEL_MAX = __DPLL_CLOCK_QUALITY_LEVEL_MAX as isize - 1,
}
...
pub enum dpll_type {
    ...
    DPLL_TYPE_GENERIC,
    __DPLL_TYPE_MAX,
    DPLL_TYPE_MAX = __DPLL_TYPE_MAX as isize - 1,
}
...
pub enum dpll_pin_type {
    ...
    __DPLL_PIN_TYPE_MAX,
    DPLL_PIN_TYPE_MAX = __DPLL_PIN_TYPE_MAX as isize - 1,
}
...
pub enum dpll_pin_direction {
    ...
    DPLL_PIN_DIRECTION_MAX = __DPLL_PIN_DIRECTION_MAX as isize - 1,
}
...
pub enum dpll_pin_state {
    ...
    DPLL_PIN_STATE_MAX = __DPLL_PIN_STATE_MAX as isize - 1,
}
...
pub enum dpll_pin_operstate {
    ...
    DPLL_PIN_OPERSTATE_MAX = __DPLL_PIN_OPERSTATE_MAX as isize - 1,
}
...
pub enum dpll_a {
    ...
    __DPLL_A_MAX,
    DPLL_A_MAX = __DPLL_A_MAX as isize - 1,
}
...
pub enum dpll_a_pin {
    ...
    __DPLL_A_PIN_MAX,
    DPLL_A_PIN_MAX = __DPLL_A_PIN_MAX as isize - 1,
}
...
pub enum dpll_cmd {
    ...
    __DPLL_CMD_MAX,
    DPLL_CMD_MAX = __DPLL_CMD_MAX as isize - 1,
}
