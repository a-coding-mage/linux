...
pub const ADDR_NO_RANDOMIZE: i32 = 0x0040000; /* disable randomization of VA space */
pub const FDPIC_FUNCPTRS: i32 = 0x0080000; /* userspace function ptrs point to descriptors
                                            * (signal handling)
                                            */
...
pub const PER_IRIX32: i32 = 0x0009 | STICKY_TIMEOUTS; /* IRIX5 32-bit */
pub const PER_IRIXN32: i32 = 0x000a | STICKY_TIMEOUTS; /* IRIX6 new 32-bit */
pub const PER_IRIX64: i32 = 0x000b | STICKY_TIMEOUTS; /* IRIX6 64-bit */
...
pub const PER_OSF4: i32 = 0x000f; /* OSF/1 v4 */
