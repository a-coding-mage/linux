...
pub const INTEL_OUI: u32 = 0x001735;
...
#[repr(i32)]
pub enum iwl_vendor_auth_akm_mode {
...
pub enum iwl_mvm_vendor_attr {
    ...
    MAX_IWL_MVM_VENDOR_ATTR = NUM_IWL_MVM_VENDOR_ATTR as i32 - 1,
}
