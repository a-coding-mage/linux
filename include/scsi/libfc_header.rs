...
extern "C" { fn alloc_percpu_fc_stats()->*mut fc_stats; fn free_percpu_fc_stats(_: *mut fc_stats); }
...
extern "C" {
 ...
 pub fn fc_lport_init(_: *mut fc_lport)->c_int; pub fn fc_lport_destroy(_: *mut fc_lport)->c_int; pub fn fc_fabric_logoff(_: *mut fc_lport)->c_int; pub fn fc_fabric_login(_: *mut fc_lport)->c_int; pub fn __fc_linkup(_: *mut fc_lport); pub fn fc_linkup(_: *mut fc_lport); pub fn __fc_linkdown(_: *mut fc_lport); pub fn fc_linkdown(_: *mut fc_lport); pub fn fc_vport_setlink(_: *mut fc_lport); pub fn fc_vports_linkchange(_: *mut fc_lport); pub fn fc_lport_config(_: *mut fc_lport)->c_int; pub fn fc_lport_reset(_: *mut fc_lport)->c_int; pub fn fc_lport_recv(_: *mut fc_lport,_: *mut fc_frame); pub fn fc_set_mfs(_: *mut fc_lport,_: u32)->c_int; pub fn libfc_vport_create(_: *mut fc_vport,_: c_int)->*mut fc_lport; pub fn fc_vport_id_lookup(_: *mut fc_lport,_: u32)->*mut fc_lport; pub fn fc_lport_bsg_request(_: *mut bsg_job)->c_int; pub fn fc_lport_set_local_id(_: *mut fc_lport,_: u32); pub fn fc_lport_iterate(_: Option<unsafe extern "C" fn(*mut fc_lport,*mut c_void)>,_: *mut c_void);
 pub fn fc_rport_terminate_io(_: *mut fc_rport); pub fn fc_rport_lookup(_: *const fc_lport,_: u32)->*mut fc_rport_priv; pub fn fc_rport_create(_: *mut fc_lport,_: u32)->*mut fc_rport_priv; pub fn fc_rport_destroy(_: *mut kref); pub fn fc_rport_login(_: *mut fc_rport_priv)->c_int; pub fn fc_rport_logoff(_: *mut fc_rport_priv)->c_int; pub fn fc_rport_recv_req(_: *mut fc_lport,_: *mut fc_frame); pub fn fc_rport_flush_queue();
 pub fn fc_disc_init(_: *mut fc_lport); pub fn fc_disc_config(_: *mut fc_lport,_: *mut c_void); pub fn fc_fcp_init(_: *mut fc_lport)->c_int; pub fn fc_fcp_destroy(_: *mut fc_lport);
 pub fn fc_queuecommand(_: *mut Scsi_Host,_: *mut scsi_cmnd)->scsi_qc_status; pub fn fc_eh_abort(_: *mut scsi_cmnd)->c_int; pub fn fc_eh_device_reset(_: *mut scsi_cmnd)->c_int; pub fn fc_eh_host_reset(_: *mut scsi_cmnd)->c_int; pub fn fc_sdev_init(_: *mut scsi_device)->c_int;
 pub fn fc_elsct_init(_: *mut fc_lport)->c_int; pub fn fc_elsct_send(_: *mut fc_lport,_: u32,_: *mut fc_frame,_: c_uint,_: Option<unsafe extern "C" fn(*mut fc_seq,*mut fc_frame,*mut c_void)>,_: *mut c_void,_: u32)->*mut fc_seq; pub fn fc_lport_flogi_resp(_: *mut fc_seq,_: *mut fc_frame,_: *mut c_void); pub fn fc_lport_logo_resp(_: *mut fc_seq,_: *mut fc_frame,_: *mut c_void); pub fn fc_fill_reply_hdr(_: *mut fc_frame,_: *const fc_frame,_: fc_rctl,_: u32); pub fn fc_fill_hdr(_: *mut fc_frame,_: *const fc_frame,_: fc_rctl,_: u32,_: u16,_: u32);
 pub fn fc_exch_init(_: *mut fc_lport)->c_int; pub fn fc_exch_update_stats(_: *mut fc_lport); pub fn fc_exch_recv(_: *mut fc_lport,_: *mut fc_frame); pub fn fc_exch_mgr_reset(_: *mut fc_lport,_: u32,_: u32); pub fn fc_seq_send(_: *mut fc_lport,_: *mut fc_seq,_: *mut fc_frame)->c_int; pub fn fc_seq_exch_abort(_: *const fc_seq,_: c_uint)->c_int; pub fn fc_exch_done(_: *mut fc_seq); pub fn fc_get_host_speed(_: *mut Scsi_Host); pub fn fc_get_host_port_state(_: *mut Scsi_Host); pub fn fc_set_rport_loss_tmo(_: *mut fc_rport,_: u32); pub fn fc_get_host_stats(_: *mut Scsi_Host)->*mut fc_host_statistics;
}
