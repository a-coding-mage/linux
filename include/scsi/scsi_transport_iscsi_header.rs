...
extern "C" {
    pub fn iscsi_register_transport(_: *mut iscsi_transport) -> *mut scsi_transport_template; pub fn iscsi_unregister_transport(_: *mut iscsi_transport);
    pub fn iscsi_conn_error_event(_: *mut iscsi_cls_conn, _: iscsi_err); pub fn iscsi_conn_login_event(_: *mut iscsi_cls_conn, _: iscsi_conn_state); pub fn iscsi_recv_pdu(_: *mut iscsi_cls_conn, _: *mut iscsi_hdr, _: *mut c_char, _: u32) -> c_int;
    pub fn iscsi_offload_mesg(_: *mut Scsi_Host, _: *mut iscsi_transport, _: u32, _: *mut c_char, _: u16) -> c_int; pub fn iscsi_post_host_event(_: u32, _: *mut iscsi_transport, _: iscsi_host_event_code, _: u32, _: *mut u8); pub fn iscsi_ping_comp_event(_: u32, _: *mut iscsi_transport, _: u32, _: u32, _: u32, _: *mut u8);
}
...
extern "C" {
    pub fn iscsi_session_chkready(_: *mut iscsi_cls_session) -> c_int; pub fn iscsi_is_session_online(_: *mut iscsi_cls_session) -> c_int; pub fn iscsi_alloc_session(_: *mut Scsi_Host, _: *mut iscsi_transport, _: c_int) -> *mut iscsi_cls_session; pub fn iscsi_add_session(_: *mut iscsi_cls_session, _: c_uint) -> c_int; pub fn iscsi_session_event(_: *mut iscsi_cls_session, _: iscsi_uevent_e) -> c_int; pub fn iscsi_force_destroy_session(_: *mut iscsi_cls_session); pub fn iscsi_remove_session(_: *mut iscsi_cls_session); pub fn iscsi_free_session(_: *mut iscsi_cls_session);
    pub fn iscsi_alloc_conn(_: *mut iscsi_cls_session, _: c_int, _: u32) -> *mut iscsi_cls_conn; pub fn iscsi_add_conn(_: *mut iscsi_cls_conn) -> c_int; pub fn iscsi_remove_conn(_: *mut iscsi_cls_conn); pub fn iscsi_put_conn(_: *mut iscsi_cls_conn); pub fn iscsi_get_conn(_: *mut iscsi_cls_conn); pub fn iscsi_unblock_session(_: *mut iscsi_cls_session); pub fn iscsi_block_session(_: *mut iscsi_cls_session); pub fn iscsi_create_endpoint(_: c_int) -> *mut iscsi_endpoint; pub fn iscsi_destroy_endpoint(_: *mut iscsi_endpoint); pub fn iscsi_lookup_endpoint(_: u64) -> *mut iscsi_endpoint; pub fn iscsi_put_endpoint(_: *mut iscsi_endpoint); pub fn iscsi_block_scsi_eh(_: *mut scsi_cmnd) -> c_int;
    pub fn iscsi_create_iface(_: *mut Scsi_Host, _: *mut iscsi_transport, _: u32, _: u32, _: c_int) -> *mut iscsi_iface; pub fn iscsi_destroy_iface(_: *mut iscsi_iface); pub fn iscsi_get_port_speed_name(_: *mut Scsi_Host) -> *mut c_char; pub fn iscsi_get_port_state_name(_: *mut Scsi_Host) -> *mut c_char; pub fn iscsi_is_session_dev(_: *const device) -> c_int; pub fn iscsi_get_discovery_parent_name(_: c_int) -> *mut c_char;
    pub fn iscsi_destroy_flashnode_sess(_: *mut iscsi_bus_flash_session); pub fn iscsi_destroy_all_flashnode(_: *mut Scsi_Host); pub fn iscsi_flashnode_bus_match(_: *mut device, _: *const device_driver) -> c_int; pub fn iscsi_find_flashnode_sess(_: *mut Scsi_Host, _: *const c_void, _: device_match_t) -> *mut device; pub fn iscsi_find_flashnode_conn(_: *mut iscsi_bus_flash_session) -> *mut device; pub fn iscsi_get_ipaddress_state_name(_: iscsi_ipaddress_state) -> *mut c_char; pub fn iscsi_get_router_state_name(_: iscsi_router_state) -> *mut c_char;
}
