...
/* MATRIX_KEY is supplied by the consumer of this header. */

macro_rules! CROS_STD_TOP_ROW_KEYMAP {
    () => {
...
macro_rules! CROS_STD_MAIN_KEYMAP {
    () => {
...
/* No numpad */
macro_rules! CROS_TOP_ROW_KEYMAP_V30 {
    () => {
...
macro_rules! CROS_MAIN_KEYMAP_V30 {
    () => {
