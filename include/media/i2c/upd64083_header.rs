...
/* There are two bits of information that the driver needs in order
   ...
   the input is a S-Video signal, then the internal Y-ADC input should be
   used. */

/* Operating modes: */

/* YCS mode: Y/C separation (burst locked clocking) */
pub const UPD64083_YCS_MODE: i32 = 0;
/* YCS+ mode: 2D Y/C separation and YCNR (burst locked clocking) */
pub const UPD64083_YCS_PLUS_MODE: i32 = 1;
...
pub const UPD64083_MNNR_MODE: i32 = 2;
/* YCNR mode: frame recursive YCNR (burst locked clocking) */
pub const UPD64083_YCNR_MODE: i32 = 3;
...
pub const UPD64083_EXT_Y_ADC: i32 = 1 << 2;
