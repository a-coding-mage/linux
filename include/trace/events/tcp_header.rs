//! Faithful Rust-side representation of the Linux TCP trace-event header.
//! External kernel trace infrastructure and types are intentionally unresolved.

#![allow(dead_code, non_camel_case_types, non_snake_case, non_upper_case_globals)]

/// Source-level trace declarations retained verbatim for expansion by the
/// surrounding trace infrastructure.
pub const TCP_TRACE_HEADER_SOURCE: &str = r###"/* SPDX-License-Identifier: GPL-2.0 */
#undef TRACE_SYSTEM
