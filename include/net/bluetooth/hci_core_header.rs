// Faithful Rust translation of the declaration-only C header.
// External Linux kernel and Bluetooth types/functions are intentionally left as future dependencies.
