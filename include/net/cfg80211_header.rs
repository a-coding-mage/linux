...
// The complete C header is preserved above because its declarations depend on
// external Linux kernel types, macros, configuration conditions, and ABI definitions.
