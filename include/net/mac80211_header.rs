 ...
 * handler.
 *
 * Intermediate queues (pub struct ieee80211_txq) are kept per-sta per-tid, with
...
/**
 * pub enum ieee80211_max_queues - maximum number of queues
 *
 * @IEEE80211_MAX_QUEUES: Maximum number of regular device queues.
 * @IEEE80211_MAX_QUEUE_MAP: bitmap with maximum queues set
 */
pub enum ieee80211_max_queues {
	IEEE80211_MAX_QUEUES =		16,
	IEEE80211_MAX_QUEUE_MAP =	BIT(IEEE80211_MAX_QUEUES) - 1,
};

pub const IEEE80211_INVAL_HW_QUEUE: u32 = 0xff;

/**
 * pub enum ieee80211_ac_numbers - AC numbers as used in mac80211
 * @IEEE80211_AC_VO: voice
 * @IEEE80211_AC_VI: video
 * @IEEE80211_AC_BE: best effort
 * @IEEE80211_AC_BK: background
 */
pub enum ieee80211_ac_numbers {
	IEEE80211_AC_VO		= 0,
	IEEE80211_AC_VI		= 1,
	IEEE80211_AC_BE		= 2,
	IEEE80211_AC_BK		= 3,
...
/**
 * pub struct ieee80211_tx_queue_params - transmit queue configuration
 *
 ...
 */
pub struct ieee80211_tx_queue_params {
	u16 txop;
	u16 cw_min;
	u16 cw_max;
	u8 aifs;
	...
	bool uapsd;
	bool mu_edca;
	pub struct ieee80211_he_mu_edca_param_ac_rec mu_edca_param_rec;
};
...
/**
 * pub enum ieee80211_chanctx_change - change flag for channel context
 ...
 */
pub enum ieee80211_chanctx_change {
...
/**
 * pub struct ieee80211_chan_req - A channel "request"
 ...
 */
pub struct ieee80211_chan_req {
	pub struct cfg80211_chan_def oper;
	pub struct cfg80211_chan_def ap;
	bool require_npca;
};

/**
 * pub struct ieee80211_chanctx_conf - channel context that vifs may be tuned to
 *
 ...
 */
pub struct ieee80211_chanctx_conf {
	pub struct cfg80211_chan_def def;
	pub struct cfg80211_chan_def min_def;
	pub struct cfg80211_chan_def ap;

	int radio_idx;
	rx_chains_static: u8, rx_chains_dynamic;
...
/**
 * pub enum ieee80211_chanctx_switch_mode - channel context switch mode
 ...
 *      for changes/removal.)
 */
pub enum ieee80211_chanctx_switch_mode {
	CHANCTX_SWMODE_REASSIGN_VIF,
	CHANCTX_SWMODE_SWAP_CONTEXTS,
};

/**
 * pub struct ieee80211_vif_chanctx_switch - vif chanctx switch information
 *
 ...
 */
pub struct ieee80211_vif_chanctx_switch {
	pub struct ieee80211_vif *vif;
	pub struct ieee80211_bss_conf *link_conf;
	pub struct ieee80211_chanctx_conf *old_ctx;
	pub struct ieee80211_chanctx_conf *new_ctx;
};

/**
 * pub enum ieee80211_bss_change - BSS change notification flags
 *
 ...
 */
pub const IEEE80211_BSS_ARP_ADDR_LIST_LEN: u32 = 4;

/**
 * pub enum ieee80211_event_type - event to be notified to the low level driver
...
/**
 * pub enum ieee80211_rssi_event_data - relevant when event type is %RSSI_EVENT
 * @RSSI_EVENT_HIGH: AP's rssi went below the threshold set by the driver.
 * @RSSI_EVENT_LOW: AP's rssi went above the threshold set by the driver.
 */
pub enum ieee80211_rssi_event_data {
	RSSI_EVENT_HIGH,
	RSSI_EVENT_LOW,
};

/**
 * pub struct ieee80211_rssi_event - data attached to an %RSSI_EVENT
 * @data: See &pub enum ieee80211_rssi_event_data
 */
pub struct ieee80211_rssi_event {
	pub enum ieee80211_rssi_event_data data;
};

/**
 * pub enum ieee80211_mlme_event_data - relevant when event type is %MLME_EVENT
 * @AUTH_EVENT: the MLME operation is authentication
 * @ASSOC_EVENT: the MLME operation is association
 * @DEAUTH_RX_EVENT: deauth received..
 * @DEAUTH_TX_EVENT: deauth sent.
 */
pub enum ieee80211_mlme_event_data {
	AUTH_EVENT,
	ASSOC_EVENT,
	DEAUTH_RX_EVENT,
	DEAUTH_TX_EVENT,
...
/**
 * pub enum ieee80211_mlme_event_status - relevant when event type is %MLME_EVENT
 * @MLME_SUCCESS: the MLME operation completed successfully.
 * @MLME_DENIED: the MLME operation was denied by the peer.
 * @MLME_TIMEOUT: the MLME operation timed out.
 */
pub enum ieee80211_mlme_event_status {
	MLME_SUCCESS,
	MLME_DENIED,
	MLME_TIMEOUT,
};
...
/**
 * pub struct ieee80211_mlme_event - data attached to an %MLME_EVENT
 * @data: See &pub enum ieee80211_mlme_event_data
 * @status: See &pub enum ieee80211_mlme_event_status
 * @reason: the reason code if applicable
 */
pub struct ieee80211_mlme_event {
	pub enum ieee80211_mlme_event_data data;
	pub enum ieee80211_mlme_event_status status;
	u16 reason;
};

/**
 * pub struct ieee80211_ba_event - data attached for BlockAck related events
 * @sta: pointer to the &ieee80211_sta to which this event relates
 * @tid: the tid
 * @ssn: the starting sequence number (for %BAR_RX_EVENT)
 */
pub struct ieee80211_ba_event {
...
/**
 * pub struct ieee80211_event - event to be sent to the driver
 * @type: The event itself. See &pub enum ieee80211_event_type.
 ...
 * @u:pub union holding the fields above
 */
pub struct ieee80211_event {
	pub enum ieee80211_event_type type;
	pub union {
		pub struct ieee80211_rssi_event rssi;
		pub struct ieee80211_mlme_event mlme;
		pub struct ieee80211_ba_event ba;
	} u;
};

/**
 * pub struct ieee80211_mu_group_data - STA's VHT MU-MIMO group data
 *
 ...
 */
pub struct ieee80211_mu_group_data {
	u8 membership[WLAN_MEMBERSHIP_LEN];
	u8 position[WLAN_USER_POSITION_LEN];
};

/**
 * pub struct ieee80211_ftm_responder_params - FTM responder parameters
 *
 ...
 */
pub struct ieee80211_ftm_responder_params {
	*const u8lci;
	*const u8civicloc;
	size_t lci_len;
	size_t civicloc_len;
...
/**
 * pub struct ieee80211_fils_discovery - FILS discovery parameters from
 * IEEE Std 802.11ai-2016, Annex C.3 MIB detail.
 *
 * @min_interval: Minimum packet interval in TUs (0 - 10000)
 * @max_interval: Maximum packet interval in TUs (0 - 10000)
 */
pub struct ieee80211_fils_discovery {
	u32 min_interval;
	u32 max_interval;
};

pub const IEEE80211_TPE_EIRP_ENTRIES_320MHZ: u32 = 5;
pub struct ieee80211_parsed_tpe_eirp {
	bool valid;
	s8 power[IEEE80211_TPE_EIRP_ENTRIES_320MHZ];
	u8 count;
};

pub const IEEE80211_TPE_PSD_ENTRIES_320MHZ: u32 = 16;
pub struct ieee80211_parsed_tpe_psd {
	bool valid;
...
/**
 * pub struct ieee80211_parsed_tpe - parsed transmit power envelope information
 ...
 *	(indexed by TX power category)
 */
pub struct ieee80211_parsed_tpe {
	pub struct ieee80211_parsed_tpe_eirp max_local[2], max_reg_client[2];
	pub struct ieee80211_parsed_tpe_psd psd_local[2], psd_reg_client[2];
};

/**
 * pub struct ieee80211_bss_npca_params - NPCA parameters
 ...
 */
pub struct ieee80211_bss_npca_params {
...
/**
 * pub struct ieee80211_bss_conf - holds the BSS's changing parameters
 *
 ...
 * @ht_operation_mode: HT operation mode like in &pub struct ieee80211_ht_operation.
...
pub struct ieee80211_bss_conf {
	...
	*const u8bssid;
	...
	u8 sync_dtim_count;
	u32 basic_rates;
	pub struct ieee80211_rate *beacon_rate;
	...
	s32 cqm_rssi_low;
	s32 cqm_rssi_high;
	pub struct ieee80211_chan_req chanreq;
	pub struct ieee80211_mu_group_data mu_group;
	bool qos;
	bool hidden_ssid;
	int txpower;
	pub enum nl80211_tx_power_setting txpower_type;
	pub struct ieee80211_p2p_noa_attr p2p_noa_attr;
	bool allow_p2p_go_ps;
	u16 max_idle_period;
	bool protected_keep_alive;
	bool ftm_responder;
	pub struct ieee80211_ftm_responder_params *ftmr_params;
	/* Multiple BSSID data */
	bool nontransmitted;
	pub struct ieee80211_bss_conf __rcu *tx_bss_conf;
	...
	pub struct ieee80211_he_obss_pd he_obss_pd;
	pub struct cfg80211_he_bss_color he_bss_color;
	pub struct ieee80211_fils_discovery fils_discovery;
	u32 unsol_bcast_probe_resp_interval;
	pub struct cfg80211_bitrate_mask beacon_tx_rate;
	pub enum ieee80211_ap_reg_power power_type;

	pub struct ieee80211_parsed_tpe tpe;
	...
	bool mu_mimo_owner;
	pub struct ieee80211_chanctx_conf __rcu *chanctx_conf;
	...
	pub struct ieee80211_bss_npca_params npca;
};

pub const IEEE80211_NAN_MAX_CHANNELS: u32 = 3;

/**
 * pub struct ieee80211_nan_channel - NAN channel information
 *
 ...
 */
pub struct ieee80211_nan_channel {
	pub struct ieee80211_chan_req chanreq;
	u8 needed_rx_chains;
	pub struct ieee80211_chanctx_conf *chanctx_conf;
	u8 channel_entry[6];
};

/**
 * pub struct ieee80211_nan_peer_map - NAN peer schedule map
 *
 ...
 *	channels array
 */
pub struct ieee80211_nan_peer_map {
	u8 map_id;
	pub struct ieee80211_nan_channel *slots[CFG80211_NAN_SCHED_NUM_TIME_SLOTS];
};

/**
 * pub struct ieee80211_nan_peer_sched - NAN peer schedule
 *
 ...
 */
pub struct ieee80211_nan_peer_sched {
	u8 seq_id;
	u16 committed_dw;
	u16 max_chan_switch;
	*const u8init_ulw;
	u16 ulw_size;
	pub struct ieee80211_nan_peer_map maps[CFG80211_NAN_MAX_PEER_MAPS];
	u8 n_channels;
	pub struct ieee80211_nan_channel channels[] __counted_by(n_channels);
};

/**
 * pub enum mac80211_tx_info_flags - flags to describe transmission information/status
 *
 ...
 */
pub enum mac80211_tx_info_flags {
...
pub const IEEE80211_TX_CTL_STBC_SHIFT: u32 = 23;

#define IEEE80211_TX_RC_S1G_MCS IEEE80211_TX_RC_VHT_MCS

/**
 * pub enum mac80211_tx_control_flags - flags to describe transmit control
 *
 ...
 */
pub enum mac80211_tx_control_flags {
...
/**
 * pub enum mac80211_rate_control_flags - per-rate flags set by the
 *	Rate Control algorithm.
 *
 * These flags are set by the Rate control algorithm for each rate during tx,
 * in the @flags member of pub struct ieee80211_tx_rate.
 *
 ...
 */
pub enum mac80211_rate_control_flags {
...
pub const IEEE80211_TX_INFO_DRIVER_DATA_SIZE: u32 = 40;

/* if you do need the rateset, then you have less space */
pub const IEEE80211_TX_INFO_RATE_DRIVER_DATA_SIZE: u32 = 24;

/* maximum number of rate stages */
pub const IEEE80211_TX_MAX_RATES: u32 = 4;

/* maximum number of rate table entries */
pub const IEEE80211_TX_RATE_TABLE_SIZE: u32 = 4;

/**
 * pub struct ieee80211_tx_rate - rate selection/status
 *
 * @idx: rate index to attempt to send with
 * @flags: rate control flags (&pub enum mac80211_rate_control_flags)
 ...
 *
 * &pub struct ieee80211_tx_info contains an array of these structs
...
pub const IEEE80211_MAX_TX_RETRY: u32 = 31;

pub unsafe fn bool ieee80211_rate_valid(pub struct ieee80211_tx_rate *rate)
{
	return (*rate).idx >= 0 && (*rate).count > 0;
}

pub unsafe fn void ieee80211_rate_set_vht(pub struct ieee80211_tx_rate *rate,
					  mcs: u8, nss: u8)
{
	WARN_ON(mcs & ~0xF);
	WARN_ON((nss - 1) & ~0x7);
...
pub unsafe fn u8
ieee80211_rate_get_vht_mcs(const pub struct ieee80211_tx_rate *rate)
{
	return (*rate).idx & 0xF;
}

pub unsafe fn u8
ieee80211_rate_get_vht_nss(const pub struct ieee80211_tx_rate *rate)
{
	return ((*rate).idx >> 4) + 1;
}

/**
 * pub struct ieee80211_tx_info - skb transmit information
 *
 ...
 *	see also &pub enum ieee80211_status_data for the internal documentation
 ...
 * @control: pub union part for control data
 ...
 * @control.flags: control flags, see &pub enum mac80211_tx_control_flags
 ...
 * @status: pub union part for status data
 ...
 * @status.flags: status flags, see &pub enum mac80211_tx_status_flags
 ...
 * @ack: pub union part for pure ACK data
	...
	pub union {
		pub struct {
			pub union {
				/* rate control */
				pub struct {
					pub struct ieee80211_tx_rate rates[
			...
			pub struct ieee80211_vif *vif;
			pub struct ieee80211_key_conf *hw_key;
			u32 flags;
		...
		pub struct {
			pub struct ieee80211_tx_rate rates[IEEE80211_TX_MAX_RATES];
			s32 ack_signal;
			u8 ampdu_ack_len;
			u8 ampdu_len;
			u8 antenna;
		...
		pub struct {
			pub struct ieee80211_tx_rate driver_rates[
				IEEE80211_TX_MAX_RATES];
			u8 pad[4];
...
pub unsafe fn u16
ieee80211_info_set_tx_time_est(pub struct ieee80211_tx_info *info, tx_time_est: u16)
{
...
pub unsafe fn u16
ieee80211_info_get_tx_time_est(pub struct ieee80211_tx_info *info)
{
	return (*info).tx_time_est << 2;
}

/***
 * pub struct ieee80211_rate_status - mrr stage for status path
 *
 * This pub struct is used in pub struct ieee80211_tx_status to provide drivers a
 ...
 */
pub struct ieee80211_rate_status {
	pub struct rate_info rate_idx;
	u8 try_count;
	u8 tx_power_idx;
};

/**
 * pub struct ieee80211_tx_status - extended tx status info for rate control
 *
 ...
 */
pub struct ieee80211_tx_status {
	pub struct ieee80211_sta *sta;
	pub struct ieee80211_tx_info *info;
	pub struct sk_buff *skb;
	pub struct ieee80211_rate_status *rates;
	ktime_t ack_hwtstamp;
	u8 n_rates;

	pub struct list_head *free_list;
};

/**
 * pub struct ieee80211_scan_ies - descriptors for different blocks of IEs
 *
 ...
 */
pub struct ieee80211_scan_ies {
	*const u8ies[NUM_NL80211_BANDS];
...
pub unsafe fn pub struct ieee80211_tx_info *IEEE80211_SKB_CB(pub struct sk_buff *skb)
{
	return (*(pub struct ieee80211_tx_info *)skb).cb;
}

pub unsafe fn pub struct ieee80211_rx_status *IEEE80211_SKB_RXCB(pub struct sk_buff *skb)
{
	return (*(pub struct ieee80211_rx_status *)skb).cb;
}

/**
 * ieee80211_tx_info_clear_status - clear TX status
 *
 * @info: The &pub struct ieee80211_tx_info to be cleared.
 *
 ...
 */
pub unsafe fn void
ieee80211_tx_info_clear_status(pub struct ieee80211_tx_info *info)
{
	int i;

	BUILD_BUG_ON(offsetof(pub struct ieee80211_tx_info, status.rates) !=
		     offsetof(pub struct ieee80211_tx_info, control.rates));
	BUILD_BUG_ON(offsetof(pub struct ieee80211_tx_info, status.rates) !=
		     offsetof(pub struct ieee80211_tx_info, driver_rates));
	BUILD_BUG_ON(offsetof(pub struct ieee80211_tx_info, status.rates) != 8);
...
/**
 * pub enum mac80211_rx_flags - receive flags
 *
 * These flags are used with the @flag member of &pub struct ieee80211_rx_status.
 ...
 *	(&pub struct ieee80211_radiotap_he, mac80211 will fill in
 *	
 *	 - DATA3_DATA_MCS
 *	 - DATA3_DATA_DCM
 *	 - DATA3_CODING
 ...
 *	in &pub struct ieee80211_rx_status.  Note that if this value isn't
 *	known the frame shouldn't be reported.
 * @RX_FLAG_8023: the frame has an 802.3 header (decap offload performed by
 *	hardware or driver)
 * @RX_FLAG_RADIOTAP_VHT: VHT radiotap data is present
 */
pub enum mac80211_rx_flags {
...
/**
 * pub enum mac80211_rx_encoding_flags - MCS & bandwidth flags
 *
 ...
 */
pub enum mac80211_rx_encoding_flags {
...
pub const RX_ENC_FLAG_STBC_SHIFT: u32 = 4;

pub enum mac80211_rx_encoding {
	RX_ENC_LEGACY = 0,
	RX_ENC_HT,
	RX_ENC_VHT,
	RX_ENC_HE,
...
/**
 * pub struct ieee80211_rx_status - receive status
 *
 ...
 * @flag: %RX_FLAG_\*
 * @encoding: &pub enum mac80211_rx_encoding
 * @bw: &pub enum rate_info_bw
 * @enc_flags: uses bits from &pub enum mac80211_rx_encoding_flags
 * @he_ru: HE RU, from &pub enum nl80211_he_ru_alloc
 * @he_gi: HE GI, from &pub enum nl80211_he_gi
 * @he_dcm: HE DCM value
 * @eht: EHT specific rate information
 * @eht.ru: EHT RU, from &pub enum nl80211_eht_ru_alloc
 * @eht.gi: EHT GI, from &pub enum nl80211_eht_gi
 * @uhr: UHR specific rate information
 * @uhr.ru: UHR RU, from &pub enum nl80211_eht_ru_alloc
 * @uhr.gi: UHR GI, from &pub enum nl80211_eht_gi
 ...
 *	@link_valid.
 */
pub struct ieee80211_rx_status {
	u64 mactime;
	pub union {
		u64 boottime_ns;
...
static_assert(sizeof(pub struct ieee80211_rx_status) <= sizeof_field(pub struct sk_buff, cb));

pub unsafe fn u32
ieee80211_rx_status_to_khz(pub struct ieee80211_rx_status *rx_status)
{
...
/**
 * pub enum ieee80211_conf_flags - configuration flags
 *
...
/**
 * pub enum ieee80211_conf_changed - denotes which configuration changed
 *
 ...
 */
pub enum ieee80211_conf_changed {
...
/**
 * pub enum ieee80211_smps_mode - spatial multiplexing power save mode
 *
...
/**
 * pub struct ieee80211_conf - configuration of the device
 *
 * This pub struct indicates how the driver shall configure the hardware.
 *
...
pub struct ieee80211_conf {
	...
	long_frame_max_tx_count: u8, short_frame_max_tx_count;

	pub struct cfg80211_chan_def chandef;
	bool radar_enabled;
	pub enum ieee80211_smps_mode smps_mode;
};

/**
 * pub struct ieee80211_channel_switch - holds the channel switch data
 *
 ...
 */
pub struct ieee80211_channel_switch {
	u64 timestamp;
	u32 device_timestamp;
	bool block_tx;
	pub struct cfg80211_chan_def chandef;
...
/**
 * pub enum ieee80211_vif_flags - virtual interface flags
 *
...
/**
 * pub enum ieee80211_offload_flags - virtual interface offload flags
 *
...
pub enum ieee80211_offload_flags {
...
pub const IEEE80211_NAN_AVAIL_BLOB_MAX_LEN: u32 = 54;

/**
 * pub struct ieee80211_eml_params - EHT Operating mode notification parameters
 *
 * EML Operating mode notification parameters received in the Operating mode
 * notification frame. This pub struct is used as a container to pass the info to
 * the underlay driver.
 *
 ...
 *	P802.11be section 9.4.1.76 (valid if eMLMR mode control bit is set).
 */
pub struct ieee80211_eml_params {
	u8 link_id;
	u8 control;
	u16 link_bitmap;
...
/**
 * pub struct ieee80211_nan_sched_cfg - NAN schedule configuration
 ...
 */
pub struct ieee80211_nan_sched_cfg {
	pub struct ieee80211_nan_channel channels[IEEE80211_NAN_MAX_CHANNELS];
	pub struct ieee80211_nan_channel *schedule[CFG80211_NAN_SCHED_NUM_TIME_SLOTS];
...
/**
 * pub struct ieee80211_vif_cfg - interface configuration
 ...
 *	(station mode only)
 * @nan_sched: NAN schedule parameters. &pub struct ieee80211_nan_sched_cfg
 */
pub struct ieee80211_vif_cfg {
	/* association related data */
	assoc: bool, ibss_joined;
	bool ibss_creator;
	bool ps;
	u16 aid;
	u16 eml_cap;
	...
	pub struct ieee80211_nan_sched_cfg nan_sched;
};

pub const IEEE80211_TTLM_NUM_TIDS: u32 = 8;

/**
 * pub struct ieee80211_neg_ttlm - negotiated TID to link map info
 *
...
/**
 * pub enum ieee80211_neg_ttlm_res - return value for negotiated TTLM handling
 ...
 */
pub enum ieee80211_neg_ttlm_res {
	NEG_TTLM_RES_ACCEPT,
	NEG_TTLM_RES_REJECT,
...
/**
 * pub struct ieee80211_vif - per-interface data
 *
 * Data in this structure is continually present for driver
 * use during the life of a virtual interface.
 *
 * @type: type of this virtual interface
 * @cfg: vif configuration, see &pub struct ieee80211_vif_cfg
 ...
 *	see &pub struct ieee80211_neg_ttlm.
 ...
 *	&pub enum ieee80211_offload_flags.
 */
pub struct ieee80211_vif {
	pub enum nl80211_iftype type;
	pub struct ieee80211_vif_cfg cfg;
	pub struct ieee80211_bss_conf bss_conf;
	pub struct ieee80211_bss_conf __rcu *link_conf[IEEE80211_MLD_MAX_NUM_LINKS];
	valid_links: u16, active_links, dormant_links, suspended_links;
	pub struct ieee80211_neg_ttlm neg_ttlm;
	u8 addr[ETH_ALEN] __aligned(2);
	bool addr_valid;
	bool p2p;
	...
	pub struct ieee80211_txq *txq;
	pub struct ieee80211_txq *txq_mgmt;
 ...
 */
pub unsafe fn u16 ieee80211_vif_usable_links(const pub struct ieee80211_vif *vif)
{
 ...
 */
pub unsafe fn bool ieee80211_vif_is_mld(const pub struct ieee80211_vif *vif)
{
...
pub unsafe fn bool ieee80211_vif_is_mesh(pub struct ieee80211_vif *vif)
{
...
/**
 * wdev_to_ieee80211_vif - return a vif pub struct from a wdev
 ...
 */
pub struct ieee80211_vif *wdev_to_ieee80211_vif(pub struct wireless_dev *wdev);

/**
 * ieee80211_vif_to_wdev - return a wdev pub struct from a vif
 ...
 */
pub struct wireless_dev *ieee80211_vif_to_wdev(pub struct ieee80211_vif *vif);

pub unsafe fn bool lockdep_vif_wiphy_mutex_held(pub struct ieee80211_vif *vif)
{
...
/**
 * pub enum ieee80211_key_flags - key flags
 *
 * These flags are used for communication about keys between the driver
 * and mac80211, with the @flags parameter of &pub struct ieee80211_key_conf.
 *
...
/**
 * pub struct ieee80211_key_conf - key information
 *
 * This key information is given by mac80211 to the driver by
 * the set_key() callback in &pub struct ieee80211_ops.
 *
 ...
 * @flags: key flags, see &pub enum ieee80211_key_flags.
...
pub const IEEE80211_MAX_PN_LEN: u32 = 16;

#define TKIP_PN_TO_IV16(pn) ((u16)(pn & 0xffff))
#define TKIP_PN_TO_IV32(pn) ((u32)((pn >> 16) & 0xffffffff))

/**
 * pub struct ieee80211_key_seq - key sequence counter
 *
...
/**
 * pub enum set_key_cmd - key command
 *
 * Used with the set_key() callback in &pub struct ieee80211_ops, this
 * indicates whether a key is being removed or added.
 *
 * @SET_KEY: a key is set
 * @DISABLE_KEY: a key must be disabled
 */
pub enum set_key_cmd {
	SET_KEY, DISABLE_KEY,
};

/**
 * pub enum ieee80211_sta_state - station state
 *
...
/**
 * pub enum ieee80211_sta_rx_bandwidth - station RX bandwidth
 ...
 */
pub enum ieee80211_sta_rx_bandwidth {
...
/**
 * pub struct ieee80211_sta_rates - station rate selection table
 *
 * @rcu_head: RCU head used for freeing the table on update
 * @rate: transmit rates/flags to be used by default.
 *	Overriding entries per-packet is possible by using cb tx control.
 */
pub struct ieee80211_sta_rates {
	pub struct rcu_head rcu_head;
	pub struct {
		s8 idx;
		u8 count;
		u8 count_cts;
...
/**
 * pub struct ieee80211_sta_txpwr - station txpower configuration
 *
 ...
 *	per peer TPC.
 */
pub struct ieee80211_sta_txpwr {
	s16 power;
	pub enum nl80211_tx_power_setting type;
};

/**
 * pub struct ieee80211_sta_aggregates - info that is aggregated from active links
 *
 * Used for any per-link data that needs to be aggregated and updated in the
 * main &pub struct ieee80211_sta when updated or the active links change.
 *
 ...
 */
pub struct ieee80211_sta_aggregates {
	u16 max_amsdu_len;
...
/**
 * pub struct ieee80211_link_sta - station Link specific info
...
pub struct ieee80211_link_sta {
	...
	pub struct ieee80211_sta_ht_cap ht_cap;
	pub struct ieee80211_sta_vht_cap vht_cap;
	pub struct ieee80211_sta_he_cap he_cap;
	pub struct ieee80211_he_6ghz_capa he_6ghz_capa;
	pub struct ieee80211_sta_eht_cap eht_cap;
	pub struct ieee80211_sta_uhr_cap uhr_cap;
	pub struct ieee80211_sta_s1g_cap s1g_cap;

	pub struct ieee80211_sta_aggregates agg;

	u8 rx_nss;
	pub enum ieee80211_sta_rx_bandwidth bandwidth;
	pub struct ieee80211_sta_txpwr txpwr;
};

/**
 * pub struct ieee80211_sta - station table entry
 *
...
pub struct ieee80211_sta {
	...
	u8 uapsd_queues;
	u8 max_sp;
	pub struct ieee80211_sta_rates __rcu *rates;
	bool tdls;
	bool tdls_initiator;
	bool mfp;
	bool mlo;
	...
	pub struct ieee80211_sta_aggregates *cur;

	bool support_p2p_ps;

	pub struct ieee80211_txq *txq[IEEE80211_NUM_TIDS + 1];

	u16 valid_links;
	u16 ext_mld_capa_ops;
	bool epp_peer;
	pub struct ieee80211_link_sta deflink;
	pub struct ieee80211_link_sta __rcu *link[IEEE80211_MLD_MAX_NUM_LINKS];

	pub struct ieee80211_sta __rcu *nmi;

	/* should only be accessed with the wiphy mutex held */
	pub struct ieee80211_nan_peer_sched *nan_sched;
...
bool lockdep_sta_mutex_held(pub struct ieee80211_sta *pubsta);
#else
pub unsafe fn bool lockdep_sta_mutex_held(pub struct ieee80211_sta *pubsta)
{
	return true;
}
#endif
...
/**
 * pub enum sta_notify_cmd - sta notify command
 *
 * Used with the sta_notify() callback in &pub struct ieee80211_ops, this
 * indicates if an associated station made a power state transition.
 *
 * @STA_NOTIFY_SLEEP: a station is now sleeping
 * @STA_NOTIFY_AWAKE: a sleeping station woke up
 */
pub enum sta_notify_cmd {
	STA_NOTIFY_SLEEP, STA_NOTIFY_AWAKE,
};

/**
 * pub struct ieee80211_tx_control - TX control data
 *
 * @sta: station table entry, this sta pointer may be NULL and
 * 	it is not allowed to copy the pointer, due to RCU.
 */
pub struct ieee80211_tx_control {
	pub struct ieee80211_sta *sta;
};

/**
 * pub struct ieee80211_txq - Software intermediate tx queue
 *
 * @vif: &pub struct ieee80211_vif pointer from the add_interface callback.
...
/**
 * pub enum ieee80211_hw_flags - hardware flags
 *
 ...
 *	max_rc_amsdu_len in pub struct ieee80211_sta.
 *
...
/**
 * pub struct ieee80211_hw - hardware information and state
 *
 * This structure contains the configuration and hardware
 * information for an 802.11 PHY.
 *
 * @wiphy: This points to the &pub struct wiphy allocated for this
 *	802.11 PHY. You must fill in the @perm_addr and @dev
 *	members of this structure using SET_IEEE80211_DEV()
 *	and SET_IEEE80211_PERM_ADDR(). Additionally, all supported
 *	bands (with channels, bitrates) are registered here.
 *
 * @conf: &pub struct ieee80211_conf, device configuration, don't use.
 *
 * @priv: pointer to private area that was allocated for driver use
 *	along with this structure.
 *
 * @flags: hardware flags, see &pub enum ieee80211_hw_flags.
 *
 ...
 *	within &pub struct ieee80211_vif.
 * @sta_data_size: size (in bytes) of the drv_priv data area
 *	within &pub struct ieee80211_sta.
 * @chanctx_data_size: size (in bytes) of the drv_priv data area
 *	within &pub struct ieee80211_chanctx_conf.
 * @txq_data_size: size (in bytes) of the drv_priv data area
 *	within @pub struct ieee80211_txq.
 *
 ...
 *	field will be added and populated from the &pub struct ieee80211_rx_status
 *	device_timestamp.
...
pub struct ieee80211_hw {
	pub struct ieee80211_conf conf;
...
pub unsafe fn bool _ieee80211_hw_check(pub struct ieee80211_hw *hw,
				       pub enum ieee80211_hw_flags flg)
{
	return test_bit(flg, (*hw).flags);
}
#define ieee80211_hw_check(hw, flg)	_ieee80211_hw_check(hw, IEEE80211_HW_##flg)

pub unsafe fn void _ieee80211_hw_set(pub struct ieee80211_hw *hw,
				     pub enum ieee80211_hw_flags flg)
{
...
/**
 * pub struct ieee80211_scan_request - hw scan request
 *
 * @ies: pointers different parts of IEs (in req.ie)
 * @req: cfg80211 request.
 */
pub struct ieee80211_scan_request {
	pub struct ieee80211_scan_ies ies;

	/* Keep last */
	pub struct cfg80211_scan_request req;
};

/**
 * pub struct ieee80211_tdls_ch_sw_params - TDLS channel switch parameters
 *
 * @sta: peer this TDLS channel-switch request/response came from
 * @chandef: channel referenced in a TDLS channel-switch request
 * @action_code: see &pub enum ieee80211_tdls_actioncode
 ...
 */
pub struct ieee80211_tdls_ch_sw_params {
	pub struct ieee80211_sta *sta;
	pub struct cfg80211_chan_def *chandef;
	u8 action_code;
	u32 status;
	...
	u16 switch_time;
	u16 switch_timeout;
	pub struct sk_buff *tmpl_skb;
	u32 ch_sw_tm_ie;
};

/**
 * wiphy_to_ieee80211_hw - return a mac80211 driver hw pub struct from a wiphy
 *
 * @wiphy: the &pub struct wiphy which we want to query
 *
 * mac80211 drivers can use this to get to their respective
 * &pub struct ieee80211_hw. Drivers wishing to get to their own private
 * structure can then access it via hw->priv. Note that mac802111 drivers should
 * not use wiphy_priv() to try to get their private driver structure as this
 * is already used internally by mac80211.
 *
 * Return: The mac80211 driver hw pub struct of @wiphy.
 */
pub struct ieee80211_hw *wiphy_to_ieee80211_hw(pub struct wiphy *wiphy);

/**
 * SET_IEEE80211_DEV - set device for 802.11 hardware
 *
 * @hw: the &pub struct ieee80211_hw to set the device for
 * @dev: the &pub struct device of this 802.11 device
 */
pub unsafe fn void SET_IEEE80211_DEV(pub struct ieee80211_hw *hw, pub struct device *dev)
{
 ...
 *
 * @hw: the &pub struct ieee80211_hw to set the MAC address for
 * @addr: the address to set
 */
pub unsafe fn void SET_IEEE80211_PERM_ADDR(pub struct ieee80211_hw *hw, addr: *const u8)
{
	memcpy((*(*hw).wiphy).perm_addr, addr, ETH_ALEN);
}

pub unsafe fn pub struct ieee80211_rate *
ieee80211_get_tx_rate(const pub struct ieee80211_hw *hw,
		      const pub struct ieee80211_tx_info *c)
{
...
pub unsafe fn pub struct ieee80211_rate *
ieee80211_get_rts_cts_rate(const pub struct ieee80211_hw *hw,
			   const pub struct ieee80211_tx_info *c)
{
...
pub unsafe fn pub struct ieee80211_rate *
ieee80211_get_alt_retry_rate(const pub struct ieee80211_hw *hw,
			     const pub struct ieee80211_tx_info *c, int idx)
{
 ...
 */
void ieee80211_free_txskb(pub struct ieee80211_hw *hw, pub struct sk_buff *skb);
 ...
 */
void ieee80211_purge_tx_queue(pub struct ieee80211_hw *hw,
			      pub struct sk_buff_head *skbs);
 ...
 *
 * The set_key() callback in the &pub struct ieee80211_ops for a given
 ...
 * selected by the driver by modifying the &pub struct ieee80211_key_conf
 ...
 *
 * The &pub struct ieee80211_key_conf structure pointed to by the @key
 ...
 * so, the driver will set up the various queues in each &pub struct ieee80211_vif
 * and the offchannel queue in &pub struct ieee80211_hw. In response, mac80211 will
 * use those queue IDs in the hw_queue field of &pub struct ieee80211_tx_info and
...
/**
 * pub enum ieee80211_filter_flags - hardware filter flags
 *
 ...
 */
pub enum ieee80211_filter_flags {
	FIF_ALLMULTI		= 1<<1,
	FIF_FCSFAIL		= 1<<2,
	FIF_PLCPFAIL		= 1<<3,
...
/**
 * pub enum ieee80211_ampdu_mlme_action - A-MPDU actions
 *
 * These flags are used with the ampdu_action() callback in
 * &pub struct ieee80211_ops to indicate which action is needed.
 *
 ...
 */
pub enum ieee80211_ampdu_mlme_action {
...
pub const IEEE80211_AMPDU_TX_START_IMMEDIATE: u32 = 1;
pub const IEEE80211_AMPDU_TX_START_DELAY_ADDBA: u32 = 2;

/**
 * pub struct ieee80211_ampdu_params - AMPDU action parameters
 *
 ...
 *	%IEEE80211_AMPDU_RX_START
 */
pub struct ieee80211_ampdu_params {
	pub enum ieee80211_ampdu_mlme_action action;
	pub struct ieee80211_sta *sta;
	u16 tid;
	u16 ssn;
	u16 buf_size;
...
/**
 * pub enum ieee80211_frame_release_type - frame release reason
 * @IEEE80211_FRAME_RELEASE_PSPOLL: frame released for PS-Poll
 * @IEEE80211_FRAME_RELEASE_UAPSD: frame(s) released due to
 *	frame received on trigger-enabled AC
 */
pub enum ieee80211_frame_release_type {
	IEEE80211_FRAME_RELEASE_PSPOLL,
	IEEE80211_FRAME_RELEASE_UAPSD,
};

/**
 * pub enum ieee80211_rate_control_changed - flags to indicate what changed
 *
 ...
 *	by the peer
 */
pub enum ieee80211_rate_control_changed {
...
/**
 * pub enum ieee80211_roc_type - remain on channel type
 *
 ...
 */
pub enum ieee80211_roc_type {
	IEEE80211_ROC_TYPE_NORMAL = 0,
	IEEE80211_ROC_TYPE_MGMT_TX,
};

/**
 * pub enum ieee80211_reconfig_type - reconfig type
 *
 * This pub enum is used by the reconfig_complete() callback to indicate what
 ...
 */
pub enum ieee80211_reconfig_type {
	IEEE80211_RECONFIG_TYPE_RESTART,
	IEEE80211_RECONFIG_TYPE_SUSPEND,
};

/**
 * pub struct ieee80211_prep_tx_info - prepare TX information
 ...
 */
pub struct ieee80211_prep_tx_info {
	u16 duration;
	u16 subtype;
...
/**
 * pub struct ieee80211_ops - callbacks from mac80211 to the driver
 *
 ...
 *	(MLD) parameters from &pub struct ieee80211_vif_cfg that vary during the
 ...
 *	parameters from &pub struct ieee80211_bss_conf that are related to an
 ...
 *	from &pub enum ieee80211_rate_control_changed and the values are reflected
 ...
 *	&pub enum ieee80211_event_type for the different types.
 *	The callback must be atomic.
 *
 ...
 *	Additional information is passed in the &pub struct ieee80211_prep_tx_info
 ...
 *	notification frame.
 */
pub struct ieee80211_ops {
	void (*tx)(pub struct ieee80211_hw *hw,
		   pub struct ieee80211_tx_control *control,
		   pub struct sk_buff *skb);
	int (*start)(pub struct ieee80211_hw *hw);
	void (*stop)(pub struct ieee80211_hw *hw, suspend: bool);
#ifdef CONFIG_PM
	int (*suspend)(pub struct ieee80211_hw *hw, pub struct cfg80211_wowlan *wowlan);
	int (*resume)(pub struct ieee80211_hw *hw);
	void (*set_wakeup)(pub struct ieee80211_hw *hw, enabled: bool);
#endif
	int (*add_interface)(pub struct ieee80211_hw *hw,
			     pub struct ieee80211_vif *vif);
	int (*change_interface)(pub struct ieee80211_hw *hw,
				pub struct ieee80211_vif *vif,
				pub enum nl80211_iftype new_type, p2p: bool);
	void (*remove_interface)(pub struct ieee80211_hw *hw,
				 pub struct ieee80211_vif *vif);
	int (*config)(pub struct ieee80211_hw *hw, int radio_idx, changed: u32);
	void (*bss_info_changed)(pub struct ieee80211_hw *hw,
				 pub struct ieee80211_vif *vif,
				 pub struct ieee80211_bss_conf *info,
				 changed: u64);
	void (*vif_cfg_changed)(pub struct ieee80211_hw *hw,
				pub struct ieee80211_vif *vif,
				changed: u64);
	void (*link_info_changed)(pub struct ieee80211_hw *hw,
				  pub struct ieee80211_vif *vif,
				  pub struct ieee80211_bss_conf *info,
				  changed: u64);

	int (*start_ap)(pub struct ieee80211_hw *hw, pub struct ieee80211_vif *vif,
			pub struct ieee80211_bss_conf *link_conf);
	void (*stop_ap)(pub struct ieee80211_hw *hw, pub struct ieee80211_vif *vif,
			pub struct ieee80211_bss_conf *link_conf);
	...
	int (*set_key)(pub struct ieee80211_hw *hw, pub enum set_key_cmd cmd,
		       pub struct ieee80211_vif *vif, pub struct ieee80211_sta *sta,
		       pub struct ieee80211_key_conf *key);
	void (*update_tkip_key)(pub struct ieee80211_hw *hw,
				pub struct ieee80211_vif *vif,
				pub struct ieee80211_key_conf *conf,
				pub struct ieee80211_sta *sta,
				iv32: u32, u16 *phase1key);
	void (*set_rekey_data)(pub struct ieee80211_hw *hw,
			       pub struct ieee80211_vif *vif,
			       pub struct cfg80211_gtk_rekey_data *data);
	void (*set_default_unicast_key)(pub struct ieee80211_hw *hw,
					pub struct ieee80211_vif *vif, int idx);
	int (*hw_scan)(pub struct ieee80211_hw *hw, pub struct ieee80211_vif *vif,
		       pub struct ieee80211_scan_request *req);
	void (*cancel_hw_scan)(pub struct ieee80211_hw *hw,
			       pub struct ieee80211_vif *vif);
	int (*sched_scan_start)(pub struct ieee80211_hw *hw,
				pub struct ieee80211_vif *vif,
				pub struct cfg80211_sched_scan_request *req,
				pub struct ieee80211_scan_ies *ies);
	int (*sched_scan_stop)(pub struct ieee80211_hw *hw,
			       pub struct ieee80211_vif *vif);
	void (*sw_scan_start)(pub struct ieee80211_hw *hw,
			      pub struct ieee80211_vif *vif,
			      mac_addr: *const u8);
	void (*sw_scan_complete)(pub struct ieee80211_hw *hw,
				 pub struct ieee80211_vif *vif);
	int (*get_stats)(pub struct ieee80211_hw *hw,
			 pub struct ieee80211_low_level_stats *stats);
	void (*get_key_seq)(pub struct ieee80211_hw *hw,
			    pub struct ieee80211_key_conf *key,
			    pub struct ieee80211_key_seq *seq);
	int (*set_frag_threshold)(pub struct ieee80211_hw *hw, int radio_idx,
				  value: u32);
	int (*set_rts_threshold)(pub struct ieee80211_hw *hw, int radio_idx,
				 value: u32);
	int (*sta_add)(pub struct ieee80211_hw *hw, pub struct ieee80211_vif *vif,
		       pub struct ieee80211_sta *sta);
	int (*sta_remove)(pub struct ieee80211_hw *hw, pub struct ieee80211_vif *vif,
			  pub struct ieee80211_sta *sta);
#ifdef CONFIG_MAC80211_DEBUGFS
	void (*vif_add_debugfs)(pub struct ieee80211_hw *hw,
				pub struct ieee80211_vif *vif);
	void (*link_add_debugfs)(pub struct ieee80211_hw *hw,
				 pub struct ieee80211_vif *vif,
				 pub struct ieee80211_bss_conf *link_conf,
				 pub struct dentry *dir);
	void (*sta_add_debugfs)(pub struct ieee80211_hw *hw,
				pub struct ieee80211_vif *vif,
				pub struct ieee80211_sta *sta,
				pub struct dentry *dir);
	void (*link_sta_add_debugfs)(pub struct ieee80211_hw *hw,
				     pub struct ieee80211_vif *vif,
				     pub struct ieee80211_link_sta *link_sta,
				     pub struct dentry *dir);
#endif
	void (*sta_notify)(pub struct ieee80211_hw *hw, pub struct ieee80211_vif *vif,
			pub enum sta_notify_cmd, pub struct ieee80211_sta *sta);
	int (*sta_set_txpwr)(pub struct ieee80211_hw *hw,
			     pub struct ieee80211_vif *vif,
			     pub struct ieee80211_sta *sta);
	int (*sta_state)(pub struct ieee80211_hw *hw, pub struct ieee80211_vif *vif,
			 pub struct ieee80211_sta *sta,
			 pub enum ieee80211_sta_state old_state,
			 pub enum ieee80211_sta_state new_state);
	void (*sta_pre_rcu_remove)(pub struct ieee80211_hw *hw,
				   pub struct ieee80211_vif *vif,
				   pub struct ieee80211_sta *sta);
	void (*link_sta_rc_update)(pub struct ieee80211_hw *hw,
				   pub struct ieee80211_vif *vif,
				   pub struct ieee80211_link_sta *link_sta,
				   changed: u32);
	void (*sta_rate_tbl_update)(pub struct ieee80211_hw *hw,
				    pub struct ieee80211_vif *vif,
				    pub struct ieee80211_sta *sta);
	void (*sta_statistics)(pub struct ieee80211_hw *hw,
			       pub struct ieee80211_vif *vif,
			       pub struct ieee80211_sta *sta,
	...
	void (*set_tsf)(pub struct ieee80211_hw *hw, pub struct ieee80211_vif *vif,
			tsf: u64);
	void (*offset_tsf)(pub struct ieee80211_hw *hw, pub struct ieee80211_vif *vif,
			   s64 offset);
	void (*reset_tsf)(pub struct ieee80211_hw *hw, pub struct ieee80211_vif *vif);
	int (*tx_last_beacon)(pub struct ieee80211_hw *hw);
	void (*link_sta_statistics)(pub struct ieee80211_hw *hw,
				    pub struct ieee80211_vif *vif,
				    pub struct ieee80211_link_sta *link_sta,
				    pub struct link_station_info *link_sinfo);
	 ...
	 * The callback can sleep.
	 */
	int (*ampdu_action)(pub struct ieee80211_hw *hw,
			    pub struct ieee80211_vif *vif,
			    pub struct ieee80211_ampdu_params *params);
	int (*get_survey)(pub struct ieee80211_hw *hw, int idx,
		pub struct survey_info *survey);
	void (*rfkill_poll)(pub struct ieee80211_hw *hw);
	void (*set_coverage_class)(pub struct ieee80211_hw *hw, int radio_idx,
				   s16 coverage_class);
#ifdef CONFIG_NL80211_TESTMODE
	int (*testmode_cmd)(pub struct ieee80211_hw *hw, pub struct ieee80211_vif *vif,
			    void *data, int len);
	int (*testmode_dump)(pub struct ieee80211_hw *hw, pub struct sk_buff *skb,
			     pub struct netlink_callback *cb,
			     void *data, int len);
#endif
	void (*flush)(pub struct ieee80211_hw *hw, pub struct ieee80211_vif *vif,
		      queues: u32, drop: bool);
	void (*flush_sta)(pub struct ieee80211_hw *hw, pub struct ieee80211_vif *vif,
			  pub struct ieee80211_sta *sta);
	void (*channel_switch)(pub struct ieee80211_hw *hw,
			       pub struct ieee80211_vif *vif,
			       pub struct ieee80211_channel_switch *ch_switch);
	int (*set_antenna)(pub struct ieee80211_hw *hw, int radio_idx,
			   tx_ant: u32, rx_ant: u32);
	int (*get_antenna)(pub struct ieee80211_hw *hw, int radio_idx,
			   u32 *tx_ant, u32 *rx_ant);

	int (*remain_on_channel)(pub struct ieee80211_hw *hw,
				 pub struct ieee80211_vif *vif,
				 pub struct ieee80211_channel *chan,
				 int duration,
				 pub enum ieee80211_roc_type type);
	int (*cancel_remain_on_channel)(pub struct ieee80211_hw *hw,
					pub struct ieee80211_vif *vif);
	int (*set_ringparam)(pub struct ieee80211_hw *hw, tx: u32, rx: u32);
	void (*get_ringparam)(pub struct ieee80211_hw *hw,
			      u32 *tx, u32 *tx_max, u32 *rx, u32 *rx_max);
	bool (*tx_frames_pending)(pub struct ieee80211_hw *hw);
	int (*set_bitrate_mask)(pub struct ieee80211_hw *hw, pub struct ieee80211_vif *vif,
				const pub struct cfg80211_bitrate_mask *mask);
	void (*event_callback)(pub struct ieee80211_hw *hw,
			       pub struct ieee80211_vif *vif,
			       const pub struct ieee80211_event *event);

	void (*allow_buffered_frames)(pub struct ieee80211_hw *hw,
				      pub struct ieee80211_sta *sta,
				      tids: u16, int num_frames,
				      pub enum ieee80211_frame_release_type reason,
				      more_data: bool);
	void (*release_buffered_frames)(pub struct ieee80211_hw *hw,
					pub struct ieee80211_sta *sta,
					tids: u16, int num_frames,
					pub enum ieee80211_frame_release_type reason,
					more_data: bool);

	int	(*get_et_sset_count)(pub struct ieee80211_hw *hw,
				     pub struct ieee80211_vif *vif, int sset);
	void	(*get_et_stats)(pub struct ieee80211_hw *hw,
				pub struct ieee80211_vif *vif,
				pub struct ethtool_stats *stats, u64 *data);
	void	(*get_et_strings)(pub struct ieee80211_hw *hw,
				  pub struct ieee80211_vif *vif,
				  sset: u32, u8 *data);

	void	(*mgd_prepare_tx)(pub struct ieee80211_hw *hw,
				  pub struct ieee80211_vif *vif,
				  pub struct ieee80211_prep_tx_info *info);
	void	(*mgd_complete_tx)(pub struct ieee80211_hw *hw,
				   pub struct ieee80211_vif *vif,
				   pub struct ieee80211_prep_tx_info *info);
	...
	void (*remove_chanctx)(pub struct ieee80211_hw *hw,
			       pub struct ieee80211_chanctx_conf *ctx);
	void (*change_chanctx)(pub struct ieee80211_hw *hw,
			       pub struct ieee80211_chanctx_conf *ctx,
			       changed: u32);
	int (*assign_vif_chanctx)(pub struct ieee80211_hw *hw,
				  pub struct ieee80211_vif *vif,
				  pub struct ieee80211_bss_conf *link_conf,
				  pub struct ieee80211_chanctx_conf *ctx);
	void (*unassign_vif_chanctx)(pub struct ieee80211_hw *hw,
				     pub struct ieee80211_vif *vif,
				     pub struct ieee80211_bss_conf *link_conf,
				     pub struct ieee80211_chanctx_conf *ctx);
	int (*switch_vif_chanctx)(pub struct ieee80211_hw *hw,
				  pub struct ieee80211_vif_chanctx_switch *vifs,
				  int n_vifs,
				  pub enum ieee80211_chanctx_switch_mode mode);

	void (*reconfig_complete)(pub struct ieee80211_hw *hw,
				  pub enum ieee80211_reconfig_type reconfig_type);

#if IS_ENABLED(CONFIG_IPV6)
	void (*ipv6_addr_change)(pub struct ieee80211_hw *hw,
				 pub struct ieee80211_vif *vif,
				 pub struct inet6_dev *idev);
#endif
	void (*channel_switch_beacon)(pub struct ieee80211_hw *hw,
				      pub struct ieee80211_vif *vif,
				      pub struct cfg80211_chan_def *chandef);
	int (*pre_channel_switch)(pub struct ieee80211_hw *hw,
				  pub struct ieee80211_vif *vif,
				  pub struct ieee80211_channel_switch *ch_switch);

	int (*post_channel_switch)(pub struct ieee80211_hw *hw,
				   pub struct ieee80211_vif *vif,
				   pub struct ieee80211_bss_conf *link_conf);
	void (*abort_channel_switch)(pub struct ieee80211_hw *hw,
				     pub struct ieee80211_vif *vif,
				     pub struct ieee80211_bss_conf *link_conf);
	void (*channel_switch_rx_beacon)(pub struct ieee80211_hw *hw,
					 pub struct ieee80211_vif *vif,
					 pub struct ieee80211_channel_switch *ch_switch);

	int (*join_ibss)(pub struct ieee80211_hw *hw, pub struct ieee80211_vif *vif);
	void (*leave_ibss)(pub struct ieee80211_hw *hw, pub struct ieee80211_vif *vif);
	...
	int (*tdls_channel_switch)(pub struct ieee80211_hw *hw,
				   pub struct ieee80211_vif *vif,
				   pub struct ieee80211_sta *sta, oper_class: u8,
				   pub struct cfg80211_chan_def *chandef,
				   pub struct sk_buff *tmpl_skb, ch_sw_tm_ie: u32);
	void (*tdls_cancel_channel_switch)(pub struct ieee80211_hw *hw,
					   pub struct ieee80211_vif *vif,
					   pub struct ieee80211_sta *sta);
	void (*tdls_recv_channel_switch)(pub struct ieee80211_hw *hw,
					 pub struct ieee80211_vif *vif,
					 pub struct ieee80211_tdls_ch_sw_params *params);

	void (*wake_tx_queue)(pub struct ieee80211_hw *hw,
			      pub struct ieee80211_txq *txq);
	void (*sync_rx_queues)(pub struct ieee80211_hw *hw);

	int (*start_nan)(pub struct ieee80211_hw *hw,
			 pub struct ieee80211_vif *vif,
			 pub struct cfg80211_nan_conf *conf);
	int (*stop_nan)(pub struct ieee80211_hw *hw,
			pub struct ieee80211_vif *vif);
	int (*nan_change_conf)(pub struct ieee80211_hw *hw,
			       pub struct ieee80211_vif *vif,
			       pub struct cfg80211_nan_conf *conf, changes: u32);
	int (*add_nan_func)(pub struct ieee80211_hw *hw,
			    pub struct ieee80211_vif *vif,
			    const pub struct cfg80211_nan_func *nan_func);
	void (*del_nan_func)(pub struct ieee80211_hw *hw,
			    pub struct ieee80211_vif *vif,
			    instance_id: u8);
	int (*nan_peer_sched_changed)(pub struct ieee80211_hw *hw,
				      pub struct ieee80211_sta *sta);
	bool (*can_aggregate_in_amsdu)(pub struct ieee80211_hw *hw,
				       pub struct sk_buff *head,
				       pub struct sk_buff *skb);
	int (*get_ftm_responder_stats)(pub struct ieee80211_hw *hw,
				       pub struct ieee80211_vif *vif,
				       pub struct cfg80211_ftm_responder_stats *ftm_stats);
	int (*start_pmsr)(pub struct ieee80211_hw *hw, pub struct ieee80211_vif *vif,
			  pub struct cfg80211_pmsr_request *request);
	void (*abort_pmsr)(pub struct ieee80211_hw *hw, pub struct ieee80211_vif *vif,
			   pub struct cfg80211_pmsr_request *request);
	int (*set_tid_config)(pub struct ieee80211_hw *hw,
			      pub struct ieee80211_vif *vif,
			      pub struct ieee80211_sta *sta,
			      pub struct cfg80211_tid_config *tid_conf);
	int (*reset_tid_config)(pub struct ieee80211_hw *hw,
				pub struct ieee80211_vif *vif,
				pub struct ieee80211_sta *sta, tids: u8);
	void (*update_vif_offload)(pub struct ieee80211_hw *hw,
				   pub struct ieee80211_vif *vif);
	void (*sta_set_4addr)(pub struct ieee80211_hw *hw, pub struct ieee80211_vif *vif,
			      pub struct ieee80211_sta *sta, enabled: bool);
	int (*set_sar_specs)(pub struct ieee80211_hw *hw,
			     const pub struct cfg80211_sar_specs *sar);
	void (*sta_set_decap_offload)(pub struct ieee80211_hw *hw,
				      pub struct ieee80211_vif *vif,
				      pub struct ieee80211_sta *sta, enabled: bool);
	void (*add_twt_setup)(pub struct ieee80211_hw *hw,
			      pub struct ieee80211_sta *sta,
			      pub struct ieee80211_twt_setup *twt);
	void (*twt_teardown_request)(pub struct ieee80211_hw *hw,
				     pub struct ieee80211_sta *sta, flowid: u8);
	int (*set_radar_background)(pub struct ieee80211_hw *hw,
				    pub struct cfg80211_chan_def *chandef);
	int (*net_fill_forward_path)(pub struct ieee80211_hw *hw,
				     pub struct ieee80211_vif *vif,
				     pub struct ieee80211_sta *sta,
				     pub struct net_device_path_ctx *ctx,
				     pub struct net_device_path *path);
	bool (*can_activate_links)(pub struct ieee80211_hw *hw,
				   pub struct ieee80211_vif *vif,
				   active_links: u16);
	int (*change_vif_links)(pub struct ieee80211_hw *hw,
				pub struct ieee80211_vif *vif,
				old_links: u16, new_links: u16,
				pub struct ieee80211_bss_conf *old[IEEE80211_MLD_MAX_NUM_LINKS]);
	int (*change_sta_links)(pub struct ieee80211_hw *hw,
				pub struct ieee80211_vif *vif,
				pub struct ieee80211_sta *sta,
				old_links: u16, new_links: u16);
	int (*set_hw_timestamp)(pub struct ieee80211_hw *hw,
				pub struct ieee80211_vif *vif,
				pub struct cfg80211_set_hw_timestamp *hwts);
	int (*net_setup_tc)(pub struct ieee80211_hw *hw,
			    pub struct ieee80211_vif *vif,
			    pub struct net_device *dev,
			    pub enum tc_setup_type type,
			    void *type_data);
	pub enum ieee80211_neg_ttlm_res
	(*can_neg_ttlm)(pub struct ieee80211_hw *hw, pub struct ieee80211_vif *vif,
			pub struct ieee80211_neg_ttlm *ttlm);
	void (*prep_add_interface)(pub struct ieee80211_hw *hw,
				   pub enum nl80211_iftype type);
	int (*set_eml_op_mode)(pub struct ieee80211_hw *hw,
			       pub struct ieee80211_vif *vif,
			       pub struct ieee80211_sta *sta,
			       pub struct ieee80211_eml_params *eml_params);
};
 ...
 * @priv in &pub struct ieee80211_hw, the size of this area is given as
 * @priv_data_len.
 *
 ...
 */
pub struct ieee80211_hw *ieee80211_alloc_hw_nm(size_t priv_data_len,
					   const pub struct ieee80211_ops *ops,
 ...
 */
pub unsafe fn
pub struct ieee80211_hw *ieee80211_alloc_hw(size_t priv_data_len,
					const pub struct ieee80211_ops *ops)
{
 ...
 */
int ieee80211_register_hw(pub struct ieee80211_hw *hw);

/**
 * pub struct ieee80211_tpt_blink - throughput blink description
 * @throughput: throughput in Kbit/sec
 * @blink_time: blink time in milliseconds
 *	(full cycle, ie. one off + one on period)
 */
pub struct ieee80211_tpt_blink {
	int throughput;
	int blink_time;
};

/**
 * pub enum ieee80211_tpt_led_trigger_flags - throughput trigger flags
 * @IEEE80211_TPT_LEDTRIG_FL_RADIO: enable blinking with radio
 * @IEEE80211_TPT_LEDTRIG_FL_WORK: enable blinking when working
 * @IEEE80211_TPT_LEDTRIG_FL_CONNECTED: enable blinking when at least one
 *	interface is connected in some way, including being an AP
 */
pub enum ieee80211_tpt_led_trigger_flags {
...
const char *__ieee80211_get_tx_led_name(pub struct ieee80211_hw *hw);
const char *__ieee80211_get_rx_led_name(pub struct ieee80211_hw *hw);
const char *__ieee80211_get_assoc_led_name(pub struct ieee80211_hw *hw);
 ...
 */
pub unsafe fn const char *ieee80211_get_tx_led_name(pub struct ieee80211_hw *hw)
{
#ifdef CONFIG_MAC80211_LEDS
 ...
 * Return: The name of the LED trigger. %NULL if not configured for LEDs.
 */
pub unsafe fn const char *ieee80211_get_rx_led_name(pub struct ieee80211_hw *hw)
{
#ifdef CONFIG_MAC80211_LEDS
 ...
 * Return: The name of the LED trigger. %NULL if not configured for LEDs.
 */
pub unsafe fn const char *ieee80211_get_assoc_led_name(pub struct ieee80211_hw *hw)
{
#ifdef CONFIG_MAC80211_LEDS
 ...
 * Return: The name of the LED trigger. %NULL if not configured for LEDs.
 */
pub unsafe fn const char *ieee80211_get_radio_led_name(pub struct ieee80211_hw *hw)
{
#ifdef CONFIG_MAC80211_LEDS
 ...
 * @flags: trigger flags, see &pub enum ieee80211_tpt_led_trigger_flags
 ...
 */
void ieee80211_unregister_hw(pub struct ieee80211_hw *hw);
 ...
 */
void ieee80211_free_hw(pub struct ieee80211_hw *hw);
 ...
 */
void ieee80211_restart_hw(pub struct ieee80211_hw *hw);
 ...
 */
void ieee80211_rx_list(pub struct ieee80211_hw *hw, pub struct ieee80211_sta *sta,
		       pub struct sk_buff *skb, pub struct list_head *list);
 ...
 */
void ieee80211_rx_napi(pub struct ieee80211_hw *hw, pub struct ieee80211_sta *sta,
		       pub struct sk_buff *skb, pub struct napi_struct *napi);
 ...
 * @skb: the buffer to receive, owned by mac80211 after this call
 */
pub unsafe fn void ieee80211_rx(pub struct ieee80211_hw *hw, pub struct sk_buff *skb)
{
 ...
 * @skb: the buffer to receive, owned by mac80211 after this call
 */
void ieee80211_rx_irqsafe(pub struct ieee80211_hw *hw, pub struct sk_buff *skb);
 ...
 * @skb: the buffer to receive, owned by mac80211 after this call
 */
pub unsafe fn void ieee80211_rx_ni(pub struct ieee80211_hw *hw,
				   pub struct sk_buff *skb)
{
	local_bh_disable();
	ieee80211_rx(hw, skb);
 ...
 */
int ieee80211_sta_ps_transition(pub struct ieee80211_sta *sta, start: bool);
 ...
 */
pub unsafe fn int ieee80211_sta_ps_transition_ni(pub struct ieee80211_sta *sta,
						  start: bool)
{
	int ret;
 ...
 * be serialized.
 */
void ieee80211_sta_pspoll(pub struct ieee80211_sta *sta);
 ...
 * checks.
 */
void ieee80211_sta_uapsd_trigger(pub struct ieee80211_sta *sta, tid: u8);
 ...
 * @sta: &pub struct ieee80211_sta pointer for the sleeping station
 ...
 * use this API.
 */
void ieee80211_sta_set_buffered(pub struct ieee80211_sta *sta,
				tid: u8, buffered: bool);
 ...
 */
void ieee80211_get_tx_rates(pub struct ieee80211_vif *vif,
			    pub struct ieee80211_sta *sta,
			    pub struct sk_buff *skb,
			    pub struct ieee80211_tx_rate *dest,
			    int max_rates);
 ...
 */
void ieee80211_tx_rate_update(pub struct ieee80211_hw *hw,
			      pub struct ieee80211_sta *pubsta,
			      pub struct ieee80211_tx_info *info);
 ...
 */
void ieee80211_tx_status_skb(pub struct ieee80211_hw *hw,
			     pub struct sk_buff *skb);
 ...
 * fit into &pub struct ieee80211_tx_info.
 *
 ...
 */
void ieee80211_tx_status_ext(pub struct ieee80211_hw *hw,
			     pub struct ieee80211_tx_status *status);
 ...
 * @info: tx status information
 */
pub unsafe fn void ieee80211_tx_status_noskb(pub struct ieee80211_hw *hw,
					     pub struct ieee80211_sta *sta,
					     pub struct ieee80211_tx_info *info)
{
	pub struct ieee80211_tx_status status = {
 ...
 * @skb: the frame that was transmitted, owned by mac80211 after this call
 */
pub unsafe fn void ieee80211_tx_status_ni(pub struct ieee80211_hw *hw,
					  pub struct sk_buff *skb)
{
	local_bh_disable();
 ...
 * @skb: the frame that was transmitted, owned by mac80211 after this call
 */
void ieee80211_tx_status_irqsafe(pub struct ieee80211_hw *hw,
				 pub struct sk_buff *skb);
 ...
 */
void ieee80211_report_low_ack(pub struct ieee80211_sta *sta, num_packets: u32);

pub const IEEE80211_MAX_CNTDWN_COUNTERS_NUM: u32 = 2;

/**
 * pub struct ieee80211_mutable_offsets - mutable beacon offsets
 ...
 */
pub struct ieee80211_mutable_offsets {
	u16 tim_offset;
	u16 tim_length;
 ...
 * @vif: &pub struct ieee80211_vif pointer from the add_interface callback.
 * @offs: &pub struct ieee80211_mutable_offsets pointer to pub struct that will
 ...
 * @bcn.offs: &pub struct ieee80211_mutable_offsets pointer to pub struct that will
 *	receive the offsets that may be updated by the driver.
 */
 ...
 *
 * Return: EMA beacon templates of type pub struct ieee80211_ema_beacons *.
 *	%NULL on error.
 */
pub struct ieee80211_ema_beacons *
 ...
 * @ema_beacons: list of EMA beacons of type &pub struct ieee80211_ema_beacons pointers.
 *
 * This function will free a list previously acquired by calling
 * ieee80211_beacon_get_template_ema_list()
 */
void ieee80211_beacon_free_ema_list(pub struct ieee80211_ema_beacons *ema_beacons);
 ...
 */
void ieee80211_beacon_set_cntdwn(pub struct ieee80211_vif *vif, counter: u8);
 ...
 */
void ieee80211_color_change_finish(pub struct ieee80211_vif *vif, link_id: u8);
 ...
 */
pub struct sk_buff *ieee80211_proberesp_get(pub struct ieee80211_hw *hw,
					pub struct ieee80211_vif *vif);
 ...
 */
pub struct sk_buff *ieee80211_pspoll_get(pub struct ieee80211_hw *hw,
				     pub struct ieee80211_vif *vif);
 ...
 */
pub struct sk_buff *ieee80211_nullfunc_get(pub struct ieee80211_hw *hw,
				       pub struct ieee80211_vif *vif,
				       int link_id, qos_ok: bool);
 ...
 */
pub struct sk_buff *ieee80211_probereq_get(pub struct ieee80211_hw *hw,
				       src_addr: *const u8,
				       ssid: *const u8, size_t ssid_len,
				       size_t tailroom);
 ...
 * @frame_txctl: &pub struct ieee80211_tx_info of the frame.
 ...
 */
void ieee80211_rts_get(pub struct ieee80211_hw *hw, pub struct ieee80211_vif *vif,
		       const void *frame, size_t frame_len,
		       const pub struct ieee80211_tx_info *frame_txctl,
		       pub struct ieee80211_rts *rts);
 ...
 * Return: The duration.
 */
__le16 ieee80211_rts_duration(pub struct ieee80211_hw *hw,
			      pub struct ieee80211_vif *vif, size_t frame_len,
			      const pub struct ieee80211_tx_info *frame_txctl);
 ...
 */
void ieee80211_ctstoself_get(pub struct ieee80211_hw *hw,
			     pub struct ieee80211_vif *vif,
			     const void *frame, size_t frame_len,
			     const pub struct ieee80211_tx_info *frame_txctl,
			     pub struct ieee80211_cts *cts);
 ...
 * Return: The duration.
 */
__le16 ieee80211_ctstoself_duration(pub struct ieee80211_hw *hw,
				    pub struct ieee80211_vif *vif,
				    size_t frame_len,
				    const pub struct ieee80211_tx_info *frame_txctl);
 ...
 * Return: The duration.
 */
__le16 ieee80211_generic_frame_duration(pub struct ieee80211_hw *hw,
					pub struct ieee80211_vif *vif,
					pub enum nl80211_band band,
					size_t frame_len,
					pub struct ieee80211_rate *rate);
 ...
 */
pub struct sk_buff *
ieee80211_get_buffered_bc(pub struct ieee80211_hw *hw, pub struct ieee80211_vif *vif);
 ...
 */
void ieee80211_get_tkip_p1k_iv(pub struct ieee80211_key_conf *keyconf,
			       iv32: u32, u16 *p1k);
 ...
 * @p1k: a buffer to which the key will be written, as 5 u16 values
 */
pub unsafe fn void ieee80211_get_tkip_p1k(pub struct ieee80211_key_conf *keyconf,
					  pub struct sk_buff *skb, u16 *p1k)
{
	pub struct ieee80211_hdr *hdr = (*(pub struct ieee80211_hdr *)skb).data;
	*const u8data = (u8 *)hdr + ieee80211_hdrlen((*hdr).frame_control);
 ...
 * @p1k: a buffer to which the key will be written, as 5 u16 values
 */
void ieee80211_get_tkip_rx_p1k(pub struct ieee80211_key_conf *keyconf,
			       ta: *const u8, iv32: u32, u16 *p1k);
 ...
 */
void ieee80211_get_tkip_p2k(pub struct ieee80211_key_conf *keyconf,
			    pub struct sk_buff *skb, u8 *p2k);
 ...
 */
u8 *ieee80211_tkip_add_iv(u8 *pos, pub struct ieee80211_key_conf *keyconf, pn: u64);
 ...
 */
void ieee80211_get_key_rx_seq(pub struct ieee80211_key_conf *keyconf,
			      int tid, pub struct ieee80211_key_seq *seq);
 ...
 * can be done concurrently.
 */
void ieee80211_set_key_rx_seq(pub struct ieee80211_key_conf *keyconf,
			      int tid, pub struct ieee80211_key_seq *seq);
 ...
 */
pub struct ieee80211_key_conf *
ieee80211_gtk_rekey_add(pub struct ieee80211_vif *vif,
			idx: u8, u8 *key_data, key_len: u8,
			int link_id);
 ...
 */
void ieee80211_gtk_rekey_notify(pub struct ieee80211_vif *vif, bssid: *const u8,
				replay_ctr: *const u8, gfp_t gfp);
 ...
 */
void ieee80211_key_mic_failure(pub struct ieee80211_key_conf *keyconf);
 ...
 * @keyconf: the key in question
 */
void ieee80211_key_replay(pub struct ieee80211_key_conf *keyconf);
 ...
 */
void ieee80211_wake_queue(pub struct ieee80211_hw *hw, int queue);
 ...
 */
void ieee80211_stop_queue(pub struct ieee80211_hw *hw, int queue);
...
int ieee80211_queue_stopped(pub struct ieee80211_hw *hw, int queue);
 ...
 */
void ieee80211_stop_queues(pub struct ieee80211_hw *hw);
 ...
 */
void ieee80211_wake_queues(pub struct ieee80211_hw *hw);
 ...
 */
void ieee80211_scan_completed(pub struct ieee80211_hw *hw,
			      pub struct cfg80211_scan_info *info);
 ...
 */
void ieee80211_sched_scan_results(pub struct ieee80211_hw *hw);
 ...
 * @hw: the hardware that is performing scheduled scans
 */
void ieee80211_sched_scan_stopped(pub struct ieee80211_hw *hw);

/**
 * pub enum ieee80211_interface_iteration_flags - interface iteration flags
 ...
 *	for instance.
 */
pub enum ieee80211_interface_iteration_flags {
 ...
 *
 * @hw: the hardware pub struct of which the interfaces should be iterated over
 * @iter_flags: iteration flags, see &pub enum ieee80211_interface_iteration_flags
 * @iterator: the iterator function to call
 * @data: first argument of the iterator function
 */
void ieee80211_iterate_interfaces(pub struct ieee80211_hw *hw, iter_flags: u32,
 ...
 */
pub unsafe fn void
ieee80211_iterate_active_interfaces(pub struct ieee80211_hw *hw, iter_flags: u32,
				    void (*iterator)(void *data, u8 *mac,
						     pub struct ieee80211_vif *vif),
				    void *data)
{
 ...
 * @data: first argument of the iterator function
 */
void ieee80211_iterate_active_interfaces_atomic(pub struct ieee80211_hw *hw,
						iter_flags: u32,
...
pub struct ieee80211_vif *
__ieee80211_iterate_interfaces(pub struct ieee80211_hw *hw,
			       pub struct ieee80211_vif *prev,
			       iter_flags: u32);
 ...
 * @flags: the iteration flags, see &pub enum ieee80211_interface_iteration_flags
 */
 ...
 */
pub unsafe fn void
ieee80211_iterate_active_interfaces_mtx(pub struct ieee80211_hw *hw,
					iter_flags: u32,
					void (*iterator)(void *data, u8 *mac,
							 pub struct ieee80211_vif *vif),
					void *data)
 ...
 * @data: first argument of the iterator function
 */
void ieee80211_iterate_stations_atomic(pub struct ieee80211_hw *hw,
				       void (*iterator)(void *data,
						pub struct ieee80211_sta *sta),
				       void *data);

pub struct ieee80211_sta *
__ieee80211_iterate_stations(pub struct ieee80211_hw *hw,
			     pub struct ieee80211_sta *prev);
 ...
 */
pub unsafe fn void
ieee80211_iterate_stations_mtx(pub struct ieee80211_hw *hw,
			       void (*iterator)(void *data,
						pub struct ieee80211_sta *sta),
			       void *data)
{
 ...
 *
 * @hw: the hardware pub struct for the interface we are adding work for
 * @work: the work we want to add onto the mac80211 workqueue
 */
void ieee80211_queue_work(pub struct ieee80211_hw *hw, pub struct work_struct *work);
 ...
 */
void ieee80211_refresh_tx_agg_session_timer(pub struct ieee80211_sta *sta,
					    tid: u16);
 ...
 */
int ieee80211_start_tx_ba_session(pub struct ieee80211_sta *sta, tid: u16,
				  timeout: u16);
 ...
 * from any context.
 */
void ieee80211_start_tx_ba_cb_irqsafe(pub struct ieee80211_vif *vif, ra: *const u8,
				      tid: u16);
 ...
 * will be managed by the mac80211.
 */
int ieee80211_stop_tx_ba_session(pub struct ieee80211_sta *sta, tid: u16);
 ...
 */
void ieee80211_stop_tx_ba_cb_irqsafe(pub struct ieee80211_vif *vif, ra: *const u8,
				     tid: u16);
 ...
 */
pub struct ieee80211_sta *ieee80211_find_sta(pub struct ieee80211_vif *vif,
					 addr: *const u8);
 ...
 */
pub struct ieee80211_sta *ieee80211_find_sta_by_ifaddr(pub struct ieee80211_hw *hw,
					       addr: *const u8,
					       localaddr: *const u8);
 ...
 */
void ieee80211_sta_block_awake(pub struct ieee80211_hw *hw,
			       pub struct ieee80211_sta *pubsta, block: bool);
 ...
 */
void ieee80211_sta_eosp(pub struct ieee80211_sta *pubsta);
 ...
 */
void ieee80211_send_eosp_nullfunc(pub struct ieee80211_sta *pubsta, int tid);
 ...
 * &pub struct ieee80211_sta_aggregates by accessing the agg field of
 * &pub struct ieee80211_link_sta.
 *
 * With non MLO the data in deflink will be referenced directly. In that case
 * there is no need to call this function.
 */
void ieee80211_sta_recalc_aggregates(pub struct ieee80211_sta *pubsta);
 ...
 */
void ieee80211_sta_register_airtime(pub struct ieee80211_sta *pubsta, tid: u8,
				    tx_airtime: u32, rx_airtime: u32);
 ...
 */
bool
ieee80211_txq_airtime_check(pub struct ieee80211_hw *hw, pub struct ieee80211_txq *txq);
 ...
 */
u32 ieee80211_txq_aql_pending(pub struct ieee80211_hw *hw,
			      pub struct ieee80211_txq *txq);
 ...
 * set_key callback.
 */
void ieee80211_iter_keys(pub struct ieee80211_hw *hw,
			 pub struct ieee80211_vif *vif,
			 void (*iter)(pub struct ieee80211_hw *hw,
				      pub struct ieee80211_vif *vif,
				      pub struct ieee80211_sta *sta,
				      pub struct ieee80211_key_conf *key,
				      void *data),
 ...
 */
void ieee80211_iter_keys_rcu(pub struct ieee80211_hw *hw,
			     pub struct ieee80211_vif *vif,
			     void (*iter)(pub struct ieee80211_hw *hw,
					  pub struct ieee80211_vif *vif,
					  pub struct ieee80211_sta *sta,
 ...
 * Return: The Probe Request template. %NULL on error.
 */
pub struct sk_buff *ieee80211_ap_probereq_get(pub struct ieee80211_hw *hw,
					  pub struct ieee80211_vif *vif);
 ...
 */
void ieee80211_beacon_loss(pub struct ieee80211_vif *vif);
 ...
 */
void ieee80211_connection_loss(pub struct ieee80211_vif *vif);
 ...
 */
void ieee80211_disconnect(pub struct ieee80211_vif *vif, reconnect: bool);
 ...
 */
void ieee80211_resume_disconnect(pub struct ieee80211_vif *vif);
 ...
 * hardware restart.
 */
void ieee80211_hw_restart_disconnect(pub struct ieee80211_vif *vif);
 ...
 */
void ieee80211_cqm_rssi_notify(pub struct ieee80211_vif *vif,
			       pub enum nl80211_cqm_rssi_threshold_event rssi_event,
			       s32 rssi_level,
			       gfp_t gfp);
 ...
 * @gfp: context flags
 */
void ieee80211_cqm_beacon_loss_notify(pub struct ieee80211_vif *vif, gfp_t gfp);
 ...
 */
void ieee80211_radar_detected(pub struct ieee80211_hw *hw,
			      pub struct ieee80211_chanctx_conf *chanctx_conf);
 ...
 */
void ieee80211_channel_switch_disconnect(pub struct ieee80211_vif *vif);
 ...
 * @hw: pointer as obtained from ieee80211_alloc_hw()
 */
void ieee80211_ready_on_channel(pub struct ieee80211_hw *hw);

/**
 * ieee80211_remain_on_channel_expired - remain_on_channel duration expired
 * @hw: pointer as obtained from ieee80211_alloc_hw()
 */
void ieee80211_remain_on_channel_expired(pub struct ieee80211_hw *hw);
 ...
 */
void ieee80211_stop_rx_ba_session(pub struct ieee80211_vif *vif, ba_rx_bitmap: u16,
				  addr: *const u8);
 ...
 */
void ieee80211_mark_rx_ba_filtered_frames(pub struct ieee80211_sta *pubsta, tid: u8,
					  ssn: u16, filtered: u64,
					  received_mpdus: u16);
 ...
 */
void ieee80211_send_bar(pub struct ieee80211_vif *vif, u8 *ra, tid: u16, ssn: u16);
 ...
 * @tid: the rx tid
 */
pub unsafe fn void ieee80211_start_rx_ba_session_offl(pub struct ieee80211_vif *vif,
						      addr: *const u8, tid: u16)
{
 ...
 * @tid: the rx tid
 */
pub unsafe fn void ieee80211_stop_rx_ba_session_offl(pub struct ieee80211_vif *vif,
						     addr: *const u8, tid: u16)
{
	if (WARN_ON(tid >= IEEE80211_NUM_TIDS))
		return;
...
/**
 * pub struct ieee80211_tx_rate_control - rate control information for/from RC algo
 *
 ...
 */
pub struct ieee80211_tx_rate_control {
	pub struct ieee80211_hw *hw;
	pub struct ieee80211_supported_band *sband;
	pub struct ieee80211_bss_conf *bss_conf;
	pub struct sk_buff *skb;
	pub struct ieee80211_tx_rate reported_rate;
	rts: bool, short_preamble;
	u32 rate_idx_mask;
...
/**
 * pub enum rate_control_capabilities - rate control capabilities
 */
pub enum rate_control_capabilities {
	/**
...
pub struct rate_control_ops {
	...
	void (*add_debugfs)(pub struct ieee80211_hw *hw, void *priv,
			    pub struct dentry *debugfsdir);
	void (*free)(void *priv);

	void *(*alloc_sta)(void *priv, pub struct ieee80211_sta *sta, gfp_t gfp);
	void (*rate_init)(void *priv, pub struct ieee80211_supported_band *sband,
			  pub struct cfg80211_chan_def *chandef,
			  pub struct ieee80211_sta *sta, void *priv_sta);
	void (*rate_update)(void *priv, pub struct ieee80211_supported_band *sband,
			    pub struct cfg80211_chan_def *chandef,
			    pub struct ieee80211_sta *sta, void *priv_sta,
			    changed: u32);
	void (*free_sta)(void *priv, pub struct ieee80211_sta *sta,
			 void *priv_sta);

	void (*tx_status_ext)(void *priv,
			      pub struct ieee80211_supported_band *sband,
			      void *priv_sta, pub struct ieee80211_tx_status *st);
	void (*tx_status)(void *priv, pub struct ieee80211_supported_band *sband,
			  pub struct ieee80211_sta *sta, void *priv_sta,
			  pub struct sk_buff *skb);
	void (*get_rate)(void *priv, pub struct ieee80211_sta *sta, void *priv_sta,
			 pub struct ieee80211_tx_rate_control *txrc);
...
pub unsafe fn int rate_supported(pub struct ieee80211_sta *sta,
				 pub enum nl80211_band band,
				 int index)
{
...
pub unsafe fn s8
rate_lowest_index(pub struct ieee80211_supported_band *sband,
		  pub struct ieee80211_sta *sta)
{
	int i;
 ...
 *
 * @hw: pointer as obtained from ieee80211_alloc_hw()
 * @pubsta: &pub struct ieee80211_sta pointer to the target destination.
 * @rates: new tx rate set to be used for this station.
 *
 * Return: 0 on success. An error code otherwise.
 */
int rate_control_set_rates(pub struct ieee80211_hw *hw,
			   pub struct ieee80211_sta *pubsta,
			   pub struct ieee80211_sta_rates *rates);

int ieee80211_rate_control_register(const pub struct rate_control_ops *ops);
void ieee80211_rate_control_unregister(const pub struct rate_control_ops *ops);

pub unsafe fn bool
conf_is_ht20(pub struct ieee80211_conf *conf)
{
	return (*conf).chandef.width == NL80211_CHAN_WIDTH_20;
}

pub unsafe fn bool
conf_is_ht40_minus(pub struct ieee80211_conf *conf)
{
...
pub unsafe fn bool
conf_is_ht40_plus(pub struct ieee80211_conf *conf)
{
	return (*conf).chandef.width == NL80211_CHAN_WIDTH_40 &&
	       (*conf).chandef.center_freq1 > (*(*conf).chandef.chan).center_freq;
}
...
pub unsafe fn bool
conf_is_ht40(pub struct ieee80211_conf *conf)
{
	return (*conf).chandef.width == NL80211_CHAN_WIDTH_40;
}

pub unsafe fn bool
conf_is_ht(pub struct ieee80211_conf *conf)
{
...
pub unsafe fn pub enum nl80211_iftype
ieee80211_iftype_p2p(pub enum nl80211_iftype type, p2p: bool)
{
	if (p2p) {
		switch (type) {
...
pub unsafe fn pub enum nl80211_iftype
ieee80211_vif_type_p2p(pub struct ieee80211_vif *vif)
{
 ...
 *
 * Return: pointer to the pub struct ieee80211_sta_he_cap, or %NULL is none found
 */
pub unsafe fn const pub struct ieee80211_sta_he_cap *
ieee80211_get_he_iftype_cap_vif(const pub struct ieee80211_supported_band *sband,
				pub struct ieee80211_vif *vif)
{
 ...
 */
pub unsafe fn __le16
ieee80211_get_he_6ghz_capa_vif(const pub struct ieee80211_supported_band *sband,
			       pub struct ieee80211_vif *vif)
{
 ...
 * @vif: the vif to get the iftype from
 *
 * Return: pointer to the pub struct ieee80211_sta_eht_cap, or %NULL is none found
 */
pub unsafe fn const pub struct ieee80211_sta_eht_cap *
ieee80211_get_eht_iftype_cap_vif(const pub struct ieee80211_supported_band *sband,
				 pub struct ieee80211_vif *vif)
{
 ...
 * @vif: the vif to get the iftype from
 *
 * Return: pointer to the pub struct ieee80211_sta_uhr_cap, or %NULL is none found
 */
pub unsafe fn const pub struct ieee80211_sta_uhr_cap *
ieee80211_get_uhr_iftype_cap_vif(const pub struct ieee80211_supported_band *sband,
				 pub struct ieee80211_vif *vif)
{
...
void ieee80211_disable_rssi_reports(pub struct ieee80211_vif *vif);
 ...
 * applicable.
 */
int ieee80211_ave_rssi(pub struct ieee80211_vif *vif, int link_id);
 ...
 */
void ieee80211_report_wowlan_wakeup(pub struct ieee80211_vif *vif,
				    pub struct cfg80211_wowlan_wakeup *wakeup,
				    gfp_t gfp);
 ...
 */
bool ieee80211_tx_prepare_skb(pub struct ieee80211_hw *hw,
			      pub struct ieee80211_vif *vif, pub struct sk_buff *skb,
			      int band, pub struct ieee80211_sta **sta);
 ...
 */
bool ieee80211_parse_tx_radiotap(pub struct sk_buff *skb,
				 pub struct net_device *dev);

/**
 * pub struct ieee80211_noa_data - holds temporary data for tracking P2P NoA state
 *
 ...
 */
int ieee80211_parse_p2p_noa(const pub struct ieee80211_p2p_noa_attr *attr,
			    pub struct ieee80211_noa_data *data, tsf: u32);
 ...
 * @tsf: current TSF timestamp
 */
void ieee80211_update_p2p_noa(pub struct ieee80211_noa_data *data, tsf: u32);
 ...
 */
void ieee80211_tdls_oper_request(pub struct ieee80211_vif *vif, peer: *const u8,
				 pub enum nl80211_tdls_operation oper,
				 reason_code: u16, gfp_t gfp);
 ...
 */
int ieee80211_reserve_tid(pub struct ieee80211_sta *sta, tid: u8);
 ...
 */
void ieee80211_unreserve_tid(pub struct ieee80211_sta *sta, tid: u8);
 ...
 */
pub struct sk_buff *ieee80211_tx_dequeue(pub struct ieee80211_hw *hw,
				     pub struct ieee80211_txq *txq);
 ...
 * Return: the skb if successful, %NULL if no frame was available.
 */
pub unsafe fn pub struct sk_buff *ieee80211_tx_dequeue_ni(pub struct ieee80211_hw *hw,
						      pub struct ieee80211_txq *txq)
{
	pub struct sk_buff *skb;
 ...
 * callback in pub struct ieee80211_ops. They should not call this function.
 */
void ieee80211_handle_wake_tx_queue(pub struct ieee80211_hw *hw,
				    pub struct ieee80211_txq *txq);
 ...
 */
pub struct ieee80211_txq *ieee80211_next_txq(pub struct ieee80211_hw *hw, ac: u8);
 ...
 */
void ieee80211_txq_schedule_start(pub struct ieee80211_hw *hw, ac: u8);

/* (deprecated) */
pub unsafe fn void ieee80211_txq_schedule_end(pub struct ieee80211_hw *hw, ac: u8)
{
}

void __ieee80211_schedule_txq(pub struct ieee80211_hw *hw,
			      pub struct ieee80211_txq *txq, force: bool);
 ...
 */
pub unsafe fn void
ieee80211_schedule_txq(pub struct ieee80211_hw *hw, pub struct ieee80211_txq *txq)
{
 ...
 */
pub unsafe fn void
ieee80211_return_txq(pub struct ieee80211_hw *hw, pub struct ieee80211_txq *txq,
		     force: bool)
{
 ...
 */
bool ieee80211_txq_may_transmit(pub struct ieee80211_hw *hw,
				pub struct ieee80211_txq *txq);
 ...
 * @gfp: allocation flags
 */
void ieee80211_nan_func_terminated(pub struct ieee80211_vif *vif,
				   inst_id: u8,
				   pub enum nl80211_nan_func_term_reason reason,
				   gfp_t gfp);
 ...
 * cookie inside the match pub struct will be assigned by mac80211.
 * Note that this function can't be called from hard irq.
 *
 * @vif: &pub struct ieee80211_vif pointer from the add_interface callback.
 ...
 * @gfp: allocation flags
 */
void ieee80211_nan_func_match(pub struct ieee80211_vif *vif,
			      pub struct cfg80211_nan_match_params *match,
			      gfp_t gfp);
 ...
 * @vif: &pub struct ieee80211_vif pointer from the add_interface callback.
 */
void ieee80211_nan_sched_update_done(pub struct ieee80211_vif *vif);
 ...
 * @gfp: allocation flags
 */
void ieee80211_nan_cluster_joined(pub struct ieee80211_vif *vif,
				  cluster_id: *const u8, new_cluster: bool,
				  gfp_t gfp);
 ...
 */
bool ieee80211_nan_try_evacuate(pub struct ieee80211_hw *hw,
				pub struct ieee80211_chanctx_conf *conf);

/**
 * ieee80211_calc_rx_airtime - calculate estimated transmission airtime for RX.
 *
 * This function calculates the estimated airtime usage of a frame based on the
 * rate information in the RX status pub struct and the frame length.
 *
 * @hw: pointer as obtained from ieee80211_alloc_hw()
 * @status: &pub struct ieee80211_rx_status containing the transmission rate
 *          information.
 * @len: frame length in bytes
 *
 * Return: the airtime estimate
 */
u32 ieee80211_calc_rx_airtime(pub struct ieee80211_hw *hw,
			      pub struct ieee80211_rx_status *status,
			      int len);
 ...
 *
 * This function calculates the estimated airtime usage of a frame based on the
 * rate information in the TX info pub struct and the frame length.
 *
 * @hw: pointer as obtained from ieee80211_alloc_hw()
 * @info: &pub struct ieee80211_tx_info of the frame.
 * @len: frame length in bytes
 *
 * Return: the airtime estimate
 */
u32 ieee80211_calc_tx_airtime(pub struct ieee80211_hw *hw,
			      pub struct ieee80211_tx_info *info,
			      int len);
/**
 ...
 */
void
ieee80211_obss_color_collision_notify(pub struct ieee80211_vif *vif,
				      color_bitmap: u64, link_id: u8);
 ...
 */
pub unsafe fn bool ieee80211_is_tx_data(pub struct sk_buff *skb)
{
	pub struct ieee80211_tx_info *info = IEEE80211_SKB_CB(skb);
	pub struct ieee80211_hdr *hdr = (void *) (*skb).data;
 ...
 * Return: 0 on success. An error code otherwise.
 */
int ieee80211_set_active_links(pub struct ieee80211_vif *vif, active_links: u16);
 ...
 */
void ieee80211_set_active_links_async(pub struct ieee80211_vif *vif,
				      active_links: u16);
 ...
 * TTLM request.
 */
void ieee80211_send_teardown_neg_ttlm(pub struct ieee80211_vif *vif);
 ...
 */
pub unsafe fn pub enum ieee80211_sta_rx_bandwidth
ieee80211_chan_width_to_rx_bw(pub enum nl80211_chan_width width)
{
	switch (width) {
	default:
		WARN_ON_ONCE(1);
 ...
 */
bool ieee80211_prepare_rx_omi_bw(pub struct ieee80211_link_sta *link_sta,
				 pub enum ieee80211_sta_rx_bandwidth bw);
 ...
 * as well.
 */
void ieee80211_finalize_rx_omi_bw(pub struct ieee80211_link_sta *link_sta);

/* for older drivers - let's not document these ... */
int ieee80211_emulate_add_chanctx(pub struct ieee80211_hw *hw,
				  pub struct ieee80211_chanctx_conf *ctx);
void ieee80211_emulate_remove_chanctx(pub struct ieee80211_hw *hw,
				      pub struct ieee80211_chanctx_conf *ctx);
void ieee80211_emulate_change_chanctx(pub struct ieee80211_hw *hw,
				      pub struct ieee80211_chanctx_conf *ctx,
				      changed: u32);
int ieee80211_emulate_switch_vif_chanctx(pub struct ieee80211_hw *hw,
					 pub struct ieee80211_vif_chanctx_switch *vifs,
					 int n_vifs,
					 pub enum ieee80211_chanctx_switch_mode mode);
 ...
 */
bool ieee80211_vif_nan_started(pub struct ieee80211_vif *vif);
 ...
 */
int ieee80211_encrypt_tx_skb(pub struct sk_buff *skb);
