// Translated from sdca_function.h.
...
// Header guard: __SDCA_FUNCTION_H__


// Dependency: linux/bits.h
// Dependency: linux/types.h
// Dependency: linux/hid.h
 ...
 */
#[inline]
pub const fn SDCA_CTL_TYPE(ent: i32, sel: i32) . i32 { (ent << 8) | sel }
...
/**
 * sdca_messageoffset_range - Column definitions UMP MessageOffset
 */
sdca_messageoffset_range {
...
/**
 * sdca_it_controls - SDCA Controls for Input Terminal
 *
...
/**
 * sdca_ot_controls - SDCA Controls for Output Terminal
 *
...
/**
 * sdca_usage_range - Column definitions for Usage
 */
sdca_usage_range {
	SDCA_USAGE_NUMBER				= 0,
	SDCA_USAGE_CBN					= 1,
...
/**
 * sdca_dataport_selector_range - Column definitions for DataPort_Selector
 */
sdca_dataport_selector_range {
	SDCA_DATAPORT_SELECTOR_NCOLS			= 16,
	SDCA_DATAPORT_SELECTOR_NROWS			= 4,
};

/**
 * sdca_mu_controls - SDCA Controls for Mixer Unit
 *
...
/**
 * sdca_su_controls - SDCA Controls for Selector Unit
 *
...
/**
 * sdca_fu_controls - SDCA Controls for Feature Unit
 *
...
/**
 * sdca_volume_range - Column definitions for Q7.8dB volumes/gains
 */
sdca_volume_range {
...
/**
 * sdca_xu_controls - SDCA Controls for Extension Unit
 *
...
/**
 * sdca_fdl_set_index_range - Column definitions UMP SetIndex
 */
...
/**
 * sdca_cs_controls - SDCA Controls for Clock Source
 *
...
/**
 * sdca_samplerateindex_range - Column definitions for SampleRateIndex
 */
sdca_samplerateindex_range {
...
/**
 * sdca_cx_controls - SDCA Controls for Clock Selector
 *
...
/**
 * sdca_pde_controls - SDCA Controls for Power Domain Entity
 *
...
/**
 * sdca_requested_ps_range - Column definitions for Requested PS
 */
sdca_requested_ps_range {
	SDCA_REQUESTED_PS_STATE				= 0,
	SDCA_REQUESTED_PS_NCOLS				= 1,
};

/**
 * sdca_ge_controls - SDCA Controls for Group Unit
 *
...
/**
 * sdca_selected_mode_range - Column definitions for Selected Mode
 */
sdca_selected_mode_range {
...
/**
 * sdca_detected_mode_values - Predefined GE Detected Mode values
 */
sdca_detected_mode_values {
...
/**
 * sdca_spe_controls - SDCA Controls for Security & Privacy Unit
 *
...
/**
 * sdca_cru_controls - SDCA Controls for Channel Remapping Unit
 *
...
/**
 * sdca_udmpu_controls - SDCA Controls for Up-Down Mixer Processing Unit
 *
...
/**
 * sdca_mfpu_controls - SDCA Controls for Multi-Function Processing Unit
 *
...
/**
 * sdca_smpu_controls - SDCA Controls for Smart Mic Processing Unit
 *
...
/**
 * sdca_sapu_controls - SDCA Controls for Smart Amp Processing Unit
 *
...
/**
 * sdca_ppu_controls - SDCA Controls for Post Processing Unit
 *
...
/**
 * sdca_tg_controls - SDCA Controls for Tone Generator Entity
 *
...
/**
 * sdca_hide_controls - SDCA Controls for HIDE Entity
 *
...
/**
 * sdca_entity0_controls - SDCA Controls for Entity 0
 *
 * Control Selectors for Entity 0 from SDCA specification v1.0 Section
 * 6.7.1.1.
 */
sdca_entity0_controls {
...
/**
 * sdca_access_mode - SDCA Control access mode
 *
...
/**
 * sdca_access_layer - SDCA Control access layer
 *
...
struct sdca_control {
	...
	sdca_control_datatype type;
	struct sdca_control_range range;
	sdca_access_mode mode;
	u8 layers;
...
/**
 * sdca_terminal_type - SDCA Terminal Types
 *
...
struct sdca_entity_iot {
	...
	sdca_terminal_type type;
	sdca_connector_type connector;
	int reference;
	int num_transducer;
...
/**
 * sdca_clock_type - SDCA Clock Types
 *
...
struct sdca_entity_cs {
	sdca_clock_type type;
	u32 max_delay;
};

/**
 * sdca_pde_power_state - SDCA Power States
 *
...
/**
 * sdca_entity_type - SDCA Entity Type codes
...
struct sdca_entity_hide {
	...
	int num_hidtx_ids;
	int num_hidrx_ids;
	u32 af_number_list[SDCA_MAX_FUNCTION_COUNT];
	u32 hide_reside_function_num;
	u32 max_delay;
};

/**
 * sdca_xu_reset_mechanism - SDCA FDL Resets
 */
sdca_xu_reset_mechanism {
...
struct sdca_entity_xu {
	u32 max_delay;
	sdca_xu_reset_mechanism reset_mechanism;
};
 ...
 * @group: Pointer to Group Entity controlling this one, core::ptr::null_mut() if N/A.
...
/**
 * sdca_channel_purpose - SDCA Channel Purpose code
 *
 * Channel Purpose codes as described in the SDCA specification v1.0
 * section 11.4.3.
 */
sdca_channel_purpose {
	/* Table 210 - Purpose */
...
/**
 * sdca_channel_relationship - SDCA Channel Relationship code
 *
 * Channel Relationship codes as described in the SDCA specification
 * v1.0 section 11.4.2.
 */
sdca_channel_relationship {
	/* Table 206 - Streaming */
...
struct sdca_channel {
	int id;
	sdca_channel_purpose purpose;
	sdca_channel_relationship relationship;
};
...
/**
 * sdca_cluster_range - SDCA Range column definitions for ClusterIndex
 */
sdca_cluster_range {
