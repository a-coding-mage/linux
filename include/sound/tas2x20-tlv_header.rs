...
//
// Translated from tas2x20-tlv.h.
//
pub const TAS2X20_DVC_LEVEL: u32 = TASDEVICE_REG!(0x0, 0x2, 0x0c);
pub const TAS2X20_AMP_LEVEL: u32 = TASDEVICE_REG!(0x0, 0x0, 0x07);

pub static tas2x20_dvc_tlv, 1650, 50, 0);
pub static tas2x20_amp_tlv, 2100, 50, 0);

/* pow(10, db/20) * pow(2,22) */
pub static tas2x20_dvc_table: [[u8; 4]] = [
