...
extern "C" { fn container_of<T>(p:*mut c_void,o:usize)->*mut T; fn scatterwalk_advance(_: *mut c_void,_: u32); fn scatterwalk_done_src(_: *mut c_void,_: u32); fn scatterwalk_map(_: *mut c_void); fn scatterwalk_done_dst(_: *mut c_void,_: u32); fn memcpy(_: *mut c_void,_: *const c_void,_: usize); fn memcpy_to_scatterwalk(_: *mut c_void,_: *mut c_void,_: u32); fn cond_resched(); fn kfree(_: *mut c_void); fn free_page(_: c_ulong); fn kzalloc(_: usize,_: gfp_t)->*mut c_void; fn kmalloc(_: usize,_: gfp_t)->*mut c_void; fn crypto_tfm_ctx_alignment()->u32; fn ptr_align(_: *mut c_void,_: u32)->*mut c_void; fn memcpy_from_scatterwalk(_: *mut c_void,_: *mut c_void,_: u32); fn offset_in_page(_: u32)->c_ulong; fn sg_page(_: *mut c_void)->*mut c_void; fn __get_free_page(_: gfp_t)->c_ulong; fn align(_: u32,_: u32)->u32; fn min(_: u32,_: u32)->u32; fn max(_: u32,_: u32)->u32; fn in_hardirq()->bool; fn might_sleep_if(_: u32); fn crypto_skcipher_reqtfm(_: *mut skcipher_request)->*mut c_void; fn crypto_skcipher_alg(_: *mut c_void)->*mut skcipher_alg; fn crypto_skcipher_blocksize(_: *mut c_void)->u32; fn crypto_skcipher_ivsize(_: *mut c_void)->u32; fn crypto_skcipher_alignmask(_: *mut c_void)->u32; fn scatterwalk_start(_: *mut c_void,_: *mut c_void); }
