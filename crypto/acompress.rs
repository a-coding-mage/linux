...
extern "C" {
    ...
    fn crypto_alloc_tfm(_: *const i8, _: *const CryptoType, _: U32, _: U32) -> *mut CryptoAc​omp;
    fn crypto_alloc_tfm_node(_: *const i8, _: *const CryptoType, _: U32, _: U32, _: i32) -> *mut CryptoAc​omp;
    fn crypto_register_alg(_: *mut CryptoAlg) -> i32;
    fn crypto_unregister_alg(_: *mut CryptoAlg);
    fn crypto_free_acomp(_: *mut CryptoAc​omp);
    fn crypto_acomp_reqsize(_: *mut CryptoAc​omp) -> usize;
    fn crypto_acomp_reqtfm(_: *mut AcompReq) -> *mut CryptoAc​omp;
    fn crypto_acomp_compress(_: *mut AcompReq) -> i32;
    fn crypto_acomp_decompress(_: *mut AcompReq) -> i32;
    fn acomp_request_isnondma(_: *mut AcompReq) -> bool;
    fn acomp_request_issg(_: *mut AcompReq) -> bool;
    fn acomp_request_src_isvirt(_: *mut AcompReq) -> bool;
    fn acomp_request_dst_isvirt(_: *mut AcompReq) -> bool;
    fn acomp_req_on_stack(_: *mut AcompReq) -> bool;
    fn acomp_is_async(_: *mut CryptoAc​omp) -> bool;
    fn acomp_request_set_src_dma(_: *mut AcompReq, _: *const U8, _: u32);
    fn acomp_request_set_dst_dma(_: *mut AcompReq, _: *mut U8, _: u32);
    fn acomp_request_set_src_sg(_: *mut AcompReq, _: *mut ScatterList, _: u32);
    fn acomp_request_set_dst_sg(_: *mut AcompReq, _: *mut ScatterList, _: u32);
    fn sg_init_one(_: *mut ScatterList, _: *const c_void, _: usize);
    fn nla_put(_: *mut SkBuff, _: i32, _: usize, _: *const c_void) -> i32;
    fn seq_puts(_: *mut SeqFile, _: *const i8);
    fn crypto_init_scomp_ops_async(_: *mut CryptoTfm) -> i32;
