...
extern "C" {
    fn kstrtobool(_: *mut c_char, _: *mut bool) -> c_int;
    fn kstrtouint(_: *mut c_char, _: u32, _: *mut u32) -> c_int;
    fn kasan_enabled() -> bool;
    fn alloc_large_system_hash(_: *const c_char, _: usize, _: usize, _: u32, _: u32, _: *mut c_void, _: *mut u32, _: usize, _: usize) -> *mut list_head;
    fn memblock_alloc(_: usize, _: usize) -> *mut *mut c_void;
    fn memblock_free(_: *mut c_void, _: usize);
    fn kvzalloc_objs(ty: usize, n: usize) -> *mut list_head;
    fn kvcalloc(_: usize, _: usize, _: usize) -> *mut *mut c_void;
    fn kvfree(_: *mut c_void);
    fn nr_free_buffer_pages() -> usize;
    fn roundup_pow_of_two(_: usize) -> usize;
    ...
    fn raw_spin_trylock_irqsave(_: *mut c_void, _: *mut usize) -> bool;
    fn alloc_pages(_: usize, _: u32) -> *mut page; fn page_address(_: *mut page) -> *mut c_void;
    fn free_pages_nolock(_: *mut page, _: u32); fn free_pages(_: usize, _: u32); fn virt_to_page(_: *mut c_void) -> *mut page;
    fn gfpflags_allow_spinning(_: usize) -> bool; fn gfp_nested_mask(_: usize) -> usize; fn in_nmi() -> bool;
    fn filter_irq_stacks(_: *mut usize, _: u32) -> u32; fn jhash2(_: *const u32, _: u32, _: u32) -> u32;
    fn poll_state_synchronize_rcu(_: u64) -> bool; fn get_state_synchronize_rcu() -> u64;
    fn refcount_read(_: *const refcount_t) -> i32; fn refcount_set(_: *mut refcount_t, _: i32) -> bool;
    fn refcount_inc_not_zero(_: *mut refcount_t) -> bool; fn refcount_dec_and_test(_: *mut refcount_t) -> bool;
    fn kmsan_unpoison_memory(_: *const c_void, _: usize); fn memcpy(_: *mut c_void, _: *const c_void, _: usize) -> *mut c_void;
    fn stack_trace_print(_: *mut usize, _: u32, _: u32); fn stack_trace_snprint(_: *mut c_char, _: usize, _: *mut usize, _: u32, _: c_int) -> c_int;
    fn seq_printf(_: *mut seq_file, _: *const c_char, ... ) -> c_int;
}
