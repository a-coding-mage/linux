...
// POLYVAL_DIGEST_SIZE is supplied by the surrounding translation unit.
#[repr(C)]
struct HashTestvec {
    data_len: usize,
    digest: [u8; POLYVAL_DIGEST_SIZE],
}
...
static HASH_TESTVEC_CONSOLIDATED: [u8; POLYVAL_DIGEST_SIZE] = [
    0xdf, 0x68, 0x52, 0x99, 0x92, 0xc3, 0xe8, 0x88,
    0x29, 0x13, 0xc8, 0x35, 0x67, 0xa3, 0xd3, 0xad,
];

static POLYVAL_ALLONES_HASHOFHASHES: [u8; POLYVAL_DIGEST_SIZE] = [
