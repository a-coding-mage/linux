...
pub struct HashTestvec {
    pub data_len: usize,
    pub digest: [u8; BLAKE2B_HASH_SIZE],
}
...
pub static HASH_TESTVEC_CONSOLIDATED: [u8; BLAKE2B_HASH_SIZE] = [
...
pub static BLAKE2B_KEYED_TESTVEC_CONSOLIDATED: [u8; BLAKE2B_HASH_SIZE] = [
