...
// Dependency intent: Linux FIPS definitions and initialization annotations are external.

pub static fips_test_mldsa65_signature: &[u8] = &[
...
pub static fips_test_mldsa65_message: &[u8] = &[
