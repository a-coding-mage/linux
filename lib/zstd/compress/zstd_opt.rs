...
pub const ZSTD_LITFREQ_ADD: u32 = 2;  /* scaling factor for litFreq, so that frequencies adapt faster to new stats */
pub const ZSTD_MAX_PRICE: u32 = 1 << 30;

pub const ZSTD_PREDEF_THRESHOLD: u32 = 8;  /* if srcSize < ZSTD_PREDEF_THRESHOLD, symbols' cost is assumed static, directly determined by pre-defined distributions */
...
pub const BITCOST_ACCURACY: u32 = 0;
...
*/
const _ZSTD_OPT_TRANSLATION_SOURCE: &str = "zstd_opt.c source-level translation retained for external binding generation";
