...
/// Counts all bits of an unsigned 32-bit word.
#[inline]
pub fn __sw_hweight32(w: u32) -> u32 {
    ...
    #[cfg(not(CONFIG_ARCH_HAS_FAST_MULTIPLIER))]
    {
        ...
        res.wrapping_add(res >> 16) & 0x0000_00ff
    }
}

// EXPORT_SYMBOL(__sw_hweight32);

/// Preserves the C algorithm for every unsigned-int input, including high bits.
#[inline]
...
/// Counts all bits of an unsigned 64-bit word with the native unsigned-long result.
#[inline]
pub fn __sw_hweight64(w: u64) -> usize {
    // BITS_PER_LONG == 32
    #[cfg(target_pointer_width = "32")]
    {
        (__sw_hweight32((w >> 32) as u32).wrapping_add(__sw_hweight32(w as u32))) as usize
    }
    ...
    #[cfg(target_pointer_width = "64")]
    {
        ...
        #[cfg(CONFIG_ARCH_HAS_FAST_MULTIPLIER)]
        {
            ...
            value =
                (value & 0x3333_3333_3333_3333).wrapping_add((value >> 2) & 0x3333_3333_3333_3333);
            value = value.wrapping_add(value >> 4) & 0x0f0f_0f0f_0f0f_0f0f;
            (value.wrapping_mul(0x0101_0101_0101_0101) >> 56) as usize
        }

        #[cfg(not(CONFIG_ARCH_HAS_FAST_MULTIPLIER))]
        {
            let mut res = w.wrapping_sub((w >> 1) & 0x5555_5555_5555_5555);
            res = (res & 0x3333_3333_3333_3333).wrapping_add((res >> 2) & 0x3333_3333_3333_3333);
            res = res.wrapping_add(res >> 4) & 0x0f0f_0f0f_0f0f_0f0f;
            res = res.wrapping_add(res >> 8);
            res = res.wrapping_add(res >> 16);
            (res.wrapping_add(res >> 32) & 0x0000_0000_0000_00ff) as usize
        }
    }
}
