...
extern "C" { fn ldc_write(_: *mut ldc_channel,_: *mut core::ffi::c_void,_: i32)->i32; fn udelay(_: u32); fn spin_lock_irqsave(_: *mut core::ffi::c_void,_: *mut usize); fn spin_unlock_irqrestore(_: *mut core::ffi::c_void,_: usize); fn strcmp(_: *const i8,_: *const i8)->i32; fn strlen(_: *const i8)->usize; fn memcpy(_: *mut core::ffi::c_void,_: *const core::ffi::c_void,_: usize)->*mut core::ffi::c_void; fn memset(_: *mut core::ffi::c_void,_: i32,_: usize)->*mut core::ffi::c_void; fn kmalloc(_: usize,_: u32)->*mut core::ffi::c_void; fn kzalloc(_: usize,_: u32)->*mut core::ffi::c_void; fn kfree(_: *mut core::ffi::c_void); fn printk(_: *const i8,...); fn mdesc_update(); fn orderly_poweroff(_: bool); fn panic(_: *const i8)->!; fn __ds_send_placeholder(); }
