...
extern "C" { fn strcmp(_: *const i8,_: *const i8)->i32; fn strncmp(_: *const i8,_: *const i8,_: usize)->i32; fn strlen(_: *const i8)->usize; fn memset(_: *mut core::ffi::c_void,_: i32,_: usize)->*mut core::ffi::c_void; fn memcpy(_: *mut core::ffi::c_void,_: *const core::ffi::c_void,_: usize)->*mut core::ffi::c_void; fn kmalloc(_: usize,_: u32)->*mut core::ffi::c_void; fn kfree(_: *mut core::ffi::c_void); fn kstrdup_const(_: *const i8,_: u32)->*mut i8; fn kfree_const(_: *const i8); fn printk(_: *const i8,...); fn pr_err(_: *const i8,...); fn pr_info(_: *const i8,...); fn BUG_ON(_: bool); fn num_possible_cpus()->u32; fn cpu_data(_: u64)->*mut cpuinfo_sparc; fn mdesc_get_property(_: *mut mdesc_handle,_: u64,_: *const i8,_: *mut i32)->*const core::ffi::c_void; fn mdesc_node_name(_: *mut mdesc_handle,_: u64)->*const i8; fn mdesc_arc_target(_: *mut mdesc_handle,_: u64)->u64; fn mdesc_node_by_name(_: *mut mdesc_handle,_: u64,_: *const i8)->u64; fn mdesc_next_arc(_: *mut mdesc_handle,_: u64,_: *const i8)->u64; fn mdesc_grab()->*mut mdesc_handle; fn mdesc_release(_: *mut mdesc_handle); fn sun4v_mach_desc(_: u64,_: u64,_: *mut usize)->usize; fn __pa(_: *const core::ffi::c_void)->u64; fn prom_printf(_: *const i8,...); fn prom_halt(); fn mdesc_adi_init(); }
