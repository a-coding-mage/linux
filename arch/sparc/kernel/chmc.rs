...
extern "C" { static mut mctrl_list: list_head; fn list_add(_: *mut list_head,_: *mut list_head); fn list_del_init(_: *mut list_head); fn list_del(_: *mut list_head); fn spin_lock(_: *mut u8); fn spin_unlock(_: *mut u8); fn strlen(_: *const i8)->usize; fn sprintf(_: *mut i8, _: *const i8, ...); fn memcpy(_: *mut u8,_: *const u8,_: usize); fn kfree(_: *mut u8); fn printk(_: *const i8,...)->i32; fn of_find_node_by_path(_: *const i8)->*mut device_node; fn of_get_property(_: *mut device_node,_: *const i8,_: *mut i32)->*const u8; fn of_getintprop_default(_: *mut device_node,_: *const i8,_: i32)->i32; fn of_ioremap(_: *mut resource,_: usize,_: usize,_: *const i8)->*mut u8; fn of_iounmap(_: *mut resource,_: *mut u8,_: usize); fn dev_set_drvdata(_: *mut device,_: *mut u8); fn dev_get_drvdata(_: *mut device)->*mut u8; }
