...
#[cfg(CONFIG_PCI)] unsafe fn schizo_irq_trans_init(dp:*mut device_node){__schizo_irq_trans_init(dp,0)}
#[cfg(CONFIG_PCI)] unsafe fn tomatillo_irq_trans_init(dp:*mut device_node){__schizo_irq_trans_init(dp,1)}
