...
pub const ESTATE_ERROR_FMT: u64 = 0x0000000000040000; /* Force MTAG ECC */
pub const ESTATE_ERROR_FMESS: u64 = 0x000000000003c000; /* Forced MTAG ECC val */
pub const ESTATE_ERROR_FMD: u64 = 0x0000000000002000; /* Force DATA ECC */
pub const ESTATE_ERROR_FDECC: u64 = 0x0000000000001ff0; /* Forced DATA ECC val */
pub const ESTATE_ERROR_UCEEN: u64 = 0x0000000000000008; /* See below */
pub const ESTATE_ERROR_NCEEN: u64 = 0x0000000000000002; /* See below */
pub const ESTATE_ERROR_CEEN: u64 = 0x0000000000000001; /* See below */
