...
pub const GIO_32BIT_ID: u32 = 0x80;

macro_rules! GIO_REV {
    ($x:expr) => { (($x >> 8) & 0xff) };
}

pub const GIO_64BIT_IFACE: u32 = 0x10000;
pub const GIO_ROM_PRESENT: u32 = 0x20000;

macro_rules! GIO_VENDOR_CODE {
    ($x:expr) => { (($x >> 18) & 0x3fff) };
}

pub const GIO_SLOT_GFX_BASE: u32 = 0x1f000000;
pub const GIO_SLOT_EXP0_BASE: u32 = 0x1f400000;
pub const GIO_SLOT_EXP1_BASE: u32 = 0x1f600000;
