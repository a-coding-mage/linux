...
extern "C" {
    pub fn kvm_mips_complete_mmio_load(_: *mut kvm_vcpu) -> emulation_result;
    pub fn kvm_mips_read_count(_: *mut kvm_vcpu) -> u32; pub fn kvm_mips_write_count(_: *mut kvm_vcpu, _: u32); pub fn kvm_mips_write_compare(_: *mut kvm_vcpu, _: u32, _: bool); pub fn kvm_mips_init_count(_: *mut kvm_vcpu, _: usize); pub fn kvm_mips_set_count_ctl(_: *mut kvm_vcpu, _: i64) -> i32; pub fn kvm_mips_set_count_resume(_: *mut kvm_vcpu, _: i64) -> i32; pub fn kvm_mips_set_count_hz(_: *mut kvm_vcpu, _: i64) -> i32; pub fn kvm_mips_count_enable_cause(_: *mut kvm_vcpu); pub fn kvm_mips_count_disable_cause(_: *mut kvm_vcpu); pub fn kvm_mips_count_timeout(_: *mut kvm_vcpu) -> hrtimer_restart; pub fn kvm_mips_count_disabled(_: *mut kvm_vcpu) -> i32; pub fn kvm_mips_freeze_hrtimer(_: *mut kvm_vcpu, _: *mut u32) -> ktime_t; pub fn kvm_mips_restore_hrtimer(_: *mut kvm_vcpu, _: ktime_t, _: u32, _: i32) -> i32; pub fn kvm_vz_acquire_htimer(_: *mut kvm_vcpu); pub fn kvm_vz_lose_htimer(_: *mut kvm_vcpu); pub fn kvm_mips_emul_wait(_: *mut kvm_vcpu) -> emulation_result; pub fn kvm_mips_handle_hypcall(_: *mut kvm_vcpu) -> i32; pub fn kvm_mips_get_ramsize(_: *mut kvm) -> usize; pub fn kvm_vcpu_ioctl_interrupt(_: *mut kvm_vcpu, _: *mut kvm_mips_interrupt) -> i32;
}
