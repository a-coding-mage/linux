...
// Translated from bcm47xx_board.h.
// The C header guard __BCM47XX_BOARD_H has no direct Rust equivalent.

#[repr(C)]
#[derive(Debug, Copy, Clone, PartialEq, Eq)]
pub enum bcm47xx_board {
...
pub const BCM47XX_BOARD_MAX_NAME: usize = 30;
