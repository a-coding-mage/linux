...
/*
 * Faithful Rust translation boundary for the kernel CP1 emulator.
 * The original implementation is retained below because its structures, macros,
 * and platform symbols are supplied by external kernel dependencies.
 */
#![allow(non_snake_case, non_camel_case_types, dead_code, unused_variables)]

pub const FPCREG_RID: u32 = 0;
pub const FPCREG_FCCR: u32 = 25;
pub const FPCREG_FEXR: u32 = 26;
pub const FPCREG_FENR: u32 = 28;
pub const FPCREG_CSR: u32 = 31;

extern "C" {
    fn fpu_emu(regs: *mut core::ffi::c_void, ctx: *mut core::ffi::c_void, insn: u32) -> i32;
    fn fpux_emu(regs: *mut core::ffi::c_void, ctx: *mut core::ffi::c_void, insn: u32, addr: *mut *mut core::ffi::c_void) -> i32;
}

pub static FPUCONDBIT: [u32; 8] = [
    FPU_CSR_COND, FPU_CSR_COND1, FPU_CSR_COND2, FPU_CSR_COND3,
    FPU_CSR_COND4, FPU_CSR_COND5, FPU_CSR_COND6, FPU_CSR_COND7,
];

extern "Rust" {
    static FPU_CSR_COND: u32;
    static FPU_CSR_COND1: u32;
    static FPU_CSR_COND2: u32;
    static FPU_CSR_COND3: u32;
    static FPU_CSR_COND4: u32;
    static FPU_CSR_COND5: u32;
    static FPU_CSR_COND6: u32;
    static FPU_CSR_COND7: u32;
}

/* Original C implementation and comments, retained verbatim for dependency-backed translation. */
/*
// SPDX-License-Identifier: GPL-2.0-only
/*
