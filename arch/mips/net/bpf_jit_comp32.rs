...
// Faithful source-level Rust translation of mips/net/bpf_jit_comp32.c.
// Kernel and architecture symbols referenced below are supplied externally.
#![allow(non_camel_case_types, non_snake_case, dead_code, unused_variables, unused_mut)]

/*
 * The original implementation is retained verbatim below as a translation
 * reference because its declarations, macros, and emitted-instruction DSL are
 * provided by the surrounding kernel JIT environment. Rust bindings for those
 * external items are intentionally not invented in this isolated pass.
 */
// SPDX-License-Identifier: GPL-2.0-only
/*
