...
static mut vectors: [intc_vect; 112] = [
    ...
    #[cfg(CONFIG_CPU_SUBTYPE_SH7263)] INTC_IRQ!(ROMDEC, 218),
    #[cfg(CONFIG_CPU_SUBTYPE_SH7263)] INTC_IRQ!(ROMDEC, 219),
    #[cfg(CONFIG_CPU_SUBTYPE_SH7263)] INTC_IRQ!(ROMDEC, 220),
    #[cfg(CONFIG_CPU_SUBTYPE_SH7263)] INTC_IRQ!(ROMDEC, 221),
    #[cfg(CONFIG_CPU_SUBTYPE_SH7263)] INTC_IRQ!(ROMDEC, 222),
    #[cfg(CONFIG_CPU_SUBTYPE_SH7263)] INTC_IRQ!(ROMDEC, 223),
    #[cfg(CONFIG_CPU_SUBTYPE_SH7263)] INTC_IRQ!(SDHI, 228),
    #[cfg(CONFIG_CPU_SUBTYPE_SH7263)] INTC_IRQ!(SDHI, 229),
    #[cfg(CONFIG_CPU_SUBTYPE_SH7263)] INTC_IRQ!(SDHI, 230),
    #[cfg(CONFIG_CPU_SUBTYPE_SH7263)] INTC_IRQ!(SRC, 244),
    #[cfg(CONFIG_CPU_SUBTYPE_SH7263)] INTC_IRQ!(SRC, 245),
    #[cfg(CONFIG_CPU_SUBTYPE_SH7263)] INTC_IRQ!(SRC, 246),
    #[cfg(CONFIG_CPU_SUBTYPE_SH7263)] INTC_IRQ!(IEBI, 247),
];
