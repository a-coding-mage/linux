...
// Faithful low-level Rust translation of the SH7724 setup implementation.
// External kernel types, constants, macros, and functions are supplied by the surrounding kernel.
...
const RAMCR_CACHE_L2FC: u32 = 0x0002;
const RAMCR_CACHE_L2E: u32 = 0x0001;
const L2_CACHE_ENABLE: u32 = RAMCR_CACHE_L2E | RAMCR_CACHE_L2FC;

extern "C" { static RAMCR: u32; }

#[no_mangle]
pub unsafe extern "C" fn l2_cache_init() {
    __raw_writel(L2_CACHE_ENABLE, RAMCR as u32);
}
