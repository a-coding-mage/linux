...
// Dependency supplied by the platform's Linux I/O layer.
unsafe extern "C" {
...
pub enum Sh7786Pin {
    ...
    /* FLCTL */
    GPIO_FN_FALE, GPIO_FN_FRB, GPIO_FN_FSTATUS, GPIO_FN_FSE, GPIO_FN_FCLE,
    /* DMAC */
    ...
    /* USB */
    GPIO_FN_USB_OVC0, GPIO_FN_USB_PENC0, GPIO_FN_USB_OVC1, GPIO_FN_USB_PENC1,
    /* HAC */
    GPIO_FN_HAC_RES,
    GPIO_FN_HAC0_SDOUT, GPIO_FN_HAC0_SDIN, GPIO_FN_HAC0_SYNC, GPIO_FN_HAC0_BITCLK,
    GPIO_FN_HAC1_SDOUT, GPIO_FN_HAC1_SDIN, GPIO_FN_HAC1_SYNC, GPIO_FN_HAC1_BITCLK,
    /* SSI */
...
#[inline]
pub unsafe fn sh7786_mm_sel() -> u32 {
    unsafe { __raw_readl(0xFC400020usize as *const core::ffi::c_void) } & 0x7
}
