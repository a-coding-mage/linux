...
// external dependency: <asm/opcodes.h>
// external dependency: <asm/probes.h>
...
pub unsafe extern "C" fn kprobe_thumb16_test_cases() {
{
...
pub unsafe extern "C" fn kprobe_thumb32_test_cases() {
{
	kprobe_test_flags = 0;
