...
static t32_table_1110_100x_x0xx[DecodeItem; 0] = {
...
static t32_table_1110_100x_x1xx[DecodeItem; 0] = {
...
static t32_table_1110_101x[DecodeItem; 0] = {
...
static t32_table_1111_0x0x___0[DecodeItem; 0] = {
...
static t32_table_1111_0x1x___0[DecodeItem; 0] = {
...
static t32_table_1111_0xxx___1[DecodeItem; 0] = {
...
static t32_table_1111_100x_x0x1__1111[DecodeItem; 0] = {
	/* Memory hints							*/
...
static t32_table_1111_100x[DecodeItem; 0] = {
...
static t32_table_1111_1010___1111[DecodeItem; 0] = {
...
static t32_table_1111_1011_0[DecodeItem; 0] = {
...
static t32_table_1111_1011_1[DecodeItem; 0] = {
...
pub static probes_decode_thumb32_table[DecodeItem; 0] = {
...
#[cfg(CONFIG_ARM_KPROBES_TEST_MODULE)]


static t16_table_1011[DecodeItem; 0] = {
...
pub static probes_decode_thumb16_table[DecodeItem; 0] = {
...
unsafe fn thumb_check_cc(cpsr: u64) -> u64 {
	if (unlikely(in_it_block(cpsr)))
		return probes_condition_checks[current_cond(cpsr)](cpsr);
	return true
}

unsafe fn thumb16_singlestep(opcode: probes_opcode_t, asi: *mut arch_probes_insn, regs: *mut pt_regs) {
	(*regs).ARM_pc += 2;
	(*asi).insn_handler(opcode, asi, regs);
	(*regs).ARM_cpsr = it_advance((*regs).ARM_cpsr)
}

unsafe fn thumb32_singlestep(opcode: probes_opcode_t, asi: *mut arch_probes_insn, regs: *mut pt_regs) {
	(*regs).ARM_pc += 4;
	(*asi).insn_handler(opcode, asi, regs);
	(*regs).ARM_cpsr = it_advance((*regs).ARM_cpsr)
}

unsafe fn thumb16_probes_decode_insn(insn: probes_opcode_t, asi: *mut arch_probes_insn, emulate: bool, actions: *const decode_action, checkers: *const *const decode_checker) -> probes_insn {
...
unsafe fn thumb32_probes_decode_insn(insn: probes_opcode_t, asi: *mut arch_probes_insn, emulate: bool, actions: *const decode_action, checkers: *const *const decode_checker) -> probes_insn {
