...
#[cfg(any(CONFIG_SOC_OMAP2420, CONFIG_SOC_OMAP2430))]
...
#[cfg(any(CONFIG_SOC_AM33XX, CONFIG_SOC_AM43XX))]
...
#[cfg(CONFIG_SOC_OMAP2420)] pub unsafe fn omap242x_map_io() { map_io(OMAP24XX_IO_DESC.as_mut_ptr(), 2); map_io(OMAP242X_IO_DESC.as_mut_ptr(), 3); }
#[cfg(CONFIG_SOC_OMAP2430)] pub unsafe fn omap243x_map_io() { map_io(OMAP24XX_IO_DESC.as_mut_ptr(), 2); map_io(OMAP243X_IO_DESC.as_mut_ptr(), 4); }
#[cfg(CONFIG_ARCH_OMAP3)] pub unsafe fn omap3_map_io() { map_io(OMAP34XX_IO_DESC.as_mut_ptr(), 7); }
#[cfg(CONFIG_SOC_TI81XX)] pub unsafe fn ti81xx_map_io() { map_io(OMAPTI81XX_IO_DESC.as_mut_ptr(), 1); }
#[cfg(any(CONFIG_SOC_AM33XX, CONFIG_SOC_AM43XX))] pub unsafe fn am33xx_map_io() { map_io(OMAPAM33XX_IO_DESC.as_mut_ptr(), 2); }
#[cfg(CONFIG_ARCH_OMAP4)] pub unsafe fn omap4_map_io() { map_io(OMAP44XX_IO_DESC.as_mut_ptr(), 3); omap_barriers_init(); }
#[cfg(CONFIG_SOC_OMAP5)] pub unsafe fn omap5_map_io() { map_io(OMAP54XX_IO_DESC.as_mut_ptr(), 4); omap_barriers_init(); }
#[cfg(CONFIG_SOC_DRA7XX)] pub unsafe fn dra7xx_map_io() { map_io(DRA7XX_IO_DESC.as_mut_ptr(), 7); omap_barriers_init(); }
...
unsafe fn omap_hwmod_init_postsetup() {
    #[cfg(CONFIG_OMAP_HWMOD)] { let mut state: u8 = _HWMOD_STATE_DEFAULT; omap_hwmod_for_each(Some(_set_hwmod_postsetup_state), &mut state as *mut _ as *mut _); }
}

// SoC early/late initialization routines, translated with their original call ordering.
#[cfg(CONFIG_SOC_OMAP2420)] pub unsafe fn omap2420_init_early() { omap2_set_globals_tap(OMAP242X_CLASS, OMAP2_L4_IO_ADDRESS(0x48014000)); omap2_set_globals_sdrc(OMAP2_L3_IO_ADDRESS(OMAP2420_SDRC_BASE), OMAP2_L3_IO_ADDRESS(OMAP2420_SMS_BASE)); omap2_control_base_init(); omap2xxx_check_revision(); omap2_prcm_base_init(); omap2xxx_voltagedomains_init(); omap242x_powerdomains_init(); omap242x_clockdomains_init(); omap2420_hwmod_init(); omap_hwmod_init_postsetup(); OMAP_CLK_SOC_INIT = Some(omap2420_dt_clk_init); rate_table = omap2420_rate_table; }
#[cfg(CONFIG_SOC_OMAP2430)] pub unsafe fn omap2430_init_early() { omap2_set_globals_tap(OMAP243X_CLASS, OMAP2_L4_IO_ADDRESS(0x4900a000)); omap2_set_globals_sdrc(OMAP2_L3_IO_ADDRESS(OMAP243X_SDRC_BASE), OMAP2_L3_IO_ADDRESS(OMAP243X_SMS_BASE)); omap2_control_base_init(); omap2xxx_check_revision(); omap2_prcm_base_init(); omap2xxx_voltagedomains_init(); omap243x_powerdomains_init(); omap243x_clockdomains_init(); omap2430_hwmod_init(); omap_hwmod_init_postsetup(); OMAP_CLK_SOC_INIT = Some(omap2430_dt_clk_init); rate_table = omap2430_rate_table; }

#[cfg(CONFIG_ARCH_OMAP3)] unsafe fn omap3_init_early() { omap2_set_globals_tap(OMAP343X_CLASS, OMAP2_L4_IO_ADDRESS(0x4830A000)); omap2_set_globals_sdrc(OMAP2_L3_IO_ADDRESS(OMAP343X_SDRC_BASE), OMAP2_L3_IO_ADDRESS(OMAP343X_SMS_BASE)); omap2_control_base_init(); omap3xxx_check_revision(); omap3xxx_check_features(); omap2_prcm_base_init(); omap3xxx_voltagedomains_init(); omap3xxx_powerdomains_init(); omap3xxx_clockdomains_init(); omap3xxx_hwmod_init(); omap_hwmod_init_postsetup(); omap_secure_init(); }
#[cfg(CONFIG_ARCH_OMAP3)] pub unsafe fn omap3430_init_early() { omap3_init_early(); OMAP_CLK_SOC_INIT = Some(omap3430_dt_clk_init); }
#[cfg(CONFIG_ARCH_OMAP3)] pub unsafe fn omap3630_init_early() { omap3_init_early(); OMAP_CLK_SOC_INIT = Some(omap3630_dt_clk_init); }
#[cfg(CONFIG_ARCH_OMAP3)] pub unsafe fn am35xx_init_early() { omap3_init_early(); OMAP_CLK_SOC_INIT = Some(am35xx_dt_clk_init); }
#[cfg(CONFIG_ARCH_OMAP3)] pub unsafe fn omap3_init_late() { omap_pm_soc_init = Some(omap3_pm_init); }
#[cfg(CONFIG_ARCH_OMAP3)] pub unsafe fn ti81xx_init_late() { omap_pm_soc_init = Some(omap_pm_nop_init); }

#[cfg(CONFIG_SOC_TI81XX)] pub unsafe fn ti814x_init_early() { omap2_set_globals_tap(TI814X_CLASS, OMAP2_L4_IO_ADDRESS(TI81XX_TAP_BASE)); omap2_control_base_init(); omap3xxx_check_revision(); ti81xx_check_features(); omap2_prcm_base_init(); omap3xxx_voltagedomains_init(); omap3xxx_powerdomains_init(); ti814x_clockdomains_init(); dm814x_hwmod_init(); omap_hwmod_init_postsetup(); OMAP_CLK_SOC_INIT = Some(dm814x_dt_clk_init); omap_secure_init(); }
#[cfg(CONFIG_SOC_TI81XX)] pub unsafe fn ti816x_init_early() { omap2_set_globals_tap(TI816X_CLASS, OMAP2_L4_IO_ADDRESS(TI81XX_TAP_BASE)); omap2_control_base_init(); omap3xxx_check_revision(); ti81xx_check_features(); omap2_prcm_base_init(); omap3xxx_voltagedomains_init(); omap3xxx_powerdomains_init(); ti816x_clockdomains_init(); dm816x_hwmod_init(); omap_hwmod_init_postsetup(); OMAP_CLK_SOC_INIT = Some(dm816x_dt_clk_init); omap_secure_init(); }

#[cfg(CONFIG_SOC_AM33XX)] pub unsafe fn am33xx_init_early() { omap2_set_globals_tap(AM335X_CLASS, AM33XX_L4_WK_IO_ADDRESS(AM33XX_TAP_BASE)); omap2_control_base_init(); omap3xxx_check_revision(); am33xx_check_features(); omap2_prcm_base_init(); am33xx_powerdomains_init(); am33xx_clockdomains_init(); OMAP_CLK_SOC_INIT = Some(am33xx_dt_clk_init); omap_secure_init(); }
#[cfg(CONFIG_SOC_AM33XX)] pub unsafe fn am33xx_init_late() { omap_pm_soc_init = Some(amx3_common_pm_init); }
#[cfg(CONFIG_SOC_AM43XX)] pub unsafe fn am43xx_init_early() { omap2_set_globals_tap(AM335X_CLASS, AM33XX_L4_WK_IO_ADDRESS(AM33XX_TAP_BASE)); omap2_control_base_init(); omap3xxx_check_revision(); am33xx_check_features(); omap2_prcm_base_init(); am43xx_powerdomains_init(); am43xx_clockdomains_init(); omap_l2_cache_init(); OMAP_CLK_SOC_INIT = Some(am43xx_dt_clk_init); omap_secure_init(); }
#[cfg(CONFIG_SOC_AM43XX)] pub unsafe fn am43xx_init_late() { omap_pm_soc_init = Some(amx3_common_pm_init); }

#[cfg(CONFIG_ARCH_OMAP4)] pub unsafe fn omap4430_init_early() { omap2_set_globals_tap(OMAP443X_CLASS, OMAP2_L4_IO_ADDRESS(OMAP443X_SCM_BASE)); omap2_set_globals_prcm_mpu(OMAP2_L4_IO_ADDRESS(OMAP4430_PRCM_MPU_BASE)); omap2_control_base_init(); omap4xxx_check_revision(); omap4xxx_check_features(); omap2_prcm_base_init(); omap4_sar_ram_init(); omap4_mpuss_early_init(); omap4_pm_init_early(); omap44xx_voltagedomains_init(); omap44xx_powerdomains_init(); omap44xx_clockdomains_init(); omap_l2_cache_init(); OMAP_CLK_SOC_INIT = Some(omap4xxx_dt_clk_init); omap_secure_init(); }
#[cfg(CONFIG_ARCH_OMAP4)] pub unsafe fn omap4430_init_late() { omap_pm_soc_init = Some(omap4_pm_init); }
#[cfg(CONFIG_SOC_OMAP5)] pub unsafe fn omap5_init_early() { omap2_set_globals_tap(OMAP54XX_CLASS, OMAP2_L4_IO_ADDRESS(OMAP54XX_SCM_BASE)); omap2_set_globals_prcm_mpu(OMAP2_L4_IO_ADDRESS(OMAP54XX_PRCM_MPU_BASE)); omap2_control_base_init(); omap2_prcm_base_init(); omap5xxx_check_revision(); omap4_sar_ram_init(); omap4_mpuss_early_init(); omap4_pm_init_early(); omap54xx_voltagedomains_init(); omap54xx_powerdomains_init(); omap54xx_clockdomains_init(); OMAP_CLK_SOC_INIT = Some(omap5xxx_dt_clk_init); omap_secure_init(); }
#[cfg(CONFIG_SOC_OMAP5)] pub unsafe fn omap5_init_late() { omap_pm_soc_init = Some(omap4_pm_init); }
#[cfg(CONFIG_SOC_DRA7XX)] pub unsafe fn dra7xx_init_early() { omap2_set_globals_tap(DRA7XX_CLASS, OMAP2_L4_IO_ADDRESS(DRA7XX_TAP_BASE)); omap2_set_globals_prcm_mpu(OMAP2_L4_IO_ADDRESS(OMAP54XX_PRCM_MPU_BASE)); omap2_control_base_init(); omap4_pm_init_early(); omap2_prcm_base_init(); dra7xxx_check_revision(); dra7xx_powerdomains_init(); dra7xx_clockdomains_init(); OMAP_CLK_SOC_INIT = Some(dra7xx_dt_clk_init); omap_secure_init(); }
#[cfg(CONFIG_SOC_DRA7XX)] pub unsafe fn dra7xx_init_late() { omap_pm_soc_init = Some(omap4_pm_init); }
