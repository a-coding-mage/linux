 ...
 */
pub static mut gfx_omap2_pwrdm: powerdomain = powerdomain {
    name: "gfx_pwrdm",
    prcm_offs: GFX_MOD,
    pwrsts: PWRSTS_OFF_RET_ON,
    pwrsts_logic_ret: PWRSTS_RET,
    banks: 1,
    pwrsts_mem_ret: [PWRSTS_RET], // MEMRETSTATE
    pwrsts_mem_on: [PWRSTS_ON], // MEMONSTATE
    voltdm: voltagedomain { name: "core" },
};

pub static mut wkup_omap2_pwrdm: powerdomain = powerdomain {
    name: "wkup_pwrdm",
    prcm_offs: WKUP_MOD,
    pwrsts: PWRSTS_ON,
    voltdm: voltagedomain { name: "wakeup" },
};
