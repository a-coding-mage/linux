...
#[cfg(all(CONFIG_PM_DEBUG, CONFIG_DEBUG_FS))]
extern "C" {
    pub fn pm_dbg_update_time(pwrdm: *mut powerdomain, prev: ::core::ffi::c_int);
}

#[cfg(not(all(CONFIG_PM_DEBUG, CONFIG_DEBUG_FS)))]
#[inline]
...
#[cfg(all(CONFIG_PM, CONFIG_ARCH_OMAP3))]
extern "C" {
...
#[cfg(not(all(CONFIG_PM, CONFIG_ARCH_OMAP3)))]
#[inline]
...
#[cfg(all(CONFIG_PM, any(CONFIG_ARCH_OMAP4, CONFIG_SOC_OMAP5, CONFIG_SOC_DRA7XX)))]
...
#[cfg(not(all(CONFIG_PM, any(CONFIG_ARCH_OMAP4, CONFIG_SOC_OMAP5, CONFIG_SOC_DRA7XX))))]
#[inline]
