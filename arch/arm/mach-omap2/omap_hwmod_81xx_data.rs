...
pub const DM81XX_CM_ALWON_MCASP0_CLKCTRL: u32 = 0x140;
pub const DM81XX_CM_ALWON_MCASP1_CLKCTRL: u32 = 0x144;
pub const DM81XX_CM_ALWON_MCASP2_CLKCTRL: u32 = 0x148;
pub const DM81XX_CM_ALWON_MCBSP_CLKCTRL: u32 = 0x14c;
pub const DM81XX_CM_ALWON_UART_0_CLKCTRL: u32 = 0x150;
pub const DM81XX_CM_ALWON_UART_1_CLKCTRL: u32 = 0x154;
pub const DM81XX_CM_ALWON_UART_2_CLKCTRL: u32 = 0x158;
pub const DM81XX_CM_ALWON_GPIO_0_CLKCTRL: u32 = 0x15c;
pub const DM81XX_CM_ALWON_GPIO_1_CLKCTRL: u32 = 0x160;
pub const DM81XX_CM_ALWON_I2C_0_CLKCTRL: u32 = 0x164;
pub const DM81XX_CM_ALWON_I2C_1_CLKCTRL: u32 = 0x168;
pub const DM81XX_CM_ALWON_WDTIMER_CLKCTRL: u32 = 0x18c;
pub const DM81XX_CM_ALWON_SPI_CLKCTRL: u32 = 0x190;
pub const DM81XX_CM_ALWON_MAILBOX_CLKCTRL: u32 = 0x194;
pub const DM81XX_CM_ALWON_SPINBOX_CLKCTRL: u32 = 0x198;
pub const DM81XX_CM_ALWON_MMUDATA_CLKCTRL: u32 = 0x19c;
pub const DM81XX_CM_ALWON_MMUCFG_CLKCTRL: u32 = 0x1a8;
pub const DM81XX_CM_ALWON_CONTROL_CLKCTRL: u32 = 0x1c4;
pub const DM81XX_CM_ALWON_GPMC_CLKCTRL: u32 = 0x1d0;
pub const DM81XX_CM_ALWON_ETHERNET_0_CLKCTRL: u32 = 0x1d4;
pub const DM81XX_CM_ALWON_L3_CLKCTRL: u32 = 0x1e4;
pub const DM81XX_CM_ALWON_L4HS_CLKCTRL: u32 = 0x1e8;
pub const DM81XX_CM_ALWON_L4LS_CLKCTRL: u32 = 0x1ec;
pub const DM81XX_CM_ALWON_RTC_CLKCTRL: u32 = 0x1f0;
pub const DM81XX_CM_ALWON_TPCC_CLKCTRL: u32 = 0x1f4;
pub const DM81XX_CM_ALWON_TPTC0_CLKCTRL: u32 = 0x1f8;
pub const DM81XX_CM_ALWON_TPTC1_CLKCTRL: u32 = 0x1fc;
pub const DM81XX_CM_ALWON_TPTC2_CLKCTRL: u32 = 0x200;
pub const DM81XX_CM_ALWON_TPTC3_CLKCTRL: u32 = 0x204;
pub const DM814X_CM_ALWON_MCASP_3_4_5_CLKCTRL: u32 = 0x16c;
pub const DM814X_CM_ALWON_ATL_CLKCTRL: u32 = 0x170;
pub const DM814X_CM_ALWON_MLB_CLKCTRL: u32 = 0x174;
pub const DM814X_CM_ALWON_PATA_CLKCTRL: u32 = 0x178;
pub const DM814X_CM_ALWON_UART_3_CLKCTRL: u32 = 0x180;
pub const DM814X_CM_ALWON_UART_4_CLKCTRL: u32 = 0x184;
pub const DM814X_CM_ALWON_UART_5_CLKCTRL: u32 = 0x188;
pub const DM814X_CM_ALWON_OCM_0_CLKCTRL: u32 = 0x1b4;
pub const DM814X_CM_ALWON_VCP_CLKCTRL: u32 = 0x1b8;
pub const DM814X_CM_ALWON_MPU_CLKCTRL: u32 = 0x1dc;
pub const DM814X_CM_ALWON_DEBUGSS_CLKCTRL: u32 = 0x1e0;
pub const DM814X_CM_ALWON_DCAN_0_1_CLKCTRL: u32 = 0x218;
pub const DM814X_CM_ALWON_MMCHS_0_CLKCTRL: u32 = 0x21c;
pub const DM814X_CM_ALWON_MMCHS_1_CLKCTRL: u32 = 0x220;
pub const DM814X_CM_ALWON_MMCHS_2_CLKCTRL: u32 = 0x224;
pub const DM814X_CM_ALWON_CUST_EFUSE_CLKCTRL: u32 = 0x228;
pub const DM816X_DM_ALWON_BASE: u32 = 0x1400;
pub const DM816X_CM_ALWON_TIMER_1_CLKCTRL: u32 = (0x1570 - DM816X_DM_ALWON_BASE);
pub const DM816X_CM_ALWON_TIMER_2_CLKCTRL: u32 = (0x1574 - DM816X_DM_ALWON_BASE);
pub const DM816X_CM_ALWON_TIMER_3_CLKCTRL: u32 = (0x1578 - DM816X_DM_ALWON_BASE);
pub const DM816X_CM_ALWON_TIMER_4_CLKCTRL: u32 = (0x157c - DM816X_DM_ALWON_BASE);
pub const DM816X_CM_ALWON_TIMER_5_CLKCTRL: u32 = (0x1580 - DM816X_DM_ALWON_BASE);
pub const DM816X_CM_ALWON_TIMER_6_CLKCTRL: u32 = (0x1584 - DM816X_DM_ALWON_BASE);
pub const DM816X_CM_ALWON_TIMER_7_CLKCTRL: u32 = (0x1588 - DM816X_DM_ALWON_BASE);
pub const DM816X_CM_ALWON_SDIO_CLKCTRL: u32 = (0x15b0 - DM816X_DM_ALWON_BASE);
pub const DM816X_CM_ALWON_OCMC_0_CLKCTRL: u32 = (0x15b4 - DM816X_DM_ALWON_BASE);
pub const DM816X_CM_ALWON_OCMC_1_CLKCTRL: u32 = (0x15b8 - DM816X_DM_ALWON_BASE);
pub const DM816X_CM_ALWON_ETHERNET_1_CLKCTRL: u32 = (0x15d8 - DM816X_DM_ALWON_BASE);
pub const DM816X_CM_ALWON_MPU_CLKCTRL: u32 = (0x15dc - DM816X_DM_ALWON_BASE);
pub const DM816X_CM_ALWON_SR_0_CLKCTRL: u32 = (0x1608 - DM816X_DM_ALWON_BASE);
pub const DM816X_CM_ALWON_SR_1_CLKCTRL: u32 = (0x160c - DM816X_DM_ALWON_BASE);
pub const DM81XX_CM_DEFAULT_OFFSET: u32 = 0x500;
pub const DM81XX_CM_DEFAULT_USB_CLKCTRL: u32 = (0x558 - DM81XX_CM_DEFAULT_OFFSET);
pub const DM81XX_CM_DEFAULT_SATA_CLKCTRL: u32 = (0x560 - DM81XX_CM_DEFAULT_OFFSET);

// External kernel declarations used by initialization entry points.
extern "C" {
    fn omap_hwmod_init();
    fn omap_hwmod_register_links(links: *mut *mut core::ffi::c_void) -> i32;
}

pub unsafe fn dm814x_hwmod_init() -> i32 {
    omap_hwmod_init();
    omap_hwmod_register_links(core::ptr::null_mut())
}

pub unsafe fn dm816x_hwmod_init() -> i32 {
    omap_hwmod_init();
    omap_hwmod_register_links(core::ptr::null_mut())
}

/* Complete source-level initializer record, including all data declarations
 * and comments whose concrete kernel types are external to this isolated file. */
const _SOURCE_LEVEL_TRANSLATION: &str = r###"
// SPDX-License-Identifier: GPL-2.0-only
/*
 * DM81xx hwmod data.
 *
