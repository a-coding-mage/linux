...
// C dependencies supplied by the surrounding translation unit/crate:
...
static mut omap4_vp_mpu: omap_vp_instance = omap_vp_instance {
...
static mut omap4_vp_iva: omap_vp_instance = omap_vp_instance {
...
static mut omap4_vp_core: omap_vp_instance = omap_vp_instance {
...
static mut omap4_mpu_vp_data: omap_vp_param = omap_vp_param {
    vddmin: OMAP4_VP_MPU_VLIMITTO_VDDMIN,
    vddmax: OMAP4_VP_MPU_VLIMITTO_VDDMAX,
};

static mut omap4_iva_vp_data: omap_vp_param = omap_vp_param {
    vddmin: OMAP4_VP_IVA_VLIMITTO_VDDMIN,
    vddmax: OMAP4_VP_IVA_VLIMITTO_VDDMAX,
};

static mut omap4_core_vp_data: omap_vp_param = omap_vp_param {
