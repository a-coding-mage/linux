...
#[cfg(all(not(CONFIG_CPU_CP15), CONFIG_CPU_V7M))]
#[inline]
...
#[cfg(all(not(CONFIG_CPU_CP15), not(CONFIG_CPU_V7M)))]
#[inline]
pub unsafe fn read_cpuid(_reg: u32) -> u32 { 0 }
#[cfg(all(not(CONFIG_CPU_CP15), not(CONFIG_CPU_V7M)))]
#[inline]
...
#[cfg(all(not(CONFIG_CPU_XSCALE), not(CONFIG_CPU_XSC3), not(CONFIG_CPU_MOHAWK)))]
#[inline]
pub fn cpu_is_xscale_family() -> i32 { 0 }
#[cfg(any(CONFIG_CPU_XSCALE, CONFIG_CPU_XSC3, CONFIG_CPU_MOHAWK))]
#[inline]
...
#[cfg(any(CONFIG_CPU_PJ4, CONFIG_CPU_PJ4B))]
#[inline]
pub unsafe fn cpu_is_pj4() -> i32 {
    if read_cpuid_id() & 0xff0fff00 == 0x560f5800 { 1 } else { 0 }
}
#[cfg(not(any(CONFIG_CPU_PJ4, CONFIG_CPU_PJ4B)))]
#[inline]
