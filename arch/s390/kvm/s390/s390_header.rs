...
extern "C" {
    pub fn kvm_s390_pv_destroy_cpu(_: *mut kvm_vcpu,_: *mut u16,_: *mut u16)->i32;
    pub fn kvm_s390_pv_create_cpu(_: *mut kvm_vcpu,_: *mut u16,_: *mut u16)->i32;
    pub fn kvm_s390_handle_wait(_: *mut kvm_vcpu)->i32;
    pub fn kvm_s390_get_ilen(_: *mut kvm_vcpu)->u8;
    pub fn kvm_handle_sie_intercept(_: *mut kvm_vcpu)->i32;
    pub fn handle_sthyi(_: *mut kvm_vcpu)->i32;
    pub fn kvm_s390_handle_diag(_: *mut kvm_vcpu)->i32;
    pub fn kvm_s390_handle_sigp(_: *mut kvm_vcpu)->i32;
    pub fn kvm_s390_handle_vsie(_: *mut kvm_vcpu)->i32;
    pub fn kvm_s390_pv_set_aside(_: *mut kvm,_: *mut u16,_: *mut u16)->i32;
    pub fn kvm_s390_pv_deinit_aside_vm(_: *mut kvm,_: *mut u16,_: *mut u16)->i32;
    pub fn kvm_s390_pv_deinit_cleanup_all(_: *mut kvm,_: *mut u16,_: *mut u16)->i32;
    pub fn kvm_s390_pv_deinit_vm(_: *mut kvm,_: *mut u16,_: *mut u16)->i32;
    pub fn kvm_s390_pv_init_vm(_: *mut kvm,_: *mut u16,_: *mut u16)->i32;
    pub fn kvm_s390_pv_set_sec_parms(_: *mut kvm,_: *mut core::ffi::c_void,_: u64,_: *mut u16,_: *mut u16)->i32;
    pub fn kvm_s390_pv_unpack(_: *mut kvm,_: usize,_: usize,_: usize,_: *mut u16,_: *mut u16)->i32;
    pub fn kvm_s390_pv_set_cpu_state(_: *mut kvm_vcpu,_: u8)->i32;
    pub fn kvm_s390_pv_dump_cpu(_: *mut kvm_vcpu,_: *mut core::ffi::c_void,_: *mut u16,_: *mut u16)->i32;
    pub fn kvm_s390_pv_destroy_page(_: *mut kvm,_: usize)->i32;
    pub fn kvm_s390_pv_convert_to_secure(_: *mut kvm,_: usize)->i32;
    pub fn kvm_s390_pv_make_secure(_: *mut kvm,_: usize,_: *mut core::ffi::c_void)->i32;
    pub fn kvm_s390_vcpu_wakeup(_: *mut kvm_vcpu);
    pub fn kvm_s390_deliver_pending_interrupts(_: *mut kvm_vcpu)->i32;
    pub fn kvm_s390_clear_local_irqs(_: *mut kvm_vcpu);
    pub fn kvm_s390_clear_float_irqs(_: *mut kvm);
    pub fn kvm_s390_vsie_kick(_: *mut kvm_vcpu);
    pub fn kvm_s390_vsie_init(_: *mut kvm);
    pub fn kvm_s390_vsie_destroy(_: *mut kvm);
    pub fn kvm_s390_handle_sigp_pei(_: *mut kvm_vcpu)->i32;
    pub fn kvm_s390_vcpu_start(_: *mut kvm_vcpu)->i32;
    pub fn kvm_s390_vcpu_stop(_: *mut kvm_vcpu)->i32;
    pub fn kvm_s390_vcpu_block(_: *mut kvm_vcpu);
    pub fn kvm_s390_vcpu_unblock(_: *mut kvm_vcpu);
    pub fn kvm_s390_sync_request(_: i32,_: *mut kvm_vcpu);
    pub fn kvm_s390_handle_aa(_: *mut kvm_vcpu)->i32;
    pub fn kvm_s390_handle_b2(_: *mut kvm_vcpu)->i32;
    pub fn kvm_s390_handle_e3(_: *mut kvm_vcpu)->i32;
    pub fn kvm_s390_handle_e5(_: *mut kvm_vcpu)->i32;
    pub fn kvm_s390_handle_01(_: *mut kvm_vcpu)->i32;
    pub fn kvm_s390_handle_b9(_: *mut kvm_vcpu)->i32;
    pub fn kvm_s390_handle_lpsw(_: *mut kvm_vcpu)->i32;
    pub fn kvm_s390_handle_stctl(_: *mut kvm_vcpu)->i32;
    pub fn kvm_s390_handle_lctl(_: *mut kvm_vcpu)->i32;
    pub fn kvm_s390_handle_eb(_: *mut kvm_vcpu)->i32;
    pub fn kvm_s390_skey_check_enable(_: *mut kvm_vcpu)->i32;
    pub fn kvm_s390_handle_per_ifetch_icpt(_: *mut kvm_vcpu)->i32;
    pub fn kvm_s390_handle_per_event(_: *mut kvm_vcpu)->i32;
    pub fn kvm_s390_reinject_machine_check(_: *mut kvm_vcpu,_: *mut mcck_volatile_info);
    pub fn kvm_s390_vcpu_crypto_reset_all(_: *mut kvm);
    pub fn kvm_s390_vcpu_pci_enable_interp(_: *mut kvm);
