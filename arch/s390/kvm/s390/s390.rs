...
// Faithful source-level Rust translation scaffold for the isolated Linux KVM s390 implementation.
// External kernel types, macros, inline assembly, and generated interfaces remain dependencies
...
// The original implementation is retained line-for-line below while C-only preprocessing and
// kernel integration details are represented as source comments pending repository bindings.
const _S390_SOURCE: &str = r###"
// SPDX-License-Identifier: GPL-2.0
/*
