 ...
 */
// C headers provide the OFFSET!, BLANK!, and DEFINE! macros and layout types.
...
pub fn main() -> i32 {
    ...
    DEFINE!(__PT_SIZE, core::mem::size_of::<pt_regs>());
    BLANK!();
    /* stack_frame offsets */
    ...
    DEFINE!(STACK_FRAME_OVERHEAD, core::mem::size_of::<stack_frame>());
    BLANK!();
    OFFSET!(__SFUSER_BACKCHAIN, stack_frame_user, back_chain);
    DEFINE!(STACK_FRAME_USER_OVERHEAD, core::mem::size_of::<stack_frame_user>());
    OFFSET!(__SFVDSO_RETURN_ADDRESS, stack_frame_vdso_wrapper, return_address);
    DEFINE!(STACK_FRAME_VDSO_OVERHEAD, core::mem::size_of::<stack_frame_vdso_wrapper>());
    BLANK!();
    ...
    DEFINE!(__KEXEC_SHA_REGION_SIZE, core::mem::size_of::<kexec_sha_region>());
    /* sizeof kernel parameter area */
    DEFINE!(__PARMAREA_SIZE, core::mem::size_of::<parmarea>());
    /* kernel parameter area offsets */
    DEFINE!(IPL_DEVICE, PARMAREA + core::mem::offset_of!(parmarea, ipl_device));
    DEFINE!(INITRD_START, PARMAREA + core::mem::offset_of!(parmarea, initrd_start));
    DEFINE!(INITRD_SIZE, PARMAREA + core::mem::offset_of!(parmarea, initrd_size));
    DEFINE!(OLDMEM_BASE, PARMAREA + core::mem::offset_of!(parmarea, oldmem_base));
    DEFINE!(OLDMEM_SIZE, PARMAREA + core::mem::offset_of!(parmarea, oldmem_size));
    DEFINE!(COMMAND_LINE, PARMAREA + core::mem::offset_of!(parmarea, command_line));
    DEFINE!(MAX_COMMAND_LINE_SIZE, PARMAREA + core::mem::offset_of!(parmarea, max_command_line_size));
    ...
    DEFINE!(__FTRACE_REGS_SIZE, core::mem::size_of::<__arch_ftrace_regs>());
