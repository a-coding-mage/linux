...
#[cfg(not(CONFIG_SUN3))] pub const DMA_VERS0: usize = 0;
#[cfg(not(CONFIG_SUN3))] pub const DMA_ESCV1: usize = 0x40000000;
#[cfg(not(CONFIG_SUN3))] pub const DMA_VERS1: usize = 0x80000000;
#[cfg(not(CONFIG_SUN3))] pub const DMA_VERS2: usize = 0xa0000000;
#[cfg(not(CONFIG_SUN3))] pub const DMA_VERHME: usize = 0xb0000000;
#[cfg(not(CONFIG_SUN3))] pub const DMA_VERSPLUS: usize = 0x90000000;
#[cfg(not(CONFIG_SUN3))]
pub const DMA_HNDL_INTR: usize = 1;
#[cfg(not(CONFIG_SUN3))]
pub const DMA_HNDL_ERROR: usize = 2;
#[cfg(not(CONFIG_SUN3))] pub const DMA_FIFO_STDRAIN: usize = 0x40;
#[cfg(not(CONFIG_SUN3))]
...
#[cfg(not(CONFIG_SUN3))] pub const DMA_ACC_SZ_ERR: usize = 0x40;
#[cfg(not(CONFIG_SUN3))]
pub const DMA_ST_WRITE: usize = 0x100;
#[cfg(not(CONFIG_SUN3))]
pub const DMA_ENABLE: usize = 0x200;
#[cfg(not(CONFIG_SUN3))] pub const DMA_PEND_READ: usize = 0x400;
#[cfg(not(CONFIG_SUN3))] pub const DMA_ESC_BURST: usize = 0x800;
#[cfg(not(CONFIG_SUN3))] pub const DMA_READ_AHEAD: usize = 0x1800;
#[cfg(not(CONFIG_SUN3))] pub const DMA_DSBL_RD_DRN: usize = 0x1000;
#[cfg(not(CONFIG_SUN3))] pub const DMA_BCNT_ENAB: usize = 0x2000;
#[cfg(not(CONFIG_SUN3))] pub const DMA_TERM_CNTR: usize = 0x4000;
#[cfg(not(CONFIG_SUN3))] pub const DMA_CSR_DISAB: usize = 0x10000;
#[cfg(not(CONFIG_SUN3))] pub const DMA_SCSI_DISAB: usize = 0x20000;
#[cfg(not(CONFIG_SUN3))] pub const DMA_ADD_ENABLE: usize = 0x40000;
#[cfg(not(CONFIG_SUN3))] pub const DMA_BRST_SZ: usize = 0x000c0000;
#[cfg(not(CONFIG_SUN3))] pub const DMA_BRST64: usize = 0x80000;
#[cfg(not(CONFIG_SUN3))] pub const DMA_BRST32: usize = 0x40000;
#[cfg(not(CONFIG_SUN3))] pub const DMA_BRST16: usize = 0;
#[cfg(not(CONFIG_SUN3))] pub const DMA_BRST0: usize = 0x80000;
#[cfg(not(CONFIG_SUN3))] pub const DMA_ADDR_DISAB: usize = 0x100000;
#[cfg(not(CONFIG_SUN3))] pub const DMA_2CLKS: usize = 0x200000;
#[cfg(not(CONFIG_SUN3))] pub const DMA_CNTR_DISAB: usize = 0x00800000;
#[cfg(not(CONFIG_SUN3))] pub const DMA_AUTO_NADDR: usize = 0x01000000;
#[cfg(not(CONFIG_SUN3))] pub const DMA_SCSI_ON: usize = 0x02000000;
#[cfg(not(CONFIG_SUN3))] pub const DMA_LOADED_ADDR: usize = 0x04000000;
#[cfg(not(CONFIG_SUN3))] pub const DMA_LOADED_NADDR: usize = 0x08000000;
#[cfg(not(CONFIG_SUN3))] pub const DMA_BURST1: usize = 1;
#[cfg(not(CONFIG_SUN3))] pub const DMA_BURST2: usize = 2;
#[cfg(not(CONFIG_SUN3))] pub const DMA_BURST4: usize = 4;
#[cfg(not(CONFIG_SUN3))] pub const DMA_BURST8: usize = 8;
#[cfg(not(CONFIG_SUN3))] pub const DMA_BURST16: usize = 0x10;
#[cfg(not(CONFIG_SUN3))] pub const DMA_BURST32: usize = 0x20;
#[cfg(not(CONFIG_SUN3))] pub const DMA_BURST64: usize = 0x40;
#[cfg(not(CONFIG_SUN3))] pub const DMA_BURSTBITS: usize = 0x7f;
#[cfg(not(CONFIG_SUN3))]
