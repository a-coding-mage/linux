...
// The C implementation depends on float.h and sgl_float.h for these macros and types.

/* Single Floating-point Square Root */

#[allow(unused_variables)]
pub unsafe fn sgl_fsqrt(
    ...
    Sgl_setzero!(result);
    newbit = 1u32 << SGL_P;
    while newbit != 0 && Sgl_isnotzero!(src) {
    ...
    if Sgl_isnotzero!(src) {
        ...
        match Rounding_mode!() {
            ...
            ROUNDNEAREST => {
                 ...
                 */
                if guardbit { Sgl_increment!(result); }
            }
            _ => {}
        }
