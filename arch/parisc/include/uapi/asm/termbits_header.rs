...
/* Translated from the Linux parisc termbits header. */
/* Dependency intent: cc_t and speed_t are supplied by asm-generic termbits-common. */
...
pub const IMAXBEL: tcflag_t = 0x4000;
pub const IUTF8: tcflag_t = 0x8000;
...
pub const CIBAUD: tcflag_t = 0x100f0000; /* input baud rate */
