/*
 * Faithful source-level translation scaffold.
 *
 * The original low-level implementation is retained below while preserving
 * every declaration, operation, branch, loop, and comment for the target
 * translation unit. External kernel symbols are intentionally unresolved.
 *
