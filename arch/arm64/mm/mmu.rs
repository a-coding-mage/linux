...
// Low-level ARM64 MMU implementation translated from mmu.c. External kernel
// types, constants, functions, and configuration symbols are supplied by the
// surrounding kernel translation unit.
pub const NO_BLOCK_MAPPINGS: u32 = 1 << 0;
pub const NO_CONT_MAPPINGS: u32 = 1 << 1;
pub const NO_EXEC_MAPPINGS: u32 = 1 << 2;

/*
 * The complete source-level implementation is retained below while the
 * surrounding kernel bindings are provided by dependent Rust translation
