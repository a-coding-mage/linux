 ...
 *
 */
const RV_MAX_REG_ARGS: usize = 8;
const RV_FENTRY_NINSNS: usize = 2;
const RV_FENTRY_NBYTES: usize = (RV_FENTRY_NINSNS * 4);
/* imm that allows emit_imm to emit max count insns */
const RV_MAX_COUNT_IMM: usize = 0x7FFF7FF7FF7FF7FF;
/* fentry and TCC init insns will be skipped on tailcall */
const RV_TAILCALL_OFFSET: usize = ((RV_FENTRY_NINSNS + 1) * 4);
const RV_REG_TCC: usize = RV_REG_A6;
const RV_REG_ARENA: usize = RV_REG_S7 /* For storing arena_vm_start */;
const regmap[] = {
	[BPF_REG_0] =	RV_REG_A5,
	[BPF_REG_1] =	RV_REG_A0,
	[BPF_REG_2] =	RV_REG_A1,
...
unsafe fn in_auipc_jalr_range(s64 val)
{
	/*
...
const BPF_FIXUP_OFFSET_MASK: usize = GENMASK(26, 0);
const BPF_FIXUP_REG_MASK: usize = GENMASK(31, 27);
