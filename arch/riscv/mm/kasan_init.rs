...
#[cfg(CONFIG_KASAN_VMALLOC)] pub unsafe extern "C" fn kasan_populate_early_vm_area_shadow(start:*mut core::ffi::c_void,size:usize){kasan_populate(kasan_mem_to_shadow(start),kasan_mem_to_shadow((start as usize+size) as *mut _));}
