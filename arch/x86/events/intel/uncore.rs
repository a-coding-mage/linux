...
/// Faithful source-level translation retained for integration with the kernel Rust bindings.
pub const UNCORE_C_SOURCE: &str = r###"// SPDX-License-Identifier: GPL-2.0-only
