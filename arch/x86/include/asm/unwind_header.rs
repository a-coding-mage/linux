...
pub struct unwind_state {
    ...
    #[cfg(all(not(CONFIG_UNWINDER_ORC), CONFIG_UNWINDER_FRAME_POINTER))]
    pub got_irq: bool,
    #[cfg(all(not(CONFIG_UNWINDER_ORC), CONFIG_UNWINDER_FRAME_POINTER))]
    ...
    #[cfg(all(not(CONFIG_UNWINDER_ORC), not(CONFIG_UNWINDER_FRAME_POINTER)))]
...
#[cfg(any(CONFIG_UNWINDER_ORC, CONFIG_UNWINDER_FRAME_POINTER))]
#[inline]
...
#[cfg(not(any(CONFIG_UNWINDER_ORC, CONFIG_UNWINDER_FRAME_POINTER)))]
#[inline]
