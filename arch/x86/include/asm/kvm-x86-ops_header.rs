...
// The source header requires KVM_X86_OP, KVM_X86_OP_OPTIONAL, and
// KVM_X86_OP_OPTIONAL_RET0 macro definitions from the including translation
// unit.  These Rust macro invocations preserve that X-macro interface.
//
// KVM_X86_OP() and KVM_X86_OP_OPTIONAL() are used to help generate both
// DECLARE/DEFINE_STATIC_CALL() invocations and "static_call_update()" calls.
// KVM_X86_OP_OPTIONAL() can be used for functions that can have a NULL
// definition. KVM_X86_OP_OPTIONAL_RET0() can be used likewise to make a
// definition optional, with __static_call_return0 as the default.
...
#[cfg(feature = "CONFIG_HAVE_KVM_ARCH_GMEM_CONVERT")]
KVM_X86_OP_OPTIONAL_RET0!(gmem_make_private);
#[cfg(feature = "CONFIG_HAVE_KVM_ARCH_GMEM_RECLAIM")]
KVM_X86_OP_OPTIONAL!(gmem_make_shared);
#[cfg(feature = "CONFIG_HAVE_KVM_ARCH_GMEM_INVALIDATE")]
