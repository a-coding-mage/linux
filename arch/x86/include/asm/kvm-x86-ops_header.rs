 ...
 *
 * The C header is an X-macro list included with caller-defined
 * KVM_X86_OP* macros; here the caller passes its macros as arguments:
 *
 *     kvm_x86_ops!(KVM_X86_OP, KVM_X86_OP_OPTIONAL, KVM_X86_OP_OPTIONAL_RET0);
 */
#[macro_export]
macro_rules! kvm_x86_ops {
    ($KVM_X86_OP:ident, $KVM_X86_OP_OPTIONAL:ident, $KVM_X86_OP_OPTIONAL_RET0:ident) => {
        ...
        #[cfg(any(CONFIG_HYPERV, CONFIG_HYPERV = "m"))]
        ...
        #[cfg(CONFIG_HAVE_KVM_ARCH_GMEM_CONVERT)]
        $KVM_X86_OP_OPTIONAL_RET0!(gmem_make_private);
        #[cfg(CONFIG_HAVE_KVM_ARCH_GMEM_RECLAIM)]
        $KVM_X86_OP_OPTIONAL!(gmem_make_shared);
        #[cfg(CONFIG_HAVE_KVM_ARCH_GMEM_INVALIDATE)]
