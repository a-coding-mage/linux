...
#[cfg(all(CONFIG_FUNCTION_TRACER, CONFIG_HAVE_FENTRY))]
...
#[cfg(all(CONFIG_FUNCTION_TRACER, CONFIG_DYNAMIC_FTRACE_WITH_ARGS))]
#[inline(always)]
...
#[cfg(all(CONFIG_FUNCTION_TRACER, CONFIG_DYNAMIC_FTRACE_WITH_DIRECT_CALLS))]
#[inline]
...
#[cfg(not(all(CONFIG_FUNCTION_TRACER, CONFIG_DYNAMIC_FTRACE)))]
#[inline]
pub fn set_ftrace_ops_ro() {}
