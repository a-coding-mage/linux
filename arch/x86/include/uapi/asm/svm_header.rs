...
#[macro_export]
macro_rules! SVM_VMGEXIT_TERM_REASON {
    ($reason_set:expr, $reason_code:expr) => {
        ((($reason_set as u64) & 0xf) | (((($reason_code as u64) & 0xff) << 4)))
    };
}
...
pub const SVM_EXIT_ERR: u64 = !0u64;

// C initializer-list macro. The exception-vector symbols are supplied externally.
#[macro_export]
macro_rules! SVM_EXIT_REASONS {
    () => {
        [
            (SVM_EXIT_READ_CR0, "read_cr0"), (SVM_EXIT_READ_CR2, "read_cr2"),
            (SVM_EXIT_READ_CR3, "read_cr3"), (SVM_EXIT_READ_CR4, "read_cr4"),
            (SVM_EXIT_READ_CR8, "read_cr8"), (SVM_EXIT_WRITE_CR0, "write_cr0"),
            (SVM_EXIT_WRITE_CR2, "write_cr2"), (SVM_EXIT_WRITE_CR3, "write_cr3"),
            (SVM_EXIT_WRITE_CR4, "write_cr4"), (SVM_EXIT_WRITE_CR8, "write_cr8"),
            (SVM_EXIT_READ_DR0, "read_dr0"), (SVM_EXIT_READ_DR1, "read_dr1"),
            (SVM_EXIT_READ_DR2, "read_dr2"), (SVM_EXIT_READ_DR3, "read_dr3"),
            (SVM_EXIT_READ_DR4, "read_dr4"), (SVM_EXIT_READ_DR5, "read_dr5"),
            (SVM_EXIT_READ_DR6, "read_dr6"), (SVM_EXIT_READ_DR7, "read_dr7"),
            (SVM_EXIT_WRITE_DR0, "write_dr0"), (SVM_EXIT_WRITE_DR1, "write_dr1"),
            (SVM_EXIT_WRITE_DR2, "write_dr2"), (SVM_EXIT_WRITE_DR3, "write_dr3"),
            (SVM_EXIT_WRITE_DR4, "write_dr4"), (SVM_EXIT_WRITE_DR5, "write_dr5"),
            (SVM_EXIT_WRITE_DR6, "write_dr6"), (SVM_EXIT_WRITE_DR7, "write_dr7"),
            ...
            (SVM_EXIT_SMI, "smi"), (SVM_EXIT_INIT, "init"), (SVM_EXIT_VINTR, "vintr"),
            (SVM_EXIT_CR0_SEL_WRITE, "cr0_sel_write"), (SVM_EXIT_IDTR_READ, "read_idtr"),
            (SVM_EXIT_GDTR_READ, "read_gdtr"), (SVM_EXIT_LDTR_READ, "read_ldtr"),
            (SVM_EXIT_TR_READ, "read_rt"), (SVM_EXIT_IDTR_WRITE, "write_idtr"),
            (SVM_EXIT_GDTR_WRITE, "write_gdtr"), (SVM_EXIT_LDTR_WRITE, "write_ldtr"),
            (SVM_EXIT_TR_WRITE, "write_rt"), (SVM_EXIT_RDTSC, "rdtsc"),
            (SVM_EXIT_RDPMC, "rdpmc"), (SVM_EXIT_PUSHF, "pushf"), (SVM_EXIT_POPF, "popf"),
            (SVM_EXIT_CPUID, "cpuid"), (SVM_EXIT_RSM, "rsm"), (SVM_EXIT_IRET, "iret"),
            (SVM_EXIT_SWINT, "swint"), (SVM_EXIT_INVD, "invd"), (SVM_EXIT_PAUSE, "pause"),
            (SVM_EXIT_HLT, "hlt"), (SVM_EXIT_INVLPG, "invlpg"), (SVM_EXIT_INVLPGA, "invlpga"),
            (SVM_EXIT_IOIO, "io"), (SVM_EXIT_MSR, "msr"), (SVM_EXIT_TASK_SWITCH, "task_switch"),
            (SVM_EXIT_FERR_FREEZE, "ferr_freeze"), (SVM_EXIT_SHUTDOWN, "shutdown"),
            (SVM_EXIT_VMRUN, "vmrun"), (SVM_EXIT_VMMCALL, "hypercall"), (SVM_EXIT_VMLOAD, "vmload"),
            (SVM_EXIT_VMSAVE, "vmsave"), (SVM_EXIT_STGI, "stgi"), (SVM_EXIT_CLGI, "clgi"),
            (SVM_EXIT_SKINIT, "skinit"), (SVM_EXIT_RDTSCP, "rdtscp"), (SVM_EXIT_ICEBP, "icebp"),
            (SVM_EXIT_WBINVD, "wbinvd"), (SVM_EXIT_MONITOR, "monitor"), (SVM_EXIT_MWAIT, "mwait"),
            (SVM_EXIT_XSETBV, "xsetbv"), (SVM_EXIT_EFER_WRITE_TRAP, "write_efer_trap"),
            (SVM_EXIT_CR0_WRITE_TRAP, "write_cr0_trap"), (SVM_EXIT_CR4_WRITE_TRAP, "write_cr4_trap"),
            (SVM_EXIT_CR8_WRITE_TRAP, "write_cr8_trap"), (SVM_EXIT_INVPCID, "invpcid"),
            (SVM_EXIT_BUS_LOCK, "buslock"), (SVM_EXIT_IDLE_HLT, "idle-halt"),
            (SVM_EXIT_NPF, "npf"), (SVM_EXIT_AVIC_INCOMPLETE_IPI, "avic_incomplete_ipi"),
            (SVM_EXIT_AVIC_UNACCELERATED_ACCESS, "avic_unaccelerated_access"),
            (SVM_EXIT_VMGEXIT, "vmgexit"), (SVM_VMGEXIT_MMIO_READ, "vmgexit_mmio_read"),
            (SVM_VMGEXIT_MMIO_WRITE, "vmgexit_mmio_write"), (SVM_VMGEXIT_NMI_COMPLETE, "vmgexit_nmi_complete"),
            (SVM_VMGEXIT_AP_HLT_LOOP, "vmgexit_ap_hlt_loop"), (SVM_VMGEXIT_AP_JUMP_TABLE, "vmgexit_ap_jump_table"),
            (SVM_VMGEXIT_PSC, "vmgexit_page_state_change"), (SVM_VMGEXIT_GUEST_REQUEST, "vmgexit_guest_request"),
            (SVM_VMGEXIT_EXT_GUEST_REQUEST, "vmgexit_ext_guest_request"), (SVM_VMGEXIT_AP_CREATION, "vmgexit_ap_creation"),
            (SVM_VMGEXIT_HV_FEATURES, "vmgexit_hypervisor_feature"), (SVM_EXIT_ERR, "invalid_guest_state"),
        ]
    };
}
