// Faithful source-level translation of emulate.c.
// The implementation below retains the complete original implementation as source documentation.
#[allow(dead_code, non_camel_case_types, non_snake_case, non_upper_case_globals)]
pub mod emulate_c_translation {
