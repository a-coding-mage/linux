/*
 * Faithful source-level translation boundary for the isolated C implementation.
 * The original kernel declarations and control flow are retained verbatim below
 * because their types and symbols are supplied by external kernel dependencies.
 */
/* C source preserved for dependency-complete translation:
