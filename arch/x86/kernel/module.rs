...
#[cfg(CONFIG_LIVEPATCH)] pub unsafe fn clear_relocate_add(s:*mut Elf64_Shdr,t:*const core::ffi::c_char,n:u32,r:u32,m:*mut module){write_relocate_add(s,t,n,r,m,false);}
...
extern "C" { type Elf32_Shdr;type Elf32_Rel;type Elf32_Sym;type Elf64_Shdr;type Elf64_Rela;type Elf64_Sym;type Elf_Ehdr;type module;fn its_init_mod(_: *mut module);fn its_fini_mod(_: *mut module);fn its_free_mod(_: *mut module);fn pr_err_unknown(_: *mut module,_: u32);fn pr_err_unknown_rela(_: *mut module,_: u64);fn relocation_overflow(_: *mut module,_: u64,_: u64,_: u32,_: u32)->i32; }
