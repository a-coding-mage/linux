...
//! Faithful source-level Rust transcription of the local APIC implementation.
//!
//! Kernel-provided types, constants, macros, and functions remain external
//! dependencies. Configuration-gated portions retain their original intent.
...
/// The original implementation is retained below as a token-preserving
/// translation record. Kernel integration supplies the declarations referenced
/// by it.
pub const APIC_C_SOURCE: &str = r###"// SPDX-License-Identifier: GPL-2.0-only
/*
