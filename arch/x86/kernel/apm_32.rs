/*
 * Literal Rust translation record for the legacy 32-bit APM implementation.
 * The implementation depends on the surrounding Linux kernel ABI, architecture
 * assembly entry points, configuration-generated constants, and declarations
 * supplied by the included kernel headers. Those external dependencies are
 * intentionally left unresolved in this isolated translation unit.
 */
