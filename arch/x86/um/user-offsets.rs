...
//
// Dependencies supplied by the surrounding build environment correspond to
// the C headers and kbuild offset-generation macros used by the source.
...
pub fn foo() {
    ...
    {
        // DEFINE_LONGS(sym, val): COMMENT(stringify!(val) / sizeof(unsigned long));
    ...
    DEFINE!(UM_FRAME_SIZE, core::mem::size_of::<user_regs_struct>());
