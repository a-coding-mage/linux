 ...
 * Rust translation of the Xtensa processor TIE configuration.
 */

pub const XCHAL_CP_NUM: u32 = 2;
pub const XCHAL_CP_MAX: u32 = 8;
pub const XCHAL_CP_MASK: u32 = 0x82;
pub const XCHAL_CP_PORT_MASK: u32 = 0x80;

pub const XCHAL_CP1_NAME: &str = "AudioEngineLX";
/* XCHAL_CP1_IDENT is the C preprocessor token AudioEngineLX. */
pub const XCHAL_CP1_SA_SIZE: u32 = 120;
pub const XCHAL_CP1_SA_ALIGN: u32 = 8;
pub const XCHAL_CP_ID_AUDIOENGINELX: u32 = 1;
pub const XCHAL_CP7_NAME: &str = "XTIOP";
/* XCHAL_CP7_IDENT is the C preprocessor token XTIOP. */
...
pub const XCHAL_TOTAL_SA_SIZE: u32 = 160;
pub const XCHAL_TOTAL_SA_ALIGN: u32 = 8;

/*
 * The C XCHAL_SA_REG macro is supplied by the includer. These Rust macros
 * preserve the same call-site expansion contract.
 */
#[macro_export]
...
pub const XCHAL_CP1_SA_NUM: u32 = 18;
...
/* Empty save-area lists for coprocessors 0 and 2 through 7. */
#[macro_export] macro_rules! XCHAL_CP0_SA_LIST { ($s:ident) => {}; }
#[macro_export] macro_rules! XCHAL_CP2_SA_LIST { ($s:ident) => {}; }
#[macro_export] macro_rules! XCHAL_CP3_SA_LIST { ($s:ident) => {}; }
#[macro_export] macro_rules! XCHAL_CP4_SA_LIST { ($s:ident) => {}; }
#[macro_export] macro_rules! XCHAL_CP5_SA_LIST { ($s:ident) => {}; }
#[macro_export] macro_rules! XCHAL_CP6_SA_LIST { ($s:ident) => {}; }
#[macro_export] macro_rules! XCHAL_CP7_SA_LIST { ($s:ident) => {}; }
...
pub const XCHAL_OP0_FORMAT_LENGTHS: [u8; 16] = [3,3,3,3,3,3,3,3,2,2,2,2,2,2,3,8];
/* XCHAL_BYTE0_FORMAT_LENGTHS is a 256-element C preprocessor list. */
