...
#[cfg(all(CONFIG_MMU, CONFIG_XTENSA_KSEG_MMU_V2))]
...
#[cfg(all(CONFIG_MMU, CONFIG_XTENSA_KSEG_256M))]
...
#[cfg(all(CONFIG_MMU, CONFIG_XTENSA_KSEG_512M))]
...
#[cfg(all(CONFIG_MMU, CONFIG_KSEG_PADDR))]
pub const XCHAL_KSEG_PADDR: usize = CONFIG_KSEG_PADDR;
#[cfg(all(CONFIG_MMU, not(CONFIG_KSEG_PADDR)))]
...
#[cfg(any(
    all(not(feature = "XCHAL_HAVE_PTP_MMU"), CONFIG_USE_OF),
    all(feature = "XCHAL_HAVE_SPANNING_WAY", CONFIG_USE_OF)
))]
extern "C" {
