...
pub const PROT_GROWSUP: u32 = 0x02000000; /* mprotect flag: extend change to end fo growsup vma */
...
pub const MAP_UNINITIALIZED: u32 = 0x4000000; /* For anonymous mmap, memory could be
                                                  * uninitialized */
