...
// COMPILE_OFFSETS
// Dependencies supplied by the Linux and Hexagon headers:
// linux/compat.h, linux/types.h, linux/sched.h, linux/interrupt.h,
// linux/kbuild.h, asm/ptrace.h, and asm/processor.h.
...
fn main() {
    ...
    DEFINE!(_PT_REGS_SIZE, core::mem::size_of::<pt_regs>());
    BLANK!();
    ...
    DEFINE!(
        _SWITCH_STACK_SIZE,
        core::mem::size_of::<hexagon_switch_stack>()
    );
    BLANK!();
