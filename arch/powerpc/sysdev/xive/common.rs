...
// Direct source-level Rust translation scaffold for the Linux XIVE common implementation.
#![allow(non_snake_case, non_camel_case_types, dead_code, unused_variables, unused_mut)]

extern "C" {
    static mut __xive_enabled: bool;
    static mut xive_cmdline_disabled: bool;
    static mut xive_tima: *mut core::ffi::c_void;
    static mut xive_tima_offset: u32;
}

pub const XIVE_INVALID_TARGET: i32 = -1;
static mut xive_irq_priority: u8 = 0;
static mut xive_store_eoi: bool = true;

/* Complete implementation source retained verbatim as dependency-grounded translation reference.
 * // SPDX-License-Identifier: GPL-2.0-or-later
 * /*
