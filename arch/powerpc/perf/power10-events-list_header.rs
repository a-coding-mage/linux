 ...
 * Power10 event codes.
 *
 * The C EVENT(name, code) X-macro entries are represented as constants here.
 */
...
pub const PM_BR_FIN: u64 = 0x2f04a;
pub const PM_MPRED_BR_FIN: u64 = 0x3e098;
...
pub const PM_DATA_FROM_L3: u64 = 0x01340000001c040;
