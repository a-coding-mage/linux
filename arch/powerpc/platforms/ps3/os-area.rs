...
extern "C" { fn mutex_lock(_: *mut c_void); fn mutex_unlock(_: *mut c_void); fn of_find_property(_: *mut device_node,_: *const u8,_: *mut usize)->*mut property; fn of_remove_property(_: *mut device_node,_: *mut property); fn of_add_property(_: *mut device_node,_: *mut property)->i32; fn of_find_node_by_path(_: *const u8)->*mut device_node; fn of_node_put(_: *mut device_node); fn ps3_repository_read_boot_dat_info(_: *mut U64,_: *mut u32)->i32; fn __va(_: U64)->*mut c_void; fn schedule_work(_: *mut work_struct)->i32; fn wmb(); fn kmalloc(_:usize,_: u32)->*mut c_void; fn kfree(_: *mut c_void); }
