...
extern "C" {
    ...
    fn eeh_has_flag(_: i32)->bool; fn eeh_add_flag(_: i32); fn eeh_clear_flag(_: i32); fn eeh_enabled()->bool; fn eeh_state_active(_: i32)->bool; fn eeh_dev_to_pci_dev(_: *mut eeh_dev)->*mut pci_dev; fn eeh_dev_to_pe(_: *mut eeh_dev)->*mut eeh_pe; fn pci_dev_to_eeh_dev(_: *mut pci_dev)->*mut eeh_dev;
    fn eeh_phb_pe_get(_: *mut pci_controller)->*mut eeh_pe; fn eeh_serialize_lock(_: *mut c_ulong); fn eeh_serialize_unlock(_: c_ulong); fn eeh_pe_mark_isolated(_: *mut eeh_pe); fn eeh_send_failure_event(_: *mut eeh_pe); fn __eeh_send_failure_event(_: *mut eeh_pe); fn eeh_wait_state(_: *mut eeh_pe,_: i32)->i32; fn eeh_pe_state_mark(_: *mut eeh_pe,_: i32); fn eeh_pe_state_clear(_: *mut eeh_pe,_: i32,_: bool); fn eeh_pe_passed(_: *mut eeh_pe)->bool; fn eeh_unfreeze_pe(_: *mut eeh_pe)->i32; fn eeh_pe_reset(_: *mut eeh_pe,_: i32,_: bool)->i32; fn eeh_pe_restore_bars(_: *mut eeh_pe); fn eeh_pe_reset_and_recover(_: *mut eeh_pe)->i32; fn eeh_pe_set_option(_: *mut eeh_pe,_: i32)->i32;
    fn ppc_find_vmap_phys(_: c_ulong)->c_ulong; fn eeh_addr_cache_get_dev(_: c_ulong)->*mut eeh_dev; fn eeh_addr_cache_init(); fn eeh_addr_cache_insert_dev(_: *mut pci_dev); fn eeh_addr_cache_rmv_dev(_: *mut pci_dev); fn eeh_event_init()->i32; fn eeh_phb_pe_create(_: *mut pci_controller); fn eeh_pe_tree_remove(_: *mut eeh_dev); fn eeh_sysfs_remove_device(_: *mut pci_dev); fn eeh_sysfs_add_device(_: *mut pci_dev); fn pci_reenable_device(_: *mut pci_dev)->i32; fn pci_set_power_state(_: *mut pci_dev,_: i32); fn pci_save_state(_: *mut pci_dev); fn pci_restore_state(_: *mut pci_dev); fn pci_write_config_word(_: *mut pci_dev,_: i32,_: u16); fn pci_read_config_word(_: *mut pci_dev,_: i32,_: *mut u16); fn pci_name(_: *mut pci_dev)->*const c_char;
}
