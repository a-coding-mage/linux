...
extern "C" {
    ...
    fn proc_create(_: *const u8, _: u32, _: *mut inode, _: *const proc_ops) -> *mut inode;
    fn proc_create_single(_: *const u8, _: u32, _: *mut inode, _: unsafe extern "C" fn(*mut seq_file, *mut core::ffi::c_void) -> i32) -> *mut inode;
    fn machine_is(x: i32) -> bool; fn of_find_node_by_name(_: *mut device_node, _: *const u8) -> *mut device_node;
    fn copy_from_user(_: *mut u8, _: *const u8, _: usize) -> usize;
    fn kstrtoull(_: *const u8, _: u32, _: *mut u64) -> i32;
    fn rtc_time64_to_tm(_: i64, _: *mut rtc_time);
    fn rtas_function_token(_: i32) -> i32;
    fn rtas_call(_: i32, _: i32, _: i32, _: *mut i32, ... ) -> i32;
    fn printk(_: *const u8, ...);
    fn rtas_progress(_: *const u8, _: u64);
    fn mktime64(_: u32,_: u32,_: u32,_: u32,_: u32,_: u32) -> i64;
    fn of_get_property(_: *mut device_node, _: *const u8, _: *mut i32) -> *const u8;
    fn seq_printf(_: *mut seq_file, _: *const u8, ...); fn seq_putc(_: *mut seq_file, _: i32);
    fn simple_strtoul(_: *const u8, _: *mut *const u8, _: u32) -> u64;
}
