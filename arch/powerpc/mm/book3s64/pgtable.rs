...
pub static mut tlbie_capable: bool = cfg!(CONFIG_PPC_RADIX_BROADCAST_TLBIE);
pub static mut tlbie_enabled: bool = cfg!(CONFIG_PPC_RADIX_BROADCAST_TLBIE);
...
#[cfg(all(CONFIG_ZONE_DEVICE, CONFIG_ARCH_HAS_MEMREMAP_COMPAT_ALIGN))]
