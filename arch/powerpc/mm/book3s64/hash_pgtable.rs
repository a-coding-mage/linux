...
#[cfg(CONFIG_STRICT_KERNEL_RWX)] static mut chmem_parms: change_memory_parms = unsafe { core::mem::zeroed() };
#[cfg(CONFIG_STRICT_KERNEL_RWX)] static mut chmem_lock: mutex = unsafe { core::mem::zeroed() };
