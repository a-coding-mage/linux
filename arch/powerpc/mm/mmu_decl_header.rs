...
mod mmu_nohash {
    ...
    #[cfg(all(not(CONFIG_PPC_8xx), CONFIG_PPC_BOOK3E_64))]
    unsafe extern "C" { pub fn _tlbil_va(address: usize, pid: u32, tsize: u32, ind: u32); }

    #[cfg(all(not(CONFIG_PPC_8xx), not(CONFIG_PPC_BOOK3E_64)))]
    ...
    #[cfg(any(CONFIG_PPC_BOOK3E_64, CONFIG_PPC_47x))]
    unsafe extern "C" { pub fn _tlbivax_bcast(address: usize, pid: u32, tsize: u32, ind: u32); }

    #[cfg(not(any(CONFIG_PPC_BOOK3E_64, CONFIG_PPC_47x)))]
    #[inline]
...
#[cfg(all(CONFIG_PPC_E500, CONFIG_PPC32))]
unsafe extern "C" {
...
pub unsafe fn debug_pagealloc_enabled_or_kfence() -> bool {
    cfg!(CONFIG_KFENCE) || debug_pagealloc_enabled()
}
