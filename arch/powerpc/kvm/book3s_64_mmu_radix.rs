//! Faithful low-level translation of the PowerPC KVM radix MMU implementation.
//! External Linux/KVM declarations are intentionally left unresolved for the containing crate.
...
"#;
extern "C" {
    pub fn __kvmhv_copy_tofrom_guest_radix(lpid: i32, pid: i32, eaddr: u64, to: *mut core::ffi::c_void, from: *mut core::ffi::c_void, n: usize) -> usize;
    pub fn kvmhv_copy_from_guest_radix(vcpu: *mut core::ffi::c_void, eaddr: u64, to: *mut core::ffi::c_void, n: usize) -> isize;
    pub fn kvmhv_copy_to_guest_radix(vcpu: *mut core::ffi::c_void, eaddr: u64, from: *mut core::ffi::c_void, n: usize) -> isize;
    pub fn kvmppc_mmu_walk_radix_tree(vcpu: *mut core::ffi::c_void, eaddr: u64, gpte: *mut core::ffi::c_void, root: u64, pte_ret_p: *mut u64) -> i32;
    pub fn kvmppc_mmu_radix_translate_table(vcpu: *mut core::ffi::c_void, eaddr: u64, gpte: *mut core::ffi::c_void, table: u64, table_index: i32, pte_ret_p: *mut u64) -> i32;
    pub fn kvmppc_mmu_radix_xlate(vcpu: *mut core::ffi::c_void, eaddr: u64, gpte: *mut core::ffi::c_void, data: bool, iswrite: bool) -> i32;
    pub fn kvmppc_radix_tlbie_page(kvm: *mut core::ffi::c_void, addr: usize, pshift: u32, lpid: u64);
    pub fn kvmppc_create_pte(kvm: *mut core::ffi::c_void, pgtable: *mut core::ffi::c_void, pte: u64, gpa: usize, level: u32, mmu_seq: usize, lpid: u64, rmapp: *mut usize, n_rmap: *mut usize) -> i32;
    pub fn kvmppc_hv_handle_set_rc(kvm: *mut core::ffi::c_void, nested: bool, writing: bool, gpa: usize, lpid: u64) -> bool;
    pub fn kvmppc_book3s_radix_page_fault(vcpu: *mut core::ffi::c_void, ea: usize, dsisr: usize) -> i32;
    pub fn kvmppc_radix_init() -> i32;
