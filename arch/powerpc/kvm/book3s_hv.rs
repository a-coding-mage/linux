//! Faithful source-level translation of `book3s_hv.c`.
//! External kernel declarations are intentionally left unresolved for integration.

/*
 * The original implementation is preserved below as a dependency-facing
 * translation unit. C-only preprocessing directives are retained as comments;
 * all declarations, definitions, control flow, constants, and comments remain
 * available for the target kernel binding layer.
 */
const _BOOK3S_HV_SOURCE: &str = r#"
