...
unsafe fn kvmppc_core_get_sregs_e500mc(vcpu:*mut kvm_vcpu,sregs:*mut kvm_sregs)->i32 { let e=to_e500(vcpu); (*sregs).u.e.features|=KVM_SREGS_E_ARCH206_MMU|KVM_SREGS_E_PM|KVM_SREGS_E_PC; (*sregs).u.e.impl_id=KVM_SREGS_E_IMPL_FSL; (*sregs).u.e.r#impl.fsl.features=0; (*sregs).u.e.r#impl.fsl.svr=(*e).svr; (*sregs).u.e.r#impl.fsl.hid0=(*e).hid0; (*sregs).u.e.r#impl.fsl.mcar=(*e).mcar; kvmppc_get_sregs_e500_tlb(vcpu,sregs); (*sregs).u.e.ivor_high[3]=(*vcpu).arch.ivor[BOOKE_IRQPRIO_PERFORMANCE_MONITOR]; (*sregs).u.e.ivor_high[4]=(*vcpu).arch.ivor[BOOKE_IRQPRIO_DBELL]; (*sregs).u.e.ivor_high[5]=(*vcpu).arch.ivor[BOOKE_IRQPRIO_DBELL_CRIT]; kvmppc_get_sregs_ivor(vcpu,sregs) }

// The remaining operations retain the C ABI-facing callback structure and external helper calls.
unsafe fn kvmppc_core_set_sregs_e500mc(vcpu:*mut kvm_vcpu,sregs:*mut kvm_sregs)->i32 { let e=to_e500(vcpu); if (*sregs).u.e.impl_id==KVM_SREGS_E_IMPL_FSL { (*e).svr=(*sregs).u.e.r#impl.fsl.svr; (*e).hid0=(*sregs).u.e.r#impl.fsl.hid0; (*e).mcar=(*sregs).u.e.r#impl.fsl.mcar; } let r=kvmppc_set_sregs_e500_tlb(vcpu,sregs); if r<0{return r} if (*sregs).u.e.features&KVM_SREGS_E_IVOR==0{return 0} if (*sregs).u.e.features&KVM_SREGS_E_PM!=0 {(*vcpu).arch.ivor[BOOKE_IRQPRIO_PERFORMANCE_MONITOR]=(*sregs).u.e.ivor_high[3]} if (*sregs).u.e.features&KVM_SREGS_E_PC!=0 {(*vcpu).arch.ivor[BOOKE_IRQPRIO_DBELL]=(*sregs).u.e.ivor_high[4];(*vcpu).arch.ivor[BOOKE_IRQPRIO_DBELL_CRIT]=(*sregs).u.e.ivor_high[5]} kvmppc_set_sregs_ivor(vcpu,sregs) }
