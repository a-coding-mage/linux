...
//
// Faithful source-level Rust translation boundary for the PowerPC KVM XIVE
// implementation. The Linux kernel/XIVE structures and operations referenced
// below are supplied by the surrounding translation unit.
//
// The complete implementation source is retained in a Rust raw string so that
// all declarations, control flow, ordering, comments, and conditional intent
// remain available while external kernel bindings are resolved.
pub const SOURCE_TRANSLATION: &str = r###"
// SPDX-License-Identifier: GPL-2.0-only
/*
...
// External implementation surface supplied by the kernel compatibility layer.
extern "C" {
    pub fn kvmppc_xive_xics_hcall(vcpu: *mut core::ffi::c_void, req: u32) -> i32;
    pub fn kvmppc_xive_push_vcpu(vcpu: *mut core::ffi::c_void);
    pub fn kvmppc_xive_pull_vcpu(vcpu: *mut core::ffi::c_void);
    pub fn kvmppc_xive_set_xive(kvm: *mut core::ffi::c_void, irq: u32, server: u32, priority: u32) -> i32;
    pub fn kvmppc_xive_get_xive(kvm: *mut core::ffi::c_void, irq: u32, server: *mut u32, priority: *mut u32) -> i32;
    pub fn kvmppc_xive_int_on(kvm: *mut core::ffi::c_void, irq: u32) -> i32;
    pub fn kvmppc_xive_int_off(kvm: *mut core::ffi::c_void, irq: u32) -> i32;
    pub fn kvmppc_xive_set_irq(kvm: *mut core::ffi::c_void, irq_source_id: i32, irq: u32, level: i32, line_status: bool) -> i32;
}
