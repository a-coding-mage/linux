...
/* Translated from the PowerPC UAPI header. */
/* Dependency supplied by asm-generic/termbits-common.h: cc_t and speed_t. */
...
pub const XTABS: u32 = 0x00c00; /* required by POSIX to == TAB3 */
...
/* c_cflag bit meaning */
pub const CBAUD: u32 = 0x000000ff;
...
pub const CIBAUD: u32 = 0x00ff0000;
