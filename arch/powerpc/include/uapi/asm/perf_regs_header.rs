...
pub enum perf_event_powerpc_regs {
    ...
    PERF_REG_POWERPC_MAX = PERF_REG_POWERPC_MMCRA as u32 + 1,
    /* Max mask value for interrupt regs including extended regs */
    PERF_REG_EXTENDED_MAX = PERF_REG_POWERPC_SIAR as u32 + 1,
}

pub const PERF_REG_PMU_MASK: u64 = (1u64 << (PERF_REG_POWERPC_MAX as u32)) - 1;
...
pub const PERF_REG_PMU_MASK_300: u64 =
    (1u64 << (PERF_REG_POWERPC_MMCR0 as u32)) |
    (1u64 << (PERF_REG_POWERPC_MMCR1 as u32)) |
    (1u64 << (PERF_REG_POWERPC_MMCR2 as u32)) |
    (1u64 << (PERF_REG_POWERPC_PMC1 as u32)) |
    (1u64 << (PERF_REG_POWERPC_PMC2 as u32)) |
    (1u64 << (PERF_REG_POWERPC_PMC3 as u32)) |
    (1u64 << (PERF_REG_POWERPC_PMC4 as u32)) |
    (1u64 << (PERF_REG_POWERPC_PMC5 as u32)) |
    (1u64 << (PERF_REG_POWERPC_PMC6 as u32)) |
    (1u64 << (PERF_REG_POWERPC_SDAR as u32)) |
    (1u64 << (PERF_REG_POWERPC_SIAR as u32));

/*
 * PERF_REG_EXTENDED_MASK value for CPU_FTR_ARCH_31
 * includes 14 SPRs from MMCR0 to SIAR.
 */
pub const PERF_REG_PMU_MASK_31: u64 =
    PERF_REG_PMU_MASK_300 |
    (1u64 << (PERF_REG_POWERPC_MMCR3 as u32)) |
    (1u64 << (PERF_REG_POWERPC_SIER2 as u32)) |
    (1u64 << (PERF_REG_POWERPC_SIER3 as u32));
