...
extern "C" {
    pub fn ps3av_set_hdr(_: u32, _: u16, _: *mut ps3av_send_hdr);
    pub fn ps3av_do_pkt(_: u32, _: u16, _: usize, _: *mut ps3av_send_hdr) -> i32;
    pub fn ps3av_cmd_init() -> i32;
    pub fn ps3av_cmd_fin() -> i32;
    pub fn ps3av_cmd_av_video_mute(_: i32, _: *mut u32, _: u32) -> i32;
    pub fn ps3av_cmd_av_video_disable_sig(_: u32) -> i32;
    pub fn ps3av_cmd_av_tv_mute(_: u32, _: u32) -> i32;
    pub fn ps3av_cmd_enable_event() -> i32;
    pub fn ps3av_cmd_av_hdmi_mode(_: u8) -> i32;
    pub fn ps3av_cmd_set_av_video_cs(_: *mut core::ffi::c_void, _: u32, _: i32, _: i32, _: i32, _: u32) -> u32;
    pub fn ps3av_cmd_set_video_mode(_: *mut core::ffi::c_void, _: u32, _: i32, _: i32, _: u32) -> u32;
    pub fn ps3av_cmd_video_format_black(_: u32, _: u32, _: u32) -> i32;
    pub fn ps3av_cmd_av_audio_mute(_: i32, _: *mut u32, _: u32) -> i32;
    pub fn ps3av_cmd_set_av_audio_param(_: *mut core::ffi::c_void, _: u32, _: *const ps3av_pkt_audio_mode, _: u32) -> u32;
    pub fn ps3av_cmd_set_audio_mode(_: *mut ps3av_pkt_audio_mode, _: u32, _: u32, _: u32, _: u32, _: u32, _: u32);
    pub fn ps3av_cmd_audio_mode(_: *mut ps3av_pkt_audio_mode) -> i32;
    pub fn ps3av_cmd_audio_mute(_: i32, _: *mut u32, _: u32) -> i32;
    pub fn ps3av_cmd_audio_active(_: i32, _: u32) -> i32;
    pub fn ps3av_cmd_avb_param(_: *mut ps3av_pkt_avb_param, _: u32) -> i32;
    pub fn ps3av_cmd_av_get_hw_conf(_: *mut ps3av_pkt_av_get_hw_conf) -> i32;
    pub fn ps3av_cmd_video_get_monitor_info(_: *mut ps3av_pkt_av_get_monitor_info, _: u32) -> i32;
    pub fn ps3av_set_video_mode(_: i32) -> i32;
    pub fn ps3av_set_audio_mode(_: u32, _: u32, _: u32, _: u32, _: u32) -> i32;
    pub fn ps3av_get_auto_mode() -> i32;
    pub fn ps3av_get_mode() -> i32;
    pub fn ps3av_video_mode2res(_: u32, _: *mut u32, _: *mut u32) -> i32;
    pub fn ps3av_video_mute(_: i32) -> i32;
    pub fn ps3av_audio_mute(_: i32) -> i32;
    pub fn ps3av_audio_mute_analog(_: i32) -> i32;
}
