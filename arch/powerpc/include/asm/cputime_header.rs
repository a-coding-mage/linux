 ...
 */
#[cfg(all(CONFIG_VIRT_CPU_ACCOUNTING_NATIVE, feature = "__KERNEL__", CONFIG_PPC64))]
...
#[cfg(all(CONFIG_VIRT_CPU_ACCOUNTING_NATIVE, feature = "__KERNEL__", not(CONFIG_PPC64)))]
macro_rules! get_accounting {
    ($tsk:expr) => {
