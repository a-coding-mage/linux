...
// COMPILE_OFFSETS
// The declarations and offset-generation macros below are supplied by the
// kernel build environment represented by the included C headers.
...
fn main() -> i32 {
    ...
    DEFINE!(PT_REGS_SIZE, core::mem::size_of::<pt_regs>());
    BLANK!();
