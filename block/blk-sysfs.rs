...
macro_rules! simple_limit { ($n:tt) => { unsafe fn ::kernel::macros::paste!([<$n _show>])(d:*mut gendisk,p:*mut i8)->isize{queue_var_show((*(*d).queue).limits.$n as usize,p)} }; }
...
extern "C" {
    fn sysfs_emit(_: *mut i8,_: *const i8,...) -> isize; fn kstrtoul(_: *const i8,_: u32,_: *mut usize)->i32; fn kstrtou32(_: *const i8,_: u32,_: *mut u32)->i32;
    fn mutex_lock(_: *mut mutex); fn mutex_unlock(_: *mut mutex); fn down_write_trylock(_: *mut rw_semaphore)->i32; fn up_write(_: *mut rw_semaphore);
    fn blk_mq_freeze_queue(_: *mut request_queue)->u32; fn blk_mq_unfreeze_queue(_: *mut request_queue,_: u32); fn blk_mq_quiesce_queue(_: *mut request_queue); fn blk_mq_unquiesce_queue(_: *mut request_queue);
    fn queue_is_mq(_: *mut request_queue)->bool; fn blk_mq_is_shared_tags(_: u32)->bool; fn blk_mq_alloc_sched_tags(_: *mut blk_mq_tag_set,_: u32,_: usize)->*mut elevator_tags; fn blk_mq_update_nr_requests(_: *mut request_queue,_: *mut elevator_tags,_: usize)->*mut elevator_tags; fn blk_mq_free_sched_tags(_: *mut elevator_tags,_: *mut blk_mq_tag_set);
    fn blk_mq_can_poll(_: *mut request_queue)->u32; fn blk_queue_is_zoned(_: *mut request_queue)->bool; fn disk_nr_zones(_: *mut gendisk)->usize; fn blk_queue_zoned_qd1_writes(_: *mut request_queue)->bool; fn blk_queue_passthrough_stat(_: *mut request_queue)->bool; fn blk_queue_nomerges(_: *mut request_queue)->bool; fn blk_queue_noxmerges(_: *mut request_queue)->bool; fn blk_queue_write_cache(_: *mut request_queue)->bool; fn blk_queue_rq_timeout(_: *mut request_queue,_: u32); fn msecs_to_jiffies(_: u32)->u32; fn jiffies_to_msecs(_: u32)->u32; fn blk_queue_flag_set(_: u32,_: *mut request_queue); fn blk_queue_flag_clear(_: u32,_: *mut request_queue);
}
