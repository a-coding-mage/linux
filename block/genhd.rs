...
extern "C" {
    ...
    fn bdev_set_nr_sectors(_: *mut block_device, _: sector_t); fn get_capacity(_: *mut gendisk) -> sector_t;
    fn disk_live(_: *mut gendisk) -> bool; fn disk_to_dev(_: *mut gendisk) -> *mut device;
    fn kobject_uevent_env(_: *mut kobject, _: c_int, _: *mut *mut c_char) -> c_int;
    fn kobject_uevent(_: *mut kobject, _: c_int) -> c_int; fn kobject_get_unless_zero(_: *mut kobject) -> *mut kobject;
    fn put_device(_: *mut device); fn bdev_kobj(_: *mut block_device) -> *mut kobject;
    fn blk_mq_in_driver_rw(_: *mut block_device, _: *mut c_uint); fn part_stat_local_read_cpu(_: *mut block_device, _: c_int, _: c_int) -> c_int;
    fn ida_alloc_range(_: *mut c_void, _: c_uint, _: c_uint, _: c_uint) -> c_int; fn ida_free(_: *mut c_void, _: c_uint);
    fn kmalloc_obj(size: usize) -> *mut c_void; fn kfree(_: *mut c_void); fn strscpy(_: *mut c_char,_: *const c_char,_: usize)->isize;
    fn mutex_lock(_: *mut c_void); fn mutex_unlock(_: *mut c_void); fn spin_lock(_: *mut c_void); fn spin_unlock(_: *mut c_void);
    fn blk_alloc_queue(_: *mut queue_limits,_: c_int)->*mut request_queue; fn blk_put_queue(_: *mut request_queue);
    fn bdev_alloc(_: *mut gendisk,_: u8)->*mut block_device; fn bdev_drop(_: *mut block_device);
    fn bioset_init(_: *mut c_void,_: c_uint,_: c_uint,_: c_uint)->c_int; fn bioset_exit(_: *mut c_void);
    fn bdi_alloc(_: c_int)->*mut c_void; fn bdi_put(_: *mut c_void); fn blkcg_init_disk(_: *mut gendisk)->c_int; fn blkcg_exit_disk(_: *mut gendisk);
    fn xa_init(_: *mut c_void); fn xa_destroy(_: *mut c_void); fn xa_insert(_: *mut c_void,_: usize,_: *mut c_void,_: c_uint)->c_int; fn xa_erase(_: *mut c_void,_: usize);
    fn memalloc_noio_save()->c_uint; fn memalloc_noio_restore(_: c_uint); fn down_read(_: *mut c_void); fn up_read(_: *mut c_void);
    fn set_bit(_: c_int,_: *mut c_ulong); fn test_bit(_: c_int,_: *const c_ulong)->bool; fn test_and_set_bit(_: c_int,_: *mut c_ulong)->bool; fn test_and_clear_bit(_: c_int,_: *mut c_ulong)->bool;
    fn device_initialize(_: *mut device); fn device_add(_: *mut device)->c_int; fn device_del(_: *mut device); fn dev_set_name(_: *mut device,_: *const c_char,...);
    fn rq_qos_exit(_: *mut request_queue); fn blk_register_queue(_: *mut gendisk)->c_int; fn blk_unregister_queue(_: *mut gendisk);
    fn blk_queue_start_drain(_: *mut request_queue)->bool; fn blk_queue_flag_set(_: c_int,_: *mut request_queue); fn blk_mq_exit_queue(_: *mut request_queue);
    fn blk_mq_freeze_queue_wait(_: *mut request_queue); fn blk_mq_cancel_work_sync(_: *mut request_queue); fn blk_sync_queue(_: *mut request_queue);
    fn bdi_register(_: *mut c_void,_: *const c_char,...)->c_int; fn bdi_unregister(_: *mut c_void); fn bdi_set_owner(_: *mut c_void,_: *mut device);
    fn sysfs_create_link(_: *mut kobject,_: *mut kobject,_: *const c_char)->c_int; fn sysfs_remove_link(_: *mut kobject,_: *const c_char);
    fn kobject_create_and_add(_: *const c_char,_: *mut kobject)->*mut kobject; fn kobject_put(_: *mut kobject);
    fn fput(_: *mut c_void); fn bdev_file_open_by_dev(_: dev_t,_: blk_mode_t,_: *mut c_void,_: *mut c_void)->*mut c_void;
    fn bd_prepare_to_claim(_: *mut block_device,_: *mut c_void,_: *mut c_void)->c_int; fn bd_abort_claiming(_: *mut block_device,_: *mut c_void);
    fn device_add_disk(_: *mut device,_: *mut gendisk,_: *const *const attribute_group)->c_int;
}
