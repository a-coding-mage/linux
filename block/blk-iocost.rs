// Faithful low-level translation container for blk-iocost.c.
// The implementation depends on Linux kernel headers and project-local ABI
// definitions which are intentionally left as external dependencies.
#![allow(non_camel_case_types, non_snake_case, non_upper_case_globals, dead_code)]

/*
 * The complete source is retained below while its kernel-specific declarations
 * are resolved by the containing translation unit. C layout and operations are
 * intentionally preserved verbatim for source-level translation.
 */
