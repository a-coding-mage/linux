...
extern "C" {
    ...
    fn sbitmap_queue_recalculate_wake_batch(_: *mut sbitmap_queue,_: u32); fn sbitmap_queue_wake_all(_: *mut sbitmap_queue); fn sbitmap_queue_get_shallow(_: *mut sbitmap_queue,_: u32)->i32; fn __sbitmap_queue_get(_: *mut sbitmap_queue)->i32; fn __sbitmap_queue_get_batch(_: *mut sbitmap_queue,_: i32,_: *mut u32)->u64;
    fn hctx_may_queue(_: *mut blk_mq_hw_ctx,_: *mut sbitmap_queue)->bool; fn bt_wait_ptr(_: *mut sbitmap_queue,_: *mut blk_mq_hw_ctx)->*mut sbq_wait_state; fn sbitmap_prepare_to_wait(_: *mut sbitmap_queue,_: *mut sbq_wait_state,_: *mut c_void,_: i32); fn sbitmap_finish_wait(_: *mut sbitmap_queue,_: *mut sbq_wait_state,_: *mut c_void); fn sbitmap_queue_wake_up(_: *mut sbitmap_queue,_: u32); fn io_schedule(); fn blk_mq_run_hw_queue(_: *mut blk_mq_hw_ctx,_: bool);
    fn blk_mq_tags_from_data(_: *mut blk_mq_alloc_data)->*mut blk_mq_tags; fn blk_mq_get_ctx(_: *mut request_queue)->*mut blk_mq_ctx; fn blk_mq_map_queue(_: u32,_: *mut blk_mq_ctx)->*mut blk_mq_hw_ctx; fn blk_mq_put_tag(_: *mut blk_mq_tags,_: *mut blk_mq_ctx,_: u32); fn blk_mq_tag_is_reserved(_: *mut blk_mq_tags,_: u32)->bool;
    fn sbitmap_queue_clear(_: *mut sbitmap_queue,_: i32,_: i32); fn sbitmap_queue_clear_batch(_: *mut sbitmap_queue,_: u32,_: *mut i32,_: i32); fn req_ref_inc_not_zero(_: *mut request)->bool; fn blk_mq_put_rq_ref(_: *mut request); fn blk_mq_request_started(_: *mut request)->bool; fn blk_mq_request_completed(_: *mut request)->bool;
    fn sbitmap_for_each_set(_: *mut sbitmap, _: unsafe extern "C" fn(*mut sbitmap,u32,*mut c_void)->bool,*mut c_void); fn srcu_read_lock(_: *mut srcu_struct)->i32; fn srcu_read_unlock(_: *mut srcu_struct,_: i32); fn msleep(_: u32); fn percpu_ref_tryget(_: *mut percpu_ref)->bool; fn blk_queue_exit(_: *mut request_queue); fn blk_mq_hw_queue_mapped(_: *mut blk_mq_hw_ctx)->bool;
    fn sbitmap_queue_init_node(_: *mut sbitmap_queue,_: u32,_: i32,_: bool,_: u32,_: i32)->i32; fn sbitmap_queue_free(_: *mut sbitmap_queue); fn sbitmap_queue_resize(_: *mut sbitmap_queue,_: u32); fn blk_mq_unique_tag_impl(_: *mut request)->u32;
}
