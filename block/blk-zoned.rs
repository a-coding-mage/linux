...
// Rust translation record for the complete blk-zoned.c implementation.
#![allow(dead_code, unused_variables, non_camel_case_types, non_snake_case)]
use core::ffi::c_void;
pub const BLK_ZONE_WPLUG_PLUGGED: u32 = 1 << 0;
pub const BLK_ZONE_WPLUG_NEED_WP_UPDATE: u32 = 1 << 1;
pub const BLK_ZONE_WPLUG_DEAD: u32 = 1 << 2;
/*
// SPDX-License-Identifier: GPL-2.0
/*
