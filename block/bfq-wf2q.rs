...
// Faithful source-level Rust translation; kernel dependencies are external.
#![allow(dead_code, unused_variables, unsafe_op_in_unsafe_fn)]

pub const WFQ_SERVICE_SHIFT: u32 = 22;

#[inline]
pub unsafe fn bfq_gt(a: u64, b: u64) -> bool {
    (a.wrapping_sub(b) as i64) > 0
}

#[inline]
pub fn bfq_delta(service: usize, weight: usize) -> u64 {
    (((service as u64) << WFQ_SERVICE_SHIFT) / weight as u64)
}

#[inline]
pub fn bfq_ioprio_to_weight(ioprio: i32) -> u16 {
    ((IOPRIO_NR_LEVELS - ioprio) * BFQ_WEIGHT_CONVERSION_COEFF) as u16
}

// Supplied by bfq-iosched.h in the kernel integration.
extern "C" {
    static IOPRIO_NR_LEVELS: i32;
    static BFQ_WEIGHT_CONVERSION_COEFF: i32;
}
