// Faithful translation container for the Linux-kernel BFQ implementation.
// The referenced kernel declarations remain external dependencies by design.
pub const BFQ_IOSCHED_SOURCE: &str = r###"
