...
// Dependencies are provided by the surrounding driver translation unit.

static mut c3xxxiov_class: adf_hw_device_class = adf_hw_device_class {
...
pub unsafe fn adf_init_hw_data_c3xxxiov(hw_data: *mut adf_hw_device_data) {
    (*hw_data).dev_class = &raw mut c3xxxiov_class;
...
pub unsafe fn adf_clean_hw_data_c3xxxiov(hw_data: *mut adf_hw_device_data) {
    (*(*hw_data).dev_class).instances -= 1;
    adf_devmgr_update_class_index(hw_data);
}
