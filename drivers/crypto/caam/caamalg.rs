// Faithful low-level Rust translation scaffold for the isolated CAAM implementation.
// External kernel types, functions, and constants remain dependencies supplied by the surrounding tree.
...
// dependency: #include "compat.h"

// dependency: #include "regs.h"
// dependency: #include "intern.h"
// dependency: #include "desc_constr.h"
// dependency: #include "jr.h"
// dependency: #include "error.h"
// dependency: #include "sg_sw_sec4.h"
// dependency: #include "key_gen.h"
// dependency: #include "caamalg_desc.h"
// dependency: #include <linux/unaligned.h>
// dependency: #include <crypto/internal/aead.h>
// dependency: #include <crypto/internal/engine.h>
// dependency: #include <crypto/internal/skcipher.h>
// dependency: #include <crypto/xts.h>
// dependency: #include <keys/trusted-type.h>
// dependency: #include <linux/dma-mapping.h>
// dependency: #include <linux/device.h>
// dependency: #include <linux/err.h>
// dependency: #include <linux/module.h>
// dependency: #include <linux/kernel.h>
// dependency: #include <linux/key-type.h>
// dependency: #include <linux/slab.h>
// dependency: #include <linux/string.h>
// dependency: #include <soc/fsl/caam-blob.h>

/*
 * crypto alg
 */
// C macro preserved: #define CAAM_CRA_PRIORITY		3000
/* max key is sum of AES_MAX_KEY_SIZE, max split key size */
// C macro preserved: #define CAAM_MAX_KEY_SIZE		(AES_MAX_KEY_SIZE + \
					 CTR_RFC3686_NONCE_SIZE + \
					 SHA512_DIGEST_SIZE * 2)

// C macro preserved: #define AEAD_DESC_JOB_IO_LEN		(DESC_JOB_IO_LEN + CAAM_CMD_SZ * 2)
// C macro preserved: #define GCM_DESC_JOB_IO_LEN		(AEAD_DESC_JOB_IO_LEN + \
					 CAAM_CMD_SZ * 4)
// C macro preserved: #define AUTHENC_DESC_JOB_IO_LEN		(AEAD_DESC_JOB_IO_LEN + \
					 CAAM_CMD_SZ * 5)

// C macro preserved: #define CHACHAPOLY_DESC_JOB_IO_LEN	(AEAD_DESC_JOB_IO_LEN + CAAM_CMD_SZ * 6)

// C macro preserved: #define DESC_MAX_USED_BYTES		(CAAM_DESC_BYTES_MAX - DESC_JOB_IO_LEN_MIN)
// C macro preserved: #define DESC_MAX_USED_LEN		(DESC_MAX_USED_BYTES / CAAM_CMD_SZ)
