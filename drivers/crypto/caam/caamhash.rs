...
// Direct source-level Rust translation boundary. External kernel/CAAM symbols
// are intentionally left for the surrounding crate to provide.
pub const CAAMHASH_C_SOURCE: &str = r####"
