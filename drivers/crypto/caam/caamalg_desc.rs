// Faithful low-level Rust translation of caamalg_desc.c
#![allow(non_snake_case, non_camel_case_types, dead_code, unused_variables)]
use core::ffi::c_void;
use core::ffi::c_int;
type c_uint = u32;
type dma_addr_t = usize;
#[repr(C)] pub struct alginfo { pub key_inline: bool, pub key_virt: *mut u8, pub keylen_pad: u32, pub keylen: u32, pub key_dma: dma_addr_t, pub algtype: u32, pub protected_key_dma: dma_addr_t, pub plain_keylen: u32, pub key_cmd_opt: u32 }
...
// external dependency: #include "compat.h"
// external dependency: #include "desc_constr.h"
// external dependency: #include "caamalg_desc.h"
// external dependency: #include <soc/fsl/caam-blob.h>
 ...
 */
#[inline]
unsafe fn void aead_append_src_dst(desc: *mut u32, msg_type: u32)
{
 ...
 * @era: SEC Era
 */
void cnstr_shdsc_aead_null_encap(desc: *mut u32, adata: *mut alginfo,
				 icvsize: c_uint, era: c_int)
{
	key_jump_cmd: *mut u32, *read_move_cmd, *write_move_cmd;
 ...
 * @era: SEC Era
 */
void cnstr_shdsc_aead_null_decap(desc: *mut u32, adata: *mut alginfo,
				 icvsize: c_uint, era: c_int)
{
	key_jump_cmd: *mut u32, *read_move_cmd, *write_move_cmd, *jump_cmd;
 ...
 * @era: SEC Era
 */
void cnstr_shdsc_aead_encap(desc: *mut u32, cdata: *mut alginfo,
			    adata: *mut alginfo, ivsize: c_uint,
			    icvsize: c_uint, is_rfc3686: bool,
			    nonce: *mut u32, const ctx1_iv_off: u32, is_qi: bool,
			    era: c_int)
{
	/* Note: Context registers are saved. */
 ...
 * @era: SEC Era
 */
void cnstr_shdsc_aead_decap(desc: *mut u32, cdata: *mut alginfo,
			    adata: *mut alginfo, ivsize: c_uint,
			    icvsize: c_uint, geniv: bool,
			    is_rfc3686: bool, nonce: *mut u32,
			    const ctx1_iv_off: u32, is_qi: bool, era: c_int)
{
	/* Note: Context registers are saved. */
	init_sh_desc_key_aead(desc, cdata, adata, is_rfc3686, nonce, era);
 ...
 * @era: SEC Era
 */
void cnstr_shdsc_aead_givencap(desc: *mut u32, cdata: *mut alginfo,
			       adata: *mut alginfo, ivsize: c_uint,
			       icvsize: c_uint, is_rfc3686: bool,
 ...
 * @is_qi: true when called from caam/qi
 */
void cnstr_shdsc_gcm_encap(desc: *mut u32, cdata: *mut alginfo,
			   ivsize: c_uint, icvsize: c_uint,
			   is_qi: bool)
{
	key_jump_cmd: *mut u32, *zero_payload_jump_cmd, *zero_assoc_jump_cmd1,
 ...
 * @is_qi: true when called from caam/qi
 */
void cnstr_shdsc_gcm_decap(desc: *mut u32, cdata: *mut alginfo,
			   ivsize: c_uint, icvsize: c_uint,
			   is_qi: bool)
{
	key_jump_cmd: *mut u32, *zero_payload_jump_cmd, *zero_assoc_jump_cmd1;
 ...
 */
void cnstr_shdsc_rfc4106_encap(desc: *mut u32, cdata: *mut alginfo,
			       ivsize: c_uint, icvsize: c_uint,
			       is_qi: bool)
{
	key_jump_cmd: *mut u32, *zero_cryptlen_jump_cmd, *skip_instructions;
	init_sh_desc(desc, HDR_SHARE_SERIAL);
	...
	if is_qi {
		...
		/* Read salt and IV */
		append_fifo_load_as_imm(desc, (*mut c_void)(cdata.key_virt +
 ...
 * @is_qi: true when called from caam/qi
 */
void cnstr_shdsc_rfc4106_decap(desc: *mut u32, cdata: *mut alginfo,
			       ivsize: c_uint, icvsize: c_uint,
			       is_qi: bool)
{
	key_jump_cmd: *mut u32;
 ...
 * @is_qi: true when called from caam/qi
 */
void cnstr_shdsc_rfc4543_encap(desc: *mut u32, cdata: *mut alginfo,
			       ivsize: c_uint, icvsize: c_uint,
			       is_qi: bool)
{
	key_jump_cmd: *mut u32, *read_move_cmd, *write_move_cmd;
 ...
 * @is_qi: true when called from caam/qi
 */
void cnstr_shdsc_rfc4543_decap(desc: *mut u32, cdata: *mut alginfo,
			       ivsize: c_uint, icvsize: c_uint,
			       is_qi: bool)
{
	key_jump_cmd: *mut u32, *read_move_cmd, *write_move_cmd;
 ...
 * @is_qi: true when called from caam/qi
 */
void cnstr_shdsc_chachapoly(desc: *mut u32, cdata: *mut alginfo,
			    adata: *mut alginfo, ivsize: c_uint,
			    icvsize: c_uint, encap: bool,
			    is_qi: bool)
{
	key_jump_cmd: *mut u32, *wait_cmd;
	nfifo: u32;
	is_ipsec: bool = (ivsize != CHACHAPOLY_IV_SIZE);
...
#[inline]
unsafe fn void skcipher_append_src_dst(desc: *mut u32)
{
	append_math_add(desc, VARSEQOUTLEN, SEQINLEN, REG0, CAAM_CMD_SZ);
	append_math_add(desc, VARSEQINLEN, SEQINLEN, REG0, CAAM_CMD_SZ);
...
void cnstr_desc_skcipher_enc_dec(desc: *mut u32, cdata: *mut alginfo,
				 src: dma_addr_t, dst: dma_addr_t, data_sz: c_uint,
				 in_options: c_uint, out_options: c_uint,
				 ivsize: c_uint, encrypt: bool)
{
	options: u32 = cdata.algtype | OP_ALG_AS_INIT;
...
void cnstr_desc_protected_blob_decap(desc: *mut u32, cdata: *mut alginfo,
				     next_desc_addr: dma_addr_t)
{
	protected_store: u32;
	...
	/* Load key modifier */
	append_load_as_imm(desc, KEYMOD, core::mem::size_of::<KEYMOD>() - 1,
 ...
 * @ctx1_iv_off: IV offset in CONTEXT1 register
 */
void cnstr_shdsc_skcipher_encap(desc: *mut u32, cdata: *mut alginfo,
				ivsize: c_uint, is_rfc3686: bool,
				const ctx1_iv_off: u32)
{
	key_jump_cmd: *mut u32;
	options: u32 = cdata.algtype | OP_ALG_AS_INIT | OP_ALG_ENCRYPT;
	is_chacha20: bool = ((cdata.algtype & OP_ALG_ALGSEL_MASK) ==
			    OP_ALG_ALGSEL_CHACHA20);
	...
	if is_rfc3686 {
		nonce: *const u8 = cdata.key_virt + cdata.keylen;
 ...
 * @ctx1_iv_off: IV offset in CONTEXT1 register
 */
void cnstr_shdsc_skcipher_decap(desc: *mut u32, cdata: *mut alginfo,
				ivsize: c_uint, is_rfc3686: bool,
				const ctx1_iv_off: u32)
{
	key_jump_cmd: *mut u32;
 ...
 */
unsafe fn cnstr_shdsc_xts_skcipher_encap(desc: *mut u32, cdata: *mut alginfo)
{
	/*
	 ...
	 */
	sector_size: u64 = cpu_to_be64(BIT(15));
	key_jump_cmd: *mut u32;
	...
	append_load_as_imm(desc, (*mut c_void)&sector_size, 8, LDST_CLASS_1_CCB |
			   LDST_SRCDST_BYTE_CONTEXT |
 ...
 *         Valid algorithm values - OP_ALG_ALGSEL_AES ANDed with OP_ALG_AAI_XTS.
 */
unsafe fn cnstr_shdsc_xts_skcipher_decap(desc: *mut u32, cdata: *mut alginfo)
{
	/*
	 * Set sector size to a big value, practically disabling
	 * sector size segmentation in xts implementation. We cannot
