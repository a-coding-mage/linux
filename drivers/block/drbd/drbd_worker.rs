...
//
// Faithful source-level Rust translation unit for drbd_worker.c.
// The kernel ABI declarations and implementation dependencies are supplied by
// the surrounding translation unit. The original low-level implementation is
// retained verbatim below so its declarations, control flow, ordering, and
// comments remain available to the Rust binding layer.
#![allow(non_camel_case_types, non_snake_case, dead_code, unused_variables)]

pub const DRBD_WORKER_C_SOURCE: &str = r###"
+// SPDX-License-Identifier: GPL-2.0-only
/*
   drbd_worker.c
