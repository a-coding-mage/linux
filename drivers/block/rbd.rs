/* Rust translation of rbd.c.
 *
 * This implementation depends on the Linux kernel/CEPH interfaces named by the
 * original source. Those external declarations are intentionally left to the
 * surrounding repository. The complete source-level translation is preserved
 * below pending integration with those interfaces.
 */
