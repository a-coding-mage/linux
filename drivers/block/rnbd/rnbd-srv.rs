...
extern "C" {
    fn rnbd_srv_destroy_dev_sysfs(_: *mut rnbd_srv_dev); fn rnbd_srv_destroy_dev_session_sysfs(_: *mut rnbd_srv_sess_dev); fn rnbd_srv_create_dev_sysfs(_: *mut rnbd_srv_dev,_: *mut block_device)->i32; fn rnbd_srv_create_dev_session_sysfs(_: *mut rnbd_srv_sess_dev)->i32; fn rnbd_srv_create_sysfs_files()->i32; fn rnbd_srv_destroy_sysfs_files();
    fn rtrs_srv_open(_: *mut rtrs_srv_ops,_: u16)->*mut rtrs_srv_ctx; fn rtrs_srv_close(_: *mut rtrs_srv_ctx); fn rtrs_srv_resp_rdma(_: *mut rtrs_srv_op,_: i32); fn rtrs_srv_get_path_name(_: *mut rtrs_srv_sess,_: *mut c_char,_: usize)->i32; fn rtrs_srv_get_queue_depth(_: *mut rtrs_srv_sess)->u32; fn rtrs_srv_set_sess_priv(_: *mut rtrs_srv_sess,_: *mut rnbd_srv_session);
    fn rnbd_to_bio_flags(_: u32)->u32; fn blk_status_to_errno(_: u32)->i32; fn file_bdev(_: *mut file)->*mut block_device; fn bdev_file_open_by_path(_: *const c_char,_: u32,_: *mut c_void,_: *mut c_void)->*mut file; fn fput(_: *mut file); fn submit_bio(_: *mut bio); fn bio_alloc(_: *mut block_device,_: bool,_: u32)->*mut bio; fn bio_add_virt_nofail(_: *mut bio,_: *mut c_void,_: u32); fn bio_put(_: *mut bio); fn kfree(_: *mut c_void); fn kmalloc(_: usize,_: u32)->*mut c_void; fn kzalloc(_: usize,_: u32)->*mut c_void;
}
...
extern "C" { fn complete(_: *mut completion); fn kref_put(_: *mut kref,_: unsafe extern "C" fn(*mut kref)); fn kref_get_unless_zero(_: *mut kref)->bool; fn xa_load(_: *mut xarray,_: i32)->*mut rnbd_srv_sess_dev; fn rcu_read_lock(); fn rcu_read_unlock(); fn list_del(_: *mut list_head); fn list_add(_: *mut list_head,_: *mut list_head); fn mutex_init(_: *mut mutex); fn mutex_destroy(_: *mut mutex); fn mutex_lock(_: *mut mutex); fn mutex_unlock(_: *mut mutex); fn synchronize_rcu(); fn xa_cmpxchg(_: *mut xarray,_: u32,_: *mut rnbd_srv_sess_dev,_: *mut rnbd_srv_sess_dev,_: u32); fn xa_erase(_: *mut xarray,_: u32); fn wait_for_completion(_: *mut completion); fn xa_destroy(_: *mut xarray); fn xa_init_flags(_: *mut xarray,_: u32); fn rnbd_srv_destroy_dev_session_sysfs(_: *mut rnbd_srv_sess_dev); }
