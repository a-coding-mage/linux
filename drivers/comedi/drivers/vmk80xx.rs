...
extern "C" {
    ...
    fn usb_endpoint_maxp(_: *mut usb_endpoint_descriptor)->usize; fn usb_sndbulkpipe(_: *mut usb_device,_: u8)->u32; fn usb_rcvbulkpipe(_: *mut usb_device,_: u8)->u32; fn usb_sndintpipe(_: *mut usb_device,_: u8)->u32; fn usb_rcvintpipe(_: *mut usb_device,_: u8)->u32;
    fn usb_bulk_msg(_: *mut usb_device,_: u32,_: *mut u8,_: usize,_: *mut i32,_: u32)->i32; fn usb_interrupt_msg(_: *mut usb_device,_: u32,_: *mut u8,_: usize,_: *mut i32,_: u32)->i32;
    fn down(_: *mut semaphore); fn up(_: *mut semaphore); fn memset(_: *mut u8,_: i32,_: usize)->*mut u8; fn kfree(_: *mut u8);
    fn int_sqrt(_: u64)->u64; fn CR_CHAN(_:u32)->i32; fn comedi_dio_update_state(_: *mut comedi_subdevice,_: *mut u32)->bool;
}
...
extern "C" { fn vmk80xx_ai_insn_read(_: *mut comedi_device,_: *mut comedi_subdevice,_: *mut comedi_insn,_: *mut u32)->i32; fn vmk80xx_ao_insn_write(_: *mut comedi_device,_: *mut comedi_subdevice,_: *mut comedi_insn,_: *mut u32)->i32; fn vmk80xx_ao_insn_read(_: *mut comedi_device,_: *mut comedi_subdevice,_: *mut comedi_insn,_: *mut u32)->i32; fn vmk80xx_di_insn_bits(_: *mut comedi_device,_: *mut comedi_subdevice,_: *mut comedi_insn,_: *mut u32)->i32; fn vmk80xx_do_insn_bits(_: *mut comedi_device,_: *mut comedi_subdevice,_: *mut comedi_insn,_: *mut u32)->i32; fn vmk80xx_cnt_insn_read(_: *mut comedi_device,_: *mut comedi_subdevice,_: *mut comedi_insn,_: *mut u32)->i32; fn vmk80xx_cnt_insn_config(_: *mut comedi_device,_: *mut comedi_subdevice,_: *mut comedi_insn,_: *mut u32)->i32; fn vmk80xx_cnt_insn_write(_: *mut comedi_device,_: *mut comedi_subdevice,_: *mut comedi_insn,_: *mut u32)->i32; fn vmk80xx_pwm_insn_read(_: *mut comedi_device,_: *mut comedi_subdevice,_: *mut comedi_insn,_: *mut u32)->i32; fn vmk80xx_pwm_insn_write(_: *mut comedi_device,_: *mut comedi_subdevice,_: *mut comedi_insn,_: *mut u32)->i32; }
