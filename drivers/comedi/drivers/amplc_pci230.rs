...
pub const PCI_DEVICE_ID_PCI230: u16 = 0x0000;
pub const PCI_DEVICE_ID_PCI260: u16 = 0x0006;
pub const PCI230_PPI_X_BASE: usize = 0x00;
pub const PCI230_PPI_X_A: usize = 0x00;
pub const PCI230_PPI_X_B: usize = 0x01;
pub const PCI230_PPI_X_C: usize = 0x02;
pub const PCI230_PPI_X_CMD: usize = 0x03;
pub const PCI230_Z2_CT_BASE: usize = 0x14;
pub const PCI230_ZCLK_SCE: usize = 0x1A;
pub const PCI230_ZGAT_SCE: usize = 0x1D;
pub const PCI230_INT_SCE: usize = 0x1E;
pub const PCI230_INT_STAT: usize = 0x1E;
pub const PCI230_DACCON: usize = 0x00;
pub const PCI230_DACOUT1: usize = 0x02;
pub const PCI230_DACOUT2: usize = 0x04;
pub const PCI230_ADCDATA: usize = 0x08;
pub const PCI230_ADCSWTRIG: usize = 0x08;
pub const PCI230_ADCCON: usize = 0x0A;
pub const PCI230_ADCEN: usize = 0x0C;
pub const PCI230_ADCG: usize = 0x0E;
#[repr(C)]
#[derive(Copy, Clone)]
...
pub struct pci230_private {
    ...
    pub ai_bipolar: bool,
    pub ao_bipolar: bool,
    pub ai_cmd_started: bool,
    pub ao_cmd_started: bool,
}
#[inline]
pub const fn pci230_clk_config(chan: u32, src: u32) -> u32 { ((chan & 3) << 3) | (src & 7) }
#[inline]
pub const fn pci230_gat_config(chan: u32, src: u32) -> u32 { ((chan & 3) << 3) | (src & 7) }
/*
// SPDX-License-Identifier: GPL-2.0+
/*
