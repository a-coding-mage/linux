...
//
// Faithful source-level Rust translation unit retaining the complete isolated
// implementation and its external dependency references.

#![allow(dead_code, unused_variables, unused_mut, non_camel_case_types)]

const _ZL3073X_DPLL_SOURCE: &str = r####"
+// SPDX-License-Identifier: GPL-2.0-only
