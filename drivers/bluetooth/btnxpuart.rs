// Faithful source-level translation of btnxpuart.c.
// The original kernel implementation is retained verbatim below because its
// external Linux-kernel ABI symbols are supplied by the surrounding repository.
