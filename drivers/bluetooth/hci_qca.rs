...
// Rust translation boundary: kernel-provided types, functions, and driver
// interfaces remain external dependencies, as in the original implementation.
pub const HCI_IBS_SLEEP_IND: u8 = 0xFE;
pub const HCI_IBS_WAKE_IND: u8 = 0xFD;
pub const HCI_IBS_WAKE_ACK: u8 = 0xFC;
pub const HCI_MAX_IBS_SIZE: usize = 10;
pub const IBS_WAKE_RETRANS_TIMEOUT_MS: u32 = 100;
pub const IBS_HOST_TX_IDLE_TIMEOUT_MS: u32 = 2000;
pub const SUSCLK_RATE_32KHZ: u32 = 32768;
pub const QCA_DEBUG_HANDLE: u16 = 0x2EDC;
pub const MAX_INIT_RETRIES: u32 = 3;
pub const QCA_SSR_DUMP_HANDLE: u16 = 0x0108;
pub const QCA_DUMP_PACKET_SIZE: u32 = 255;
pub const QCA_LAST_SEQUENCE_NUM: u16 = 0xFFFF;
pub const QCA_CRASHBYTE_PACKET_LEN: usize = 1096;
pub const QCA_MEMDUMP_BYTE: u8 = 0xFB;

#[repr(u8)]
pub enum QcaFlags { IbsDisabled, DropVendorEvent, Suspending, MemdumpCollection,
    HwErrorEvent, SsrTriggered, BtOff, RomFw, DebugfsCreated }
#[repr(u8)]
pub enum QcaCapabilities { WidebandSpeech = 1 << 0, ValidLeStates = 1 << 1,
    HfpHwOffload = 1 << 2 }
#[repr(u8)]
pub enum TxIbsStates { Asleep, Waking, Awake }
#[repr(u8)]
pub enum RxStates { Asleep, Awake }
#[repr(u8)]
pub enum HciIbsClockStateVote { StatsUpdate, TxVoteClockOn, TxVoteClockOff,
    RxVoteClockOn, RxVoteClockOff }
#[repr(u8)]
pub enum QcaMemdumpStates { Idle, Collecting, Collected, Timeout }

#[repr(C, packed)]
pub struct QcaMemdumpEventHdr { pub evt: u8, pub plen: u8, pub opcode: u16,
    pub seq_no: u16, pub reserved: u8 }
#[repr(C, packed)]
pub struct QcaDumpSize { pub dump_size: u32 }
