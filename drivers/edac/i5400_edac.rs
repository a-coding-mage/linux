...
extern "C" { fn pci_read_config_dword(_: *mut pci_dev,_: u16,_: *mut u32); fn pci_read_config_word(_: *mut pci_dev,_: u16,_: *mut u16); fn pci_write_config_dword(_: *mut pci_dev,_: u16,_: u32); fn pci_dev_put(_: *mut pci_dev); fn edac_get_dimm(_: *mut mem_ctl_info,_: i32,_: i32,_: i32)->*mut dimm_info; fn edac_mc_handle_error(_: i32,_: *mut mem_ctl_info,_: usize,_: usize,_: usize,_: usize,_: i32,_: i32,_: i32,_: *const u8,_: *const u8); }
