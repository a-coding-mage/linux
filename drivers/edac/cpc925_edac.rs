...
extern "C" { fn __raw_readl(p:*mut c_void)->u32; fn __raw_writel(v:u32,p:*mut c_void); fn edac_mc_handle_error(a:c_int,m:*mut mem_ctl_info,n:u32,p:c_ulong,o:c_ulong,s:u16,r:c_int,ch:c_int,x:c_int,name:*const c_char,msg:*const c_char); fn edac_device_handle_ue(_: *mut edac_device_ctl_info,_: c_int,_: c_int,_: *const c_char); fn edac_device_handle_ce(_: *mut edac_device_ctl_info,_: c_int,_: c_int,_: *const c_char); static mut edac_op_state:c_int; fn platform_driver_register(_: *mut platform_driver)->c_int; fn platform_driver_unregister(_: *mut platform_driver); }
