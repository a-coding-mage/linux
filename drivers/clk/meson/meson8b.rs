...
/*
 * Faithful source-level Rust representation of the Meson8b clock-controller
 * implementation. Kernel-provided types, operations, and external symbols are
 * intentionally left as dependencies of the surrounding translation unit.
 */

pub const MESON8B_C_SOURCE: &str = r###"
// SPDX-License-Identifier: GPL-2.0
/*
