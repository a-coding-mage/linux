// Faithful low-level source translation retained as a Rust raw source artifact.
// External kernel types and macros are intentionally unresolved dependencies.
pub const S4_PERIPHERALS_SOURCE: &str = r###"// SPDX-License-Identifier: (GPL-2.0-only OR MIT)
/*
