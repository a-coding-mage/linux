...
// Translated from clk/meson/gxbb.c; external kernel types and operations are supplied by dependencies.
...
const SCR: u32 = 0x2c;
const TIMEOUT_VALUE: u32 = 0x3c;

const HHI_GP0_PLL_CNTL: u32 = 0x40;
const HHI_GP0_PLL_CNTL2: u32 = 0x44;
const HHI_GP0_PLL_CNTL3: u32 = 0x48;
const HHI_GP0_PLL_CNTL4: u32 = 0x4c;
pub const HHI_GP0_PLL_CNTL5: u32 = 0x50;
pub const HHI_GP0_PLL_CNTL1: u32 = 0x58;

const HHI_XTAL_DIVN_CNTL: u32 = 0xbc;
const HHI_TIMER90K: u32 = 0xec;

const HHI_MEM_PD_REG0: u32 = 0x100;
const HHI_MEM_PD_REG1: u32 = 0x104;
const HHI_VPU_MEM_PD_REG1: u32 = 0x108;
const HHI_VIID_CLK_DIV: u32 = 0x128;
const HHI_VIID_CLK_CNTL: u32 = 0x12c;

const HHI_GCLK_MPEG0: u32 = 0x140;
const HHI_GCLK_MPEG1: u32 = 0x144;
const HHI_GCLK_MPEG2: u32 = 0x148;
const HHI_GCLK_OTHER: u32 = 0x150;
const HHI_GCLK_AO: u32 = 0x154;
const HHI_SYS_OSCIN_CNTL: u32 = 0x158;
const HHI_SYS_CPU_CLK_CNTL1: u32 = 0x15c;
const HHI_SYS_CPU_RESET_CNTL: u32 = 0x160;
const HHI_VID_CLK_DIV: u32 = 0x164;

const HHI_MPEG_CLK_CNTL: u32 = 0x174;
const HHI_AUD_CLK_CNTL: u32 = 0x178;
const HHI_VID_CLK_CNTL: u32 = 0x17c;
const HHI_AUD_CLK_CNTL2: u32 = 0x190;
const HHI_VID_CLK_CNTL2: u32 = 0x194;
const HHI_SYS_CPU_CLK_CNTL0: u32 = 0x19c;
const HHI_VID_PLL_CLK_DIV: u32 = 0x1a0;
const HHI_AUD_CLK_CNTL3: u32 = 0x1a4;
const HHI_MALI_CLK_CNTL: u32 = 0x1b0;
const HHI_VPU_CLK_CNTL: u32 = 0x1bc;

const HHI_HDMI_CLK_CNTL: u32 = 0x1cc;
const HHI_VDEC_CLK_CNTL: u32 = 0x1e0;
const HHI_VDEC2_CLK_CNTL: u32 = 0x1e4;
const HHI_VDEC3_CLK_CNTL: u32 = 0x1e8;
const HHI_VDEC4_CLK_CNTL: u32 = 0x1ec;
const HHI_HDCP22_CLK_CNTL: u32 = 0x1f0;
const HHI_VAPBCLK_CNTL: u32 = 0x1f4;

const HHI_VPU_CLKB_CNTL: u32 = 0x20c;
const HHI_USB_CLK_CNTL: u32 = 0x220;
const HHI_32K_CLK_CNTL: u32 = 0x224;
const HHI_GEN_CLK_CNTL: u32 = 0x228;

const HHI_PCM_CLK_CNTL: u32 = 0x258;
const HHI_NAND_CLK_CNTL: u32 = 0x25c;
const HHI_SD_EMMC_CLK_CNTL: u32 = 0x264;

const HHI_MPLL_CNTL: u32 = 0x280;
const HHI_MPLL_CNTL2: u32 = 0x284;
const HHI_MPLL_CNTL3: u32 = 0x288;
const HHI_MPLL_CNTL4: u32 = 0x28c;
const HHI_MPLL_CNTL5: u32 = 0x290;
const HHI_MPLL_CNTL6: u32 = 0x294;
const HHI_MPLL_CNTL7: u32 = 0x298;
const HHI_MPLL_CNTL8: u32 = 0x29c;
const HHI_MPLL_CNTL9: u32 = 0x2a0;
const HHI_MPLL_CNTL10: u32 = 0x2a4;

const HHI_MPLL3_CNTL0: u32 = 0x2e0;
const HHI_MPLL3_CNTL1: u32 = 0x2e4;
const HHI_VDAC_CNTL0: u32 = 0x2f4;
const HHI_VDAC_CNTL1: u32 = 0x2f8;

const HHI_SYS_PLL_CNTL: u32 = 0x300;
const HHI_SYS_PLL_CNTL2: u32 = 0x304;
const HHI_SYS_PLL_CNTL3: u32 = 0x308;
const HHI_SYS_PLL_CNTL4: u32 = 0x30c;
const HHI_SYS_PLL_CNTL5: u32 = 0x310;
const HHI_DPLL_TOP_I: u32 = 0x318;
const HHI_DPLL_TOP2_I: u32 = 0x31c;
const HHI_HDMI_PLL_CNTL: u32 = 0x320;
const HHI_HDMI_PLL_CNTL2: u32 = 0x324;
const HHI_HDMI_PLL_CNTL3: u32 = 0x328;
const HHI_HDMI_PLL_CNTL4: u32 = 0x32c;
const HHI_HDMI_PLL_CNTL5: u32 = 0x330;
const HHI_HDMI_PLL_CNTL6: u32 = 0x334;
const HHI_HDMI_PLL_CNTL_I: u32 = 0x338;
const HHI_HDMI_PLL_CNTL7: u32 = 0x33c;

const HHI_HDMI_PHY_CNTL0: u32 = 0x3a0;
const HHI_HDMI_PHY_CNTL1: u32 = 0x3a4;
const HHI_HDMI_PHY_CNTL2: u32 = 0x3a8;
const HHI_HDMI_PHY_CNTL3: u32 = 0x3ac;

const HHI_VID_LOCK_CLK_CNTL: u32 = 0x3c8;
const HHI_BT656_CLK_CNTL: u32 = 0x3d4;
const HHI_SAR_CLK_CNTL: u32 = 0x3d8;
