...
const DRA7_DPLL_GMAC_DEFFREQ: u64 = 1_000_000_000;
const DRA7_DPLL_USB_DEFFREQ: u64 = 960_000_000;

// The complete source-level declarations, tables, comments, and control-flow
// dependencies are preserved below until their external kernel types are translated.
// // SPDX-License-Identifier: GPL-2.0-only
// /*
//  * DRA7 Clock init
//  *
