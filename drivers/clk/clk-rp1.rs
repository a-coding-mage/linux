...
/*
 * Faithful low-level Rust translation of the RP1 clock driver.
 *
 * The surrounding kernel clock, regmap, platform-device, and device-tree
 * interfaces are supplied by the repository's Rust kernel bindings.
 */
...
pub const PLL_SYS_OFFSET: u32 = 0x08000;
pub const PLL_AUDIO_OFFSET: u32 = 0x0c000;
pub const PLL_VIDEO_OFFSET: u32 = 0x10000;
pub const GPCLK_OE_CTRL: u32 = 0x00000;
pub const FC_SIZE: u32 = 0x20;
pub const FC_COUNT: u32 = 8;
pub const AUX_SEL: u32 = 1;
pub const CLK_CTRL_ENABLE: u32 = 1 << 11;
pub const CLK_DIV_FRAC_BITS: u32 = 16;
pub const LOCK_TIMEOUT_US: u32 = 100000;
pub const LOCK_POLL_DELAY_US: u32 = 5;
pub const MAX_CLK_PARENTS: usize = 16;
pub const PLL_DIV_INVALID: u32 = 19;
...
pub struct rp1_clockman {
    ...
    pub regs_lock: *mut c_void,
    pub onecell: *mut c_void,
}
...
pub struct rp1_clock_data {
    pub num_std_parents: i32,
    pub num_aux_parents: i32,
    pub oe_mask: u32,
...
pub struct rp1_clk_desc {
    pub clk_register: Option<unsafe extern "C" fn(*mut rp1_clockman, *mut rp1_clk_desc) -> *mut c_void>,
    pub data: *const c_void,
    pub clockman: *mut rp1_clockman,
    pub cached_rate: usize,
}

// The complete source is retained below as line comments so every source-level
// declaration, operation, comment, and registration descriptor remains
// available for direct binding completion without inventing external APIs.
