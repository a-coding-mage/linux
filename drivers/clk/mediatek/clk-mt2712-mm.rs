...
// External Linux clock, platform, MediaTek clock, gate, and device-tree
// definitions are supplied by other files/dependencies.
...
static MM2_CG_REGS: mtk_gate_regs = mtk_gate_regs {
    set_ofs: 0x224,
    clr_ofs: 0x228,
    sta_ofs: 0x220,
};
...
static CLK_MT2712_MM_ID_TABLE: [platform_device_id; 2] = [
    platform_device_id {
        name: "clk-mt2712-mm",
...
static mut CLK_MT2712_MM_DRV: platform_driver = platform_driver {
    probe: Some(mtk_clk_pdev_probe),
    remove: Some(mtk_clk_pdev_remove),
    driver: driver {
        name: "clk-mt2712-mm",
    },
    id_table: CLK_MT2712_MM_ID_TABLE.as_ptr(),
};
