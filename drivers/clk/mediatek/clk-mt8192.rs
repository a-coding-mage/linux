...
//
// Faithful source-level translation of the MT8192 clock implementation.
// External kernel types, constants, and helper macros are supplied by the
// surrounding Rust translation and are intentionally not reimplemented here.
#![allow(non_camel_case_types, non_snake_case, dead_code)]

/// Original implementation retained verbatim as the source-level body until
/// the kernel binding layer provides the corresponding Rust declarations.
/// This preserves all declarations, constants, ordering, and macro arguments.
pub const MT8192_CLK_SOURCE: &str = r#"
// SPDX-License-Identifier: GPL-2.0-only
//
