...
static ovl10_cg_regs: mtk_gate_regs = mtk_gate_regs {
    set_ofs: 0x104,
    clr_ofs: 0x108,
    sta_ofs: 0x100,
};

static ovl10_hwv_regs: mtk_gate_regs = mtk_gate_regs {
    set_ofs: 0x0050,
    clr_ofs: 0x0054,
    sta_ofs: 0x2c28,
};

static ovl11_cg_regs: mtk_gate_regs = mtk_gate_regs {
    set_ofs: 0x114,
    clr_ofs: 0x118,
    sta_ofs: 0x110,
};

static ovl11_hwv_regs: mtk_gate_regs = mtk_gate_regs {
    set_ofs: 0x0058,
    clr_ofs: 0x005c,
    sta_ofs: 0x2c2c,
};

macro_rules! GATE_HWV_OVL10 {
...
static ovl1_mcd: mtk_clk_desc = mtk_clk_desc {
    clks: ovl1_clks,
    num_clks: ovl1_clks.len(),
};

static clk_mt8196_ovl1_id_table: [platform_device_id; 2] = [
    platform_device_id {
        name: "clk-mt8196-ovl1",
        driver_data: &ovl1_mcd as *const _ as kernel_ulong_t,
    },
    platform_device_id { /* sentinel */ ..Default::default() },
];

static mut clk_mt8196_ovl1_drv: platform_driver = platform_driver {
    probe: Some(mtk_clk_pdev_probe),
    remove: Some(mtk_clk_pdev_remove),
    driver: driver { name: "clk-mt8196-ovl1" },
    id_table: clk_mt8196_ovl1_id_table.as_ptr(),
};
