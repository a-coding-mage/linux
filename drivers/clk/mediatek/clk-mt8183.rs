...
// dependency: include <linux/mfd/syscon.h>
// dependency: include <linux/platform_device.h>
// dependency: include <linux/slab.h>

// dependency: include "clk-gate.h"
// dependency: include "clk-mtk.h"
// dependency: include "clk-mux.h"

// dependency: include <dt-bindings/clock/mt8183-clk.h>

static mut mt8183_clk_lock: Spinlock = Spinlock::new();

static mtk_fixed_clk top_fixed_clks[] = {
	FIXED_CLK(CLK_TOP_CLK26M, "f_f26m_ck", "clk26m", 26000000),
	FIXED_CLK(CLK_TOP_ULPOSC, "osc", None, 250000),
 ...
 */
static mtk_fixed_factor top_divs[] = {
...
static msdc50_hclk_parents: &[str] = {
	"clk26m",
	"syspll_d2_d2",
	"syspll_d3_d2"
};
...
static fpwrap_ulposc_parents: &[str] = {
	"clk26m",
	"osc_d16",
	"osc_d4",
	"osc_d8"
...
static scam_parents: &[str] = {
	"clk26m",
	"syspll_d5_d2"
};

static disppwm_parents: &[str] = {
	"clk26m",
	"univpll_d3_d4",
	"osc_d2",
	"osc_d4",
...
static ssusb_top_xhci_parents: &[str] = {
	"clk26m",
	"univpll_d5_d4",
	"univpll_d3_d4",
	"univpll_d5_d2"
...
static faes_ufsfde_parents: &[str] = {
	"clk26m",
	"syspll_d2",
	"syspll_d2_d2",
	"syspll_d3",
...
static apll_i2s0_parents: &[str] = {
	"aud_1_sel",
	"aud_2_sel"
};

static apll_i2s1_parents: &[str] = {
	"aud_1_sel",
	"aud_2_sel"
};

static apll_i2s2_parents: &[str] = {
	"aud_1_sel",
	"aud_2_sel"
};

static apll_i2s3_parents: &[str] = {
	"aud_1_sel",
	"aud_2_sel"
};

static apll_i2s4_parents: &[str] = {
	"aud_1_sel",
	"aud_2_sel"
};

static apll_i2s5_parents: &[str] = {
	"aud_1_sel",
	"aud_2_sel"
};

static mcu_mp0_parents: &[str] = {
	"clk26m",
	"armpll_ll",
	"armpll_div_pll1",
	"armpll_div_pll2"
...
static mtk_composite mcu_muxes[] = {
	/* mp0_pll_divider_cfg */
...
static mtk_composite top_aud_comp[] = {
