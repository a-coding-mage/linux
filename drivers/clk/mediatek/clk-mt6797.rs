...
// dependency: "clk-gate.h"
// dependency: "clk-mtk.h"
// dependency: "clk-pll.h"

// dependency: <dt-bindings/clock/mt6797-clk.h>
...
static const mtk_fixed_factor top_fixed_divs[] = {
 ...
 */
static const mtk_composite top_muxes[] = {
...
static int mtk_topckgen_init(PlatformDevice *pdev)
{
 ...
 */
static const mtk_gate infra_clks[] = {
...
static const mtk_fixed_factor infra_fixed_divs[] = {
	factor!(CLK_INFRA_13M, "clk13m", "clk26m", 1, 2),
];

static clk_hw_onecell_data *infra_clk_data;

static void mtk_infrasys_init_early(DeviceNode *node)
{
	int r, i;
...
static const mtk_pll_data plls[] = {
...
static int clk_mt6797_probe(PlatformDevice *pdev)
{
