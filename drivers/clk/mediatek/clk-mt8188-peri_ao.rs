...
// External clock-framework and device-tree definitions are supplied by the
...
static peri_ao_clks: [mtk_gate; 13] = [
...
static of_match_clk_mt8188_peri_ao: [of_device_id; 2] = [
    of_device_id {
...
static mut clk_mt8188_peri_ao_drv: platform_driver = platform_driver {
