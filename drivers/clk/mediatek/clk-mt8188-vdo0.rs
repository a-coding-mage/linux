...
// device-tree bindings, clk-gate, and clk-mtk interfaces.
...
macro_rules! gate_vdo0_0 {
    ($id:expr, $name:expr, $parent:expr, $shift:expr) => {
        GATE_MTK!($id, $name, $parent, &VDO0_0_CG_REGS, $shift,
...
macro_rules! gate_vdo0_1 {
    ($id:expr, $name:expr, $parent:expr, $shift:expr) => {
        GATE_MTK!($id, $name, $parent, &VDO0_1_CG_REGS, $shift,
                  &mtk_clk_gate_ops_setclr)
    };
}
...
macro_rules! gate_vdo0_2 {
    ($id:expr, $name:expr, $parent:expr, $shift:expr) => {
        GATE_MTK!($id, $name, $parent, &VDO0_2_CG_REGS, $shift,
                  &mtk_clk_gate_ops_setclr)
    };
}
...
static VDO0_DESC: mtk_clk_desc = mtk_clk_desc {
    clks: &VDO0_CLKS,
    num_clks: VDO0_CLKS.len(),
};

static CLK_MT8188_VDO0_ID_TABLE: [platform_device_id; 2] = [
    platform_device_id {
...
static mut CLK_MT8188_VDO0_DRV: platform_driver = platform_driver {
