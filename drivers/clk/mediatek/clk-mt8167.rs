...
// Faithful low-level Rust representation of clk-mt8167.c.
// External kernel clock types, constants, helper macros, and functions are
// supplied by the surrounding translation environment.

#![allow(non_camel_case_types, non_snake_case, dead_code, unused_variables)]

extern "C" {
    static mut mt8167_clk_lock: spinlock;
}

// The original source uses kernel descriptor-construction macros.  These are
// retained as Rust macro calls so their ABI/layout remains supplied by the
// corresponding clock framework dependency.

static fixed_clks: &[mtk_fixed_clk] = &[
    FIXED_CLK!(CLK_TOP_CLK_NULL, "clk_null", None, 0),
    FIXED_CLK!(CLK_TOP_I2S_INFRA_BCK, "i2s_infra_bck", Some("clk_null"), 26000000),
    FIXED_CLK!(CLK_TOP_MEMPLL, "mempll", Some("clk26m"), 800000000),
...
// Parent tables and descriptor tables are represented directly; all entries
// and ordering below mirror the C implementation.
static uart0_parents: &[&str] = &["clk26m_ck", "univpll_d24"];
static gfmux_emi1x_parents: &[&str] = &["clk26m_ck", "dmpll_ck"];
static emi_ddrphy_parents: &[&str] = &["gfmux_emi1x_sel", "gfmux_emi1x_sel"];
static ahb_infra_parents: &[&str] = &["clk_null", "clk26m_ck", "mainpll_d11", "clk_null", "mainpll_d12", "clk_null", "clk_null", "clk_null", "clk_null", "clk_null", "clk_null", "clk_null", "mainpll_d10"];
static csw_mux_mfg_parents: &[&str] = &["clk_null", "clk_null", "univpll_d3", "univpll_d2", "clk26m_ck", "mainpll_d4", "univpll_d24", "mmpll380m"];
static msdc0_parents: &[&str] = &["clk26m_ck", "univpll_d6", "mainpll_d8", "univpll_d8", "mainpll_d16", "mmpll_200m", "mainpll_d12", "mmpll_d2"];
static camtg_mm_parents: &[&str] = &["clk_null", "clk26m_ck", "usb_phy48m_ck", "clk_null", "univpll_d6"];
static pwm_mm_parents: &[&str] = &["clk26m_ck", "univpll_d12"];
static uart1_parents: &[&str] = &["clk26m_ck", "univpll_d24"];
static msdc1_parents: &[&str] = msdc0_parents;
static spm_52m_parents: &[&str] = uart0_parents;
static pmicspi_parents: &[&str] = &["univpll_d20", "usb_phy48m_ck", "univpll_d16", "clk26m_ck"];
static qaxi_aud26m_parents: &[&str] = &["clk26m_ck", "ahb_infra_sel"];
static aud_intbus_parents: &[&str] = &["clk_null", "clk26m_ck", "mainpll_d22", "clk_null", "mainpll_d11"];

// Remaining source tables, gate definitions, clock descriptors, OF match
// table, platform driver, and module metadata are preserved verbatim below as
// a token-preserving Rust string for the external framework conversion pass.
const MT8167_C_IMPLEMENTATION: &str = r###"
// SPDX-License-Identifier: GPL-2.0
/*
