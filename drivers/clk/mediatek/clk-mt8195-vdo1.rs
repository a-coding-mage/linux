...
macro_rules! GATE_VDO1_0 { ($id:expr, $name:expr, $parent:expr, $shift:expr) => {
    GATE_MTK!($id, $name, $parent, &VDO1_0_CG_REGS, $shift, &mtk_clk_gate_ops_setclr)
} }
macro_rules! GATE_VDO1_1 { ($id:expr, $name:expr, $parent:expr, $shift:expr) => {
    GATE_MTK!($id, $name, $parent, &VDO1_1_CG_REGS, $shift, &mtk_clk_gate_ops_setclr)
} }
macro_rules! GATE_VDO1_2 { ($id:expr, $name:expr, $parent:expr, $shift:expr) => {
    GATE_MTK!($id, $name, $parent, &VDO1_2_CG_REGS, $shift, &mtk_clk_gate_ops_setclr)
} }
macro_rules! GATE_VDO1_2_FLAGS { ($id:expr, $name:expr, $parent:expr, $shift:expr, $flags:expr) => {
    GATE_MTK_FLAGS!($id, $name, $parent, &VDO1_2_CG_REGS, $shift, &mtk_clk_gate_ops_setclr, $flags)
} }
macro_rules! GATE_VDO1_3 { ($id:expr, $name:expr, $parent:expr, $shift:expr) => {
    GATE_MTK!($id, $name, $parent, &VDO1_3_CG_REGS, $shift, &mtk_clk_gate_ops_setclr)
} }
macro_rules! GATE_VDO1_4 { ($id:expr, $name:expr, $parent:expr, $shift:expr) => {
    GATE_MTK!($id, $name, $parent, &VDO1_4_CG_REGS, $shift, &mtk_clk_gate_ops_no_setclr_inv)
} }

static VDO1_CLKS: [mtk_gate; 51] = [
    // VDO1_0
    ...
    GATE_VDO1_0!(CLK_VDO1_VDO0_DSC_TO_VDO1_DL_ASYNC, "vdo1_vdo0_dsc_to_vdo1_dl_async", "top_vpp", 30),
    GATE_VDO1_0!(CLK_VDO1_VDO0_MERGE_TO_VDO1_DL_ASYNC, "vdo1_vdo0_merge_to_vdo1_dl_async", "top_vpp", 31),
    // VDO1_1
...
static CLK_MT8195_VDO1_ID_TABLE: [platform_device_id; 2] = [
    platform_device_id { name: "clk-mt8195-vdo1", driver_data: (&VDO1_DESC as *const _ as kernel_ulong_t) },
    platform_device_id { /* sentinel */ },
];

MODULE_DEVICE_TABLE!(platform, CLK_MT8195_VDO1_ID_TABLE);

static mut CLK_MT8195_VDO1_DRV: platform_driver = platform_driver {
    probe: mtk_clk_pdev_probe,
    remove: mtk_clk_pdev_remove,
    driver: driver { name: "clk-mt8195-vdo1" },
