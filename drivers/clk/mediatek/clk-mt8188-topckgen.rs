...
static mut mt8188_clk_lock: u8 = 0;

static top_fixed_clks: &[mtk_fixed_clk] = &[
	fixed_clk!(CLK_TOP_ULPOSC1, "ulposc_ck1", std::ptr::null_mut(), 260000000),
	fixed_clk!(CLK_TOP_MPHONE_SLAVE_BCK, "mphone_slave_bck", std::ptr::null_mut(), 49152000),
	fixed_clk!(CLK_TOP_PAD_FPC, "pad_fpc_ck", std::ptr::null_mut(), 50000000),
	fixed_clk!(CLK_TOP_466M_FMEM, "hd_466m_fmem_ck", std::ptr::null_mut(), 533000000),
	fixed_clk!(CLK_TOP_PEXTP_PIPE, "pextp_pipe", std::ptr::null_mut(), 250000000),
	fixed_clk!(CLK_TOP_DSI_PHY, "dsi_phy", std::ptr::null_mut(), 500000000),
];
...
//
static mfg_core_tmp_parents: &[&str] = &[
	"clk26m",
	"mainpll_d5_d2"
];

static camtg_parents: &[&str] = &[
	"clk26m",
	"univpll_192m_d8",
	"univpll_d6_d8",
	"univpll_192m_d4",
...
static pwrap_ulposc_parents: &[&str] = &[
	"clk26m",
	"ulposc1_d10",
	"ulposc1_d7",
	"ulposc1_d8",
...
static dp_parents_idx: &[u8] = &[ 0, 2, 4, 6, 8 ];

static edp_parents: &[&str] = &[
	"clk26m",
	"tvdpll1_d2",
	"tvdpll1_d4",
	"tvdpll1_d8",
...
static edp_parents_idx: &[u8] = &[ 0, 1, 3, 5, 7 ];

static dpi_parents: &[&str] = &[
	"clk26m",
	"tvdpll1_d2",
	"tvdpll2_d2",
	"tvdpll1_d4",
...
static ssusb_xhci_2p_parents: &[&str] = &[
	"clk26m",
	"univpll_d5_d4",
	"univpll_d6_d4",
	"univpll_d5_d2"
...
static ssusb_xhci_3p_parents: &[&str] = &[
	"clk26m",
	"univpll_d5_d4",
	"univpll_d6_d4",
	"univpll_d5_d2"
...
static i2c_parents: &[&str] = &[
	"clk26m",
	"mainpll_d4_d8",
	"univpll_d5_d4"
];

static seninf_parents: &[&str] = &[
	"clk26m",
	"univpll_d4_d4",
	"univpll_d6_d2",
	"mainpll_d4_d2",
...
static mcupm_parents: &[&str] = &[
	"clk26m",
	"mainpll_d6_d2",
	"mainpll_d7_d4"
];

static spmi_p_mst_parents: &[&str] = &[
	"clk26m",
	"clk13m",
	"ulposc1_d8",
	"ulposc1_d10",
...
static tl_parents: &[&str] = &[
	"clk26m",
	"univpll_d5_d4",
	"mainpll_d4_d4"
];

static aes_msdcfde_parents: &[&str] = &[
	"clk26m",
	"mainpll_d4_d2",
	"mainpll_d6",
	"mainpll_d4_d4",
...
static hdmi_apb_parents: &[&str] = &[
	"clk26m",
	"univpll_d6_d4",
	"msdcpll_d2"
];

static snps_eth_250m_parents: &[&str] = &[
	"clk26m",
	"ethpll_d2"
];

static snps_eth_62p4m_ptp_parents: &[&str] = &[
	"apll2_d3",
	"apll1_d3",
	"clk26m",
	"ethpll_d8"
...
static snps_eth_50m_rmii_parents: &[&str] = &[
	"clk26m",
	"ethpll_d10"
];

static adsp_parents: &[&str] = &[
	"clk26m",
	"clk13m",
	"mainpll_d6",
	"mainpll_d5_d2",
...
static audio_local_bus_parents: &[&str] = &[
	"clk26m",
	"clk13m",
	"mainpll_d4_d4",
	"mainpll_d7_d2",
...
static apll1_parents: &[&str] = &[
	"clk26m",
	"apll1_d4"
];

static apll2_parents: &[&str] = &[
	"clk26m",
	"apll2_d4"
];

static apll3_parents: &[&str] = &[
	"clk26m",
	"apll3_d4"
];

static apll4_parents: &[&str] = &[
	"clk26m",
	"apll4_d4"
];

static apll5_parents: &[&str] = &[
	"clk26m",
	"apll5_d4"
];

static i2so1_parents: &[&str] = &[
	"clk26m",
	"apll1",
	"apll2",
	"apll3",
...
static a1sys_hp_parents: &[&str] = &[
	"clk26m",
	"apll1_d4"
];

static a2sys_parents: &[&str] = &[
	"clk26m",
	"apll2_d4"
];

static a3sys_parents: &[&str] = &[
	"clk26m",
	"apll3_d4",
	"apll4_d4",
	"apll5_d4"
...
static srck_parents: &[&str] = &[
	"ulposc1_d10",
	"clk26m"
];

static mfg_fast_ref_parents: &[&str] = &[
	"top_mfg_core_tmp",
	"mfgpll"
];
...
static top_adj_divs: &[mtk_composite] = &[
...
static of_match_clk_mt8188_topck: &[of_device_id] = &[
...
static let mut clk_mt8188_reg_mfg_mux_notifier: i32(*mut dev: device, *mut clk: clk)
{
	*mut mfg_mux_nb: mtk_mux_nb;
...
static platform_driver clk_mt8188_topck_drv = {
