...
// Dependencies supplied by the kernel clock and platform-device headers:
...
static clk_mt8365_mm_id_table: [platform_device_id; 2] = [
	platform_device_id {
		name: "clk-mt8365-mm",
...
static mut clk_mt8365_mm_drv: platform_driver = platform_driver {
	...
	id_table: clk_mt8365_mm_id_table.as_ptr(),
};
