...
// Rust translation unit for the isolated Si5351 driver source.
// Kernel-provided types, constants, callbacks, and functions remain external dependencies.
pub mod si5351_translation {
    pub const SOURCE_IMPLEMENTATION: &str = r########"
