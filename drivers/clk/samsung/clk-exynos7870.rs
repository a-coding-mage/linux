 ...
 */
const PLL_LOCKTIME_MIF_MEM_PLL: u32 = 0x0000;const PLL_LOCKTIME_MIF_MEDIA_PLL: u32 = 0x0020;const PLL_LOCKTIME_MIF_BUS_PLL: u32 = 0x0040;const PLL_CON0_MIF_MEM_PLL: u32 = 0x0100;const PLL_CON0_MIF_MEDIA_PLL: u32 = 0x0120;const PLL_CON0_MIF_BUS_PLL: u32 = 0x0140;const CLK_CON_GAT_MIF_MUX_MEM_PLL: u32 = 0x0200;const CLK_CON_GAT_MIF_MUX_MEM_PLL_CON: u32 = 0x0200;const CLK_CON_GAT_MIF_MUX_MEDIA_PLL: u32 = 0x0204;const CLK_CON_GAT_MIF_MUX_MEDIA_PLL_CON: u32 = 0x0204;const CLK_CON_GAT_MIF_MUX_BUS_PLL: u32 = 0x0208;const CLK_CON_GAT_MIF_MUX_BUS_PLL_CON: u32 = 0x0208;const CLK_CON_GAT_MIF_MUX_BUSD: u32 = 0x0220;const CLK_CON_MUX_MIF_BUSD: u32 = 0x0220;const CLK_CON_GAT_MIF_MUX_CMU_ISP_VRA: u32 = 0x0264;const CLK_CON_MUX_MIF_CMU_ISP_VRA: u32 = 0x0264;const CLK_CON_GAT_MIF_MUX_CMU_ISP_CAM: u32 = 0x0268;const CLK_CON_MUX_MIF_CMU_ISP_CAM: u32 = 0x0268;const CLK_CON_GAT_MIF_MUX_CMU_ISP_ISP: u32 = 0x026c;const CLK_CON_MUX_MIF_CMU_ISP_ISP: u32 = 0x026c;const CLK_CON_GAT_MIF_MUX_CMU_DISPAUD_BUS: u32 = 0x0270;const CLK_CON_MUX_MIF_CMU_DISPAUD_BUS: u32 = 0x0270;const CLK_CON_GAT_MIF_MUX_CMU_DISPAUD_DECON_VCLK: u32 = 0x0274;const CLK_CON_MUX_MIF_CMU_DISPAUD_DECON_VCLK: u32 = 0x0274;const CLK_CON_GAT_MIF_MUX_CMU_DISPAUD_DECON_ECLK: u32 = 0x0278;const CLK_CON_MUX_MIF_CMU_DISPAUD_DECON_ECLK: u32 = 0x0278;const CLK_CON_GAT_MIF_MUX_CMU_MFCMSCL_MSCL: u32 = 0x027c;const CLK_CON_MUX_MIF_CMU_MFCMSCL_MSCL: u32 = 0x027c;const CLK_CON_GAT_MIF_MUX_CMU_MFCMSCL_MFC: u32 = 0x0280;const CLK_CON_MUX_MIF_CMU_MFCMSCL_MFC: u32 = 0x0280;const CLK_CON_GAT_MIF_MUX_CMU_FSYS_BUS: u32 = 0x0284;const CLK_CON_MUX_MIF_CMU_FSYS_BUS: u32 = 0x0284;const CLK_CON_GAT_MIF_MUX_CMU_FSYS_MMC0: u32 = 0x0288;const CLK_CON_MUX_MIF_CMU_FSYS_MMC0: u32 = 0x0288;const CLK_CON_GAT_MIF_MUX_CMU_FSYS_MMC1: u32 = 0x028c;const CLK_CON_MUX_MIF_CMU_FSYS_MMC1: u32 = 0x028c;const CLK_CON_GAT_MIF_MUX_CMU_FSYS_MMC2: u32 = 0x0290;const CLK_CON_MUX_MIF_CMU_FSYS_MMC2: u32 = 0x0290;const CLK_CON_GAT_MIF_MUX_CMU_FSYS_USB20DRD_REFCLK: u32 = 0x029c;const CLK_CON_MUX_MIF_CMU_FSYS_USB20DRD_REFCLK: u32 = 0x029c;const CLK_CON_GAT_MIF_MUX_CMU_PERI_BUS: u32 = 0x02a0;const CLK_CON_MUX_MIF_CMU_PERI_BUS: u32 = 0x02a0;const CLK_CON_GAT_MIF_MUX_CMU_PERI_UART1: u32 = 0x02a4;const CLK_CON_MUX_MIF_CMU_PERI_UART1: u32 = 0x02a4;const CLK_CON_GAT_MIF_MUX_CMU_PERI_UART2: u32 = 0x02a8;const CLK_CON_MUX_MIF_CMU_PERI_UART2: u32 = 0x02a8;const CLK_CON_GAT_MIF_MUX_CMU_PERI_UART0: u32 = 0x02ac;const CLK_CON_MUX_MIF_CMU_PERI_UART0: u32 = 0x02ac;const CLK_CON_GAT_MIF_MUX_CMU_PERI_SPI2: u32 = 0x02b0;const CLK_CON_MUX_MIF_CMU_PERI_SPI2: u32 = 0x02b0;const CLK_CON_GAT_MIF_MUX_CMU_PERI_SPI1: u32 = 0x02b4;const CLK_CON_MUX_MIF_CMU_PERI_SPI1: u32 = 0x02b4;const CLK_CON_GAT_MIF_MUX_CMU_PERI_SPI0: u32 = 0x02b8;const CLK_CON_MUX_MIF_CMU_PERI_SPI0: u32 = 0x02b8;const CLK_CON_GAT_MIF_MUX_CMU_PERI_SPI3: u32 = 0x02bc;const CLK_CON_MUX_MIF_CMU_PERI_SPI3: u32 = 0x02bc;const CLK_CON_GAT_MIF_MUX_CMU_PERI_SPI4: u32 = 0x02c0;const CLK_CON_MUX_MIF_CMU_PERI_SPI4: u32 = 0x02c0;const CLK_CON_GAT_MIF_MUX_CMU_ISP_SENSOR0: u32 = 0x02c4;const CLK_CON_MUX_MIF_CMU_ISP_SENSOR0: u32 = 0x02c4;const CLK_CON_GAT_MIF_MUX_CMU_ISP_SENSOR1: u32 = 0x02c8;const CLK_CON_MUX_MIF_CMU_ISP_SENSOR1: u32 = 0x02c8;const CLK_CON_GAT_MIF_MUX_CMU_ISP_SENSOR2: u32 = 0x02cc;const CLK_CON_MUX_MIF_CMU_ISP_SENSOR2: u32 = 0x02cc;const CLK_CON_DIV_MIF_BUSD: u32 = 0x0420;const CLK_CON_DIV_MIF_APB: u32 = 0x0424;const CLK_CON_DIV_MIF_HSI2C: u32 = 0x0430;const CLK_CON_DIV_MIF_CMU_G3D_SWITCH: u32 = 0x0460;const CLK_CON_DIV_MIF_CMU_ISP_VRA: u32 = 0x0464;const CLK_CON_DIV_MIF_CMU_ISP_CAM: u32 = 0x0468;const CLK_CON_DIV_MIF_CMU_ISP_ISP: u32 = 0x046c;const CLK_CON_DIV_MIF_CMU_DISPAUD_BUS: u32 = 0x0470;const CLK_CON_DIV_MIF_CMU_DISPAUD_DECON_VCLK: u32 = 0x0474;const CLK_CON_DIV_MIF_CMU_DISPAUD_DECON_ECLK: u32 = 0x0478;const CLK_CON_DIV_MIF_CMU_MFCMSCL_MSCL: u32 = 0x047c;const CLK_CON_DIV_MIF_CMU_MFCMSCL_MFC: u32 = 0x0480;const CLK_CON_DIV_MIF_CMU_FSYS_BUS: u32 = 0x0484;const CLK_CON_DIV_MIF_CMU_FSYS_MMC0: u32 = 0x0488;const CLK_CON_DIV_MIF_CMU_FSYS_MMC1: u32 = 0x048c;const CLK_CON_DIV_MIF_CMU_FSYS_MMC2: u32 = 0x0490;const CLK_CON_DIV_MIF_CMU_FSYS_USB20DRD_REFCLK: u32 = 0x049c;const CLK_CON_DIV_MIF_CMU_PERI_BUS: u32 = 0x04a0;const CLK_CON_DIV_MIF_CMU_PERI_UART1: u32 = 0x04a4;const CLK_CON_DIV_MIF_CMU_PERI_UART2: u32 = 0x04a8;const CLK_CON_DIV_MIF_CMU_PERI_UART0: u32 = 0x04ac;const CLK_CON_DIV_MIF_CMU_PERI_SPI2: u32 = 0x04b0;const CLK_CON_DIV_MIF_CMU_PERI_SPI1: u32 = 0x04b4;const CLK_CON_DIV_MIF_CMU_PERI_SPI0: u32 = 0x04b8;const CLK_CON_DIV_MIF_CMU_PERI_SPI3: u32 = 0x04bc;const CLK_CON_DIV_MIF_CMU_PERI_SPI4: u32 = 0x04c0;const CLK_CON_DIV_MIF_CMU_ISP_SENSOR0: u32 = 0x04c4;const CLK_CON_DIV_MIF_CMU_ISP_SENSOR1: u32 = 0x04c8;const CLK_CON_DIV_MIF_CMU_ISP_SENSOR2: u32 = 0x04cc;const CLK_CON_GAT_MIF_WRAP_ADC_IF_OSC_SYS: u32 = 0x080c;const CLK_CON_GAT_MIF_HSI2C_AP_PCLKS: u32 = 0x0828;const CLK_CON_GAT_MIF_HSI2C_CP_PCLKS: u32 = 0x0828;const CLK_CON_GAT_MIF_WRAP_ADC_IF_PCLK_S0: u32 = 0x0828;const CLK_CON_GAT_MIF_WRAP_ADC_IF_PCLK_S1: u32 = 0x0828;const CLK_CON_GAT_MIF_HSI2C_AP_PCLKM: u32 = 0x0840;const CLK_CON_GAT_MIF_HSI2C_CP_PCLKM: u32 = 0x0840;const CLK_CON_GAT_MIF_HSI2C_IPCLK: u32 = 0x0840;const CLK_CON_GAT_MIF_HSI2C_ITCLK: u32 = 0x0840;const CLK_CON_GAT_MIF_CP_PCLK_HSI2C: u32 = 0x0840;const CLK_CON_GAT_MIF_CP_PCLK_HSI2C_BAT_0: u32 = 0x0840;const CLK_CON_GAT_MIF_CP_PCLK_HSI2C_BAT_1: u32 = 0x0840;const CLK_CON_GAT_MIF_CMU_G3D_SWITCH: u32 = 0x0860;const CLK_CON_GAT_MIF_CMU_ISP_VRA: u32 = 0x0864;const CLK_CON_GAT_MIF_CMU_ISP_CAM: u32 = 0x0868;const CLK_CON_GAT_MIF_CMU_ISP_ISP: u32 = 0x086c;const CLK_CON_GAT_MIF_CMU_DISPAUD_BUS: u32 = 0x0870;const CLK_CON_GAT_MIF_CMU_DISPAUD_DECON_VCLK: u32 = 0x0874;const CLK_CON_GAT_MIF_CMU_DISPAUD_DECON_ECLK: u32 = 0x0878;const CLK_CON_GAT_MIF_CMU_MFCMSCL_MSCL: u32 = 0x087c;const CLK_CON_GAT_MIF_CMU_MFCMSCL_MFC: u32 = 0x0880;const CLK_CON_GAT_MIF_CMU_FSYS_BUS: u32 = 0x0884;const CLK_CON_GAT_MIF_CMU_FSYS_MMC0: u32 = 0x0888;const CLK_CON_GAT_MIF_CMU_FSYS_MMC1: u32 = 0x088c;const CLK_CON_GAT_MIF_CMU_FSYS_MMC2: u32 = 0x0890;const CLK_CON_GAT_MIF_CMU_FSYS_USB20DRD_REFCLK: u32 = 0x089c;const CLK_CON_GAT_MIF_CMU_PERI_BUS: u32 = 0x08a0;const CLK_CON_GAT_MIF_CMU_PERI_UART1: u32 = 0x08a4;const CLK_CON_GAT_MIF_CMU_PERI_UART2: u32 = 0x08a8;const CLK_CON_GAT_MIF_CMU_PERI_UART0: u32 = 0x08ac;const CLK_CON_GAT_MIF_CMU_PERI_SPI2: u32 = 0x08b0;const CLK_CON_GAT_MIF_CMU_PERI_SPI1: u32 = 0x08b4;const CLK_CON_GAT_MIF_CMU_PERI_SPI0: u32 = 0x08b8;const CLK_CON_GAT_MIF_CMU_PERI_SPI3: u32 = 0x08bc;const CLK_CON_GAT_MIF_CMU_PERI_SPI4: u32 = 0x08c0;const CLK_CON_GAT_MIF_CMU_ISP_SENSOR0: u32 = 0x08c4;const CLK_CON_GAT_MIF_CMU_ISP_SENSOR1: u32 = 0x08c8;const CLK_CON_GAT_MIF_CMU_ISP_SENSOR2: u32 = 0x08cc;
const u32 mif_clk_regs[] = {
...
const Samsungfixed_factor_clock mif_fixed_factor_clks[] = {
...
const Samsungpll_clock mif_pll_clks[] = {
	PLL(pll_1417x, CLK_FOUT_MIF_BUS_PLL, "fout_mif_bus_pll", "oscclk",
	    PLL_LOCKTIME_MIF_BUS_PLL, PLL_CON0_MIF_BUS_PLL, core::ptr::null_mut()),
	PLL(pll_1417x, CLK_FOUT_MIF_MEDIA_PLL, "fout_mif_media_pll", "oscclk",
	    PLL_LOCKTIME_MIF_MEDIA_PLL, PLL_CON0_MIF_MEDIA_PLL, core::ptr::null_mut()),
	PLL(pll_1417x, CLK_FOUT_MIF_MEM_PLL, "fout_mif_mem_pll", "oscclk",
	    PLL_LOCKTIME_MIF_MEM_PLL, PLL_CON0_MIF_MEM_PLL, core::ptr::null_mut()),
};
...
const Samsungmux_clock mif_mux_clks[] = {
...
const Samsungdiv_clock mif_div_clks[] = {
...
const Samsunggate_clock mif_gate_clks[] = {
...
const Samsungcmu_info mif_cmu_info = {
	.$1: mif_fixed_factor_clks,
	.$1: mif_fixed_factor_clks.len(),
	.$1: mif_pll_clks,
	.$1: mif_pll_clks.len(),
	.$1: mif_mux_clks,
	.$1: mif_mux_clks.len(),
 ...
 */
const PLL_LOCKTIME_DISPAUD_PLL: u32 = 0x0000;const PLL_LOCKTIME_DISPAUD_AUD_PLL: u32 = 0x00c0;const PLL_CON0_DISPAUD_PLL: u32 = 0x0100;const PLL_CON0_DISPAUD_AUD_PLL: u32 = 0x01c0;const CLK_CON_GAT_DISPAUD_MUX_PLL: u32 = 0x0200;const CLK_CON_GAT_DISPAUD_MUX_PLL_CON: u32 = 0x0200;const CLK_CON_GAT_DISPAUD_MUX_AUD_PLL: u32 = 0x0204;const CLK_CON_GAT_DISPAUD_MUX_AUD_PLL_CON: u32 = 0x0204;const CLK_CON_GAT_DISPAUD_MUX_BUS_USER: u32 = 0x0210;const CLK_CON_MUX_DISPAUD_BUS_USER: u32 = 0x0210;const CLK_CON_GAT_DISPAUD_MUX_DECON_VCLK_USER: u32 = 0x0214;const CLK_CON_MUX_DISPAUD_DECON_VCLK_USER: u32 = 0x0214;const CLK_CON_GAT_DISPAUD_MUX_DECON_ECLK_USER: u32 = 0x0218;const CLK_CON_MUX_DISPAUD_DECON_ECLK_USER: u32 = 0x0218;const CLK_CON_GAT_DISPAUD_MUX_DECON_VCLK: u32 = 0x021c;const CLK_CON_MUX_DISPAUD_DECON_VCLK: u32 = 0x021c;const CLK_CON_GAT_DISPAUD_MUX_DECON_ECLK: u32 = 0x0220;const CLK_CON_MUX_DISPAUD_DECON_ECLK: u32 = 0x0220;const CLK_CON_GAT_DISPAUD_MUX_MIPIPHY_TXBYTECLKHS_USER: u32 = 0x0224;const CLK_CON_GAT_DISPAUD_MUX_MIPIPHY_TXBYTECLKHS_USER_CON: u32 = 0x0224;const CLK_CON_GAT_DISPAUD_MUX_MIPIPHY_RXCLKESC0_USER: u32 = 0x0228;const CLK_CON_GAT_DISPAUD_MUX_MIPIPHY_RXCLKESC0_USER_CON: u32 = 0x0228;const CLK_CON_GAT_DISPAUD_MUX_MI2S: u32 = 0x022c;const CLK_CON_MUX_DISPAUD_MI2S: u32 = 0x022c;const CLK_CON_DIV_DISPAUD_APB: u32 = 0x0400;const CLK_CON_DIV_DISPAUD_DECON_VCLK: u32 = 0x0404;const CLK_CON_DIV_DISPAUD_DECON_ECLK: u32 = 0x0408;const CLK_CON_DIV_DISPAUD_MI2S: u32 = 0x040c;const CLK_CON_DIV_DISPAUD_MIXER: u32 = 0x0410;const CLK_CON_GAT_DISPAUD_BUS: u32 = 0x0810;const CLK_CON_GAT_DISPAUD_BUS_DISP: u32 = 0x0810;const CLK_CON_GAT_DISPAUD_BUS_PPMU: u32 = 0x0810;const CLK_CON_GAT_DISPAUD_APB_AUD: u32 = 0x0814;const CLK_CON_GAT_DISPAUD_APB_AUD_AMP: u32 = 0x0814;const CLK_CON_GAT_DISPAUD_APB_DISP: u32 = 0x0814;const CLK_CON_GAT_DISPAUD_DECON_VCLK: u32 = 0x081c;const CLK_CON_GAT_DISPAUD_DECON_ECLK: u32 = 0x0820;const CLK_CON_GAT_DISPAUD_MI2S_AMP_I2SCODCLKI: u32 = 0x082c;const CLK_CON_GAT_DISPAUD_MI2S_AUD_I2SCODCLKI: u32 = 0x082c;const CLK_CON_GAT_DISPAUD_MIXER_AUD_SYSCLK: u32 = 0x0830;const CLK_CON_GAT_DISPAUD_CON_EXT2AUD_BCK_GPIO_I2S: u32 = 0x0834;const CLK_CON_GAT_DISPAUD_CON_AUD_I2S_BCLK_BT_IN: u32 = 0x0838;const CLK_CON_GAT_DISPAUD_CON_CP2AUD_BCK: u32 = 0x083c;const CLK_CON_GAT_DISPAUD_CON_AUD_I2S_BCLK_FM_IN: u32 = 0x0840;
const u32 dispaud_clk_regs[] = {
...
const Samsungfixed_rate_clock dispaud_fixed_clks[] = {
	FRATE(0, "frat_dispaud_audiocdclk0", core::ptr::null_mut(), 0, 100000000),
	FRATE(0, "frat_dispaud_mixer_bclk_bt", core::ptr::null_mut(), 0, 12500000),
	FRATE(0, "frat_dispaud_mixer_bclk_cp", core::ptr::null_mut(), 0, 12500000),
	FRATE(0, "frat_dispaud_mixer_bclk_fm", core::ptr::null_mut(), 0, 12500000),
	FRATE(0, "frat_dispaud_mixer_sclk_ap", core::ptr::null_mut(), 0, 12500000),
	FRATE(0, "frat_dispaud_mipiphy_rxclkesc0", core::ptr::null_mut(), 0, 188000000),
	FRATE(0, "frat_dispaud_mipiphy_txbyteclkhs", core::ptr::null_mut(), 0, 188000000),
};

const Samsungpll_clock dispaud_pll_clks[] = {
	...
	PLL(pll_1417x, CLK_FOUT_DISPAUD_PLL, "fout_dispaud_pll", "oscclk",
	    PLL_LOCKTIME_DISPAUD_PLL, PLL_CON0_DISPAUD_PLL, core::ptr::null_mut()),
};

/* List of parent clocks for muxes in CMU_DISPAUD */
static mout_dispaud_bus_user_p: &[&str] = [ "oscclk", "gout_mif_cmu_dispaud_bus" ];
...
const Samsungmux_clock dispaud_mux_clks[] = {
...
const Samsungdiv_clock dispaud_div_clks[] = {
...
const Samsunggate_clock dispaud_gate_clks[] = {
...
const Samsungcmu_info dispaud_cmu_info = {
	.$1: dispaud_fixed_clks,
	.$1: dispaud_fixed_clks.len(),
	.$1: dispaud_pll_clks,
	.$1: dispaud_pll_clks.len(),
	.$1: dispaud_mux_clks,
	.$1: dispaud_mux_clks.len(),
	.$1: dispaud_div_clks,
	.$1: dispaud_div_clks.len(),
	.$1: dispaud_gate_clks,
	.$1: dispaud_gate_clks.len(),
	.$1: dispaud_clk_regs,
	.$1: dispaud_clk_regs.len(),
	.$1: DISPAUD_NR_CLK,
};
 ...
 */
const PLL_LOCKTIME_FSYS_USB_PLL: u32 = 0x0000;const PLL_CON0_FSYS_USB_PLL: u32 = 0x0100;const CLK_CON_GAT_FSYS_MUX_USB_PLL: u32 = 0x0200;const CLK_CON_GAT_FSYS_MUX_USB_PLL_CON: u32 = 0x0200;const CLK_CON_GAT_FSYS_MUX_USB20DRD_PHYCLOCK_USER: u32 = 0x0230;const CLK_CON_GAT_FSYS_MUX_USB20DRD_PHYCLOCK_USER_CON: u32 = 0x0230;const CLK_CON_GAT_FSYS_BUSP3_HCLK: u32 = 0x0804;const CLK_CON_GAT_FSYS_MMC0_ACLK: u32 = 0x0804;const CLK_CON_GAT_FSYS_MMC1_ACLK: u32 = 0x0804;const CLK_CON_GAT_FSYS_MMC2_ACLK: u32 = 0x0804;const CLK_CON_GAT_FSYS_PDMA0_ACLK_PDMA0: u32 = 0x0804;const CLK_CON_GAT_FSYS_PPMU_ACLK: u32 = 0x0804;const CLK_CON_GAT_FSYS_PPMU_PCLK: u32 = 0x0804;const CLK_CON_GAT_FSYS_SROMC_HCLK: u32 = 0x0804;const CLK_CON_GAT_FSYS_UPSIZER_BUS1_ACLK: u32 = 0x0804;const CLK_CON_GAT_FSYS_USB20DRD_ACLK_HSDRD: u32 = 0x0804;const CLK_CON_GAT_FSYS_USB20DRD_HCLK_USB20_CTRL: u32 = 0x0804;const CLK_CON_GAT_FSYS_USB20DRD_HSDRD_REF_CLK: u32 = 0x0828;
const u32 fsys_clk_regs[] = {
...
const Samsungfixed_rate_clock fsys_fixed_clks[] = {
	FRATE(0, "frat_fsys_usb20drd_phyclock", core::ptr::null_mut(), 0, 60000000),
};

const Samsungpll_clock fsys_pll_clks[] = {
	PLL(pll_1417x, CLK_FOUT_FSYS_USB_PLL, "fout_fsys_usb_pll", "oscclk",
	    PLL_LOCKTIME_FSYS_USB_PLL, PLL_CON0_FSYS_USB_PLL, core::ptr::null_mut()),
};

const Samsunggate_clock fsys_gate_clks[] = {
...
const Samsungcmu_info fsys_cmu_info = {
	.$1: fsys_fixed_clks,
	.$1: fsys_fixed_clks.len(),
	.$1: fsys_pll_clks,
	.$1: fsys_pll_clks.len(),
	.$1: fsys_gate_clks,
	.$1: fsys_gate_clks.len(),
	.$1: fsys_clk_regs,
	.$1: fsys_clk_regs.len(),
	.$1: FSYS_NR_CLK,
};
 ...
 */
const PLL_LOCKTIME_G3D_PLL: u32 = 0x0000;const PLL_CON0_G3D_PLL: u32 = 0x0100;const CLK_CON_GAT_G3D_MUX_PLL: u32 = 0x0200;const CLK_CON_GAT_G3D_MUX_PLL_CON: u32 = 0x0200;const CLK_CON_GAT_G3D_MUX_SWITCH_USER: u32 = 0x0204;const CLK_CON_MUX_G3D_SWITCH_USER: u32 = 0x0204;const CLK_CON_GAT_G3D_MUX: u32 = 0x0208;const CLK_CON_MUX_G3D: u32 = 0x0208;const CLK_CON_DIV_G3D_BUS: u32 = 0x0400;const CLK_CON_DIV_G3D_APB: u32 = 0x0404;const CLK_CON_GAT_G3D_ASYNCS_D0_CLK: u32 = 0x0804;const CLK_CON_GAT_G3D_ASYNC_PCLKM: u32 = 0x0804;const CLK_CON_GAT_G3D_CLK: u32 = 0x0804;const CLK_CON_GAT_G3D_PPMU_ACLK: u32 = 0x0804;const CLK_CON_GAT_G3D_QE_ACLK: u32 = 0x0804;const CLK_CON_GAT_G3D_PPMU_PCLK: u32 = 0x0808;const CLK_CON_GAT_G3D_QE_PCLK: u32 = 0x0808;const CLK_CON_GAT_G3D_SYSREG_PCLK: u32 = 0x0808;
const u32 g3d_clk_regs[] = {
...
const Samsungpll_clock g3d_pll_clks[] = {
	PLL(pll_1417x, CLK_FOUT_G3D_PLL, "fout_g3d_pll", "oscclk",
	    PLL_LOCKTIME_G3D_PLL, PLL_CON0_G3D_PLL, core::ptr::null_mut()),
};

/* List of parent clocks for muxes in CMU_G3D */
static mout_g3d_switch_user_p: &[&str] = [ "oscclk", "gout_mif_cmu_g3d_switch" ];
PNAME(mout_g3d_p)		= { "gout_g3d_mux_pll_con",
				    "gout_g3d_mux_switch_user" };

const Samsungmux_clock g3d_mux_clks[] = {
...
const Samsungdiv_clock g3d_div_clks[] = {
...
const Samsunggate_clock g3d_gate_clks[] = {
...
const Samsungcmu_info g3d_cmu_info = {
	.$1: g3d_pll_clks,
	.$1: g3d_pll_clks.len(),
	.$1: g3d_mux_clks,
	.$1: g3d_mux_clks.len(),
 ...
 */
const PLL_LOCKTIME_ISP_PLL: u32 = 0x0000;const PLL_CON0_ISP_PLL: u32 = 0x0100;const CLK_CON_GAT_ISP_MUX_PLL: u32 = 0x0200;const CLK_CON_GAT_ISP_MUX_PLL_CON: u32 = 0x0200;const CLK_CON_GAT_ISP_MUX_VRA_USER: u32 = 0x0210;const CLK_CON_MUX_ISP_VRA_USER: u32 = 0x0210;const CLK_CON_GAT_ISP_MUX_CAM_USER: u32 = 0x0214;const CLK_CON_MUX_ISP_CAM_USER: u32 = 0x0214;const CLK_CON_GAT_ISP_MUX_USER: u32 = 0x0218;const CLK_CON_MUX_ISP_USER: u32 = 0x0218;const CLK_CON_GAT_ISP_MUX_VRA: u32 = 0x0220;const CLK_CON_MUX_ISP_VRA: u32 = 0x0220;const CLK_CON_GAT_ISP_MUX_CAM: u32 = 0x0224;const CLK_CON_MUX_ISP_CAM: u32 = 0x0224;const CLK_CON_GAT_ISP_MUX_ISP: u32 = 0x0228;const CLK_CON_MUX_ISP_ISP: u32 = 0x0228;const CLK_CON_GAT_ISP_MUX_ISPD: u32 = 0x022c;const CLK_CON_MUX_ISP_ISPD: u32 = 0x022c;const CLK_CON_GAT_ISP_MUX_RXBYTECLKHS0_SENSOR0_USER: u32 = 0x0230;const CLK_CON_GAT_ISP_MUX_RXBYTECLKHS0_SENSOR0_USER_CON: u32 = 0x0230;const CLK_CON_GAT_ISP_MUX_RXBYTECLKHS0_SENSOR1_USER: u32 = 0x0234;const CLK_CON_GAT_ISP_MUX_RXBYTECLKHS0_SENSOR1_USER_CON: u32 = 0x0234;const CLK_CON_DIV_ISP_APB: u32 = 0x0400;const CLK_CON_DIV_ISP_CAM_HALF: u32 = 0x0404;const CLK_CON_GAT_ISP_VRA: u32 = 0x0810;const CLK_CON_GAT_ISP_ISPD: u32 = 0x0818;const CLK_CON_GAT_ISP_ISPD_PPMU: u32 = 0x0818;const CLK_CON_GAT_ISP_CAM: u32 = 0x081c;const CLK_CON_GAT_ISP_CAM_HALF: u32 = 0x0820;
const u32 isp_clk_regs[] = {
...
const Samsungfixed_rate_clock isp_fixed_clks[] = {
	FRATE(0, "frat_isp_rxbyteclkhs0_sensor0", core::ptr::null_mut(), 0, 188000000),
	FRATE(0, "frat_isp_rxbyteclkhs0_sensor1", core::ptr::null_mut(), 0, 188000000),
};

const Samsungpll_clock isp_pll_clks[] = {
	PLL(pll_1417x, CLK_FOUT_ISP_PLL, "fout_isp_pll", "oscclk",
	    PLL_LOCKTIME_ISP_PLL, PLL_CON0_ISP_PLL, core::ptr::null_mut()),
};

/* List of parent clocks for muxes in CMU_ISP */
static mout_isp_cam_user_p: &[&str] = [ "oscclk", "gout_mif_cmu_isp_cam" ];
static mout_isp_user_p: &[&str] = [ "oscclk", "gout_mif_cmu_isp_isp" ];
static mout_isp_vra_user_p: &[&str] = [ "oscclk", "gout_mif_cmu_isp_vra" ];
PNAME(mout_isp_cam_p)		= { "gout_isp_mux_cam_user",
				    "gout_isp_mux_pll_con" };
static mout_isp_isp_p: &[&str] = [ "gout_isp_mux_user", "gout_isp_mux_pll_con" ];
static mout_isp_ispd_p: &[&str] = [ "gout_isp_mux_vra", "gout_isp_mux_cam" ];
PNAME(mout_isp_vra_p)		= { "gout_isp_mux_vra_user",
				    "gout_isp_mux_pll_con" };

const Samsungmux_clock isp_mux_clks[] = {
...
const Samsungdiv_clock isp_div_clks[] = {
...
const Samsunggate_clock isp_gate_clks[] = {
...
const Samsungcmu_info isp_cmu_info = {
	.$1: isp_fixed_clks,
	.$1: isp_fixed_clks.len(),
	.$1: isp_pll_clks,
	.$1: isp_pll_clks.len(),
	.$1: isp_mux_clks,
	.$1: isp_mux_clks.len(),
 ...
 */
const CLK_CON_GAT_MFCMSCL_MUX_MSCL_USER: u32 = 0x0200;const CLK_CON_MUX_MFCMSCL_MSCL_USER: u32 = 0x0200;const CLK_CON_GAT_MFCMSCL_MUX_MFC_USER: u32 = 0x0204;const CLK_CON_MUX_MFCMSCL_MFC_USER: u32 = 0x0204;const CLK_CON_DIV_MFCMSCL_APB: u32 = 0x0400;const CLK_CON_GAT_MFCMSCL_MSCL: u32 = 0x0804;const CLK_CON_GAT_MFCMSCL_MSCL_BI: u32 = 0x0804;const CLK_CON_GAT_MFCMSCL_MSCL_D: u32 = 0x0804;const CLK_CON_GAT_MFCMSCL_MSCL_JPEG: u32 = 0x0804;const CLK_CON_GAT_MFCMSCL_MSCL_POLY: u32 = 0x0804;const CLK_CON_GAT_MFCMSCL_MSCL_PPMU: u32 = 0x0804;const CLK_CON_GAT_MFCMSCL_MFC: u32 = 0x0808;
const u32 mfcmscl_clk_regs[] = {
...
static mout_mfcmscl_mfc_user_p: &[&str] = [ "oscclk", "gout_mif_cmu_mfcmscl_mfc" ];
static mout_mfcmscl_mscl_user_p: &[&str] = [ "oscclk", "gout_mif_cmu_mfcmscl_mscl" ];

const Samsungmux_clock mfcmscl_mux_clks[] = {
...
const Samsungcmu_info mfcmscl_cmu_info = {
	.$1: mfcmscl_mux_clks,
	.$1: mfcmscl_mux_clks.len(),
	.$1: mfcmscl_div_clks,
	.$1: mfcmscl_div_clks.len(),
	.$1: mfcmscl_gate_clks,
	.$1: mfcmscl_gate_clks.len(),
	.$1: mfcmscl_clk_regs,
	.$1: mfcmscl_clk_regs.len(),
	.$1: MFCMSCL_NR_CLK,
};
 ...
 */
const CLK_CON_GAT_PERI_PWM_MOTOR_OSCCLK: u32 = 0x0800;const CLK_CON_GAT_PERI_TMU_CPUCL0_CLK: u32 = 0x0800;const CLK_CON_GAT_PERI_TMU_CPUCL1_CLK: u32 = 0x0800;const CLK_CON_GAT_PERI_TMU_CLK: u32 = 0x0800;const CLK_CON_GAT_PERI_BUSP1_PERIC0_HCLK: u32 = 0x0810;const CLK_CON_GAT_PERI_GPIO2_PCLK: u32 = 0x0810;const CLK_CON_GAT_PERI_GPIO5_PCLK: u32 = 0x0810;const CLK_CON_GAT_PERI_GPIO6_PCLK: u32 = 0x0810;const CLK_CON_GAT_PERI_GPIO7_PCLK: u32 = 0x0810;const CLK_CON_GAT_PERI_HSI2C4_IPCLK: u32 = 0x0810;const CLK_CON_GAT_PERI_HSI2C6_IPCLK: u32 = 0x0810;const CLK_CON_GAT_PERI_HSI2C3_IPCLK: u32 = 0x0810;const CLK_CON_GAT_PERI_HSI2C5_IPCLK: u32 = 0x0810;const CLK_CON_GAT_PERI_HSI2C2_IPCLK: u32 = 0x0810;const CLK_CON_GAT_PERI_HSI2C1_IPCLK: u32 = 0x0810;const CLK_CON_GAT_PERI_I2C0_PCLK: u32 = 0x0810;const CLK_CON_GAT_PERI_I2C4_PCLK: u32 = 0x0810;const CLK_CON_GAT_PERI_I2C5_PCLK: u32 = 0x0810;const CLK_CON_GAT_PERI_I2C6_PCLK: u32 = 0x0810;const CLK_CON_GAT_PERI_I2C7_PCLK: u32 = 0x0810;const CLK_CON_GAT_PERI_I2C8_PCLK: u32 = 0x0810;const CLK_CON_GAT_PERI_I2C3_PCLK: u32 = 0x0810;const CLK_CON_GAT_PERI_I2C2_PCLK: u32 = 0x0810;const CLK_CON_GAT_PERI_I2C1_PCLK: u32 = 0x0810;const CLK_CON_GAT_PERI_MCT_PCLK: u32 = 0x0810;const CLK_CON_GAT_PERI_PWM_MOTOR_PCLK_S0: u32 = 0x0810;const CLK_CON_GAT_PERI_SFRIF_TMU_CPUCL0_PCLK: u32 = 0x0814;const CLK_CON_GAT_PERI_SFRIF_TMU_CPUCL1_PCLK: u32 = 0x0814;const CLK_CON_GAT_PERI_SFRIF_TMU_PCLK: u32 = 0x0814;const CLK_CON_GAT_PERI_SPI0_PCLK: u32 = 0x0814;const CLK_CON_GAT_PERI_SPI2_PCLK: u32 = 0x0814;const CLK_CON_GAT_PERI_SPI1_PCLK: u32 = 0x0814;const CLK_CON_GAT_PERI_SPI4_PCLK: u32 = 0x0814;const CLK_CON_GAT_PERI_SPI3_PCLK: u32 = 0x0814;const CLK_CON_GAT_PERI_UART1_PCLK: u32 = 0x0814;const CLK_CON_GAT_PERI_UART2_PCLK: u32 = 0x0814;const CLK_CON_GAT_PERI_UART0_PCLK: u32 = 0x0814;const CLK_CON_GAT_PERI_WDT_CPUCL0_PCLK: u32 = 0x0814;const CLK_CON_GAT_PERI_WDT_CPUCL1_PCLK: u32 = 0x0814;const CLK_CON_GAT_PERI_UART1_EXT_UCLK: u32 = 0x0830;const CLK_CON_GAT_PERI_UART2_EXT_UCLK: u32 = 0x0834;const CLK_CON_GAT_PERI_UART0_EXT_UCLK: u32 = 0x0838;const CLK_CON_GAT_PERI_SPI2_SPI_EXT_CLK: u32 = 0x083c;const CLK_CON_GAT_PERI_SPI1_SPI_EXT_CLK: u32 = 0x0840;const CLK_CON_GAT_PERI_SPI0_SPI_EXT_CLK: u32 = 0x0844;const CLK_CON_GAT_PERI_SPI3_SPI_EXT_CLK: u32 = 0x0848;const CLK_CON_GAT_PERI_SPI4_SPI_EXT_CLK: u32 = 0x084c;
const u32 peri_clk_regs[] = {
...
const Samsunggate_clock peri_gate_clks[] = {
...
const Samsungcmu_info peri_cmu_info = {
	.$1: peri_gate_clks,
	.$1: peri_gate_clks.len(),
	.$1: peri_clk_regs,
	.$1: peri_clk_regs.len(),
	.$1: PERI_NR_CLK,
};
...
const OfDeviceId exynos7870_cmu_of_match[] = {
	{
		.$1: "samsung,exynos7870-cmu-mif",
		.$1: &mif_cmu_info,
	}, {
		.$1: "samsung,exynos7870-cmu-dispaud",
		.$1: &dispaud_cmu_info,
	}, {
		.$1: "samsung,exynos7870-cmu-fsys",
		.$1: &fsys_cmu_info,
	}, {
		.$1: "samsung,exynos7870-cmu-g3d",
		.$1: &g3d_cmu_info,
	}, {
		.$1: "samsung,exynos7870-cmu-isp",
		.$1: &isp_cmu_info,
	}, {
		.$1: "samsung,exynos7870-cmu-mfcmscl",
		.$1: &mfcmscl_cmu_info,
	}, {
		.$1: "samsung,exynos7870-cmu-peri",
		.$1: &peri_cmu_info,
	}, {
	},
};

static PlatformDriver exynos7870_cmu_driver __refdata = {
	.$1: {
		.$1: "exynos7870-cmu",
		.$1: exynos7870_cmu_of_match,
		.$1: true,
	},
	.$1: exynos7870_cmu_probe,
};
