...
/* Faithful low-level Rust translation of clk-exynos5433.c. External Linux clock-framework symbols are supplied by dependencies. */
// SPDX-License-Identifier: GPL-2.0-only
/*
...
const CLKS_NR_TOP: u32 = (CLK_SCLK_HDMI_SPDIF_DISP + 1);
const CLKS_NR_CPIF: u32 = (CLK_SCLK_UFS_MPHY + 1);
const CLKS_NR_MIF: u32 = (CLK_SCLK_BUS_PLL_ATLAS + 1);
const CLKS_NR_PERIC: u32 = (CLK_DIV_SCLK_SC_IN + 1);
const CLKS_NR_PERIS: u32 = (CLK_SCLK_OTP_CON + 1);
const CLKS_NR_FSYS: u32 = (CLK_PCIE + 1);
const CLKS_NR_G2D: u32 = (CLK_PCLK_SMMU_G2D + 1);
const CLKS_NR_DISP: u32 = (CLK_PHYCLK_MIPIDPHY0_RXCLKESC0_PHY + 1);
const CLKS_NR_AUD: u32 = (CLK_SCLK_AUD_I2S + 1);
const CLKS_NR_BUSX: u32 = (CLK_ACLK_BUS2RTND_400 + 1);
const CLKS_NR_G3D: u32 = (CLK_SCLK_HPM_G3D + 1);
const CLKS_NR_GSCL: u32 = (CLK_PCLK_SMMU_GSCL2 + 1);
const CLKS_NR_APOLLO: u32 = (CLK_SCLK_APOLLO + 1);
const CLKS_NR_ATLAS: u32 = (CLK_SCLK_ATLAS + 1);
const CLKS_NR_MSCL: u32 = (CLK_SCLK_JPEG + 1);
const CLKS_NR_MFC: u32 = (CLK_PCLK_SMMU_MFC_0 + 1);
const CLKS_NR_HEVC: u32 = (CLK_PCLK_SMMU_HEVC_0 + 1);
const CLKS_NR_ISP: u32 = (CLK_SCLK_PIXELASYNCM_ISPC + 1);
const CLKS_NR_CAM0: u32 = (CLK_SCLK_PIXELASYNCS_LITE_C_INIT + 1);
const CLKS_NR_CAM1: u32 = (CLK_SCLK_ISP_CA5 + 1);
const CLKS_NR_IMEM: u32 = (CLK_PCLK_SLIMSSS + 1);

/*
 * Register offset definitions for CMU_TOP
 */
const ISP_PLL_LOCK: u32 = 0x0000;
const AUD_PLL_LOCK: u32 = 0x0004;
const ISP_PLL_CON0: u32 = 0x0100;
const ISP_PLL_CON1: u32 = 0x0104;
const ISP_PLL_FREQ_DET: u32 = 0x0108;
const AUD_PLL_CON0: u32 = 0x0110;
const AUD_PLL_CON1: u32 = 0x0114;
const AUD_PLL_CON2: u32 = 0x0118;
const AUD_PLL_FREQ_DET: u32 = 0x011c;
const MUX_SEL_TOP0: u32 = 0x0200;
const MUX_SEL_TOP1: u32 = 0x0204;
const MUX_SEL_TOP2: u32 = 0x0208;
const MUX_SEL_TOP3: u32 = 0x020c;
const MUX_SEL_TOP4: u32 = 0x0210;
const MUX_SEL_TOP_MSCL: u32 = 0x0220;
const MUX_SEL_TOP_CAM1: u32 = 0x0224;
const MUX_SEL_TOP_DISP: u32 = 0x0228;
const MUX_SEL_TOP_FSYS0: u32 = 0x0230;
const MUX_SEL_TOP_FSYS1: u32 = 0x0234;
const MUX_SEL_TOP_PERIC0: u32 = 0x0238;
const MUX_SEL_TOP_PERIC1: u32 = 0x023c;
const MUX_ENABLE_TOP0: u32 = 0x0300;
const MUX_ENABLE_TOP1: u32 = 0x0304;
const MUX_ENABLE_TOP2: u32 = 0x0308;
const MUX_ENABLE_TOP3: u32 = 0x030c;
const MUX_ENABLE_TOP4: u32 = 0x0310;
const MUX_ENABLE_TOP_MSCL: u32 = 0x0320;
const MUX_ENABLE_TOP_CAM1: u32 = 0x0324;
const MUX_ENABLE_TOP_DISP: u32 = 0x0328;
const MUX_ENABLE_TOP_FSYS0: u32 = 0x0330;
const MUX_ENABLE_TOP_FSYS1: u32 = 0x0334;
const MUX_ENABLE_TOP_PERIC0: u32 = 0x0338;
const MUX_ENABLE_TOP_PERIC1: u32 = 0x033c;
const MUX_STAT_TOP0: u32 = 0x0400;
const MUX_STAT_TOP1: u32 = 0x0404;
const MUX_STAT_TOP2: u32 = 0x0408;
const MUX_STAT_TOP3: u32 = 0x040c;
const MUX_STAT_TOP4: u32 = 0x0410;
const MUX_STAT_TOP_MSCL: u32 = 0x0420;
const MUX_STAT_TOP_CAM1: u32 = 0x0424;
const MUX_STAT_TOP_FSYS0: u32 = 0x0430;
const MUX_STAT_TOP_FSYS1: u32 = 0x0434;
const MUX_STAT_TOP_PERIC0: u32 = 0x0438;
const MUX_STAT_TOP_PERIC1: u32 = 0x043c;
const DIV_TOP0: u32 = 0x0600;
const DIV_TOP1: u32 = 0x0604;
const DIV_TOP2: u32 = 0x0608;
const DIV_TOP3: u32 = 0x060c;
const DIV_TOP4: u32 = 0x0610;
const DIV_TOP_MSCL: u32 = 0x0618;
const DIV_TOP_CAM10: u32 = 0x061c;
const DIV_TOP_CAM11: u32 = 0x0620;
const DIV_TOP_FSYS0: u32 = 0x062c;
const DIV_TOP_FSYS1: u32 = 0x0630;
const DIV_TOP_FSYS2: u32 = 0x0634;
const DIV_TOP_PERIC0: u32 = 0x0638;
const DIV_TOP_PERIC1: u32 = 0x063c;
const DIV_TOP_PERIC2: u32 = 0x0640;
const DIV_TOP_PERIC3: u32 = 0x0644;
const DIV_TOP_PERIC4: u32 = 0x0648;
const DIV_TOP_PLL_FREQ_DET: u32 = 0x064c;
const DIV_STAT_TOP0: u32 = 0x0700;
const DIV_STAT_TOP1: u32 = 0x0704;
const DIV_STAT_TOP2: u32 = 0x0708;
const DIV_STAT_TOP3: u32 = 0x070c;
const DIV_STAT_TOP4: u32 = 0x0710;
const DIV_STAT_TOP_MSCL: u32 = 0x0718;
const DIV_STAT_TOP_CAM10: u32 = 0x071c;
const DIV_STAT_TOP_CAM11: u32 = 0x0720;
const DIV_STAT_TOP_FSYS0: u32 = 0x072c;
const DIV_STAT_TOP_FSYS1: u32 = 0x0730;
const DIV_STAT_TOP_FSYS2: u32 = 0x0734;
const DIV_STAT_TOP_PERIC0: u32 = 0x0738;
const DIV_STAT_TOP_PERIC1: u32 = 0x073c;
const DIV_STAT_TOP_PERIC2: u32 = 0x0740;
const DIV_STAT_TOP_PERIC3: u32 = 0x0744;
const DIV_STAT_TOP_PLL_FREQ_DET: u32 = 0x074c;
const ENABLE_ACLK_TOP: u32 = 0x0800;
const ENABLE_SCLK_TOP: u32 = 0x0a00;
const ENABLE_SCLK_TOP_MSCL: u32 = 0x0a04;
const ENABLE_SCLK_TOP_CAM1: u32 = 0x0a08;
const ENABLE_SCLK_TOP_DISP: u32 = 0x0a0c;
const ENABLE_SCLK_TOP_FSYS: u32 = 0x0a10;
const ENABLE_SCLK_TOP_PERIC: u32 = 0x0a14;
const ENABLE_IP_TOP: u32 = 0x0b00;
const ENABLE_CMU_TOP: u32 = 0x0c00;
const ENABLE_CMU_TOP_DIV_STAT: u32 = 0x0c04;
...
static struct samsung_clk_reg_dump top_suspend_regs[] = {
...
static struct samsung_fixed_rate_clock top_fixed_clks[]  = {
 ...
 */
static struct samsung_pll_rate_table exynos5433_pll_rates[]  = {
...
/* AUD_PLL */
static struct samsung_pll_rate_table exynos5433_aud_pll_rates[]  = {
...
static unsafe fn exynos5433_cmu_top_init(struct device_node *np)
{
 ...
 */
const MPHY_PLL_LOCK: u32 = 0x0000;
const MPHY_PLL_CON0: u32 = 0x0100;
const MPHY_PLL_CON1: u32 = 0x0104;
const MPHY_PLL_FREQ_DET: u32 = 0x010c;
const MUX_SEL_CPIF0: u32 = 0x0200;
const DIV_CPIF: u32 = 0x0600;
const ENABLE_SCLK_CPIF: u32 = 0x0a00;

static u32 cpif_clk_regs[]  = {
	MPHY_PLL_LOCK,
	MPHY_PLL_CON0,
	MPHY_PLL_CON1,
	MPHY_PLL_FREQ_DET,
...
static struct samsung_clk_reg_dump cpif_suspend_regs[] = {
...
static struct samsung_cmu_info cpif_cmu_info  = {
...
static unsafe fn exynos5433_cmu_cpif_init(struct device_node *np)
{
 ...
 */
const MEM0_PLL_LOCK: u32 = 0x0000;
const MEM1_PLL_LOCK: u32 = 0x0004;
const BUS_PLL_LOCK: u32 = 0x0008;
const MFC_PLL_LOCK: u32 = 0x000c;
const MEM0_PLL_CON0: u32 = 0x0100;
const MEM0_PLL_CON1: u32 = 0x0104;
const MEM0_PLL_FREQ_DET: u32 = 0x010c;
const MEM1_PLL_CON0: u32 = 0x0110;
const MEM1_PLL_CON1: u32 = 0x0114;
const MEM1_PLL_FREQ_DET: u32 = 0x011c;
const BUS_PLL_CON0: u32 = 0x0120;
const BUS_PLL_CON1: u32 = 0x0124;
const BUS_PLL_FREQ_DET: u32 = 0x012c;
const MFC_PLL_CON0: u32 = 0x0130;
const MFC_PLL_CON1: u32 = 0x0134;
const MFC_PLL_FREQ_DET: u32 = 0x013c;
const MUX_SEL_MIF0: u32 = 0x0200;
const MUX_SEL_MIF1: u32 = 0x0204;
const MUX_SEL_MIF2: u32 = 0x0208;
const MUX_SEL_MIF3: u32 = 0x020c;
const MUX_SEL_MIF4: u32 = 0x0210;
const MUX_SEL_MIF5: u32 = 0x0214;
const MUX_SEL_MIF6: u32 = 0x0218;
const MUX_SEL_MIF7: u32 = 0x021c;
const MUX_ENABLE_MIF0: u32 = 0x0300;
const MUX_ENABLE_MIF1: u32 = 0x0304;
const MUX_ENABLE_MIF2: u32 = 0x0308;
const MUX_ENABLE_MIF3: u32 = 0x030c;
const MUX_ENABLE_MIF4: u32 = 0x0310;
const MUX_ENABLE_MIF5: u32 = 0x0314;
const MUX_ENABLE_MIF6: u32 = 0x0318;
const MUX_ENABLE_MIF7: u32 = 0x031c;
const MUX_STAT_MIF0: u32 = 0x0400;
const MUX_STAT_MIF1: u32 = 0x0404;
const MUX_STAT_MIF2: u32 = 0x0408;
const MUX_STAT_MIF3: u32 = 0x040c;
const MUX_STAT_MIF4: u32 = 0x0410;
const MUX_STAT_MIF5: u32 = 0x0414;
const MUX_STAT_MIF6: u32 = 0x0418;
const MUX_STAT_MIF7: u32 = 0x041c;
const DIV_MIF1: u32 = 0x0604;
const DIV_MIF2: u32 = 0x0608;
const DIV_MIF3: u32 = 0x060c;
const DIV_MIF4: u32 = 0x0610;
const DIV_MIF5: u32 = 0x0614;
const DIV_MIF_PLL_FREQ_DET: u32 = 0x0618;
const DIV_STAT_MIF1: u32 = 0x0704;
const DIV_STAT_MIF2: u32 = 0x0708;
const DIV_STAT_MIF3: u32 = 0x070c;
const DIV_STAT_MIF4: u32 = 0x0710;
const DIV_STAT_MIF5: u32 = 0x0714;
const DIV_STAT_MIF_PLL_FREQ_DET: u32 = 0x0718;
const ENABLE_ACLK_MIF0: u32 = 0x0800;
const ENABLE_ACLK_MIF1: u32 = 0x0804;
const ENABLE_ACLK_MIF2: u32 = 0x0808;
const ENABLE_ACLK_MIF3: u32 = 0x080c;
const ENABLE_PCLK_MIF: u32 = 0x0900;
const ENABLE_PCLK_MIF_SECURE_DREX0_TZ: u32 = 0x0904;
const ENABLE_PCLK_MIF_SECURE_DREX1_TZ: u32 = 0x0908;
const ENABLE_PCLK_MIF_SECURE_MONOTONIC_CNT: u32 = 0x090c;
const ENABLE_PCLK_MIF_SECURE_RTC: u32 = 0x0910;
const ENABLE_SCLK_MIF: u32 = 0x0a00;
const ENABLE_IP_MIF0: u32 = 0x0b00;
const ENABLE_IP_MIF1: u32 = 0x0b04;
const ENABLE_IP_MIF2: u32 = 0x0b08;
const ENABLE_IP_MIF3: u32 = 0x0b0c;
const ENABLE_IP_MIF_SECURE_DREX0_TZ: u32 = 0x0b10;
const ENABLE_IP_MIF_SECURE_DREX1_TZ: u32 = 0x0b14;
const ENABLE_IP_MIF_SECURE_MONOTONIC_CNT: u32 = 0x0b18;
const ENABLE_IP_MIF_SECURE_RTC: u32 = 0x0b1c;
const CLKOUT_CMU_MIF: u32 = 0x0c00;
const CLKOUT_CMU_MIF_DIV_STAT: u32 = 0x0c04;
const DREX_FREQ_CTRL0: u32 = 0x1000;
const DREX_FREQ_CTRL1: u32 = 0x1004;
const PAUSE: u32 = 0x1008;
const DDRPHY_LOCK_CTRL: u32 = 0x100c;

static u32 mif_clk_regs[]  = {
	MEM0_PLL_LOCK,
	MEM1_PLL_LOCK,
	BUS_PLL_LOCK,
	MFC_PLL_LOCK,
...
static struct samsung_pll_clock mif_pll_clks[]  = {
...
static struct samsung_fixed_factor_clock mif_fixed_factor_clks[]  = {
...
static struct samsung_mux_clock mif_mux_clks[]  = {
	/* MUX_SEL_MIF0 */
...
static struct samsung_div_clock mif_div_clks[]  = {
	/* DIV_MIF1 */
...
static struct samsung_gate_clock mif_gate_clks[]  = {
	/* ENABLE_ACLK_MIF0 */
...
static struct samsung_cmu_info mif_cmu_info  = {
...
static unsafe fn exynos5433_cmu_mif_init(struct device_node *np)
{
 ...
 */
const DIV_PERIC: u32 = 0x0600;
const DIV_STAT_PERIC: u32 = 0x0700;
const ENABLE_ACLK_PERIC: u32 = 0x0800;
const ENABLE_PCLK_PERIC0: u32 = 0x0900;
const ENABLE_PCLK_PERIC1: u32 = 0x0904;
const ENABLE_SCLK_PERIC: u32 = 0x0A00;
const ENABLE_IP_PERIC0: u32 = 0x0B00;
const ENABLE_IP_PERIC1: u32 = 0x0B04;
const ENABLE_IP_PERIC2: u32 = 0x0B08;

static u32 peric_clk_regs[]  = {
	DIV_PERIC,
	ENABLE_ACLK_PERIC,
	ENABLE_PCLK_PERIC0,
	ENABLE_PCLK_PERIC1,
...
static struct samsung_clk_reg_dump peric_suspend_regs[] = {
...
static struct samsung_cmu_info peric_cmu_info  = {
...
static unsafe fn exynos5433_cmu_peric_init(struct device_node *np)
{
 ...
 */
const ENABLE_ACLK_PERIS: u32 = 0x0800;
const ENABLE_PCLK_PERIS: u32 = 0x0900;
const ENABLE_PCLK_PERIS_SECURE_TZPC: u32 = 0x0904;
const ENABLE_PCLK_PERIS_SECURE_SECKEY_APBIF: u32 = 0x0908;
const ENABLE_PCLK_PERIS_SECURE_CHIPID_APBIF: u32 = 0x090c;
const ENABLE_PCLK_PERIS_SECURE_TOPRTC: u32 = 0x0910;
const ENABLE_PCLK_PERIS_SECURE_CUSTOM_EFUSE_APBIF: u32 = 0x0914;
const ENABLE_PCLK_PERIS_SECURE_ANTIRBK_CNT_APBIF: u32 = 0x0918;
const ENABLE_PCLK_PERIS_SECURE_OTP_CON_APBIF: u32 = 0x091c;
const ENABLE_SCLK_PERIS: u32 = 0x0a00;
const ENABLE_SCLK_PERIS_SECURE_SECKEY: u32 = 0x0a04;
const ENABLE_SCLK_PERIS_SECURE_CHIPID: u32 = 0x0a08;
const ENABLE_SCLK_PERIS_SECURE_TOPRTC: u32 = 0x0a0c;
const ENABLE_SCLK_PERIS_SECURE_CUSTOM_EFUSE: u32 = 0x0a10;
const ENABLE_SCLK_PERIS_SECURE_ANTIRBK_CNT: u32 = 0x0a14;
const ENABLE_SCLK_PERIS_SECURE_OTP_CON: u32 = 0x0a18;
const ENABLE_IP_PERIS0: u32 = 0x0b00;
const ENABLE_IP_PERIS1: u32 = 0x0b04;
const ENABLE_IP_PERIS_SECURE_TZPC: u32 = 0x0b08;
const ENABLE_IP_PERIS_SECURE_SECKEY: u32 = 0x0b0c;
const ENABLE_IP_PERIS_SECURE_CHIPID: u32 = 0x0b10;
const ENABLE_IP_PERIS_SECURE_TOPRTC: u32 = 0x0b14;
const ENABLE_IP_PERIS_SECURE_CUSTOM_EFUSE: u32 = 0x0b18;
const ENABLE_IP_PERIS_SECURE_ANTIBRK_CNT: u32 = 0x0b1c;
const ENABLE_IP_PERIS_SECURE_OTP_CON: u32 = 0x0b20;

static u32 peris_clk_regs[]  = {
	ENABLE_ACLK_PERIS,
	ENABLE_PCLK_PERIS,
...
static struct samsung_gate_clock peris_gate_clks[]  = {
	/* ENABLE_ACLK_PERIS */
...
static struct samsung_cmu_info peris_cmu_info  = {
...
static unsafe fn exynos5433_cmu_peris_init(struct device_node *np)
{
 ...
 */
const MUX_SEL_FSYS0: u32 = 0x0200;
const MUX_SEL_FSYS1: u32 = 0x0204;
const MUX_SEL_FSYS2: u32 = 0x0208;
const MUX_SEL_FSYS3: u32 = 0x020c;
const MUX_SEL_FSYS4: u32 = 0x0210;
const MUX_ENABLE_FSYS0: u32 = 0x0300;
const MUX_ENABLE_FSYS1: u32 = 0x0304;
const MUX_ENABLE_FSYS2: u32 = 0x0308;
const MUX_ENABLE_FSYS3: u32 = 0x030c;
const MUX_ENABLE_FSYS4: u32 = 0x0310;
const MUX_STAT_FSYS0: u32 = 0x0400;
const MUX_STAT_FSYS1: u32 = 0x0404;
const MUX_STAT_FSYS2: u32 = 0x0408;
const MUX_STAT_FSYS3: u32 = 0x040c;
const MUX_STAT_FSYS4: u32 = 0x0410;
const MUX_IGNORE_FSYS2: u32 = 0x0508;
const MUX_IGNORE_FSYS3: u32 = 0x050c;
const ENABLE_ACLK_FSYS0: u32 = 0x0800;
const ENABLE_ACLK_FSYS1: u32 = 0x0804;
const ENABLE_PCLK_FSYS: u32 = 0x0900;
const ENABLE_SCLK_FSYS: u32 = 0x0a00;
const ENABLE_IP_FSYS0: u32 = 0x0b00;
const ENABLE_IP_FSYS1: u32 = 0x0b04;
...
static struct samsung_clk_reg_dump fsys_suspend_regs[] = {
	{ MUX_SEL_FSYS0, 0 },
	{ MUX_SEL_FSYS1, 0 },
	{ MUX_SEL_FSYS2, 0 },
	{ MUX_SEL_FSYS3, 0 },
...
static struct samsung_fixed_rate_clock fsys_fixed_clks[]  = {
...
static struct samsung_mux_clock fsys_mux_clks[]  = {
	/* MUX_SEL_FSYS0 */
...
static struct samsung_gate_clock fsys_gate_clks[]  = {
	/* ENABLE_ACLK_FSYS0 */
...
static struct samsung_cmu_info fsys_cmu_info  = {
 ...
 */
const MUX_SEL_G2D0: u32 = 0x0200;
const MUX_SEL_ENABLE_G2D0: u32 = 0x0300;
const MUX_SEL_STAT_G2D0: u32 = 0x0400;
const DIV_G2D: u32 = 0x0600;
const DIV_STAT_G2D: u32 = 0x0700;
const DIV_ENABLE_ACLK_G2D: u32 = 0x0800;
const DIV_ENABLE_ACLK_G2D_SECURE_SMMU_G2D: u32 = 0x0804;
const DIV_ENABLE_PCLK_G2D: u32 = 0x0900;
const DIV_ENABLE_PCLK_G2D_SECURE_SMMU_G2D: u32 = 0x0904;
const DIV_ENABLE_IP_G2D0: u32 = 0x0b00;
const DIV_ENABLE_IP_G2D1: u32 = 0x0b04;
const DIV_ENABLE_IP_G2D_SECURE_SMMU_G2D: u32 = 0x0b08;

static u32 g2d_clk_regs[]  = {
	MUX_SEL_G2D0,
	MUX_SEL_ENABLE_G2D0,
	DIV_G2D,
	DIV_ENABLE_ACLK_G2D,
...
static struct samsung_clk_reg_dump g2d_suspend_regs[] = {
	{ MUX_SEL_G2D0, 0 },
};
...
static struct samsung_mux_clock g2d_mux_clks[]  = {
	/* MUX_SEL_G2D0 */
...
static struct samsung_div_clock g2d_div_clks[]  = {
	/* DIV_G2D */
	DIV(CLK_DIV_PCLK_G2D, "div_pclk_g2d", "mout_aclk_g2d_266_user",
			DIV_G2D, 0, 2),
};

static struct samsung_gate_clock g2d_gate_clks[]  = {
	/* DIV_ENABLE_ACLK_G2D */
...
static struct samsung_cmu_info g2d_cmu_info  = {
 ...
 */
const DISP_PLL_LOCK: u32 = 0x0000;
const DISP_PLL_CON0: u32 = 0x0100;
const DISP_PLL_CON1: u32 = 0x0104;
const DISP_PLL_FREQ_DET: u32 = 0x0108;
const MUX_SEL_DISP0: u32 = 0x0200;
const MUX_SEL_DISP1: u32 = 0x0204;
const MUX_SEL_DISP2: u32 = 0x0208;
const MUX_SEL_DISP3: u32 = 0x020c;
const MUX_SEL_DISP4: u32 = 0x0210;
const MUX_ENABLE_DISP0: u32 = 0x0300;
const MUX_ENABLE_DISP1: u32 = 0x0304;
const MUX_ENABLE_DISP2: u32 = 0x0308;
const MUX_ENABLE_DISP3: u32 = 0x030c;
const MUX_ENABLE_DISP4: u32 = 0x0310;
const MUX_STAT_DISP0: u32 = 0x0400;
const MUX_STAT_DISP1: u32 = 0x0404;
const MUX_STAT_DISP2: u32 = 0x0408;
const MUX_STAT_DISP3: u32 = 0x040c;
const MUX_STAT_DISP4: u32 = 0x0410;
const MUX_IGNORE_DISP2: u32 = 0x0508;
const DIV_DISP: u32 = 0x0600;
const DIV_DISP_PLL_FREQ_DET: u32 = 0x0604;
const DIV_STAT_DISP: u32 = 0x0700;
const DIV_STAT_DISP_PLL_FREQ_DET: u32 = 0x0704;
const ENABLE_ACLK_DISP0: u32 = 0x0800;
const ENABLE_ACLK_DISP1: u32 = 0x0804;
const ENABLE_PCLK_DISP: u32 = 0x0900;
const ENABLE_SCLK_DISP: u32 = 0x0a00;
const ENABLE_IP_DISP0: u32 = 0x0b00;
const ENABLE_IP_DISP1: u32 = 0x0b04;
const CLKOUT_CMU_DISP: u32 = 0x0c00;
const CLKOUT_CMU_DISP_DIV_STAT: u32 = 0x0c04;

static u32 disp_clk_regs[]  = {
	DISP_PLL_LOCK,
	DISP_PLL_CON0,
	DISP_PLL_CON1,
	DISP_PLL_FREQ_DET,
...
static struct samsung_clk_reg_dump disp_suspend_regs[] = {
...
static struct samsung_pll_clock disp_pll_clks[]  = {
	PLL(pll_35xx, CLK_FOUT_DISP_PLL, "fout_disp_pll", "oscclk",
		DISP_PLL_LOCK, DISP_PLL_CON0, exynos5433_pll_rates),
};

static struct samsung_fixed_factor_clock disp_fixed_factor_clks[]  = {
	/*
...
static struct samsung_fixed_rate_clock disp_fixed_clks[]  = {
...
static struct samsung_mux_clock disp_mux_clks[]  = {
	/* MUX_SEL_DISP0 */
...
static struct samsung_div_clock disp_div_clks[]  = {
	/* DIV_DISP */
...
static struct samsung_gate_clock disp_gate_clks[]  = {
	/* ENABLE_ACLK_DISP0 */
...
static struct samsung_cmu_info disp_cmu_info  = {
 ...
 */
const MUX_SEL_AUD0: u32 = 0x0200;
const MUX_SEL_AUD1: u32 = 0x0204;
const MUX_ENABLE_AUD0: u32 = 0x0300;
const MUX_ENABLE_AUD1: u32 = 0x0304;
const MUX_STAT_AUD0: u32 = 0x0400;
const DIV_AUD0: u32 = 0x0600;
const DIV_AUD1: u32 = 0x0604;
const DIV_STAT_AUD0: u32 = 0x0700;
const DIV_STAT_AUD1: u32 = 0x0704;
const ENABLE_ACLK_AUD: u32 = 0x0800;
const ENABLE_PCLK_AUD: u32 = 0x0900;
const ENABLE_SCLK_AUD0: u32 = 0x0a00;
const ENABLE_SCLK_AUD1: u32 = 0x0a04;
const ENABLE_IP_AUD0: u32 = 0x0b00;
const ENABLE_IP_AUD1: u32 = 0x0b04;
...
static struct samsung_clk_reg_dump aud_suspend_regs[] = {
	{ MUX_SEL_AUD0, 0 },
	{ MUX_SEL_AUD1, 0 },
};
 ...
 */
const DIV_BUS: u32 = 0x0600;
const DIV_STAT_BUS: u32 = 0x0700;
const ENABLE_ACLK_BUS: u32 = 0x0800;
const ENABLE_PCLK_BUS: u32 = 0x0900;
const ENABLE_IP_BUS0: u32 = 0x0b00;
const ENABLE_IP_BUS1: u32 = 0x0b04;

const MUX_SEL_BUS2: u32 = 0x0200	/* Only for CMU_BUS2 */;
const MUX_ENABLE_BUS2: u32 = 0x0300	/* Only for CMU_BUS2 */;
const MUX_STAT_BUS2: u32 = 0x0400	/* Only for CMU_BUS2 */;

/* list of all parent clock list */
PNAME(mout_aclk_bus2_400_p)	= { "oscclk", "aclk_bus2_400", };

const CMU_BUS_COMMON_CLK_REGS: u32 = \;
	DIV_BUS,		\
	ENABLE_ACLK_BUS,	\
	ENABLE_PCLK_BUS,	\
	ENABLE_IP_BUS0,		\
...
static u32 bus01_clk_regs[]  = {
	CMU_BUS_COMMON_CLK_REGS,
};

static u32 bus2_clk_regs[]  = {
	MUX_SEL_BUS2,
	MUX_ENABLE_BUS2,
	CMU_BUS_COMMON_CLK_REGS,
};

static struct samsung_div_clock bus0_div_clks[]  = {
	/* DIV_BUS0 */
...
/* CMU_BUS0 clocks */
static struct samsung_gate_clock bus0_gate_clks[]  = {
	/* ENABLE_ACLK_BUS0 */
...
/* CMU_BUS1 clocks */
static struct samsung_div_clock bus1_div_clks[]  = {
	/* DIV_BUS1 */
	DIV(CLK_DIV_PCLK_BUS_133, "div_pclk_bus1_133", "aclk_bus1_400",
			DIV_BUS, 0, 3),
};

static struct samsung_gate_clock bus1_gate_clks[]  = {
	/* ENABLE_ACLK_BUS1 */
...
static struct samsung_cmu_info bus0_cmu_info  = {
	CMU_BUS_INFO_CLKS(0),
	.clk_regs		= bus01_clk_regs,
	.nr_clk_regs		= ARRAY_SIZE(bus01_clk_regs),
};

static struct samsung_cmu_info bus1_cmu_info  = {
	CMU_BUS_INFO_CLKS(1),
	.clk_regs		= bus01_clk_regs,
	.nr_clk_regs		= ARRAY_SIZE(bus01_clk_regs),
};

static struct samsung_cmu_info bus2_cmu_info  = {
	CMU_BUS_INFO_CLKS(2),
...
static unsafe fn exynos5433_cmu_bus##id##_init(struct device_node *np)\
{									\
 ...
 */
const G3D_PLL_LOCK: u32 = 0x0000;
const G3D_PLL_CON0: u32 = 0x0100;
const G3D_PLL_CON1: u32 = 0x0104;
const G3D_PLL_FREQ_DET: u32 = 0x010c;
const MUX_SEL_G3D: u32 = 0x0200;
const MUX_ENABLE_G3D: u32 = 0x0300;
const MUX_STAT_G3D: u32 = 0x0400;
const DIV_G3D: u32 = 0x0600;
const DIV_G3D_PLL_FREQ_DET: u32 = 0x0604;
const DIV_STAT_G3D: u32 = 0x0700;
const DIV_STAT_G3D_PLL_FREQ_DET: u32 = 0x0704;
const ENABLE_ACLK_G3D: u32 = 0x0800;
const ENABLE_PCLK_G3D: u32 = 0x0900;
const ENABLE_SCLK_G3D: u32 = 0x0a00;
const ENABLE_IP_G3D0: u32 = 0x0b00;
const ENABLE_IP_G3D1: u32 = 0x0b04;
const CLKOUT_CMU_G3D: u32 = 0x0c00;
const CLKOUT_CMU_G3D_DIV_STAT: u32 = 0x0c04;
const CLK_STOPCTRL: u32 = 0x1000;
...
static struct samsung_clk_reg_dump g3d_suspend_regs[] = {
	{ MUX_SEL_G3D, 0 },
};
 ...
 */
const MUX_SEL_GSCL: u32 = 0x0200;
const MUX_ENABLE_GSCL: u32 = 0x0300;
const MUX_STAT_GSCL: u32 = 0x0400;
const ENABLE_ACLK_GSCL: u32 = 0x0800;
const ENABLE_ACLK_GSCL_SECURE_SMMU_GSCL0: u32 = 0x0804;
const ENABLE_ACLK_GSCL_SECURE_SMMU_GSCL1: u32 = 0x0808;
const ENABLE_ACLK_GSCL_SECURE_SMMU_GSCL2: u32 = 0x080c;
const ENABLE_PCLK_GSCL: u32 = 0x0900;
const ENABLE_PCLK_GSCL_SECURE_SMMU_GSCL0: u32 = 0x0904;
const ENABLE_PCLK_GSCL_SECURE_SMMU_GSCL1: u32 = 0x0908;
const ENABLE_PCLK_GSCL_SECURE_SMMU_GSCL2: u32 = 0x090c;
const ENABLE_IP_GSCL0: u32 = 0x0b00;
const ENABLE_IP_GSCL1: u32 = 0x0b04;
const ENABLE_IP_GSCL_SECURE_SMMU_GSCL0: u32 = 0x0b08;
const ENABLE_IP_GSCL_SECURE_SMMU_GSCL1: u32 = 0x0b0c;
const ENABLE_IP_GSCL_SECURE_SMMU_GSCL2: u32 = 0x0b10;

static u32 gscl_clk_regs[]  = {
	MUX_SEL_GSCL,
	MUX_ENABLE_GSCL,
	ENABLE_ACLK_GSCL,
...
static struct samsung_clk_reg_dump gscl_suspend_regs[] = {
	{ MUX_SEL_GSCL, 0 },
...
static struct samsung_mux_clock gscl_mux_clks[]  = {
	/* MUX_SEL_GSCL */
...
static struct samsung_gate_clock gscl_gate_clks[]  = {
	/* ENABLE_ACLK_GSCL */
...
static struct samsung_cmu_info gscl_cmu_info  = {
 ...
 */
const APOLLO_PLL_LOCK: u32 = 0x0000;
const APOLLO_PLL_CON0: u32 = 0x0100;
const APOLLO_PLL_CON1: u32 = 0x0104;
const APOLLO_PLL_FREQ_DET: u32 = 0x010c;
const MUX_SEL_APOLLO0: u32 = 0x0200;
const MUX_SEL_APOLLO1: u32 = 0x0204;
const MUX_SEL_APOLLO2: u32 = 0x0208;
const MUX_ENABLE_APOLLO0: u32 = 0x0300;
const MUX_ENABLE_APOLLO1: u32 = 0x0304;
const MUX_ENABLE_APOLLO2: u32 = 0x0308;
const MUX_STAT_APOLLO0: u32 = 0x0400;
const MUX_STAT_APOLLO1: u32 = 0x0404;
const MUX_STAT_APOLLO2: u32 = 0x0408;
const DIV_APOLLO0: u32 = 0x0600;
const DIV_APOLLO1: u32 = 0x0604;
const DIV_APOLLO_PLL_FREQ_DET: u32 = 0x0608;
const DIV_STAT_APOLLO0: u32 = 0x0700;
const DIV_STAT_APOLLO1: u32 = 0x0704;
const DIV_STAT_APOLLO_PLL_FREQ_DET: u32 = 0x0708;
const ENABLE_ACLK_APOLLO: u32 = 0x0800;
const ENABLE_PCLK_APOLLO: u32 = 0x0900;
const ENABLE_SCLK_APOLLO: u32 = 0x0a00;
const ENABLE_IP_APOLLO0: u32 = 0x0b00;
const ENABLE_IP_APOLLO1: u32 = 0x0b04;
const CLKOUT_CMU_APOLLO: u32 = 0x0c00;
const CLKOUT_CMU_APOLLO_DIV_STAT: u32 = 0x0c04;
const ARMCLK_STOPCTRL: u32 = 0x1000;
const APOLLO_PWR_CTRL: u32 = 0x1020;
const APOLLO_PWR_CTRL2: u32 = 0x1024;
const APOLLO_INTR_SPREAD_ENABLE: u32 = 0x1080;
const APOLLO_INTR_SPREAD_USE_STANDBYWFI: u32 = 0x1084;
const APOLLO_INTR_SPREAD_BLOCKING_DURATION: u32 = 0x1088;

static u32 apollo_clk_regs[]  = {
	APOLLO_PLL_LOCK,
	APOLLO_PLL_CON0,
	APOLLO_PLL_CON1,
	APOLLO_PLL_FREQ_DET,
...
static struct samsung_div_clock apollo_div_clks[]  = {
	/* DIV_APOLLO0 */
...
static struct samsung_gate_clock apollo_gate_clks[]  = {
	/* ENABLE_ACLK_APOLLO */
...
static struct exynos_cpuclk_cfg_data exynos5433_apolloclk_d[]  = {
...
static struct samsung_cpu_clock apollo_cpu_clks[]  = {
...
static struct samsung_cmu_info apollo_cmu_info  = {
...
static unsafe fn exynos5433_cmu_apollo_init(struct device_node *np)
{
 ...
 */
const ATLAS_PLL_LOCK: u32 = 0x0000;
const ATLAS_PLL_CON0: u32 = 0x0100;
const ATLAS_PLL_CON1: u32 = 0x0104;
const ATLAS_PLL_FREQ_DET: u32 = 0x010c;
const MUX_SEL_ATLAS0: u32 = 0x0200;
const MUX_SEL_ATLAS1: u32 = 0x0204;
const MUX_SEL_ATLAS2: u32 = 0x0208;
const MUX_ENABLE_ATLAS0: u32 = 0x0300;
const MUX_ENABLE_ATLAS1: u32 = 0x0304;
const MUX_ENABLE_ATLAS2: u32 = 0x0308;
const MUX_STAT_ATLAS0: u32 = 0x0400;
const MUX_STAT_ATLAS1: u32 = 0x0404;
const MUX_STAT_ATLAS2: u32 = 0x0408;
const DIV_ATLAS0: u32 = 0x0600;
const DIV_ATLAS1: u32 = 0x0604;
const DIV_ATLAS_PLL_FREQ_DET: u32 = 0x0608;
const DIV_STAT_ATLAS0: u32 = 0x0700;
const DIV_STAT_ATLAS1: u32 = 0x0704;
const DIV_STAT_ATLAS_PLL_FREQ_DET: u32 = 0x0708;
const ENABLE_ACLK_ATLAS: u32 = 0x0800;
const ENABLE_PCLK_ATLAS: u32 = 0x0900;
const ENABLE_SCLK_ATLAS: u32 = 0x0a00;
const ENABLE_IP_ATLAS0: u32 = 0x0b00;
const ENABLE_IP_ATLAS1: u32 = 0x0b04;
const CLKOUT_CMU_ATLAS: u32 = 0x0c00;
const CLKOUT_CMU_ATLAS_DIV_STAT: u32 = 0x0c04;
const ARMCLK_STOPCTRL: u32 = 0x1000;
const ATLAS_PWR_CTRL: u32 = 0x1020;
const ATLAS_PWR_CTRL2: u32 = 0x1024;
const ATLAS_INTR_SPREAD_ENABLE: u32 = 0x1080;
const ATLAS_INTR_SPREAD_USE_STANDBYWFI: u32 = 0x1084;
const ATLAS_INTR_SPREAD_BLOCKING_DURATION: u32 = 0x1088;

static u32 atlas_clk_regs[]  = {
	ATLAS_PLL_LOCK,
	ATLAS_PLL_CON0,
	ATLAS_PLL_CON1,
	ATLAS_PLL_FREQ_DET,
...
static struct samsung_mux_clock atlas_mux_clks[]  = {
	/* MUX_SEL_ATLAS0 */
...
static struct samsung_div_clock atlas_div_clks[]  = {
	/* DIV_ATLAS0 */
...
static struct samsung_gate_clock atlas_gate_clks[]  = {
	/* ENABLE_ACLK_ATLAS */
...
static struct exynos_cpuclk_cfg_data exynos5433_atlasclk_d[]  = {
...
static struct samsung_cpu_clock atlas_cpu_clks[]  = {
...
static struct samsung_cmu_info atlas_cmu_info  = {
...
static unsafe fn exynos5433_cmu_atlas_init(struct device_node *np)
{
 ...
 */
const MUX_SEL_MSCL0: u32 = 0x0200;
const MUX_SEL_MSCL1: u32 = 0x0204;
const MUX_ENABLE_MSCL0: u32 = 0x0300;
const MUX_ENABLE_MSCL1: u32 = 0x0304;
const MUX_STAT_MSCL0: u32 = 0x0400;
const MUX_STAT_MSCL1: u32 = 0x0404;
const DIV_MSCL: u32 = 0x0600;
const DIV_STAT_MSCL: u32 = 0x0700;
const ENABLE_ACLK_MSCL: u32 = 0x0800;
const ENABLE_ACLK_MSCL_SECURE_SMMU_M2MSCALER0: u32 = 0x0804;
const ENABLE_ACLK_MSCL_SECURE_SMMU_M2MSCALER1: u32 = 0x0808;
const ENABLE_ACLK_MSCL_SECURE_SMMU_JPEG: u32 = 0x080c;
const ENABLE_PCLK_MSCL: u32 = 0x0900;
const ENABLE_PCLK_MSCL_SECURE_SMMU_M2MSCALER0: u32 = 0x0904;
const ENABLE_PCLK_MSCL_SECURE_SMMU_M2MSCALER1: u32 = 0x0908;
const ENABLE_PCLK_MSCL_SECURE_SMMU_JPEG: u32 = 0x090c;
const ENABLE_SCLK_MSCL: u32 = 0x0a00;
const ENABLE_IP_MSCL0: u32 = 0x0b00;
const ENABLE_IP_MSCL1: u32 = 0x0b04;
const ENABLE_IP_MSCL_SECURE_SMMU_M2MSCALER0: u32 = 0x0b08;
const ENABLE_IP_MSCL_SECURE_SMMU_M2MSCALER1: u32 = 0x0b0c;
const ENABLE_IP_MSCL_SECURE_SMMU_JPEG: u32 = 0x0b10;

static u32 mscl_clk_regs[]  = {
	MUX_SEL_MSCL0,
	MUX_SEL_MSCL1,
	MUX_ENABLE_MSCL0,
	MUX_ENABLE_MSCL1,
...
static struct samsung_clk_reg_dump mscl_suspend_regs[] = {
	{ MUX_SEL_MSCL0, 0 },
	{ MUX_SEL_MSCL1, 0 },
};
...
static struct samsung_mux_clock mscl_mux_clks[]  = {
	/* MUX_SEL_MSCL0 */
...
static struct samsung_div_clock mscl_div_clks[]  = {
	/* DIV_MSCL */
	DIV(CLK_DIV_PCLK_MSCL, "div_pclk_mscl", "mout_aclk_mscl_400_user",
			DIV_MSCL, 0, 3),
};

static struct samsung_gate_clock mscl_gate_clks[]  = {
	/* ENABLE_ACLK_MSCL */
...
static struct samsung_cmu_info mscl_cmu_info  = {
 ...
 */
const MUX_SEL_MFC: u32 = 0x0200;
const MUX_ENABLE_MFC: u32 = 0x0300;
const MUX_STAT_MFC: u32 = 0x0400;
const DIV_MFC: u32 = 0x0600;
const DIV_STAT_MFC: u32 = 0x0700;
const ENABLE_ACLK_MFC: u32 = 0x0800;
const ENABLE_ACLK_MFC_SECURE_SMMU_MFC: u32 = 0x0804;
const ENABLE_PCLK_MFC: u32 = 0x0900;
const ENABLE_PCLK_MFC_SECURE_SMMU_MFC: u32 = 0x0904;
const ENABLE_IP_MFC0: u32 = 0x0b00;
const ENABLE_IP_MFC1: u32 = 0x0b04;
const ENABLE_IP_MFC_SECURE_SMMU_MFC: u32 = 0x0b08;

static u32 mfc_clk_regs[]  = {
	MUX_SEL_MFC,
	MUX_ENABLE_MFC,
	DIV_MFC,
	ENABLE_ACLK_MFC,
...
static struct samsung_clk_reg_dump mfc_suspend_regs[] = {
	{ MUX_SEL_MFC, 0 },
};

PNAME(mout_aclk_mfc_400_user_p)		= { "oscclk", "aclk_mfc_400", };

static struct samsung_mux_clock mfc_mux_clks[]  = {
	/* MUX_SEL_MFC */
	MUX(CLK_MOUT_ACLK_MFC_400_USER, "mout_aclk_mfc_400_user",
			mout_aclk_mfc_400_user_p, MUX_SEL_MFC, 0, 0),
};

static struct samsung_div_clock mfc_div_clks[]  = {
	/* DIV_MFC */
	DIV(CLK_DIV_PCLK_MFC, "div_pclk_mfc", "mout_aclk_mfc_400_user",
			DIV_MFC, 0, 2),
};

static struct samsung_gate_clock mfc_gate_clks[]  = {
	/* ENABLE_ACLK_MFC */
...
static struct samsung_cmu_info mfc_cmu_info  = {
 ...
 */
const MUX_SEL_HEVC: u32 = 0x0200;
const MUX_ENABLE_HEVC: u32 = 0x0300;
const MUX_STAT_HEVC: u32 = 0x0400;
const DIV_HEVC: u32 = 0x0600;
const DIV_STAT_HEVC: u32 = 0x0700;
const ENABLE_ACLK_HEVC: u32 = 0x0800;
const ENABLE_ACLK_HEVC_SECURE_SMMU_HEVC: u32 = 0x0804;
const ENABLE_PCLK_HEVC: u32 = 0x0900;
const ENABLE_PCLK_HEVC_SECURE_SMMU_HEVC: u32 = 0x0904;
const ENABLE_IP_HEVC0: u32 = 0x0b00;
const ENABLE_IP_HEVC1: u32 = 0x0b04;
const ENABLE_IP_HEVC_SECURE_SMMU_HEVC: u32 = 0x0b08;

static u32 hevc_clk_regs[]  = {
	MUX_SEL_HEVC,
	MUX_ENABLE_HEVC,
	DIV_HEVC,
	ENABLE_ACLK_HEVC,
...
static struct samsung_clk_reg_dump hevc_suspend_regs[] = {
	{ MUX_SEL_HEVC, 0 },
};

PNAME(mout_aclk_hevc_400_user_p)	= { "oscclk", "aclk_hevc_400", };

static struct samsung_mux_clock hevc_mux_clks[]  = {
	/* MUX_SEL_HEVC */
	MUX(CLK_MOUT_ACLK_HEVC_400_USER, "mout_aclk_hevc_400_user",
			mout_aclk_hevc_400_user_p, MUX_SEL_HEVC, 0, 0),
};

static struct samsung_div_clock hevc_div_clks[]  = {
	/* DIV_HEVC */
	DIV(CLK_DIV_PCLK_HEVC, "div_pclk_hevc", "mout_aclk_hevc_400_user",
			DIV_HEVC, 0, 2),
};

static struct samsung_gate_clock hevc_gate_clks[]  = {
	/* ENABLE_ACLK_HEVC */
...
static struct samsung_cmu_info hevc_cmu_info  = {
 ...
 */
const MUX_SEL_ISP: u32 = 0x0200;
const MUX_ENABLE_ISP: u32 = 0x0300;
const MUX_STAT_ISP: u32 = 0x0400;
const DIV_ISP: u32 = 0x0600;
const DIV_STAT_ISP: u32 = 0x0700;
const ENABLE_ACLK_ISP0: u32 = 0x0800;
const ENABLE_ACLK_ISP1: u32 = 0x0804;
const ENABLE_ACLK_ISP2: u32 = 0x0808;
const ENABLE_PCLK_ISP: u32 = 0x0900;
const ENABLE_SCLK_ISP: u32 = 0x0a00;
const ENABLE_IP_ISP0: u32 = 0x0b00;
const ENABLE_IP_ISP1: u32 = 0x0b04;
const ENABLE_IP_ISP2: u32 = 0x0b08;
const ENABLE_IP_ISP3: u32 = 0x0b0c;

static u32 isp_clk_regs[]  = {
	MUX_SEL_ISP,
	MUX_ENABLE_ISP,
	DIV_ISP,
	ENABLE_ACLK_ISP0,
...
static struct samsung_clk_reg_dump isp_suspend_regs[] = {
	{ MUX_SEL_ISP, 0 },
};
...
static struct samsung_div_clock isp_div_clks[]  = {
	/* DIV_ISP */
...
static struct samsung_gate_clock isp_gate_clks[]  = {
	/* ENABLE_ACLK_ISP0 */
...
static struct samsung_cmu_info isp_cmu_info  = {
 ...
 */
const MUX_SEL_CAM00: u32 = 0x0200;
const MUX_SEL_CAM01: u32 = 0x0204;
const MUX_SEL_CAM02: u32 = 0x0208;
const MUX_SEL_CAM03: u32 = 0x020c;
const MUX_SEL_CAM04: u32 = 0x0210;
const MUX_ENABLE_CAM00: u32 = 0x0300;
const MUX_ENABLE_CAM01: u32 = 0x0304;
const MUX_ENABLE_CAM02: u32 = 0x0308;
const MUX_ENABLE_CAM03: u32 = 0x030c;
const MUX_ENABLE_CAM04: u32 = 0x0310;
const MUX_STAT_CAM00: u32 = 0x0400;
const MUX_STAT_CAM01: u32 = 0x0404;
const MUX_STAT_CAM02: u32 = 0x0408;
const MUX_STAT_CAM03: u32 = 0x040c;
const MUX_STAT_CAM04: u32 = 0x0410;
const MUX_IGNORE_CAM01: u32 = 0x0504;
const DIV_CAM00: u32 = 0x0600;
const DIV_CAM01: u32 = 0x0604;
const DIV_CAM02: u32 = 0x0608;
const DIV_CAM03: u32 = 0x060c;
const DIV_STAT_CAM00: u32 = 0x0700;
const DIV_STAT_CAM01: u32 = 0x0704;
const DIV_STAT_CAM02: u32 = 0x0708;
const DIV_STAT_CAM03: u32 = 0x070c;
const ENABLE_ACLK_CAM00: u32 = 0X0800;
const ENABLE_ACLK_CAM01: u32 = 0X0804;
const ENABLE_ACLK_CAM02: u32 = 0X0808;
const ENABLE_PCLK_CAM0: u32 = 0X0900;
const ENABLE_SCLK_CAM0: u32 = 0X0a00;
const ENABLE_IP_CAM00: u32 = 0X0b00;
const ENABLE_IP_CAM01: u32 = 0X0b04;
const ENABLE_IP_CAM02: u32 = 0X0b08;
const ENABLE_IP_CAM03: u32 = 0X0b0C;

static u32 cam0_clk_regs[]  = {
	MUX_SEL_CAM00,
	MUX_SEL_CAM01,
	MUX_SEL_CAM02,
	MUX_SEL_CAM03,
...
static struct samsung_clk_reg_dump cam0_suspend_regs[] = {
	{ MUX_SEL_CAM00, 0 },
	{ MUX_SEL_CAM01, 0 },
	{ MUX_SEL_CAM02, 0 },
	{ MUX_SEL_CAM03, 0 },
...
static struct samsung_fixed_rate_clock cam0_fixed_clks[]  = {
...
static struct samsung_mux_clock cam0_mux_clks[]  = {
	/* MUX_SEL_CAM00 */
...
static struct samsung_div_clock cam0_div_clks[]  = {
	/* DIV_CAM00 */
...
static struct samsung_gate_clock cam0_gate_clks[]  = {
	/* ENABLE_ACLK_CAM00 */
...
static struct samsung_cmu_info cam0_cmu_info  = {
 ...
 */
const MUX_SEL_CAM10: u32 = 0x0200;
const MUX_SEL_CAM11: u32 = 0x0204;
const MUX_SEL_CAM12: u32 = 0x0208;
const MUX_ENABLE_CAM10: u32 = 0x0300;
const MUX_ENABLE_CAM11: u32 = 0x0304;
const MUX_ENABLE_CAM12: u32 = 0x0308;
const MUX_STAT_CAM10: u32 = 0x0400;
const MUX_STAT_CAM11: u32 = 0x0404;
const MUX_STAT_CAM12: u32 = 0x0408;
const MUX_IGNORE_CAM11: u32 = 0x0504;
const DIV_CAM10: u32 = 0x0600;
const DIV_CAM11: u32 = 0x0604;
const DIV_STAT_CAM10: u32 = 0x0700;
const DIV_STAT_CAM11: u32 = 0x0704;
const ENABLE_ACLK_CAM10: u32 = 0X0800;
const ENABLE_ACLK_CAM11: u32 = 0X0804;
const ENABLE_ACLK_CAM12: u32 = 0X0808;
const ENABLE_PCLK_CAM1: u32 = 0X0900;
const ENABLE_SCLK_CAM1: u32 = 0X0a00;
const ENABLE_IP_CAM10: u32 = 0X0b00;
const ENABLE_IP_CAM11: u32 = 0X0b04;
const ENABLE_IP_CAM12: u32 = 0X0b08;

static u32 cam1_clk_regs[]  = {
	MUX_SEL_CAM10,
	MUX_SEL_CAM11,
	MUX_SEL_CAM12,
	MUX_ENABLE_CAM10,
...
static struct samsung_clk_reg_dump cam1_suspend_regs[] = {
	{ MUX_SEL_CAM10, 0 },
	{ MUX_SEL_CAM11, 0 },
	{ MUX_SEL_CAM12, 0 },
};
...
static struct samsung_fixed_rate_clock cam1_fixed_clks[]  = {
	FRATE(CLK_PHYCLK_RXBYTEECLKHS0_S2B, "phyclk_rxbyteclkhs0_s2b_phy", NULL,
			0, 100000000),
};

static struct samsung_mux_clock cam1_mux_clks[]  = {
	/* MUX_SEL_CAM10 */
...
static struct samsung_div_clock cam1_div_clks[]  = {
	/* DIV_CAM10 */
...
static struct samsung_gate_clock cam1_gate_clks[]  = {
	/* ENABLE_ACLK_CAM10 */
...
static struct samsung_cmu_info cam1_cmu_info  = {
 ...
 */
const ENABLE_ACLK_IMEM_SLIMSSS: u32 = 0x080c;
const ENABLE_PCLK_IMEM_SLIMSSS: u32 = 0x0908;

static u32 imem_clk_regs[]  = {
	ENABLE_ACLK_IMEM_SLIMSSS,
	ENABLE_PCLK_IMEM_SLIMSSS,
};

static struct samsung_gate_clock imem_gate_clks[]  = {
	/* ENABLE_ACLK_IMEM_SLIMSSS */
...
static struct samsung_cmu_info imem_cmu_info  = {
...
static struct of_device_id exynos5433_cmu_of_match[] = {
	{
...
static struct dev_pm_ops exynos5433_cmu_pm_ops = {
