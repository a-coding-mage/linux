...
// Faithful Rust-level translation of clk-exynos7.c.
...
// dependency: "clk.h"
// dependency: <dt-bindings/clock/exynos7-clk.h>

/* Register Offset definitions for CMU_TOPC (0x10570000) */
const CC_PLL_LOCK: u32 = 0x0000;
const BUS0_PLL_LOCK: u32 = 0x0004;
const BUS1_DPLL_LOCK: u32 = 0x0008;
const MFC_PLL_LOCK: u32 = 0x000C;
const AUD_PLL_LOCK: u32 = 0x0010;
const CC_PLL_CON0: u32 = 0x0100;
const BUS0_PLL_CON0: u32 = 0x0110;
const BUS1_DPLL_CON0: u32 = 0x0120;
const MFC_PLL_CON0: u32 = 0x0130;
const AUD_PLL_CON0: u32 = 0x0140;
const MUX_SEL_TOPC0: u32 = 0x0200;
const MUX_SEL_TOPC1: u32 = 0x0204;
const MUX_SEL_TOPC2: u32 = 0x0208;
const MUX_SEL_TOPC3: u32 = 0x020C;
const DIV_TOPC0: u32 = 0x0600;
const DIV_TOPC1: u32 = 0x0604;
const DIV_TOPC3: u32 = 0x060C;
const ENABLE_ACLK_TOPC0: u32 = 0x0800;
const ENABLE_ACLK_TOPC1: u32 = 0x0804;
const ENABLE_SCLK_TOPC1: u32 = 0x0A04;

static samsung_fixed_factor_clock topc_fixed_factor_clks[]  = {
...
static mout_topc_aud_pll_ctrl_p: &[&str] = { "fin_pll", "fout_aud_pll" };
static mout_topc_bus0_pll_ctrl_p: &[&str] = { "fin_pll", "fout_bus0_pll" };
static mout_topc_bus1_pll_ctrl_p: &[&str] = { "fin_pll", "fout_bus1_pll" };
static mout_topc_cc_pll_ctrl_p: &[&str] = { "fin_pll", "fout_cc_pll" };
static mout_topc_mfc_pll_ctrl_p: &[&str] = { "fin_pll", "fout_mfc_pll" };

static mout_topc_group2: &[&str] = { "mout_topc_bus0_pll_half",
	"mout_topc_bus1_pll_half", "mout_topc_cc_pll_half",
	"mout_topc_mfc_pll_half" };

static mout_topc_bus0_pll_half_p: &[&str] = { "mout_topc_bus0_pll",
	"ffac_topc_bus0_pll_div2", "ffac_topc_bus0_pll_div4"};
static mout_topc_bus1_pll_half_p: &[&str] = { "mout_topc_bus1_pll",
	"ffac_topc_bus1_pll_div2"};
static mout_topc_cc_pll_half_p: &[&str] = { "mout_topc_cc_pll",
	"ffac_topc_cc_pll_div2"};
static mout_topc_mfc_pll_half_p: &[&str] = { "mout_topc_mfc_pll",
	"ffac_topc_mfc_pll_div2"};


static mout_topc_bus0_pll_out_p: &[&str] = {"mout_topc_bus0_pll",
	"ffac_topc_bus0_pll_div2"};

static topc_clk_regs[]  = {
	CC_PLL_LOCK,
	BUS0_PLL_LOCK,
	BUS1_DPLL_LOCK,
	MFC_PLL_LOCK,
...
static samsung_mux_clock topc_mux_clks[]  = {
...
static samsung_div_clock topc_div_clks[]  = {
...
static samsung_pll_rate_table pll1460x_24mhz_tbl[]  = {
	pll_36xx_rate!(24 * MHZ, 491519897, 20, 1, 0, 31457),
	{},
};

static samsung_gate_clock topc_gate_clks[]  = {
...
// device-tree registration: exynos7_clk_topc, "samsung,exynos7-clock-topc",
	exynos7_clk_topc_init;

/* Register Offset definitions for CMU_TOP0 (0x105D0000) */
const MUX_SEL_TOP00: u32 = 0x0200;
const MUX_SEL_TOP01: u32 = 0x0204;
const MUX_SEL_TOP03: u32 = 0x020C;
const MUX_SEL_TOP0_PERIC0: u32 = 0x0230;
const MUX_SEL_TOP0_PERIC1: u32 = 0x0234;
const MUX_SEL_TOP0_PERIC2: u32 = 0x0238;
const MUX_SEL_TOP0_PERIC3: u32 = 0x023C;
const DIV_TOP03: u32 = 0x060C;
const DIV_TOP0_PERIC0: u32 = 0x0630;
const DIV_TOP0_PERIC1: u32 = 0x0634;
const DIV_TOP0_PERIC2: u32 = 0x0638;
const DIV_TOP0_PERIC3: u32 = 0x063C;
const ENABLE_ACLK_TOP03: u32 = 0x080C;
const ENABLE_SCLK_TOP0_PERIC0: u32 = 0x0A30;
const ENABLE_SCLK_TOP0_PERIC1: u32 = 0x0A34;
const ENABLE_SCLK_TOP0_PERIC2: u32 = 0x0A38;
const ENABLE_SCLK_TOP0_PERIC3: u32 = 0x0A3C;

/* List of parent clocks for Muxes in CMU_TOP0 */
static mout_top0_bus0_pll_user_p: &[&str] = { "fin_pll", "sclk_bus0_pll_a" };
static mout_top0_bus1_pll_user_p: &[&str] = { "fin_pll", "sclk_bus1_pll_a" };
static mout_top0_cc_pll_user_p: &[&str] = { "fin_pll", "sclk_cc_pll_a" };
static mout_top0_mfc_pll_user_p: &[&str] = { "fin_pll", "sclk_mfc_pll_a" };
static mout_top0_aud_pll_user_p: &[&str] = { "fin_pll", "sclk_aud_pll" };

static mout_top0_bus0_pll_half_p: &[&str] = {"mout_top0_bus0_pll_user",
	"ffac_top0_bus0_pll_div2"};
static mout_top0_bus1_pll_half_p: &[&str] = {"mout_top0_bus1_pll_user",
	"ffac_top0_bus1_pll_div2"};
static mout_top0_cc_pll_half_p: &[&str] = {"mout_top0_cc_pll_user",
	"ffac_top0_cc_pll_div2"};
static mout_top0_mfc_pll_half_p: &[&str] = {"mout_top0_mfc_pll_user",
	"ffac_top0_mfc_pll_div2"};

static mout_top0_group1: &[&str] = {"mout_top0_bus0_pll_half",
	"mout_top0_bus1_pll_half", "mout_top0_cc_pll_half",
	"mout_top0_mfc_pll_half"};
static mout_top0_group3: &[&str] = {"ioclk_audiocdclk0",
	"ioclk_audiocdclk1", "ioclk_spdif_extclk",
	"mout_top0_aud_pll_user", "mout_top0_bus0_pll_half",
	"mout_top0_bus1_pll_half"};
static mout_top0_group4: &[&str] = {"ioclk_audiocdclk1", "mout_top0_aud_pll_user",
	"mout_top0_bus0_pll_half", "mout_top0_bus1_pll_half"};

static top0_clk_regs[]  = {
	MUX_SEL_TOP00,
	MUX_SEL_TOP01,
	MUX_SEL_TOP03,
	MUX_SEL_TOP0_PERIC0,
...
static samsung_mux_clock top0_mux_clks[]  = {
...
static samsung_div_clock top0_div_clks[]  = {
...
static samsung_gate_clock top0_gate_clks[]  = {
...
static samsung_fixed_factor_clock top0_fixed_factor_clks[]  = {
...
// device-tree registration: exynos7_clk_top0, "samsung,exynos7-clock-top0",
	exynos7_clk_top0_init;

/* Register Offset definitions for CMU_TOP1 (0x105E0000) */
const MUX_SEL_TOP10: u32 = 0x0200;
const MUX_SEL_TOP11: u32 = 0x0204;
const MUX_SEL_TOP13: u32 = 0x020C;
const MUX_SEL_TOP1_FSYS0: u32 = 0x0224;
const MUX_SEL_TOP1_FSYS1: u32 = 0x0228;
const MUX_SEL_TOP1_FSYS11: u32 = 0x022C;
const DIV_TOP13: u32 = 0x060C;
const DIV_TOP1_FSYS0: u32 = 0x0624;
const DIV_TOP1_FSYS1: u32 = 0x0628;
const DIV_TOP1_FSYS11: u32 = 0x062C;
const ENABLE_ACLK_TOP13: u32 = 0x080C;
const ENABLE_SCLK_TOP1_FSYS0: u32 = 0x0A24;
const ENABLE_SCLK_TOP1_FSYS1: u32 = 0x0A28;
const ENABLE_SCLK_TOP1_FSYS11: u32 = 0x0A2C;

/* List of parent clocks for Muxes in CMU_TOP1 */
static mout_top1_bus0_pll_user_p: &[&str] = { "fin_pll", "sclk_bus0_pll_b" };
static mout_top1_bus1_pll_user_p: &[&str] = { "fin_pll", "sclk_bus1_pll_b" };
static mout_top1_cc_pll_user_p: &[&str] = { "fin_pll", "sclk_cc_pll_b" };
static mout_top1_mfc_pll_user_p: &[&str] = { "fin_pll", "sclk_mfc_pll_b" };

static mout_top1_bus0_pll_half_p: &[&str] = {"mout_top1_bus0_pll_user",
	"ffac_top1_bus0_pll_div2"};
static mout_top1_bus1_pll_half_p: &[&str] = {"mout_top1_bus1_pll_user",
	"ffac_top1_bus1_pll_div2"};
static mout_top1_cc_pll_half_p: &[&str] = {"mout_top1_cc_pll_user",
	"ffac_top1_cc_pll_div2"};
static mout_top1_mfc_pll_half_p: &[&str] = {"mout_top1_mfc_pll_user",
	"ffac_top1_mfc_pll_div2"};

static mout_top1_group1: &[&str] = {"mout_top1_bus0_pll_half",
	"mout_top1_bus1_pll_half", "mout_top1_cc_pll_half",
	"mout_top1_mfc_pll_half"};

static top1_clk_regs[]  = {
	MUX_SEL_TOP10,
	MUX_SEL_TOP11,
	MUX_SEL_TOP13,
	MUX_SEL_TOP1_FSYS0,
...
static samsung_mux_clock top1_mux_clks[]  = {
...
static samsung_div_clock top1_div_clks[]  = {
...
static samsung_gate_clock top1_gate_clks[]  = {
...
static samsung_fixed_factor_clock top1_fixed_factor_clks[]  = {
...
// device-tree registration: exynos7_clk_top1, "samsung,exynos7-clock-top1",
	exynos7_clk_top1_init;

/* Register Offset definitions for CMU_CCORE (0x105B0000) */
const MUX_SEL_CCORE: u32 = 0x0200;
const DIV_CCORE: u32 = 0x0600;
const ENABLE_ACLK_CCORE0: u32 = 0x0800;
const ENABLE_ACLK_CCORE1: u32 = 0x0804;
const ENABLE_PCLK_CCORE: u32 = 0x0900;

/*
 * List of parent clocks for Muxes in CMU_CCORE
 */
static mout_aclk_ccore_133_user_p: &[&str] = { "fin_pll", "aclk_ccore_133" };

static ccore_clk_regs[]  = {
	MUX_SEL_CCORE,
	ENABLE_PCLK_CCORE,
};

static samsung_mux_clock ccore_mux_clks[]  = {
	mux!(0, "mout_aclk_ccore_133_user", mout_aclk_ccore_133_user_p,
		MUX_SEL_CCORE, 1, 1),
};

static samsung_gate_clock ccore_gate_clks[]  = {
...
// device-tree registration: exynos7_clk_ccore, "samsung,exynos7-clock-ccore",
	exynos7_clk_ccore_init;

/* Register Offset definitions for CMU_PERIC0 (0x13610000) */
const MUX_SEL_PERIC0: u32 = 0x0200;
const ENABLE_PCLK_PERIC0: u32 = 0x0900;
const ENABLE_SCLK_PERIC0: u32 = 0x0A00;

/* List of parent clocks for Muxes in CMU_PERIC0 */
static mout_aclk_peric0_66_user_p: &[&str] = { "fin_pll", "aclk_peric0_66" };
static mout_sclk_uart0_user_p: &[&str] = { "fin_pll", "sclk_uart0" };

static peric0_clk_regs[]  = {
	MUX_SEL_PERIC0,
	ENABLE_PCLK_PERIC0,
	ENABLE_SCLK_PERIC0,
};

static samsung_mux_clock peric0_mux_clks[]  = {
...
static samsung_gate_clock peric0_gate_clks[]  = {
...
const MUX_SEL_PERIC10: u32 = 0x0200;
const MUX_SEL_PERIC11: u32 = 0x0204;
const MUX_SEL_PERIC12: u32 = 0x0208;
const ENABLE_PCLK_PERIC1: u32 = 0x0900;
const ENABLE_SCLK_PERIC10: u32 = 0x0A00;

// device-tree registration: exynos7_clk_peric0, "samsung,exynos7-clock-peric0",
	exynos7_clk_peric0_init;

/* List of parent clocks for Muxes in CMU_PERIC1 */
static mout_aclk_peric1_66_user_p: &[&str] = { "fin_pll", "aclk_peric1_66" };
static mout_sclk_uart1_user_p: &[&str] = { "fin_pll", "sclk_uart1" };
static mout_sclk_uart2_user_p: &[&str] = { "fin_pll", "sclk_uart2" };
static mout_sclk_uart3_user_p: &[&str] = { "fin_pll", "sclk_uart3" };
static mout_sclk_spi0_user_p: &[&str] = { "fin_pll", "sclk_spi0" };
static mout_sclk_spi1_user_p: &[&str] = { "fin_pll", "sclk_spi1" };
static mout_sclk_spi2_user_p: &[&str] = { "fin_pll", "sclk_spi2" };
static mout_sclk_spi3_user_p: &[&str] = { "fin_pll", "sclk_spi3" };
static mout_sclk_spi4_user_p: &[&str] = { "fin_pll", "sclk_spi4" };

static peric1_clk_regs[]  = {
	MUX_SEL_PERIC10,
	MUX_SEL_PERIC11,
	MUX_SEL_PERIC12,
	ENABLE_PCLK_PERIC1,
...
static samsung_mux_clock peric1_mux_clks[]  = {
...
static samsung_gate_clock peric1_gate_clks[]  = {
...
// device-tree registration: exynos7_clk_peric1, "samsung,exynos7-clock-peric1",
	exynos7_clk_peric1_init;

/* Register Offset definitions for CMU_PERIS (0x10040000) */
const MUX_SEL_PERIS: u32 = 0x0200;
const ENABLE_PCLK_PERIS: u32 = 0x0900;
const ENABLE_PCLK_PERIS_SECURE_CHIPID: u32 = 0x0910;
const ENABLE_SCLK_PERIS: u32 = 0x0A00;
const ENABLE_SCLK_PERIS_SECURE_CHIPID: u32 = 0x0A10;

/* List of parent clocks for Muxes in CMU_PERIS */
static mout_aclk_peris_66_user_p: &[&str] = { "fin_pll", "aclk_peris_66" };

static peris_clk_regs[]  = {
	MUX_SEL_PERIS,
	ENABLE_PCLK_PERIS,
...
static samsung_mux_clock peris_mux_clks[]  = {
	mux!(0, "mout_aclk_peris_66_user",
		mout_aclk_peris_66_user_p, MUX_SEL_PERIS, 0, 1),
};

static samsung_gate_clock peris_gate_clks[]  = {
...
// device-tree registration: exynos7_clk_peris, "samsung,exynos7-clock-peris",
	exynos7_clk_peris_init;

/* Register Offset definitions for CMU_FSYS0 (0x10E90000) */
const MUX_SEL_FSYS00: u32 = 0x0200;
const MUX_SEL_FSYS01: u32 = 0x0204;
const MUX_SEL_FSYS02: u32 = 0x0208;
const ENABLE_ACLK_FSYS00: u32 = 0x0800;
const ENABLE_ACLK_FSYS01: u32 = 0x0804;
const ENABLE_SCLK_FSYS01: u32 = 0x0A04;
const ENABLE_SCLK_FSYS02: u32 = 0x0A08;
const ENABLE_SCLK_FSYS04: u32 = 0x0A10;

/*
 * List of parent clocks for Muxes in CMU_FSYS0
 */
static mout_aclk_fsys0_200_user_p: &[&str] = { "fin_pll", "aclk_fsys0_200" };
static mout_sclk_mmc2_user_p: &[&str] = { "fin_pll", "sclk_mmc2" };

static mout_sclk_usbdrd300_user_p: &[&str] = { "fin_pll", "sclk_usbdrd300" };
static mout_phyclk_usbdrd300_udrd30_phyclk_user_p: &[&str] = { "fin_pll",
				"phyclk_usbdrd300_udrd30_phyclock" };
static mout_phyclk_usbdrd300_udrd30_pipe_pclk_user_p: &[&str] = { "fin_pll",
				"phyclk_usbdrd300_udrd30_pipe_pclk" };

/* fixed rate clocks used in the FSYS0 block */
static samsung_fixed_rate_clock fixed_rate_clks_fsys0[]  = {
	frate!(0, "phyclk_usbdrd300_udrd30_phyclock", core::ptr::null_mut(), 0, 60000000),
	frate!(0, "phyclk_usbdrd300_udrd30_pipe_pclk", core::ptr::null_mut(), 0, 125000000),
};

static fsys0_clk_regs[]  = {
	MUX_SEL_FSYS00,
	MUX_SEL_FSYS01,
	MUX_SEL_FSYS02,
	ENABLE_ACLK_FSYS00,
...
static samsung_mux_clock fsys0_mux_clks[]  = {
...
static samsung_gate_clock fsys0_gate_clks[]  = {
...
// device-tree registration: exynos7_clk_fsys0, "samsung,exynos7-clock-fsys0",
	exynos7_clk_fsys0_init;

/* Register Offset definitions for CMU_FSYS1 (0x156E0000) */
const MUX_SEL_FSYS10: u32 = 0x0200;
const MUX_SEL_FSYS11: u32 = 0x0204;
const MUX_SEL_FSYS12: u32 = 0x0208;
const DIV_FSYS1: u32 = 0x0600;
const ENABLE_ACLK_FSYS1: u32 = 0x0800;
const ENABLE_PCLK_FSYS1: u32 = 0x0900;
const ENABLE_SCLK_FSYS11: u32 = 0x0A04;
const ENABLE_SCLK_FSYS12: u32 = 0x0A08;
const ENABLE_SCLK_FSYS13: u32 = 0x0A0C;

/*
 * List of parent clocks for Muxes in CMU_FSYS1
 */
static mout_aclk_fsys1_200_user_p: &[&str] = { "fin_pll", "aclk_fsys1_200" };
static mout_fsys1_group_p: &[&str] = { "fin_pll", "fin_pll_26m",
				"sclk_phy_fsys1_26m" };
static mout_sclk_mmc0_user_p: &[&str] = { "fin_pll", "sclk_mmc0" };
static mout_sclk_mmc1_user_p: &[&str] = { "fin_pll", "sclk_mmc1" };
static mout_sclk_ufsunipro20_user_p: &[&str] = { "fin_pll", "sclk_ufsunipro20" };
static mout_phyclk_ufs20_tx0_user_p: &[&str] = { "fin_pll", "phyclk_ufs20_tx0_symbol" };
static mout_phyclk_ufs20_rx0_user_p: &[&str] = { "fin_pll", "phyclk_ufs20_rx0_symbol" };
static mout_phyclk_ufs20_rx1_user_p: &[&str] = { "fin_pll", "phyclk_ufs20_rx1_symbol" };

/* fixed rate clocks used in the FSYS1 block */
static samsung_fixed_rate_clock fixed_rate_clks_fsys1[]  = {
	frate!(PHYCLK_UFS20_TX0_SYMBOL, "phyclk_ufs20_tx0_symbol", core::ptr::null_mut(),
			0, 300000000),
	frate!(PHYCLK_UFS20_RX0_SYMBOL, "phyclk_ufs20_rx0_symbol", core::ptr::null_mut(),
			0, 300000000),
	frate!(PHYCLK_UFS20_RX1_SYMBOL, "phyclk_ufs20_rx1_symbol", core::ptr::null_mut(),
			0, 300000000),
};

static fsys1_clk_regs[]  = {
	MUX_SEL_FSYS10,
	MUX_SEL_FSYS11,
	MUX_SEL_FSYS12,
	DIV_FSYS1,
...
static samsung_mux_clock fsys1_mux_clks[]  = {
...
static samsung_div_clock fsys1_div_clks[]  = {
	div!(DOUT_PCLK_FSYS1, "dout_pclk_fsys1", "mout_aclk_fsys1_200_user",
		DIV_FSYS1, 0, 2),
};

static samsung_gate_clock fsys1_gate_clks[]  = {
...
// device-tree registration: exynos7_clk_fsys1, "samsung,exynos7-clock-fsys1",
	exynos7_clk_fsys1_init;

const MUX_SEL_MSCL: u32 = 0x0200;
...
static mout_aclk_mscl_532_user_p: &[&str] = { "fin_pll", "aclk_mscl_532" };

static mscl_clk_regs[]  = {
	MUX_SEL_MSCL,
	DIV_MSCL,
	ENABLE_ACLK_MSCL,
	ENABLE_PCLK_MSCL,
...
// device-tree registration: exynos7_clk_mscl, "samsung,exynos7-clock-mscl",
		exynos7_clk_mscl_init;

/* Register Offset definitions for CMU_AUD (0x114C0000) */
const MUX_SEL_AUD: u32 = 0x0200;
const DIV_AUD0: u32 = 0x0600;
const DIV_AUD1: u32 = 0x0604;
const ENABLE_ACLK_AUD: u32 = 0x0800;
const ENABLE_PCLK_AUD: u32 = 0x0900;
const ENABLE_SCLK_AUD: u32 = 0x0A00;

/*
 * List of parent clocks for Muxes in CMU_AUD
 */
static mout_aud_pll_user_p: &[&str] = { "fin_pll", "fout_aud_pll" };
static mout_aud_group_p: &[&str] = { "dout_aud_cdclk", "ioclk_audiocdclk0" };
...
static samsung_mux_clock aud_mux_clks[]  = {
...
static samsung_div_clock aud_div_clks[]  = {
...
static samsung_gate_clock aud_gate_clks[]  = {
...
// device-tree registration: exynos7_clk_aud, "samsung,exynos7-clock-aud",
