...
// dependency: <dt-bindings/clock/exynos3250.h>

// dependency: "clk.h"
// dependency: "clk-cpu.h"
// dependency: "clk-pll.h"

const SRC_LEFTBUS: u32 = 0x4200;
const DIV_LEFTBUS: u32 = 0x4500;
const GATE_IP_LEFTBUS: u32 = 0x4800;
const SRC_RIGHTBUS: u32 = 0x8200;
const DIV_RIGHTBUS: u32 = 0x8500;
const GATE_IP_RIGHTBUS: u32 = 0x8800;
const GATE_IP_PERIR: u32 = 0x8960;
const MPLL_LOCK: u32 = 0xc010;
const MPLL_CON0: u32 = 0xc110;
const VPLL_LOCK: u32 = 0xc020;
const VPLL_CON0: u32 = 0xc120;
const UPLL_LOCK: u32 = 0xc030;
const UPLL_CON0: u32 = 0xc130;
const SRC_TOP0: u32 = 0xc210;
const SRC_TOP1: u32 = 0xc214;
const SRC_CAM: u32 = 0xc220;
const SRC_MFC: u32 = 0xc228;
const SRC_G3D: u32 = 0xc22c;
const SRC_LCD: u32 = 0xc234;
const SRC_ISP: u32 = 0xc238;
const SRC_FSYS: u32 = 0xc240;
const SRC_PERIL0: u32 = 0xc250;
const SRC_PERIL1: u32 = 0xc254;
const SRC_MASK_TOP: u32 = 0xc310;
const SRC_MASK_CAM: u32 = 0xc320;
const SRC_MASK_LCD: u32 = 0xc334;
const SRC_MASK_ISP: u32 = 0xc338;
const SRC_MASK_FSYS: u32 = 0xc340;
const SRC_MASK_PERIL0: u32 = 0xc350;
const SRC_MASK_PERIL1: u32 = 0xc354;
const DIV_TOP: u32 = 0xc510;
const DIV_CAM: u32 = 0xc520;
const DIV_MFC: u32 = 0xc528;
const DIV_G3D: u32 = 0xc52c;
const DIV_LCD: u32 = 0xc534;
const DIV_ISP: u32 = 0xc538;
const DIV_FSYS0: u32 = 0xc540;
const DIV_FSYS1: u32 = 0xc544;
const DIV_FSYS2: u32 = 0xc548;
const DIV_PERIL0: u32 = 0xc550;
const DIV_PERIL1: u32 = 0xc554;
const DIV_PERIL3: u32 = 0xc55c;
const DIV_PERIL4: u32 = 0xc560;
const DIV_PERIL5: u32 = 0xc564;
const DIV_CAM1: u32 = 0xc568;
const CLKDIV2_RATIO: u32 = 0xc580;
const GATE_SCLK_CAM: u32 = 0xc820;
const GATE_SCLK_MFC: u32 = 0xc828;
const GATE_SCLK_G3D: u32 = 0xc82c;
const GATE_SCLK_LCD: u32 = 0xc834;
const GATE_SCLK_ISP_TOP: u32 = 0xc838;
const GATE_SCLK_FSYS: u32 = 0xc840;
const GATE_SCLK_PERIL: u32 = 0xc850;
const GATE_IP_CAM: u32 = 0xc920;
const GATE_IP_MFC: u32 = 0xc928;
const GATE_IP_G3D: u32 = 0xc92c;
const GATE_IP_LCD: u32 = 0xc934;
const GATE_IP_ISP: u32 = 0xc938;
const GATE_IP_FSYS: u32 = 0xc940;
const GATE_IP_PERIL: u32 = 0xc950;
const GATE_BLOCK: u32 = 0xc970;
const APLL_LOCK: u32 = 0x14000;
const APLL_CON0: u32 = 0x14100;
const SRC_CPU: u32 = 0x14200;
const DIV_CPU0: u32 = 0x14500;
const DIV_CPU1: u32 = 0x14504;
const PWR_CTRL1: u32 = 0x15020;
const PWR_CTRL2: u32 = 0x15024;

/* Below definitions are used for PWR_CTRL settings */
macro_rules! PWR_CTRL1_CORE2_DOWN_RATIO { (1000 65534 65534 65534 65534 65534 65534 65534 65534 1000x),*) => { (((x) & 0x7) << 28) }; }
macro_rules! PWR_CTRL1_CORE1_DOWN_RATIO { (1000 65534 65534 65534 65534 65534 65534 65534 65534 1000x),*) => { (((x) & 0x7) << 16) }; }
const PWR_CTRL1_DIV2_DOWN_EN: u32 = (1 << 9);
const PWR_CTRL1_DIV1_DOWN_EN: u32 = (1 << 8);
const PWR_CTRL1_USE_CORE3_WFE: u32 = (1 << 7);
const PWR_CTRL1_USE_CORE2_WFE: u32 = (1 << 6);
const PWR_CTRL1_USE_CORE1_WFE: u32 = (1 << 5);
const PWR_CTRL1_USE_CORE0_WFE: u32 = (1 << 4);
const PWR_CTRL1_USE_CORE3_WFI: u32 = (1 << 3);
const PWR_CTRL1_USE_CORE2_WFI: u32 = (1 << 2);
const PWR_CTRL1_USE_CORE1_WFI: u32 = (1 << 1);
const PWR_CTRL1_USE_CORE0_WFI: u32 = (1 << 0);

/* NOTE: Must be equal to the last clock ID increased by one */
const CLKS_NR_MAIN: u32 = (CLK_SCLK_MMC2 + 1);
const CLKS_NR_DMC: u32 = (CLK_DIV_DMCD + 1);
const CLKS_NR_ISP: u32 = (CLK_SCLK_MPWM_ISP + 1);

static exynos3250_cmu_clk_regs: &[u64] = &[ {
	SRC_LEFTBUS,
	DIV_LEFTBUS,
	GATE_IP_LEFTBUS,
	SRC_RIGHTBUS,
...
static fixed_factor_clks: &[samsung_fixed_factor_clock] = &[ {
...
static mux_clks: &[samsung_mux_clock] = &[ {
	/*
...
static div_clks: &[samsung_div_clock] = &[ {
	/*
	 * NOTE: Following table is sorted by register address in ascending
	 * order and then bitfield shift in descending order, as it is done
	 * in the User's Manual. When adding new entries, please make sure
...
static gate_clks: &[samsung_gate_clock] = &[ {
	/*
	 * NOTE: Following table is sorted by register address in ascending
	 * order and then bitfield shift in descending order, as it is done
	 * in the User's Manual. When adding new entries, please make sure
...
/* APLL & MPLL & BPLL & UPLL */
static exynos3250_pll_rates: &[samsung_pll_rate_table] = &[ {
...
/* EPLL */
static exynos3250_epll_rates: &[samsung_pll_rate_table] = &[ {
...
/* VPLL */
static exynos3250_vpll_rates: &[samsung_pll_rate_table] = &[ {
...
static exynos3250_plls: &[samsung_pll_clock] = &[ {
...
macro_rules! E3250_CPU_DIV0 { (1000 65534 65534 65534 65534 65534 65534 65534 65534 1000apll, pclk_dbg, atb, corem),*) => { \ }; }
		(((apll) << 24) | ((pclk_dbg) << 20) | ((atb) << 16) |	\
		((corem) << 4))
macro_rules! E3250_CPU_DIV1 { (1000 65534 65534 65534 65534 65534 65534 65534 65534 1000hpm, copy),*) => { \ }; }
		(((hpm) << 4) | ((copy) << 0))

static e3250_armclk_d: &[exynos_cpuclk_cfg_data] = &[ {
...
unsafe fn exynos3_core_down_clock(reg_base: *mut core::ffi::c_void)
{
	...
	__raw_writel(tmp, unsafe { (reg_base as *mut u8).add(PWR_CTRL1 as usize) as *mut u32 });

	/*
	 * Disable the clock up feature on Exynos4x12, in case it was
	 * enabled by bootloader.
	 */
	__raw_writel(0x0, unsafe { (reg_base as *mut u8).add(PWR_CTRL2 as usize) as *mut u32 });
}
...
const BPLL_LOCK: u32 = 0x0118;
const BPLL_CON0: u32 = 0x0218;
const BPLL_CON1: u32 = 0x021c;
const BPLL_CON2: u32 = 0x0220;
const SRC_DMC: u32 = 0x0300;
const DIV_DMC1: u32 = 0x0504;
const GATE_BUS_DMC0: u32 = 0x0700;
const GATE_BUS_DMC1: u32 = 0x0704;
const GATE_BUS_DMC2: u32 = 0x0708;
const GATE_BUS_DMC3: u32 = 0x070c;
const GATE_SCLK_DMC: u32 = 0x0800;
const GATE_IP_DMC0: u32 = 0x0900;
const GATE_IP_DMC1: u32 = 0x0904;
const EPLL_LOCK: u32 = 0x1110;
const EPLL_CON0: u32 = 0x1114;
const EPLL_CON1: u32 = 0x1118;
const EPLL_CON2: u32 = 0x111c;
const SRC_EPLL: u32 = 0x1120;

static exynos3250_cmu_dmc_clk_regs: &[u64] = &[ {
	BPLL_LOCK,
	BPLL_CON0,
	BPLL_CON1,
	BPLL_CON2,
...
static dmc_mux_clks: &[samsung_mux_clock] = &[ {
	/*
	 * NOTE: Following table is sorted by register address in ascending
	 * order and then bitfield shift in descending order, as it is done
	 * in the User's Manual. When adding new entries, please make sure
...
static dmc_div_clks: &[samsung_div_clock] = &[ {
	/*
	 * NOTE: Following table is sorted by register address in ascending
	 * order and then bitfield shift in descending order, as it is done
	 * in the User's Manual. When adding new entries, please make sure
...
static exynos3250_dmc_plls: &[samsung_pll_clock] = &[ {
...
const DIV_ISP0: u32 = 0x300;
const DIV_ISP1: u32 = 0x304;
const GATE_IP_ISP0: u32 = 0x800;
const GATE_IP_ISP1: u32 = 0x804;
const GATE_SCLK_ISP: u32 = 0x900;

static isp_div_clks: &[samsung_div_clock] = &[ {
	/*
	 * NOTE: Following table is sorted by register address in ascending
	 * order and then bitfield shift in descending order, as it is done
	 * in the User's Manual. When adding new entries, please make sure
...
static isp_gate_clks: &[samsung_gate_clock] = &[ {
	/*
	 * NOTE: Following table is sorted by register address in ascending
	 * order and then bitfield shift in descending order, as it is done
	 * in the User's Manual. When adding new entries, please make sure
...
static exynos3250_cmu_isp_of_match: &[of_device_id] = &[ {
