// Translated from clk-exynosautov9.c. External macros/types remain dependencies.
...
// dependency: <dt-bindings/clock/samsung,exynosautov9.h>

// dependency: "clk.h"
// dependency: "clk-exynos-arm64.h"

/* NOTE: Must be equal to the last clock ID increased by one */
const CLKS_NR_TOP: usize = (GOUT_CLKCMU_PERIS_BUS + 1);
const CLKS_NR_BUSMC: usize = (CLK_GOUT_BUSMC_SPDMA_PCLK + 1);
const CLKS_NR_CORE: usize = (CLK_GOUT_CORE_CMU_CORE_PCLK + 1);
const CLKS_NR_DPUM: usize = (CLK_GOUT_DPUM_SYSMMU_D3_CLK + 1);
const CLKS_NR_FSYS0: usize = (CLK_GOUT_FSYS0_PCIE_GEN3B_4L_CLK + 1);
const CLKS_NR_FSYS1: usize = (CLK_GOUT_FSYS1_USB30_1_ACLK + 1);
const CLKS_NR_FSYS2: usize = (CLK_GOUT_FSYS2_UFS_EMBD1_UNIPRO + 1);
const CLKS_NR_PERIC0: usize = (CLK_GOUT_PERIC0_PCLK_11 + 1);
const CLKS_NR_PERIC1: usize = (CLK_GOUT_PERIC1_PCLK_11 + 1);
const CLKS_NR_PERIS: usize = (CLK_GOUT_WDT_CLUSTER1 + 1);
...
const PLL_CON0_PLL_SHARED0: usize = 0x0100;
const PLL_CON3_PLL_SHARED0: usize = 0x010c;
const PLL_CON0_PLL_SHARED1: usize = 0x0140;
const PLL_CON3_PLL_SHARED1: usize = 0x014c;
const PLL_CON0_PLL_SHARED2: usize = 0x0180;
const PLL_CON3_PLL_SHARED2: usize = 0x018c;
const PLL_CON0_PLL_SHARED3: usize = 0x01c0;
const PLL_CON3_PLL_SHARED3: usize = 0x01cc;
const PLL_CON0_PLL_SHARED4: usize = 0x0200;
const PLL_CON3_PLL_SHARED4: usize = 0x020c;

/* MUX */
const CLK_CON_MUX_MUX_CLKCMU_ACC_BUS: usize = 0x1000;
const CLK_CON_MUX_MUX_CLKCMU_APM_BUS: usize = 0x1004;
const CLK_CON_MUX_MUX_CLKCMU_AUD_BUS: usize = 0x1008;
const CLK_CON_MUX_MUX_CLKCMU_AUD_CPU: usize = 0x100c;
const CLK_CON_MUX_MUX_CLKCMU_BUSC_BUS: usize = 0x1010;
const CLK_CON_MUX_MUX_CLKCMU_BUSMC_BUS: usize = 0x1018;
const CLK_CON_MUX_MUX_CLKCMU_CMU_BOOST: usize = 0x101c;
const CLK_CON_MUX_MUX_CLKCMU_CORE_BUS: usize = 0x1020;
...
const CLK_CON_MUX_MUX_CLKCMU_DPTX_BUS: usize = 0x1040;
const CLK_CON_MUX_MUX_CLKCMU_DPTX_DPGTC: usize = 0x1044;
const CLK_CON_MUX_MUX_CLKCMU_DPUM_BUS: usize = 0x1048;
const CLK_CON_MUX_MUX_CLKCMU_DPUS0_BUS: usize = 0x104c;
const CLK_CON_MUX_MUX_CLKCMU_DPUS1_BUS: usize = 0x1050;
const CLK_CON_MUX_MUX_CLKCMU_FSYS0_BUS: usize = 0x1054;
const CLK_CON_MUX_MUX_CLKCMU_FSYS0_PCIE: usize = 0x1058;
const CLK_CON_MUX_MUX_CLKCMU_FSYS1_BUS: usize = 0x105c;
const CLK_CON_MUX_MUX_CLKCMU_FSYS1_MMC_CARD: usize = 0x1060;
const CLK_CON_MUX_MUX_CLKCMU_FSYS1_USBDRD: usize = 0x1064;
const CLK_CON_MUX_MUX_CLKCMU_FSYS2_BUS: usize = 0x1068;
const CLK_CON_MUX_MUX_CLKCMU_FSYS2_ETHERNET: usize = 0x106c;
const CLK_CON_MUX_MUX_CLKCMU_FSYS2_UFS_EMBD: usize = 0x1070;
const CLK_CON_MUX_MUX_CLKCMU_G2D_G2D: usize = 0x1074;
const CLK_CON_MUX_MUX_CLKCMU_G2D_MSCL: usize = 0x1078;
const CLK_CON_MUX_MUX_CLKCMU_G3D00_SWITCH: usize = 0x107c;
const CLK_CON_MUX_MUX_CLKCMU_G3D01_SWITCH: usize = 0x1080;
const CLK_CON_MUX_MUX_CLKCMU_G3D1_SWITCH: usize = 0x1084;
const CLK_CON_MUX_MUX_CLKCMU_ISPB_BUS: usize = 0x108c;
const CLK_CON_MUX_MUX_CLKCMU_MFC_MFC: usize = 0x1090;
const CLK_CON_MUX_MUX_CLKCMU_MFC_WFD: usize = 0x1094;
const CLK_CON_MUX_MUX_CLKCMU_MIF_SWITCH: usize = 0x109c;
const CLK_CON_MUX_MUX_CLKCMU_MIF_BUSP: usize = 0x1098;
const CLK_CON_MUX_MUX_CLKCMU_MIF_SWITCH: usize = 0x109c;
const CLK_CON_MUX_MUX_CLKCMU_NPU_BUS: usize = 0x10a0;
const CLK_CON_MUX_MUX_CLKCMU_PERIC0_BUS: usize = 0x10a4;
const CLK_CON_MUX_MUX_CLKCMU_PERIC0_IP: usize = 0x10a8;
const CLK_CON_MUX_MUX_CLKCMU_PERIC1_BUS: usize = 0x10ac;
const CLK_CON_MUX_MUX_CLKCMU_PERIC1_IP: usize = 0x10b0;
const CLK_CON_MUX_MUX_CLKCMU_PERIS_BUS: usize = 0x10b4;
const CLK_CON_MUX_MUX_CMU_CMUREF: usize = 0x10c0;

/* DIV */
const CLK_CON_DIV_CLKCMU_ACC_BUS: usize = 0x1800;
const CLK_CON_DIV_CLKCMU_APM_BUS: usize = 0x1804;
const CLK_CON_DIV_CLKCMU_AUD_BUS: usize = 0x1808;
const CLK_CON_DIV_CLKCMU_AUD_CPU: usize = 0x180c;
const CLK_CON_DIV_CLKCMU_BUSC_BUS: usize = 0x1810;
const CLK_CON_DIV_CLKCMU_BUSMC_BUS: usize = 0x1818;
const CLK_CON_DIV_CLKCMU_CORE_BUS: usize = 0x181c;
...
const CLK_CON_DIV_CLKCMU_DPTX_BUS: usize = 0x183c;
const CLK_CON_DIV_CLKCMU_DPTX_DPGTC: usize = 0x1840;
const CLK_CON_DIV_CLKCMU_DPUM_BUS: usize = 0x1844;
const CLK_CON_DIV_CLKCMU_DPUS0_BUS: usize = 0x1848;
const CLK_CON_DIV_CLKCMU_DPUS1_BUS: usize = 0x184c;
const CLK_CON_DIV_CLKCMU_FSYS0_BUS: usize = 0x1850;
const CLK_CON_DIV_CLKCMU_FSYS0_PCIE: usize = 0x1854;
const CLK_CON_DIV_CLKCMU_FSYS1_BUS: usize = 0x1858;
const CLK_CON_DIV_CLKCMU_FSYS1_USBDRD: usize = 0x185c;
const CLK_CON_DIV_CLKCMU_FSYS2_BUS: usize = 0x1860;
const CLK_CON_DIV_CLKCMU_FSYS2_ETHERNET: usize = 0x1864;
const CLK_CON_DIV_CLKCMU_FSYS2_UFS_EMBD: usize = 0x1868;
const CLK_CON_DIV_CLKCMU_G2D_G2D: usize = 0x186c;
const CLK_CON_DIV_CLKCMU_G2D_MSCL: usize = 0x1870;
const CLK_CON_DIV_CLKCMU_G3D00_SWITCH: usize = 0x1874;
const CLK_CON_DIV_CLKCMU_G3D01_SWITCH: usize = 0x1878;
const CLK_CON_DIV_CLKCMU_G3D1_SWITCH: usize = 0x187c;
const CLK_CON_DIV_CLKCMU_ISPB_BUS: usize = 0x1884;
const CLK_CON_DIV_CLKCMU_MFC_MFC: usize = 0x1888;
const CLK_CON_DIV_CLKCMU_MFC_WFD: usize = 0x188c;
const CLK_CON_DIV_CLKCMU_MIF_BUSP: usize = 0x1890;
const CLK_CON_DIV_CLKCMU_NPU_BUS: usize = 0x1894;
const CLK_CON_DIV_CLKCMU_PERIC0_BUS: usize = 0x1898;
const CLK_CON_DIV_CLKCMU_PERIC0_IP: usize = 0x189c;
const CLK_CON_DIV_CLKCMU_PERIC1_BUS: usize = 0x18a0;
const CLK_CON_DIV_CLKCMU_PERIC1_IP: usize = 0x18a4;
const CLK_CON_DIV_CLKCMU_PERIS_BUS: usize = 0x18a8;
const CLK_CON_DIV_DIV_CLKCMU_CMU_BOOST: usize = 0x18b4;

const CLK_CON_DIV_PLL_SHARED0_DIV2: usize = 0x18b8;
const CLK_CON_DIV_PLL_SHARED0_DIV3: usize = 0x18bc;
const CLK_CON_DIV_PLL_SHARED1_DIV2: usize = 0x18c0;
const CLK_CON_DIV_PLL_SHARED1_DIV3: usize = 0x18c4;
const CLK_CON_DIV_PLL_SHARED1_DIV4: usize = 0x18c8;
const CLK_CON_DIV_PLL_SHARED2_DIV2: usize = 0x18cc;
const CLK_CON_DIV_PLL_SHARED2_DIV3: usize = 0x18d0;
const CLK_CON_DIV_PLL_SHARED2_DIV4: usize = 0x18d4;
const CLK_CON_DIV_PLL_SHARED4_DIV2: usize = 0x18d4;
const CLK_CON_DIV_PLL_SHARED4_DIV4: usize = 0x18d8;

/* GATE */
const CLK_CON_GAT_CLKCMU_CMU_BUSC_BOOST: usize = 0x2000;
const CLK_CON_GAT_CLKCMU_CMU_BUSMC_BOOST: usize = 0x2004;
const CLK_CON_GAT_CLKCMU_CMU_CORE_BOOST: usize = 0x2008;
const CLK_CON_GAT_CLKCMU_CMU_CPUCL0_BOOST: usize = 0x2010;
const CLK_CON_GAT_CLKCMU_CMU_CPUCL1_BOOST: usize = 0x2018;
const CLK_CON_GAT_CLKCMU_CMU_MIF_BOOST: usize = 0x2020;
const CLK_CON_GAT_GATE_CLKCMU_FSYS1_MMC_CARD: usize = 0x2024;
const CLK_CON_GAT_GATE_CLKCMU_MIF_SWITCH: usize = 0x2028;
const CLK_CON_GAT_GATE_CLKCMU_ACC_BUS: usize = 0x202c;
const CLK_CON_GAT_GATE_CLKCMU_APM_BUS: usize = 0x2030;
const CLK_CON_GAT_GATE_CLKCMU_AUD_BUS: usize = 0x2034;
const CLK_CON_GAT_GATE_CLKCMU_AUD_CPU: usize = 0x2038;
const CLK_CON_GAT_GATE_CLKCMU_BUSC_BUS: usize = 0x203c;
const CLK_CON_GAT_GATE_CLKCMU_BUSMC_BUS: usize = 0x2044;
const CLK_CON_GAT_GATE_CLKCMU_CMU_BOOST: usize = 0x2048;
const CLK_CON_GAT_GATE_CLKCMU_CORE_BUS: usize = 0x204c;
const CLK_CON_GAT_GATE_CLKCMU_CPUCL0_CLUSTER: usize = 0x2050;
const CLK_CON_GAT_GATE_CLKCMU_CPUCL0_SWITCH: usize = 0x2058;
const CLK_CON_GAT_GATE_CLKCMU_CPUCL1_CLUSTER: usize = 0x205c;
const CLK_CON_GAT_GATE_CLKCMU_CPUCL1_SWITCH: usize = 0x2060;
const CLK_CON_GAT_GATE_CLKCMU_DPTX_BUS: usize = 0x206c;
const CLK_CON_GAT_GATE_CLKCMU_DPTX_DPGTC: usize = 0x2070;
const CLK_CON_GAT_GATE_CLKCMU_DPUM_BUS: usize = 0x2060;
const CLK_CON_GAT_GATE_CLKCMU_DPUS0_BUS: usize = 0x2064;
const CLK_CON_GAT_GATE_CLKCMU_DPUS1_BUS: usize = 0x207c;
const CLK_CON_GAT_GATE_CLKCMU_FSYS0_BUS: usize = 0x2080;
const CLK_CON_GAT_GATE_CLKCMU_FSYS0_PCIE: usize = 0x2084;
const CLK_CON_GAT_GATE_CLKCMU_FSYS1_BUS: usize = 0x2088;
const CLK_CON_GAT_GATE_CLKCMU_FSYS1_USBDRD: usize = 0x208c;
const CLK_CON_GAT_GATE_CLKCMU_FSYS2_BUS: usize = 0x2090;
const CLK_CON_GAT_GATE_CLKCMU_FSYS2_ETHERNET: usize = 0x2094;
const CLK_CON_GAT_GATE_CLKCMU_FSYS2_UFS_EMBD: usize = 0x2098;
const CLK_CON_GAT_GATE_CLKCMU_G2D_G2D: usize = 0x209c;
const CLK_CON_GAT_GATE_CLKCMU_G2D_MSCL: usize = 0x20a0;
const CLK_CON_GAT_GATE_CLKCMU_G3D00_SWITCH: usize = 0x20a4;
const CLK_CON_GAT_GATE_CLKCMU_G3D01_SWITCH: usize = 0x20a8;
const CLK_CON_GAT_GATE_CLKCMU_G3D1_SWITCH: usize = 0x20ac;
const CLK_CON_GAT_GATE_CLKCMU_ISPB_BUS: usize = 0x20b4;
const CLK_CON_GAT_GATE_CLKCMU_MFC_MFC: usize = 0x20b8;
const CLK_CON_GAT_GATE_CLKCMU_MFC_WFD: usize = 0x20bc;
const CLK_CON_GAT_GATE_CLKCMU_MIF_BUSP: usize = 0x20c0;
const CLK_CON_GAT_GATE_CLKCMU_NPU_BUS: usize = 0x20c4;
const CLK_CON_GAT_GATE_CLKCMU_PERIC0_BUS: usize = 0x20c8;
const CLK_CON_GAT_GATE_CLKCMU_PERIC0_IP: usize = 0x20cc;
const CLK_CON_GAT_GATE_CLKCMU_PERIC1_BUS: usize = 0x20d0;
...
static mout_clkcmu_cpucl0_switch_p: &[&str] = &[
	"dout_shared0_div2", "dout_shared1_div2",
	"dout_shared2_div2", "dout_shared4_div2" };
static mout_clkcmu_cpucl0_cluster_p: &[&str] = &[
...
PNAME(mout_clkcmu_fsys1_bus_p)	= { "dout_shared2_div3", "dout_shared1_div4",
				    "dout_shared2_div4", "dout_shared4_div4" };
static mout_clkcmu_fsys1_usbdrd_p: &[&str] = &[
	"oscclk", "dout_shared2_div3",
	"dout_shared2_div4", "dout_shared4_div4" };
static mout_clkcmu_fsys1_mmc_card_p: &[&str] = &[
	"oscclk", "dout_shared2_div2",
	"dout_shared4_div2", "dout_shared2_div3" };
static mout_clkcmu_fsys2_ethernet_p: &[&str] = &[
	"oscclk", "dout_shared2_div2",
...
const PLL_CON0_MUX_CLKCMU_BUSMC_BUS_USER: usize = 0x0600;
const CLK_CON_DIV_DIV_CLK_BUSMC_BUSP: usize = 0x1800;
...
static const struct samsung_cmu_info busmc_cmu_info  = {
	mux_clks: busmc_mux_clks,
	nr_mux_clks: busmc_mux_clks.len(),
	div_clks: busmc_div_clks,
	nr_div_clks: busmc_div_clks.len(),
	gate_clks: busmc_gate_clks,
	nr_gate_clks: busmc_gate_clks.len(),
	nr_clk_ids: CLKS_NR_BUSMC,
	clk_regs: busmc_clk_regs,
	nr_clk_regs: busmc_clk_regs.len(),
...
const PLL_CON0_MUX_CLKCMU_CORE_BUS_USER: usize = 0x0600;
const CLK_CON_MUX_MUX_CORE_CMUREF: usize = 0x1000;
const CLK_CON_DIV_DIV_CLK_CORE_BUSP: usize = 0x1800;
const CLK_CON_GAT_CLK_BLK_CORE_UID_CCI_IPCLKPORT_CLK: usize = 0x2000;
...
static const struct samsung_cmu_info core_cmu_info  = {
	mux_clks: core_mux_clks,
	nr_mux_clks: core_mux_clks.len(),
	div_clks: core_div_clks,
	nr_div_clks: core_div_clks.len(),
	gate_clks: core_gate_clks,
	nr_gate_clks: core_gate_clks.len(),
	nr_clk_ids: CLKS_NR_CORE,
	clk_regs: core_clk_regs,
	nr_clk_regs: core_clk_regs.len(),
...
const PLL_CON0_MUX_CLKCMU_DPUM_BUS_USER: usize = 0x0600;
const CLK_CON_DIV_DIV_CLK_DPUM_BUSP: usize = 0x1800;
const CLK_CON_GAT_GOUT_BLK_DPUM_UID_DPUM_IPCLKPORT_ACLK_DECON: usize = 0x202c;
const CLK_CON_GAT_GOUT_BLK_DPUM_UID_DPUM_IPCLKPORT_ACLK_DMA: usize = 0x2030;
const CLK_CON_GAT_GOUT_BLK_DPUM_UID_DPUM_IPCLKPORT_ACLK_DPP: usize = 0x2034;
const CLK_CON_GAT_GOUT_BLK_DPUM_UID_SYSMMU_D0_DPUM_IPCLKPORT_CLK_S1: usize = 0x207c;
const CLK_CON_GAT_GOUT_BLK_DPUM_UID_SYSMMU_D1_DPUM_IPCLKPORT_CLK_S1: usize = 0x2084;
...
static const struct samsung_cmu_info dpum_cmu_info  = {
	mux_clks: dpum_mux_clks,
	nr_mux_clks: dpum_mux_clks.len(),
	div_clks: dpum_div_clks,
	nr_div_clks: dpum_div_clks.len(),
	gate_clks: dpum_gate_clks,
	nr_gate_clks: dpum_gate_clks.len(),
	nr_clk_ids: CLKS_NR_DPUM,
	clk_regs: dpum_clk_regs,
	nr_clk_regs: dpum_clk_regs.len(),
	clk_name: "bus",
];
...
const PLL_CON0_MUX_CLKCMU_FSYS0_BUS_USER: usize = 0x0600;
const PLL_CON0_MUX_CLKCMU_FSYS0_PCIE_USER: usize = 0x0610;
const CLK_CON_GAT_CLK_BLK_FSYS0_UID_FSYS0_CMU_FSYS0_IPCLKPORT_PCLK: usize = 0x2000;

const CLK_CON_GAT_CLK_BLK_FSYS0_UID_PCIE_GEN3_2L0_X1_PHY_REFCLK_IN: usize = 0x2004;
const CLK_CON_GAT_CLK_BLK_FSYS0_UID_PCIE_GEN3_2L0_X2_PHY_REFCLK_IN: usize = 0x2008;
const CLK_CON_GAT_CLK_BLK_FSYS0_UID_PCIE_GEN3_2L1_X1_PHY_REFCLK_IN: usize = 0x200c;
const CLK_CON_GAT_CLK_BLK_FSYS0_UID_PCIE_GEN3_2L1_X2_PHY_REFCLK_IN: usize = 0x2010;
const CLK_CON_GAT_CLK_BLK_FSYS0_UID_PCIE_GEN3_4L_X2_PHY_REFCLK_IN: usize = 0x2014;
const CLK_CON_GAT_CLK_BLK_FSYS0_UID_PCIE_GEN3_4L_X4_PHY_REFCLK_IN: usize = 0x2018;

const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L0_X1_DBI_ACLK: usize = 0x205c;
const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L0_X1_MSTR_ACLK: usize = 0x2060;
const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L0_X1_SLV_ACLK: usize = 0x2064;
const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L0_X2_DBI_ACLK: usize = 0x206c;
const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L0_X2_MSTR_ACLK: usize = 0x2070;
const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L0_X2_SLV_ACLK: usize = 0x2074;
const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L0_X2_PIPE_CLK: usize = 0x207c;

const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L1_X1_DBI_ACLK: usize = 0x2084;
const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L1_X1_MSTR_ACLK: usize = 0x2088;
const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L1_X1_SLV_ACLK: usize = 0x208c;
const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L1_X2_DBI_ACLK: usize = 0x2094;
const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L1_X2_MSTR_ACLK: usize = 0x2098;
const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L1_X2_SLV_ACLK: usize = 0x209c;
const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L1_X2_PIPE_CLK: usize = 0x20a4;

const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_4L_X2_DBI_ACLK: usize = 0x20ac;
const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_4L_X2_MSTR_ACLK: usize = 0x20b0;
const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_4L_X2_SLV_ACLK: usize = 0x20b4;
const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_4L_X4_DBI_ACLK: usize = 0x20bc;
const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_4L_X4_MSTR_ACLK: usize = 0x20c0;
const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_4L_X4_SLV_ACLK: usize = 0x20c4;
const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_4L_X4_PIPE_CLK: usize = 0x20cc;

const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3A_2L0_CLK: usize = 0x20d4;
const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3A_2L1_CLK: usize = 0x20d8;
const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3A_4L_CLK: usize = 0x20dc;
const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3B_2L0_CLK: usize = 0x20e0;
const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3B_2L1_CLK: usize = 0x20e4;
...
static const struct samsung_mux_clock fsys0_mux_clks[]  = {
...
static const struct samsung_gate_clock fsys0_gate_clks[]  = {
...
const PLL_LOCKTIME_PLL_MMC: usize = 0x0000;
const PLL_CON0_PLL_MMC: usize = 0x0100;
const PLL_CON3_PLL_MMC: usize = 0x010c;
const PLL_CON0_MUX_CLKCMU_FSYS1_BUS_USER: usize = 0x0600;
const PLL_CON0_MUX_CLKCMU_FSYS1_MMC_CARD_USER: usize = 0x0610;
const PLL_CON0_MUX_CLKCMU_FSYS1_USBDRD_USER: usize = 0x0620;

const CLK_CON_MUX_MUX_CLK_FSYS1_MMC_CARD: usize = 0x1000;
const CLK_CON_DIV_DIV_CLK_FSYS1_MMC_CARD: usize = 0x1800;

const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_FSYS1_CMU_FSYS1_IPCLKPORT_PCLK: usize = 0x2018;
const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_MMC_CARD_IPCLKPORT_SDCLKIN: usize = 0x202c;
const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_MMC_CARD_IPCLKPORT_I_ACLK: usize = 0x2028;

const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_USB20DRD_0_REF_CLK_40: usize = 0x204c;
const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_USB20DRD_1_REF_CLK_40: usize = 0x2058;
const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_USB30DRD_0_REF_CLK_40: usize = 0x2064;
const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_USB30DRD_1_REF_CLK_40: usize = 0x2070;

const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_US_D_USB2_0_IPCLKPORT_ACLK: usize = 0x2074;
const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_US_D_USB2_1_IPCLKPORT_ACLK: usize = 0x2078;
...
static const struct samsung_cmu_info fsys1_cmu_info  = {
	...
	nr_pll_clks: fsys1_pll_clks.len(),
...
const PLL_CON0_MUX_CLKCMU_FSYS2_BUS_USER: usize = 0x0600;
const PLL_CON0_MUX_CLKCMU_FSYS2_UFS_EMBD_USER: usize = 0x0620;
const PLL_CON0_MUX_CLKCMU_FSYS2_ETHERNET_USER: usize = 0x0610;
const CLK_CON_GAT_GOUT_BLK_FSYS2_UID_UFS_EMBD0_IPCLKPORT_I_ACLK: usize = 0x2098;
const CLK_CON_GAT_GOUT_BLK_FSYS2_UID_UFS_EMBD0_IPCLKPORT_I_CLK_UNIPRO: usize = 0x209c;
...
static const struct samsung_mux_clock fsys2_mux_clks[]  = {
...
static const struct samsung_gate_clock fsys2_gate_clks[]  = {
...
static const struct samsung_cmu_info fsys2_cmu_info  = {
	mux_clks: fsys2_mux_clks,
	nr_mux_clks: fsys2_mux_clks.len(),
	gate_clks: fsys2_gate_clks,
	nr_gate_clks: fsys2_gate_clks.len(),
	nr_clk_ids: CLKS_NR_FSYS2,
	clk_regs: fsys2_clk_regs,
	nr_clk_regs: fsys2_clk_regs.len(),
...
const PLL_CON0_MUX_CLKCMU_PERIC0_IP_USER: usize = 0x0610;
const CLK_CON_MUX_MUX_CLK_PERIC0_USI00_USI: usize = 0x1000;
const CLK_CON_MUX_MUX_CLK_PERIC0_USI01_USI: usize = 0x1004;
const CLK_CON_MUX_MUX_CLK_PERIC0_USI02_USI: usize = 0x1008;
const CLK_CON_MUX_MUX_CLK_PERIC0_USI03_USI: usize = 0x100c;
const CLK_CON_MUX_MUX_CLK_PERIC0_USI04_USI: usize = 0x1010;
const CLK_CON_MUX_MUX_CLK_PERIC0_USI05_USI: usize = 0x1014;
const CLK_CON_MUX_MUX_CLK_PERIC0_USI_I2C: usize = 0x1018;
const CLK_CON_DIV_DIV_CLK_PERIC0_USI00_USI: usize = 0x1800;
const CLK_CON_DIV_DIV_CLK_PERIC0_USI01_USI: usize = 0x1804;
const CLK_CON_DIV_DIV_CLK_PERIC0_USI02_USI: usize = 0x1808;
const CLK_CON_DIV_DIV_CLK_PERIC0_USI03_USI: usize = 0x180c;
const CLK_CON_DIV_DIV_CLK_PERIC0_USI04_USI: usize = 0x1810;
const CLK_CON_DIV_DIV_CLK_PERIC0_USI05_USI: usize = 0x1814;
const CLK_CON_DIV_DIV_CLK_PERIC0_USI_I2C: usize = 0x1818;
const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_0: usize = 0x2014;
const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_1: usize = 0x2018;
const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_2: usize = 0x2024;
const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_3: usize = 0x2028;
const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_4: usize = 0x202c;
const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_5: usize = 0x2030;
const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_6: usize = 0x2034;
const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_7: usize = 0x2038;
const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_8: usize = 0x203c;
const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_9: usize = 0x2040;
const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_10: usize = 0x201c;
const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_11: usize = 0x2020;
const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_0: usize = 0x2044;
const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_1: usize = 0x2048;
const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_2: usize = 0x2058;
const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_3: usize = 0x205c;
...
const PLL_CON0_MUX_CLKCMU_PERIC1_IP_USER: usize = 0x0610;
const CLK_CON_MUX_MUX_CLK_PERIC1_USI06_USI: usize = 0x1000;
const CLK_CON_MUX_MUX_CLK_PERIC1_USI07_USI: usize = 0x1004;
const CLK_CON_MUX_MUX_CLK_PERIC1_USI08_USI: usize = 0x1008;
const CLK_CON_MUX_MUX_CLK_PERIC1_USI09_USI: usize = 0x100c;
const CLK_CON_MUX_MUX_CLK_PERIC1_USI10_USI: usize = 0x1010;
const CLK_CON_MUX_MUX_CLK_PERIC1_USI11_USI: usize = 0x1014;
const CLK_CON_MUX_MUX_CLK_PERIC1_USI_I2C: usize = 0x1018;
const CLK_CON_DIV_DIV_CLK_PERIC1_USI06_USI: usize = 0x1800;
const CLK_CON_DIV_DIV_CLK_PERIC1_USI07_USI: usize = 0x1804;
const CLK_CON_DIV_DIV_CLK_PERIC1_USI08_USI: usize = 0x1808;
const CLK_CON_DIV_DIV_CLK_PERIC1_USI09_USI: usize = 0x180c;
const CLK_CON_DIV_DIV_CLK_PERIC1_USI10_USI: usize = 0x1810;
const CLK_CON_DIV_DIV_CLK_PERIC1_USI11_USI: usize = 0x1814;
const CLK_CON_DIV_DIV_CLK_PERIC1_USI_I2C: usize = 0x1818;
const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_0: usize = 0x2014;
const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_1: usize = 0x2018;
const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_2: usize = 0x2024;
const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_3: usize = 0x2028;
const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_4: usize = 0x202c;
const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_5: usize = 0x2030;
const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_6: usize = 0x2034;
const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_7: usize = 0x2038;
const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_8: usize = 0x203c;
const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_9: usize = 0x2040;
const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_10: usize = 0x201c;
const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_11: usize = 0x2020;
const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_0: usize = 0x2044;
const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_1: usize = 0x2048;
const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_2: usize = 0x2054;
const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_3: usize = 0x2058;
const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_4: usize = 0x205c;
const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_5: usize = 0x2060;
const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_6: usize = 0x2064;
const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_7: usize = 0x2068;
const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_8: usize = 0x206c;
const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_9: usize = 0x2070;
...
static const struct samsung_mux_clock peric1_mux_clks[]  = {
...
static const struct samsung_div_clock peric1_div_clks[]  = {
	/* USI06 ~ USI11 */
...
static const struct samsung_gate_clock peric1_gate_clks[]  = {
	/* IPCLK */
...
const CLK_CON_GAT_GOUT_BLK_PERIS_UID_SYSREG_PERIS_IPCLKPORT_PCLK: usize = 0x2058;
...
static const struct samsung_mux_clock peris_mux_clks[]  = {
...
static exynosautov9_cmu_of_match: &[of_device_id] = &[
	{
...
static struct platform_driver exynosautov9_cmu_driver  = {
	driver: {
...
static int  exynosautov9_cmu_init(void)
{
	return platform_driver_register(&exynosautov9_cmu_driver);
}
const _: () = { /* core_initcall(exynosautov9_cmu_init) */ };
