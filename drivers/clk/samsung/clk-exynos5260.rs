// Faithful source-level Rust translation of clk-exynos5260.c.
// External kernel declarations, constants, and clock-construction macros are
...
// dependency: clk-exynos5260.h
// dependency: clk.h
// dependency: clk-pll.h

// dependency: dt-bindings/clock/exynos5260-clk.h
 ...
 */
static samsung_pll_rate_table pll2550_24mhz_tbl: [_] = [
 ...
 */
static samsung_pll_rate_table pll2650_24mhz_tbl: [_] = [
...
static mout_aud_pll_user_p: [_] = ["fin_pll", "fout_aud_pll"];
static mout_sclk_aud_i2s_p: [_] = ["mout_aud_pll_user", "ioclk_i2s_cdclk"];
static mout_sclk_aud_pcm_p: [_] = ["mout_aud_pll_user", "ioclk_pcm_extclk"];

static samsung_mux_clock aud_mux_clks: [_] = [
...
static samsung_div_clock aud_div_clks: [_] = [
...
static samsung_gate_clock aud_gate_clks: [_] = [
...
static samsung_cmu_info aud_cmu  = {
...
unsafe fn  exynos5260_clk_aud_init(*mut device_node)
{
...
static mout_phyclk_dptx_phy_ch3_txd_clk_user_p: [_] = ["fin_pll",
			"phyclk_dptx_phy_ch3_txd_clk"];
static mout_phyclk_dptx_phy_ch2_txd_clk_user_p: [_] = ["fin_pll",
			"phyclk_dptx_phy_ch2_txd_clk"];
static mout_phyclk_dptx_phy_ch1_txd_clk_user_p: [_] = ["fin_pll",
			"phyclk_dptx_phy_ch1_txd_clk"];
static mout_phyclk_dptx_phy_ch0_txd_clk_user_p: [_] = ["fin_pll",
			"phyclk_dptx_phy_ch0_txd_clk"];
static mout_aclk_disp_222_user_p: [_] = ["fin_pll", "dout_aclk_disp_222"];
static mout_sclk_disp_pixel_user_p: [_] = ["fin_pll", "dout_sclk_disp_pixel"];
static mout_aclk_disp_333_user_p: [_] = ["fin_pll", "dout_aclk_disp_333"];
static mout_phyclk_hdmi_phy_tmds_clko_user_p: [_] = ["fin_pll",
			"phyclk_hdmi_phy_tmds_clko"];
static mout_phyclk_hdmi_phy_ref_clko_user_p: [_] = ["fin_pll",
			"phyclk_hdmi_phy_ref_clko"];
static mout_phyclk_hdmi_phy_pixel_clko_user_p: [_] = ["fin_pll",
			"phyclk_hdmi_phy_pixel_clko"];
static mout_phyclk_hdmi_link_o_tmds_clkhi_user_p: [_] = ["fin_pll",
			"phyclk_hdmi_link_o_tmds_clkhi"];
static mout_phyclk_mipi_dphy_4l_m_txbyte_clkhs_p: [_] = ["fin_pll",
			"phyclk_mipi_dphy_4l_m_txbyte_clkhs"];
static mout_phyclk_dptx_phy_o_ref_clk_24m_user_p: [_] = ["fin_pll",
			"phyclk_dptx_phy_o_ref_clk_24m"];
static mout_phyclk_dptx_phy_clk_div2_user_p: [_] = ["fin_pll",
			"phyclk_dptx_phy_clk_div2"];
static mout_sclk_hdmi_pixel_p: [_] = ["mout_sclk_disp_pixel_user",
			"mout_aclk_disp_222_user"];
static mout_phyclk_mipi_dphy_4lmrxclk_esc0_user_p: [_] = ["fin_pll",
			"phyclk_mipi_dphy_4l_m_rxclkesc0"];
static mout_sclk_hdmi_spdif_p: [_] = ["fin_pll", "ioclk_spdif_extclk",
			"dout_aclk_peri_aud", "phyclk_hdmi_phy_ref_cko"];

static samsung_mux_clock disp_mux_clks: [_] = [
...
static samsung_div_clock disp_div_clks: [_] = [
...
static samsung_gate_clock disp_gate_clks: [_] = [
...
static samsung_cmu_info disp_cmu  = {
...
unsafe fn  exynos5260_clk_disp_init(*mut device_node)
{
...
static mout_egl_b_p: [_] = ["mout_egl_pll", "dout_bus_pll"];
static mout_egl_pll_p: [_] = ["fin_pll", "fout_egl_pll"];

static samsung_mux_clock egl_mux_clks: [_] = [
	MUX(EGL_MOUT_EGL_PLL, "mout_egl_pll", mout_egl_pll_p,
			MUX_SEL_EGL, 4, 1),
	MUX(EGL_MOUT_EGL_B, "mout_egl_b", mout_egl_b_p, MUX_SEL_EGL, 16, 1),
];

static samsung_div_clock egl_div_clks: [_] = [
...
unsafe fn  exynos5260_clk_egl_init(*mut device_node)
{
...
static mout_phyclk_usbhost20_phyclk_user_p: [_] = ["fin_pll",
			"phyclk_usbhost20_phy_phyclock"];
static mout_phyclk_usbhost20_freeclk_user_p: [_] = ["fin_pll",
			"phyclk_usbhost20_phy_freeclk"];
static mout_phyclk_usbhost20_clk48mohci_user_p: [_] = ["fin_pll",
			"phyclk_usbhost20_phy_clk48mohci"];
static mout_phyclk_usbdrd30_pipe_pclk_user_p: [_] = ["fin_pll",
			"phyclk_usbdrd30_udrd30_pipe_pclk"];
static mout_phyclk_usbdrd30_phyclock_user_p: [_] = ["fin_pll",
			"phyclk_usbdrd30_udrd30_phyclock"];

static samsung_mux_clock fsys_mux_clks: [_] = [
...
static samsung_gate_clock fsys_gate_clks: [_] = [
...
static samsung_cmu_info fsys_cmu  = {
...
unsafe fn  exynos5260_clk_fsys_init(*mut device_node)
{
...
static mout_aclk_g2d_333_user_p: [_] = ["fin_pll", "dout_aclk_g2d_333"];

static samsung_mux_clock g2d_mux_clks: [_] = [
	MUX(G2D_MOUT_ACLK_G2D_333_USER, "mout_aclk_g2d_333_user",
			mout_aclk_g2d_333_user_p,
			MUX_SEL_G2D, 0, 1),
];

static samsung_div_clock g2d_div_clks: [_] = [
	DIV(G2D_DOUT_PCLK_G2D_83, "dout_pclk_g2d_83", "mout_aclk_g2d_333_user",
			DIV_G2D, 0, 3),
];

static samsung_gate_clock g2d_gate_clks: [_] = [
...
static samsung_cmu_info g2d_cmu  = {
...
unsafe fn  exynos5260_clk_g2d_init(*mut device_node)
{
...
static mout_g3d_pll_p: [_] = ["fin_pll", "fout_g3d_pll"];

static samsung_mux_clock g3d_mux_clks: [_] = [
	MUX(G3D_MOUT_G3D_PLL, "mout_g3d_pll", mout_g3d_pll_p,
			MUX_SEL_G3D, 0, 1),
];

static samsung_div_clock g3d_div_clks: [_] = [
...
unsafe fn  exynos5260_clk_g3d_init(*mut device_node)
{
...
static mout_aclk_gscl_333_user_p: [_] = ["fin_pll", "dout_aclk_gscl_333"];
static mout_aclk_m2m_400_user_p: [_] = ["fin_pll", "dout_aclk_gscl_400"];
static mout_aclk_gscl_fimc_user_p: [_] = ["fin_pll", "dout_aclk_gscl_400"];
static mout_aclk_csis_p: [_] = ["dout_aclk_csis_200", "mout_aclk_gscl_fimc_user"];

static samsung_mux_clock gscl_mux_clks: [_] = [
...
static samsung_div_clock gscl_div_clks: [_] = [
...
static samsung_gate_clock gscl_gate_clks: [_] = [
...
static samsung_cmu_info gscl_cmu  = {
...
unsafe fn  exynos5260_clk_gscl_init(*mut device_node)
{
...
static mout_isp_400_user_p: [_] = ["fin_pll", "dout_aclk_isp1_400"];
static mout_isp_266_user_p: [_] = ["fin_pll", "dout_aclk_isp1_266"];

static samsung_mux_clock isp_mux_clks: [_] = [
...
static samsung_div_clock isp_div_clks: [_] = [
...
static samsung_gate_clock isp_gate_clks: [_] = [
...
static samsung_cmu_info isp_cmu  = {
...
unsafe fn  exynos5260_clk_isp_init(*mut device_node)
{
...
static mout_kfc_pll_p: [_] = ["fin_pll", "fout_kfc_pll"];
static mout_kfc_p: [_] = ["mout_kfc_pll", "dout_media_pll"];

static samsung_mux_clock kfc_mux_clks: [_] = [
	MUX(KFC_MOUT_KFC_PLL, "mout_kfc_pll", mout_kfc_pll_p,
			MUX_SEL_KFC0, 0, 1),
	MUX(KFC_MOUT_KFC, "mout_kfc", mout_kfc_p, MUX_SEL_KFC2, 0, 1),
];

static samsung_div_clock kfc_div_clks: [_] = [
...
unsafe fn  exynos5260_clk_kfc_init(*mut device_node)
{
...
static mout_aclk_mfc_333_user_p: [_] = ["fin_pll", "dout_aclk_mfc_333"];

static samsung_mux_clock mfc_mux_clks: [_] = [
	MUX(MFC_MOUT_ACLK_MFC_333_USER, "mout_aclk_mfc_333_user",
			mout_aclk_mfc_333_user_p,
			MUX_SEL_MFC, 0, 1),
];

static samsung_div_clock mfc_div_clks: [_] = [
	DIV(MFC_DOUT_PCLK_MFC_83, "dout_pclk_mfc_83", "mout_aclk_mfc_333_user",
			DIV_MFC, 0, 3),
];

static samsung_gate_clock mfc_gate_clks: [_] = [
...
static samsung_cmu_info mfc_cmu  = {
...
unsafe fn  exynos5260_clk_mfc_init(*mut device_node)
{
...
static mout_mem_pll_p: [_] = ["fin_pll", "fout_mem_pll"];
static mout_bus_pll_p: [_] = ["fin_pll", "fout_bus_pll"];
static mout_media_pll_p: [_] = ["fin_pll", "fout_media_pll"];
static mout_mif_drex_p: [_] = ["dout_mem_pll", "dout_bus_pll"];
static mout_mif_drex2x_p: [_] = ["dout_mem_pll", "dout_bus_pll"];
static mout_clkm_phy_p: [_] = ["mout_mif_drex", "dout_media_pll"];
static mout_clk2x_phy_p: [_] = ["mout_mif_drex2x", "dout_media_pll"];

static samsung_mux_clock mif_mux_clks: [_] = [
...
static samsung_div_clock mif_div_clks: [_] = [
...
static samsung_gate_clock mif_gate_clks: [_] = [
...
static samsung_pll_clock mif_pll_clks: [_] = [
...
static samsung_cmu_info mif_cmu  = {
...
unsafe fn  exynos5260_clk_mif_init(*mut device_node)
{
...
static mout_sclk_pcm_p: [_] = ["ioclk_pcm_extclk", "fin_pll", "dout_aclk_peri_aud",
			"phyclk_hdmi_phy_ref_cko"];
static mout_sclk_i2scod_p: [_] = ["ioclk_i2s_cdclk", "fin_pll", "dout_aclk_peri_aud",
			"phyclk_hdmi_phy_ref_cko"];
static mout_sclk_spdif_p: [_] = ["ioclk_spdif_extclk", "fin_pll",
			"dout_aclk_peri_aud", "phyclk_hdmi_phy_ref_cko"];

static samsung_mux_clock peri_mux_clks: [_] = [
...
static samsung_cmu_info peri_cmu  = {
...
unsafe fn  exynos5260_clk_peri_init(*mut device_node)
{
...
static samsung_fixed_rate_clock fixed_rate_clks: [_] = [
...
static mout_memtop_pll_user_p: [_] = ["fin_pll", "dout_mem_pll"];
static mout_bustop_pll_user_p: [_] = ["fin_pll", "dout_bus_pll"];
static mout_mediatop_pll_user_p: [_] = ["fin_pll", "dout_media_pll"];
static mout_audtop_pll_user_p: [_] = ["fin_pll", "mout_aud_pll"];
static mout_aud_pll_p: [_] = ["fin_pll", "fout_aud_pll"];
static mout_disp_pll_p: [_] = ["fin_pll", "fout_disp_pll"];
static mout_mfc_bustop_333_p: [_] = ["mout_bustop_pll_user", "mout_disp_pll"];
static mout_aclk_mfc_333_p: [_] = ["mout_mediatop_pll_user", "mout_mfc_bustop_333"];
static mout_g2d_bustop_333_p: [_] = ["mout_bustop_pll_user", "mout_disp_pll"];
static mout_aclk_g2d_333_p: [_] = ["mout_mediatop_pll_user", "mout_g2d_bustop_333"];
static mout_gscl_bustop_333_p: [_] = ["mout_bustop_pll_user", "mout_disp_pll"];
static mout_aclk_gscl_333_p: [_] = ["mout_mediatop_pll_user",
			"mout_gscl_bustop_333"];
static mout_m2m_mediatop_400_p: [_] = ["mout_mediatop_pll_user", "mout_disp_pll"];
static mout_aclk_gscl_400_p: [_] = ["mout_bustop_pll_user",
			"mout_m2m_mediatop_400"];
static mout_gscl_bustop_fimc_p: [_] = ["mout_bustop_pll_user", "mout_disp_pll"];
static mout_aclk_gscl_fimc_p: [_] = ["mout_mediatop_pll_user",
			"mout_gscl_bustop_fimc"];
static mout_isp1_media_266_p: [_] = ["mout_mediatop_pll_user",
			"mout_memtop_pll_user"];
static mout_aclk_isp1_266_p: [_] = ["mout_bustop_pll_user", "mout_isp1_media_266"];
static mout_isp1_media_400_p: [_] = ["mout_mediatop_pll_user", "mout_disp_pll"];
static mout_aclk_isp1_400_p: [_] = ["mout_bustop_pll_user", "mout_isp1_media_400"];
static mout_sclk_isp_spi_p: [_] = ["fin_pll", "mout_bustop_pll_user"];
static mout_sclk_isp_uart_p: [_] = ["fin_pll", "mout_bustop_pll_user"];
static mout_sclk_isp_sensor_p: [_] = ["fin_pll", "mout_bustop_pll_user"];
static mout_disp_disp_333_p: [_] = ["mout_disp_pll", "mout_bustop_pll_user"];
static mout_aclk_disp_333_p: [_] = ["mout_mediatop_pll_user", "mout_disp_disp_333"];
static mout_disp_disp_222_p: [_] = ["mout_disp_pll", "mout_bustop_pll_user"];
static mout_aclk_disp_222_p: [_] = ["mout_mediatop_pll_user", "mout_disp_disp_222"];
static mout_disp_media_pixel_p: [_] = ["mout_mediatop_pll_user",
			"mout_bustop_pll_user"];
static mout_sclk_disp_pixel_p: [_] = ["mout_disp_pll", "mout_disp_media_pixel"];
static mout_bus_bustop_400_p: [_] = ["mout_bustop_pll_user", "mout_memtop_pll_user"];
static mout_bus_bustop_100_p: [_] = ["mout_bustop_pll_user", "mout_memtop_pll_user"];
static mout_sclk_peri_spi_clk_p: [_] = ["fin_pll", "mout_bustop_pll_user"];
static mout_sclk_peri_uart_uclk_p: [_] = ["fin_pll", "mout_bustop_pll_user"];
static mout_sclk_fsys_usb_p: [_] = ["fin_pll", "mout_bustop_pll_user"];
static mout_sclk_fsys_mmc_sdclkin_a_p: [_] = ["fin_pll", "mout_bustop_pll_user"];
static mout_sclk_fsys_mmc0_sdclkin_b_p: [_] = ["mout_sclk_fsys_mmc0_sdclkin_a",
			"mout_mediatop_pll_user"];
static mout_sclk_fsys_mmc1_sdclkin_b_p: [_] = ["mout_sclk_fsys_mmc1_sdclkin_a",
			"mout_mediatop_pll_user"];
static mout_sclk_fsys_mmc2_sdclkin_b_p: [_] = ["mout_sclk_fsys_mmc2_sdclkin_a",
			"mout_mediatop_pll_user"];

static samsung_mux_clock top_mux_clks: [_] = [
...
static samsung_div_clock top_div_clks: [_] = [
...
static samsung_gate_clock top_gate_clks: [_] = [
...
static samsung_pll_clock top_pll_clks: [_] = [
...
static samsung_cmu_info top_cmu  = {
...
unsafe fn  exynos5260_clk_top_init(*mut device_node)
{
