...
const CMU_CMU_NR_CLK				(CLK_DOUT_CMU_VIO_AUDIO + 1)
const CMU_BUS_NR_CLK				(CLK_MOUT_BUS_ACLK_USER + 1)
const CMU_CORE_NR_CLK				(CLK_MOUT_CORE_ACLK_USER + 1)
const CMU_CPUCL_NR_CLK			(CLK_GOUT_CPUCL_CSSYS_IPCLKPORT_PCLKDBG + 1)
const CMU_FSYS0_NR_CLK			(CLK_GOUT_FSYS0_PWM_IPCLKPORT_I_PCLK_S0 + 1)
const CMU_FSYS1_NR_CLK			(CLK_GOUT_FSYS1_XHB_USB_IPCLKPORT_CLK + 1)
const CMU_IMEM_NR_CLK				(CLK_GOUT_IMEM_PCLK_TMU0_APBIF + 1)
const CMU_PERI_NR_CLK				(CLK_GOUT_PERI_UART2_SCLK_UART + 1)

/* Register Offset definitions for CMU_CMU (0x12c00000) */
const PLL_LOCKTIME_PLL_AUDIO					0x0000
const PLL_LOCKTIME_PLL_SHARED0				0x0004
const PLL_LOCKTIME_PLL_SHARED1				0x0008
const PLL_CON0_PLL_AUDIO					0x0100
const PLL_CON0_PLL_SHARED0					0x0120
const PLL_CON0_PLL_SHARED1					0x0140
const CLK_CON_MUX_CLKCMU_BUS					0x1000
const CLK_CON_MUX_CLKCMU_CDC_CORE				0x1004
const CLK_CON_MUX_CLKCMU_CORE_MAIN				0x1008
const CLK_CON_MUX_CLKCMU_CPUCL_SWITCH				0x100c
const CLK_CON_MUX_CLKCMU_VIO_AUDIO				0x1010
const CLK_CON_MUX_CLKCMU_DLP_CORE				0x1014
const CLK_CON_MUX_CLKCMU_FSYS0_BUS				0x1018
const CLK_CON_MUX_CLKCMU_FSYS0_IP				0x101c
const CLK_CON_MUX_CLKCMU_FSYS1_BUS				0x1020
const CLK_CON_MUX_CLKCMU_FSYS1_SCAN0				0x1024
const CLK_CON_MUX_CLKCMU_FSYS1_SCAN1				0x1028
const CLK_CON_MUX_CLKCMU_GPU_2D				0x102c
const CLK_CON_MUX_CLKCMU_GPU_3D				0x1030
const CLK_CON_MUX_CLKCMU_IMEM_ACLK				0x1034
const CLK_CON_MUX_CLKCMU_IMEM_CA5				0x1038
const CLK_CON_MUX_CLKCMU_IMEM_JPEG				0x103c
const CLK_CON_MUX_CLKCMU_IMEM_SSS				0x1040
const CLK_CON_MUX_CLKCMU_IPA_CORE				0x1044
const CLK_CON_MUX_CLKCMU_MIF_BUSP				0x1048
const CLK_CON_MUX_CLKCMU_MIF_SWITCH				0x104c
const CLK_CON_MUX_CLKCMU_PERI_DISP				0x1050
const CLK_CON_MUX_CLKCMU_PERI_IP				0x1054
const CLK_CON_MUX_CLKCMU_RSP_CORE				0x1058
const CLK_CON_MUX_CLKCMU_TRFM					0x105c
const CLK_CON_MUX_CLKCMU_VIO_CORE				0x1060
const CLK_CON_MUX_CLKCMU_VIO_CORE_L				0x1064
const CLK_CON_MUX_CLKCMU_VIP0					0x1068
const CLK_CON_MUX_CLKCMU_VIP1					0x106c
const CLK_CON_MUX_CLKCMU_VPP_CORE				0x1070
const CLK_CON_DIV_CLKCMU_ADD					0x1800
const CLK_CON_DIV_CLKCMU_BUS					0x1804
const CLK_CON_DIV_CLKCMU_CDC_CORE				0x1808
const CLK_CON_DIV_CLKCMU_CORE_MAIN				0x180c
const CLK_CON_DIV_CLKCMU_CPUCL_SWITCH				0x1810
const CLK_CON_DIV_CLKCMU_DLP_CORE				0x1814
const CLK_CON_DIV_CLKCMU_FSYS0_BUS				0x1818
const CLK_CON_DIV_CLKCMU_FSYS0_IP				0x181c
const CLK_CON_DIV_CLKCMU_FSYS1_BUS				0x1820
const CLK_CON_DIV_CLKCMU_FSYS1_SCAN0				0x1824
const CLK_CON_DIV_CLKCMU_FSYS1_SCAN1				0x1828
const CLK_CON_DIV_CLKCMU_GPU_2D				0x182c
const CLK_CON_DIV_CLKCMU_GPU_3D				0x1830
const CLK_CON_DIV_CLKCMU_IMEM_ACLK				0x1834
const CLK_CON_DIV_CLKCMU_IMEM_CA5				0x1838
const CLK_CON_DIV_CLKCMU_IMEM_JPEG				0x183c
const CLK_CON_DIV_CLKCMU_IMEM_SSS				0x1840
const CLK_CON_DIV_CLKCMU_IPA_CORE				0x1844
const CLK_CON_DIV_CLKCMU_LCPU					0x1848
const CLK_CON_DIV_CLKCMU_MIF_BUSP				0x184c
const CLK_CON_DIV_CLKCMU_MIF_SWITCH				0x1850
const CLK_CON_DIV_CLKCMU_PERI_DISP				0x1854
const CLK_CON_DIV_CLKCMU_PERI_IP				0x1858
const CLK_CON_DIV_CLKCMU_RSP_CORE				0x185c
const CLK_CON_DIV_CLKCMU_TRFM					0x1860
const CLK_CON_DIV_CLKCMU_VIO_AUDIO				0x1864
const CLK_CON_DIV_CLKCMU_VIO_CORE				0x1868
const CLK_CON_DIV_CLKCMU_VIO_CORE_L				0x186c
const CLK_CON_DIV_CLKCMU_VIP0					0x1870
const CLK_CON_DIV_CLKCMU_VIP1					0x1874
const CLK_CON_DIV_CLKCMU_VPP_CORE				0x1878
const CLK_CON_DIV_PLL_SHARED0_DIV2				0x187c
const CLK_CON_DIV_PLL_SHARED0_DIV3				0x1880
const CLK_CON_DIV_PLL_SHARED0_DIV4				0x1884
const CLK_CON_DIV_PLL_SHARED1_DIV2				0x1888
const CLK_CON_DIV_PLL_SHARED1_DIV3				0x188c
const CLK_CON_DIV_PLL_SHARED1_DIV4				0x1890

static cmu_cmu_clk_regs[]  = {
...
static samsung_pll_rate_table artpec9_pll_audio_rates[]  = {
	PLL_A9FRACO_RATE(25 * MHZ, 589824000U, 94, 1, 3, 6238440),
};

static samsung_pll_clock cmu_cmu_pll_clks[]  = {
	PLL(pll_a9fracm, CLK_FOUT_SHARED0_PLL, "fout_pll_shared0", "fin_pll",
	    PLL_LOCKTIME_PLL_SHARED0, PLL_CON0_PLL_SHARED0, core::ptr::null()),
	PLL(pll_a9fracm, CLK_FOUT_SHARED1_PLL, "fout_pll_shared1", "fin_pll",
	    PLL_LOCKTIME_PLL_SHARED1, PLL_CON0_PLL_SHARED1, core::ptr::null()),
...
static samsung_mux_clock cmu_cmu_mux_clks[]  = {
...
static samsung_div_clock cmu_cmu_div_clks[]  = {
...
static samsung_cmu_info cmu_cmu_info  = {
...
const PLL_LOCKTIME_PLL0_CPUCL					0x0000
const PLL_LOCKTIME_PLL1_CPUCL					0x0008
const PLL_CON0_MUX_CLKCMU_CPUCL_SWITCH_SCU_USER		0x0100
const PLL_CON0_MUX_CLKCMU_CPUCL_SWITCH_USER			0x0120
const PLL_CON0_PLL0_CPUCL					0x0140
const PLL_CON0_PLL1_CPUCL					0x0160
const CLK_CON_MUX_CLK_CPUCL_PLL				0x1000
const CLK_CON_MUX_CLK_CPUCL_PLL_SCU				0x1004
const CLK_CON_DIV_CLK_CPUCL_CLUSTER_PERIPHCLK			0x1800
const CLK_CON_DIV_CLK_CPUCL_CLUSTER_GICCLK			0x1804
const CLK_CON_DIV_CLK_CPUCL_CLUSTER_PCLK			0x1808
const CLK_CON_DIV_CLK_CPUCL_CMUREF				0x180c
const CLK_CON_DIV_CLK_CPUCL_CPU				0x1810
const CLK_CON_DIV_CLK_CPUCL_CLUSTER_ATCLK			0x1818
const CLK_CON_DIV_CLK_CPUCL_CLUSTER_SCU			0x181c
const CLK_CON_DIV_CLK_CPUCL_DBG				0x1820
const CLK_CON_GAT_CLK_CLUSTER_CPU				0x2008
const CLK_CON_GAT_CLK_CPUCL_SHORTSTOP				0x200c
const CSSYS_IPCLKPORT_ATCLK					0x2070
const CSSYS_IPCLKPORT_PCLKDBG					0x2074
const DMYQCH_CON_CSSYS_QCH					0x3000
const DMYQCH_CON_CLUSTER_QCH_CORECLK0				0x3104
const DMYQCH_CON_CLUSTER_QCH_CORECLK1				0x3108
const DMYQCH_CON_CLUSTER_QCH_CORECLK2				0x310c
const DMYQCH_CON_CLUSTER_QCH_CORECLK3				0x3110
const DMYQCH_CON_CLUSTER_QCH_CORECLK4				0x3114
const DMYQCH_CON_CLUSTER_QCH_CORECLK5				0x3118
const DMYQCH_CON_CLUSTER_QCH_PERIPHCLK			0x311c

static cmu_cpucl_clk_regs[]  = {
...
static samsung_mux_clock cmu_cpucl_mux_clks[]  = {
...
static samsung_fixed_factor_clock cpucl_ffactor_clks[]  = {
	FFACTOR(CLK_DOUT_CPUCL_CPU, "dout_clk_cpucl_cpu",
		"mout_clk_cpucl_pll0", 1, 1, CLK_SET_RATE_PARENT),
};

static samsung_div_clock cmu_cpucl_div_clks[]  = {
...
static samsung_gate_clock cmu_cpucl_gate_clks[]  = {
...
static samsung_cmu_info cmu_cpucl_info  = {
...
const PLL_CON0_MUX_CLK_FSYS0_BUS_USER				0x0100
const PLL_CON0_MUX_CLK_FSYS0_IP_USER				0x0120
const PLL_CON0_MUX_CLK_FSYS0_MAIN_USER			0x0140
const CLK_CON_DIV_CLK_FSYS0_125				0x1800
const CLK_CON_DIV_CLK_FSYS0_ADC				0x1804
const CLK_CON_DIV_CLK_FSYS0_BUS_300				0x1808
const CLK_CON_DIV_CLK_FSYS0_EQOS0				0x1814
const CLK_CON_DIV_CLK_FSYS0_EQOS1				0x1818
const CLK_CON_DIV_CLK_FSYS0_EQOS_250				0x181C
const CLK_CON_DIV_CLK_FSYS0_MMC_CARD0				0x1820
const CLK_CON_DIV_CLK_FSYS0_MMC_CARD1				0x1824
const CLK_CON_DIV_CLK_FSYS0_MMC_CARD2				0x1828
const CLK_CON_DIV_CLK_FSYS0_QSPI				0x182c
const CLK_CON_DIV_CLK_FSYS0_SFMC_NAND				0x1830
const CLK_CON_FSYS0_I2C0_IPCLKPORT_I_PCLK			0x2040
const CLK_CON_FSYS0_I2C1_IPCLKPORT_I_PCLK			0x2044
const CLK_CON_MMC0_IPCLKPORT_I_ACLK				0x2078
const CLK_CON_MMC1_IPCLKPORT_I_ACLK				0x2080
const CLK_CON_MMC2_IPCLKPORT_I_ACLK				0x2088
const CLK_CON_PWM_IPCLKPORT_I_PCLK_S0				0x2090
const CLK_CON_DMYQCH_CON_ADC_WRAP_QCH				0x3000
const CLK_CON_DMYQCH_CON_EQOS_TOP0_QCH			0x3004
const CLK_CON_DMYQCH_CON_EQOS_TOP1_QCH			0x3008
const CLK_CON_DMYQCH_CON_FSYS0_I3C0_QCH			0x3010
const CLK_CON_DMYQCH_CON_FSYS0_I3C1_QCH			0x3014
const CLK_CON_DMYQCH_CON_MMC0_QCH				0x3018
const CLK_CON_DMYQCH_CON_MMC1_QCH				0x301c
const CLK_CON_DMYQCH_CON_MMC2_QCH				0x3020
const CLK_CON_DMYQCH_CON_QSPI_QCH				0x3024
const CLK_CON_DMYQCH_CON_SFMC_QCH				0x3028

static cmu_fsys0_clk_regs[]  = {
...
static samsung_mux_clock cmu_fsys0_mux_clks[]  = {
...
static samsung_div_clock cmu_fsys0_div_clks[]  = {
...
static samsung_gate_clock cmu_fsys0_gate_clks[]  = {
...
static samsung_cmu_info cmu_fsys0_info  = {
...
const PLL_LOCKTIME_PLL_FSYS1						0x0000
const PLL_CON0_MUX_CLK_FSYS1_BUS_USER					0x0100
const PLL_CON0_MUX_CLK_FSYS1_SCAN0_USER				0x0120
const PLL_CON0_MUX_CLK_FSYS1_SCAN1_USER				0x0140
const PLL_CON0_PLL_FSYS1						0x0160
const CLK_CON_DIV_CLK_FSYS1_200					0x1808
const CLK_CON_DIV_CLK_FSYS1_BUS_300					0x1810
const CLK_CON_DIV_CLK_FSYS1_OTP_MEM					0x1814
const CLK_CON_DIV_CLK_FSYS1_PCIE_PHY_REFCLK_SYSPLL			0x1818
const CLK_CON_FSYS1_UART0_IPCLKPORT_I_PCLK				0x202c
const CLK_CON_FSYS1_UART0_IPCLKPORT_I_SCLK_UART			0x2030
const CLK_CON_PCIE_TOP_IPCLKPORT_PCIE_PHY_APB2CR_PCLK_300		0x205c
const CLK_CON_PCIE_TOP_IPCLKPORT_PCIE_SUB_CON_X1_DBI_ACLK_SOC		0x2068
const CLK_CON_PCIE_TOP_IPCLKPORT_PCIE_SUB_CON_X1_MSTR_ACLK_SOC	0x206c
const CLK_CON_PCIE_TOP_IPCLKPORT_PCIE_SUB_CON_X1_SLV_ACLK_SOC		0x2070
const CLK_CON_PCIE_TOP_IPCLKPORT_PCIE_SUB_CON_X2_DBI_ACLK_SOC		0x2078
const CLK_CON_PCIE_TOP_IPCLKPORT_PCIE_SUB_CON_X2_MSTR_ACLK_SOC	0x2080
const CLK_CON_PCIE_TOP_IPCLKPORT_PCIE_SUB_CON_X2_SLV_ACLK_SOC		0x2084
const CLK_CON_USB20DRD_IPCLKPORT_ACLK_PHYCTRL_20			0x209c
const CLK_CON_USB20DRD_IPCLKPORT_BUS_CLK_EARLY			0x20a0
const CLK_CON_XHB_AHBBR_FSYS1_IPCLKPORT_CLK				0x20a8
const CLK_CON_XHB_USB_IPCLKPORT_CLK					0x20ac
const CLK_CON_DMYQCH_CON_TZ400_QCH					0x3004
const CLK_CON_DMYQCH_CON_PCIE_TOP_QCH_PHY_100				0x309c
const CLK_CON_QCH_CON_MMU_FSYS1_QCH_U_TBU_0_0				0x3050
const CLK_CON_QCH_CON_MMU_FSYS1_QCH_U_TBU_1_0				0x3058

static cmu_fsys1_clk_regs[]  = {
...
static samsung_pll_rate_table artpec9_pll_fsys1_rates[]  = {
	PLL_35XX_RATE(25 * MHZ, 2000000000U, 80, 1, 0),
};

static samsung_pll_clock cmu_fsys1_pll_clks[]  = {
...
static samsung_mux_clock cmu_fsys1_mux_clks[]  = {
...
static samsung_div_clock cmu_fsys1_div_clks[]  = {
...
static samsung_gate_clock cmu_fsys1_gate_clks[]  = {
...
static samsung_cmu_info cmu_fsys1_info  = {
...
const PLL_CON0_MUX_CLK_IMEM_ACLK_USER				0x0100
const PLL_CON0_MUX_CLK_IMEM_CA5_USER				0x0120
const PLL_CON0_MUX_CLK_IMEM_JPEG_USER				0x0140
const PLL_CON0_MUX_CLK_IMEM_SSS_USER				0x0160
const CLK_CON_MCT0_IPCLKPORT_PCLK					0x20b4
const CLK_CON_MCT1_IPCLKPORT_PCLK					0x20b8
const CLK_CON_MCT2_IPCLKPORT_PCLK					0x20bc
const CLK_CON_MCT3_IPCLKPORT_PCLK					0x20c0
const CLK_CON_TMU_APB_IPCLKPORT_PCLK					0x20d4
const CLK_CON_DMYQCH_CON_CA5_0_QCH					0x3008
const CLK_CON_DMYQCH_CON_CA5_1_QCH					0x3018
const CLK_CON_DMYQCH_CON_INTMEM_QCH					0x3020
const CLK_CON_QCH_CON_GIC_CA55_QCHANNEL_SLAVE_0			0x306c
const CLK_CON_QCH_CON_GIC_CA5_0_QCH					0x3078
const CLK_CON_QCH_CON_GIC_CA5_1_QCH					0x307c
const CLK_CON_QCH_CON_MMU_IMEM_QCH_U_TBU_0_0				0x30ac
const CLK_CON_QCH_CON_MMU_IMEM_QCH_U_TBU_1_0				0x30b4

static cmu_imem_clk_regs[]  = {
...
static samsung_mux_clock cmu_imem_mux_clks[]  = {
...
static samsung_fixed_factor_clock imem_ffactor_clks[]  = {
	FFACTOR(CLK_DOUT_IMEM_PCLK, "dout_clk_imem_pclk", "mout_clk_imem_aclk_user", 1, 2, 0),
};

static samsung_gate_clock cmu_imem_gate_clks[]  = {
...
static samsung_cmu_info cmu_imem_info  = {
...
static void  artpec9_cmu_imem_init(struct device_node *np)
{
	exynos_arm64_register_cmu(core::ptr::null(), np, &cmu_imem_info);
}
...
const PLL_CON0_MUX_CLK_PERI_DISP_USER				0x0100
const PLL_CON0_MUX_CLK_PERI_IP_USER				0x0120
const CLK_CON_DIV_CLK_PERI_125				0x1800
const CLK_CON_DIV_CLK_PERI_PCLK				0x180c
const CLK_CON_DIV_CLK_PERI_SPI				0x1810
const CLK_CON_DIV_CLK_PERI_UART1				0x1814
const CLK_CON_DIV_CLK_PERI_UART2				0x1818
const CLK_CON_APB_ASYNC_DSIM_IPCLKPORT_PCLKS				0x2000
const CLK_CON_PERI_I2C2_IPCLKPORT_I_PCLK				0x202c
const CLK_CON_PERI_I2C3_IPCLKPORT_I_PCLK				0x2030
const CLK_CON_PERI_SPI0_IPCLKPORT_I_PCLK				0x2054
const CLK_CON_PERI_SPI0_IPCLKPORT_I_SCLK_SPI				0x2058
const CLK_CON_PERI_UART1_IPCLKPORT_I_PCLK				0x205c
const CLK_CON_PERI_UART1_IPCLKPORT_I_SCLK_UART			0x2060
const CLK_CON_PERI_UART2_IPCLKPORT_I_PCLK				0x2064
const CLK_CON_PERI_UART2_IPCLKPORT_I_SCLK_UART			0x2068
const CLK_CON_DMYQCH_CON_DMA4DSIM_QCH					0x3000
const CLK_CON_DMYQCH_CON_PERI_I3C2_QCH				0x3004
const CLK_CON_DMYQCH_CON_PERI_I3C3_QCH				0x3008

static cmu_peri_clk_regs[]  = {
...
static samsung_mux_clock cmu_peri_mux_clks[]  = {
...
static samsung_div_clock cmu_peri_div_clks[]  = {
...
static samsung_gate_clock cmu_peri_gate_clks[]  = {
...
static samsung_cmu_info cmu_peri_info  = {
...
static int  artpec9_cmu_probe(struct platform_device *pdev)
{
...
static of_device_id artpec9_cmu_of_match[] = {
	{
...
static struct platform_driver artpec9_cmu_driver  = {
	.driver = {
		.name = "artpec9-cmu",
...
static int  artpec9_cmu_init(void)
{
