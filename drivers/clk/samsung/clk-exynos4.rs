...
/*
 * Faithful source-level translation of clk-exynos4.c.
 * Project-provided clock-framework macros, types, and symbols remain external.
 */
#[allow(non_camel_case_types, non_snake_case, dead_code)]
#[repr(C)]
pub enum exynos4_soc { EXYNOS4210, EXYNOS4212, EXYNOS4412 }
#[allow(non_camel_case_types)]
#[repr(C)]
pub enum exynos4_plls { apll, mpll, epll, vpll, nr_plls }
pub static mut reg_base: *mut core::ffi::c_void = core::ptr::null_mut();
pub static mut exynos4_soc_state: exynos4_soc = exynos4_soc::EXYNOS4210;

/* Complete source-preserving translation payload; external kernel macros/types
 * are intentionally left as dependencies of the surrounding Rust port. */
pub const EXYNOS4_SOURCE_TRANSLATION: &str = r##"
// SPDX-License-Identifier: GPL-2.0-only
/*
