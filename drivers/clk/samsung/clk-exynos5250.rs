...
const PWR_CTRL1: u32 = 0x1020;
const PWR_CTRL2: u32 = 0x1024;
const MPLL_LOCK: u32 = 0x4000;
const MPLL_CON0: u32 = 0x4100;
const SRC_CORE1: u32 = 0x4204;
const GATE_IP_ACP: u32 = 0x8800;
const GATE_IP_ISP0: u32 = 0xc800;
const GATE_IP_ISP1: u32 = 0xc804;
const CPLL_LOCK: u32 = 0x10020;
const EPLL_LOCK: u32 = 0x10030;
const VPLL_LOCK: u32 = 0x10040;
const GPLL_LOCK: u32 = 0x10050;
const CPLL_CON0: u32 = 0x10120;
const EPLL_CON0: u32 = 0x10130;
const VPLL_CON0: u32 = 0x10140;
const GPLL_CON0: u32 = 0x10150;
const SRC_TOP0: u32 = 0x10210;
const SRC_TOP1: u32 = 0x10214;
const SRC_TOP2: u32 = 0x10218;
const SRC_TOP3: u32 = 0x1021c;
const SRC_GSCL: u32 = 0x10220;
const SRC_DISP1_0: u32 = 0x1022c;
const SRC_MAU: u32 = 0x10240;
const SRC_FSYS: u32 = 0x10244;
const SRC_GEN: u32 = 0x10248;
const SRC_PERIC0: u32 = 0x10250;
const SRC_PERIC1: u32 = 0x10254;
const SRC_MASK_GSCL: u32 = 0x10320;
const SRC_MASK_DISP1_0: u32 = 0x1032c;
const SRC_MASK_MAU: u32 = 0x10334;
const SRC_MASK_FSYS: u32 = 0x10340;
const SRC_MASK_GEN: u32 = 0x10344;
const SRC_MASK_PERIC0: u32 = 0x10350;
const SRC_MASK_PERIC1: u32 = 0x10354;
const DIV_TOP0: u32 = 0x10510;
const DIV_TOP1: u32 = 0x10514;
const DIV_GSCL: u32 = 0x10520;
const DIV_DISP1_0: u32 = 0x1052c;
const DIV_GEN: u32 = 0x1053c;
...
const DIV_PERIC5: u32 = 0x1056c;
const GATE_IP_GSCL: u32 = 0x10920;
const GATE_IP_DISP1: u32 = 0x10928;
const GATE_IP_MFC: u32 = 0x1092c;
const GATE_IP_G3D: u32 = 0x10930;
const GATE_IP_GEN: u32 = 0x10934;
...
const PLL_DIV2_SEL: u32 = 0x20a24;
// 
/*Below definitions are used for PWR_CTRL settings*/
const PWR_CTRL1_CORE2_DOWN_RATIO: u32 = (7 << 28);
const PWR_CTRL1_CORE1_DOWN_RATIO: u32 = (7 << 16);
...
const PWR_CTRL2_DIV2_UP_EN: u32 = (1 << 25);
const PWR_CTRL2_DIV1_UP_EN: u32 = (1 << 24);
const PWR_CTRL2_DUR_STANDBY2_VAL: u32 = (1 << 16);
const PWR_CTRL2_DUR_STANDBY1_VAL: u32 = (1 << 8);
const PWR_CTRL2_CORE2_UP_RATIO: u32 = (1 << 4);
const PWR_CTRL2_CORE1_UP_RATIO: u32 = (1 << 0);
// 
/* NOTE: Must be equal to the last clock ID increased by one */
const CLKS_NR: u32 = (CLK_MOUT_VPLLSRC + 1);
// 
 ...
 */
static const u32 exynos5250_clk_regs[]  = {
	SRC_CPU,
	DIV_CPU0,
	PWR_CTRL1,
	PWR_CTRL2,
...
static samsung_fixed_rate_clock exynos5250_fixed_rate_ext_clks[]  = {
	FRATE(CLK_FIN_PLL, "fin_pll", core::ptr::null_mut(), 0, 0),
};
// 
/* fixed rate clocks generated inside the soc */
static const samsung_fixed_rate_clock exynos5250_fixed_rate_clks[]  = {
	FRATE(CLK_SCLK_HDMIPHY, "sclk_hdmiphy", core::ptr::null_mut(), 0, 24000000),
	FRATE(0, "sclk_hdmi27m", core::ptr::null_mut(), 0, 27000000),
	FRATE(0, "sclk_dptxphy", core::ptr::null_mut(), 0, 24000000),
	FRATE(0, "sclk_uhostphy", core::ptr::null_mut(), 0, 48000000),
};

static const samsung_fixed_factor_clock exynos5250_fixed_factor_clks[]  = {
	FFACTOR(0, "fout_mplldiv2", "fout_mpll", 1, 2, 0),
	FFACTOR(0, "fout_bplldiv2", "fout_bpll", 1, 2, 0),
};

static const samsung_mux_clock exynos5250_pll_pmux_clks[]  = {
	MUX(CLK_MOUT_VPLLSRC, "mout_vpllsrc", mout_vpllsrc_p, SRC_TOP2, 0, 1),
};

static const samsung_mux_clock exynos5250_mux_clks[]  = {
	/*
...
static const samsung_div_clock exynos5250_div_clks[]  = {
	/*
	 * NOTE: Following table is sorted by (clock domain, register address,
	 * bitfield shift) triplet in ascending order. When adding new entries,
	 * please make sure that the order is kept, to avoid merge conflicts
...
static const samsung_gate_clock exynos5250_gate_clks[]  = {
	/*
	 * NOTE: Following table is sorted by (clock domain, register address,
	 * bitfield shift) triplet in ascending order. When adding new entries,
	 * please make sure that the order is kept, to avoid merge conflicts
...
static const samsung_gate_clock exynos5250_disp_gate_clks[]  = {
...
static exynos5_subcmu_reg_dump exynos5250_disp_suspend_regs[] = {
...
static const samsung_pll_rate_table vpll_24mhz_tbl[]  = {
...
static const samsung_pll_rate_table epll_24mhz_tbl[]  = {
// 	/* sorted in descending order */
// 	/* PLL_36XX_RATE(rate, m, p, s, k) */
...
static const samsung_pll_rate_table apll_24mhz_tbl[]  = {
// 	/* sorted in descending order */
...
static samsung_pll_clock exynos5250_plls[nr_plls]  = {
	...
	[vpll] = PLL(pll_36xx, CLK_FOUT_VPLL, "fout_vpll", "mout_vpllsrc",
		VPLL_LOCK, VPLL_CON0, core::ptr::null_mut()),
};
...
static const exynos_cpuclk_cfg_data exynos5250_armclk_d[]  = {
...
static void  exynos5250_clk_init(struct device_node *np)
{
	...
	samsung_clk_sleep_init(reg_base, core::ptr::null_mut(), exynos5250_clk_regs,
