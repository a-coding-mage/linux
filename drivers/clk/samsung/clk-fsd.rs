...
// Faithful source-level Rust translation of clk-fsd.c.
// External kernel clock types, macros, constants, and registration facilities are
// supplied by dependencies from the surrounding translation unit.
...
const PLL_LOCKTIME_PLL_SHARED0: usize = 0x0;
const PLL_LOCKTIME_PLL_SHARED1: usize = 0x4;
const PLL_LOCKTIME_PLL_SHARED2: usize = 0x8;
const PLL_LOCKTIME_PLL_SHARED3: usize = 0xc;
const PLL_CON0_PLL_SHARED0: usize = 0x100;
const PLL_CON0_PLL_SHARED1: usize = 0x120;
const PLL_CON0_PLL_SHARED2: usize = 0x140;
const PLL_CON0_PLL_SHARED3: usize = 0x160;
const MUX_CMU_CIS0_CLKMUX: usize = 0x1000;
const MUX_CMU_CIS1_CLKMUX: usize = 0x1004;
const MUX_CMU_CIS2_CLKMUX: usize = 0x1008;
const MUX_CMU_CPUCL_SWITCHMUX: usize = 0x100c;
const MUX_CMU_FSYS1_ACLK_MUX: usize = 0x1014;
const MUX_PLL_SHARED0_MUX: usize = 0x1020;
const MUX_PLL_SHARED1_MUX: usize = 0x1024;
const DIV_CMU_CIS0_CLK: usize = 0x1800;
const DIV_CMU_CIS1_CLK: usize = 0x1804;
const DIV_CMU_CIS2_CLK: usize = 0x1808;
const DIV_CMU_CMU_ACLK: usize = 0x180c;
const DIV_CMU_CPUCL_SWITCH: usize = 0x1810;
const DIV_CMU_FSYS0_SHARED0DIV4: usize = 0x181c;
const DIV_CMU_FSYS0_SHARED1DIV3: usize = 0x1820;
const DIV_CMU_FSYS0_SHARED1DIV4: usize = 0x1824;
const DIV_CMU_FSYS1_SHARED0DIV4: usize = 0x1828;
const DIV_CMU_FSYS1_SHARED0DIV8: usize = 0x182c;
const DIV_CMU_IMEM_ACLK: usize = 0x1834;
const DIV_CMU_IMEM_DMACLK: usize = 0x1838;
const DIV_CMU_IMEM_TCUCLK: usize = 0x183c;
const DIV_CMU_PERIC_SHARED0DIV20: usize = 0x1844;
const DIV_CMU_PERIC_SHARED0DIV3_TBUCLK: usize = 0x1848;
const DIV_CMU_PERIC_SHARED1DIV36: usize = 0x184c;
const DIV_CMU_PERIC_SHARED1DIV4_DMACLK: usize = 0x1850;
const DIV_PLL_SHARED0_DIV2: usize = 0x1858;
const DIV_PLL_SHARED0_DIV3: usize = 0x185c;
const DIV_PLL_SHARED0_DIV4: usize = 0x1860;
const DIV_PLL_SHARED0_DIV6: usize = 0x1864;
const DIV_PLL_SHARED1_DIV3: usize = 0x1868;
const DIV_PLL_SHARED1_DIV36: usize = 0x186c;
const DIV_PLL_SHARED1_DIV4: usize = 0x1870;
const DIV_PLL_SHARED1_DIV9: usize = 0x1874;
const GAT_CMU_CIS0_CLKGATE: usize = 0x2000;
const GAT_CMU_CIS1_CLKGATE: usize = 0x2004;
const GAT_CMU_CIS2_CLKGATE: usize = 0x2008;
const GAT_CMU_CPUCL_SWITCH_GATE: usize = 0x200c;
const GAT_CMU_FSYS0_SHARED0DIV4_GATE: usize = 0x2018;
const GAT_CMU_FSYS0_SHARED1DIV4_CLK: usize = 0x201c;
const GAT_CMU_FSYS0_SHARED1DIV4_GATE: usize = 0x2020;
const GAT_CMU_FSYS1_SHARED0DIV4_GATE: usize = 0x2024;
const GAT_CMU_FSYS1_SHARED1DIV4_GATE: usize = 0x2028;
const GAT_CMU_IMEM_ACLK_GATE: usize = 0x2030;
const GAT_CMU_IMEM_DMACLK_GATE: usize = 0x2034;
const GAT_CMU_IMEM_TCUCLK_GATE: usize = 0x2038;
const GAT_CMU_PERIC_SHARED0DIVE3_TBUCLK_GATE: usize = 0x2040;
const GAT_CMU_PERIC_SHARED0DIVE4_GATE: usize = 0x2044;
const GAT_CMU_PERIC_SHARED1DIV4_DMACLK_GATE: usize = 0x2048;
const GAT_CMU_PERIC_SHARED1DIVE4_GATE: usize = 0x204c;
const GAT_CMU_CMU_CMU_IPCLKPORT_PCLK: usize = 0x2054;
const GAT_CMU_AXI2APB_CMU_IPCLKPORT_ACLK: usize = 0x2058;
const GAT_CMU_NS_BRDG_CMU_IPCLKPORT_CLK__PSOC_CMU__CLK_CMU: usize = 0x205c;
const GAT_CMU_SYSREG_CMU_IPCLKPORT_PCLK: usize = 0x2060;

/* NOTE: Must be equal to the last clock ID increased by one */
const CLKS_NR_CMU: usize = (GAT_CMU_FSYS0_SHARED0DIV4 + 1);
const CLKS_NR_PERIC: usize = (PERIC_DOUT_RGMII_CLK + 1);
const CLKS_NR_FSYS0: usize = (FSYS0_DOUT_FSYS0_PERIBUS_GRP + 1);
const CLKS_NR_FSYS1: usize = (PCIE_LINK1_IPCLKPORT_SLV_ACLK + 1);
const CLKS_NR_IMEM: usize = (IMEM_TMU_GT_IPCLKPORT_I_CLK_TS + 1);
const CLKS_NR_MFC: usize = (MFC_MFC_IPCLKPORT_ACLK + 1);
const CLKS_NR_CAM_CSI: usize = (CAM_CSI2_3_IPCLKPORT_I_PCLK + 1);

static cmu_clk_regs: &[usize] = &[
...
static pll_shared0_rate_table: &[/* external clock descriptor */] = &[
	pll_35xx_rate!(24 * MHZ, 2000000000u32, 250, 3, 0),
];

static pll_shared1_rate_table: &[/* external clock descriptor */] = &[
	pll_35xx_rate!(24 * MHZ, 2400000000u32, 200, 2, 0),
];

static pll_shared2_rate_table: &[/* external clock descriptor */] = &[
	pll_35xx_rate!(24 * MHZ, 2400000000u32, 200, 2, 0),
];

static pll_shared3_rate_table: &[/* external clock descriptor */] = &[
	pll_35xx_rate!(24 * MHZ, 1800000000u32, 150, 2, 0),
];

static cmu_pll_clks: &[/* external clock descriptor */] = &[
...
static mout_cmu_shared0_pll_p: &[&str] = &[ "fin_pll", "fout_pll_shared0" };
static mout_cmu_shared1_pll_p: &[&str] = &[ "fin_pll", "fout_pll_shared1" };
static mout_cmu_shared2_pll_p: &[&str] = &[ "fin_pll", "fout_pll_shared2" };
static mout_cmu_shared3_pll_p: &[&str] = &[ "fin_pll", "fout_pll_shared3" };
static mout_cmu_cis0_clkmux_p: &[&str] = &[ "fin_pll", "dout_cmu_pll_shared0_div4" };
static mout_cmu_cis1_clkmux_p: &[&str] = &[ "fin_pll", "dout_cmu_pll_shared0_div4" };
static mout_cmu_cis2_clkmux_p: &[&str] = &[ "fin_pll", "dout_cmu_pll_shared0_div4" };
static mout_cmu_cpucl_switchmux_p: &[&str] = &[ "mout_cmu_pll_shared2", "mout_cmu_pll_shared0_mux" };
static mout_cmu_fsys1_aclk_mux_p: &[&str] = &[ "dout_cmu_pll_shared0_div4", "fin_pll" };
static mout_cmu_pll_shared0_mux_p: &[&str] = &[ "fin_pll", "mout_cmu_pll_shared0" };
static mout_cmu_pll_shared1_mux_p: &[&str] = &[ "fin_pll", "mout_cmu_pll_shared1" };

static cmu_mux_clks: &[/* external clock descriptor */] = &[
...
static cmu_div_clks: &[/* external clock descriptor */] = &[
...
static cmu_gate_clks: &[/* external clock descriptor */] = &[
...
static cmu_cmu_info: /* samsung_cmu_info */ = {
    pll_clks: cmu_pll_clks,
    nr_pll_clks: cmu_pll_clks.len(),
    mux_clks: cmu_mux_clks,
    nr_mux_clks: cmu_mux_clks.len(),
    div_clks: cmu_div_clks,
    nr_div_clks: cmu_div_clks.len(),
    gate_clks: cmu_gate_clks,
    nr_gate_clks: cmu_gate_clks.len(),
...
const PLL_CON0_PERIC_DMACLK_MUX: usize = 0x100;
const PLL_CON0_PERIC_EQOS_BUSCLK_MUX: usize = 0x120;
const PLL_CON0_PERIC_PCLK_MUX: usize = 0x140;
const PLL_CON0_PERIC_TBUCLK_MUX: usize = 0x160;
const PLL_CON0_SPI_CLK: usize = 0x180;
const PLL_CON0_SPI_PCLK: usize = 0x1a0;
const PLL_CON0_UART_CLK: usize = 0x1c0;
const PLL_CON0_UART_PCLK: usize = 0x1e0;
const MUX_PERIC_EQOS_PHYRXCLK: usize = 0x1000;
const DIV_EQOS_BUSCLK: usize = 0x1800;
const DIV_PERIC_MCAN_CLK: usize = 0x1804;
const DIV_RGMII_CLK: usize = 0x1808;
const DIV_RII_CLK: usize = 0x180c;
const DIV_RMII_CLK: usize = 0x1810;
const DIV_SPI_CLK: usize = 0x1814;
const DIV_UART_CLK: usize = 0x1818;
const GAT_EQOS_TOP_IPCLKPORT_CLK_PTP_REF_I: usize = 0x2000;
const GAT_GPIO_PERIC_IPCLKPORT_OSCCLK: usize = 0x2004;
const GAT_PERIC_ADC0_IPCLKPORT_I_OSCCLK: usize = 0x2008;
const GAT_PERIC_CMU_PERIC_IPCLKPORT_PCLK: usize = 0x200c;
const GAT_PERIC_PWM0_IPCLKPORT_I_OSCCLK: usize = 0x2010;
const GAT_PERIC_PWM1_IPCLKPORT_I_OSCCLK: usize = 0x2014;
const GAT_ASYNC_APB_DMA0_IPCLKPORT_PCLKM: usize = 0x2018;
const GAT_ASYNC_APB_DMA0_IPCLKPORT_PCLKS: usize = 0x201c;
const GAT_ASYNC_APB_DMA1_IPCLKPORT_PCLKM: usize = 0x2020;
const GAT_ASYNC_APB_DMA1_IPCLKPORT_PCLKS: usize = 0x2024;
const GAT_AXI2APB_PERIC0_IPCLKPORT_ACLK: usize = 0x2028;
const GAT_AXI2APB_PERIC1_IPCLKPORT_ACLK: usize = 0x202c;
const GAT_AXI2APB_PERIC2_IPCLKPORT_ACLK: usize = 0x2030;
const GAT_BUS_D_PERIC_IPCLKPORT_DMACLK: usize = 0x2034;
const GAT_BUS_D_PERIC_IPCLKPORT_EQOSCLK: usize = 0x2038;
const GAT_BUS_D_PERIC_IPCLKPORT_MAINCLK: usize = 0x203c;
const GAT_BUS_P_PERIC_IPCLKPORT_EQOSCLK: usize = 0x2040;
const GAT_BUS_P_PERIC_IPCLKPORT_MAINCLK: usize = 0x2044;
const GAT_BUS_P_PERIC_IPCLKPORT_SMMUCLK: usize = 0x2048;
const GAT_EQOS_TOP_IPCLKPORT_ACLK_I: usize = 0x204c;
const GAT_EQOS_TOP_IPCLKPORT_CLK_RX_I: usize = 0x2050;
const GAT_EQOS_TOP_IPCLKPORT_HCLK_I: usize = 0x2054;
const GAT_EQOS_TOP_IPCLKPORT_RGMII_CLK_I: usize = 0x2058;
const GAT_EQOS_TOP_IPCLKPORT_RII_CLK_I: usize = 0x205c;
const GAT_EQOS_TOP_IPCLKPORT_RMII_CLK_I: usize = 0x2060;
const GAT_GPIO_PERIC_IPCLKPORT_PCLK: usize = 0x2064;
const GAT_NS_BRDG_PERIC_IPCLKPORT_CLK__PSOC_PERIC__CLK_PERIC_D: usize = 0x2068;
const GAT_NS_BRDG_PERIC_IPCLKPORT_CLK__PSOC_PERIC__CLK_PERIC_P: usize = 0x206c;
const GAT_PERIC_ADC0_IPCLKPORT_PCLK_S0: usize = 0x2070;
const GAT_PERIC_DMA0_IPCLKPORT_ACLK: usize = 0x2074;
const GAT_PERIC_DMA1_IPCLKPORT_ACLK: usize = 0x2078;
const GAT_PERIC_I2C0_IPCLKPORT_I_PCLK: usize = 0x207c;
const GAT_PERIC_I2C1_IPCLKPORT_I_PCLK: usize = 0x2080;
const GAT_PERIC_I2C2_IPCLKPORT_I_PCLK: usize = 0x2084;
const GAT_PERIC_I2C3_IPCLKPORT_I_PCLK: usize = 0x2088;
const GAT_PERIC_I2C4_IPCLKPORT_I_PCLK: usize = 0x208c;
const GAT_PERIC_I2C5_IPCLKPORT_I_PCLK: usize = 0x2090;
const GAT_PERIC_I2C6_IPCLKPORT_I_PCLK: usize = 0x2094;
const GAT_PERIC_I2C7_IPCLKPORT_I_PCLK: usize = 0x2098;
const GAT_PERIC_MCAN0_IPCLKPORT_CCLK: usize = 0x209c;
const GAT_PERIC_MCAN0_IPCLKPORT_PCLK: usize = 0x20a0;
const GAT_PERIC_MCAN1_IPCLKPORT_CCLK: usize = 0x20a4;
const GAT_PERIC_MCAN1_IPCLKPORT_PCLK: usize = 0x20a8;
const GAT_PERIC_MCAN2_IPCLKPORT_CCLK: usize = 0x20ac;
const GAT_PERIC_MCAN2_IPCLKPORT_PCLK: usize = 0x20b0;
const GAT_PERIC_MCAN3_IPCLKPORT_CCLK: usize = 0x20b4;
const GAT_PERIC_MCAN3_IPCLKPORT_PCLK: usize = 0x20b8;
const GAT_PERIC_PWM0_IPCLKPORT_I_PCLK_S0: usize = 0x20bc;
const GAT_PERIC_PWM1_IPCLKPORT_I_PCLK_S0: usize = 0x20c0;
const GAT_PERIC_SMMU_IPCLKPORT_CCLK: usize = 0x20c4;
const GAT_PERIC_SMMU_IPCLKPORT_PERIC_BCLK: usize = 0x20c8;
const GAT_PERIC_SPI0_IPCLKPORT_I_PCLK: usize = 0x20cc;
const GAT_PERIC_SPI0_IPCLKPORT_I_SCLK_SPI: usize = 0x20d0;
const GAT_PERIC_SPI1_IPCLKPORT_I_PCLK: usize = 0x20d4;
const GAT_PERIC_SPI1_IPCLKPORT_I_SCLK_SPI: usize = 0x20d8;
const GAT_PERIC_SPI2_IPCLKPORT_I_PCLK: usize = 0x20dc;
const GAT_PERIC_SPI2_IPCLKPORT_I_SCLK_SPI: usize = 0x20e0;
const GAT_PERIC_TDM0_IPCLKPORT_HCLK_M: usize = 0x20e4;
const GAT_PERIC_TDM0_IPCLKPORT_PCLK: usize = 0x20e8;
const GAT_PERIC_TDM1_IPCLKPORT_HCLK_M: usize = 0x20ec;
const GAT_PERIC_TDM1_IPCLKPORT_PCLK: usize = 0x20f0;
const GAT_PERIC_UART0_IPCLKPORT_I_SCLK_UART: usize = 0x20f4;
const GAT_PERIC_UART0_IPCLKPORT_PCLK: usize = 0x20f8;
const GAT_PERIC_UART1_IPCLKPORT_I_SCLK_UART: usize = 0x20fc;
const GAT_PERIC_UART1_IPCLKPORT_PCLK: usize = 0x2100;
const GAT_SYSREG_PERI_IPCLKPORT_PCLK: usize = 0x2104;

static peric_clk_regs: &[usize] = &[
...
static peric_fixed_clks: &[/* external clock descriptor */] = &[
	FRATE!(PERIC_EQOS_PHYRXCLK, "eqos_phyrxclk", None, 0, 125000000),
];

/* List of parent clocks for Muxes in CMU_PERIC */
static mout_peric_dmaclk_p: &[&str] = &[ "fin_pll", "cmu_peric_shared1div4_dmaclk_gate" };
static mout_peric_eqos_busclk_p: &[&str] = &[ "fin_pll", "dout_cmu_pll_shared0_div4" };
static mout_peric_pclk_p: &[&str] = &[ "fin_pll", "dout_cmu_peric_shared1div36" };
static mout_peric_tbuclk_p: &[&str] = &[ "fin_pll", "dout_cmu_peric_shared0div3_tbuclk" };
static mout_peric_spi_clk_p: &[&str] = &[ "fin_pll", "dout_cmu_peric_shared0div20" };
static mout_peric_spi_pclk_p: &[&str] = &[ "fin_pll", "dout_cmu_peric_shared1div36" };
static mout_peric_uart_clk_p: &[&str] = &[ "fin_pll", "dout_cmu_peric_shared1div4_dmaclk" };
static mout_peric_uart_pclk_p: &[&str] = &[ "fin_pll", "dout_cmu_peric_shared1div36" };
static mout_peric_eqos_phyrxclk_p: &[&str] = &[ "dout_peric_rgmii_clk", "eqos_phyrxclk" };

static peric_mux_clks: &[/* external clock descriptor */] = &[
...
static peric_div_clks: &[/* external clock descriptor */] = &[
...
static peric_gate_clks: &[/* external clock descriptor */] = &[
...
static peric_cmu_info: /* samsung_cmu_info */ = {
    mux_clks: peric_mux_clks,
    nr_mux_clks: peric_mux_clks.len(),
    div_clks: peric_div_clks,
    nr_div_clks: peric_div_clks.len(),
    gate_clks: peric_gate_clks,
    nr_gate_clks: peric_gate_clks.len(),
    fixed_clks: peric_fixed_clks,
    nr_fixed_clks: peric_fixed_clks.len(),
    nr_clk_ids: CLKS_NR_PERIC,
    clk_regs: peric_clk_regs,
    nr_clk_regs: peric_clk_regs.len(),
    clk_name: "dout_cmu_pll_shared0_div4",
];

/* Register Offset definitions for CMU_FSYS0 (0x15010000) */
const PLL_CON0_CLKCMU_FSYS0_UNIPRO: usize = 0x100;
const PLL_CON0_CLK_FSYS0_SLAVEBUSCLK: usize = 0x140;
const PLL_CON0_EQOS_RGMII_125_MUX1: usize = 0x160;
const DIV_CLK_UNIPRO: usize = 0x1800;
const DIV_EQS_RGMII_CLK_125: usize = 0x1804;
const DIV_PERIBUS_GRP: usize = 0x1808;
const DIV_EQOS_RII_CLK2O5: usize = 0x180c;
const DIV_EQOS_RMIICLK_25: usize = 0x1810;
const DIV_PCIE_PHY_OSCCLK: usize = 0x1814;
const GAT_FSYS0_EQOS_TOP0_IPCLKPORT_CLK_PTP_REF_I: usize = 0x2004;
const GAT_FSYS0_EQOS_TOP0_IPCLKPORT_CLK_RX_I: usize = 0x2008;
const GAT_FSYS0_FSYS0_CMU_FSYS0_IPCLKPORT_PCLK: usize = 0x200c;
const GAT_FSYS0_GPIO_FSYS0_IPCLKPORT_OSCCLK: usize = 0x2010;
const GAT_FSYS0_PCIE_TOP_IPCLKPORT_PCIEG3_PHY_X4_INST_0_PLL_REFCLK_FROM_XO: usize = 0x2014;
const GAT_FSYS0_PCIE_TOP_IPCLKPORT_PIPE_PAL_INST_0_I_IMMORTAL_CLK: usize = 0x2018;
const GAT_FSYS0_PCIE_TOP_IPCLKPORT_FSD_PCIE_SUB_CTRL_INST_0_AUX_CLK_SOC: usize = 0x201c;
const GAT_FSYS0_UFS_TOP0_IPCLKPORT_I_MPHY_REFCLK_IXTAL24: usize = 0x2020;
const GAT_FSYS0_UFS_TOP0_IPCLKPORT_I_MPHY_REFCLK_IXTAL26: usize = 0x2024;
const GAT_FSYS0_UFS_TOP1_IPCLKPORT_I_MPHY_REFCLK_IXTAL24: usize = 0x2028;
const GAT_FSYS0_UFS_TOP1_IPCLKPORT_I_MPHY_REFCLK_IXTAL26: usize = 0x202c;
const GAT_FSYS0_AHBBR_FSYS0_IPCLKPORT_HCLK: usize = 0x2038;
const GAT_FSYS0_AXI2APB_FSYS0_IPCLKPORT_ACLK: usize = 0x203c;
const GAT_FSYS0_BUS_D_FSYS0_IPCLKPORT_MAINCLK: usize = 0x2040;
const GAT_FSYS0_BUS_D_FSYS0_IPCLKPORT_PERICLK: usize = 0x2044;
const GAT_FSYS0_BUS_P_FSYS0_IPCLKPORT_MAINCLK: usize = 0x2048;
const GAT_FSYS0_BUS_P_FSYS0_IPCLKPORT_TCUCLK: usize = 0x204c;
const GAT_FSYS0_CPE425_IPCLKPORT_ACLK: usize = 0x2050;
const GAT_FSYS0_EQOS_TOP0_IPCLKPORT_ACLK_I: usize = 0x2054;
const GAT_FSYS0_EQOS_TOP0_IPCLKPORT_HCLK_I: usize = 0x2058;
const GAT_FSYS0_EQOS_TOP0_IPCLKPORT_RGMII_CLK_I: usize = 0x205c;
const GAT_FSYS0_EQOS_TOP0_IPCLKPORT_RII_CLK_I: usize = 0x2060;
const GAT_FSYS0_EQOS_TOP0_IPCLKPORT_RMII_CLK_I: usize = 0x2064;
const GAT_FSYS0_GPIO_FSYS0_IPCLKPORT_PCLK: usize = 0x2068;
const GAT_FSYS0_NS_BRDG_FSYS0_IPCLKPORT_CLK__PSOC_FSYS0__CLK_FSYS0_D: usize = 0x206c;
const GAT_FSYS0_NS_BRDG_FSYS0_IPCLKPORT_CLK__PSOC_FSYS0__CLK_FSYS0_D1: usize = 0x2070;
const GAT_FSYS0_NS_BRDG_FSYS0_IPCLKPORT_CLK__PSOC_FSYS0__CLK_FSYS0_P: usize = 0x2074;
const GAT_FSYS0_NS_BRDG_FSYS0_IPCLKPORT_CLK__PSOC_FSYS0__CLK_FSYS0_S: usize = 0x2078;
const GAT_FSYS0_PCIE_TOP_IPCLKPORT_PCIEG3_PHY_X4_INST_0_I_APB_PCLK: usize = 0x207c;
const GAT_FSYS0_PCIE_TOP_IPCLKPORT_PCIEG3_PHY_X4_INST_0_PLL_REFCLK_FROM_SYSPLL: usize = 0x2080;
const GAT_FSYS0_PCIE_TOP_IPCLKPORT_PIPE_PAL_INST_0_I_APB_PCLK_0: usize = 0x2084;
const GAT_FSYS0_PCIE_TOP_IPCLKPORT_FSD_PCIE_SUB_CTRL_INST_0_DBI_ACLK_SOC: usize = 0x2088;
const GAT_FSYS0_PCIE_TOP_IPCLKPORT_FSD_PCIE_SUB_CTRL_INST_0_I_DRIVER_APB_CLK: usize = 0x208c;
const GAT_FSYS0_PCIE_TOP_IPCLKPORT_FSD_PCIE_SUB_CTRL_INST_0_MSTR_ACLK_SOC: usize = 0x2090;
const GAT_FSYS0_PCIE_TOP_IPCLKPORT_FSD_PCIE_SUB_CTRL_INST_0_SLV_ACLK_SOC: usize = 0x2094;
const GAT_FSYS0_SMMU_FSYS0_IPCLKPORT_CCLK: usize = 0x2098;
const GAT_FSYS0_SMMU_FSYS0_IPCLKPORT_FSYS0_BCLK: usize = 0x209c;
const GAT_FSYS0_SYSREG_FSYS0_IPCLKPORT_PCLK: usize = 0x20a0;
const GAT_FSYS0_UFS_TOP0_IPCLKPORT_HCLK_BUS: usize = 0x20a4;
const GAT_FSYS0_UFS_TOP0_IPCLKPORT_I_ACLK: usize = 0x20a8;
const GAT_FSYS0_UFS_TOP0_IPCLKPORT_I_CLK_UNIPRO: usize = 0x20ac;
const GAT_FSYS0_UFS_TOP0_IPCLKPORT_I_FMP_CLK: usize = 0x20b0;
const GAT_FSYS0_UFS_TOP1_IPCLKPORT_HCLK_BUS: usize = 0x20b4;
const GAT_FSYS0_UFS_TOP1_IPCLKPORT_I_ACLK: usize = 0x20b8;
const GAT_FSYS0_UFS_TOP1_IPCLKPORT_I_CLK_UNIPRO: usize = 0x20bc;
const GAT_FSYS0_UFS_TOP1_IPCLKPORT_I_FMP_CLK: usize = 0x20c0;
const GAT_FSYS0_RII_CLK_DIVGATE: usize = 0x20d4;

static fsys0_clk_regs: &[usize] = &[
...
static fsys0_fixed_clks: &[/* external clock descriptor */] = &[
	FRATE!(0, "pad_eqos0_phyrxclk", None, 0, 125000000),
	FRATE!(0, "i_mphy_refclk_ixtal26", None, 0, 26000000),
	FRATE!(0, "xtal_clk_pcie_phy", None, 0, 100000000),
];

/* List of parent clocks for Muxes in CMU_FSYS0 */
static mout_fsys0_clkcmu_fsys0_unipro_p: &[&str] = &[ "fin_pll", "dout_cmu_pll_shared0_div6" };
static mout_fsys0_clk_fsys0_slavebusclk_p: &[&str] = &[ "fin_pll", "dout_cmu_fsys0_shared1div4" };
static mout_fsys0_eqos_rgmii_125_mux1_p: &[&str] = &[ "fin_pll", "dout_cmu_fsys0_shared0div4" };

static fsys0_mux_clks: &[/* external clock descriptor */] = &[
...
static fsys0_div_clks: &[/* external clock descriptor */] = &[
...
static fsys0_gate_clks: &[/* external clock descriptor */] = &[
...
const PLL_CON0_ACLK_FSYS1_BUSP_MUX: usize = 0x100;
const PLL_CON0_PCLKL_FSYS1_BUSP_MUX: usize = 0x180;
const DIV_CLK_FSYS1_PHY0_OSCCLK: usize = 0x1800;
const DIV_CLK_FSYS1_PHY1_OSCCLK: usize = 0x1804;
const GAT_FSYS1_CMU_FSYS1_IPCLKPORT_PCLK: usize = 0x2000;
const GAT_FSYS1_PCIE_LINK0_IPCLKPORT_AUXCLK: usize = 0x2004;
const GAT_FSYS1_PCIE_LINK0_IPCLKPORT_I_SOC_REF_CLK: usize = 0x2008;
const GAT_FSYS1_PCIE_LINK1_IPCLKPORT_AUXCLK: usize = 0x200c;
const GAT_FSYS1_PCIE_PHY0_IPCLKPORT_I_REF_XTAL: usize = 0x202c;
const GAT_FSYS1_PHY0_OSCCLLK: usize = 0x2034;
const GAT_FSYS1_PHY1_OSCCLK: usize = 0x2038;
const GAT_FSYS1_AXI2APB_FSYS1_IPCLKPORT_ACLK: usize = 0x203c;
const GAT_FSYS1_BUS_D0_FSYS1_IPCLKPORT_MAINCLK: usize = 0x2040;
const GAT_FSYS1_BUS_S0_FSYS1_IPCLKPORT_M250CLK: usize = 0x2048;
const GAT_FSYS1_BUS_S0_FSYS1_IPCLKPORT_MAINCLK: usize = 0x204c;
const GAT_FSYS1_CPE425_0_FSYS1_IPCLKPORT_ACLK: usize = 0x2054;
const GAT_FSYS1_NS_BRDG_FSYS1_IPCLKPORT_CLK__PSOC_FSYS1__CLK_FSYS1_D0: usize = 0x205c;
const GAT_FSYS1_NS_BRDG_FSYS1_IPCLKPORT_CLK__PSOC_FSYS1__CLK_FSYS1_S0: usize = 0x2064;
const GAT_FSYS1_PCIE_LINK0_IPCLKPORT_DBI_ACLK: usize = 0x206c;
const GAT_FSYS1_PCIE_LINK0_IPCLKPORT_I_APB_CLK: usize = 0x2070;
const GAT_FSYS1_PCIE_LINK0_IPCLKPORT_I_DRIVER_APB_CLK: usize = 0x2074;
const GAT_FSYS1_PCIE_LINK0_IPCLKPORT_MSTR_ACLK: usize = 0x2078;
const GAT_FSYS1_PCIE_LINK0_IPCLKPORT_SLV_ACLK: usize = 0x207c;
const GAT_FSYS1_PCIE_LINK1_IPCLKPORT_DBI_ACLK: usize = 0x2080;
const GAT_FSYS1_PCIE_LINK1_IPCLKPORT_I_DRIVER_APB_CLK: usize = 0x2084;
const GAT_FSYS1_PCIE_LINK1_IPCLKPORT_MSTR_ACLK: usize = 0x2088;
const GAT_FSYS1_PCIE_LINK1_IPCLKPORT_SLV_ACLK: usize = 0x208c;
const GAT_FSYS1_PCIE_PHY0_IPCLKPORT_I_APB_CLK: usize = 0x20a4;
const GAT_FSYS1_PCIE_PHY0_IPCLKPORT_I_REF_SOC_PLL: usize = 0x20a8;
const GAT_FSYS1_SYSREG_FSYS1_IPCLKPORT_PCLK: usize = 0x20b4;
const GAT_FSYS1_TBU0_FSYS1_IPCLKPORT_ACLK: usize = 0x20b8;

static fsys1_clk_regs: &[usize] = &[
...
static fsys1_fixed_clks: &[/* external clock descriptor */] = &[
	FRATE!(0, "clk_fsys1_phy0_ref", None, 0, 100000000),
	FRATE!(0, "clk_fsys1_phy1_ref", None, 0, 100000000),
];

/* List of parent clocks for Muxes in CMU_FSYS1 */
static mout_fsys1_pclkl_fsys1_busp_mux_p: &[&str] = &[ "fin_pll", "dout_cmu_fsys1_shared0div8" };
static mout_fsys1_aclk_fsys1_busp_mux_p: &[&str] = &[ "fin_pll", "dout_cmu_fsys1_shared0div4" };

static fsys1_mux_clks: &[/* external clock descriptor */] = &[
...
static fsys1_div_clks: &[/* external clock descriptor */] = &[
...
static fsys1_gate_clks: &[/* external clock descriptor */] = &[
...
const PLL_CON0_CLK_IMEM_ACLK: usize = 0x100;
const PLL_CON0_CLK_IMEM_INTMEMCLK: usize = 0x120;
const PLL_CON0_CLK_IMEM_TCUCLK: usize = 0x140;
const DIV_OSCCLK_IMEM_TMUTSCLK: usize = 0x1800;
const GAT_IMEM_IMEM_CMU_IMEM_IPCLKPORT_PCLK: usize = 0x2000;
const GAT_IMEM_MCT_IPCLKPORT_OSCCLK__ALO: usize = 0x2004;
const GAT_IMEM_OTP_CON_TOP_IPCLKPORT_I_OSCCLK: usize = 0x2008;
const GAT_IMEM_RSTNSYNC_OSCCLK_IPCLKPORT_CLK: usize = 0x200c;
const GAT_IMEM_TMU_CPU0_IPCLKPORT_I_CLK: usize = 0x2010;
const GAT_IMEM_TMU_CPU0_IPCLKPORT_I_CLK_TS: usize = 0x2014;
const GAT_IMEM_TMU_CPU2_IPCLKPORT_I_CLK: usize = 0x2018;
const GAT_IMEM_TMU_CPU2_IPCLKPORT_I_CLK_TS: usize = 0x201c;
const GAT_IMEM_TMU_GPU_IPCLKPORT_I_CLK: usize = 0x2020;
const GAT_IMEM_TMU_GPU_IPCLKPORT_I_CLK_TS: usize = 0x2024;
const GAT_IMEM_TMU_GT_IPCLKPORT_I_CLK: usize = 0x2028;
const GAT_IMEM_TMU_GT_IPCLKPORT_I_CLK_TS: usize = 0x202c;
const GAT_IMEM_TMU_TOP_IPCLKPORT_I_CLK: usize = 0x2030;
const GAT_IMEM_TMU_TOP_IPCLKPORT_I_CLK_TS: usize = 0x2034;
const GAT_IMEM_WDT0_IPCLKPORT_CLK: usize = 0x2038;
const GAT_IMEM_WDT1_IPCLKPORT_CLK: usize = 0x203c;
const GAT_IMEM_WDT2_IPCLKPORT_CLK: usize = 0x2040;
const GAT_IMEM_ADM_AXI4ST_I0_IMEM_IPCLKPORT_ACLKM: usize = 0x2044;
const GAT_IMEM_ADM_AXI4ST_I1_IMEM_IPCLKPORT_ACLKM: usize = 0x2048;
const GAT_IMEM_ADM_AXI4ST_I2_IMEM_IPCLKPORT_ACLKM: usize = 0x204c;
const GAT_IMEM_ADS_AXI4ST_I0_IMEM_IPCLKPORT_ACLKS: usize = 0x2050;
const GAT_IMEM_ADS_AXI4ST_I1_IMEM_IPCLKPORT_ACLKS: usize = 0x2054;
const GAT_IMEM_ADS_AXI4ST_I2_IMEM_IPCLKPORT_ACLKS: usize = 0x2058;
const GAT_IMEM_ASYNC_DMA0_IPCLKPORT_PCLKM: usize = 0x205c;
const GAT_IMEM_ASYNC_DMA0_IPCLKPORT_PCLKS: usize = 0x2060;
const GAT_IMEM_ASYNC_DMA1_IPCLKPORT_PCLKM: usize = 0x2064;
const GAT_IMEM_ASYNC_DMA1_IPCLKPORT_PCLKS: usize = 0x2068;
const GAT_IMEM_AXI2APB_IMEMP0_IPCLKPORT_ACLK: usize = 0x206c;
const GAT_IMEM_AXI2APB_IMEMP1_IPCLKPORT_ACLK: usize = 0x2070;
const GAT_IMEM_BUS_D_IMEM_IPCLKPORT_MAINCLK: usize = 0x2074;
const GAT_IMEM_BUS_P_IMEM_IPCLKPORT_MAINCLK: usize = 0x2078;
const GAT_IMEM_BUS_P_IMEM_IPCLKPORT_PERICLK: usize = 0x207c;
const GAT_IMEM_BUS_P_IMEM_IPCLKPORT_TCUCLK: usize = 0x2080;
const GAT_IMEM_DMA0_IPCLKPORT_ACLK: usize = 0x2084;
const GAT_IMEM_DMA1_IPCLKPORT_ACLK: usize = 0x2088;
const GAT_IMEM_GIC500_INPUT_SYNC_IPCLKPORT_CLK: usize = 0x208c;
const GAT_IMEM_GIC_IPCLKPORT_CLK: usize = 0x2090;
const GAT_IMEM_INTMEM_IPCLKPORT_ACLK: usize = 0x2094;
const GAT_IMEM_MAILBOX_SCS_CA72_IPCLKPORT_PCLK: usize = 0x2098;
const GAT_IMEM_MAILBOX_SMS_CA72_IPCLKPORT_PCLK: usize = 0x209c;
const GAT_IMEM_MCT_IPCLKPORT_PCLK: usize = 0x20a0;
const GAT_IMEM_NS_BRDG_IMEM_IPCLKPORT_CLK__PSCO_IMEM__CLK_IMEM_D: usize = 0x20a4;
const GAT_IMEM_NS_BRDG_IMEM_IPCLKPORT_CLK__PSCO_IMEM__CLK_IMEM_TCU: usize = 0x20a8;
const GAT_IMEM_NS_BRDG_IMEM_IPCLKPORT_CLK__PSOC_IMEM__CLK_IMEM_P: usize = 0x20ac;
const GAT_IMEM_OTP_CON_TOP_IPCLKPORT_PCLK: usize = 0x20b0;
const GAT_IMEM_RSTNSYNC_ACLK_IPCLKPORT_CLK: usize = 0x20b4;
const GAT_IMEM_RSTNSYNC_INTMEMCLK_IPCLKPORT_CLK: usize = 0x20b8;
const GAT_IMEM_RSTNSYNC_TCUCLK_IPCLKPORT_CLK: usize = 0x20bc;
const GAT_IMEM_SFRIF_TMU0_IMEM_IPCLKPORT_PCLK: usize = 0x20c0;
const GAT_IMEM_SFRIF_TMU1_IMEM_IPCLKPORT_PCLK: usize = 0x20c4;
const GAT_IMEM_SYSREG_IMEM_IPCLKPORT_PCLK: usize = 0x20c8;
const GAT_IMEM_TBU_IMEM_IPCLKPORT_ACLK: usize = 0x20cc;
const GAT_IMEM_TCU_IPCLKPORT_ACLK: usize = 0x20d0;
const GAT_IMEM_WDT0_IPCLKPORT_PCLK: usize = 0x20d4;
const GAT_IMEM_WDT1_IPCLKPORT_PCLK: usize = 0x20d8;
const GAT_IMEM_WDT2_IPCLKPORT_PCLK: usize = 0x20dc;

static imem_clk_regs: &[usize] = &[
...
static mout_imem_clk_imem_tcuclk_p: &[&str] = &[ "fin_pll", "dout_cmu_imem_tcuclk" };
static mout_imem_clk_imem_aclk_p: &[&str] = &[ "fin_pll", "dout_cmu_imem_aclk" };
static mout_imem_clk_imem_intmemclk_p: &[&str] = &[ "fin_pll", "dout_cmu_imem_dmaclk" };

static imem_mux_clks: &[/* external clock descriptor */] = &[
...
static imem_div_clks: &[/* external clock descriptor */] = &[
	DIV!(0, "dout_imem_oscclk_imem_tmutsclk", "fin_pll", DIV_OSCCLK_IMEM_TMUTSCLK, 0, 4),
];

static imem_gate_clks: &[/* external clock descriptor */] = &[
...
static imem_cmu_info: /* samsung_cmu_info */ = {
    mux_clks: imem_mux_clks,
    nr_mux_clks: imem_mux_clks.len(),
    div_clks: imem_div_clks,
    nr_div_clks: imem_div_clks.len(),
    gate_clks: imem_gate_clks,
    nr_gate_clks: imem_gate_clks.len(),
...
const PLL_LOCKTIME_PLL_MFC: usize = 0x0;
const PLL_CON0_PLL_MFC: usize = 0x100;
const MUX_MFC_BUSD: usize = 0x1000;
const MUX_MFC_BUSP: usize = 0x1008;
const DIV_MFC_BUSD_DIV4: usize = 0x1800;
const GAT_MFC_CMU_MFC_IPCLKPORT_PCLK: usize = 0x2000;
const GAT_MFC_AS_P_MFC_IPCLKPORT_PCLKM: usize = 0x2004;
const GAT_MFC_AS_P_MFC_IPCLKPORT_PCLKS: usize = 0x2008;
const GAT_MFC_AXI2APB_MFC_IPCLKPORT_ACLK: usize = 0x200c;
const GAT_MFC_MFC_IPCLKPORT_ACLK: usize = 0x2010;
const GAT_MFC_NS_BRDG_MFC_IPCLKPORT_CLK__PMFC__CLK_MFC_D: usize = 0x2018;
const GAT_MFC_NS_BRDG_MFC_IPCLKPORT_CLK__PMFC__CLK_MFC_P: usize = 0x201c;
const GAT_MFC_PPMU_MFCD0_IPCLKPORT_ACLK: usize = 0x2028;
const GAT_MFC_PPMU_MFCD0_IPCLKPORT_PCLK: usize = 0x202c;
const GAT_MFC_PPMU_MFCD1_IPCLKPORT_ACLK: usize = 0x2030;
const GAT_MFC_PPMU_MFCD1_IPCLKPORT_PCLK: usize = 0x2034;
const GAT_MFC_SYSREG_MFC_IPCLKPORT_PCLK: usize = 0x2038;
const GAT_MFC_TBU_MFCD0_IPCLKPORT_CLK: usize = 0x203c;
const GAT_MFC_TBU_MFCD1_IPCLKPORT_CLK: usize = 0x2040;
const GAT_MFC_BUSD_DIV4_GATE: usize = 0x2044;
const GAT_MFC_BUSD_GATE: usize = 0x2048;
...
static pll_mfc_rate_table: &[/* external clock descriptor */] = &[
	pll_35xx_rate!(24 * MHZ, 666000000u32, 111, 4, 0),
];

static mfc_pll_clks: &[/* external clock descriptor */] = &[
	PLL!(pll_142xx, 0, "fout_pll_mfc", "fin_pll",
	    PLL_LOCKTIME_PLL_MFC, PLL_CON0_PLL_MFC, pll_mfc_rate_table),
];

static mout_mfc_pll_p: &[&str] = &[ "fin_pll", "fout_pll_mfc" };
static mout_mfc_busp_p: &[&str] = &[ "fin_pll", "dout_mfc_busd_div4" };
static mout_mfc_busd_p: &[&str] = &[ "fin_pll", "mfc_busd_gate" };

static mfc_mux_clks: &[/* external clock descriptor */] = &[
...
static mfc_div_clks: &[/* external clock descriptor */] = &[
	DIV!(0, "dout_mfc_busd_div4", "mfc_busd_div4_gate", DIV_MFC_BUSD_DIV4, 0, 4),
];

static mfc_gate_clks: &[/* external clock descriptor */] = &[
...
static mfc_cmu_info: /* samsung_cmu_info */ = {
    pll_clks: mfc_pll_clks,
    nr_pll_clks: mfc_pll_clks.len(),
    mux_clks: mfc_mux_clks,
    nr_mux_clks: mfc_mux_clks.len(),
    div_clks: mfc_div_clks,
    nr_div_clks: mfc_div_clks.len(),
    gate_clks: mfc_gate_clks,
    nr_gate_clks: mfc_gate_clks.len(),
...
const PLL_LOCKTIME_PLL_CAM_CSI: usize = 0x0;
const PLL_CON0_PLL_CAM_CSI: usize = 0x100;
const DIV_CAM_CSI0_ACLK: usize = 0x1800;
const DIV_CAM_CSI1_ACLK: usize = 0x1804;
const DIV_CAM_CSI2_ACLK: usize = 0x1808;
const DIV_CAM_CSI_BUSD: usize = 0x180c;
const DIV_CAM_CSI_BUSP: usize = 0x1810;
const GAT_CAM_CSI_CMU_CAM_CSI_IPCLKPORT_PCLK: usize = 0x2000;
const GAT_CAM_AXI2APB_CAM_CSI_IPCLKPORT_ACLK: usize = 0x2004;
const GAT_CAM_CSI_BUS_D_CAM_CSI_IPCLKPORT_CLK__SYSTEM__CLK_CSI0: usize = 0x2008;
const GAT_CAM_CSI_BUS_D_CAM_CSI_IPCLKPORT_CLK__SYSTEM__CLK_CSI1: usize = 0x200c;
const GAT_CAM_CSI_BUS_D_CAM_CSI_IPCLKPORT_CLK__SYSTEM__CLK_CSI2: usize = 0x2010;
const GAT_CAM_CSI_BUS_D_CAM_CSI_IPCLKPORT_CLK__SYSTEM__CLK_SOC_NOC: usize = 0x2014;
const GAT_CAM_CSI_BUS_D_CAM_CSI_IPCLKPORT_CLK__SYSTEM__NOC: usize = 0x2018;
const GAT_CAM_CSI0_0_IPCLKPORT_I_ACLK: usize = 0x201c;
const GAT_CAM_CSI0_0_IPCLKPORT_I_PCLK: usize = 0x2020;
const GAT_CAM_CSI0_1_IPCLKPORT_I_ACLK: usize = 0x2024;
const GAT_CAM_CSI0_1_IPCLKPORT_I_PCLK: usize = 0x2028;
const GAT_CAM_CSI0_2_IPCLKPORT_I_ACLK: usize = 0x202c;
const GAT_CAM_CSI0_2_IPCLKPORT_I_PCLK: usize = 0x2030;
const GAT_CAM_CSI0_3_IPCLKPORT_I_ACLK: usize = 0x2034;
const GAT_CAM_CSI0_3_IPCLKPORT_I_PCLK: usize = 0x2038;
const GAT_CAM_CSI1_0_IPCLKPORT_I_ACLK: usize = 0x203c;
const GAT_CAM_CSI1_0_IPCLKPORT_I_PCLK: usize = 0x2040;
const GAT_CAM_CSI1_1_IPCLKPORT_I_ACLK: usize = 0x2044;
const GAT_CAM_CSI1_1_IPCLKPORT_I_PCLK: usize = 0x2048;
const GAT_CAM_CSI1_2_IPCLKPORT_I_ACLK: usize = 0x204c;
const GAT_CAM_CSI1_2_IPCLKPORT_I_PCLK: usize = 0x2050;
const GAT_CAM_CSI1_3_IPCLKPORT_I_ACLK: usize = 0x2054;
const GAT_CAM_CSI1_3_IPCLKPORT_I_PCLK: usize = 0x2058;
const GAT_CAM_CSI2_0_IPCLKPORT_I_ACLK: usize = 0x205c;
const GAT_CAM_CSI2_0_IPCLKPORT_I_PCLK: usize = 0x2060;
const GAT_CAM_CSI2_1_IPCLKPORT_I_ACLK: usize = 0x2064;
const GAT_CAM_CSI2_1_IPCLKPORT_I_PCLK: usize = 0x2068;
const GAT_CAM_CSI2_2_IPCLKPORT_I_ACLK: usize = 0x206c;
const GAT_CAM_CSI2_2_IPCLKPORT_I_PCLK: usize = 0x2070;
const GAT_CAM_CSI2_3_IPCLKPORT_I_ACLK: usize = 0x2074;
const GAT_CAM_CSI2_3_IPCLKPORT_I_PCLK: usize = 0x2078;
const GAT_CAM_NS_BRDG_CAM_CSI_IPCLKPORT_CLK__PSOC_CAM_CSI__CLK_CAM_CSI_D: usize = 0x207c;
const GAT_CAM_NS_BRDG_CAM_CSI_IPCLKPORT_CLK__PSOC_CAM_CSI__CLK_CAM_CSI_P: usize = 0x2080;
const GAT_CAM_SYSREG_CAM_CSI_IPCLKPORT_PCLK: usize = 0x2084;
const GAT_CAM_TBU_CAM_CSI_IPCLKPORT_ACLK: usize = 0x2088;

static cam_csi_clk_regs: &[usize] = &[
...
static pll_cam_csi_rate_table: &[/* external clock descriptor */] = &[
	pll_35xx_rate!(24 * MHZ, 1066000000u32, 533, 12, 0),
];

static cam_csi_pll_clks: &[/* external clock descriptor */] = &[
	PLL!(pll_142xx, CAM_CSI_PLL, "fout_pll_cam_csi", "fin_pll",
	    PLL_LOCKTIME_PLL_CAM_CSI, PLL_CON0_PLL_CAM_CSI, pll_cam_csi_rate_table),
];

static mout_cam_csi_pll_p: &[&str] = &[ "fin_pll", "fout_pll_cam_csi" };

static cam_csi_mux_clks: &[/* external clock descriptor */] = &[
	MUX!(0, "mout_cam_csi_pll", mout_cam_csi_pll_p, PLL_CON0_PLL_CAM_CSI, 4, 1),
];

static cam_csi_div_clks: &[/* external clock descriptor */] = &[
...
static cam_csi_gate_clks: &[/* external clock descriptor */] = &[
...
static cam_csi_cmu_info: /* samsung_cmu_info */ = {
    pll_clks: cam_csi_pll_clks,
    nr_pll_clks: cam_csi_pll_clks.len(),
    mux_clks: cam_csi_mux_clks,
    nr_mux_clks: cam_csi_mux_clks.len(),
    div_clks: cam_csi_div_clks,
    nr_div_clks: cam_csi_div_clks.len(),
    gate_clks: cam_csi_gate_clks,
    nr_gate_clks: cam_csi_gate_clks.len(),
    nr_clk_ids: CLKS_NR_CAM_CSI,
    clk_regs: cam_csi_clk_regs,
    nr_clk_regs: cam_csi_clk_regs.len(),
];
...
static fsd_cmu_of_match: &[/* external clock descriptor */] = &[
	{
