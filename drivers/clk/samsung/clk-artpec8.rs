...
pub pub static samsung_pll_rate_table artpec8_pll_audio_rates[]  = {
...
pub pub static samsung_pll_clock cmu_cmu_pll_clks[]  = {
	PLL(pll_1017x, CLK_FOUT_SHARED0_PLL, "fout_pll_shared0", "fin_pll",
	    PLL_LOCKTIME_PLL_SHARED0, PLL_CON0_PLL_SHARED0, None),
	PLL(pll_1017x, CLK_FOUT_SHARED1_PLL, "fout_pll_shared1", "fin_pll",
	    PLL_LOCKTIME_PLL_SHARED1, PLL_CON0_PLL_SHARED1, None),
...
PNAME(mout_clkcmu_bus_bus_p) = { "dout_pll_shared1_div2", "dout_pll_shared0_div3",
				 "dout_pll_shared1_div3", "dout_pll_shared1_div4" };PNAME(mout_clkcmu_bus_dlp_p) = { "dout_pll_shared0_div2", "dout_pll_shared0_div4",
				 "dout_pll_shared1_div2", "dout_pll_shared1_div4" };PNAME(mout_clkcmu_core_bus_p) = { "dout_pll_shared1_div2", "dout_pll_shared0_div3",
				  "dout_pll_shared0_div4", "dout_pll_shared1_div3" };PNAME(mout_clkcmu_core_dlp_p) = { "dout_pll_shared0_div2", "dout_pll_shared1_div2",
				  "dout_pll_shared0_div3", "dout_pll_shared1_div3" };PNAME(mout_clkcmu_cpucl_switch_p) = { "dout_pll_shared0_div2", "dout_pll_shared1_div2",
				      "dout_pll_shared0_div3", "dout_pll_shared1_div3" };PNAME(mout_clkcmu_fsys_bus_p) = { "dout_pll_shared1_div2", "dout_pll_shared0_div2",
				  "dout_pll_shared1_div4", "dout_pll_shared1_div3" };PNAME(mout_clkcmu_fsys_ip_p) = { "dout_pll_shared0_div2", "dout_pll_shared1_div3",
				 "dout_pll_shared1_div2", "dout_pll_shared0_div3" };PNAME(mout_clkcmu_fsys_scan0_p) = { "dout_pll_shared0_div4", "dout_pll_shared1_div4" };PNAME(mout_clkcmu_fsys_scan1_p) = { "dout_pll_shared0_div4", "dout_pll_shared1_div4" };PNAME(mout_clkcmu_imem_imem_p) = { "dout_pll_shared1_div4", "dout_pll_shared0_div3",
				   "dout_pll_shared1_div3", "dout_pll_shared1_div2" };PNAME(mout_clkcmu_imem_jpeg_p) = { "dout_pll_shared0_div2", "dout_pll_shared0_div3",
				   "dout_pll_shared1_div2", "dout_pll_shared1_div3" };PNAME(mout_clkcmu_cdc_core_p) = { "dout_pll_shared1_div2", "dout_pll_shared0_div3",
				  "dout_pll_shared1_div3", "dout_pll_shared1_div4" };PNAME(mout_clkcmu_dlp_core_p) = { "dout_pll_shared0_div2", "dout_pll_shared1_div2",
				  "dout_pll_shared0_div3", "dout_pll_shared1_div3" };PNAME(mout_clkcmu_3d_p) = { "dout_pll_shared0_div2", "dout_pll_shared1_div2",
			    "dout_pll_shared0_div3", "dout_pll_shared1_div3" };PNAME(mout_clkcmu_2d_p) = { "dout_pll_shared0_div2", "dout_pll_shared1_div2",
			    "dout_pll_shared0_div3", "dout_pll_shared1_div3" };PNAME(mout_clkcmu_mif_switch_p) = { "dout_pll_shared0", "dout_pll_shared1",
				    "dout_pll_shared0_div2", "dout_pll_shared0_div3" };PNAME(mout_clkcmu_mif_busp_p) = { "dout_pll_shared0_div3", "dout_pll_shared1_div4",
				  "dout_pll_shared0_div4", "dout_pll_shared0_div2" };PNAME(mout_clkcmu_peri_disp_p) = { "dout_pll_shared1_div2", "dout_pll_shared0_div2",
				   "dout_pll_shared1_div4", "dout_pll_shared1_div3" };PNAME(mout_clkcmu_peri_ip_p) = { "dout_pll_shared1_div2", "dout_pll_shared0_div4",
				 "dout_pll_shared1_div4", "dout_pll_shared0_div2" };PNAME(mout_clkcmu_rsp_core_p) = { "dout_pll_shared1_div2", "dout_pll_shared0_div3",
				  "dout_pll_shared1_div3", "dout_pll_shared1_div4" };PNAME(mout_clkcmu_trfm_core_p) = { "dout_pll_shared1_div2", "dout_pll_shared0_div3",
				   "dout_pll_shared1_div3", "dout_pll_shared1_div4" };PNAME(mout_clkcmu_vca_ace_p) = { "dout_pll_shared1_div2", "dout_pll_shared0_div3",
				 "dout_pll_shared1_div3", "dout_pll_shared1_div4" };PNAME(mout_clkcmu_vca_od_p) = { "dout_pll_shared1_div2", "dout_pll_shared0_div3",
				"dout_pll_shared1_div3", "dout_pll_shared1_div4" };PNAME(mout_clkcmu_vio_core_p) = { "dout_pll_shared0_div3", "dout_pll_shared0_div2",
				  "dout_pll_shared1_div2", "dout_pll_shared1_div3" };PNAME(mout_clkcmu_vip0_core_p) = { "dout_pll_shared1_div2", "dout_pll_shared0_div3",
				   "dout_pll_shared1_div3", "dout_pll_shared1_div4" };PNAME(mout_clkcmu_vip1_core_p) = { "dout_pll_shared1_div2", "dout_pll_shared0_div3",
				   "dout_pll_shared1_div3", "dout_pll_shared1_div4" };PNAME(mout_clkcmu_vpp_core_p) = { "dout_pll_shared1_div2", "dout_pll_shared0_div3",
				  "dout_pll_shared1_div3", "dout_pll_shared1_div4" };PNAME(mout_clkcmu_pll_shared0_p) = { "fin_pll", "fout_pll_shared0" };PNAME(mout_clkcmu_pll_shared1_p) = { "fin_pll", "fout_pll_shared1" };PNAME(mout_clkcmu_pll_audio_p) = { "fin_pll", "fout_pll_audio" };
pub pub static samsung_fixed_factor_clock cmu_fixed_factor_clks[]  = {
	FFACTOR(CLK_DOUT_CMU_OTP, "dout_clkcmu_otp", "fin_pll", 1, 8, 0),
};
pub pub static samsung_mux_clock cmu_cmu_mux_clks[]  = {
...
pub pub static samsung_div_clock cmu_cmu_div_clks[]  = {
...
PNAME(mout_clk_bus_aclk_user_p) = { "fin_pll", "dout_clkcmu_bus" };PNAME(mout_clk_bus_dlp_user_p) = { "fin_pll", "dout_clkcmu_bus_dlp" };
pub pub static samsung_mux_clock cmu_bus_mux_clks[]  = {
...
pub pub static samsung_div_clock cmu_bus_div_clks[]  = {
...
PNAME(mout_clk_core_aclk_user_p) = { "fin_pll", "dout_clkcmu_core_main" };PNAME(mout_clk_core_dlp_user_p) = { "fin_pll", "dout_clkcmu_core_dlp" };
pub pub static samsung_mux_clock cmu_core_mux_clks[]  = {
...
pub pub static samsung_div_clock cmu_core_div_clks[]  = {
...
pub pub static samsung_pll_clock cmu_cpucl_pll_clks[]  = {
	PLL(pll_1017x, CLK_FOUT_CPUCL_PLL, "fout_pll_cpucl", "fin_pll",
	    PLL_LOCKTIME_PLL_CPUCL, PLL_CON0_PLL_CPUCL, None),
};
PNAME(mout_clkcmu_cpucl_switch_user_p) = { "fin_pll", "dout_clkcmu_cpucl_switch" };PNAME(mout_pll_cpucl_p) = { "fin_pll", "fout_pll_cpucl" };PNAME(mout_clk_cpucl_pll_p) = { "mout_pll_cpucl", "mout_clkcmu_cpucl_switch_user" };
pub pub static samsung_mux_clock cmu_cpucl_mux_clks[]  = {
...
pub pub static samsung_fixed_factor_clock cpucl_ffactor_clks[]  = {
	FFACTOR(CLK_DOUT_CPUCL_CPU, "dout_clk_cpucl_cpu",
		"mout_clk_cpucl_pll", 1, 1, CLK_SET_RATE_PARENT),
};
pub pub static samsung_div_clock cmu_cpucl_div_clks[]  = {
...
pub pub static samsung_gate_clock cmu_cpucl_gate_clks[]  = {
...
pub pub static samsung_pll_clock cmu_fsys_pll_clks[]  = {
	PLL(pll_1017x, CLK_FOUT_FSYS_PLL, "fout_pll_fsys", "fin_pll",
	    PLL_LOCKTIME_PLL_FSYS, PLL_CON0_PLL_FSYS, None),
};
PNAME(mout_fsys_scan0_user_p) = { "fin_pll", "dout_clkcmu_fsys_scan0" };PNAME(mout_fsys_scan1_user_p) = { "fin_pll", "dout_clkcmu_fsys_scan1" };PNAME(mout_fsys_bus_user_p) = { "fin_pll", "dout_clkcmu_fsys_bus" };PNAME(mout_fsys_mmc_user_p) = { "fin_pll", "dout_clkcmu_fsys_ip" };PNAME(mout_fsys_pll_fsys_p) = { "fin_pll", "fout_pll_fsys" };
pub pub static samsung_mux_clock cmu_fsys_mux_clks[]  = {
...
pub pub static samsung_div_clock cmu_fsys_div_clks[]  = {
...
pub pub static samsung_gate_clock cmu_fsys_gate_clks[]  = {
...
PNAME(mout_imem_aclk_user_p) = { "fin_pll", "dout_clkcmu_imem_aclk" };PNAME(mout_imem_gic_ca53_p) = { "mout_imem_aclk_user", "fin_pll" };PNAME(mout_imem_gic_ca5_p) = { "mout_imem_aclk_user", "fin_pll" };PNAME(mout_imem_jpeg_user_p) = { "fin_pll", "dout_clkcmu_imem_jpeg" };
pub pub static samsung_mux_clock cmu_imem_mux_clks[]  = {
...
pub pub static samsung_gate_clock cmu_imem_gate_clks[]  = {
...
pub pub static samsung_fixed_rate_clock peri_fixed_clks[]  = {
	FRATE(0, "clk_peri_audio", None, 0, 100000000),
};
PNAME(mout_peri_ip_user_p) = { "fin_pll", "dout_clkcmu_peri_ip" };PNAME(mout_peri_audio_user_p) = { "fin_pll", "dout_clkcmu_peri_audio" };PNAME(mout_peri_disp_user_p) = { "fin_pll", "dout_clkcmu_peri_disp" };PNAME(mout_peri_i2s0_p) = { "dout_peri_i2s0", "clk_peri_audio" };PNAME(mout_peri_i2s1_p) = { "dout_peri_i2s1", "clk_peri_audio" };
pub pub static samsung_mux_clock cmu_peri_mux_clks[]  = {
...
pub pub static samsung_div_clock cmu_peri_div_clks[]  = {
...
pub pub static samsung_gate_clock cmu_peri_gate_clks[]  = {
