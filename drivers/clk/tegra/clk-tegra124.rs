...
// Faithful low-level Rust translation of clk-tegra124.c.
...
// dependency: #include <linux/clkdev.h>
// dependency: #include <linux/of.h>
// dependency: #include <linux/of_address.h>
// dependency: #include <linux/delay.h>
// dependency: #include <linux/export.h>
// dependency: #include <linux/clk/tegra.h>
// dependency: #include <dt-bindings/clock/tegra124-car.h>
// dependency: #include <dt-bindings/reset/tegra124-car.h>

// dependency: #include "clk.h"
// dependency: #include "clk-id.h"
 ...
 */
// conditional/preprocessor: #define TEGRA124_CAR_BANK_COUNT			6

// conditional/preprocessor: #define CLK_SOURCE_CSITE 0x1d4
// conditional/preprocessor: #define CLK_SOURCE_EMC 0x19c
// conditional/preprocessor: #define CLK_SOURCE_SOR0 0x414

// conditional/preprocessor: #define RST_DFLL_DVCO			0x2f4
// conditional/preprocessor: #define DVFS_DFLL_RESET_SHIFT		0

// conditional/preprocessor: #define PLLC_BASE 0x80
// conditional/preprocessor: #define PLLC_OUT 0x84
// conditional/preprocessor: #define PLLC_MISC2 0x88
// conditional/preprocessor: #define PLLC_MISC 0x8c
// conditional/preprocessor: #define PLLC2_BASE 0x4e8
// conditional/preprocessor: #define PLLC2_MISC 0x4ec
// conditional/preprocessor: #define PLLC3_BASE 0x4fc
// conditional/preprocessor: #define PLLC3_MISC 0x500
// conditional/preprocessor: #define PLLM_BASE 0x90
// conditional/preprocessor: #define PLLM_OUT 0x94
// conditional/preprocessor: #define PLLM_MISC 0x9c
// conditional/preprocessor: #define PLLP_BASE 0xa0
// conditional/preprocessor: #define PLLP_MISC 0xac
// conditional/preprocessor: #define PLLA_BASE 0xb0
// conditional/preprocessor: #define PLLA_MISC 0xbc
// conditional/preprocessor: #define PLLD_BASE 0xd0
// conditional/preprocessor: #define PLLD_MISC 0xdc
// conditional/preprocessor: #define PLLU_BASE 0xc0
// conditional/preprocessor: #define PLLU_MISC 0xcc
// conditional/preprocessor: #define PLLX_BASE 0xe0
// conditional/preprocessor: #define PLLX_MISC 0xe4
// conditional/preprocessor: #define PLLX_MISC2 0x514
// conditional/preprocessor: #define PLLX_MISC3 0x518
// conditional/preprocessor: #define PLLE_BASE 0xe8
// conditional/preprocessor: #define PLLE_MISC 0xec
// conditional/preprocessor: #define PLLD2_BASE 0x4b8
// conditional/preprocessor: #define PLLD2_MISC 0x4bc
// conditional/preprocessor: #define PLLE_AUX 0x48c
// conditional/preprocessor: #define PLLRE_BASE 0x4c4
// conditional/preprocessor: #define PLLRE_MISC 0x4c8
// conditional/preprocessor: #define PLLDP_BASE 0x590
// conditional/preprocessor: #define PLLDP_MISC 0x594
// conditional/preprocessor: #define PLLC4_BASE 0x5a4
// conditional/preprocessor: #define PLLC4_MISC 0x5a8

// conditional/preprocessor: #define PLLC_IDDQ_BIT 26
// conditional/preprocessor: #define PLLRE_IDDQ_BIT 16
// conditional/preprocessor: #define PLLSS_IDDQ_BIT 19

// conditional/preprocessor: #define PLL_BASE_LOCK BIT(27)
// conditional/preprocessor: #define PLLE_MISC_LOCK BIT(11)
// conditional/preprocessor: #define PLLRE_MISC_LOCK BIT(24)

// conditional/preprocessor: #define PLL_MISC_LOCK_ENABLE 18
// conditional/preprocessor: #define PLLC_MISC_LOCK_ENABLE 24
// conditional/preprocessor: #define PLLDU_MISC_LOCK_ENABLE 22
// conditional/preprocessor: #define PLLE_MISC_LOCK_ENABLE 9
// conditional/preprocessor: #define PLLRE_MISC_LOCK_ENABLE 30
// conditional/preprocessor: #define PLLSS_MISC_LOCK_ENABLE 30

// conditional/preprocessor: #define PLLXC_SW_MAX_P 6

// conditional/preprocessor: #define PMC_PLLM_WB0_OVERRIDE 0x1dc
// conditional/preprocessor: #define PMC_PLLM_WB0_OVERRIDE_2 0x2b0

// conditional/preprocessor: #define CCLKG_BURST_POLICY 0x368

/* Tegra CPU clock and reset control regs */
// conditional/preprocessor: #define CLK_RST_CONTROLLER_CPU_CMPLX_STATUS	0x470
...
unsafe fn __iomem *clk_base;
unsafe fn __iomem *pmc_base;

static mut osc_freq;
static mut pll_ref_freq;
...
static mut tegra124_input_freq[] = {
	[ 0] = 13000000,
	[ 1] = 16800000,
	[ 4] = 19200000,
	[ 5] = 38400000,
...
static mut tegra_clk_pll_freq_table pll_x_freq_table[] = {
	/* 1 GHz */
...
static mut tegra_clk_pll_freq_table pll_cx_freq_table[] = {
	{ 12000000, 600000000, 100, 1, 2, 0 },
	{ 13000000, 600000000,  92, 1, 2, 0 }, /* actual: 598.0 MHz */
	{ 16800000, 600000000,  71, 1, 2, 0 }, /* actual: 596.4 MHz */
	{ 19200000, 600000000,  62, 1, 2, 0 }, /* actual: 595.2 MHz */
...
static mut tegra_clk_pll_freq_table pll_c4_freq_table[] = {
	{ 12000000, 600000000, 100, 1, 2, 0 },
	{ 13000000, 600000000,  92, 1, 2, 0 }, /* actual: 598.0 MHz */
	{ 16800000, 600000000,  71, 1, 2, 0 }, /* actual: 596.4 MHz */
	{ 19200000, 600000000,  62, 1, 2, 0 }, /* actual: 595.2 MHz */
...
static mut tegra_clk_pll_freq_table pll_m_freq_table[] = {
...
static mut tegra_clk_pll_freq_table pll_a_freq_table[] = {
...
static mut tegra_clk_pll_freq_table tegra124_pll_d2_freq_table[] = {
...
static mut tegra_clk tegra124_clks[tegra_clk_max] __initdata = {
...
static mut tegra_devclk devclks[] __initdata = {
...
static mut tegra_periph_init_data tegra124_periph[] = {
...
static void tegra124_periph_clk_init(void __iomem *clk_base,
...
unsafe fn tegra124_pll_init(void __iomem *clk_base,
				     void __iomem *pmc)
{
	struct clk *clk;
...
// conditional/preprocessor: #ifdef CONFIG_PM_SLEEP
unsafe fn tegra124_cpu_clock_suspend(void)
{
...
unsafe fn tegra124_cpu_clock_resume(void)
{
...
static mut of_device_id pmc_match[] __initconst = {
	{ .compatible = "nvidia,tegra124-pmc" },
	{ },
};

static mut tegra_clk_init_table common_init_table[] __initdata = {
...
static mut tegra_clk_init_table tegra124_init_table[] __initdata = {
...
static mut tegra_clk_init_table tegra132_init_table[] __initdata = {
	{ TEGRA124_CLK_SOC_THERM, TEGRA124_CLK_PLL_P, 51000000, 1 },
	/* must be the last entry */
	{ TEGRA124_CLK_CLK_MAX, TEGRA124_CLK_CLK_MAX, 0, 0 },
};

static mut tegra_audio_clk_info tegra124_audio_plls[] = {
 ...
 */
unsafe fn tegra124_clock_apply_init_table(void)
{
 ...
 */
unsafe fn tegra124_car_barrier(void)
{
 ...
 */
unsafe fn tegra124_clock_assert_dfll_dvco_reset(void)
{
	u32 v;
 ...
 */
unsafe fn tegra124_clock_deassert_dfll_dvco_reset(void)
{
	u32 v;
 ...
 * this will be called as an arch_initcall.  No return value.
 */
unsafe fn tegra132_clock_apply_init_table(void)
{
	tegra_init_from_table(common_init_table, clks, TEGRA124_CLK_CLK_MAX);
