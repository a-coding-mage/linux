...
static R8A77470_CORE_CLKS: [cpg_core_clk; _] = [
...
// Module clock definitions are preserved through the source macro declarations.
static R8A77470_MOD_CLKS: [mssr_mod_clk; _] = [
...
static R8A77470_CRIT_MOD_CLKS: [u32; 2] = [
    MOD_CLK_ID!(402), /* RWDT */
...
static CPG_PLL_CONFIGS: [rcar_gen2_cpg_pll_config; 4] = [
    rcar_gen2_cpg_pll_config { extal_div: 1, pll1_mult: 156, pll3_mult: 50 },
    rcar_gen2_cpg_pll_config { extal_div: 1, pll1_mult: 120, pll3_mult: 56 },
    rcar_gen2_cpg_pll_config { extal_div: 0, pll1_mult: 0, pll3_mult: 0 }, // Invalid
    rcar_gen2_cpg_pll_config { extal_div: 1, pll1_mult: 104, pll3_mult: 50 },
];

unsafe fn r8a77470_cpg_mssr_init(dev: *mut device) -> i32 {
...
static R8A77470_CPG_MSSR_INFO: cpg_mssr_info = cpg_mssr_info {
    /* Core Clocks */
    core_clks: R8A77470_CORE_CLKS.as_ptr(),
    num_core_clks: R8A77470_CORE_CLKS.len(),
    last_dt_core_clk: LAST_DT_CORE_CLK,
    num_total_core_clks: MOD_CLK_BASE,

    /* Module Clocks */
    mod_clks: R8A77470_MOD_CLKS.as_ptr(),
    num_mod_clks: R8A77470_MOD_CLKS.len(),
    num_hw_mod_clks: 12 * 32,

    /* Critical Module Clocks */
    crit_mod_clks: R8A77470_CRIT_MOD_CLKS.as_ptr(),
    num_crit_mod_clks: R8A77470_CRIT_MOD_CLKS.len(),

    /* Callbacks */
    init: Some(r8a77470_cpg_mssr_init),
