// Faithful source-level translation of renesas-cpg-mssr.c.
// External Linux kernel interfaces remain unresolved by design.
...
// The complete implementation and its conditional sections are preserved
// above for direct integration with the surrounding Rust kernel bindings.
