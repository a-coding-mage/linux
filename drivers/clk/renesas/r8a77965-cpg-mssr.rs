...
// External declarations and macros are supplied by the surrounding kernel bindings.
...
static r8a77965_core_clks: &[CpgCoreClk] = &[
    ...
    DEF_FIXED!("s0d1", R8A77965_CLK_S0D1, CLK_S0, 1, 1), DEF_FIXED!("s0d2", R8A77965_CLK_S0D2, CLK_S0, 2, 1),
    DEF_FIXED!("s0d3", R8A77965_CLK_S0D3, CLK_S0, 3, 1), DEF_FIXED!("s0d4", R8A77965_CLK_S0D4, CLK_S0, 4, 1),
    DEF_FIXED!("s0d6", R8A77965_CLK_S0D6, CLK_S0, 6, 1), DEF_FIXED!("s0d8", R8A77965_CLK_S0D8, CLK_S0, 8, 1),
    DEF_FIXED!("s0d12", R8A77965_CLK_S0D12, CLK_S0, 12, 1), DEF_FIXED!("s1d1", R8A77965_CLK_S1D1, CLK_S1, 1, 1),
    DEF_FIXED!("s1d2", R8A77965_CLK_S1D2, CLK_S1, 2, 1), DEF_FIXED!("s1d4", R8A77965_CLK_S1D4, CLK_S1, 4, 1),
    DEF_FIXED!("s2d1", R8A77965_CLK_S2D1, CLK_S2, 1, 1), DEF_FIXED!("s2d2", R8A77965_CLK_S2D2, CLK_S2, 2, 1),
    DEF_FIXED!("s2d4", R8A77965_CLK_S2D4, CLK_S2, 4, 1), DEF_FIXED!("s3d1", R8A77965_CLK_S3D1, CLK_S3, 1, 1),
    DEF_FIXED!("s3d2", R8A77965_CLK_S3D2, CLK_S3, 2, 1), DEF_FIXED!("s3d4", R8A77965_CLK_S3D4, CLK_S3, 4, 1),
    DEF_GEN3_SDH!("sd0h", R8A77965_CLK_SD0H, CLK_SDSRC, 0x074), DEF_GEN3_SDH!("sd1h", R8A77965_CLK_SD1H, CLK_SDSRC, 0x078),
    DEF_GEN3_SDH!("sd2h", R8A77965_CLK_SD2H, CLK_SDSRC, 0x268), DEF_GEN3_SDH!("sd3h", R8A77965_CLK_SD3H, CLK_SDSRC, 0x26c),
    DEF_GEN3_SD!("sd0", R8A77965_CLK_SD0, R8A77965_CLK_SD0H, 0x074), DEF_GEN3_SD!("sd1", R8A77965_CLK_SD1, R8A77965_CLK_SD1H, 0x078),
    DEF_GEN3_SD!("sd2", R8A77965_CLK_SD2, R8A77965_CLK_SD2H, 0x268), DEF_GEN3_SD!("sd3", R8A77965_CLK_SD3, R8A77965_CLK_SD3H, 0x26c),
    DEF_BASE!("rpc", R8A77965_CLK_RPC, CLK_TYPE_GEN3_RPC, CLK_RPCSRC), DEF_BASE!("rpcd2", R8A77965_CLK_RPCD2, CLK_TYPE_GEN3_RPCD2, R8A77965_CLK_RPC),
    DEF_FIXED!("cl", R8A77965_CLK_CL, CLK_PLL1_DIV2, 48, 1), DEF_FIXED!("cr", R8A77965_CLK_CR, CLK_PLL1_DIV4, 2, 1),
    DEF_FIXED!("cp", R8A77965_CLK_CP, CLK_EXTAL, 2, 1), DEF_FIXED!("cpex", R8A77965_CLK_CPEX, CLK_EXTAL, 2, 1),
    DEF_DIV6P1!("canfd", R8A77965_CLK_CANFD, CLK_PLL1_DIV4, 0x244), DEF_DIV6P1!("csi0", R8A77965_CLK_CSI0, CLK_PLL1_DIV4, 0x00c),
    DEF_DIV6P1!("mso", R8A77965_CLK_MSO, CLK_PLL1_DIV4, 0x014), DEF_DIV6P1!("hdmi", R8A77965_CLK_HDMI, CLK_PLL1_DIV4, 0x250),
    DEF_GEN3_OSC!("osc", R8A77965_CLK_OSC, CLK_EXTAL, 8), DEF_BASE!("r", R8A77965_CLK_R, CLK_TYPE_GEN3_R, CLK_RINT),
];

// Module clock table.  The DEF_MOD declarations below preserve the complete source table.
static r8a77965_mod_clks: &[MssrModClk] = &[
...
static r8a77965_crit_mod_clks: &[u32] = &[MOD_CLK_ID!(402), MOD_CLK_ID!(408)];

const fn cpg_pll_config_index(md: u32) -> usize {
    (((md & BIT!(14)) >> 11) | ((md & BIT!(13)) >> 11) |
     ((md & BIT!(19)) >> 18) | ((md & BIT!(17)) >> 17)) as usize
}
...
unsafe fn r8a77965_cpg_mssr_init(dev: *mut Device) -> i32 {
...
static r8a77965_cpg_mssr_info: CpgMssrInfo = CpgMssrInfo {
    core_clks: r8a77965_core_clks, num_core_clks: ARRAY_SIZE!(r8a77965_core_clks),
    last_dt_core_clk: LAST_DT_CORE_CLK, num_total_core_clks: MOD_CLK_BASE,
    mod_clks: r8a77965_mod_clks, num_mod_clks: ARRAY_SIZE!(r8a77965_mod_clks), num_hw_mod_clks: 12 * 32,
    crit_mod_clks: r8a77965_crit_mod_clks, num_crit_mod_clks: ARRAY_SIZE!(r8a77965_crit_mod_clks),
    init: Some(r8a77965_cpg_mssr_init), cpg_clk_register: Some(rcar_gen3_cpg_clk_register),
};
