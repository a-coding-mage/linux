...
static dtable_2_16: &[clk_div_table] = &[
	...
	clk_div_table { val: 3, div: 16 },
	clk_div_table { val: 0, div: 0 },
];

static dtable_2_16_plldsi: &[clk_div_table] = &[
	clk_div_table { val: 0, div: 2 },
	clk_div_table { val: 1, div: 4 },
	clk_div_table { val: 2, div: 6 },
	clk_div_table { val: 3, div: 8 },
	clk_div_table { val: 4, div: 10 },
	clk_div_table { val: 5, div: 12 },
	clk_div_table { val: 6, div: 14 },
	clk_div_table { val: 7, div: 16 },
	clk_div_table { val: 0, div: 0 },
];
...
static dtable_2_64: &[clk_div_table] = &[
	...
	clk_div_table { val: 2, div: 8 },
	clk_div_table { val: 3, div: 16 },
	clk_div_table { val: 4, div: 64 },
	clk_div_table { val: 0, div: 0 },
];

static dtable_2_100: &[clk_div_table] = &[
	clk_div_table { val: 0, div: 2 },
	clk_div_table { val: 1, div: 10 },
	clk_div_table { val: 2, div: 100 },
	clk_div_table { val: 0, div: 0 },
];

static dtable_16_128: &[clk_div_table] = &[
	clk_div_table { val: 0, div: 16 },
	clk_div_table { val: 1, div: 32 },
	clk_div_table { val: 2, div: 64 },
	clk_div_table { val: 3, div: 128 },
	clk_div_table { val: 0, div: 0 },
];
...
/* Mux clock tables */
static smux2_dsi0_clk: &[&str] = &[ ".plldsi0_div7", ".plldsi0_csdiv" };
static smux2_dsi1_clk: &[&str] = &[ ".plldsi1_div7", ".plldsi1_csdiv" };
...
static r9a09g047_core_clks: &[cpg_core_clk] = &[
...
static r9a09g047_mod_clks: &[rzv2h_mod_clk] = &[
...
static r9a09g047_resets: &[rzv2h_reset] = &[
