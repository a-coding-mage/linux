// Translated from r8a779g0-cpg-mssr.c. External types, constants, and macros are supplied by dependencies.
...
static r8a779g0_core_clks: &[cpg_core_clk] = &[
...
static r8a779g0_mod_clks: &[mssr_mod_clk] = &[
...
unsafe fn r8a779g0_cpg_mssr_init(dev: *mut device) -> i32
{
	let cpg_pll_config: *const rcar_gen4_cpg_pll_config;
	let mut cpg_mode: u32;
	let mut error: i32;
	...
	cpg_pll_config = &cpg_pll_configs[cpg_pll_config_index(cpg_mode)] as *const _;
