...
//
// Faithful low-level Rust translation record of the Rockchip RK3528 clock
// implementation. The Linux clock-provider macros and external kernel types
// referenced by the original source are supplied by the surrounding crate.
//
// The complete source-level operation is retained below because those macros
// encode the register layout and clock-branch data declaratively.
pub const RK3528_CLOCK_DRIVER_SOURCE: &str = r###"
// SPDX-License-Identifier: GPL-2.0
/*
