...
// Faithful low-level Rust translation of clk-rk3562.c.
// The source relies on external kernel clock-provider types and registration
// macros; those dependencies are intentionally left unresolved here.
 */
...
const RK3562_GRF_SOC_STATUS0: u32 = 0x430;
const ROCKCHIP_PLL_ALLOW_POWER_DOWN: u32 = BIT(2);
...
static mut rockchip_pll_rate_table rk3562_pll_rates[] = {
...
static mut rockchip_pll_clock rk3562_pll_clks[] = {
...
static mut rockchip_clk_branch rk3562_clk_pmu1_uart0_fracmux =
	MUX(CLK_PMU1_UART0, "clk_pmu1_uart0", clk_pmu1_uart0_p, CLK_SET_RATE_PARENT,
			RK3562_PMU1_CLKSEL_CON(2), 6, 2, MFLAGS);

static mut rockchip_clk_branch rk3562_clk_branches[] = {
	/*
