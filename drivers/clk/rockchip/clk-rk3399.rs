// Faithful low-level Rust translation; kernel-provided macros/types remain external dependencies.
...
// dependency: <linux/property.h>
// dependency: <linux/regmap.h>
// dependency: <dt-bindings/clock/rk3399-cru.h>
// dependency: "clk.h"
...
static mut rk3399_pll_clks: [rockchip_pll_clock; 0] = {
...
static mut rk3399_pmu_pll_clks: [rockchip_pll_clock; 0] = {
...
static rk3399_cpuclkl_data: rockchip_cpuclk_reg_data = {
...
const RK3399_DIV_ACLKM_SHIFT: u32 = 8;
const RK3399_DIV_ATCLK_MASK: u32 = 0x1f;
const RK3399_DIV_ATCLK_SHIFT: u32 = 0;
const RK3399_DIV_PCLK_DBG_MASK: u32 = 0x1f;
...
static mut rk3399_cpuclkb_rates: [rockchip_cpuclk_rate_table; 0] = {
...
static mut rk3399_clk_branches: [rockchip_clk_branch; 0] = {
	/*
...
static mut rk3399_clk_pmu_branches: [rockchip_clk_branch; 0] = {
	/*
...
static rk3399_cru_critical_clocks: [&str; 0] = {
	"aclk_cci_pre",
	"aclk_gic",
	"aclk_gic_noc",
	"aclk_hdcp_noc",
...
static rk3399_pmucru_critical_clocks: [&str; 0] = {
	"ppll",
	"pclk_pmu_src",
	"fclk_cm0s_src_pmu",
	"clk_timer_src_pmu",
...
struct clk_rk3399_inits {
	unsafe extern "C" fn inits(np: *mut device_node);
};
