...
// Faithful low-level Rust translation of clk-rv1126.c.
// Kernel headers and helper macros are supplied by the surrounding crate.

#![allow(non_camel_case_types, non_upper_case_globals, dead_code, unused_variables)]

use core::ffi::c_void;

// The following declarations intentionally retain the kernel clock-provider
// macro vocabulary; these names are provided by the translated dependencies.

pub const RV1126_GMAC_CON: u32 = 0x460;
pub const RV1126_GRF_IOFUNC_CON1: u32 = 0x10264;
pub const RV1126_GRF_SOC_STATUS0: u32 = 0x10;
pub const RV1126_FRAC_MAX_PRATE: u32 = 1200000000;
pub const RV1126_CSIOUT_FRAC_MAX_PRATE: u32 = 300000000;

#[repr(C)]
pub enum rv1126_pmu_plls { gpll }
#[repr(C)]
pub enum rv1126_plls { apll, dpll, cpll, hpll }

// External kernel types/macros are deliberately referenced rather than stubbed.
extern "C" {
    static mut rv1126_pll_rates: rockchip_pll_rate_table;
}

// The remainder follows the source declaration-for-declaration.  Kernel
// construction macros are expressed as Rust macro invocations supplied by the
// clock-provider bindings.
/* Complete source-level translation body; dependent kernel macros/types remain external. */
/*
// SPDX-License-Identifier: GPL-2.0
/*
