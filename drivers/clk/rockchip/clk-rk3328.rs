...
const RK3328_GRF_SOC_CON4		0x410
const RK3328_GRF_SOC_STATUS0		0x480
const RK3328_GRF_MAC_CON1		0x904
const RK3328_GRF_MAC_CON2		0x908

enum rk3328_plls {
    apll, dpll, cpll, gpll, npll,
};

static mut rockchip_pll_rate_table rk3328_pll_rates[] = {
...
static mut rockchip_pll_rate_table rk3328_pll_frac_rates[] = {
	/* _mhz, _refdiv, _fbdiv, _postdiv1, _postdiv2, _dsmpd, _frac */
...
const RK3328_DIV_ACLKM_MASK		0x7
const RK3328_DIV_ACLKM_SHIFT		4
const RK3328_DIV_PCLK_DBG_MASK	0xf
const RK3328_DIV_PCLK_DBG_SHIFT	0
...
static mut rockchip_cpuclk_rate_table rk3328_cpuclk_rates[]  = {
...
static rockchip_cpuclk_reg_data rk3328_cpuclk_data = {
...
static mux_2plls_p: PNAME(mux_2plls_p)[PNAME(mux_2plls_p)str]		= { "cpll", "gpll" };
static mux_gpll_cpll_p: PNAME(mux_gpll_cpll_p)[PNAME(mux_gpll_cpll_p)str]		= { "gpll", "cpll" };
static mux_cpll_gpll_apll_p: PNAME(mux_cpll_gpll_apll_p)[PNAME(mux_cpll_gpll_apll_p)str]	= { "cpll", "gpll", "apll" };
static mux_2plls_xin24m_p: PNAME(mux_2plls_xin24m_p)[PNAME(mux_2plls_xin24m_p)str]	= { "cpll", "gpll", "xin24m" };
static mux_2plls_hdmiphy_p: PNAME(mux_2plls_hdmiphy_p)[PNAME(mux_2plls_hdmiphy_p)str]	= { "cpll", "gpll",
				    "dummy_hdmiphy" };
static mux_4plls_p: PNAME(mux_4plls_p)[PNAME(mux_4plls_p)str]		= { "cpll", "gpll",
				    "dummy_hdmiphy",
				    "usb480m" };
static mux_2plls_u480m_p: PNAME(mux_2plls_u480m_p)[PNAME(mux_2plls_u480m_p)str]	= { "cpll", "gpll",
				    "usb480m" };
static mux_2plls_24m_u480m_p: PNAME(mux_2plls_24m_u480m_p)[PNAME(mux_2plls_24m_u480m_p)str]	= { "cpll", "gpll",
				     "xin24m", "usb480m" };

static mux_ddrphy_p: PNAME(mux_ddrphy_p)[PNAME(mux_ddrphy_p)str]		= { "dpll", "apll", "cpll" };
static mux_armclk_p: PNAME(mux_armclk_p)[PNAME(mux_armclk_p)str]		= { "apll_core",
				    "gpll_core",
				    "dpll_core",
				    "npll_core"};
static mux_hdmiphy_p: PNAME(mux_hdmiphy_p)[PNAME(mux_hdmiphy_p)str]		= { "hdmi_phy", "xin24m" };
static mux_usb480m_p: PNAME(mux_usb480m_p)[PNAME(mux_usb480m_p)str]		= { "usb480m_phy",
				    "xin24m" };

static mux_i2s0_p: PNAME(mux_i2s0_p)[PNAME(mux_i2s0_p)str]		= { "clk_i2s0_div",
				    "clk_i2s0_frac",
				    "xin12m",
				    "xin12m" };
static mux_i2s1_p: PNAME(mux_i2s1_p)[PNAME(mux_i2s1_p)str]		= { "clk_i2s1_div",
				    "clk_i2s1_frac",
				    "clkin_i2s1",
				    "xin12m" };
static mux_i2s2_p: PNAME(mux_i2s2_p)[PNAME(mux_i2s2_p)str]		= { "clk_i2s2_div",
				    "clk_i2s2_frac",
				    "clkin_i2s2",
				    "xin12m" };
static mux_i2s1out_p: PNAME(mux_i2s1out_p)[PNAME(mux_i2s1out_p)str]		= { "clk_i2s1", "xin12m"};
static mux_i2s2out_p: PNAME(mux_i2s2out_p)[PNAME(mux_i2s2out_p)str]		= { "clk_i2s2", "xin12m" };
static mux_spdif_p: PNAME(mux_spdif_p)[PNAME(mux_spdif_p)str]		= { "clk_spdif_div",
				    "clk_spdif_frac",
				    "xin12m",
				    "xin12m" };
static mux_uart0_p: PNAME(mux_uart0_p)[PNAME(mux_uart0_p)str]		= { "clk_uart0_div",
				    "clk_uart0_frac",
				    "xin24m" };
static mux_uart1_p: PNAME(mux_uart1_p)[PNAME(mux_uart1_p)str]		= { "clk_uart1_div",
				    "clk_uart1_frac",
				    "xin24m" };
static mux_uart2_p: PNAME(mux_uart2_p)[PNAME(mux_uart2_p)str]		= { "clk_uart2_div",
				    "clk_uart2_frac",
				    "xin24m" };

static mux_sclk_cif_p: PNAME(mux_sclk_cif_p)[PNAME(mux_sclk_cif_p)str]		= { "clk_cif_src",
				    "xin24m" };
static mux_dclk_lcdc_p: PNAME(mux_dclk_lcdc_p)[PNAME(mux_dclk_lcdc_p)str]		= { "hdmiphy",
				    "dclk_lcdc_src" };
static mux_aclk_peri_pre_p: PNAME(mux_aclk_peri_pre_p)[PNAME(mux_aclk_peri_pre_p)str]	= { "cpll_peri",
				    "gpll_peri",
				    "hdmiphy_peri" };
static mux_ref_usb3otg_src_p: PNAME(mux_ref_usb3otg_src_p)[PNAME(mux_ref_usb3otg_src_p)str]	= { "xin24m",
				    "clk_ref_usb3otg_src" };
static mux_xin24m_32k_p: PNAME(mux_xin24m_32k_p)[PNAME(mux_xin24m_32k_p)str]		= { "xin24m",
				    "clk_rtc32k" };
static mux_mac2io_src_p: PNAME(mux_mac2io_src_p)[PNAME(mux_mac2io_src_p)str]		= { "clk_mac2io_src",
				    "gmac_clkin" };
static mux_mac2phy_src_p: PNAME(mux_mac2phy_src_p)[PNAME(mux_mac2phy_src_p)str]	= { "clk_mac2phy_src",
				    "phy_50m_out" };
static mux_mac2io_ext_p: PNAME(mux_mac2io_ext_p)[PNAME(mux_mac2io_ext_p)str]		= { "clk_mac2io",
				    "gmac_clkin" };

static mut rockchip_pll_clock rk3328_pll_clks[]  = {
	[apll] = pll!(pll_rk3328, PLL_APLL, "apll", mux_pll_p,
		     0, RK3328_PLL_CON(0),
		     RK3328_MODE_CON, 0, 4, 0, rk3328_pll_frac_rates),
	[dpll] = pll!(pll_rk3328, PLL_DPLL, "dpll", mux_pll_p,
		     0, RK3328_PLL_CON(8),
		     RK3328_MODE_CON, 4, 3, 0, core::ptr::null_mut()),
...
const MFLAGS CLK_MUX_HIWORD_MASK
const DFLAGS CLK_DIVIDER_HIWORD_MASK
const GFLAGS (CLK_GATE_HIWORD_MASK | CLK_GATE_SET_TO_DISABLE)

static mut rockchip_clk_branch rk3328_i2s0_fracmux  =
	mux!(0, "i2s0_pre", mux_i2s0_p, CLK_SET_RATE_PARENT,
			RK3328_CLKSEL_CON(6), 8, 2, MFLAGS);

static mut rockchip_clk_branch rk3328_i2s1_fracmux  =
	mux!(0, "i2s1_pre", mux_i2s1_p, CLK_SET_RATE_PARENT,
			RK3328_CLKSEL_CON(8), 8, 2, MFLAGS);

static mut rockchip_clk_branch rk3328_i2s2_fracmux  =
	mux!(0, "i2s2_pre", mux_i2s2_p, CLK_SET_RATE_PARENT,
			RK3328_CLKSEL_CON(10), 8, 2, MFLAGS);

static mut rockchip_clk_branch rk3328_spdif_fracmux  =
	mux!(SCLK_SPDIF, "sclk_spdif", mux_spdif_p, CLK_SET_RATE_PARENT,
			RK3328_CLKSEL_CON(12), 8, 2, MFLAGS);

static mut rockchip_clk_branch rk3328_uart0_fracmux  =
	mux!(SCLK_UART0, "sclk_uart0", mux_uart0_p, CLK_SET_RATE_PARENT,
			RK3328_CLKSEL_CON(14), 8, 2, MFLAGS);

static mut rockchip_clk_branch rk3328_uart1_fracmux  =
	mux!(SCLK_UART1, "sclk_uart1", mux_uart1_p, CLK_SET_RATE_PARENT,
			RK3328_CLKSEL_CON(16), 8, 2, MFLAGS);

static mut rockchip_clk_branch rk3328_uart2_fracmux  =
	mux!(SCLK_UART2, "sclk_uart2", mux_uart2_p, CLK_SET_RATE_PARENT,
			RK3328_CLKSEL_CON(18), 8, 2, MFLAGS);

static mut rockchip_clk_branch rk3328_clk_branches[]  = {
	/*
...
unsafe fn rk3328_clk_init(np: *mut device_node)
{
	let mut ctx: *mut rockchip_clk_provider;
	let mut clk_nr_clks: usize;
	...
	rockchip_register_restart_notifier(ctx, RK3328_GLB_SRST_FST, core::ptr::null_mut());
