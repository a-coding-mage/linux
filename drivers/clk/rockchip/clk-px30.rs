...
const PX30_GRF_SOC_STATUS0: u32 = 0x480;
...
static mut rockchip_pll_rate_table px30_pll_rates[] = {
...
const PX30_DIV_ACLKM_MASK: u32 = 0x7;
const PX30_DIV_ACLKM_SHIFT: u32 = 12;
const PX30_DIV_PCLK_DBG_MASK: u32 = 0xf;
const PX30_DIV_PCLK_DBG_SHIFT: u32 = 8;

// C initializer macros PX30_CLKSEL0 and PX30_CPUCLK_RATE are represented by external Rust macros.

static mut rockchip_cpuclk_rate_table px30_cpuclk_rates[]  = {
...
static rockchip_cpuclk_reg_data px30_cpuclk_data = {
...
static mut rockchip_pll_clock px30_pll_clks[]  = {
	[apll] = PLL!(pll_rk3328, PLL_APLL, "apll", mux_pll_p,
		     0, PX30_PLL_CON(0),
		     PX30_MODE_CON, 0, 0, 0, px30_pll_rates),
	[dpll] = PLL!(pll_rk3328, PLL_DPLL, "dpll", mux_pll_p,
		     0, PX30_PLL_CON(8),
		     PX30_MODE_CON, 4, 1, 0, core::ptr::null_mut()),
...
static mut rockchip_pll_clock px30_pmu_pll_clks[]  = {
...
static mut rockchip_clk_branch px30_clk_pmu_branches[]  = {
	/*
...
static px30_cru_critical_clocks[]  = {
	"aclk_bus_pre",
	"pclk_bus_pre",
	"hclk_bus_pre",
	"aclk_peri_pre",
...
unsafe fn px30_clk_init(np: *mut device_node)
{
	...
	rockchip_clk_register_armclk(ctx, ARMCLK, "armclk",
				     ...
				     &mut px30_cpuclk_data, px30_cpuclk_rates,
				     array_size!(px30_cpuclk_rates));

	rockchip_clk_protect_critical(px30_cru_critical_clocks,
				      array_size!(px30_cru_critical_clocks));

	rockchip_register_softrst(np, 12, (reg_base as *mut u8).add(PX30_SOFTRST_CON(0),
				  ROCKCHIP_SOFTRST_HIWORD_MASK);

	rockchip_register_restart_notifier(ctx, PX30_GLB_SRST_FST, core::ptr::null_mut());

	rockchip_clk_of_add_provider(np, ctx);
}
// Device-tree registration: px30_cru, "rockchip,px30-cru", px30_clk_init;

unsafe fn px30_pmu_clk_init(np: *mut device_node)
{
	let mut ctx: *mut rockchip_clk_provider;
	let mut clkpmu_nr_clks: usize;
	let mut reg_base: *mut core::ffi::c_void;
...
// Device-tree registration: px30_cru_pmu, "rockchip,px30-pmucru", px30_pmu_clk_init;
