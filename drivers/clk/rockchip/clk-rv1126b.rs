...
// Direct source-level translation of clk-rv1126b.c. Kernel-provided clock
// provider types, constants, and constructor macros remain external.
pub const RV1126B_FRAC_MAX_PRATE: u32 = 1_200_000_000;
pub const PVTPLL_SRC_SEL_PVTPLL: u32 = (1u32 << 0) | (1u32 << 16);

#[repr(C)]
#[derive(Copy, Clone)]
pub enum rv1126b_plls { gpll, cpll, aupll, dpll }
