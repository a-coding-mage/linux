...
// dependency: #include <linux/syscore_ops.h>
// dependency: #include <dt-bindings/clock/rk3568-cru.h>
// dependency: #include "clk.h"

const RK3568_GRF_SOC_STATUS0	0x580
...
static mut rockchip_pll_rate_table rk3568_pll_rates[] = {
...
const RK3568_DIV_ATCLK_CORE_MASK	0x1f
const RK3568_DIV_ATCLK_CORE_SHIFT	0
const RK3568_DIV_GICCLK_CORE_MASK	0x1f
const RK3568_DIV_GICCLK_CORE_SHIFT	8
const RK3568_DIV_PCLK_CORE_MASK	0x1f
const RK3568_DIV_PCLK_CORE_SHIFT	0
const RK3568_DIV_PERIPHCLK_CORE_MASK	0x1f
const RK3568_DIV_PERIPHCLK_CORE_SHIFT	8
const RK3568_DIV_ACLK_CORE_MASK	0x1f
const RK3568_DIV_ACLK_CORE_SHIFT	8

const RK3568_DIV_SCLK_CORE_MASK	0xf
const RK3568_DIV_SCLK_CORE_SHIFT	0
const RK3568_MUX_SCLK_CORE_MASK	0x3
const RK3568_MUX_SCLK_CORE_SHIFT	8
const RK3568_MUX_SCLK_CORE_NPLL_MASK	0x1
const RK3568_MUX_SCLK_CORE_NPLL_SHIFT	15
const RK3568_MUX_CLK_CORE_APLL_MASK	0x1
const RK3568_MUX_CLK_CORE_APLL_SHIFT	7
const RK3568_MUX_CLK_PVTPLL_MASK	0x1
const RK3568_MUX_CLK_PVTPLL_SHIFT	15
...
static mut rockchip_cpuclk_rate_table rk3568_cpuclk_rates[] = {
...
static rockchip_cpuclk_reg_data rk3568_cpuclk_data = {
...
static mut rockchip_pll_clock rk3568_pmu_pll_clks[] = {
...
static mut rockchip_pll_clock rk3568_pll_clks[] = {
...
static mut rockchip_clk_branch rk3568_clk_branches[] = {
	/*
...
static mut rockchip_clk_branch rk3568_clk_pmu_branches[] = {
	/* PD_PMU */
...
static const char *const rk3568_cru_critical_clocks[] = {
	"armclk",
	"pclk_core_pre",
	"aclk_bus",
	"pclk_bus",
...
static const char *const rk3568_pmucru_critical_clocks[] = {
	"pclk_pdpmu",
	"pclk_pmu",
	"clk_pmu",
};

static void rk3568_pmu_clk_init(device_node *np)
{
...
static void rk3568_clk_init(device_node *np)
{
	rockchip_clk_provider *ctx;
