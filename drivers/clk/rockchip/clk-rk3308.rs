// Direct translation of clk-rk3308.c; included kernel symbols and helper macros remain external dependencies.
...
const RK3308_GRF_SOC_STATUS0: u32 = 0x380;
...
const RK3308_DIV_ACLKM_MASK: u32 = 0x7;
const RK3308_DIV_ACLKM_SHIFT: u32 = 12;
const RK3308_DIV_PCLK_DBG_MASK: u32 = 0xf;
const RK3308_DIV_PCLK_DBG_SHIFT: u32 = 8;
...
static mut rk3308_cpuclk_rates: [rockchip_cpuclk_rate_table; _] = {
...
static rk3308_cpuclk_data: rockchip_cpuclk_reg_data = {
...
static mux_usb480m_p: &[&str] = &[ "xin24m", "usb480m_phy", "clk_rtc32k" ];
static mux_armclk_p: &[&str] = &[ "apll_core", "vpll0_core", "vpll1_core" ];
static mux_dpll_vpll0_p: &[&str] = &[ "dpll", "vpll0" ];
static mux_dpll_vpll0_xin24m_p: &[&str] = &[ "dpll", "vpll0", "xin24m" ];
static mux_dpll_vpll0_vpll1_p: &[&str] = &[ "dpll", "vpll0", "vpll1" ];
static mux_dpll_vpll0_vpll1_xin24m_p: &[&str] = &[ "dpll", "vpll0", "vpll1", "xin24m" ];
static mux_dpll_vpll0_vpll1_usb480m_xin24m_p: &[&str] = &[ "dpll", "vpll0", "vpll1", "usb480m", "xin24m" ];
static mux_vpll0_vpll1_p: &[&str] = &[ "vpll0", "vpll1" ];
static mux_vpll0_vpll1_xin24m_p: &[&str] = &[ "vpll0", "vpll1", "xin24m" ];
static mux_uart0_p: &[&str] = &[ "clk_uart0_src", "dummy", "clk_uart0_frac" ];
static mux_uart1_p: &[&str] = &[ "clk_uart1_src", "dummy", "clk_uart1_frac" ];
static mux_uart2_p: &[&str] = &[ "clk_uart2_src", "dummy", "clk_uart2_frac" ];
static mux_uart3_p: &[&str] = &[ "clk_uart3_src", "dummy", "clk_uart3_frac" ];
static mux_uart4_p: &[&str] = &[ "clk_uart4_src", "dummy", "clk_uart4_frac" ];
static mux_dclk_vop_p: &[&str] = &[ "dclk_vop_src", "dclk_vop_frac", "xin24m" ];
static mux_nandc_p: &[&str] = &[ "clk_nandc_div", "clk_nandc_div50" ];
static mux_sdmmc_p: &[&str] = &[ "clk_sdmmc_div", "clk_sdmmc_div50" ];
static mux_sdio_p: &[&str] = &[ "clk_sdio_div", "clk_sdio_div50" ];
static mux_emmc_p: &[&str] = &[ "clk_emmc_div", "clk_emmc_div50" ];
static mux_mac_p: &[&str] = &[ "clk_mac_src", "mac_clkin" ];
static mux_mac_rmii_sel_p: &[&str] = &[ "clk_mac_rx_tx_div20", "clk_mac_rx_tx_div2" ];
static mux_ddrstdby_p: &[&str] = &[ "clk_ddrphy1x_out", "clk_ddr_stdby_div4" ];
static mux_rtc32k_p: &[&str] = &[ "xin32k", "clk_pvtm_32k", "clk_rtc32k_frac", "clk_rtc32k_div" ];
static mux_usbphy_ref_p: &[&str] = &[ "xin24m", "clk_usbphy_ref_src" ];
static mux_wifi_src_p: &[&str] = &[ "clk_wifi_dpll", "clk_wifi_vpll0" ];
static mux_wifi_p: &[&str] = &[ "clk_wifi_osc", "clk_wifi_src" ];
static mux_pdm_p: &[&str] = &[ "clk_pdm_src", "clk_pdm_frac" ];
static mux_i2s0_8ch_tx_p: &[&str] = &[ "clk_i2s0_8ch_tx_src", "clk_i2s0_8ch_tx_frac", "mclk_i2s0_8ch_in" ];
static mux_i2s0_8ch_tx_rx_p: &[&str] = &[ "clk_i2s0_8ch_tx_mux", "clk_i2s0_8ch_rx_mux"];
static mux_i2s0_8ch_tx_out_p: &[&str] = &[ "clk_i2s0_8ch_tx", "xin12m" ];
static mux_i2s0_8ch_rx_p: &[&str] = &[ "clk_i2s0_8ch_rx_src", "clk_i2s0_8ch_rx_frac", "mclk_i2s0_8ch_in" ];
static mux_i2s0_8ch_rx_tx_p: &[&str] = &[ "clk_i2s0_8ch_rx_mux", "clk_i2s0_8ch_tx_mux"];
static mux_i2s1_8ch_tx_p: &[&str] = &[ "clk_i2s1_8ch_tx_src", "clk_i2s1_8ch_tx_frac", "mclk_i2s1_8ch_in" ];
static mux_i2s1_8ch_tx_rx_p: &[&str] = &[ "clk_i2s1_8ch_tx_mux", "clk_i2s1_8ch_rx_mux"];
static mux_i2s1_8ch_tx_out_p: &[&str] = &[ "clk_i2s1_8ch_tx", "xin12m" ];
static mux_i2s1_8ch_rx_p: &[&str] = &[ "clk_i2s1_8ch_rx_src", "clk_i2s1_8ch_rx_frac", "mclk_i2s1_8ch_in" ];
static mux_i2s1_8ch_rx_tx_p: &[&str] = &[ "clk_i2s1_8ch_rx_mux", "clk_i2s1_8ch_tx_mux"];
static mux_i2s2_8ch_tx_p: &[&str] = &[ "clk_i2s2_8ch_tx_src", "clk_i2s2_8ch_tx_frac", "mclk_i2s2_8ch_in" ];
static mux_i2s2_8ch_tx_rx_p: &[&str] = &[ "clk_i2s2_8ch_tx_mux", "clk_i2s2_8ch_rx_mux"];
static mux_i2s2_8ch_tx_out_p: &[&str] = &[ "clk_i2s2_8ch_tx", "xin12m" ];
static mux_i2s2_8ch_rx_p: &[&str] = &[ "clk_i2s2_8ch_rx_src", "clk_i2s2_8ch_rx_frac", "mclk_i2s2_8ch_in" ];
static mux_i2s2_8ch_rx_tx_p: &[&str] = &[ "clk_i2s2_8ch_rx_mux", "clk_i2s2_8ch_tx_mux"];
static mux_i2s3_8ch_tx_p: &[&str] = &[ "clk_i2s3_8ch_tx_src", "clk_i2s3_8ch_tx_frac", "mclk_i2s3_8ch_in" ];
static mux_i2s3_8ch_tx_rx_p: &[&str] = &[ "clk_i2s3_8ch_tx_mux", "clk_i2s3_8ch_rx_mux"];
static mux_i2s3_8ch_tx_out_p: &[&str] = &[ "clk_i2s3_8ch_tx", "xin12m" ];
static mux_i2s3_8ch_rx_p: &[&str] = &[ "clk_i2s3_8ch_rx_src", "clk_i2s3_8ch_rx_frac", "mclk_i2s3_8ch_in" ];
static mux_i2s3_8ch_rx_tx_p: &[&str] = &[ "clk_i2s3_8ch_rx_mux", "clk_i2s3_8ch_tx_mux"];
static mux_i2s0_2ch_p: &[&str] = &[ "clk_i2s0_2ch_src", "clk_i2s0_2ch_frac", "mclk_i2s0_2ch_in" ];
static mux_i2s0_2ch_out_p: &[&str] = &[ "clk_i2s0_2ch", "xin12m" ];
static mux_i2s1_2ch_p: &[&str] = &[ "clk_i2s1_2ch_src", "clk_i2s1_2ch_frac", "mclk_i2s1_2ch_in"];
static mux_i2s1_2ch_out_p: &[&str] = &[ "clk_i2s1_2ch", "xin12m" ];
static mux_spdif_tx_src_p: &[&str] = &[ "clk_spdif_tx_div", "clk_spdif_tx_div50" ];
static mux_spdif_tx_p: &[&str] = &[ "clk_spdif_tx_src", "clk_spdif_tx_frac", "mclk_i2s0_2ch_in" ];
static mux_spdif_rx_src_p: &[&str] = &[ "clk_spdif_rx_div", "clk_spdif_rx_div50" ];
static mux_spdif_rx_p: &[&str] = &[ "clk_spdif_rx_src", "clk_spdif_rx_frac" ];

static mut rk3308_pll_clks: [rockchip_pll_clock; _] = {
...
static void __init rk3308_clk_init(struct device_node *np)
{
	...
	rockchip_register_restart_notifier(ctx, RK3308_GLB_SRST_FST, core::ptr::null_mut());
