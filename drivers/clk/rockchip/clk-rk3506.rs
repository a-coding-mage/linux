...
// Faithful low-level Rust translation. Kernel-provided types, constants,
// macros, and functions remain external dependencies supplied by other files.
/*
...
// dependency: <linux/of_device.h>
// dependency: <linux/of_address.h>
// dependency: <linux/platform_device.h>
// dependency: <linux/syscore_ops.h>
// dependency: <dt-bindings/clock/rockchip,rk3506-cru.h>
// dependency: "clk.h"

// C macro: #define PVTPLL_SRC_SEL_PVTPLL		(BIT(7) | BIT(23))
 ...
 *   - post2div: 1 to 7
 */
static mut rockchip_pll_rate_table rk3506_pll_rates[] = {
...
// C macro: #define RK3506_DIV_ACLK_CORE_MASK	0xf
// C macro: #define RK3506_DIV_ACLK_CORE_SHIFT	9
// C macro: #define RK3506_DIV_PCLK_CORE_MASK	0xf
...
// C macro: #define MFLAGS CLK_MUX_HIWORD_MASK
// C macro: #define DFLAGS CLK_DIVIDER_HIWORD_MASK
// C macro: #define GFLAGS (CLK_GATE_HIWORD_MASK | CLK_GATE_SET_TO_DISABLE)

static mut rockchip_pll_clock rk3506_pll_clks[] __initdata = {
...
static mut rockchip_clk_branch rk3506_armclk __initdata =
	MUX(ARMCLK, "armclk", mux_armclk_p, CLK_IS_CRITICAL | CLK_SET_RATE_PARENT,
			RK3506_CLKSEL_CON(15), 8, 1, MFLAGS);

static mut rockchip_clk_branch rk3506_clk_branches[] __initdata = {
	/*
...
unsafe fn __init rk3506_clk_init(*mut device_node np)
{
	struct rockchip_clk_provider *ctx;
	u64 clk_nr_clks;
	*mut core::ffi::c_void reg_base;
