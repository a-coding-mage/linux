...
// dependency: <linux/mfd/syscon.h>
// dependency: <linux/of.h>
// dependency: <linux/of_address.h>
// dependency: <linux/platform_device.h>
// dependency: <linux/syscore_ops.h>
// dependency: <dt-bindings/clock/rockchip,rk3588-cru.h>
// dependency: <soc/rockchip/rk3588_grf.h>
// dependency: "clk.h"

const RK3588_GRF_SOC_STATUS0: u32 = 0x600;
const RK3588_PHYREF_ALT_GATE: u32 = 0xc38;

enum rk3588_plls {
	b0pll, b1pll, lpll, v0pll, aupll, cpll, gpll, npll, ppll,
};

static mut rockchip_pll_rate_table rk3588_pll_rates[] = {
	/* _mhz, _p, _m, _s, _k */
...
const RK3588_CLK_CORE_B0_SEL_CLEAN_MASK: u32 = 0x3;
const RK3588_CLK_CORE_B0_SEL_CLEAN_SHIFT: u32 = 13;
const RK3588_CLK_CORE_B1_SEL_CLEAN_MASK: u32 = 0x3;
const RK3588_CLK_CORE_B1_SEL_CLEAN_SHIFT: u32 = 5;
const RK3588_CLK_CORE_B0_GPLL_DIV_MASK: u32 = 0x1f;
const RK3588_CLK_CORE_B0_GPLL_DIV_SHIFT: u32 = 1;
const RK3588_CLK_CORE_L_SEL_CLEAN_MASK: u32 = 0x3;
const RK3588_CLK_CORE_L1_SEL_CLEAN_SHIFT: u32 = 12;
const RK3588_CLK_CORE_L0_SEL_CLEAN_SHIFT: u32 = 5;
const RK3588_CLK_DSU_SEL_DF_MASK: u32 = 0x1;
const RK3588_CLK_DSU_SEL_DF_SHIFT: u32 = 15;
const RK3588_CLK_DSU_DF_SRC_MASK: u32 = 0x3;
const RK3588_CLK_DSU_DF_SRC_SHIFT: u32 = 12;
const RK3588_CLK_DSU_DF_DIV_MASK: u32 = 0x1f;
const RK3588_CLK_DSU_DF_DIV_SHIFT: u32 = 7;
const RK3588_ACLKM_DSU_DIV_MASK: u32 = 0x1f;
const RK3588_ACLKM_DSU_DIV_SHIFT: u32 = 1;
const RK3588_ACLKS_DSU_DIV_MASK: u32 = 0x1f;
const RK3588_ACLKS_DSU_DIV_SHIFT: u32 = 6;
const RK3588_ACLKMP_DSU_DIV_MASK: u32 = 0x1f;
const RK3588_ACLKMP_DSU_DIV_SHIFT: u32 = 11;
const RK3588_PERIPH_DSU_DIV_MASK: u32 = 0x1f;
const RK3588_PERIPH_DSU_DIV_SHIFT: u32 = 0;
const RK3588_ATCLK_DSU_DIV_MASK: u32 = 0x1f;
const RK3588_ATCLK_DSU_DIV_SHIFT: u32 = 0;
const RK3588_GICCLK_DSU_DIV_MASK: u32 = 0x1f;
const RK3588_GICCLK_DSU_DIV_SHIFT: u32 = 5;
...
static mut rockchip_clk_provider *early_ctx;

static mut rockchip_cpuclk_rate_table rk3588_cpub0clk_rates[]  = {
...
static rockchip_cpuclk_reg_data rk3588_cpub0clk_data = {
...
static rockchip_cpuclk_reg_data rk3588_cpub1clk_data = {
...
static rockchip_cpuclk_reg_data rk3588_cpulclk_data = {
...
static mux_armclkl_p: PNAME(mux_armclkl_p)[PNAME(mux_armclkl_p)str]			= { "xin24m", "gpll", "lpll" };
static mux_armclkb01_p: PNAME(mux_armclkb01_p)[PNAME(mux_armclkb01_p)str]			= { "xin24m", "gpll", "b0pll",};
static mux_armclkb23_p: PNAME(mux_armclkb23_p)[PNAME(mux_armclkb23_p)str]			= { "xin24m", "gpll", "b1pll",};
static b0pll_b1pll_lpll_gpll_p: PNAME(b0pll_b1pll_lpll_gpll_p)[PNAME(b0pll_b1pll_lpll_gpll_p)str]		= { "b0pll", "b1pll", "lpll", "gpll" };
static gpll_24m_p: PNAME(gpll_24m_p)[PNAME(gpll_24m_p)str]			= { "gpll", "xin24m" };
static gpll_aupll_p: PNAME(gpll_aupll_p)[PNAME(gpll_aupll_p)str]			= { "gpll", "aupll" };
static gpll_lpll_p: PNAME(gpll_lpll_p)[PNAME(gpll_lpll_p)str]			= { "gpll", "lpll" };
static gpll_cpll_p: PNAME(gpll_cpll_p)[PNAME(gpll_cpll_p)str]			= { "gpll", "cpll" };
static gpll_spll_p: PNAME(gpll_spll_p)[PNAME(gpll_spll_p)str]			= { "gpll", "spll" };
static gpll_cpll_24m_p: PNAME(gpll_cpll_24m_p)[PNAME(gpll_cpll_24m_p)str]			= { "gpll", "cpll", "xin24m"};
static gpll_cpll_aupll_p: PNAME(gpll_cpll_aupll_p)[PNAME(gpll_cpll_aupll_p)str]		= { "gpll", "cpll", "aupll"};
static gpll_cpll_npll_p: PNAME(gpll_cpll_npll_p)[PNAME(gpll_cpll_npll_p)str]			= { "gpll", "cpll", "npll"};
static gpll_cpll_npll_v0pll_p: PNAME(gpll_cpll_npll_v0pll_p)[PNAME(gpll_cpll_npll_v0pll_p)str]		= { "gpll", "cpll", "npll", "v0pll"};
static gpll_cpll_24m_spll_p: PNAME(gpll_cpll_24m_spll_p)[PNAME(gpll_cpll_24m_spll_p)str]		= { "gpll", "cpll", "xin24m", "spll" };
static gpll_cpll_aupll_spll_p: PNAME(gpll_cpll_aupll_spll_p)[PNAME(gpll_cpll_aupll_spll_p)str]		= { "gpll", "cpll", "aupll", "spll" };
static gpll_cpll_aupll_npll_p: PNAME(gpll_cpll_aupll_npll_p)[PNAME(gpll_cpll_aupll_npll_p)str]		= { "gpll", "cpll", "aupll", "npll" };
static gpll_cpll_v0pll_aupll_p: PNAME(gpll_cpll_v0pll_aupll_p)[PNAME(gpll_cpll_v0pll_aupll_p)str]		= { "gpll", "cpll", "v0pll", "aupll" };
static gpll_cpll_v0pll_spll_p: PNAME(gpll_cpll_v0pll_spll_p)[PNAME(gpll_cpll_v0pll_spll_p)str]		= { "gpll", "cpll", "v0pll", "spll" };
static gpll_cpll_aupll_npll_spll_p: PNAME(gpll_cpll_aupll_npll_spll_p)[PNAME(gpll_cpll_aupll_npll_spll_p)str]	= { "gpll", "cpll", "aupll", "npll", "spll" };
static gpll_cpll_dmyaupll_npll_spll_p: PNAME(gpll_cpll_dmyaupll_npll_spll_p)[PNAME(gpll_cpll_dmyaupll_npll_spll_p)str]	= { "gpll", "cpll", "dummy_aupll", "npll", "spll" };
static gpll_cpll_npll_aupll_spll_p: PNAME(gpll_cpll_npll_aupll_spll_p)[PNAME(gpll_cpll_npll_aupll_spll_p)str]	= { "gpll", "cpll", "npll", "aupll", "spll" };
static gpll_cpll_npll_1000m_p: PNAME(gpll_cpll_npll_1000m_p)[PNAME(gpll_cpll_npll_1000m_p)str]		= { "gpll", "cpll", "npll", "clk_1000m_src" };
static mux_24m_spll_gpll_cpll_p: PNAME(mux_24m_spll_gpll_cpll_p)[PNAME(mux_24m_spll_gpll_cpll_p)str]		= { "xin24m", "spll", "gpll", "cpll" };
static mux_24m_32k_p: PNAME(mux_24m_32k_p)[PNAME(mux_24m_32k_p)str]			= { "xin24m", "xin32k" };
static mux_24m_100m_p: PNAME(mux_24m_100m_p)[PNAME(mux_24m_100m_p)str]			= { "xin24m", "clk_100m_src" };
static mux_200m_100m_p: PNAME(mux_200m_100m_p)[PNAME(mux_200m_100m_p)str]			= { "clk_200m_src", "clk_100m_src" };
static mux_100m_50m_24m_p: PNAME(mux_100m_50m_24m_p)[PNAME(mux_100m_50m_24m_p)str]		= { "clk_100m_src", "clk_50m_src", "xin24m" };
static mux_150m_50m_24m_p: PNAME(mux_150m_50m_24m_p)[PNAME(mux_150m_50m_24m_p)str]		= { "clk_150m_src", "clk_50m_src", "xin24m" };
static mux_150m_100m_24m_p: PNAME(mux_150m_100m_24m_p)[PNAME(mux_150m_100m_24m_p)str]		= { "clk_150m_src", "clk_100m_src", "xin24m" };
static mux_200m_150m_24m_p: PNAME(mux_200m_150m_24m_p)[PNAME(mux_200m_150m_24m_p)str]		= { "clk_200m_src", "clk_150m_src", "xin24m" };
static mux_150m_100m_50m_24m_p: PNAME(mux_150m_100m_50m_24m_p)[PNAME(mux_150m_100m_50m_24m_p)str]		= { "clk_150m_src", "clk_100m_src", "clk_50m_src", "xin24m" };
static mux_200m_100m_50m_24m_p: PNAME(mux_200m_100m_50m_24m_p)[PNAME(mux_200m_100m_50m_24m_p)str]		= { "clk_200m_src", "clk_100m_src", "clk_50m_src", "xin24m" };
static mux_300m_200m_100m_24m_p: PNAME(mux_300m_200m_100m_24m_p)[PNAME(mux_300m_200m_100m_24m_p)str]		= { "clk_300m_src", "clk_200m_src", "clk_100m_src", "xin24m" };
static mux_700m_400m_200m_24m_p: PNAME(mux_700m_400m_200m_24m_p)[PNAME(mux_700m_400m_200m_24m_p)str]		= { "clk_700m_src", "clk_400m_src", "clk_200m_src", "xin24m" };
static mux_500m_250m_100m_24m_p: PNAME(mux_500m_250m_100m_24m_p)[PNAME(mux_500m_250m_100m_24m_p)str]		= { "clk_500m_src", "clk_250m_src", "clk_100m_src", "xin24m" };
static mux_500m_300m_100m_24m_p: PNAME(mux_500m_300m_100m_24m_p)[PNAME(mux_500m_300m_100m_24m_p)str]		= { "clk_500m_src", "clk_300m_src", "clk_100m_src", "xin24m" };
static mux_400m_200m_100m_24m_p: PNAME(mux_400m_200m_100m_24m_p)[PNAME(mux_400m_200m_100m_24m_p)str]		= { "clk_400m_src", "clk_200m_src", "clk_100m_src", "xin24m" };
static clk_i2s2_2ch_p: PNAME(clk_i2s2_2ch_p)[PNAME(clk_i2s2_2ch_p)str]			= { "clk_i2s2_2ch_src", "clk_i2s2_2ch_frac", "i2s2_mclkin", "xin12m" };
static i2s2_2ch_mclkout_p: PNAME(i2s2_2ch_mclkout_p)[PNAME(i2s2_2ch_mclkout_p)str]		= { "mclk_i2s2_2ch", "xin12m" };
static clk_i2s3_2ch_p: PNAME(clk_i2s3_2ch_p)[PNAME(clk_i2s3_2ch_p)str]			= { "clk_i2s3_2ch_src", "clk_i2s3_2ch_frac", "i2s3_mclkin", "xin12m" };
static i2s3_2ch_mclkout_p: PNAME(i2s3_2ch_mclkout_p)[PNAME(i2s3_2ch_mclkout_p)str]		= { "mclk_i2s3_2ch", "xin12m" };
static clk_i2s0_8ch_tx_p: PNAME(clk_i2s0_8ch_tx_p)[PNAME(clk_i2s0_8ch_tx_p)str]		= { "clk_i2s0_8ch_tx_src", "clk_i2s0_8ch_tx_frac", "i2s0_mclkin", "xin12m" };
static clk_i2s0_8ch_rx_p: PNAME(clk_i2s0_8ch_rx_p)[PNAME(clk_i2s0_8ch_rx_p)str]		= { "clk_i2s0_8ch_rx_src", "clk_i2s0_8ch_rx_frac", "i2s0_mclkin", "xin12m" };
static i2s0_8ch_mclkout_p: PNAME(i2s0_8ch_mclkout_p)[PNAME(i2s0_8ch_mclkout_p)str]		= { "mclk_i2s0_8ch_tx", "mclk_i2s0_8ch_rx", "xin12m" };
static clk_i2s1_8ch_tx_p: PNAME(clk_i2s1_8ch_tx_p)[PNAME(clk_i2s1_8ch_tx_p)str]		= { "clk_i2s1_8ch_tx_src", "clk_i2s1_8ch_tx_frac", "i2s1_mclkin", "xin12m" };
static clk_i2s1_8ch_rx_p: PNAME(clk_i2s1_8ch_rx_p)[PNAME(clk_i2s1_8ch_rx_p)str]		= { "clk_i2s1_8ch_rx_src", "clk_i2s1_8ch_rx_frac", "i2s1_mclkin", "xin12m" };
static i2s1_8ch_mclkout_p: PNAME(i2s1_8ch_mclkout_p)[PNAME(i2s1_8ch_mclkout_p)str]		= { "mclk_i2s1_8ch_tx", "mclk_i2s1_8ch_rx", "xin12m" };
static clk_i2s4_8ch_tx_p: PNAME(clk_i2s4_8ch_tx_p)[PNAME(clk_i2s4_8ch_tx_p)str]		= { "clk_i2s4_8ch_tx_src", "clk_i2s4_8ch_tx_frac", "i2s4_mclkin", "xin12m" };
static clk_i2s5_8ch_tx_p: PNAME(clk_i2s5_8ch_tx_p)[PNAME(clk_i2s5_8ch_tx_p)str]		= { "clk_i2s5_8ch_tx_src", "clk_i2s5_8ch_tx_frac", "i2s5_mclkin", "xin12m" };
static clk_i2s6_8ch_tx_p: PNAME(clk_i2s6_8ch_tx_p)[PNAME(clk_i2s6_8ch_tx_p)str]		= { "clk_i2s6_8ch_tx_src", "clk_i2s6_8ch_tx_frac", "i2s6_mclkin", "xin12m" };
static clk_i2s6_8ch_rx_p: PNAME(clk_i2s6_8ch_rx_p)[PNAME(clk_i2s6_8ch_rx_p)str]		= { "clk_i2s6_8ch_rx_src", "clk_i2s6_8ch_rx_frac", "i2s6_mclkin", "xin12m" };
static i2s6_8ch_mclkout_p: PNAME(i2s6_8ch_mclkout_p)[PNAME(i2s6_8ch_mclkout_p)str]		= { "mclk_i2s6_8ch_tx", "mclk_i2s6_8ch_rx", "xin12m" };
static clk_i2s7_8ch_rx_p: PNAME(clk_i2s7_8ch_rx_p)[PNAME(clk_i2s7_8ch_rx_p)str]		= { "clk_i2s7_8ch_rx_src", "clk_i2s7_8ch_rx_frac", "i2s7_mclkin", "xin12m" };
static clk_i2s8_8ch_tx_p: PNAME(clk_i2s8_8ch_tx_p)[PNAME(clk_i2s8_8ch_tx_p)str]		= { "clk_i2s8_8ch_tx_src", "clk_i2s8_8ch_tx_frac", "i2s8_mclkin", "xin12m" };
static clk_i2s9_8ch_rx_p: PNAME(clk_i2s9_8ch_rx_p)[PNAME(clk_i2s9_8ch_rx_p)str]		= { "clk_i2s9_8ch_rx_src", "clk_i2s9_8ch_rx_frac", "i2s9_mclkin", "xin12m" };
static clk_i2s10_8ch_rx_p: PNAME(clk_i2s10_8ch_rx_p)[PNAME(clk_i2s10_8ch_rx_p)str]		= { "clk_i2s10_8ch_rx_src", "clk_i2s10_8ch_rx_frac", "i2s10_mclkin", "xin12m" };
static clk_spdif0_p: PNAME(clk_spdif0_p)[PNAME(clk_spdif0_p)str]			= { "clk_spdif0_src", "clk_spdif0_frac", "xin12m" };
static clk_spdif1_p: PNAME(clk_spdif1_p)[PNAME(clk_spdif1_p)str]			= { "clk_spdif1_src", "clk_spdif1_frac", "xin12m" };
static clk_spdif2_dp0_p: PNAME(clk_spdif2_dp0_p)[PNAME(clk_spdif2_dp0_p)str]			= { "clk_spdif2_dp0_src", "clk_spdif2_dp0_frac", "xin12m" };
static clk_spdif3_p: PNAME(clk_spdif3_p)[PNAME(clk_spdif3_p)str]			= { "clk_spdif3_src", "clk_spdif3_frac", "xin12m" };
static clk_spdif4_p: PNAME(clk_spdif4_p)[PNAME(clk_spdif4_p)str]			= { "clk_spdif4_src", "clk_spdif4_frac", "xin12m" };
static clk_spdif5_dp1_p: PNAME(clk_spdif5_dp1_p)[PNAME(clk_spdif5_dp1_p)str]			= { "clk_spdif5_dp1_src", "clk_spdif5_dp1_frac", "xin12m" };
static clk_uart0_p: PNAME(clk_uart0_p)[PNAME(clk_uart0_p)str]			= { "clk_uart0_src", "clk_uart0_frac", "xin24m" };
static clk_uart1_p: PNAME(clk_uart1_p)[PNAME(clk_uart1_p)str]			= { "clk_uart1_src", "clk_uart1_frac", "xin24m" };
static clk_uart2_p: PNAME(clk_uart2_p)[PNAME(clk_uart2_p)str]			= { "clk_uart2_src", "clk_uart2_frac", "xin24m" };
static clk_uart3_p: PNAME(clk_uart3_p)[PNAME(clk_uart3_p)str]			= { "clk_uart3_src", "clk_uart3_frac", "xin24m" };
static clk_uart4_p: PNAME(clk_uart4_p)[PNAME(clk_uart4_p)str]			= { "clk_uart4_src", "clk_uart4_frac", "xin24m" };
static clk_uart5_p: PNAME(clk_uart5_p)[PNAME(clk_uart5_p)str]			= { "clk_uart5_src", "clk_uart5_frac", "xin24m" };
static clk_uart6_p: PNAME(clk_uart6_p)[PNAME(clk_uart6_p)str]			= { "clk_uart6_src", "clk_uart6_frac", "xin24m" };
static clk_uart7_p: PNAME(clk_uart7_p)[PNAME(clk_uart7_p)str]			= { "clk_uart7_src", "clk_uart7_frac", "xin24m" };
static clk_uart8_p: PNAME(clk_uart8_p)[PNAME(clk_uart8_p)str]			= { "clk_uart8_src", "clk_uart8_frac", "xin24m" };
static clk_uart9_p: PNAME(clk_uart9_p)[PNAME(clk_uart9_p)str]			= { "clk_uart9_src", "clk_uart9_frac", "xin24m" };
static clk_gmac0_ptp_ref_p: PNAME(clk_gmac0_ptp_ref_p)[PNAME(clk_gmac0_ptp_ref_p)str]		= { "cpll", "clk_gmac0_ptpref_io" };
static clk_gmac1_ptp_ref_p: PNAME(clk_gmac1_ptp_ref_p)[PNAME(clk_gmac1_ptp_ref_p)str]		= { "cpll", "clk_gmac1_ptpref_io" };
static clk_hdmirx_aud_p: PNAME(clk_hdmirx_aud_p)[PNAME(clk_hdmirx_aud_p)str]			= { "clk_hdmirx_aud_src", "clk_hdmirx_aud_frac" };
static aclk_hdcp1_root_p: PNAME(aclk_hdcp1_root_p)[PNAME(aclk_hdcp1_root_p)str]		= { "gpll", "cpll", "clk_hdmitrx_refsrc" };
static aclk_vop_sub_src_p: PNAME(aclk_vop_sub_src_p)[PNAME(aclk_vop_sub_src_p)str]		= { "aclk_vop_root", "aclk_vop_div2_src" };
static dclk_vop0_p: PNAME(dclk_vop0_p)[PNAME(dclk_vop0_p)str]			= { "dclk_vop0_src", "clk_hdmiphy_pixel0", "clk_hdmiphy_pixel1" };
static dclk_vop1_p: PNAME(dclk_vop1_p)[PNAME(dclk_vop1_p)str]			= { "dclk_vop1_src", "clk_hdmiphy_pixel0", "clk_hdmiphy_pixel1" };
static dclk_vop2_p: PNAME(dclk_vop2_p)[PNAME(dclk_vop2_p)str]			= { "dclk_vop2_src", "clk_hdmiphy_pixel0", "clk_hdmiphy_pixel1" };
static pmu_200m_100m_p: PNAME(pmu_200m_100m_p)[PNAME(pmu_200m_100m_p)str]			= { "clk_pmu1_200m_src", "clk_pmu1_100m_src" };
static pmu_300m_24m_p: PNAME(pmu_300m_24m_p)[PNAME(pmu_300m_24m_p)str]			= { "clk_300m_src", "xin24m" };
static pmu_400m_24m_p: PNAME(pmu_400m_24m_p)[PNAME(pmu_400m_24m_p)str]			= { "clk_400m_src", "xin24m" };
static pmu_100m_50m_24m_src_p: PNAME(pmu_100m_50m_24m_src_p)[PNAME(pmu_100m_50m_24m_src_p)str]		= { "clk_pmu1_100m_src", "clk_pmu1_50m_src", "xin24m" };
static pmu_24m_32k_100m_src_p: PNAME(pmu_24m_32k_100m_src_p)[PNAME(pmu_24m_32k_100m_src_p)str]		= { "xin24m", "xin32k", "clk_pmu1_100m_src" };
static hclk_pmu1_root_p: PNAME(hclk_pmu1_root_p)[PNAME(hclk_pmu1_root_p)str]			= { "clk_pmu1_200m_src", "clk_pmu1_100m_src", "clk_pmu1_50m_src", "xin24m" };
static hclk_pmu_cm0_root_p: PNAME(hclk_pmu_cm0_root_p)[PNAME(hclk_pmu_cm0_root_p)str]		= { "clk_pmu1_400m_src", "clk_pmu1_200m_src", "clk_pmu1_100m_src", "xin24m" };
static mclk_pdm0_p: PNAME(mclk_pdm0_p)[PNAME(mclk_pdm0_p)str]			= { "clk_pmu1_300m_src", "clk_pmu1_200m_src" };
static mux_24m_ppll_spll_p: PNAME(mux_24m_ppll_spll_p)[PNAME(mux_24m_ppll_spll_p)str]		= { "xin24m", "ppll", "spll" };
static mux_24m_ppll_p: PNAME(mux_24m_ppll_p)[PNAME(mux_24m_ppll_p)str]			= { "xin24m", "ppll" };
static clk_ref_pipe_phy0_p: PNAME(clk_ref_pipe_phy0_p)[PNAME(clk_ref_pipe_phy0_p)str]		= { "clk_ref_pipe_phy0_osc_src", "clk_ref_pipe_phy0_pll_src" };
static clk_ref_pipe_phy1_p: PNAME(clk_ref_pipe_phy1_p)[PNAME(clk_ref_pipe_phy1_p)str]		= { "clk_ref_pipe_phy1_osc_src", "clk_ref_pipe_phy1_pll_src" };
static clk_ref_pipe_phy2_p: PNAME(clk_ref_pipe_phy2_p)[PNAME(clk_ref_pipe_phy2_p)str]		= { "clk_ref_pipe_phy2_osc_src", "clk_ref_pipe_phy2_pll_src" };

macro_rules! MFLAGS CLK_MUX_HIWORD_MASK
macro_rules! DFLAGS CLK_DIVIDER_HIWORD_MASK
macro_rules! GFLAGS (CLK_GATE_HIWORD_MASK | CLK_GATE_SET_TO_DISABLE)

static mut rockchip_clk_branch rk3588_i2s0_8ch_tx_fracmux  =
	MUX(CLK_I2S0_8CH_TX, "clk_i2s0_8ch_tx", clk_i2s0_8ch_tx_p, CLK_SET_RATE_PARENT,
			RK3588_CLKSEL_CON(26), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_i2s0_8ch_rx_fracmux  =
	MUX(CLK_I2S0_8CH_RX, "clk_i2s0_8ch_rx", clk_i2s0_8ch_rx_p, CLK_SET_RATE_PARENT,
			RK3588_CLKSEL_CON(28), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_i2s1_8ch_tx_fracmux  =
	MUX(CLK_I2S1_8CH_TX, "clk_i2s1_8ch_tx", clk_i2s1_8ch_tx_p, CLK_SET_RATE_PARENT,
			 RK3588_PMU_CLKSEL_CON(7), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_i2s1_8ch_rx_fracmux  =
	MUX(CLK_I2S1_8CH_RX, "clk_i2s1_8ch_rx", clk_i2s1_8ch_rx_p, CLK_SET_RATE_PARENT,
			 RK3588_PMU_CLKSEL_CON(9), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_i2s2_2ch_fracmux  =
	MUX(CLK_I2S2_2CH, "clk_i2s2_2ch", clk_i2s2_2ch_p, CLK_SET_RATE_PARENT,
			RK3588_CLKSEL_CON(30), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_i2s3_2ch_fracmux  =
	MUX(CLK_I2S3_2CH, "clk_i2s3_2ch", clk_i2s3_2ch_p, CLK_SET_RATE_PARENT,
			RK3588_CLKSEL_CON(32), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_i2s4_8ch_tx_fracmux  =
	MUX(CLK_I2S4_8CH_TX, "clk_i2s4_8ch_tx", clk_i2s4_8ch_tx_p, CLK_SET_RATE_PARENT,
			RK3588_CLKSEL_CON(120), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_i2s5_8ch_tx_fracmux  =
	MUX(CLK_I2S5_8CH_TX, "clk_i2s5_8ch_tx", clk_i2s5_8ch_tx_p, CLK_SET_RATE_PARENT,
			 RK3588_CLKSEL_CON(142), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_i2s6_8ch_tx_fracmux  =
	MUX(CLK_I2S6_8CH_TX, "clk_i2s6_8ch_tx", clk_i2s6_8ch_tx_p, CLK_SET_RATE_PARENT,
			 RK3588_CLKSEL_CON(146), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_i2s6_8ch_rx_fracmux  =
	MUX(CLK_I2S6_8CH_RX, "clk_i2s6_8ch_rx", clk_i2s6_8ch_rx_p, CLK_SET_RATE_PARENT,
			 RK3588_CLKSEL_CON(148), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_i2s7_8ch_rx_fracmux  =
	MUX(CLK_I2S7_8CH_RX, "clk_i2s7_8ch_rx", clk_i2s7_8ch_rx_p, CLK_SET_RATE_PARENT,
			 RK3588_CLKSEL_CON(131), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_i2s8_8ch_tx_fracmux  =
	MUX(CLK_I2S8_8CH_TX, "clk_i2s8_8ch_tx", clk_i2s8_8ch_tx_p, CLK_SET_RATE_PARENT,
			RK3588_CLKSEL_CON(122), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_i2s9_8ch_rx_fracmux  =
	MUX(CLK_I2S9_8CH_RX, "clk_i2s9_8ch_rx", clk_i2s9_8ch_rx_p, CLK_SET_RATE_PARENT,
			 RK3588_CLKSEL_CON(155), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_i2s10_8ch_rx_fracmux  =
	MUX(CLK_I2S10_8CH_RX, "clk_i2s10_8ch_rx", clk_i2s10_8ch_rx_p, CLK_SET_RATE_PARENT,
			RK3588_CLKSEL_CON(157), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_spdif0_fracmux  =
	MUX(CLK_SPDIF0, "clk_spdif0", clk_spdif0_p, CLK_SET_RATE_PARENT,
			RK3588_CLKSEL_CON(34), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_spdif1_fracmux  =
	MUX(CLK_SPDIF1, "clk_spdif1", clk_spdif1_p, CLK_SET_RATE_PARENT,
			RK3588_CLKSEL_CON(36), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_spdif2_dp0_fracmux  =
	MUX(CLK_SPDIF2_DP0, "clk_spdif2_dp0", clk_spdif2_dp0_p, CLK_SET_RATE_PARENT,
			RK3588_CLKSEL_CON(124), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_spdif3_fracmux  =
	MUX(CLK_SPDIF3, "clk_spdif3", clk_spdif3_p, CLK_SET_RATE_PARENT,
			RK3588_CLKSEL_CON(150), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_spdif4_fracmux  =
	MUX(CLK_SPDIF4, "clk_spdif4", clk_spdif4_p, CLK_SET_RATE_PARENT,
			RK3588_CLKSEL_CON(152), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_spdif5_dp1_fracmux  =
	MUX(CLK_SPDIF5_DP1, "clk_spdif5_dp1", clk_spdif5_dp1_p, CLK_SET_RATE_PARENT,
			RK3588_CLKSEL_CON(126), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_uart0_fracmux  =
	MUX(CLK_UART0, "clk_uart0", clk_uart0_p, CLK_SET_RATE_PARENT,
			RK3588_PMU_CLKSEL_CON(5), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_uart1_fracmux  =
	MUX(CLK_UART1, "clk_uart1", clk_uart1_p, CLK_SET_RATE_PARENT,
			RK3588_CLKSEL_CON(43), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_uart2_fracmux  =
	MUX(CLK_UART2, "clk_uart2", clk_uart2_p, CLK_SET_RATE_PARENT,
			RK3588_CLKSEL_CON(45), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_uart3_fracmux  =
	MUX(CLK_UART3, "clk_uart3", clk_uart3_p, CLK_SET_RATE_PARENT,
			RK3588_CLKSEL_CON(47), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_uart4_fracmux  =
	MUX(CLK_UART4, "clk_uart4", clk_uart4_p, CLK_SET_RATE_PARENT,
			RK3588_CLKSEL_CON(49), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_uart5_fracmux  =
	MUX(CLK_UART5, "clk_uart5", clk_uart5_p, CLK_SET_RATE_PARENT,
			RK3588_CLKSEL_CON(51), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_uart6_fracmux  =
	MUX(CLK_UART6, "clk_uart6", clk_uart6_p, CLK_SET_RATE_PARENT,
			RK3588_CLKSEL_CON(53), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_uart7_fracmux  =
	MUX(CLK_UART7, "clk_uart7", clk_uart7_p, CLK_SET_RATE_PARENT,
			RK3588_CLKSEL_CON(55), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_uart8_fracmux  =
	MUX(CLK_UART8, "clk_uart8", clk_uart8_p, CLK_SET_RATE_PARENT,
			RK3588_CLKSEL_CON(57), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_uart9_fracmux  =
	MUX(CLK_UART9, "clk_uart9", clk_uart9_p, CLK_SET_RATE_PARENT,
			RK3588_CLKSEL_CON(59), 0, 2, MFLAGS);

static mut rockchip_clk_branch rk3588_hdmirx_aud_fracmux  =
	MUX(CLK_HDMIRX_AUD_P_MUX, "clk_hdmirx_aud_mux", clk_hdmirx_aud_p, CLK_SET_RATE_PARENT,
			RK3588_CLKSEL_CON(140), 0, 1, MFLAGS);

static mut rockchip_pll_clock rk3588_pll_clks[]  = {
...
static mut rockchip_clk_branch rk3588_early_clk_branches[]  = {
	/*
...
static mut rockchip_clk_branch rk3588_clk_branches[] = {
...
static int  rockchip_clk_rk3588_drv_register(void)
{
