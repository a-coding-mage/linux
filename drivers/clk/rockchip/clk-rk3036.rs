// External kernel types, constants, helper macros, and functions are supplied by other translation units.\n#![allow(non_camel_case_types, non_upper_case_globals, dead_code, unused_mut, unused_variables)]\n\n// SPDX-License-Identifier: GPL-2.0-or-later
/*
...
const RK3036_GRF_SOC_STATUS0: u32 = 0x14c;

#[repr(C)]\nenum Rk3036Plls {\n    Apll, Dpll, Gpll,\n}\n\nuse Rk3036Plls::{Apll as apll, Dpll as dpll, Gpll as gpll};

static mut rk3036_pll_rates[]: rockchip_pll_rate_table = {
...
const RK3036_DIV_CPU_MASK: u32 = 0x1f;
const RK3036_DIV_CPU_SHIFT: u32 = 8;

const RK3036_DIV_PERI_MASK: u32 = 0xf;
const RK3036_DIV_PERI_SHIFT: u32 = 0;
const RK3036_DIV_ACLK_MASK: u32 = 0x7;
const RK3036_DIV_ACLK_SHIFT: u32 = 4;
const RK3036_DIV_HCLK_MASK: u32 = 0x3;
const RK3036_DIV_HCLK_SHIFT: u32 = 8;
const RK3036_DIV_PCLK_MASK: u32 = 0x7;
const RK3036_DIV_PCLK_SHIFT: u32 = 12;
...
static mut rk3036_cpuclk_rates[]: rockchip_cpuclk_rate_table = {
	RK3036_CPUCLK_RATE(816000000, 4),
	RK3036_CPUCLK_RATE(600000000, 4),
	RK3036_CPUCLK_RATE(312000000, 4),
};

static rk3036_cpuclk_data: rockchip_cpuclk_reg_data = {
...
static mut rk3036_pll_clks[]: rockchip_pll_clock = {
	...
	[dpll] = PLL(pll_rk3036, PLL_DPLL, "dpll", mux_pll_p, 0, RK2928_PLL_CON(4),
		     RK2928_MODE_CON, 4, 4, 0, core::ptr::null_mut()),
...
static mut rk3036_uart0_fracmux: rockchip_clk_branch =
	MUX(SCLK_UART0, "sclk_uart0", mux_uart0_p, CLK_SET_RATE_PARENT,
			RK2928_CLKSEL_CON(13), 8, 2, MFLAGS);

static mut rk3036_uart1_fracmux: rockchip_clk_branch =
	MUX(SCLK_UART1, "sclk_uart1", mux_uart1_p, CLK_SET_RATE_PARENT,
			RK2928_CLKSEL_CON(14), 8, 2, MFLAGS);

static mut rk3036_uart2_fracmux: rockchip_clk_branch =
	MUX(SCLK_UART2, "sclk_uart2", mux_uart2_p, CLK_SET_RATE_PARENT,
			RK2928_CLKSEL_CON(15), 8, 2, MFLAGS);

static mut rk3036_i2s_fracmux: rockchip_clk_branch =
	MUX(0, "i2s_pre", mux_i2s_pre_p, CLK_SET_RATE_PARENT,
			RK2928_CLKSEL_CON(3), 8, 2, MFLAGS);

static mut rk3036_spdif_fracmux: rockchip_clk_branch =
	MUX(SCLK_SPDIF, "sclk_spdif", mux_spdif_p, 0,
			RK2928_CLKSEL_CON(5), 8, 2, MFLAGS);

static mut rk3036_clk_branches[]: rockchip_clk_branch = {
	/*
...
static rk3036_critical_clocks: &[&str] __initconst = {
	"aclk_cpu",
	"aclk_peri",
	"hclk_peri",
	"pclk_peri",
...
unsafe fn rk3036_clk_init(np: *mut device_node)
{
	...
	writel_relaxed(HIWORD_UPDATE(0x2, 0x3, 10),
		       (reg_base as *mut u8).add(RK2928_CLKSEL_CON(13));

	clk_nr_clks = rockchip_clk_find_max_clk_id(rk3036_clk_branches,
						   (rk3036_clk_branches.len())) + 1;
	...
	rockchip_clk_register_branches(ctx, rk3036_clk_branches,
				  (rk3036_clk_branches.len()));
	rockchip_clk_protect_critical(rk3036_critical_clocks,
				      (rk3036_critical_clocks.len()));

	rockchip_clk_register_armclk(ctx, ARMCLK, "armclk",
			mux_armclk_p, (mux_armclk_p.len()),
			&rk3036_cpuclk_data, rk3036_cpuclk_rates,
			(rk3036_cpuclk_rates.len()));

	rockchip_register_softrst(np, 9, (reg_base as *mut u8).add(RK2928_SOFTRST_CON(0),
...
const _: () = { /* CLK_OF_DECLARE(rk3036_cru, "rockchip,rk3036-cru", rk3036_clk_init) */ };
