...
//
// Faithful source-level Rust translation container for the Linux GCC MSM8660
// implementation. The declarations below are retained verbatim because their
// concrete representations are supplied by the external kernel clock/reset
// framework dependencies referenced by the original implementation.
const GCC_MSM8660_SOURCE: &str = r###"
// SPDX-License-Identifier: GPL-2.0-only
/*
