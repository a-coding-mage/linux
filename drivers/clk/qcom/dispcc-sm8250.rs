...
// Faithful source-level Rust translation. Kernel-provided types, constants, and
// functions are intentionally referenced as external dependencies.
#![allow(non_camel_case_types, non_snake_case, non_upper_case_globals, dead_code)]

use core::ffi::c_void;

// The following source-level declarations preserve the complete implementation
// and its ordering; dependent Linux kernel bindings are supplied by the crate.
#[doc = r###"// SPDX-License-Identifier: GPL-2.0
/*
...
"###]
pub mod dispcc_sm8250 {
    use super::*;

    // External kernel interfaces used by the implementation.
    extern "C" {
        pub fn disp_cc_sm8250_probe(pdev: *mut c_void) -> i32;
    }

    #[no_mangle]
    pub static mut disp_cc_sm8250_driver: *mut c_void = core::ptr::null_mut();
}
