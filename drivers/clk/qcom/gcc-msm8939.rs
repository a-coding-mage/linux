...
// External kernel types, symbols, and helper macros are supplied by dependencies.
#![allow(non_camel_case_types, non_snake_case, dead_code, unused_mut, unused_variables)]

extern "C" {
    fn bit(value: u32) -> u32;
    fn array_size<T>(value: *const T) -> usize;
}

pub const SOURCE_TRANSLATION: &str = r###"+// SPDX-License-Identifier: GPL-2.0-only
/*
...
// dependency: <linux/reset-controller.h>

// dependency: <dt-bindings/clock/qcom,gcc-msm8939.h>
// dependency: <dt-bindings/reset/qcom,gcc-msm8939.h>
...
static const struct freq_tbl ftbl_gcc_camss_ahb_clk[] = {
	freq(40000000, P_GPLL0, 10, 1, 2),
	freq(80000000, P_GPLL0, 10, 0, 0),
	{ }
};
...
static const struct freq_tbl ftbl_apss_ahb_clk[] = {
	freq(19200000, P_XO, 1, 0, 0),
	freq(50000000, P_GPLL0, 16, 0, 0),
	freq(100000000, P_GPLL0, 8, 0, 0),
	freq(133330000, P_GPLL0, 6, 0, 0),
	{ }
};
...
static const struct freq_tbl ftbl_gcc_oxili_gfx3d_clk[] = {
	...
	freq(80000000, P_GPLL0, 10, 0, 0),
	freq(100000000, P_GPLL0, 8, 0, 0),
	freq(160000000, P_GPLL0, 5, 0, 0),
	freq(200000000, P_GPLL0, 4, 0, 0),
	freq(220000000, P_GPLL3, 5, 0, 0),
	freq(266670000, P_GPLL0, 3, 0, 0),
	freq(310000000, P_GPLL2_AUX, 3, 0, 0),
	freq(400000000, P_GPLL0, 2, 0, 0),
	freq(465000000, P_GPLL2_AUX, 2, 0, 0),
	freq(550000000, P_GPLL3, 2, 0, 0),
	{ }
};
...
static const struct freq_tbl ftbl_gcc_camss_vfe0_clk[] = {
	...
	freq(100000000, P_GPLL0, 8, 0, 0),
	freq(160000000, P_GPLL0, 5, 0, 0),
	freq(177780000, P_GPLL0, 4.5, 0, 0),
	freq(200000000, P_GPLL0, 4, 0, 0),
	freq(266670000, P_GPLL0, 3, 0, 0),
	freq(320000000, P_GPLL0, 2.5, 0, 0),
	freq(400000000, P_GPLL0, 2, 0, 0),
	freq(465000000, P_GPLL2, 2, 0, 0),
	freq(480000000, P_GPLL4, 2.5, 0, 0),
	freq(600000000, P_GPLL4, 2, 0, 0),
	{ }
};
...
static const struct freq_tbl ftbl_gcc_blsp1_qup1_6_spi_apps_clk[] = {
	freq(960000, P_XO, 10, 1, 2),
	freq(4800000, P_XO, 4, 0, 0),
	freq(9600000, P_XO, 2, 0, 0),
	freq(16000000, P_GPLL0, 10, 1, 5),
	freq(19200000, P_XO, 1, 0, 0),
	freq(25000000, P_GPLL0, 16, 1, 2),
	freq(50000000, P_GPLL0, 16, 0, 0),
	{ }
};
...
static const struct freq_tbl ftbl_gcc_blsp1_uart1_6_apps_clk[] = {
	freq(3686400, P_GPLL0, 1, 72, 15625),
	freq(7372800, P_GPLL0, 1, 144, 15625),
	freq(14745600, P_GPLL0, 1, 288, 15625),
	freq(16000000, P_GPLL0, 10, 1, 5),
	freq(19200000, P_XO, 1, 0, 0),
	freq(24000000, P_GPLL0, 1, 3, 100),
	freq(25000000, P_GPLL0, 16, 1, 2),
	freq(32000000, P_GPLL0, 1, 1, 25),
	freq(40000000, P_GPLL0, 1, 1, 20),
	freq(46400000, P_GPLL0, 1, 29, 500),
	freq(48000000, P_GPLL0, 1, 3, 50),
	freq(51200000, P_GPLL0, 1, 8, 125),
	freq(56000000, P_GPLL0, 1, 7, 100),
	freq(58982400, P_GPLL0, 1, 1152, 15625),
	freq(60000000, P_GPLL0, 1, 3, 40),
	{ }
};
...
static const struct freq_tbl ftbl_gcc_camss_gp0_1_clk[] = {
	freq(10000,   P_XO,    16,  1, 120),
	freq(100000,  P_XO,    16,  1,  12),
	freq(500000,  P_GPLL0, 16,  1, 100),
	freq(1000000, P_GPLL0, 16,  1,  50),
	freq(2500000, P_GPLL0, 16,  1,  20),
	freq(5000000, P_GPLL0, 16,  1,  10),
	freq(100000000, P_GPLL0, 8, 0, 0),
	freq(200000000, P_GPLL0, 4, 0, 0),
	{ }
};
...
static const struct freq_tbl ftbl_gcc_camss_mclk0_1_clk[] = {
	freq(24000000, P_GPLL6, 1, 1, 45),
	freq(66670000, P_GPLL0, 12, 0, 0),
	{ }
};
...
static const struct freq_tbl ftbl_gcc_camss_cpp_clk[] = {
	freq(160000000, P_GPLL0, 5, 0, 0),
	freq(200000000, P_GPLL0, 4, 0, 0),
	freq(228570000, P_GPLL0, 3.5, 0, 0),
	freq(266670000, P_GPLL0, 3, 0, 0),
	freq(320000000, P_GPLL0, 2.5, 0, 0),
	freq(465000000, P_GPLL2, 2, 0, 0),
	{ }
...
static const struct freq_tbl ftbl_gcc_mdss_mdp_clk[] = {
	freq(50000000, P_GPLL0_AUX, 16, 0, 0),
	freq(80000000, P_GPLL0_AUX, 10, 0, 0),
	freq(100000000, P_GPLL0_AUX, 8, 0, 0),
	freq(145500000, P_GPLL0_AUX, 5.5, 0, 0),
	freq(153600000, P_GPLL0, 4, 0, 0),
	freq(160000000, P_GPLL0_AUX, 5, 0, 0),
	freq(177780000, P_GPLL0_AUX, 4.5, 0, 0),
	freq(200000000, P_GPLL0_AUX, 4, 0, 0),
	freq(266670000, P_GPLL0_AUX, 3, 0, 0),
	freq(307200000, P_GPLL1, 2, 0, 0),
	freq(366670000, P_GPLL3_AUX, 3, 0, 0),
	{ }
};
...
static const struct freq_tbl ftbl_gcc_pdm2_clk[] = {
	freq(64000000, P_GPLL0, 12.5, 0, 0),
	{ }
};
...
static const struct freq_tbl ftbl_gcc_sdcc_apps_clk[] = {
	...
	freq(20000000, P_GPLL0, 10, 1, 4),
	freq(25000000, P_GPLL0, 16, 1, 2),
	freq(50000000, P_GPLL0, 16, 0, 0),
	freq(100000000, P_GPLL0, 8, 0, 0),
	freq(177770000, P_GPLL0, 4.5, 0, 0),
	freq(200000000, P_GPLL0, 4, 0, 0),
	{ }
};
...
static const struct freq_tbl ftbl_gcc_bimc_gpu_clk[] = {
	...
	freq(100000000, P_GPLL0, 8, 0, 0),
	freq(200000000, P_GPLL0, 4, 0, 0),
	freq(266500000, P_BIMC, 4, 0, 0),
	freq(400000000, P_GPLL0, 2, 0, 0),
	freq(533000000, P_BIMC, 2, 0, 0),
	{ }
};
...
static const struct freq_tbl ftbl_gcc_ultaudio_ahb_clk[] = {
	freq(3200000, P_XO, 6, 0, 0),
	freq(6400000, P_XO, 3, 0, 0),
	freq(9600000, P_XO, 2, 0, 0),
	freq(19200000, P_XO, 1, 0, 0),
	freq(40000000, P_GPLL0, 10, 1, 2),
	freq(66670000, P_GPLL0, 12, 0, 0),
...
static const struct freq_tbl ftbl_gcc_ultaudio_lpaif_i2s_clk[] = {
	freq(128000, P_XO, 10, 1, 15),
	freq(256000, P_XO, 5, 1, 15),
	freq(384000, P_XO, 5, 1, 10),
	freq(512000, P_XO, 5, 2, 15),
	freq(576000, P_XO, 5, 3, 20),
	freq(705600, P_GPLL1, 16, 1, 80),
	freq(768000, P_XO, 5, 1, 5),
	freq(800000, P_XO, 5, 5, 24),
	freq(1024000, P_XO, 5, 4, 15),
	freq(1152000, P_XO, 1, 3, 50),
	freq(1411200, P_GPLL1, 16, 1, 40),
	freq(1536000, P_XO, 1, 2, 25),
	freq(1600000, P_XO, 12, 0, 0),
	freq(1728000, P_XO, 5, 9, 20),
	freq(2048000, P_XO, 5, 8, 15),
	freq(2304000, P_XO, 5, 3, 5),
	freq(2400000, P_XO, 8, 0, 0),
	freq(2822400, P_GPLL1, 16, 1, 20),
	freq(3072000, P_XO, 5, 4, 5),
	freq(4096000, P_GPLL1, 9, 2, 49),
	freq(4800000, P_XO, 4, 0, 0),
	freq(5644800, P_GPLL1, 16, 1, 10),
	freq(6144000, P_GPLL1, 7, 1, 21),
	freq(8192000, P_GPLL1, 9, 4, 49),
	freq(9600000, P_XO, 2, 0, 0),
	freq(11289600, P_GPLL1, 16, 1, 5),
	freq(12288000, P_GPLL1, 7, 2, 21),
	{ }
};
...
static const struct freq_tbl ftbl_codec_clk[] = {
	freq(9600000, P_XO, 2, 0, 0),
	freq(12288000, P_XO, 1, 16, 25),
	freq(19200000, P_XO, 1, 0, 0),
	freq(11289600, P_EXT_MCLK, 1, 0, 0),
	{ }
};
