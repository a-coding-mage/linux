...
// External Linux kernel dependencies supplied by the surrounding Rust tree.

// External clock identifiers supplied by the surrounding Rust tree.

// External local clock-controller dependencies supplied by the surrounding Rust tree.
...
pub const P_GPLL0_OUT_EVEN: i32 = P_BI_TCXO + 1;
pub const P_GPLL0_OUT_MAIN: i32 = P_GPLL0_OUT_EVEN + 1;
pub const P_GPLL6_OUT_MAIN: i32 = P_GPLL0_OUT_MAIN + 1;
pub const P_GPLL7_OUT_MAIN: i32 = P_GPLL6_OUT_MAIN + 1;
pub const P_SLEEP_CLK: i32 = P_GPLL7_OUT_MAIN + 1;
...
static int gcc_sm7150_probe(platform_device *pdev)
{
