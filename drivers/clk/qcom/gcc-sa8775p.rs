...
/*
 * Faithful Rust source-level translation of gcc-sa8775p.c.
 * External Linux clock-provider bindings retain their original C layout and
 * designated-initializer semantics in this source-level representation.
 */
