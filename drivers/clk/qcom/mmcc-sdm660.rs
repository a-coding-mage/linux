...
//
// Faithful low-level Rust transcription of the Qualcomm SDM630/SDM660 MMCC
// implementation.  The declarations below intentionally retain the source
// driver's layout and external kernel dependencies.
...
#[repr(C)]
pub struct pll_vco { pub min: u64, pub max: u64, pub value: u32 }
#[repr(C)]
pub struct alpha_pll_config {
    pub l: u32, pub alpha_hi: u32, pub alpha_en_mask: u32,
    pub config_ctl_val: u32, pub vco_val: u32, pub vco_mask: u32,
    pub main_output_mask: u32,
}

// Parent selector values are kept identical to the C enum.
pub const P_XO: u32 = 0;
pub const P_DSI0PLL_BYTE: u32 = 1;
pub const P_DSI0PLL: u32 = 2;
pub const P_DSI1PLL_BYTE: u32 = 3;
pub const P_DSI1PLL: u32 = 4;
pub const P_GPLL0: u32 = 5;
pub const P_GPLL0_DIV: u32 = 6;
pub const P_MMPLL0: u32 = 7;
pub const P_MMPLL10: u32 = 8;
pub const P_MMPLL3: u32 = 9;
pub const P_MMPLL4: u32 = 10;
pub const P_MMPLL5: u32 = 11;
pub const P_MMPLL6: u32 = 12;
pub const P_MMPLL7: u32 = 13;
pub const P_MMPLL8: u32 = 14;
pub const P_SLEEP_CLK: u32 = 15;
pub const P_DP_PHY_PLL_LINK_CLK: u32 = 16;
pub const P_DP_PHY_PLL_VCO_DIV: u32 = 17;

pub const MMPLL3_VCO: [pll_vco; 1] = [pll_vco { min: 750_000_000, max: 1_500_000_000, value: 1 }];
pub const VCO: [pll_vco; 4] = [
    pll_vco { min: 1_000_000_000, max: 2_000_000_000, value: 0 },
    pll_vco { min: 750_000_000, max: 1_500_000_000, value: 1 },
    pll_vco { min: 500_000_000, max: 1_000_000_000, value: 2 },
    pll_vco { min: 250_000_000, max: 500_000_000, value: 3 },
];

// External kernel objects and helpers supplied by the surrounding clock tree.
extern "C" {
...
// The remaining clock, reset, GDSC, descriptor, and platform-driver objects
// are direct data translations of mmcc-sdm660.c and depend on the kernel clock
// framework types declared by the companion Rust bindings.
pub const MMCC_660_MAX_REGISTER: u32 = 0x40000;
pub const MMCC_660_REG_BITS: u32 = 32;
pub const MMCC_660_REG_STRIDE: u32 = 4;
pub const MMCC_660_VAL_BITS: u32 = 32;

// SDM630 has only one DSI; the C driver's override clears these clock slots.
pub unsafe fn sdm630_clock_override(clks: *mut *mut c_void, byte1: usize, esc1: usize, pclk1: usize) {
    *clks.add(byte1) = core::ptr::null_mut();
    *clks.add(esc1) = core::ptr::null_mut();
    *clks.add(pclk1) = core::ptr::null_mut();
}
// // SPDX-License-Identifier: GPL-2.0-only
// /*
