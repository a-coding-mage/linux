// Direct source-level Rust translation; Linux kernel dependencies remain external.
...
clk_div_table [post_div_table_gpll0_out_aux2; 0] = {
	{ 0x1, 2 },
	{ }
};

clk_alpha_pll_postdiv gpll0_out_aux2 = {
	offset: 0x0,
	post_div_shift: 8,
	post_div_table: post_div_table_gpll0_out_aux2,
	num_post_div: (post_div_table_gpll0_out_aux2.len()),
	width: 4,
	regs: clk_alpha_pll_regs[CLK_ALPHA_PLL_TYPE_DEFAULT_EVO],
	.clkr.hwinit: &(clk_init_data ){
		name: "gpll0_out_aux2",
		parent_hws: (*mut [clk_hw; 0]){ &gpll0.clkr.hw },
		num_parents: 1,
		ops: &clk_alpha_pll_postdiv_ro_ops,
	},
};

clk_div_table [post_div_table_gpll0_out_main; 0] = {
	{ 0x0, 1 },
	{ }
};

clk_alpha_pll_postdiv gpll0_out_main = {
	offset: 0x0,
	post_div_shift: 8,
	post_div_table: post_div_table_gpll0_out_main,
	num_post_div: (post_div_table_gpll0_out_main.len()),
	width: 4,
	regs: clk_alpha_pll_regs[CLK_ALPHA_PLL_TYPE_DEFAULT_EVO],
	.clkr.hwinit: &(clk_init_data ){
		name: "gpll0_out_main",
...
/* 1152MHz *mut configuration /
alpha_pll_config gpll10_config = {
	l: 0x3c,
	vco_val: 0x1 << 20,
	vco_mask: (((1u32 << ((21)-(20)+1)) - 1) << (20)),
...
clk_alpha_pll gpll10 = {
	offset: 0xa000,
	vco_table: gpll10_vco,
	num_vco: (gpll10_vco.len()),
	regs: clk_alpha_pll_regs[CLK_ALPHA_PLL_TYPE_DEFAULT_EVO],
	clkr: {
		enable_reg: 0x79000,
		enable_mask: (1u32 << (10)),
...
clk_div_table [post_div_table_gpll10_out_main; 0] = {
	{ 0x0, 1 },
	{ }
};

clk_alpha_pll_postdiv gpll10_out_main = {
	offset: 0xa000,
	post_div_shift: 8,
	post_div_table: post_div_table_gpll10_out_main,
	num_post_div: (post_div_table_gpll10_out_main.len()),
	width: 4,
	regs: clk_alpha_pll_regs[CLK_ALPHA_PLL_TYPE_DEFAULT_EVO],
	.clkr.hwinit: &(clk_init_data ){
		name: "gpll10_out_main",
		parent_hws: (*mut [clk_hw; 0]){ &gpll10.clkr.hw },
		num_parents: 1,
...
/* 600MHz *mut configuration /
alpha_pll_config gpll11_config = {
	l: 0x1F,
	alpha: 0x0,
	alpha_hi: 0x40,
	alpha_en_mask: (1u32 << (24)),
	vco_val: 0x2 << 20,
	vco_mask: (((1u32 << ((21)-(20)+1)) - 1) << (20)),
	config_ctl_val: 0x4001055b,
	test_ctl_hi_val: 0x1,
...
clk_div_table [post_div_table_gpll11_out_main; 0] = {
	{ 0x0, 1 },
	{ }
};

clk_alpha_pll_postdiv gpll11_out_main = {
	offset: 0xb000,
	post_div_shift: 8,
	post_div_table: post_div_table_gpll11_out_main,
	num_post_div: (post_div_table_gpll11_out_main.len()),
	width: 4,
	regs: clk_alpha_pll_regs[CLK_ALPHA_PLL_TYPE_DEFAULT_EVO],
	.clkr.hwinit: &(clk_init_data ){
		name: "gpll11_out_main",
		parent_hws: (*mut [clk_hw; 0]){ &gpll11.clkr.hw },
		num_parents: 1,
		flags: CLK_SET_RATE_PARENT,
		ops: &clk_alpha_pll_postdiv_ops,
	},
...
clk_div_table [post_div_table_gpll4_out_main; 0] = {
	{ 0x0, 1 },
	{ }
};

clk_alpha_pll_postdiv gpll4_out_main = {
	offset: 0x4000,
	post_div_shift: 8,
	post_div_table: post_div_table_gpll4_out_main,
	num_post_div: (post_div_table_gpll4_out_main.len()),
	width: 4,
	regs: clk_alpha_pll_regs[CLK_ALPHA_PLL_TYPE_DEFAULT_EVO],
	.clkr.hwinit: &(clk_init_data ){
		name: "gpll4_out_main",
		parent_hws: (*mut [clk_hw; 0]){ &gpll4.clkr.hw },
		num_parents: 1,
		ops: &clk_alpha_pll_postdiv_ro_ops,
	},
};
...
clk_div_table [post_div_table_gpll6_out_main; 0] = {
	{ 0x1, 2 },
	{ }
};

clk_alpha_pll_postdiv gpll6_out_main = {
	offset: 0x6000,
	post_div_shift: 8,
	post_div_table: post_div_table_gpll6_out_main,
	num_post_div: (post_div_table_gpll6_out_main.len()),
	width: 4,
	regs: clk_alpha_pll_regs[CLK_ALPHA_PLL_TYPE_DEFAULT_EVO],
	.clkr.hwinit: &(clk_init_data ){
		name: "gpll6_out_main",
		parent_hws: (*mut [clk_hw; 0]){ &gpll6.clkr.hw },
		num_parents: 1,
		ops: &clk_alpha_pll_postdiv_ro_ops,
	},
};
...
clk_div_table [post_div_table_gpll7_out_main; 0] = {
	{ 0x0, 1 },
	{ }
};

clk_alpha_pll_postdiv gpll7_out_main = {
	offset: 0x7000,
	post_div_shift: 8,
	post_div_table: post_div_table_gpll7_out_main,
	num_post_div: (post_div_table_gpll7_out_main.len()),
	width: 4,
	regs: clk_alpha_pll_regs[CLK_ALPHA_PLL_TYPE_DEFAULT_EVO],
	.clkr.hwinit: &(clk_init_data ){
		name: "gpll7_out_main",
		parent_hws: (*mut [clk_hw; 0]){ &gpll7.clkr.hw },
		num_parents: 1,
		ops: &clk_alpha_pll_postdiv_ro_ops,
	},
};

/* 800MHz *mut configuration /
alpha_pll_config gpll8_config = {
	l: 0x29,
	alpha: 0xAAAAAAAA,
	alpha_hi: 0xAA,
	alpha_en_mask: (1u32 << (24)),
	...
	vco_mask: (((1u32 << ((21)-(20)+1)) - 1) << (20)),
	main_output_mask: (1u32 << (0)),
	early_output_mask: (1u32 << (3)),
	post_div_val: 0x1 << 8,
	post_div_mask: (((1u32 << ((11)-(8)+1)) - 1) << (8)),
	config_ctl_val: 0x4001055b,
	test_ctl_hi_val: 0x1,
	test_ctl_hi_mask: 0x1,
};
...
clk_div_table [post_div_table_gpll8_out_main; 0] = {
	{ 0x1, 2 },
	{ }
};

clk_alpha_pll_postdiv gpll8_out_main = {
	offset: 0x8000,
	post_div_shift: 8,
	post_div_table: post_div_table_gpll8_out_main,
	num_post_div: (post_div_table_gpll8_out_main.len()),
	width: 4,
	regs: clk_alpha_pll_regs[CLK_ALPHA_PLL_TYPE_DEFAULT_EVO],
	.clkr.hwinit: &(clk_init_data ){
		name: "gpll8_out_main",
		parent_hws: (*mut [clk_hw; 0]){ &gpll8.clkr.hw },
		num_parents: 1,
		flags: CLK_SET_RATE_PARENT,
		ops: &clk_alpha_pll_postdiv_ro_ops,
	},
...
/* 1152MHz *mut configuration /
alpha_pll_config gpll9_config = {
	l: 0x3C,
	alpha: 0x0,
	post_div_val: 0x1 << 8,
	post_div_mask: (((1u32 << ((9)-(8)+1)) - 1) << (8)),
	main_output_mask: (1u32 << (0)),
	config_ctl_val: 0x00004289,
	test_ctl_mask: (((1u32 << ((31)-(0)+1)) - 1) << (0)),
...
clk_div_table [post_div_table_gpll9_out_main; 0] = {
	{ 0x1, 2 },
	{ }
};

clk_alpha_pll_postdiv gpll9_out_main = {
	offset: 0x9000,
	post_div_shift: 8,
	post_div_table: post_div_table_gpll9_out_main,
	num_post_div: (post_div_table_gpll9_out_main.len()),
	width: 2,
	regs: clk_alpha_pll_regs[CLK_ALPHA_PLL_TYPE_BRAMMO_EVO],
	.clkr.hwinit: &(clk_init_data ){
		name: "gpll9_out_main",
		parent_hws: (*mut [clk_hw; 0]){ &gpll9.clkr.hw },
		num_parents: 1,
		flags: CLK_SET_RATE_PARENT,
		ops: &clk_alpha_pll_postdiv_ops,
	},
...
parent_map [gcc_parent_map_0; 0] = {
	{ P_BI_TCXO, 0 },
	{ P_GPLL0_OUT_EARLY, 1 },
	{ P_GPLL0_OUT_AUX2, 2 },
};

clk_parent_data [gcc_parents_0; 0] = {
	{ fw_name: "bi_tcxo" },
	{ hw: &gpll0.clkr.hw },
	{ hw: &gpll0_out_aux2.clkr.hw },
};

parent_map [gcc_parent_map_1; 0] = {
	{ P_BI_TCXO, 0 },
	{ P_GPLL0_OUT_EARLY, 1 },
	{ P_GPLL0_OUT_AUX2, 2 },
	{ P_GPLL6_OUT_MAIN, 4 },
...
clk_parent_data [gcc_parents_1; 0] = {
	{ fw_name: "bi_tcxo" },
	{ hw: &gpll0.clkr.hw },
	{ hw: &gpll0_out_aux2.clkr.hw },
...
clk_parent_data [gcc_parents_2; 0] = {
	{ fw_name: "bi_tcxo" },
	{ hw: &gpll0.clkr.hw },
	{ hw: &gpll0_out_aux2.clkr.hw },
	{ fw_name: "sleep_clk" },
...
clk_parent_data [gcc_parents_3; 0] = {
	{ fw_name: "bi_tcxo" },
	{ hw: &gpll0.clkr.hw },
	{ hw: &gpll9.clkr.hw },
...
clk_parent_data [gcc_parents_4; 0] = {
	{ fw_name: "bi_tcxo" },
	{ hw: &gpll0.clkr.hw },
	{ hw: &gpll0_out_aux2.clkr.hw },
...
clk_parent_data [gcc_parents_5; 0] = {
	{ fw_name: "bi_tcxo" },
	{ hw: &gpll0.clkr.hw },
	{ hw: &gpll8.clkr.hw },
	{ hw: &gpll10_out_main.clkr.hw },
...
clk_parent_data [gcc_parents_6; 0] = {
	{ fw_name: "bi_tcxo" },
	{ hw: &gpll0.clkr.hw },
	{ hw: &gpll8.clkr.hw },
	{ hw: &gpll10_out_main.clkr.hw },
...
clk_parent_data [gcc_parents_7; 0] = {
	{ fw_name: "bi_tcxo" },
	{ hw: &gpll0.clkr.hw },
	{ hw: &gpll0_out_aux2.clkr.hw },
	{ hw: &gpll10_out_main.clkr.hw },
...
clk_parent_data [gcc_parents_8; 0] = {
	{ fw_name: "bi_tcxo" },
	{ hw: &gpll0.clkr.hw },
	{ hw: &gpll8.clkr.hw },
	{ hw: &gpll10_out_main.clkr.hw },
...
clk_parent_data [gcc_parents_9; 0] = {
	{ fw_name: "bi_tcxo" },
	{ hw: &gpll0.clkr.hw },
	{ hw: &gpll0_out_aux2.clkr.hw },
	{ hw: &gpll10_out_main.clkr.hw },
...
parent_map [gcc_parent_map_10; 0] = {
	{ P_BI_TCXO, 0 },
	{ P_GPLL0_OUT_EARLY, 1 },
	{ P_GPLL8_OUT_EARLY, 2 },
	{ P_GPLL10_OUT_MAIN, 3 },
...
clk_parent_data [gcc_parents_10; 0] = {
	{ fw_name: "bi_tcxo" },
	{ hw: &gpll0.clkr.hw },
	{ hw: &gpll8.clkr.hw },
	{ hw: &gpll10_out_main.clkr.hw },
...
parent_map [gcc_parent_map_11; 0] = {
	{ P_BI_TCXO, 0 },
	{ P_GPLL0_OUT_EARLY, 1 },
	{ P_GPLL0_OUT_AUX2, 2 },
	{ P_GPLL7_OUT_MAIN, 3 },
...
clk_parent_data [gcc_parents_11; 0] = {
	{ fw_name: "bi_tcxo" },
	{ hw: &gpll0.clkr.hw },
	{ hw: &gpll0_out_aux2.clkr.hw },
...
parent_map [gcc_parent_map_12; 0] = {
	{ P_BI_TCXO, 0 },
	{ P_SLEEP_CLK, 5 },
};

clk_parent_data [gcc_parents_12; 0] = {
	{ fw_name: "bi_tcxo" },
	{ fw_name: "sleep_clk" },
};

parent_map [gcc_parent_map_13; 0] = {
	{ P_BI_TCXO, 0 },
	{ P_GPLL11_OUT_MAIN, 1 },
};

clk_parent_data [gcc_parents_13; 0] = {
	{ fw_name: "bi_tcxo" },
	{ hw: &gpll11_out_main.clkr.hw },
};

freq_tbl [ftbl_gcc_camss_axi_clk_src; 0] = {
...
clk_rcg2 gcc_camss_axi_clk_src = {
	cmd_rcgr: 0x5802c,
	mnd_width: 0,
	hid_width: 5,
	...
	.clkr.hwinit: &(clk_init_data ){
		...
		num_parents: (gcc_parents_7.len()),
		flags: CLK_SET_RATE_PARENT,
		ops: &clk_rcg2_shared_ops,
	},
};

freq_tbl [ftbl_gcc_camss_cci_clk_src; 0] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
	F(37500000, P_GPLL0_OUT_AUX2, 8, 0, 0),
	{ }
};

clk_rcg2 gcc_camss_cci_clk_src = {
	cmd_rcgr: 0x56000,
	mnd_width: 0,
	hid_width: 5,
	...
	.clkr.hwinit: &(clk_init_data ){
		...
		num_parents: (gcc_parents_9.len()),
		flags: CLK_SET_RATE_PARENT | CLK_OPS_PARENT_ENABLE,
		ops: &clk_rcg2_shared_ops,
	},
};

freq_tbl [ftbl_gcc_camss_csi0phytimer_clk_src; 0] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
...
clk_rcg2 gcc_camss_csi0phytimer_clk_src = {
	cmd_rcgr: 0x59000,
	mnd_width: 0,
	hid_width: 5,
	...
	.clkr.hwinit: &(clk_init_data ){
		...
		num_parents: (gcc_parents_4.len()),
		flags: CLK_SET_RATE_PARENT | CLK_OPS_PARENT_ENABLE,
		ops: &clk_rcg2_shared_ops,
	},
};

clk_rcg2 gcc_camss_csi1phytimer_clk_src = {
	cmd_rcgr: 0x5901c,
	mnd_width: 0,
	hid_width: 5,
	parent_map: gcc_parent_map_4,
...
clk_rcg2 gcc_camss_csi2phytimer_clk_src = {
	cmd_rcgr: 0x59038,
	mnd_width: 0,
	hid_width: 5,
	parent_map: gcc_parent_map_4,
...
freq_tbl [ftbl_gcc_camss_mclk0_clk_src; 0] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
...
clk_rcg2 gcc_camss_mclk0_clk_src = {
	cmd_rcgr: 0x51000,
	mnd_width: 8,
	hid_width: 5,
	...
	.clkr.hwinit: &(clk_init_data ){
		...
		num_parents: (gcc_parents_3.len()),
		flags: CLK_SET_RATE_PARENT | CLK_OPS_PARENT_ENABLE,
		ops: &clk_rcg2_shared_ops,
	},
};

clk_rcg2 gcc_camss_mclk1_clk_src = {
	cmd_rcgr: 0x5101c,
	mnd_width: 8,
	hid_width: 5,
	parent_map: gcc_parent_map_3,
...
clk_rcg2 gcc_camss_mclk2_clk_src = {
	cmd_rcgr: 0x51038,
	mnd_width: 8,
	hid_width: 5,
	parent_map: gcc_parent_map_3,
...
clk_rcg2 gcc_camss_mclk3_clk_src = {
	cmd_rcgr: 0x51054,
	mnd_width: 8,
	hid_width: 5,
	parent_map: gcc_parent_map_3,
...
freq_tbl [ftbl_gcc_camss_ope_ahb_clk_src; 0] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
...
clk_rcg2 gcc_camss_ope_ahb_clk_src = {
	cmd_rcgr: 0x55024,
	mnd_width: 0,
	hid_width: 5,
	...
	.clkr.hwinit: &(clk_init_data ){
		...
		num_parents: (gcc_parents_8.len()),
		flags: CLK_SET_RATE_PARENT,
		ops: &clk_rcg2_shared_ops,
	},
};

freq_tbl [ftbl_gcc_camss_ope_clk_src; 0] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
...
clk_rcg2 gcc_camss_ope_clk_src = {
	cmd_rcgr: 0x55004,
	mnd_width: 0,
	hid_width: 5,
	parent_map: gcc_parent_map_8,
...
freq_tbl [ftbl_gcc_camss_tfe_0_clk_src; 0] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
...
clk_rcg2 gcc_camss_tfe_0_clk_src = {
	cmd_rcgr: 0x52004,
	mnd_width: 8,
	hid_width: 5,
	...
	.clkr.hwinit: &(clk_init_data ){
		...
		num_parents: (gcc_parents_5.len()),
		flags: CLK_SET_RATE_PARENT,
		ops: &clk_rcg2_shared_ops,
	},
};

freq_tbl [ftbl_gcc_camss_tfe_0_csid_clk_src; 0] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
...
clk_rcg2 gcc_camss_tfe_0_csid_clk_src = {
	cmd_rcgr: 0x52094,
	mnd_width: 0,
	hid_width: 5,
	...
	.clkr.hwinit: &(clk_init_data ){
		...
		num_parents: (gcc_parents_6.len()),
		flags: CLK_SET_RATE_PARENT,
		ops: &clk_rcg2_shared_ops,
	},
};

clk_rcg2 gcc_camss_tfe_1_clk_src = {
	cmd_rcgr: 0x52024,
	mnd_width: 8,
	hid_width: 5,
	parent_map: gcc_parent_map_5,
...
clk_rcg2 gcc_camss_tfe_1_csid_clk_src = {
	cmd_rcgr: 0x520b4,
	mnd_width: 0,
	hid_width: 5,
	parent_map: gcc_parent_map_6,
...
clk_rcg2 gcc_camss_tfe_2_clk_src = {
	cmd_rcgr: 0x52044,
	mnd_width: 8,
	hid_width: 5,
	parent_map: gcc_parent_map_5,
...
clk_rcg2 gcc_camss_tfe_2_csid_clk_src = {
	cmd_rcgr: 0x520d4,
	mnd_width: 0,
	hid_width: 5,
	parent_map: gcc_parent_map_6,
...
freq_tbl [ftbl_gcc_camss_tfe_cphy_rx_clk_src; 0] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
	F(240000000, P_GPLL0_OUT_EARLY, 2.5, 0, 0),
...
clk_rcg2 gcc_camss_tfe_cphy_rx_clk_src = {
	cmd_rcgr: 0x52064,
	mnd_width: 16,
	hid_width: 5,
	...
	.clkr.hwinit: &(clk_init_data ){
		...
		num_parents: (gcc_parents_10.len()),
		flags: CLK_SET_RATE_PARENT | CLK_OPS_PARENT_ENABLE,
		ops: &clk_rcg2_shared_ops,
	},
};

freq_tbl [ftbl_gcc_camss_top_ahb_clk_src; 0] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
...
clk_rcg2 gcc_camss_top_ahb_clk_src = {
	cmd_rcgr: 0x58010,
	mnd_width: 0,
	hid_width: 5,
	parent_map: gcc_parent_map_7,
...
freq_tbl [ftbl_gcc_gp1_clk_src; 0] = {
...
freq_tbl [ftbl_gcc_pdm2_clk_src; 0] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
...
clk_rcg2 gcc_pdm2_clk_src = {
	...
	.clkr.hwinit: &(clk_init_data ){
		...
		num_parents: (gcc_parents_0.len()),
		ops: &clk_rcg2_shared_ops,
	},
};

freq_tbl [ftbl_gcc_qupv3_wrap0_s0_clk_src; 0] = {
...
clk_init_data gcc_qupv3_wrap0_s0_clk_src_init = {
	name: "gcc_qupv3_wrap0_s0_clk_src",
	parent_data: gcc_parents_1,
	num_parents: (gcc_parents_1.len()),
	ops: &clk_rcg2_ops,
};

clk_rcg2 gcc_qupv3_wrap0_s0_clk_src = {
	cmd_rcgr: 0x1f148,
	mnd_width: 16,
	hid_width: 5,
	parent_map: gcc_parent_map_1,
	freq_tbl: ftbl_gcc_qupv3_wrap0_s0_clk_src,
	.clkr.hwinit: &gcc_qupv3_wrap0_s0_clk_src_init,
};

clk_init_data gcc_qupv3_wrap0_s1_clk_src_init = {
...
clk_rcg2 gcc_qupv3_wrap0_s1_clk_src = {
	cmd_rcgr: 0x1f278,
	mnd_width: 16,
	hid_width: 5,
	parent_map: gcc_parent_map_1,
	freq_tbl: ftbl_gcc_qupv3_wrap0_s0_clk_src,
	.clkr.hwinit: &gcc_qupv3_wrap0_s1_clk_src_init,
};

clk_init_data gcc_qupv3_wrap0_s2_clk_src_init = {
...
clk_rcg2 gcc_qupv3_wrap0_s2_clk_src = {
	cmd_rcgr: 0x1f3a8,
	mnd_width: 16,
	hid_width: 5,
	parent_map: gcc_parent_map_1,
	freq_tbl: ftbl_gcc_qupv3_wrap0_s0_clk_src,
	.clkr.hwinit: &gcc_qupv3_wrap0_s2_clk_src_init,
};

clk_init_data gcc_qupv3_wrap0_s3_clk_src_init = {
...
clk_rcg2 gcc_qupv3_wrap0_s3_clk_src = {
	cmd_rcgr: 0x1f4d8,
	mnd_width: 16,
	hid_width: 5,
	parent_map: gcc_parent_map_1,
	freq_tbl: ftbl_gcc_qupv3_wrap0_s0_clk_src,
	.clkr.hwinit: &gcc_qupv3_wrap0_s3_clk_src_init,
};

clk_init_data gcc_qupv3_wrap0_s4_clk_src_init = {
...
clk_rcg2 gcc_qupv3_wrap0_s4_clk_src = {
	cmd_rcgr: 0x1f608,
	mnd_width: 16,
	hid_width: 5,
	parent_map: gcc_parent_map_1,
	freq_tbl: ftbl_gcc_qupv3_wrap0_s0_clk_src,
	.clkr.hwinit: &gcc_qupv3_wrap0_s4_clk_src_init,
};

clk_init_data gcc_qupv3_wrap0_s5_clk_src_init = {
...
clk_rcg2 gcc_qupv3_wrap0_s5_clk_src = {
	...
	parent_map: gcc_parent_map_1,
	freq_tbl: ftbl_gcc_qupv3_wrap0_s0_clk_src,
	.clkr.hwinit: &gcc_qupv3_wrap0_s5_clk_src_init,
};

freq_tbl [ftbl_gcc_sdcc1_apps_clk_src; 0] = {
...
freq_tbl [ftbl_gcc_sdcc1_ice_core_clk_src; 0] = {
	F(75000000, P_GPLL0_OUT_AUX2, 4, 0, 0),
	F(100000000, P_GPLL0_OUT_AUX2, 3, 0, 0),
	F(150000000, P_GPLL0_OUT_AUX2, 2, 0, 0),
...
clk_rcg2 gcc_sdcc1_ice_core_clk_src = {
	cmd_rcgr: 0x38010,
	mnd_width: 0,
	hid_width: 5,
	parent_map: gcc_parent_map_0,
...
freq_tbl [ftbl_gcc_sdcc2_apps_clk_src; 0] = {
	F(400000, P_BI_TCXO, 12, 1, 4),
	F(19200000, P_BI_TCXO, 1, 0, 0),
	F(25000000, P_GPLL0_OUT_AUX2, 12, 0, 0),
	F(50000000, P_GPLL0_OUT_AUX2, 6, 0, 0),
...
clk_rcg2 gcc_sdcc2_apps_clk_src = {
	...
	.clkr.hwinit: &(clk_init_data ){
		...
		num_parents: (gcc_parents_11.len()),
		ops: &clk_rcg2_floor_ops,
		flags: CLK_OPS_PARENT_ENABLE,
	},
};

freq_tbl [ftbl_gcc_ufs_phy_axi_clk_src; 0] = {
	F(25000000, P_GPLL0_OUT_AUX2, 12, 0, 0),
	F(50000000, P_GPLL0_OUT_AUX2, 6, 0, 0),
	F(100000000, P_GPLL0_OUT_AUX2, 3, 0, 0),
	F(200000000, P_GPLL0_OUT_EARLY, 3, 0, 0),
...
freq_tbl [ftbl_gcc_ufs_phy_ice_core_clk_src; 0] = {
	F(37500000, P_GPLL0_OUT_AUX2, 8, 0, 0),
	F(75000000, P_GPLL0_OUT_AUX2, 4, 0, 0),
	F(150000000, P_GPLL0_OUT_AUX2, 2, 0, 0),
	F(300000000, P_GPLL0_OUT_AUX2, 1, 0, 0),
...
freq_tbl [ftbl_gcc_ufs_phy_phy_aux_clk_src; 0] = {
...
freq_tbl [ftbl_gcc_ufs_phy_unipro_core_clk_src; 0] = {
	F(37500000, P_GPLL0_OUT_AUX2, 8, 0, 0),
	F(75000000, P_GPLL0_OUT_AUX2, 4, 0, 0),
	F(150000000, P_GPLL0_OUT_AUX2, 2, 0, 0),
	{ }
...
clk_rcg2 gcc_ufs_phy_unipro_core_clk_src = {
	cmd_rcgr: 0x45060,
	mnd_width: 0,
	hid_width: 5,
	parent_map: gcc_parent_map_0,
...
freq_tbl [ftbl_gcc_usb30_prim_master_clk_src; 0] = {
...
freq_tbl [ftbl_gcc_usb30_prim_mock_utmi_clk_src; 0] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
	{ }
};
...
clk_rcg2 gcc_usb3_prim_phy_aux_clk_src = {
	...
	.clkr.hwinit: &(clk_init_data ){
		...
		num_parents: (gcc_parents_12.len()),
		ops: &clk_rcg2_ops,
	},
};

freq_tbl [ftbl_gcc_video_venus_clk_src; 0] = {
...
clk_rcg2 gcc_video_venus_clk_src = {
	cmd_rcgr: 0x58060,
	mnd_width: 0,
	hid_width: 5,
	...
	.clkr.hwinit: &(clk_init_data ){
		...
		num_parents: (gcc_parents_13.len()),
		flags: CLK_SET_RATE_PARENT,
		ops: &clk_rcg2_shared_ops,
	},
};

clk_branch gcc_ahb2phy_csi_clk = {
	halt_reg: 0x1d004,
...
clk_branch gcc_ahb2phy_usb_clk = {
	halt_reg: 0x1d008,
	halt_check: BRANCH_HALT,
	hwcg_reg: 0x1d008,
	hwcg_bit: 1,
...
clk_branch gcc_bimc_gpu_axi_clk = {
	halt_reg: 0x71154,
...
clk_branch gcc_cam_throttle_nrt_clk = {
	halt_reg: 0x17070,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x17070,
	hwcg_bit: 1,
...
clk_branch gcc_cam_throttle_rt_clk = {
	halt_reg: 0x1706c,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x1706c,
	hwcg_bit: 1,
...
clk_branch gcc_camss_camnoc_atb_clk = {
	halt_reg: 0x5804c,
	halt_check: BRANCH_HALT_DELAY,
	hwcg_reg: 0x5804c,
	hwcg_bit: 1,
...
clk_branch gcc_camss_camnoc_nts_xo_clk = {
	halt_reg: 0x58050,
	halt_check: BRANCH_HALT_DELAY,
	hwcg_reg: 0x58050,
	hwcg_bit: 1,
...
clk_branch gcc_camss_cci_0_clk = {
	halt_reg: 0x56018,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x56018,
...
clk_branch gcc_camss_cphy_0_clk = {
	halt_reg: 0x52088,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x52088,
...
clk_branch gcc_camss_cphy_1_clk = {
	halt_reg: 0x5208c,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x5208c,
...
clk_branch gcc_camss_cphy_2_clk = {
	halt_reg: 0x52090,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x52090,
...
clk_branch gcc_camss_csi0phytimer_clk = {
	halt_reg: 0x59018,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x59018,
...
clk_branch gcc_camss_csi1phytimer_clk = {
	halt_reg: 0x59034,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x59034,
...
clk_branch gcc_camss_csi2phytimer_clk = {
	halt_reg: 0x59050,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x59050,
...
clk_branch gcc_camss_mclk0_clk = {
	halt_reg: 0x51018,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x51018,
...
clk_branch gcc_camss_mclk1_clk = {
	halt_reg: 0x51034,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x51034,
...
clk_branch gcc_camss_mclk2_clk = {
	halt_reg: 0x51050,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x51050,
...
clk_branch gcc_camss_mclk3_clk = {
	halt_reg: 0x5106c,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x5106c,
...
clk_branch gcc_camss_nrt_axi_clk = {
	halt_reg: 0x58054,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x58054,
...
clk_branch gcc_camss_ope_ahb_clk = {
	halt_reg: 0x5503c,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x5503c,
...
clk_branch gcc_camss_rt_axi_clk = {
	halt_reg: 0x5805c,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x5805c,
...
clk_branch gcc_camss_tfe_0_clk = {
	halt_reg: 0x5201c,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x5201c,
...
clk_branch gcc_camss_tfe_0_cphy_rx_clk = {
	halt_reg: 0x5207c,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x5207c,
...
clk_branch gcc_camss_tfe_0_csid_clk = {
	halt_reg: 0x520ac,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x520ac,
...
clk_branch gcc_camss_tfe_1_clk = {
	halt_reg: 0x5203c,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x5203c,
...
clk_branch gcc_camss_tfe_1_cphy_rx_clk = {
	halt_reg: 0x52080,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x52080,
...
clk_branch gcc_camss_tfe_1_csid_clk = {
	halt_reg: 0x520cc,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x520cc,
...
clk_branch gcc_camss_tfe_2_clk = {
	halt_reg: 0x5205c,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x5205c,
...
clk_branch gcc_camss_tfe_2_cphy_rx_clk = {
	halt_reg: 0x52084,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x52084,
...
clk_branch gcc_camss_tfe_2_csid_clk = {
	halt_reg: 0x520ec,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x520ec,
...
clk_branch gcc_camss_top_ahb_clk = {
	halt_reg: 0x58028,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x58028,
...
clk_regmap_div gcc_disp_gpll0_clk_src = {
	reg: 0x17058,
	shift: 0,
	width: 2,
	.clkr.hwinit: &(clk_init_data ) {
...
clk_branch gcc_disp_gpll0_div_clk_src = {
	halt_check: BRANCH_HALT_DELAY,
	clkr: {
		enable_reg: 0x79004,
		enable_mask: (1u32 << (20)),
...
clk_branch gcc_disp_hf_axi_clk = {
	halt_reg: 0x17020,
	halt_check: BRANCH_HALT,
	hwcg_reg: 0x17020,
	hwcg_bit: 1,
...
clk_branch gcc_disp_throttle_core_clk = {
	halt_reg: 0x17064,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x17064,
	hwcg_bit: 1,
...
clk_branch gcc_gpu_memnoc_gfx_clk = {
	halt_reg: 0x3600c,
...
clk_branch gcc_gpu_snoc_dvm_gfx_clk = {
	halt_reg: 0x36018,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x36018,
...
clk_branch gcc_gpu_throttle_core_clk = {
	halt_reg: 0x36048,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x36048,
	hwcg_bit: 1,
...
clk_branch gcc_qmip_camera_nrt_ahb_clk = {
	halt_reg: 0x17014,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x17014,
	hwcg_bit: 1,
...
clk_branch gcc_qmip_camera_rt_ahb_clk = {
	halt_reg: 0x17060,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x17060,
	hwcg_bit: 1,
...
clk_branch gcc_qmip_disp_ahb_clk = {
	halt_reg: 0x17018,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x17018,
	hwcg_bit: 1,
...
clk_branch gcc_qmip_gpu_cfg_ahb_clk = {
	halt_reg: 0x36040,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x36040,
	hwcg_bit: 1,
...
clk_branch gcc_qmip_video_vcodec_ahb_clk = {
	halt_reg: 0x17010,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x17010,
	hwcg_bit: 1,
...
clk_branch gcc_qupv3_wrap0_core_2x_clk = {
	halt_reg: 0x1f014,
	halt_check: BRANCH_HALT_VOTED,
	clkr: {
		enable_reg: 0x7900c,
...
clk_branch gcc_qupv3_wrap0_core_clk = {
	halt_reg: 0x1f00c,
	halt_check: BRANCH_HALT_VOTED,
	clkr: {
		enable_reg: 0x7900c,
...
clk_branch gcc_qupv3_wrap0_s0_clk = {
	halt_reg: 0x1f144,
	halt_check: BRANCH_HALT_VOTED,
	clkr: {
		enable_reg: 0x7900c,
...
clk_branch gcc_qupv3_wrap0_s1_clk = {
	halt_reg: 0x1f274,
	halt_check: BRANCH_HALT_VOTED,
	clkr: {
		enable_reg: 0x7900c,
...
clk_branch gcc_qupv3_wrap0_s2_clk = {
	halt_reg: 0x1f3a4,
	halt_check: BRANCH_HALT_VOTED,
	clkr: {
		enable_reg: 0x7900c,
...
clk_branch gcc_qupv3_wrap0_s3_clk = {
	halt_reg: 0x1f4d4,
	halt_check: BRANCH_HALT_VOTED,
	clkr: {
		enable_reg: 0x7900c,
...
clk_branch gcc_qupv3_wrap0_s4_clk = {
	halt_reg: 0x1f604,
	halt_check: BRANCH_HALT_VOTED,
	clkr: {
		enable_reg: 0x7900c,
...
clk_branch gcc_qupv3_wrap0_s5_clk = {
	halt_reg: 0x1f734,
	halt_check: BRANCH_HALT_VOTED,
	clkr: {
		enable_reg: 0x7900c,
...
clk_branch gcc_qupv3_wrap_0_m_ahb_clk = {
	halt_reg: 0x1f004,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x1f004,
	hwcg_bit: 1,
...
clk_branch gcc_qupv3_wrap_0_s_ahb_clk = {
	halt_reg: 0x1f008,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x1f008,
	hwcg_bit: 1,
...
clk_branch gcc_sdcc1_apps_clk = {
	...
	clkr: {
		...
		.hwinit: &(clk_init_data ){
			...
			num_parents: 1,
			flags: CLK_SET_RATE_PARENT /* | *mut CLK_ENABLE_HAND_OFF /,
			ops: &clk_branch2_ops,
		},
	},
};

clk_branch gcc_sdcc1_ice_core_clk = {
	halt_reg: 0x3800c,
	halt_check: BRANCH_HALT,
	hwcg_reg: 0x3800c,
	hwcg_bit: 1,
...
clk_branch gcc_sys_noc_cpuss_ahb_clk = {
	halt_reg: 0x2b06c,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x2b06c,
	hwcg_bit: 1,
...
clk_branch gcc_sys_noc_ufs_phy_axi_clk = {
	halt_reg: 0x45098,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x45098,
...
clk_branch gcc_sys_noc_usb3_prim_axi_clk = {
	halt_reg: 0x1a080,
	halt_check: BRANCH_HALT,
	hwcg_reg: 0x1a080,
	hwcg_bit: 1,
...
clk_branch gcc_ufs_phy_unipro_core_clk = {
	halt_reg: 0x45040,
	halt_check: BRANCH_HALT,
	hwcg_reg: 0x45040,
	hwcg_bit: 1,
...
clk_branch gcc_usb3_prim_clkref_clk = {
	halt_reg: 0x9f000,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x9f000,
...
clk_branch gcc_vcodec0_axi_clk = {
	halt_reg: 0x6e008,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x6e008,
...
clk_branch gcc_venus_ctl_axi_clk = {
	halt_reg: 0x6e004,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x6e004,
...
clk_branch gcc_video_venus_ctl_clk = {
	halt_reg: 0x5808c,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x5808c,
...
gdsc hlos1_vote_turing_mmu_tbu1_gdsc = {
	gdscr: 0x7d060,
	pd: {
...
gdsc hlos1_vote_turing_mmu_tbu0_gdsc = {
	gdscr: 0x7d07c,
	pd: {
...
gdsc hlos1_vote_mm_snoc_mmu_tbu_rt_gdsc = {
	gdscr: 0x7d074,
	pd: {
...
gdsc hlos1_vote_mm_snoc_mmu_tbu_nrt_gdsc = {
	gdscr: 0x7d078,
	pd: {
...
*mut clk_regmap [gcc_sm6115_clocks; 0] = {
...
qcom_reset_map [gcc_sm6115_resets; 0] = {
...
clk_rcg_dfs_data [gcc_dfs_clocks; 0] = {
...
regmap_config gcc_sm6115_regmap_config = {
	reg_bits: 32,
	reg_stride: 4,
	val_bits: 32,
...
qcom_cc_desc gcc_sm6115_desc = {
	config: &gcc_sm6115_regmap_config,
	clks: gcc_sm6115_clocks,
	num_clks: (gcc_sm6115_clocks.len()),
	resets: gcc_sm6115_resets,
	num_resets: (gcc_sm6115_resets.len()),
	gdscs: gcc_sm6115_gdscs,
	num_gdscs: (gcc_sm6115_gdscs.len()),
};

of_device_id [gcc_sm6115_match_table; 0] = {
	{ compatible: "qcom,gcc-sm6115" },
	{ }
};
MODULE_DEVICE_TABLE(of, gcc_sm6115_match_table);

int gcc_sm6115_probe(*mut platform_device pdev)
{
	*mut regmap regmap;
	int ret;
...
platform_driver gcc_sm6115_driver = {
