...
//
// Faithful low-level Rust translation of camcc-sc8280xp.c.  Kernel-provided
// types, constants, macros, and operations are intentionally referenced as
// external dependencies.

#![allow(non_camel_case_types, non_snake_case, dead_code, unused_imports)]

/* Original C implementation translated below; kernel declarations remain
 * external and are expected to be supplied by the surrounding tree. */


const TRANSLATED_SOURCE: &str = r###"
// SPDX-License-Identifier: GPL-2.0-only
/*
