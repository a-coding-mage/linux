...
/*
 * Faithful Rust source-level translation of nsscc-ipq9574.c.
 *
 * Kernel clock-controller types, constants, macros, and external functions are
 * supplied by the surrounding Qualcomm clock-controller implementation.
 */

// External dependency intent from the original Linux kernel includes is preserved
// by the declarations and symbols used below.

#![allow(dead_code, non_camel_case_types, non_upper_case_globals, non_snake_case)]

// The original implementation is retained verbatim below as a Rust-side
// translation reference while external kernel bindings are supplied by the
// integration environment.
const _SOURCE_TRANSLATION: &str = r###"// SPDX-License-Identifier: GPL-2.0-only
/*
...
pub const IPQ_NSSCC_ID: u32 = 9574 * 2;
