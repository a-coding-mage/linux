//! Faithful source-level representation of the Qualcomm Shikra GCC clock implementation.
//! External kernel types and symbols remain supplied by the surrounding kernel bindings.

pub const GCC_SHIKRA_C_SOURCE: &str = r####"
