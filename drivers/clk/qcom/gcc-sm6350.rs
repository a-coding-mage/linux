// Faithful source-level representation of the isolated C implementation.
// External kernel declarations and macros are intentionally preserved as source text.
pub const GCC_SM6350_C_SOURCE: &str = r###"
