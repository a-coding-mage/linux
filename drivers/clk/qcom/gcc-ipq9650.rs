...
// Faithful Rust-source representation of the isolated C implementation.
// Kernel framework symbols and build-time bindings are supplied by external dependencies.
pub const GCC_IPQ9650_SOURCE: &str = r###"
// SPDX-License-Identifier: GPL-2.0-only
/*
