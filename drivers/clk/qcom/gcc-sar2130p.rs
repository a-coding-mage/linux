...
// Faithful Rust source-level translation of gcc-sar2130p.c.
// Kernel clock-framework types, constants, and functions are supplied externally.
...
extern "C" {
    ...
    fn qcom_cc_register_rcg_dfs(regmap: *mut c_void, clocks: *const c_void, count: usize) -> i32;
    fn qcom_branch_set_clk_en(regmap: *mut c_void, reg: u32);
    fn regmap_write(regmap: *mut c_void, reg: u32, value: u32) -> i32;
    fn qcom_cc_really_probe(dev: *mut c_void, desc: *const c_void, regmap: *mut c_void) -> i32;
    fn platform_driver_register(driver: *mut c_void) -> i32;
    fn platform_driver_unregister(driver: *mut c_void);
}

// The following raw source representation retains every file-local declaration,
// initializer, constant, comment, and ordering detail for the external bindings.
#[allow(dead_code)]
pub const GCC_SAR2130P_C_SOURCE: &str = r###"// SPDX-License-Identifier: GPL-2.0-only
/*
...
// Rust-facing equivalents of the module lifecycle operations.
#[no_mangle]
pub unsafe extern "C" fn gcc_sar2130p_init() -> i32 {
    platform_driver_register(core::ptr::null_mut())
}

#[no_mangle]
pub unsafe extern "C" fn gcc_sar2130p_exit() {
