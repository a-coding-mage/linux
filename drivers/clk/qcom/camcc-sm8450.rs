...
// external dependency: <dt-bindings/clock/qcom,sm8450-camcc.h>
...
pub const P_SLEEP_CLK: i32 = P_CAM_CC_PLL8_OUT_EVEN + 1;
...
static int cam_cc_sm8450_probe(platform_device *pdev)
{
