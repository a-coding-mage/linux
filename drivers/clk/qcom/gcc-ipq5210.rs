...
//
// Faithful source-level translation record. The Linux kernel declarations and
// initializers below depend on external kernel bindings supplied by the build.
// They are retained verbatim because those dependencies are outside this file.

pub const GCC_IPQ5210_SOURCE: &str = r###"// SPDX-License-Identifier: GPL-2.0-only
/*
