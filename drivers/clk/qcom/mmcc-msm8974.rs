...
//
// Source-level Rust representation. External Linux kernel declarations and
// macros remain embedded verbatim because they are supplied by other files.
pub const MMCC_MSM8974_C_SOURCE: &str = r###"
+// SPDX-License-Identifier: GPL-2.0-only
/*
