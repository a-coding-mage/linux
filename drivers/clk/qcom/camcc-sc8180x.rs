...
// The declarations above are preserved verbatim as source-level reference; external kernel types and operations are supplied by the surrounding Rust translation environment.
