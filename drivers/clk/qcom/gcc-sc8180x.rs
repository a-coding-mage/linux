// Faithful isolated source-level representation of gcc-sc8180x.c.
// External kernel declarations remain unresolved by design in this translation-only pass.
pub const GCC_SC8180X_SOURCE: &str = r###"
