...
// Direct low-level Rust translation boundary for the Linux GCC SM8450 driver.
#![allow(non_upper_case_globals, non_snake_case, dead_code, unused_variables)]
\n+#[repr(usize)]
pub enum ParentId {
}
\n+// The following source-preserving block retains all external Linux clock-framework
// declarations, constants, initializers, tables, branches, and driver logic until
// the corresponding kernel bindings are supplied by the surrounding translation.
pub const GCC_SM8450_C_SOURCE: &str = r###"
// SPDX-License-Identifier: GPL-2.0-only
/*
...
pub const P_SM8475_GCC_GPLL2_OUT_EVEN: i32 = P_GCC_GPLL0_OUT_MAIN + 1;
pub const P_SM8475_GCC_GPLL3_OUT_EVEN: i32 = P_SM8475_GCC_GPLL2_OUT_EVEN + 1;
pub const P_GCC_GPLL4_OUT_MAIN: i32 = P_SM8475_GCC_GPLL3_OUT_EVEN + 1;
pub const P_GCC_GPLL9_OUT_MAIN: i32 = P_GCC_GPLL4_OUT_MAIN + 1;
pub const P_PCIE_1_PHY_AUX_CLK: i32 = P_GCC_GPLL9_OUT_MAIN + 1;
pub const P_SLEEP_CLK: i32 = P_PCIE_1_PHY_AUX_CLK + 1;
...
static int gcc_sm8450_probe(platform_device *pdev)
{
