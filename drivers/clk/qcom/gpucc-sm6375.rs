...
pub const DT_GCC_GPU_SNOC_DVM_GFX_CLK: i32 = DT_GCC_GPU_GPLL0_DIV_CLK_SRC + 1;
pub const P_BI_TCXO: i32 = 0;
pub const P_GCC_GPU_GPLL0_CLK_SRC: i32 = P_BI_TCXO + 1;
pub const P_GCC_GPU_GPLL0_DIV_CLK_SRC: i32 = P_GCC_GPU_GPLL0_CLK_SRC + 1;
pub const P_GPU_CC_PLL0_OUT_EVEN: i32 = P_GCC_GPU_GPLL0_DIV_CLK_SRC + 1;
pub const P_GPU_CC_PLL0_OUT_MAIN: i32 = P_GPU_CC_PLL0_OUT_EVEN + 1;
pub const P_GPU_CC_PLL0_OUT_ODD: i32 = P_GPU_CC_PLL0_OUT_MAIN + 1;
pub const P_GPU_CC_PLL1_OUT_EVEN: i32 = P_GPU_CC_PLL0_OUT_ODD + 1;
pub const P_GPU_CC_PLL1_OUT_MAIN: i32 = P_GPU_CC_PLL1_OUT_EVEN + 1;
pub const P_GPU_CC_PLL1_OUT_ODD: i32 = P_GPU_CC_PLL1_OUT_MAIN + 1;
