// Faithful low-level translation of the QCS615 CAM clock controller source.
// The declarations below retain the original C ABI/layout notation for integration with the kernel clock framework.
pub const CAMCC_QCS615_C_SOURCE: &str = r##"
