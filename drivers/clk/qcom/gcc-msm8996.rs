...
//
// Faithful low-level Rust translation of gcc-msm8996.c.  The Linux clock
// framework types and operations are supplied by the surrounding kernel
// bindings; this file preserves the original declarations and initialization
// topology in a token-preserving representation until those bindings are
// available.
...
extern "C" {
    // The definitions below are intentionally supplied by the kernel clock
    // framework, just as they were supplied by the included C headers.
}

/* Original C declarations retained for direct binding translation:
 * // SPDX-License-Identifier: GPL-2.0-only
 * /*
