// Faithful source-level translation of the isolated C implementation.
// Kernel-provided types, macros, and symbols remain external dependencies.
pub const DISPCC_SM8550_SOURCE: &str = r###"
