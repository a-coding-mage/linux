...
// dependency: <dt-bindings/clock/qcom,gcc-sdm845.h>
...
pub const P_AUD_REF_CLK: i32 = P_BI_TCXO + 1;
pub const P_GPLL0_OUT_EVEN: i32 = P_AUD_REF_CLK + 1;
pub const P_GPLL0_OUT_MAIN: i32 = P_GPLL0_OUT_EVEN + 1;
pub const P_GPLL4_OUT_MAIN: i32 = P_GPLL0_OUT_MAIN + 1;
pub const P_GPLL6_OUT_MAIN: i32 = P_GPLL4_OUT_MAIN + 1;
pub const P_SLEEP_CLK: i32 = P_GPLL6_OUT_MAIN + 1;
...
static int gcc_sdm845_probe(platform_device *pdev)
{
