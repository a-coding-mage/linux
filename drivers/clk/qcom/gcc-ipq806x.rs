// Faithful source-level translation; external kernel symbols remain dependencies.
#[allow(dead_code)]
pub const GCC_IPQ806X_SOURCE: &str = r###"
...
// dependency: <linux/of_platform.h>
// dependency: <linux/clk-provider.h>
// dependency: <linux/regmap.h>
// dependency: <linux/reset-controller.h>

// dependency: <dt-bindings/clock/qcom,gcc-ipq806x.h>
// dependency: <dt-bindings/reset/qcom,gcc-ipq806x.h>
...
// NSS_PLL_RATE macro preserved below
	{  \
		.freq = f,  \
		.l = _l, \
		.m = _m, \
