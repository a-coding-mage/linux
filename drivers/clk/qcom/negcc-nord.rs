// Direct Rust source-level translation; external kernel symbols remain dependencies.
...
// dependency: <dt-bindings/clock/qcom,nord-negcc.h>
...
static mut clk_div_table post_div_table_ne_gcc_gpll0_out_even[] = {
	{ 0x1, 2 },
	{ }
};

static mut clk_alpha_pll_postdiv ne_gcc_gpll0_out_even = {
	offset: 0x0,
	post_div_shift: 10,
	post_div_table: post_div_table_ne_gcc_gpll0_out_even,
	num_post_div: (post_div_table_ne_gcc_gpll0_out_even.len()),
	width: 4,
	regs: clk_alpha_pll_regs[CLK_ALPHA_PLL_TYPE_LUCID_OLE],
	.clkr.hwinit: &(const  clk_init_data) {
...
static mut clk_alpha_pll ne_gcc_gpll2 = {
	offset: 0x2000,
	regs: clk_alpha_pll_regs[CLK_ALPHA_PLL_TYPE_LUCID_OLE],
	clkr: {
		enable_reg: 0x0,
...
static mut struct parent_map ne_gcc_parent_map_0[] = {
	{ P_BI_TCXO, 0 },
	{ P_NE_GCC_GPLL0_OUT_MAIN, 1 },
};

static mut clk_parent_data ne_gcc_parent_data_0[] = {
	{ index: DT_BI_TCXO },
	{ hw: &ne_gcc_gpll0.clkr.hw },
};

static mut struct parent_map ne_gcc_parent_map_1[] = {
	{ P_BI_TCXO, 0 },
	{ P_NE_GCC_GPLL0_OUT_MAIN, 1 },
	{ P_NE_GCC_GPLL0_OUT_EVEN, 5 },
};

static mut clk_parent_data ne_gcc_parent_data_1[] = {
	{ index: DT_BI_TCXO },
	{ hw: &ne_gcc_gpll0.clkr.hw },
	{ hw: &ne_gcc_gpll0_out_even.clkr.hw },
};

static mut struct parent_map ne_gcc_parent_map_2[] = {
	{ P_BI_TCXO, 0 },
	{ P_NE_GCC_GPLL0_OUT_MAIN, 1 },
	{ P_NE_GCC_GPLL2_OUT_MAIN, 3 },
};

static mut clk_parent_data ne_gcc_parent_data_2[] = {
	{ index: DT_BI_TCXO },
	{ hw: &ne_gcc_gpll0.clkr.hw },
	{ hw: &ne_gcc_gpll2.clkr.hw },
};

static mut struct parent_map ne_gcc_parent_map_3[] = {
	{ P_BI_TCXO, 0 },
	{ P_SLEEP_CLK, 5 },
};

static mut clk_parent_data ne_gcc_parent_data_3[] = {
	{ index: DT_BI_TCXO },
	{ index: DT_SLEEP_CLK },
};

static mut struct parent_map ne_gcc_parent_map_4[] = {
	{ P_BI_TCXO, 0 },
	{ P_NE_GCC_GPLL0_OUT_MAIN, 1 },
	{ P_SLEEP_CLK, 5 },
};

static mut clk_parent_data ne_gcc_parent_data_4[] = {
	{ index: DT_BI_TCXO },
	{ hw: &ne_gcc_gpll0.clkr.hw },
	{ index: DT_SLEEP_CLK },
};

static mut struct parent_map ne_gcc_parent_map_5[] = {
	{ P_BI_TCXO, 0 },
};

static mut clk_parent_data ne_gcc_parent_data_5[] = {
	{ index: DT_BI_TCXO },
};
...
static mut struct freq_tbl ftbl_ne_gcc_gp1_clk_src[] = {
...
static mut clk_rcg2 ne_gcc_gp1_clk_src = {
	cmd_rcgr: 0x21004,
	mnd_width: 16,
	hid_width: 5,
	...
	.clkr.hwinit: &(const  clk_init_data) {
		...
		num_parents: (ne_gcc_parent_data_4.len()),
		flags: CLK_SET_RATE_PARENT,
		ops: &clk_rcg2_shared_ops,
	},
};

static mut clk_rcg2 ne_gcc_gp2_clk_src = {
	cmd_rcgr: 0x22004,
	mnd_width: 16,
	hid_width: 5,
	parent_map: ne_gcc_parent_map_4,
...
static mut struct freq_tbl ftbl_ne_gcc_qupv3_wrap2_s0_clk_src[] = {
...
static mut clk_init_data ne_gcc_qupv3_wrap2_s0_clk_src_init = {
	name: "ne_gcc_qupv3_wrap2_s0_clk_src",
	parent_data: ne_gcc_parent_data_0,
	num_parents: (ne_gcc_parent_data_0.len()),
	flags: CLK_SET_RATE_PARENT,
	ops: &clk_rcg2_shared_no_init_park_ops,
};

static mut clk_rcg2 ne_gcc_qupv3_wrap2_s0_clk_src = {
	cmd_rcgr: 0x3816c,
	mnd_width: 16,
	hid_width: 5,
	...
	hw_clk_ctrl: true,
	.clkr.hwinit: &ne_gcc_qupv3_wrap2_s0_clk_src_init,
};

static mut clk_init_data ne_gcc_qupv3_wrap2_s1_clk_src_init = {
...
static mut clk_rcg2 ne_gcc_qupv3_wrap2_s1_clk_src = {
	cmd_rcgr: 0x382a8,
	mnd_width: 16,
	hid_width: 5,
	parent_map: ne_gcc_parent_map_0,
	freq_tbl: ftbl_ne_gcc_qupv3_wrap2_s0_clk_src,
	hw_clk_ctrl: true,
	.clkr.hwinit: &ne_gcc_qupv3_wrap2_s1_clk_src_init,
};

static mut struct freq_tbl ftbl_ne_gcc_qupv3_wrap2_s2_clk_src[] = {
	F(7372800, P_NE_GCC_GPLL0_OUT_MAIN, 1, 192, 15625),
	F(14745600, P_NE_GCC_GPLL0_OUT_MAIN, 1, 384, 15625),
	F(19200000, P_BI_TCXO, 1, 0, 0),
	F(29491200, P_NE_GCC_GPLL0_OUT_MAIN, 1, 768, 15625),
...
static mut clk_init_data ne_gcc_qupv3_wrap2_s2_clk_src_init = {
...
static mut clk_rcg2 ne_gcc_qupv3_wrap2_s2_clk_src = {
	cmd_rcgr: 0x383e4,
	mnd_width: 16,
	hid_width: 5,
	parent_map: ne_gcc_parent_map_0,
	...
	hw_clk_ctrl: true,
	.clkr.hwinit: &ne_gcc_qupv3_wrap2_s2_clk_src_init,
};

static mut clk_init_data ne_gcc_qupv3_wrap2_s3_clk_src_init = {
...
static mut clk_rcg2 ne_gcc_qupv3_wrap2_s3_clk_src = {
	cmd_rcgr: 0x38520,
	mnd_width: 16,
	hid_width: 5,
	parent_map: ne_gcc_parent_map_0,
	freq_tbl: ftbl_ne_gcc_qupv3_wrap2_s2_clk_src,
	hw_clk_ctrl: true,
	.clkr.hwinit: &ne_gcc_qupv3_wrap2_s3_clk_src_init,
};

static mut clk_init_data ne_gcc_qupv3_wrap2_s4_clk_src_init = {
...
static mut clk_rcg2 ne_gcc_qupv3_wrap2_s4_clk_src = {
	cmd_rcgr: 0x3865c,
	mnd_width: 16,
	hid_width: 5,
	parent_map: ne_gcc_parent_map_0,
	freq_tbl: ftbl_ne_gcc_qupv3_wrap2_s2_clk_src,
	hw_clk_ctrl: true,
	.clkr.hwinit: &ne_gcc_qupv3_wrap2_s4_clk_src_init,
};

static mut clk_init_data ne_gcc_qupv3_wrap2_s5_clk_src_init = {
...
static mut clk_rcg2 ne_gcc_qupv3_wrap2_s5_clk_src = {
	cmd_rcgr: 0x38798,
	mnd_width: 16,
	hid_width: 5,
	parent_map: ne_gcc_parent_map_0,
	freq_tbl: ftbl_ne_gcc_qupv3_wrap2_s2_clk_src,
	hw_clk_ctrl: true,
	.clkr.hwinit: &ne_gcc_qupv3_wrap2_s5_clk_src_init,
};

static mut clk_init_data ne_gcc_qupv3_wrap2_s6_clk_src_init = {
...
static mut clk_rcg2 ne_gcc_qupv3_wrap2_s6_clk_src = {
	cmd_rcgr: 0x388d4,
	mnd_width: 16,
	hid_width: 5,
	parent_map: ne_gcc_parent_map_0,
	freq_tbl: ftbl_ne_gcc_qupv3_wrap2_s2_clk_src,
	hw_clk_ctrl: true,
	.clkr.hwinit: &ne_gcc_qupv3_wrap2_s6_clk_src_init,
};

static mut struct freq_tbl ftbl_ne_gcc_sdcc4_apps_clk_src[] = {
...
static mut clk_rcg2 ne_gcc_sdcc4_apps_clk_src = {
	cmd_rcgr: 0x1801c,
	mnd_width: 8,
	hid_width: 5,
	parent_map: ne_gcc_parent_map_0,
...
static mut struct freq_tbl ftbl_ne_gcc_ufs_phy_axi_clk_src[] = {
	F(120000000, P_NE_GCC_GPLL0_OUT_MAIN, 5, 0, 0),
...
static mut clk_rcg2 ne_gcc_ufs_phy_axi_clk_src = {
	cmd_rcgr: 0x33034,
	mnd_width: 8,
	hid_width: 5,
	...
	.clkr.hwinit: &(const  clk_init_data) {
		...
		num_parents: (ne_gcc_parent_data_2.len()),
		flags: CLK_SET_RATE_PARENT,
		ops: &clk_rcg2_shared_ops,
	},
};

static mut clk_rcg2 ne_gcc_ufs_phy_ice_core_clk_src = {
	cmd_rcgr: 0x3308c,
	mnd_width: 0,
	hid_width: 5,
	parent_map: ne_gcc_parent_map_2,
...
static mut struct freq_tbl ftbl_ne_gcc_ufs_phy_phy_aux_clk_src[] = {
	F(19200000, P_BI_TCXO, 1, 0, 0),
	{ }
};

static mut clk_rcg2 ne_gcc_ufs_phy_phy_aux_clk_src = {
	cmd_rcgr: 0x330c0,
	mnd_width: 0,
	hid_width: 5,
	...
	.clkr.hwinit: &(const  clk_init_data) {
		...
		num_parents: (ne_gcc_parent_data_5.len()),
		flags: CLK_SET_RATE_PARENT,
		ops: &clk_rcg2_shared_ops,
	},
};

static mut clk_rcg2 ne_gcc_ufs_phy_unipro_core_clk_src = {
	cmd_rcgr: 0x330a4,
	mnd_width: 0,
	hid_width: 5,
	parent_map: ne_gcc_parent_map_2,
...
static mut struct freq_tbl ftbl_ne_gcc_usb20_master_clk_src[] = {
	F(75000000, P_NE_GCC_GPLL0_OUT_MAIN, 8, 0, 0),
	F(120000000, P_NE_GCC_GPLL0_OUT_MAIN, 5, 0, 0),
	{ }
};

static mut clk_rcg2 ne_gcc_usb20_master_clk_src = {
	cmd_rcgr: 0x31030,
	mnd_width: 8,
	hid_width: 5,
	parent_map: ne_gcc_parent_map_0,
...
static mut clk_rcg2 ne_gcc_usb20_mock_utmi_clk_src = {
	cmd_rcgr: 0x31048,
	mnd_width: 0,
	hid_width: 5,
	parent_map: ne_gcc_parent_map_0,
...
static mut struct freq_tbl ftbl_ne_gcc_usb31_prim_master_clk_src[] = {
...
static mut clk_rcg2 ne_gcc_usb31_prim_master_clk_src = {
	cmd_rcgr: 0x2a038,
	mnd_width: 8,
	hid_width: 5,
	...
	.clkr.hwinit: &(const  clk_init_data) {
		...
		num_parents: (ne_gcc_parent_data_1.len()),
		flags: CLK_SET_RATE_PARENT,
		ops: &clk_rcg2_shared_ops,
	},
};

static mut clk_rcg2 ne_gcc_usb31_prim_mock_utmi_clk_src = {
	cmd_rcgr: 0x2a050,
	mnd_width: 0,
	hid_width: 5,
	parent_map: ne_gcc_parent_map_0,
...
static mut clk_rcg2 ne_gcc_usb31_sec_master_clk_src = {
	cmd_rcgr: 0x2c038,
	mnd_width: 8,
	hid_width: 5,
	parent_map: ne_gcc_parent_map_0,
...
static mut clk_rcg2 ne_gcc_usb31_sec_mock_utmi_clk_src = {
	cmd_rcgr: 0x2c050,
	mnd_width: 0,
	hid_width: 5,
	parent_map: ne_gcc_parent_map_0,
...
static mut clk_rcg2 ne_gcc_usb3_prim_phy_aux_clk_src = {
	cmd_rcgr: 0x2a07c,
	mnd_width: 0,
	hid_width: 5,
	...
	.clkr.hwinit: &(const  clk_init_data) {
		...
		num_parents: (ne_gcc_parent_data_3.len()),
		flags: CLK_SET_RATE_PARENT,
		ops: &clk_rcg2_shared_ops,
	},
};

static mut clk_rcg2 ne_gcc_usb3_sec_phy_aux_clk_src = {
	cmd_rcgr: 0x2c07c,
	mnd_width: 0,
	hid_width: 5,
	parent_map: ne_gcc_parent_map_3,
...
static mut clk_regmap_div ne_gcc_usb20_mock_utmi_postdiv_clk_src = {
	reg: 0x31060,
	shift: 0,
	width: 4,
	.clkr.hwinit: &(const  clk_init_data) {
...
static mut clk_regmap_div ne_gcc_usb31_prim_mock_utmi_postdiv_clk_src = {
	reg: 0x2a068,
	shift: 0,
	width: 4,
	.clkr.hwinit: &(const  clk_init_data) {
...
static mut clk_regmap_div ne_gcc_usb31_sec_mock_utmi_postdiv_clk_src = {
	reg: 0x2c068,
	shift: 0,
	width: 4,
	.clkr.hwinit: &(const  clk_init_data) {
...
static mut clk_branch ne_gcc_aggre_noc_ufs_phy_axi_clk = {
	halt_reg: 0x330f4,
...
static mut clk_branch ne_gcc_aggre_noc_usb2_axi_clk = {
	halt_reg: 0x31068,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x31068,
	hwcg_bit: 1,
...
static mut clk_branch ne_gcc_aggre_noc_usb3_prim_axi_clk = {
	halt_reg: 0x2a098,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x2a098,
	hwcg_bit: 1,
...
static mut clk_branch ne_gcc_aggre_noc_usb3_sec_axi_clk = {
	halt_reg: 0x2c098,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x2c098,
	hwcg_bit: 1,
...
static mut clk_branch ne_gcc_ahb2phy_clk = {
	halt_reg: 0x30004,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x30004,
	hwcg_bit: 1,
...
static mut clk_branch ne_gcc_cnoc_usb2_axi_clk = {
	halt_reg: 0x31064,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x31064,
	hwcg_bit: 1,
...
static mut clk_branch ne_gcc_cnoc_usb3_prim_axi_clk = {
	halt_reg: 0x2a094,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x2a094,
	hwcg_bit: 1,
...
static mut clk_branch ne_gcc_cnoc_usb3_sec_axi_clk = {
	halt_reg: 0x2c094,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x2c094,
	hwcg_bit: 1,
...
static mut clk_branch ne_gcc_frq_measure_ref_clk = {
	halt_reg: 0x20008,
...
static mut clk_branch ne_gcc_gp1_clk = {
	halt_reg: 0x21000,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x21000,
...
static mut clk_branch ne_gcc_gp2_clk = {
	halt_reg: 0x22000,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x22000,
...
static mut clk_branch ne_gcc_gpu_2_gpll0_clk_src = {
...
static mut clk_branch ne_gcc_gpu_2_gpll0_div_clk_src = {
	halt_check: BRANCH_HALT_DELAY,
	clkr: {
		enable_reg: 0x57000,
		enable_mask: (1u32 << (20)),
...
static mut clk_branch ne_gcc_gpu_2_hscnoc_gfx_clk = {
	halt_reg: 0x34014,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x34014,
	hwcg_bit: 1,
...
static mut clk_branch ne_gcc_gpu_2_smmu_vote_clk = {
	halt_reg: 0x57028,
	halt_check: BRANCH_HALT_VOTED,
	clkr: {
		enable_reg: 0x57028,
...
static mut clk_branch ne_gcc_qupv3_wrap2_core_2x_clk = {
	halt_reg: 0x38020,
	halt_check: BRANCH_HALT_VOTED,
	clkr: {
		enable_reg: 0x57008,
...
static mut clk_branch ne_gcc_qupv3_wrap2_core_clk = {
	halt_reg: 0x3800c,
	halt_check: BRANCH_HALT_VOTED,
	clkr: {
		enable_reg: 0x57008,
...
static mut clk_branch ne_gcc_qupv3_wrap2_m_ahb_clk = {
	halt_reg: 0x38004,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x38004,
	hwcg_bit: 1,
...
static mut clk_branch ne_gcc_qupv3_wrap2_s0_clk = {
	halt_reg: 0x3815c,
	halt_check: BRANCH_HALT_VOTED,
	clkr: {
		enable_reg: 0x57008,
...
static mut clk_branch ne_gcc_qupv3_wrap2_s1_clk = {
	halt_reg: 0x38298,
	halt_check: BRANCH_HALT_VOTED,
	clkr: {
		enable_reg: 0x57008,
...
static mut clk_branch ne_gcc_qupv3_wrap2_s2_clk = {
	halt_reg: 0x383d4,
	halt_check: BRANCH_HALT_VOTED,
	clkr: {
		enable_reg: 0x57008,
...
static mut clk_branch ne_gcc_qupv3_wrap2_s3_clk = {
	halt_reg: 0x38510,
	halt_check: BRANCH_HALT_VOTED,
	clkr: {
		enable_reg: 0x57008,
...
static mut clk_branch ne_gcc_qupv3_wrap2_s4_clk = {
	halt_reg: 0x3864c,
	halt_check: BRANCH_HALT_VOTED,
	clkr: {
		enable_reg: 0x57008,
...
static mut clk_branch ne_gcc_qupv3_wrap2_s5_clk = {
	halt_reg: 0x38788,
	halt_check: BRANCH_HALT_VOTED,
	clkr: {
		enable_reg: 0x57008,
...
static mut clk_branch ne_gcc_qupv3_wrap2_s6_clk = {
	halt_reg: 0x388c4,
	halt_check: BRANCH_HALT_VOTED,
	clkr: {
		enable_reg: 0x57008,
...
static mut clk_branch ne_gcc_qupv3_wrap2_s_ahb_clk = {
	halt_reg: 0x38008,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x38008,
	hwcg_bit: 1,
...
static mut clk_branch ne_gcc_sdcc4_apps_clk = {
	halt_reg: 0x18004,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x18004,
...
static mut clk_branch ne_gcc_sdcc4_axi_clk = {
	halt_reg: 0x18014,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x18014,
...
static mut clk_branch ne_gcc_ufs_phy_ahb_clk = {
	halt_reg: 0x33028,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x33028,
	hwcg_bit: 1,
...
static mut clk_branch ne_gcc_ufs_phy_axi_clk = {
	halt_reg: 0x33018,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x33018,
	hwcg_bit: 1,
...
static mut clk_branch ne_gcc_ufs_phy_ice_core_clk = {
	halt_reg: 0x3307c,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x3307c,
	hwcg_bit: 1,
...
static mut clk_branch ne_gcc_ufs_phy_phy_aux_clk = {
	halt_reg: 0x330bc,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x330bc,
	hwcg_bit: 1,
...
static mut clk_branch ne_gcc_ufs_phy_rx_symbol_0_clk = {
	halt_reg: 0x33030,
	halt_check: BRANCH_HALT_DELAY,
	clkr: {
		enable_reg: 0x33030,
...
static mut clk_branch ne_gcc_ufs_phy_rx_symbol_1_clk = {
	halt_reg: 0x330d8,
	halt_check: BRANCH_HALT_DELAY,
	clkr: {
		enable_reg: 0x330d8,
...
static mut clk_branch ne_gcc_ufs_phy_tx_symbol_0_clk = {
	halt_reg: 0x3302c,
	halt_check: BRANCH_HALT_DELAY,
	clkr: {
		enable_reg: 0x3302c,
...
static mut clk_branch ne_gcc_ufs_phy_unipro_core_clk = {
	halt_reg: 0x3306c,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x3306c,
	hwcg_bit: 1,
...
static mut clk_branch ne_gcc_usb20_master_clk = {
	halt_reg: 0x31018,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x31018,
...
static mut clk_branch ne_gcc_usb20_mock_utmi_clk = {
	halt_reg: 0x3102c,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x3102c,
...
static mut clk_branch ne_gcc_usb20_sleep_clk = {
	halt_reg: 0x31028,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x31028,
...
static mut clk_branch ne_gcc_usb31_prim_atb_clk = {
	halt_reg: 0x2a018,
	halt_check: BRANCH_HALT_VOTED,
	clkr: {
		enable_reg: 0x2a018,
...
static mut clk_branch ne_gcc_usb31_prim_eud_ahb_clk = {
	halt_reg: 0x2a02c,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x2a02c,
	hwcg_bit: 1,
...
static mut clk_branch ne_gcc_usb31_prim_master_clk = {
	halt_reg: 0x2a01c,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x2a01c,
...
static mut clk_branch ne_gcc_usb31_prim_mock_utmi_clk = {
	halt_reg: 0x2a034,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x2a034,
...
static mut clk_branch ne_gcc_usb31_prim_sleep_clk = {
	halt_reg: 0x2a030,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x2a030,
...
static mut clk_branch ne_gcc_usb31_sec_atb_clk = {
	halt_reg: 0x2c018,
	halt_check: BRANCH_HALT_VOTED,
	clkr: {
		enable_reg: 0x2c018,
...
static mut clk_branch ne_gcc_usb31_sec_eud_ahb_clk = {
	halt_reg: 0x2c02c,
	halt_check: BRANCH_HALT_VOTED,
	hwcg_reg: 0x2c02c,
	hwcg_bit: 1,
...
static mut clk_branch ne_gcc_usb31_sec_master_clk = {
	halt_reg: 0x2c01c,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x2c01c,
...
static mut clk_branch ne_gcc_usb31_sec_mock_utmi_clk = {
	halt_reg: 0x2c034,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x2c034,
...
static mut clk_branch ne_gcc_usb31_sec_sleep_clk = {
	halt_reg: 0x2c030,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x2c030,
...
static mut clk_branch ne_gcc_usb3_prim_phy_aux_clk = {
	halt_reg: 0x2a06c,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x2a06c,
...
static mut clk_branch ne_gcc_usb3_prim_phy_com_aux_clk = {
	halt_reg: 0x2a070,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x2a070,
...
static mut clk_branch ne_gcc_usb3_prim_phy_pipe_clk = {
	halt_reg: 0x2a074,
...
static mut clk_branch ne_gcc_usb3_sec_phy_aux_clk = {
	halt_reg: 0x2c06c,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x2c06c,
...
static mut clk_branch ne_gcc_usb3_sec_phy_com_aux_clk = {
	halt_reg: 0x2c070,
	halt_check: BRANCH_HALT,
	clkr: {
		enable_reg: 0x2c070,
...
static mut clk_branch ne_gcc_usb3_sec_phy_pipe_clk = {
	halt_reg: 0x2c074,
	halt_check: BRANCH_HALT_SKIP,
	hwcg_reg: 0x2c074,
	hwcg_bit: 1,
...
static mut gdsc ne_gcc_ufs_mem_phy_gdsc = {
	gdscr: 0x32000,
...
static mut gdsc ne_gcc_ufs_phy_gdsc = {
	gdscr: 0x33004,
	en_rest_wait_val: 0x2,
	en_few_wait_val: 0x2,
...
static mut gdsc ne_gcc_usb20_prim_gdsc = {
	gdscr: 0x31004,
	en_rest_wait_val: 0x2,
	en_few_wait_val: 0x2,
	clk_dis_wait_val: 0xf,
...
static mut gdsc ne_gcc_usb31_prim_gdsc = {
	gdscr: 0x2a004,
	en_rest_wait_val: 0x2,
	en_few_wait_val: 0x2,
	clk_dis_wait_val: 0xf,
...
static mut gdsc ne_gcc_usb31_sec_gdsc = {
	gdscr: 0x2c004,
	en_rest_wait_val: 0x2,
	en_few_wait_val: 0x2,
	clk_dis_wait_val: 0xf,
...
static mut gdsc ne_gcc_usb3_phy_gdsc = {
	gdscr: 0x2b00c,
	en_rest_wait_val: 0x2,
	en_few_wait_val: 0x2,
	clk_dis_wait_val: 0x2,
...
static mut gdsc ne_gcc_usb3_sec_phy_gdsc = {
	gdscr: 0x2d00c,
	en_rest_wait_val: 0x2,
	en_few_wait_val: 0x2,
	clk_dis_wait_val: 0x2,
...
static mut clk_regmap *ne_gcc_nord_clocks[] = {
...
static mut gdsc *ne_gcc_nord_gdscs[] = {
...
static mut qcom_reset_map ne_gcc_nord_resets[] = {
...
static mut clk_rcg_dfs_data ne_gcc_nord_dfs_clocks[] = {
...
static mut regmap_config ne_gcc_nord_regmap_config = {
	reg_bits: 32,
	reg_stride: 4,
	val_bits: 32,
...
static mut void clk_nord_regs_configure(device *dev, regmap *regmap)
{
...
static mut u32 ne_gcc_nord_critical_cbcrs[] = {
	0x34004, /* NE_GCC_GPU_2_CFG_CLK */
};

static mut qcom_cc_driver_data ne_gcc_nord_driver_data = {
	dfs_rcgs: ne_gcc_nord_dfs_clocks,
	num_dfs_rcgs: (ne_gcc_nord_dfs_clocks.len()),
	clk_regs_configure: clk_nord_regs_configure,
	clk_cbcrs: ne_gcc_nord_critical_cbcrs,
	num_clk_cbcrs: (ne_gcc_nord_critical_cbcrs.len()),
};

static mut qcom_cc_desc ne_gcc_nord_desc = {
	config: &ne_gcc_nord_regmap_config,
	clks: ne_gcc_nord_clocks,
	num_clks: (ne_gcc_nord_clocks.len()),
	resets: ne_gcc_nord_resets,
	num_resets: (ne_gcc_nord_resets.len()),
	gdscs: ne_gcc_nord_gdscs,
	num_gdscs: (ne_gcc_nord_gdscs.len()),
	driver_data: &ne_gcc_nord_driver_data,
};

static mut of_device_id ne_gcc_nord_match_table[] = {
	{ compatible: "qcom,nord-negcc" },
	{ }
};
MODULE_DEVICE_TABLE(of, ne_gcc_nord_match_table);

static mut int ne_gcc_nord_probe(platform_device *pdev)
{
	return qcom_cc_probe(pdev, &ne_gcc_nord_desc);
}

static mut platform_driver ne_gcc_nord_driver = {
