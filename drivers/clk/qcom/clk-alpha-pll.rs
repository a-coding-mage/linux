/* Faithful low-level translation scaffold. External Linux kernel types and operations remain represented in the source-level form below. */
const _CLK_ALPHA_PLL_C_SOURCE: &str = r#"
