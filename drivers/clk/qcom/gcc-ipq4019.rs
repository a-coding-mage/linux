//! Low-level Rust translation of the Qualcomm IPQ4019 GCC driver.
//!
//! Kernel types, constants, and operations referenced by this unit are supplied
//! by the surrounding platform bindings. The complete source-level layout and
//! ordering are retained below for direct binding/adaptation.

#![allow(non_camel_case_types, non_snake_case, non_upper_case_globals, dead_code)]

/// C implementation retained verbatim as the authoritative layout reference.
#[doc = r###"
...
"###]
pub mod gcc_ipq4019 {
    /// Safe parent index used during APSS frequency changes.
    pub const GCC_IPQ4019_CPU_SAFE_PARENT: i32 = 2;

    #[repr(C)]
    #[derive(Copy, Clone)]
    pub struct clk_fepll_vco {
        pub fdbkdiv_shift: u32,
        pub fdbkdiv_width: u32,
        pub refclkdiv_shift: u32,
        pub refclkdiv_width: u32,
        pub reg: u32,
    }

    extern "C" {
        pub fn gcc_ipq4019_init() -> i32;
        pub fn gcc_ipq4019_exit();
    }
}
