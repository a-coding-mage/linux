...
// Faithful low-level Rust representation of the SM8350 GCC implementation.
// Kernel-provided types, constants, macros, and operations remain external dependencies.
