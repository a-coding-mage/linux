//! Source-level Rust representation of the SM8150 CAM clock controller.
//! External kernel bindings and helper types are intentionally unresolved here.
pub const CAMCC_SM8150_SOURCE: &str = r###"
