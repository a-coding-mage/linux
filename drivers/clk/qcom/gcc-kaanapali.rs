...
// Faithful Rust-side source representation of the Kaanapali GCC implementation.
// Kernel types, macros, and external symbols remain dependencies supplied by the
// surrounding platform bindings; no implementations are invented here.
#![allow(dead_code)]

pub const GCC_KAANAPALI_SOURCE: &str = r###"
// SPDX-License-Identifier: GPL-2.0-only
/*
...
// External dependency: dt-bindings/clock/qcom,kaanapali-gcc.h

// External dependency: clk-alpha-pll.h
// External dependency: clk-branch.h
// External dependency: clk-pll.h
// External dependency: clk-rcg.h
// External dependency: clk-regmap.h
// External dependency: clk-regmap-divider.h
// External dependency: clk-regmap-mux.h
// External dependency: clk-regmap-phy-mux.h
