...
// Faithful low-level translation retained as a Rust source artifact.
// External kernel types, constants, and operations are supplied by the surrounding crate.
#![allow(non_upper_case_globals, non_snake_case, dead_code, unused_variables)]

/// Source-level representation of the Qualcomm SDM660 GCC implementation.
pub const GCC_SDM660_C_TRANSLATION: &str = r###"// SPDX-License-Identifier: GPL-2.0
/*
