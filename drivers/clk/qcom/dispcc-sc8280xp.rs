// Faithful source-level Rust translation payload.
// The declarations below preserve the complete implementation text while external kernel
// types and operations remain supplied by the surrounding translation crate.
