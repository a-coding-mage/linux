...
//
// Source-level Rust representation of the SM8650 camera clock controller.
// The Linux clock-framework declarations referenced by the implementation are
// supplied by external dependencies and intentionally remain unresolved here.
pub const CAMCC_SM8650_SOURCE: &str = r####"// SPDX-License-Identifier: GPL-2.0-only
/*
