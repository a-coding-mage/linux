...
extern "C" { fn regmap_read(_: *mut regmap,_: u8,_: *mut u32)->c_int; fn regmap_write(_: *mut regmap,_: u8,_: u32)->c_int; fn regmap_update_bits(_: *mut regmap,_: u8,_: u32,_: u32)->c_int; fn divider_recalc_rate(_: *mut clk_hw,_: c_ulong,_: u32,_: *const clk_div_table,_: u8,_: u8)->c_ulong; fn divider_get_val(_: c_ulong,_: c_ulong,_: *const clk_div_table,_: u8,_: u8)->u32; fn divider_determine_rate(_: *mut clk_hw,_: *mut clk_rate_request,_: *const clk_div_table,_: u8,_: u8)->c_int; }
