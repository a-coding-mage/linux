// Translated from clk-imx5.c; external kernel symbols are intentionally unresolved here.
...
const MX51_DPLL1_BASE: usize = 0x83f80000;
const MX51_DPLL2_BASE: usize = 0x83f84000;
const MX51_DPLL3_BASE: usize = 0x83f88000;

const MX53_DPLL1_BASE: usize = 0x63f80000;
const MX53_DPLL2_BASE: usize = 0x63f84000;
const MX53_DPLL3_BASE: usize = 0x63f88000;
const MX53_DPLL4_BASE: usize = 0x63f8c000;

const MXC_CCM_CCR: usize = (ccm_base + 0x00);
const MXC_CCM_CCDR: usize = (ccm_base + 0x04);
const MXC_CCM_CSR: usize = (ccm_base + 0x08);
const MXC_CCM_CCSR: usize = (ccm_base + 0x0c);
const MXC_CCM_CACRR: usize = (ccm_base + 0x10);
const MXC_CCM_CBCDR: usize = (ccm_base + 0x14);
const MXC_CCM_CBCMR: usize = (ccm_base + 0x18);
const MXC_CCM_CSCMR1: usize = (ccm_base + 0x1c);
const MXC_CCM_CSCMR2: usize = (ccm_base + 0x20);
const MXC_CCM_CSCDR1: usize = (ccm_base + 0x24);
const MXC_CCM_CS1CDR: usize = (ccm_base + 0x28);
const MXC_CCM_CS2CDR: usize = (ccm_base + 0x2c);
const MXC_CCM_CDCDR: usize = (ccm_base + 0x30);
const MXC_CCM_CHSCDR: usize = (ccm_base + 0x34);
const MXC_CCM_CSCDR2: usize = (ccm_base + 0x38);
const MXC_CCM_CSCDR3: usize = (ccm_base + 0x3c);
const MXC_CCM_CSCDR4: usize = (ccm_base + 0x40);
const MXC_CCM_CWDR: usize = (ccm_base + 0x44);
const MXC_CCM_CDHIPR: usize = (ccm_base + 0x48);
const MXC_CCM_CDCR: usize = (ccm_base + 0x4c);
const MXC_CCM_CTOR: usize = (ccm_base + 0x50);
const MXC_CCM_CLPCR: usize = (ccm_base + 0x54);
const MXC_CCM_CISR: usize = (ccm_base + 0x58);
const MXC_CCM_CIMR: usize = (ccm_base + 0x5c);
const MXC_CCM_CCOSR: usize = (ccm_base + 0x60);
const MXC_CCM_CGPR: usize = (ccm_base + 0x64);
const MXC_CCM_CCGR0: usize = (ccm_base + 0x68);
const MXC_CCM_CCGR1: usize = (ccm_base + 0x6c);
const MXC_CCM_CCGR2: usize = (ccm_base + 0x70);
const MXC_CCM_CCGR3: usize = (ccm_base + 0x74);
const MXC_CCM_CCGR4: usize = (ccm_base + 0x78);
const MXC_CCM_CCGR5: usize = (ccm_base + 0x7c);
const MXC_CCM_CCGR6: usize = (ccm_base + 0x80);
const MXC_CCM_CCGR7: usize = (ccm_base + 0x84);
...
unsafe fn mx5_clocks_common_init(*mut core::ffi::c_voidccm_base)
{
	...
	clk[IMX5_CLK_PER_LP_APM]	= imx_clk_mux("per_lp_apm", MXC_CCM_CBCMR, 1, 1,
						per_lp_apm_sel, per_lp_apm_sel.len());
	...
	clk[IMX5_CLK_UART_SEL]		= imx_clk_mux("uart_sel", MXC_CCM_CSCMR1, 24, 2,
						standard_pll_sel, standard_pll_sel.len());
	...
	clk[IMX5_CLK_USB_PHY_SEL]	= imx_clk_mux("usb_phy_sel", MXC_CCM_CSCMR1, 26, 1,
						usb_phy_sel_str, usb_phy_sel_str.len());
	clk[IMX5_CLK_STEP_SEL]		= imx_clk_mux("step_sel", MXC_CCM_CCSR, 7, 2, step_sels, step_sels.len());
	clk[IMX5_CLK_CPU_PODF_SEL]	= imx_clk_mux("cpu_podf_sel", MXC_CCM_CCSR, 2, 1, cpu_podf_sels, cpu_podf_sels.len());
	...
	clk[IMX5_CLK_IPU_SEL]		= imx_clk_mux("ipu_sel", MXC_CCM_CBCMR, 6, 2, ipu_sel, ipu_sel.len());
	...
	clk[IMX5_CLK_GPU3D_SEL]		= imx_clk_mux("gpu3d_sel", MXC_CCM_CBCMR, 4, 2, gpu3d_sel, gpu3d_sel.len());
	clk[IMX5_CLK_GPU2D_SEL]		= imx_clk_mux("gpu2d_sel", MXC_CCM_CBCMR, 16, 2, gpu2d_sel, gpu2d_sel.len());
	...
	clk[IMX5_CLK_VPU_SEL]		= imx_clk_mux("vpu_sel", MXC_CCM_CBCMR, 14, 2, vpu_sel, vpu_sel.len());
	clk[IMX5_CLK_VPU_GATE]		= imx_clk_gate2("vpu_gate", "vpu_sel", MXC_CCM_CCGR5, 6);
	clk[IMX5_CLK_VPU_REFERENCE_GATE] = imx_clk_gate2("vpu_reference_gate", "osc", MXC_CCM_CCGR5, 8);
	clk[IMX5_CLK_GPC_DVFS]		= imx_clk_gate2_flags("gpc_dvfs", "dummy", MXC_CCM_CCGR5, 24, CLK_IS_CRITICAL);

	clk[IMX5_CLK_SSI_APM]		= imx_clk_mux("ssi_apm", MXC_CCM_CSCMR1, 8, 2, ssi_apm_sels, ssi_apm_sels.len());
	clk[IMX5_CLK_SSI1_ROOT_SEL]	= imx_clk_mux("ssi1_root_sel", MXC_CCM_CSCMR1, 14, 2, ssi_clk_sels, ssi_clk_sels.len());
	clk[IMX5_CLK_SSI2_ROOT_SEL]	= imx_clk_mux("ssi2_root_sel", MXC_CCM_CSCMR1, 12, 2, ssi_clk_sels, ssi_clk_sels.len());
	clk[IMX5_CLK_SSI3_ROOT_SEL]	= imx_clk_mux("ssi3_root_sel", MXC_CCM_CSCMR1, 11, 1, ssi3_clk_sels, ssi3_clk_sels.len());
	clk[IMX5_CLK_SSI_EXT1_SEL]	= imx_clk_mux("ssi_ext1_sel", MXC_CCM_CSCMR1, 28, 2, ssi_clk_sels, ssi_clk_sels.len());
	clk[IMX5_CLK_SSI_EXT2_SEL]	= imx_clk_mux("ssi_ext2_sel", MXC_CCM_CSCMR1, 30, 2, ssi_clk_sels, ssi_clk_sels.len());
	clk[IMX5_CLK_SSI_EXT1_COM_SEL]	= imx_clk_mux("ssi_ext1_com_sel", MXC_CCM_CSCMR1, 0, 1, ssi_ext1_com_sels, ssi_ext1_com_sels.len());
	clk[IMX5_CLK_SSI_EXT2_COM_SEL]	= imx_clk_mux("ssi_ext2_com_sel", MXC_CCM_CSCMR1, 1, 1, ssi_ext2_com_sels, ssi_ext2_com_sels.len());
	...
	clk[IMX5_CLK_SPDIF0_SEL]	= imx_clk_mux("spdif0_sel", MXC_CCM_CSCMR2, 0, 2, spdif_sel, spdif_sel.len());
	...
	clk[IMX5_CLK_SPDIF0_COM_SEL]	= imx_clk_mux_flags("spdif0_com_sel", MXC_CCM_CSCMR2, 4, 1,
						spdif0_com_sel, spdif0_com_sel.len(), CLK_SET_RATE_PARENT);
	...
	clk_register_clkdev(clk[IMX5_CLK_CPU_PODF], core::ptr::null_mut(), "cpu0");
	clk_register_clkdev(clk[IMX5_CLK_GPC_DVFS], "gpc_dvfs", core::ptr::null_mut());

	/* move usb phy clk to 24MHz */
	clk_set_parent(clk[IMX5_CLK_USB_PHY_SEL], clk[IMX5_CLK_OSC]);
}

unsafe fn mx50_clocks_init(DeviceNode *np)
{
	...
	*mut core::ffi::c_voidpll_base;
	...
	clk[IMX5_CLK_ESDHC_B_SEL]	= imx_clk_mux("esdhc_b_sel", MXC_CCM_CSCMR1, 16, 2,
						standard_pll_sel, standard_pll_sel.len());
	clk[IMX5_CLK_ESDHC_C_SEL]	= imx_clk_mux("esdhc_c_sel", MXC_CCM_CSCMR1, 20, 1, esdhc_c_sel, esdhc_c_sel.len());
	clk[IMX5_CLK_ESDHC_D_SEL]	= imx_clk_mux("esdhc_d_sel", MXC_CCM_CSCMR1, 19, 1, esdhc_d_sel, esdhc_d_sel.len());
	...
	clk[IMX5_CLK_CKO1_SEL]		= imx_clk_mux("cko1_sel", MXC_CCM_CCOSR, 0, 4,
						mx53_cko1_sel, mx53_cko1_sel.len());
...
unsafe fn mx51_clocks_init(DeviceNode *np)
{
	*mut core::ffi::c_voidccm_base;
	*mut core::ffi::c_voidpll_base;
	u32 val;
	...
	clk[IMX5_CLK_ESDHC_B_SEL]	= imx_clk_mux("esdhc_b_sel", MXC_CCM_CSCMR1, 16, 2,
						standard_pll_sel, standard_pll_sel.len());
	clk[IMX5_CLK_ESDHC_C_SEL]	= imx_clk_mux("esdhc_c_sel", MXC_CCM_CSCMR1, 19, 1, esdhc_c_sel, esdhc_c_sel.len());
	clk[IMX5_CLK_ESDHC_D_SEL]	= imx_clk_mux("esdhc_d_sel", MXC_CCM_CSCMR1, 18, 1, esdhc_d_sel, esdhc_d_sel.len());
	clk[IMX5_CLK_ESDHC1_PER_GATE]	= imx_clk_gate2("esdhc1_per_gate", "esdhc_a_podf", MXC_CCM_CCGR3, 2);
	...
	clk[IMX5_CLK_SPDIF_XTAL_SEL]	= imx_clk_mux("spdif_xtal_sel", MXC_CCM_CSCMR1, 2, 2,
						mx51_spdif_xtal_sel, mx51_spdif_xtal_sel.len());
	clk[IMX5_CLK_SPDIF1_SEL]	= imx_clk_mux("spdif1_sel", MXC_CCM_CSCMR2, 2, 2,
						spdif_sel, spdif_sel.len());
	...
	clk[IMX5_CLK_SPDIF1_COM_SEL]	= imx_clk_mux("spdif1_com_sel", MXC_CCM_CSCMR2, 5, 1,
						mx51_spdif1_com_sel, mx51_spdif1_com_sel.len());
...
unsafe fn mx53_clocks_init(DeviceNode *np)
{
	*mut core::ffi::c_voidccm_base;
	*mut core::ffi::c_voidpll_base;
	unsigned long r;
	...
	clk[IMX5_CLK_LDB_DI1_SEL]	= imx_clk_mux_flags("ldb_di1_sel", MXC_CCM_CSCMR2, 9, 1,
						mx53_ldb_di1_sel, mx53_ldb_di1_sel.len(), CLK_SET_RATE_PARENT);
	...
	clk[IMX5_CLK_LDB_DI0_SEL]	= imx_clk_mux_flags("ldb_di0_sel", MXC_CCM_CSCMR2, 8, 1,
						mx53_ldb_di0_sel, mx53_ldb_di0_sel.len(), CLK_SET_RATE_PARENT);
	clk[IMX5_CLK_LDB_DI0_GATE]	= imx_clk_gate2("ldb_di0_gate", "ldb_di0_div", MXC_CCM_CCGR6, 28);
	clk[IMX5_CLK_LDB_DI1_GATE]	= imx_clk_gate2("ldb_di1_gate", "ldb_di1_div", MXC_CCM_CCGR6, 30);
	clk[IMX5_CLK_IPU_DI0_SEL]	= imx_clk_mux_flags("ipu_di0_sel", MXC_CCM_CSCMR2, 26, 3,
						mx53_ipu_di0_sel, mx53_ipu_di0_sel.len(), CLK_SET_RATE_PARENT);
	clk[IMX5_CLK_IPU_DI1_SEL]	= imx_clk_mux_flags("ipu_di1_sel", MXC_CCM_CSCMR2, 29, 3,
						mx53_ipu_di1_sel, mx53_ipu_di1_sel.len(), CLK_SET_RATE_PARENT);
	clk[IMX5_CLK_TVE_EXT_SEL]	= imx_clk_mux_flags("tve_ext_sel", MXC_CCM_CSCMR1, 6, 1,
						mx53_tve_ext_sel, mx53_tve_ext_sel.len(), CLK_SET_RATE_PARENT);
	...
	clk[IMX5_CLK_IEEE1588_SEL]	= imx_clk_mux("ieee1588_sel", MXC_CCM_CSCMR2, 14, 2,
						ieee1588_sels, ieee1588_sels.len());
	...
	clk[IMX5_CLK_CKO2]		= imx_clk_gate2("cko2", "cko2_podf", MXC_CCM_CCOSR, 24);
	clk[IMX5_CLK_SPDIF_XTAL_SEL]	= imx_clk_mux("spdif_xtal_sel", MXC_CCM_CSCMR1, 2, 2,
						mx53_spdif_xtal_sel, mx53_spdif_xtal_sel.len());
