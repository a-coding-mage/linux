...
// Direct Rust translation; kernel-provided declarations remain external dependencies.
...
type ClkOnecellData = core::ffi::c_void;
type SyscoreOps = core::ffi::c_void;
type Syscore = core::ffi::c_void;
#[repr(C)] #[derive(Copy, Clone, Default)] struct ClkDivTable { val: u32, div: u32 }

extern "C" { fn is_err<T>(p: *mut T) -> bool; }
...
unsafe fn __iomem *anatop_base;
unsafe fn __iomem *ccm_base;
...
unsafe fn vf610_clk_suspend(void *data)
{
	int i;
...
unsafe fn vf610_clk_resume(void *data)
{
	int i;
