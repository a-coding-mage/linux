...
//
// Faithful source-level Rust translation retained below. Kernel symbols and
// types supplied by other translation units remain external dependencies.
// C-only preprocessor include directives have been removed.
const _IMX7D_SOURCE_TRANSLATION: &str = r###"
// SPDX-License-Identifier: GPL-2.0-or-later
/*
