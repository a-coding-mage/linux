// C includes are represented as dependency comments; external kernel symbols remain unresolved by design.
...
static mut share_count_nand: u32 = 0;
static mut share_count_media: u32 = 0;
static mut share_count_usb: u32 = 0;
...
static video_pll1_bypass_sels: [&'static str; 2] = ["video_pll1", "video_pll1_ref_sel"];
...
static vpu_pll_bypass_sels: [&'static str; 2] = ["vpu_pll", "vpu_pll_ref_sel"];
static arm_pll_bypass_sels: [&'static str; 2] = ["arm_pll", "arm_pll_ref_sel"];
static sys_pll1_bypass_sels: [&'static str; 2] = ["sys_pll1", "sys_pll1_ref_sel"];
static sys_pll2_bypass_sels: [&'static str; 2] = ["sys_pll2", "sys_pll2_ref_sel"];
static sys_pll3_bypass_sels: [&'static str; 2] = ["sys_pll3", "sys_pll3_ref_sel"];

static imx8mp_a53_sels: [&'static str; 8] = ["osc_24m", "arm_pll_out", "sys_pll2_500m", "sys_pll2_1000m", "sys_pll1_800m", "sys_pll1_400m", "audio_pll1_out", "sys_pll3_out"];

static imx8mp_a53_core_sels: [&'static str; 2] = ["arm_a53_div", "arm_pll_out"];

static imx8mp_m7_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_200m", "sys_pll2_250m", "vpu_pll_out", "sys_pll1_800m", "audio_pll1_out", "video_pll1_out", "sys_pll3_out"];

static imx8mp_ml_sels: [&'static str; 8] = ["osc_24m", "gpu_pll_out", "sys_pll1_800m", "sys_pll3_out", "sys_pll2_1000m", "audio_pll1_out", "video_pll1_out", "audio_pll2_out"];

static imx8mp_gpu3d_core_sels: [&'static str; 8] = ["osc_24m", "gpu_pll_out", "sys_pll1_800m", "sys_pll3_out", "sys_pll2_1000m", "audio_pll1_out", "video_pll1_out", "audio_pll2_out"];

static imx8mp_gpu3d_shader_sels: [&'static str; 8] = ["osc_24m", "gpu_pll_out", "sys_pll1_800m", "sys_pll3_out", "sys_pll2_1000m", "audio_pll1_out", "video_pll1_out", "audio_pll2_out"];

static imx8mp_gpu2d_sels: [&'static str; 8] = ["osc_24m", "gpu_pll_out", "sys_pll1_800m", "sys_pll3_out", "sys_pll2_1000m", "audio_pll1_out", "video_pll1_out", "audio_pll2_out"];

static imx8mp_audio_axi_sels: [&'static str; 8] = ["osc_24m", "gpu_pll_out", "sys_pll1_800m", "sys_pll3_out", "sys_pll2_1000m", "audio_pll1_out", "video_pll1_out", "audio_pll2_out"];

static imx8mp_hsio_axi_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_500m", "sys_pll1_800m", "sys_pll2_100m", "sys_pll2_200m", "clk_ext2", "clk_ext4", "audio_pll2_out"];

static imx8mp_media_isp_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_1000m", "sys_pll1_800m", "sys_pll3_out", "sys_pll1_400m", "audio_pll2_out", "clk_ext1", "sys_pll2_500m"];

static imx8mp_main_axi_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_333m", "sys_pll1_800m", "sys_pll2_250m", "sys_pll2_1000m", "audio_pll1_out", "video_pll1_out", "sys_pll1_100m"];

static imx8mp_enet_axi_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_266m", "sys_pll1_800m", "sys_pll2_250m", "sys_pll2_200m", "audio_pll1_out", "video_pll1_out", "sys_pll3_out"];

static imx8mp_nand_usdhc_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_266m", "sys_pll1_800m", "sys_pll2_200m", "sys_pll1_133m", "sys_pll3_out", "sys_pll2_250m", "audio_pll1_out"];

static imx8mp_vpu_bus_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_800m", "vpu_pll_out", "audio_pll2_out", "sys_pll3_out", "sys_pll2_1000m", "sys_pll2_200m", "sys_pll1_100m"];

static imx8mp_media_axi_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_1000m", "sys_pll1_800m", "sys_pll3_out", "sys_pll1_40m", "audio_pll2_out", "clk_ext1", "sys_pll2_500m"];

static imx8mp_media_apb_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_125m", "sys_pll1_800m", "sys_pll3_out", "sys_pll1_40m", "audio_pll2_out", "clk_ext1", "sys_pll1_133m"];

static imx8mp_gpu_axi_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_800m", "gpu_pll_out", "sys_pll3_out", "sys_pll2_1000m", "audio_pll1_out", "video_pll1_out", "audio_pll2_out"];

static imx8mp_gpu_ahb_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_800m", "gpu_pll_out", "sys_pll3_out", "sys_pll2_1000m", "audio_pll1_out", "video_pll1_out", "audio_pll2_out"];

static imx8mp_noc_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_800m", "sys_pll3_out", "sys_pll2_1000m", "sys_pll2_500m", "audio_pll1_out", "video_pll1_out", "audio_pll2_out"];

static imx8mp_noc_io_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_800m", "sys_pll3_out", "sys_pll2_1000m", "sys_pll2_500m", "audio_pll1_out", "video_pll1_out", "audio_pll2_out"];

static imx8mp_ml_axi_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_800m", "gpu_pll_out", "sys_pll3_out", "sys_pll2_1000m", "audio_pll1_out", "video_pll1_out", "audio_pll2_out"];

static imx8mp_ml_ahb_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_800m", "gpu_pll_out", "sys_pll3_out", "sys_pll2_1000m", "audio_pll1_out", "video_pll1_out", "audio_pll2_out"];

static imx8mp_ahb_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_133m", "sys_pll1_800m", "sys_pll1_400m", "sys_pll2_125m", "sys_pll3_out", "audio_pll1_out", "video_pll1_out"];

static imx8mp_audio_ahb_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_500m", "sys_pll1_800m", "sys_pll2_1000m", "sys_pll2_166m", "sys_pll3_out", "audio_pll1_out", "video_pll1_out"];

static imx8mp_mipi_dsi_esc_rx_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_100m", "sys_pll1_80m", "sys_pll1_800m", "sys_pll2_1000m", "sys_pll3_out", "clk_ext3", "audio_pll2_out"];

static imx8mp_dram_alt_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_800m", "sys_pll1_100m", "sys_pll2_500m", "sys_pll2_1000m", "sys_pll3_out", "audio_pll1_out", "sys_pll1_266m"];

static imx8mp_dram_apb_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_200m", "sys_pll1_40m", "sys_pll1_160m", "sys_pll1_800m", "sys_pll3_out", "sys_pll2_250m", "audio_pll2_out"];

static imx8mp_vpu_g1_sels: [&'static str; 8] = ["osc_24m", "vpu_pll_out", "sys_pll1_800m", "sys_pll2_1000m", "sys_pll1_100m", "sys_pll2_125m", "sys_pll3_out", "audio_pll1_out"];

static imx8mp_vpu_g2_sels: [&'static str; 8] = ["osc_24m", "vpu_pll_out", "sys_pll1_800m", "sys_pll2_1000m", "sys_pll1_100m", "sys_pll2_125m", "sys_pll3_out", "audio_pll1_out"];

static imx8mp_can1_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_200m", "sys_pll1_40m", "sys_pll1_160m", "sys_pll1_800m", "sys_pll3_out", "sys_pll2_250m", "audio_pll2_out"];

static imx8mp_can2_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_200m", "sys_pll1_40m", "sys_pll1_160m", "sys_pll1_800m", "sys_pll3_out", "sys_pll2_250m", "audio_pll2_out"];

static imx8mp_pcie_aux_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_200m", "sys_pll2_50m", "sys_pll3_out", "sys_pll2_100m", "sys_pll1_80m", "sys_pll1_160m", "sys_pll1_200m"];

static imx8mp_i2c5_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_160m", "sys_pll2_50m", "sys_pll3_out", "audio_pll1_out", "video_pll1_out", "audio_pll2_out", "sys_pll1_133m"];

static imx8mp_i2c6_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_160m", "sys_pll2_50m", "sys_pll3_out", "audio_pll1_out", "video_pll1_out", "audio_pll2_out", "sys_pll1_133m"];

static imx8mp_sai1_sels: [&'static str; 8] = ["osc_24m", "audio_pll1_out", "audio_pll2_out", "video_pll1_out", "sys_pll1_133m", "osc_hdmi", "clk_ext1", "clk_ext2"];

static imx8mp_sai2_sels: [&'static str; 8] = ["osc_24m", "audio_pll1_out", "audio_pll2_out", "video_pll1_out", "sys_pll1_133m", "osc_hdmi", "clk_ext2", "clk_ext3"];

static imx8mp_sai3_sels: [&'static str; 8] = ["osc_24m", "audio_pll1_out", "audio_pll2_out", "video_pll1_out", "sys_pll1_133m", "osc_hdmi", "clk_ext3", "clk_ext4"];

static imx8mp_sai5_sels: [&'static str; 8] = ["osc_24m", "audio_pll1_out", "audio_pll2_out", "video_pll1_out", "sys_pll1_133m", "osc_hdmi", "clk_ext2", "clk_ext3"];

static imx8mp_sai6_sels: [&'static str; 8] = ["osc_24m", "audio_pll1_out", "audio_pll2_out", "video_pll1_out", "sys_pll1_133m", "osc_hdmi", "clk_ext3", "clk_ext4"];

static imx8mp_enet_qos_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_125m", "sys_pll2_50m", "sys_pll2_100m", "sys_pll1_160m", "audio_pll1_out", "video_pll1_out", "clk_ext4"];

static imx8mp_enet_qos_timer_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_100m", "audio_pll1_out", "clk_ext1", "clk_ext2", "clk_ext3", "clk_ext4", "video_pll1_out"];

static imx8mp_enet_ref_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_125m", "sys_pll2_50m", "sys_pll2_100m", "sys_pll1_160m", "audio_pll1_out", "video_pll1_out", "clk_ext4"];

static imx8mp_enet_timer_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_100m", "audio_pll1_out", "clk_ext1", "clk_ext2", "clk_ext3", "clk_ext4", "video_pll1_out"];

static imx8mp_enet_phy_ref_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_50m", "sys_pll2_125m", "sys_pll2_200m", "sys_pll2_500m", "audio_pll1_out", "video_pll1_out", "audio_pll2_out"];

static imx8mp_nand_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_500m", "audio_pll1_out", "sys_pll1_400m", "audio_pll2_out", "sys_pll3_out", "sys_pll2_250m", "video_pll1_out"];

static imx8mp_qspi_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_400m", "sys_pll2_333m", "sys_pll2_500m", "audio_pll2_out", "sys_pll1_266m", "sys_pll3_out", "sys_pll1_100m"];

static imx8mp_usdhc1_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_400m", "sys_pll1_800m", "sys_pll2_500m", "sys_pll3_out", "sys_pll1_266m", "audio_pll2_out", "sys_pll1_100m"];

static imx8mp_usdhc2_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_400m", "sys_pll1_800m", "sys_pll2_500m", "sys_pll3_out", "sys_pll1_266m", "audio_pll2_out", "sys_pll1_100m"];

static imx8mp_i2c1_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_160m", "sys_pll2_50m", "sys_pll3_out", "audio_pll1_out", "video_pll1_out", "audio_pll2_out", "sys_pll1_133m"];

static imx8mp_i2c2_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_160m", "sys_pll2_50m", "sys_pll3_out", "audio_pll1_out", "video_pll1_out", "audio_pll2_out", "sys_pll1_133m"];

static imx8mp_i2c3_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_160m", "sys_pll2_50m", "sys_pll3_out", "audio_pll1_out", "video_pll1_out", "audio_pll2_out", "sys_pll1_133m"];

static imx8mp_i2c4_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_160m", "sys_pll2_50m", "sys_pll3_out", "audio_pll1_out", "video_pll1_out", "audio_pll2_out", "sys_pll1_133m"];

static imx8mp_uart1_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_80m", "sys_pll2_200m", "sys_pll2_100m", "sys_pll3_out", "clk_ext2", "clk_ext4", "audio_pll2_out"];

static imx8mp_uart2_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_80m", "sys_pll2_200m", "sys_pll2_100m", "sys_pll3_out", "clk_ext2", "clk_ext3", "audio_pll2_out"];

static imx8mp_uart3_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_80m", "sys_pll2_200m", "sys_pll2_100m", "sys_pll3_out", "clk_ext2", "clk_ext4", "audio_pll2_out"];

static imx8mp_uart4_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_80m", "sys_pll2_200m", "sys_pll2_100m", "sys_pll3_out", "clk_ext2", "clk_ext3", "audio_pll2_out"];

static imx8mp_usb_core_ref_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_100m", "sys_pll1_40m", "sys_pll2_100m", "sys_pll2_200m", "clk_ext2", "clk_ext3", "audio_pll2_out"];

static imx8mp_usb_phy_ref_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_100m", "sys_pll1_40m", "sys_pll2_100m", "sys_pll2_200m", "clk_ext2", "clk_ext3", "audio_pll2_out"];

static imx8mp_gic_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_200m", "sys_pll1_40m", "sys_pll2_100m", "sys_pll1_800m", "sys_pll2_500m", "clk_ext4", "audio_pll2_out"];

static imx8mp_ecspi1_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_200m", "sys_pll1_40m", "sys_pll1_160m", "sys_pll1_800m", "sys_pll3_out", "sys_pll2_250m", "audio_pll2_out"];

static imx8mp_ecspi2_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_200m", "sys_pll1_40m", "sys_pll1_160m", "sys_pll1_800m", "sys_pll3_out", "sys_pll2_250m", "audio_pll2_out"];

static imx8mp_pwm1_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_100m", "sys_pll1_160m", "sys_pll1_40m", "sys_pll3_out", "clk_ext1", "sys_pll1_80m", "video_pll1_out"];

static imx8mp_pwm2_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_100m", "sys_pll1_160m", "sys_pll1_40m", "sys_pll3_out", "clk_ext1", "sys_pll1_80m", "video_pll1_out"];

static imx8mp_pwm3_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_100m", "sys_pll1_160m", "sys_pll1_40m", "sys_pll3_out", "clk_ext2", "sys_pll1_80m", "video_pll1_out"];

static imx8mp_pwm4_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_100m", "sys_pll1_160m", "sys_pll1_40m", "sys_pll3_out", "clk_ext2", "sys_pll1_80m", "video_pll1_out"];

static imx8mp_gpt1_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_100m", "sys_pll1_400m", "sys_pll1_40m", "video_pll1_out", "sys_pll1_80m", "audio_pll1_out", "clk_ext1"];

static imx8mp_gpt2_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_100m", "sys_pll1_400m", "sys_pll1_40m", "video_pll1_out", "sys_pll1_80m", "audio_pll1_out", "clk_ext2"];

static imx8mp_gpt3_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_100m", "sys_pll1_400m", "sys_pll1_40m", "video_pll1_out", "sys_pll1_80m", "audio_pll1_out", "clk_ext3"];

static imx8mp_gpt4_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_100m", "sys_pll1_400m", "sys_pll1_40m", "video_pll1_out", "sys_pll1_80m", "audio_pll1_out", "clk_ext1"];

static imx8mp_gpt5_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_100m", "sys_pll1_400m", "sys_pll1_40m", "video_pll1_out", "sys_pll1_80m", "audio_pll1_out", "clk_ext2"];

static imx8mp_gpt6_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_100m", "sys_pll1_400m", "sys_pll1_40m", "video_pll1_out", "sys_pll1_80m", "audio_pll1_out", "clk_ext3"];

static imx8mp_wdog_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_133m", "sys_pll1_160m", "vpu_pll_out", "sys_pll2_125m", "sys_pll3_out", "sys_pll1_80m", "sys_pll2_166m"];

static imx8mp_wrclk_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_40m", "vpu_pll_out", "sys_pll3_out", "sys_pll2_200m", "sys_pll1_266m", "sys_pll2_500m", "sys_pll1_100m"];

static imx8mp_ipp_do_clko1_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_800m", "sys_pll1_133m", "sys_pll1_200m", "audio_pll2_out", "sys_pll2_500m", "vpu_pll_out", "sys_pll1_80m"];

static imx8mp_ipp_do_clko2_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_200m", "sys_pll1_400m", "sys_pll1_166m", "sys_pll3_out", "audio_pll1_out", "video_pll1_out", "osc_32k"];

static imx8mp_hdmi_fdcc_tst_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_266m", "sys_pll2_250m", "sys_pll1_800m", "sys_pll2_1000m", "sys_pll3_out", "audio_pll2_out", "video_pll1_out"];

static imx8mp_hdmi_24m_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_160m", "sys_pll2_50m", "sys_pll3_out", "audio_pll1_out", "video_pll1_out", "audio_pll2_out", "sys_pll1_133m"];

static imx8mp_hdmi_ref_266m_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_400m", "sys_pll3_out", "sys_pll2_333m", "sys_pll1_266m", "sys_pll2_200m", "audio_pll1_out", "video_pll1_out"];

static imx8mp_usdhc3_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_400m", "sys_pll1_800m", "sys_pll2_500m", "sys_pll3_out", "sys_pll1_266m", "audio_pll2_out", "sys_pll1_100m"];

static imx8mp_media_cam1_pix_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_266m", "sys_pll2_250m", "sys_pll1_800m", "sys_pll2_1000m", "sys_pll3_out", "audio_pll2_out", "video_pll1_out"];

static imx8mp_media_mipi_phy1_ref_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_333m", "sys_pll2_100m", "sys_pll1_800m", "sys_pll2_1000m", "clk_ext2", "audio_pll2_out", "video_pll1_out"];

static imx8mp_media_disp_pix_sels: [&'static str; 8] = ["osc_24m", "video_pll1_out", "audio_pll2_out", "audio_pll1_out", "sys_pll1_800m", "sys_pll2_1000m", "sys_pll3_out", "clk_ext4"];

static imx8mp_media_cam2_pix_sels: [&'static str; 8] = ["osc_24m", "sys_pll1_266m", "sys_pll2_250m", "sys_pll1_800m", "sys_pll2_1000m", "sys_pll3_out", "audio_pll2_out", "video_pll1_out"];

static imx8mp_media_ldb_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_333m", "sys_pll2_100m", "sys_pll1_800m", "sys_pll2_1000m", "clk_ext2", "audio_pll2_out", "video_pll1_out"];

static imx8mp_memrepair_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_100m", "sys_pll1_80m", "sys_pll1_800m", "sys_pll2_1000m", "sys_pll3_out", "clk_ext3", "audio_pll2_out"];

static imx8mp_media_mipi_test_byte_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_200m", "sys_pll2_50m", "sys_pll3_out", "sys_pll2_100m", "sys_pll1_80m", "sys_pll1_160m", "sys_pll1_200m"];

static imx8mp_ecspi3_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_200m", "sys_pll1_40m", "sys_pll1_160m", "sys_pll1_800m", "sys_pll3_out", "sys_pll2_250m", "audio_pll2_out"];

static imx8mp_pdm_sels: [&'static str; 8] = ["osc_24m", "sys_pll2_100m", "audio_pll1_out", "sys_pll1_800m", "sys_pll2_1000m", "sys_pll3_out", "clk_ext3", "audio_pll2_out"];

static imx8mp_vpu_vc8000e_sels: [&'static str; 8] = ["osc_24m", "vpu_pll_out", "sys_pll1_800m", "sys_pll2_1000m", "audio_pll2_out", "sys_pll2_125m", "sys_pll3_out", "audio_pll1_out"];

static imx8mp_sai7_sels: [&'static str; 8] = ["osc_24m", "audio_pll1_out", "audio_pll2_out", "video_pll1_out", "sys_pll1_133m", "osc_hdmi", "clk_ext3", "clk_ext4"];

static imx8mp_dram_core_sels: [&'static str; 2] = ["dram_pll_out", "dram_alt_root"];

static imx8mp_clkout_sels: [&'static str; 16] = ["audio_pll1_out", "audio_pll2_out", "video_pll1_out", "dummy", "dummy", "gpu_pll_out", "vpu_pll_out", "arm_pll_out", "sys_pll1_out", "sys_pll2_out", "sys_pll3_out", "dummy", "dummy", "osc_24m", "dummy", "osc_32k"];

static mut hws: *mut clk_hw;
static mut clk_hw_data: *mut clk_hw_onecell_data;

#[repr(C)]
struct imx8mp_clock_constraints { clkid: u32, maxrate: u32 }
 ...
 */
static imx8mp_clock_common_constraints: [imx8mp_clock_constraints; 0] = [
...
static imx8mp_clock_nominal_constraints: [imx8mp_clock_constraints; 0] = [
...
static imx8mp_clock_overdrive_constraints: [imx8mp_clock_constraints; 0] = [
...
unsafe fn imx8mp_clocks_apply_constraints(*const imx8mp_clock_constraints)
{
