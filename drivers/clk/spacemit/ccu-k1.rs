...
// Direct Rust translation; external kernel symbols and macros are supplied by dependencies.
// SPDX-License-Identifier: GPL-2.0-only
/*
...
// dependency: <linux/array_size.h>
// dependency: <linux/clk-provider.h>
// dependency: <linux/minmax.h>
// dependency: <linux/module.h>
// dependency: <linux/platform_device.h>
// dependency: <soc/spacemit/k1-syscon.h>

// dependency: "ccu_common.h"
// dependency: "ccu_pll.h"
// dependency: "ccu_mix.h"
// dependency: "ccu_ddn.h"

// dependency: <dt-bindings/clock/spacemit,k1-syscon.h>
...
static ssp_parents: &[clk_parent_data] = &[
...
static sspa0_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d384_6p4),
	CCU_PARENT_HW(pll1_d192_12p8),
	CCU_PARENT_HW(pll1_d96_25p6),
	CCU_PARENT_HW(pll1_d48_51p2),
...
static sspa1_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d384_6p4),
	CCU_PARENT_HW(pll1_d192_12p8),
	CCU_PARENT_HW(pll1_d96_25p6),
	CCU_PARENT_HW(pll1_d48_51p2),
...
/* APMU clocks start */
static pmua_aclk_parents: &[clk_parent_data] = &[
...
static cpu_c0_hi_clk_parents: &[clk_parent_data] = &[
...
static cpu_c1_hi_clk_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll3_d2),
	CCU_PARENT_HW(pll3_d1),
};
...
static jpg_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d4_614p4),
	CCU_PARENT_HW(pll1_d6_409p6),
	CCU_PARENT_HW(pll1_d5_491p52),
	CCU_PARENT_HW(pll1_d3_819p2),
...
static camm_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d8_307p2),
...
static isp_cpp_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d8_307p2),
	CCU_PARENT_HW(pll1_d6_409p6),
};
...
CCU_MUX_DIV_GATE_FC_DEFINE(isp_bus_clk, isp_bus_parents, APMU_ISP_CLK_RES_CTRL, 18, 3, BIT(23),
			   21, 2, BIT(17), 0);
static isp_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d6_409p6),
	CCU_PARENT_HW(pll1_d5_491p52),
	CCU_PARENT_HW(pll1_d4_614p4),
	CCU_PARENT_HW(pll1_d8_307p2),
...
static dpumclk_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d6_409p6),
	CCU_PARENT_HW(pll1_d5_491p52),
	CCU_PARENT_HW(pll1_d4_614p4),
	CCU_PARENT_HW(pll1_d8_307p2),
...
static dpuesc_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d48_51p2_ap),
...
static dpubit_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d3_819p2),
	CCU_PARENT_HW(pll2_d2),
	CCU_PARENT_HW(pll2_d3),
	CCU_PARENT_HW(pll1_d2_1228p8),
...
static dpupx_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d6_409p6),
	CCU_PARENT_HW(pll1_d5_491p52),
	CCU_PARENT_HW(pll1_d4_614p4),
	CCU_PARENT_HW(pll1_d8_307p2),
...
static dpu_spi_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d8_307p2),
	CCU_PARENT_HW(pll1_d6_409p6),
	CCU_PARENT_HW(pll1_d10_245p76),
...
static aes_parents: &[clk_parent_data] = &[
...
static emmc_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d6_409p6),
	CCU_PARENT_HW(pll1_d4_614p4),
	CCU_PARENT_HW(pll1_d52_47p26),
	CCU_PARENT_HW(pll1_d3_819p2),
...
static audio_parents: &[clk_parent_data] = &[
...
static hdmi_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d6_409p6),
	CCU_PARENT_HW(pll1_d5_491p52),
	CCU_PARENT_HW(pll1_d4_614p4),
	CCU_PARENT_HW(pll1_d8_307p2),
...
static mut k1_ccu_pll_hws: &[*mut clk_hw] = &[
...
static k1_ccu_pll_data: spacemit_ccu_data = spacemit_ccu_data {
	/* The PLL CCU implements no resets */
    hws: k1_ccu_pll_hws,
    num: (k1_ccu_pll_hws.len()),
};

static mut k1_ccu_mpmu_hws: &[*mut clk_hw] = &[
...
static k1_ccu_mpmu_data: spacemit_ccu_data = spacemit_ccu_data {
    reset_name: "k1-mpmu-reset",
    hws: k1_ccu_mpmu_hws,
    num: (k1_ccu_mpmu_hws.len()),
};

static mut k1_ccu_apbc_hws: &[*mut clk_hw] = &[
...
static k1_ccu_apbc_data: spacemit_ccu_data = spacemit_ccu_data {
    reset_name: "k1-apbc-reset",
    hws: k1_ccu_apbc_hws,
    num: (k1_ccu_apbc_hws.len()),
};

static mut k1_ccu_apmu_hws: &[*mut clk_hw] = &[
...
static k1_ccu_apmu_data: spacemit_ccu_data = spacemit_ccu_data {
    reset_name: "k1-apmu-reset",
    hws: k1_ccu_apmu_hws,
    num: (k1_ccu_apmu_hws.len()),
};

static k1_ccu_rcpu_data: spacemit_ccu_data = spacemit_ccu_data {
    reset_name: "k1-rcpu-reset",
};

static k1_ccu_rcpu2_data: spacemit_ccu_data = spacemit_ccu_data {
    reset_name: "k1-rcpu2-reset",
};

static k1_ccu_apbc2_data: spacemit_ccu_data = spacemit_ccu_data {
    reset_name: "k1-apbc2-reset",
};

static of_k1_ccu_match: &[of_device_id] = &[
	{
...
static mut k1_ccu_driver: platform_driver = platform_driver {
    driver: {
