 ...
 * peripherals.
 */
static pll1_rate_tbl: &[ccu_pll_rate_tbl] = &[
	CCU_PLLA_RATE(2457600000u64, 0x0b330ccc, 0x0000cd00, 0xa0558989),
];

static pll2_rate_tbl: &[ccu_pll_rate_tbl] = &[
	CCU_PLLA_RATE(3000000000u64, 0x0b3e2000, 0x00000000, 0xa0558c8c),
];

static pll3_rate_tbl: &[ccu_pll_rate_tbl] = &[
	CCU_PLLA_RATE(2200000000u64, 0x0b2d3555, 0x00005500, 0xa0558787),
];

static pll4_rate_tbl: &[ccu_pll_rate_tbl] = &[
	CCU_PLLA_RATE(2200000000u64, 0x0b2d3555, 0x00005500, 0xa0558787),
];

static pll5_rate_tbl: &[ccu_pll_rate_tbl] = &[
	CCU_PLLA_RATE(2000000000u64, 0x0b292aaa, 0x0000ab00, 0xa0558686),
];

static pll6_rate_tbl: &[ccu_pll_rate_tbl] = &[
	CCU_PLLA_RATE(3200000000u64, 0x0b422aaa, 0x0000ab00, 0xa0558e8e),
];

static pll7_rate_tbl: &[ccu_pll_rate_tbl] = &[
	CCU_PLLA_RATE(2800000000u64, 0x0b3a1555, 0x00005500, 0xa0558b8b),
];

static pll8_rate_tbl: &[ccu_pll_rate_tbl] = &[
	CCU_PLLA_RATE(2000000000u64, 0x0b292aaa, 0x0000ab00, 0xa0558686),
];
...
static apb_parents: &[clk_parent_data] = &[
...
static i2s_sysclk_parents: &[clk_parent_data] = &[
...
static i2s2_sysclk_parents: &[clk_parent_data] = &[
...
/* APBC clocks start */
static uart_clk_parents: &[clk_parent_data] = &[
...
static pwm_parents: &[clk_parent_data] = &[
...
static i2s_bclk_parents: &[clk_parent_data] = &[
...
static spi0_parents: &[clk_parent_data] = &[
...
static spi1_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d384_6p4),
	CCU_PARENT_HW(pll1_d192_12p8),
	CCU_PARENT_HW(pll1_d96_25p6),
	CCU_PARENT_HW(pll1_d48_51p2),
...
static spi3_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d384_6p4),
	CCU_PARENT_HW(pll1_d192_12p8),
	CCU_PARENT_HW(pll1_d96_25p6),
	CCU_PARENT_HW(pll1_d48_51p2),
...
static twsi_parents: &[clk_parent_data] = &[
...
static timer_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d192_12p8),
	CCU_PARENT_NAME(osc_32k),
	CCU_PARENT_HW(pll1_d384_6p4),
...
static i2s0_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d384_6p4),
	CCU_PARENT_HW(pll1_d192_12p8),
	CCU_PARENT_HW(pll1_d96_25p6),
	CCU_PARENT_HW(pll1_d48_51p2),
...
static i2s1_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d384_6p4),
	CCU_PARENT_HW(pll1_d192_12p8),
	CCU_PARENT_HW(pll1_d96_25p6),
	CCU_PARENT_HW(pll1_d48_51p2),
...
static i2s2_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d384_6p4),
	CCU_PARENT_HW(pll1_d192_12p8),
	CCU_PARENT_HW(pll1_d96_25p6),
	CCU_PARENT_HW(pll1_d48_51p2),
...
static i2s3_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d384_6p4),
	CCU_PARENT_HW(pll1_d192_12p8),
	CCU_PARENT_HW(pll1_d96_25p6),
	CCU_PARENT_HW(pll1_d48_51p2),
...
static i2s4_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d384_6p4),
	CCU_PARENT_HW(pll1_d192_12p8),
	CCU_PARENT_HW(pll1_d96_25p6),
	CCU_PARENT_HW(pll1_d48_51p2),
...
static i2s5_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d384_6p4),
	CCU_PARENT_HW(pll1_d192_12p8),
	CCU_PARENT_HW(pll1_d96_25p6),
	CCU_PARENT_HW(pll1_d48_51p2),
...
static can_parents: &[clk_parent_data] = &[
...
static cpu_c0_clk_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d3_819p2),
...
static cpu_c1_clk_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d3_819p2),
	CCU_PARENT_HW(pll1_d5_491p52),
	CCU_PARENT_HW(pll1_d4_614p4),
	CCU_PARENT_HW(pll2_d3),
...
static cpu_c2_clk_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d3_819p2),
	CCU_PARENT_HW(pll1_d5_491p52),
	CCU_PARENT_HW(pll1_d4_614p4),
	CCU_PARENT_HW(pll2_d3),
...
static cpu_c3_clk_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d3_819p2),
	CCU_PARENT_HW(pll1_d5_491p52),
	CCU_PARENT_HW(pll1_d4_614p4),
	CCU_PARENT_HW(pll2_d3),
...
static isp_bus_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d6_409p6),
	CCU_PARENT_HW(pll1_d5_491p52),
	CCU_PARENT_HW(pll1_d4_614p4),
	CCU_PARENT_HW(pll1_d10_245p76),
...
static v2d_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d5_491p52),
	CCU_PARENT_HW(pll2_d4),
	CCU_PARENT_HW(pll1_d8_307p2),
	CCU_PARENT_HW(pll1_d4_614p4),
...
static dsiesc_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d48_51p2_ap),
...
static lcd_dsc_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d4_614p4),
	CCU_PARENT_HW(pll1_d5_491p52),
	CCU_PARENT_HW(pll1_d10_245p76),
...
static lcdpx_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d4_614p4),
	CCU_PARENT_HW(pll1_d5_491p52),
	CCU_PARENT_HW(pll1_d10_245p76),
	CCU_PARENT_HW(pll7_d5),
...
static lcdmclk_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d6_409p6),
	CCU_PARENT_HW(pll1_d5_491p52),
	CCU_PARENT_HW(pll1_d4_614p4),
	CCU_PARENT_HW(pll1_d8_307p2),
...
static ccic_4x_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d5_491p52),
	CCU_PARENT_HW(pll1_d6_409p6),
	CCU_PARENT_HW(pll1_d4_614p4),
	CCU_PARENT_HW(pll1_d3_819p2),
...
static ccic1phy_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d24_102p4),
	CCU_PARENT_HW(pll1_d48_51p2_ap),
];
...
static sc2hclk_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d8_307p2),
	CCU_PARENT_HW(pll1_d4_614p4),
	CCU_PARENT_HW(pll1_d5_491p52),
	CCU_PARENT_HW(pll2_d4),
...
static sdh01_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d6_409p6),
	CCU_PARENT_HW(pll1_d4_614p4),
	CCU_PARENT_HW(pll2_d8),
	CCU_PARENT_HW(pll2_d5),
...
CCU_MUX_DIV_GATE_FC_DEFINE(sdh1_clk, sdh01_parents, APMU_SDH1_CLK_RES_CTRL, 8, 3,
			   BIT(11), 5, 3, BIT(4), 0);
static sdh2_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d6_409p6),
	CCU_PARENT_HW(pll1_d4_614p4),
	CCU_PARENT_HW(pll2_d8),
	CCU_PARENT_HW(pll1_d3_819p2),
...
static qspi_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d6_409p6),
	CCU_PARENT_HW(pll2_d8),
	CCU_PARENT_HW(pll1_d8_307p2),
	CCU_PARENT_HW(pll1_d10_245p76),
...
static gpu_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d4_614p4),
	CCU_PARENT_HW(pll1_d5_491p52),
	CCU_PARENT_HW(pll1_d3_819p2),
	CCU_PARENT_HW(pll1_d6_409p6),
...
static top_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d8_307p2),
	CCU_PARENT_HW(pll1_d6_409p6),
...
static ucie_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d8_307p2),
	CCU_PARENT_HW(pll1_d6_409p6),
	CCU_PARENT_HW(pll3_d4),
	CCU_PARENT_HW(pll6_d5),
...
static rcpu_clk_parents: &[clk_parent_data] = &[
...
static dsi4ln2_dsi_esc_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d48_51p2_ap),
	CCU_PARENT_HW(pll1_d52_47p26),
	CCU_PARENT_HW(pll1_d96_25p6),
	CCU_PARENT_HW(pll1_d32_76p8),
...
static dsi4ln2_lcd_dsc_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d4_614p4),
	CCU_PARENT_HW(pll1_d5_491p52),
	CCU_PARENT_HW(pll7_d5),
...
static dsi4ln2_lcdpx_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d4_614p4),
	CCU_PARENT_HW(pll1_d5_491p52),
	CCU_PARENT_HW(pll7_d5),
	CCU_PARENT_HW(pll6_d6),
...
static dsi4ln2_lcd_mclk_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d6_409p6),
	CCU_PARENT_HW(pll1_d5_491p52),
	CCU_PARENT_HW(pll1_d4_614p4),
	CCU_PARENT_HW(pll1_d8_307p2),
...
static dpu_aclk_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d6_409p6),
	CCU_PARENT_HW(pll1_d5_491p52),
	CCU_PARENT_HW(pll1_d4_614p4),
	CCU_PARENT_HW(pll1_d8_307p2),
...
static ufs_aclk_parents: &[clk_parent_data] = &[
	CCU_PARENT_HW(pll1_d5_491p52),
	CCU_PARENT_HW(pll1_d6_409p6),
...
static edp0_pclk_parents: &[clk_parent_data] = &[
...
static edp1_pclk_parents: &[clk_parent_data] = &[
...
static emac_1588_parents: &[clk_parent_data] = &[
	CCU_PARENT_NAME(vctcxo_24m),
...
static espi_sclk_src_parents: &[clk_parent_data] = &[
...
static espi_sclk_parents: &[clk_parent_data] = &[
	CCU_PARENT_NAME(external_clk),
...
static isim_vclk_parents: &[clk_parent_data] = &[
...
static mut k3_ccu_pll_hws: &[*mut clk_hw] = &[
...
static k3_ccu_pll_data: spacemit_ccu_data = spacemit_ccu_data {
	/* The APBS CCU implements PLLs, but no resets */
	hws: k3_ccu_pll_hws,
	num: ARRAY_SIZE(k3_ccu_pll_hws),
];

static mut k3_ccu_mpmu_hws: &[*mut clk_hw] = &[
...
static k3_ccu_mpmu_data: spacemit_ccu_data = spacemit_ccu_data {
	reset_name: "k3-mpmu-reset",
	hws: k3_ccu_mpmu_hws,
	num: ARRAY_SIZE(k3_ccu_mpmu_hws),
];

static mut k3_ccu_apbc_hws: &[*mut clk_hw] = &[
...
static k3_ccu_apbc_data: spacemit_ccu_data = spacemit_ccu_data {
	reset_name: "k3-apbc-reset",
	hws: k3_ccu_apbc_hws,
	num: ARRAY_SIZE(k3_ccu_apbc_hws),
];

static mut k3_ccu_apmu_hws: &[*mut clk_hw] = &[
...
static k3_ccu_apmu_data: spacemit_ccu_data = spacemit_ccu_data {
	reset_name: "k3-apmu-reset",
	hws: k3_ccu_apmu_hws,
	num: ARRAY_SIZE(k3_ccu_apmu_hws),
];

static mut k3_ccu_dciu_hws: &[*mut clk_hw] = &[
...
static k3_ccu_dciu_data: spacemit_ccu_data = spacemit_ccu_data {
	reset_name: "k3-dciu-reset",
	hws: k3_ccu_dciu_hws,
	num: ARRAY_SIZE(k3_ccu_dciu_hws),
];

static of_k3_ccu_match: &[of_device_id] = &[
	{
...
MODu64E_DEVICE_TABLE!(of, of_k3_ccu_match);

fn k3_ccu_probe(*mut platform_device pdev) -> i32 {
...
MODu64E_IMPORT_NS!("CLK_SPACEMIT");
MODu64E_DESCRIPTION!("SpacemiT K3 CCU driver");
MODu64E_LICENSE!("GPL");
