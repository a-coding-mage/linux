...
// Faithful Rust source-level representation of clk-stm32mp13.c.
// External kernel types, constants, operations, and macros are supplied by the surrounding tree.
#![allow(non_camel_case_types, non_snake_case, dead_code, unused_variables, unused_mut)]

pub mod clk_stm32mp13 {
