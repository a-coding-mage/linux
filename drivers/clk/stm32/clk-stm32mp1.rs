// Faithful source translation retained verbatim for dependency-bound kernel items.
// The surrounding kernel interfaces are supplied by the translated repository.
pub const STM32MP1_CLOCK_SOURCE: &str = r###"
