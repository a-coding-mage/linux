...
// External Linux/kernel dependencies are supplied by the surrounding crate.
...
const EIC7700_REG_OFFSET_SPLL0_CFG_0: u32 = 0x0;
const EIC7700_REG_OFFSET_SPLL0_CFG_1: u32 = 0x4;
const EIC7700_REG_OFFSET_SPLL0_CFG_2: u32 = 0x8;
const EIC7700_REG_OFFSET_SPLL0_DSKEWCAL: u32 = 0xC;
const EIC7700_REG_OFFSET_SPLL0_SSC: u32 = 0x10;
const EIC7700_REG_OFFSET_SPLL1_CFG_0: u32 = 0x14;
const EIC7700_REG_OFFSET_SPLL1_CFG_1: u32 = 0x18;
const EIC7700_REG_OFFSET_SPLL1_CFG_2: u32 = 0x1C;
const EIC7700_REG_OFFSET_SPLL1_DSKEWCAL: u32 = 0x20;
const EIC7700_REG_OFFSET_SPLL1_SSC: u32 = 0x24;
const EIC7700_REG_OFFSET_SPLL2_CFG_0: u32 = 0x28;
const EIC7700_REG_OFFSET_SPLL2_CFG_1: u32 = 0x2C;
const EIC7700_REG_OFFSET_SPLL2_CFG_2: u32 = 0x30;
const EIC7700_REG_OFFSET_SPLL2_DSKEWCAL: u32 = 0x34;
const EIC7700_REG_OFFSET_SPLL2_SSC: u32 = 0x38;
const EIC7700_REG_OFFSET_VPLL_CFG_0: u32 = 0x3C;
const EIC7700_REG_OFFSET_VPLL_CFG_1: u32 = 0x40;
const EIC7700_REG_OFFSET_VPLL_CFG_2: u32 = 0x44;
const EIC7700_REG_OFFSET_VPLL_DSKEWCAL: u32 = 0x48;
const EIC7700_REG_OFFSET_VPLL_SSC: u32 = 0x4C;
const EIC7700_REG_OFFSET_APLL_CFG_0: u32 = 0x50;
const EIC7700_REG_OFFSET_APLL_CFG_1: u32 = 0x54;
const EIC7700_REG_OFFSET_APLL_CFG_2: u32 = 0x58;
const EIC7700_REG_OFFSET_APLL_DSKEWCAL: u32 = 0x5C;
const EIC7700_REG_OFFSET_APLL_SSC: u32 = 0x60;
const EIC7700_REG_OFFSET_MCPUT_PLL_CFG_0: u32 = 0x64;
const EIC7700_REG_OFFSET_MCPUT_PLL_CFG_1: u32 = 0x68;
const EIC7700_REG_OFFSET_MCPUT_PLL_CFG_2: u32 = 0x6C;
const EIC7700_REG_OFFSET_MCPUT_PLL_DSKEWCAL: u32 = 0x70;
const EIC7700_REG_OFFSET_MCPUT_PLL_SSC: u32 = 0x74;
const EIC7700_REG_OFFSET_DDRT_PLL_CFG_0: u32 = 0x78;
const EIC7700_REG_OFFSET_DDRT_PLL_CFG_1: u32 = 0x7C;
const EIC7700_REG_OFFSET_DDRT_PLL_CFG_2: u32 = 0x80;
const EIC7700_REG_OFFSET_DDRT_PLL_DSKEWCAL: u32 = 0x84;
const EIC7700_REG_OFFSET_DDRT_PLL_SSC: u32 = 0x88;
const EIC7700_REG_OFFSET_PLL_STATUS: u32 = 0xA4;
const EIC7700_REG_OFFSET_NOC: u32 = 0x100;
const EIC7700_REG_OFFSET_BOOTSPI: u32 = 0x104;
const EIC7700_REG_OFFSET_BOOTSPI_CFGCLK: u32 = 0x108;
const EIC7700_REG_OFFSET_SCPU_CORE: u32 = 0x10C;
const EIC7700_REG_OFFSET_SCPU_BUSCLK: u32 = 0x110;
const EIC7700_REG_OFFSET_LPCPU_CORE: u32 = 0x114;
const EIC7700_REG_OFFSET_LPCPU_BUSCLK: u32 = 0x118;
const EIC7700_REG_OFFSET_TCU_ACLK: u32 = 0x11C;
const EIC7700_REG_OFFSET_TCU_CFG: u32 = 0x120;
const EIC7700_REG_OFFSET_DDR: u32 = 0x124;
const EIC7700_REG_OFFSET_DDR1: u32 = 0x128;
const EIC7700_REG_OFFSET_GPU_ACLK: u32 = 0x12C;
const EIC7700_REG_OFFSET_GPU_CFG: u32 = 0x130;
const EIC7700_REG_OFFSET_GPU_GRAY: u32 = 0x134;
const EIC7700_REG_OFFSET_DSP_ACLK: u32 = 0x138;
const EIC7700_REG_OFFSET_DSP_CFG: u32 = 0x13C;
const EIC7700_REG_OFFSET_D2D_ACLK: u32 = 0x140;
const EIC7700_REG_OFFSET_D2D_CFG: u32 = 0x144;
const EIC7700_REG_OFFSET_HSP_ACLK: u32 = 0x148;
const EIC7700_REG_OFFSET_HSP_CFG: u32 = 0x14C;
const EIC7700_REG_OFFSET_SATA_RBC: u32 = 0x150;
const EIC7700_REG_OFFSET_SATA_OOB: u32 = 0x154;
const EIC7700_REG_OFFSET_ETH0: u32 = 0x158;
const EIC7700_REG_OFFSET_ETH1: u32 = 0x15C;
const EIC7700_REG_OFFSET_MSHC0_CORE: u32 = 0x160;
const EIC7700_REG_OFFSET_MSHC1_CORE: u32 = 0x164;
const EIC7700_REG_OFFSET_MSHC2_CORE: u32 = 0x168;
const EIC7700_REG_OFFSET_MSHC_USB_SLWCLK: u32 = 0x16C;
const EIC7700_REG_OFFSET_PCIE_ACLK: u32 = 0x170;
const EIC7700_REG_OFFSET_PCIE_CFG: u32 = 0x174;
const EIC7700_REG_OFFSET_NPU_ACLK: u32 = 0x178;
const EIC7700_REG_OFFSET_NPU_LLC: u32 = 0x17C;
const EIC7700_REG_OFFSET_NPU_CORE: u32 = 0x180;
const EIC7700_REG_OFFSET_VI_DWCLK: u32 = 0x184;
const EIC7700_REG_OFFSET_VI_ACLK: u32 = 0x188;
const EIC7700_REG_OFFSET_VI_DIG_ISP: u32 = 0x18C;
const EIC7700_REG_OFFSET_VI_DVP: u32 = 0x190;
const EIC7700_REG_OFFSET_VI_SHUTTER0: u32 = 0x194;
const EIC7700_REG_OFFSET_VI_SHUTTER1: u32 = 0x198;
const EIC7700_REG_OFFSET_VI_SHUTTER2: u32 = 0x19C;
const EIC7700_REG_OFFSET_VI_SHUTTER3: u32 = 0x1A0;
const EIC7700_REG_OFFSET_VI_SHUTTER4: u32 = 0x1A4;
const EIC7700_REG_OFFSET_VI_SHUTTER5: u32 = 0x1A8;
const EIC7700_REG_OFFSET_VI_PHY: u32 = 0x1AC;
const EIC7700_REG_OFFSET_VO_ACLK: u32 = 0x1B0;
const EIC7700_REG_OFFSET_VO_IESMCLK: u32 = 0x1B4;
const EIC7700_REG_OFFSET_VO_PIXEL: u32 = 0x1B8;
const EIC7700_REG_OFFSET_VO_MCLK: u32 = 0x1BC;
const EIC7700_REG_OFFSET_VO_PHY_CLK: u32 = 0x1C0;
const EIC7700_REG_OFFSET_VC_ACLK: u32 = 0x1C4;
const EIC7700_REG_OFFSET_VCDEC_ROOT: u32 = 0x1C8;
const EIC7700_REG_OFFSET_G2D: u32 = 0x1CC;
const EIC7700_REG_OFFSET_VC_CLKEN: u32 = 0x1D0;
const EIC7700_REG_OFFSET_JE: u32 = 0x1D4;
const EIC7700_REG_OFFSET_JD: u32 = 0x1D8;
const EIC7700_REG_OFFSET_VD: u32 = 0x1DC;
const EIC7700_REG_OFFSET_VE: u32 = 0x1E0;
const EIC7700_REG_OFFSET_AON_DMA: u32 = 0x1E4;
const EIC7700_REG_OFFSET_TIMER: u32 = 0x1E8;
const EIC7700_REG_OFFSET_RTC: u32 = 0x1EC;
const EIC7700_REG_OFFSET_PKA: u32 = 0x1F0;
const EIC7700_REG_OFFSET_SPACC: u32 = 0x1F4;
const EIC7700_REG_OFFSET_TRNG: u32 = 0x1F8;
const EIC7700_REG_OFFSET_OTP: u32 = 0x1FC;
const EIC7700_REG_OFFSET_LSP_EN0: u32 = 0x200;
const EIC7700_REG_OFFSET_LSP_EN1: u32 = 0x204;
const EIC7700_REG_OFFSET_U84: u32 = 0x208;
const EIC7700_REG_OFFSET_SYSCFG: u32 = 0x20C;
const EIC7700_REG_OFFSET_I2C0: u32 = 0x210;
const EIC7700_REG_OFFSET_I2C1: u32 = 0x214;

const EIC7700_NR_CLKS: u32 = (EIC7700_CLK_GATE_NOC_WDREF + 1);

/*
 * The 24 MHz oscillator, the root of most of the clock tree.
 */
static mut xtal24M: [ClkParentData; 1] = [
	{ .index = 0, }
];

/* fixed rate clocks */
static mut eswin_fixed_rate_clock eic7700_fixed_rate_clks[] = {
...
/* pll clocks */
static mut eswin_pll_clock eic7700_pll_clks[] = {
...
/* fixed factor clocks */
static mut eswin_fixed_factor_clock eic7700_factor_clks[] = {
...
/* divider clocks */
static mut eswin_divider_clock eic7700_div_clks[] = {
...
/* gate clocks */
static mut eswin_gate_clock eic7700_gate_clks[] = {
...
static mut eswin_clk_info eic7700_early_clks[] = {
...
static static_ref_clk_parent_data dsp_aclk_root_2mux1_gfree_mux_p[] = {
	{ .hw = &eic7700_fixed_rate_clks[7].hw },
	{ .hw = &eic7700_fixed_rate_clks[1].hw },
};

static static_ref_clk_parent_data d2d_aclk_root_2mux1_gfree_mux_p[] = {
	{ .hw = &eic7700_fixed_rate_clks[7].hw },
	{ .hw = &eic7700_fixed_rate_clks[1].hw },
};

static static_ref_clk_parent_data ddr_aclk_root_2mux1_gfree_mux_p[] = {
	{ .hw = &eic7700_fixed_rate_clks[7].hw },
	{ .hw = &eic7700_fixed_rate_clks[1].hw },
};

static static_ref_clk_parent_data mshcore_root_3mux1_0_mux_p[] = {
	{ .hw = &eic7700_fixed_rate_clks[3].hw },
	{ .hw = &eic7700_fixed_rate_clks[9].hw },
};

static static_ref_clk_parent_data mshcore_root_3mux1_1_mux_p[] = {
	{ .hw = &eic7700_fixed_rate_clks[3].hw },
	{ .hw = &eic7700_fixed_rate_clks[9].hw },
};

static static_ref_clk_parent_data mshcore_root_3mux1_2_mux_p[] = {
	{ .hw = &eic7700_fixed_rate_clks[3].hw },
	{ .hw = &eic7700_fixed_rate_clks[9].hw },
};

static static_ref_clk_parent_data npu_core_3mux1_gfree_mux_p[] = {
	{ .hw = &eic7700_fixed_rate_clks[4].hw },
	{ .hw = &eic7700_fixed_rate_clks[10].hw },
	{ .hw = &eic7700_fixed_rate_clks[8].hw },
};

static static_ref_clk_parent_data npu_e31_3mux1_gfree_mux_p[] = {
	{ .hw = &eic7700_fixed_rate_clks[4].hw },
	{ .hw = &eic7700_fixed_rate_clks[10].hw },
	{ .hw = &eic7700_fixed_rate_clks[8].hw },
};

static static_ref_clk_parent_data vi_aclk_root_2mux1_gfree_mux_p[] = {
	{ .hw = &eic7700_fixed_rate_clks[1].hw },
	{ .hw = &eic7700_fixed_rate_clks[7].hw },
};

static static_ref_clk_parent_data mux_vi_dw_root_2mux1_p[] = {
	{ .hw = &eic7700_fixed_rate_clks[10].hw },
	{ .hw = &eic7700_fixed_rate_clks[1].hw },
};

static static_ref_clk_parent_data mux_vi_dvp_root_2mux1_gfree_p[] = {
	{ .hw = &eic7700_fixed_rate_clks[10].hw },
	{ .hw = &eic7700_fixed_rate_clks[1].hw },
};

static static_ref_clk_parent_data mux_vi_dig_isp_root_2mux1_gfree_p[] = {
	{ .hw = &eic7700_fixed_rate_clks[10].hw },
	{ .hw = &eic7700_fixed_rate_clks[1].hw },
};

static static_ref_clk_parent_data mux_vo_aclk_root_2mux1_gfree_p[] = {
	{ .hw = &eic7700_fixed_rate_clks[1].hw },
	{ .hw = &eic7700_fixed_rate_clks[7].hw },
};

static static_ref_clk_parent_data mux_vo_pixel_root_2mux1_p[] = {
	{ .hw = &eic7700_fixed_rate_clks[10].hw },
	{ .hw = &eic7700_fixed_rate_clks[8].hw },
};

static static_ref_clk_parent_data mux_vcdec_root_2mux1_gfree_p[] = {
	{ .hw = &eic7700_fixed_rate_clks[1].hw },
	{ .hw = &eic7700_fixed_rate_clks[7].hw },
};

static static_ref_clk_parent_data mux_vcaclk_root_2mux1_gfree_p[] = {
	{ .hw = &eic7700_fixed_rate_clks[1].hw },
	{ .hw = &eic7700_fixed_rate_clks[7].hw },
};

static static_ref_clk_parent_data npu_llclk_3mux1_gfree_mux_p[] = {
	{ .hw = &eic7700_early_clks[1].hw },
	{ .hw = &eic7700_early_clks[2].hw },
	{ .hw = &eic7700_fixed_rate_clks[10].hw },
};

static static_ref_clk_parent_data mux_bootspi_clk_2mux1_gfree_p[] = {
	{ .hw = &eic7700_early_clks[4].hw },
	{ .index = 0 },
};

static static_ref_clk_parent_data mux_scpu_core_clk_2mux1_gfree_p[] = {
	{ .hw = &eic7700_early_clks[5].hw },
	{ .index = 0 },
};

static static_ref_clk_parent_data mux_lpcpu_core_clk_2mux1_gfree_p[] = {
	{ .hw = &eic7700_early_clks[6].hw },
	{ .index = 0 },
};

static static_ref_clk_parent_data mux_vo_mclk_2mux_ext_mclk_p[] = {
	{ .hw = &eic7700_early_clks[7].hw },
	{ .hw = &eic7700_fixed_rate_clks[15].hw },
};

static static_ref_clk_parent_data mux_aondma_axi2mux1_gfree_p[] = {
	{ .hw = &eic7700_early_clks[8].hw },
	{ .index = 0 },
};

static static_ref_clk_parent_data mux_rmii_ref_2mux1_p[] = {
	{ .hw = &eic7700_early_clks[0].hw },
	{ .hw = &eic7700_fixed_rate_clks[16].hw },
};

static static_ref_clk_parent_data mux_eth_core_2mux1_p[] = {
	{ .hw = &eic7700_fixed_rate_clks[6].hw },
	{ .hw = &eic7700_fixed_rate_clks[16].hw },
};

static static_ref_clk_parent_data mux_sata_phy_2mux1_p[] = {
	{ .hw = &eic7700_early_clks[9].hw },
	{ .hw = &eic7700_fixed_rate_clks[16].hw },
};

static static_ref_clk_parent_data mux_syscfg_clk_root_2mux1_gfree_p[] = {
	{ .hw = &eic7700_early_clks[10].hw },
	{ .index = 0 },
};

static static_ref_clk_parent_data mux_cpu_root_3mux1_gfree_p[] = {
	{ .hw = &eic7700_pll_clks[1].hw },
	{ .hw = &eic7700_early_clks[11].hw },
	{ .index = 0 },
};

static mut eswin_mux_clock eic7700_mux_clks[] = {
...
static static_ref_clk_parent_data mux_cpu_aclk_2mux1_gfree_p[] = {
	{ .hw = &eic7700_mux_clks[1].hw },
	{ .hw = &eic7700_mux_clks[0].hw },
};

static mut eswin_clk_info eic7700_clks[] = {
