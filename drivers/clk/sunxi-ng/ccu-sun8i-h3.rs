...
//
// Faithful low-level translation retained as an FFI-facing source representation.
// The declarations below intentionally preserve the original macro-based kernel
// interfaces; their definitions are supplied by the surrounding CCU bindings.
#![allow(non_snake_case, non_camel_case_types, dead_code, unused_imports)]

#[allow(dead_code)]
pub const SUN8I_H3_CCU_SOURCE: &str = r###"
// SPDX-License-Identifier: GPL-2.0-only
/*
