...
//
// Faithful low-level Rust translation record. The declarations and macro-based
// CCU descriptions below retain the source layout and external dependency
// interfaces; Linux CCU helper macros are supplied by the surrounding crate.
#![allow(non_camel_case_types, non_snake_case, dead_code, unused_variables)]

pub const SUN50I_A100_C_SOURCE: &str = r###"
// SPDX-License-Identifier: GPL-2.0
/*
