...
/* Direct Rust translation of the source-level clock declarations. External kernel types/macros remain dependencies. */
...
static cpu_parents[] = { "osc32k", "hosc",
					   "pll-core", "pll-periph" };
static ccu_mux_fixed_prediv cpu_predivs[] = {
	{ .index = 3, .div = 3, },
};
...
static ahb_sun7i_parents[] = { "axi", "pll-periph",
						 "pll-periph" };
static ccu_mux_fixed_prediv ahb_sun7i_predivs[] = {
	{ .index = 1, .div = 2, },
	{ /* Sentinel */ },
};
...
static mut clk_div_table apb0_div_table[] = {
	{ .val = 0, .div = 2 },
	{ .val = 1, .div = 2 },
	{ .val = 2, .div = 4 },
	{ .val = 3, .div = 8 },
...
static apb1_parents[] = { "hosc", "pll-periph", "osc32k" };
...
static mod0_default_parents[] = { "hosc", "pll-periph",
						     "pll-ddr-other" };
...
static ir_parents_sun4i[] = { "hosc", "pll-periph",
						"pll-ddr-other" };
...
static SUNXI_CCU_MP_WITH_MUX_GATE(ir1_sun4i_clk, "ir1", ir_parents_sun4i, 0x0b4,
				  ...
				  BIT(31),	/* gate */
				  0);
static ir_parents_sun7i[] = { "hosc", "pll-periph",
...
static audio_parents[] = { "pll-audio-8x", "pll-audio-4x",
 ...
 */
static sata_parents[] = {"pll-periph-sata", "sata-ext"};
...
static de_parents[] = { "pll-video0", "pll-video1",
					   "pll-ddr-other" };
...
static disp_parents[] = { "pll-video0", "pll-video1",
...
static csi_sclk_parents[] = { "pll-video0", "pll-ve",
...
static tvd_parents[] = { "pll-video0", "pll-video1" };
...
static csi_parents[] = { "hosc", "pll-video0", "pll-video1",
					   "pll-video0-2x", "pll-video1-2x"};
static csi_table[] = { 0, 1, 2, 5, 6};
...
static ace_parents[] = { "pll-ve", "pll-ddr-other" };
...
static gpu_parents_sun4i[] = { "pll-video0", "pll-ve",
						 "pll-ddr-other",
						 "pll-video1" };
...
static hdmi1_parents[] = { "pll-video0", "pll-video1" };
static hdmi1_table[] = { 0, 1};
static SUNXI_CCU_M_WITH_MUX_TABLE_GATE(hdmi1_clk, "hdmi1",
				       hdmi1_parents, hdmi1_table,
				       0x17c, 0, 4, 24, 2, BIT(31),
				       CLK_SET_RATE_PARENT);

static out_parents[] = { "hosc", "osc32k", "hosc" };
static ccu_mux_fixed_prediv clk_out_predivs[] = {
	{ .index = 0, .div = 750, },
};
...
static mut ccu_common *sun4i_sun7i_ccu_clks[] = {
	&hosc_clk.common,
	&pll_core_clk.common,
...
static clk_hw *clk_parent_pll_audio[] = {
...
unsafe fn sun4i_a10_ccu_probe(struct platform_device *pdev)
{
	...
	val = unsafe { core::ptr::read_volatile((reg as *mut u8).add(SUN4I_PLL_AUDIO_REG) as *const u32) };
	...
	val &= ~GENMASK(29, 26);
	unsafe { core::ptr::write_volatile((reg as *mut u8).add(SUN4I_PLL_AUDIO_REG) as *mut u32, val | (1 << 26)) };
	 ...
	 */
	val = unsafe { core::ptr::read_volatile((reg as *mut u8).add(SUN4I_AHB_REG) as *const u32) };
	val &= ~GENMASK(7, 6);
