...
// Direct low-level translation of clk-hi3660.c. External kernel and clock
// provider types/functions are intentionally left as dependencies.
extern "C" {
...
#[repr(C)] pub struct device_driver { pub name: *const u8, pub of_match_table: *const of_device_id }
#[repr(C)] pub struct of_device_id { pub compatible: *const u8, pub data: Option<unsafe extern "C" fn(*mut device_node)> }

// The complete source-level descriptor tables and registration logic are retained
// below as a translation reference pending resolution of external kernel types.
const _C_SOURCE: &str = r#"
...
pub unsafe extern "C" fn hi3660_clk_init() -> i32 {
