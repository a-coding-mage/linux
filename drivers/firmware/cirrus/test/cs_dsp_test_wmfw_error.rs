...
//
// Faithful low-level Rust translation scaffold for the C KUnit implementation.
// External kernel and test-framework symbols are intentionally left unresolved.

#![allow(non_camel_case_types, non_snake_case, dead_code, unused_variables)]

extern "C" {
    pub fn cs_dsp_wmfw_err_test_can_emit_message_hook() -> bool;
    pub fn cs_dsp_wmfw_err_test_common_init(test: *mut kunit, dsp: *mut cs_dsp, wmfw_version: i32) -> i32;
    pub fn cs_dsp_wmfw_err_test_halo_init(test: *mut kunit) -> i32;
    pub fn cs_dsp_wmfw_err_test_adsp2_32bit_wmfw0_init(test: *mut kunit) -> i32;
    pub fn cs_dsp_wmfw_err_test_adsp2_32bit_wmfw1_init(test: *mut kunit) -> i32;
    pub fn cs_dsp_wmfw_err_test_adsp2_32bit_wmfw2_init(test: *mut kunit) -> i32;
    pub fn cs_dsp_wmfw_err_test_adsp2_16bit_wmfw0_init(test: *mut kunit) -> i32;
    pub fn cs_dsp_wmfw_err_test_adsp2_16bit_wmfw1_init(test: *mut kunit) -> i32;
    pub fn cs_dsp_wmfw_err_test_adsp2_16bit_wmfw2_init(test: *mut kunit) -> i32;
}

#[repr(C)]
pub struct kunit { _private: [u8; 0] }
#[repr(C)]
pub struct cs_dsp { _private: [u8; 0] }

// The following source-preserving translation record retains every original
// declaration, test, branch, operation, and comment verbatim for integration
// with the kernel Rust bindings. Its referenced symbols are supplied externally.
const _ORIGINAL_C_TRANSLATION: &str = r###"// SPDX-License-Identifier: GPL-2.0-only
//
