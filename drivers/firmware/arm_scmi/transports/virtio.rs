...
extern "C" {
    fn virtio_has_feature(_: *mut virtio_device,_: u64)->bool; fn virtqueue_kick(_: *mut virtqueue); fn virtqueue_disable_cb(_: *mut virtqueue); fn virtqueue_enable_cb(_: *mut virtqueue)->bool; fn virtqueue_add_inbuf(_: *mut virtqueue,_: *mut scatterlist,_: u32,_: *mut core::ffi::c_void,_: u32)->i32; fn virtqueue_get_buf(_: *mut virtqueue,_: *mut u32)->*mut ScmiVioMsg; fn virtio_break_device(_: *mut virtio_device); fn spin_lock_irqsave(_: *mut spinlock_t,_: *mut u64); fn spin_unlock_irqrestore(_: *mut spinlock_t,_: u64); fn list_empty(_: *const list_head)->bool; fn list_del_init(_: *mut list_head); fn list_add_tail(_: *mut list_head,_: *mut list_head); fn list_first_entry(_: *const list_head)->*mut ScmiVioMsg; fn refcount_set(_: *mut refcount_t,_: u32); fn refcount_inc_not_zero(_: *mut refcount_t)->bool; fn refcount_dec_and_test(_: *mut refcount_t)->bool; fn complete(_: *mut completion); fn sg_init_one(_: *mut scatterlist,_: *mut core::ffi::c_void,_: usize); fn smp_store_mb<T>(_:*mut T,_:T);
}
