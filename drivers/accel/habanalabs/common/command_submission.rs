// Faithful source-preservation translation boundary.
// The original C implementation is retained below because its external kernel
// types, macros, and ABI definitions are supplied by other repository files.
/*
