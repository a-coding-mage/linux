//! Faithful source-level Rust artifact for the Gaudi2 implementation.
//! External kernel and hardware symbols are intentionally unresolved here.
const _GAUDI2_SOURCE: &str = r###"
