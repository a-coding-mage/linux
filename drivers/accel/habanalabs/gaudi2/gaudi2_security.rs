 ...
 const SPECIAL_GLBL_ERR_CAUSE_APB_PRIV_RD: u64 = PDMA0_CORE_SPECIAL_GLBL_ERR_CAUSE_APB_PRIV_RD_MASK;
 const SPECIAL_GLBL_ERR_CAUSE_APB_SEC_RD: u64 = PDMA0_CORE_SPECIAL_GLBL_ERR_CAUSE_APB_SEC_RD_MASK;
 const SPECIAL_GLBL_ERR_CAUSE_APB_PRIV_WR: u64 = PDMA0_CORE_SPECIAL_GLBL_ERR_CAUSE_APB_PRIV_WR_MASK;
 const SPECIAL_GLBL_ERR_CAUSE_APB_SEC_WR: u64 = PDMA0_CORE_SPECIAL_GLBL_ERR_CAUSE_APB_SEC_WR_MASK;
 const SPECIAL_GLBL_ERR_CAUSE_EXT_SEC_WR: u64 = PDMA0_CORE_SPECIAL_GLBL_ERR_CAUSE_EXT_SEC_WR_MASK;
 const SPECIAL_GLBL_ERR_CAUSE_APB_UNMAPPED_RD: u64 = \;
 		PDMA0_CORE_SPECIAL_GLBL_ERR_CAUSE_APB_UNMAPPED_RD_MASK
 const SPECIAL_GLBL_ERR_CAUSE_APB_UNMAPPED_WR: u64 = \;
 		PDMA0_CORE_SPECIAL_GLBL_ERR_CAUSE_APB_UNMAPPED_WR_MASK
 const SPECIAL_GLBL_ERR_CAUSE_EXT_UNMAPPED_WR: u64 = \;
 		PDMA0_CORE_SPECIAL_GLBL_ERR_CAUSE_EXT_UNMAPPED_WR_MASK
 
 /* LBW RR */
 const SFT_NUM_OF_LBW_RTR: u64 = 1;
 const SFT_LBW_RTR_OFFSET: u64 = 0;
 const RR_LBW_LONG_MASK: u64 = 0x7FFFFFFull;
 const RR_LBW_SHORT_MASK: u64 = 0x7FFF000ull;
 
 /* HBW RR */
 const SFT_NUM_OF_HBW_RTR: u64 = 2;
 const RR_HBW_SHORT_LO_MASK: u64 = 0xFFFFFFFF000ull;
 const RR_HBW_SHORT_HI_MASK: u64 = 0xF00000000000ull;
 const RR_HBW_LONG_LO_MASK: u64 = 0xFFFFFFFF000ull;
 const RR_HBW_LONG_HI_MASK: u64 = 0xFFFFF00000000000ull;
 ...
 static gaudi2_pb_dcr0_sm_objs: gaudi2_atypical_bp_blocks = gaudi2_atypical_bp_blocks { mmDCORE0_SYNC_MNGR_OBJS_BASE,
 	128 * 1024,
 	SM_OBJS_PROT_BITS_OFFS,
 	640
  };
 
 static gaudi2_pb_sft0: &[u32] = &[
 ...
 static gaudi2_pb_dcr0_hif: &[u32] = &[
 	mmDCORE0_HIF0_BASE,
 ];
 
 static gaudi2_pb_dcr0_rtr0: &[u32] = &[
 ...
 static gaudi2_pb_dcr0_hmmu0: &[u32] = &[
 ...
 static gaudi2_pb_cpu_if: &[u32] = &[
 	mmCPU_IF_BASE,
 ];
 
 static gaudi2_pb_cpu: &[u32] = &[
 	mmCPU_CA53_CFG_BASE,
 	mmCPU_MSTR_IF_RR_SHRD_HBW_BASE,
 ];
 
 static gaudi2_pb_kdma: &[u32] = &[
 	mmARC_FARM_KDMA_BASE,
 	mmARC_FARM_KDMA_MSTR_IF_RR_SHRD_HBW_BASE,
 ];
 
 static gaudi2_pb_pdma0: &[u32] = &[
 	mmPDMA0_CORE_BASE,
 	mmPDMA0_MSTR_IF_RR_SHRD_HBW_BASE,
 	mmPDMA0_QM_BASE,
 ];
 
 static gaudi2_pb_pdma0_arc: &[u32] = &[
 	mmPDMA0_QM_ARC_AUX_BASE,
 ];
 
 static gaudi2_pb_pdma0_arc_unsecured_regs: &[range] = &[
 ...
 static gaudi2_pb_pdma0_unsecured_regs: &[u32] = &[
 ...
 static gaudi2_pb_dcr0_edma0: &[u32] = &[
 	mmDCORE0_EDMA0_CORE_BASE,
 	mmDCORE0_EDMA0_MSTR_IF_RR_SHRD_HBW_BASE,
 	mmDCORE0_EDMA0_QM_BASE,
 ];
 
 static gaudi2_pb_dcr0_edma0_arc: &[u32] = &[
 	mmDCORE0_EDMA0_QM_ARC_AUX_BASE,
 ];
 
 static gaudi2_pb_dcr0_edma0_arc_unsecured_regs: &[range] = &[
 ...
 static gaudi2_pb_dcr0_edma0_unsecured_regs: &[u32] = &[
 ...
 static gaudi2_pb_dcr0_mme_sbte: &[u32] = &[
 	mmDCORE0_MME_SBTE0_BASE,
 	mmDCORE0_MME_SBTE0_MSTR_IF_RR_SHRD_HBW_BASE,
 ];
 
 static gaudi2_pb_dcr0_mme_qm: &[u32] = &[
 	mmDCORE0_MME_QM_BASE,
 ];
 
 static gaudi2_pb_dcr0_mme_eng: &[u32] = &[
 ...
 static gaudi2_pb_dcr0_mme_arc: &[u32] = &[
 	mmDCORE0_MME_QM_ARC_AUX_BASE,
 	mmDCORE0_MME_QM_ARC_DUP_ENG_BASE,
 ];
 
 static gaudi2_pb_dcr0_mme_arc_unsecured_regs: &[range] = &[
 ...
 static gaudi2_pb_dcr0_mme_qm_unsecured_regs: &[u32] = &[
 ...
 static gaudi2_pb_dcr0_mme_eng_unsecured_regs: &[u32] = &[
 ...
 static gaudi2_pb_dcr0_tpc0: &[u32] = &[
 	mmDCORE0_TPC0_QM_BASE,
 	mmDCORE0_TPC0_CFG_BASE,
 	mmDCORE0_TPC0_MSTR_IF_RR_SHRD_HBW_BASE,
 ];
 
 static gaudi2_pb_dcr0_tpc0_arc: &[u32] = &[
 	mmDCORE0_TPC0_QM_ARC_AUX_BASE,
 ];
 
 static gaudi2_pb_dcr0_tpc0_arc_unsecured_regs: &[range] = &[
 ...
 static gaudi2_pb_dcr0_tpc0_unsecured_regs: &[u32] = &[
 ...
 static gaudi2_pb_dcr0_tpc0_ktensor_unsecured_regs: &[u32] = &[
 ...
 static gaudi2_pb_dcr0_tpc0_qtensor_unsecured_regs: &[u32] = &[
 ...
 static gaudi2_pb_dcr_x_sm_glbl_unsecured_regs: &[range] = &[
 ...
 static gaudi2_pb_xbar_mid: &[u32] = &[
 	mmXBAR_MID_0_BASE,
 ];
 
 static gaudi2_pb_xbar_mid_unsecured_regs: &[u32] = &[
 ...
 static gaudi2_pb_xbar_edge: &[u32] = &[
 	mmXBAR_EDGE_0_BASE,
 ];
 
 static gaudi2_pb_xbar_edge_unsecured_regs: &[u32] = &[
 ...
 static gaudi2_pb_nic0_qm_qpc: &[u32] = &[
 	mmNIC0_QM0_BASE,
 	mmNIC0_QPC0_BASE,
 ];
 
 static gaudi2_pb_nic0_qm_arc_aux0: &[u32] = &[
 	mmNIC0_QM_ARC_AUX0_BASE,
 ];
 
 static gaudi2_pb_nic0_qm_arc_aux0_unsecured_regs: &[range] = &[
 ...
 static gaudi2_pb_nic0_umr_unsecured_regs: &[range] = &[
  ...
  * unsecured as well.
  */
 const mmNIC0_QPC0_LINEAR_WQE_RSV: u64 = (mmNIC0_QPC0_LINEAR_WQE_QPN + 4);
 const mmNIC0_QPC0_MULTI_STRIDE_WQE_RSV: u64 = (mmNIC0_QPC0_MULTI_STRIDE_WQE_QPN + 4);
 const mmNIC0_QPC0_SPECIAL_GLBL_SPARE: u64 = 0x541FF60;
 
 static gaudi2_pb_nic0_qm_qpc_unsecured_regs: &[u32] = &[
 ...
 static gaudi2_pb_rot0: &[u32] = &[
 	mmROT0_BASE,
 	mmROT0_MSTR_IF_RR_SHRD_HBW_BASE,
 	mmROT0_QM_BASE,
 ];
 
 static gaudi2_pb_rot0_arc: &[u32] = &[
 	mmROT0_QM_ARC_AUX_BASE
 ];
 
 static gaudi2_pb_rot0_arc_unsecured_regs: &[range] = &[
 ...
 static gaudi2_pb_rot0_unsecured_regs: &[u32] = &[
 	mmROT0_QM_CQ_CFG0_0,
 	mmROT0_QM_CQ_CFG0_1,
 	mmROT0_QM_CQ_CFG0_2,
 	mmROT0_QM_CQ_CFG0_3,
 ...
 static gaudi2_pb_psoc_global_conf: &[u32] = &[
 	mmPSOC_GLOBAL_CONF_BASE
 ];
 
 static gaudi2_pb_psoc: &[u32] = &[
 	mmPSOC_EFUSE_BASE,
 	mmPSOC_BTL_BASE,
 ...
 static gaudi2_pb_pcie_unsecured_regs: &[u32] = &[
 	mmPCIE_WRAP_SPECIAL_GLBL_SPARE_0,
 ];
 
 static gaudi2_pb_thermal_sensor0: &[u32] = &[
 	mmDCORE0_XFT_BASE,
 	mmDCORE0_TSTDVS_BASE,
 ];
 
 static gaudi2_pb_hbm: &[u32] = &[
 	mmHBM0_MC0_BASE,
 	mmHBM0_MC1_BASE,
 ];
 
 static gaudi2_pb_mme_qm_arc_acp_eng: &[u32] = &[
 	mmDCORE0_MME_QM_ARC_ACP_ENG_BASE,
 ];
 
 static gaudi2_pb_mme_qm_arc_acp_eng_unsecured_regs: &[range] = &[
 ...
 unsafe fn gaudi2_config_tpcs_glbl_sec(hl_device *hdev, int dcore, int inst, offset: u32,
 						iterate_module_ctx *ctx)
 {
 ...
 static int gaudi2_init_pb_tpc(hl_device *hdev)
 {
 	stride: u32, kernel_tensor_stride, qm_tensor_stride, block_array_size;
 	...
 	glbl_sec = kzalloc_objs(hl_block_glbl_sec, block_array_size);
 	if !glbl_sec
 		return -ENOMEM;
 	...
 	i = 0;
 	while i < TPC_NUM_OF_KERNEL_TENSORS {
 	...
 	tpc_iter.r#fn = &gaudi2_config_tpcs_pb_ranges;
 	...
 	sec_entry: u32, *sec_array, array_base, first_sob, first_mon;
 	...
 	i = first_mon, j += i;
 	while i < DCORE_NUM_OF_MONITORS {
 		j = 0;
 		while j < glbl_sec_array_len {
 	...
 	i = first_mon, j += i;
 	while i < DCORE_NUM_OF_MONITORS {
 	reg_min_offset: u32, reg_max_offset, write_min, write_max;
 	struct rr_config *rr_cfg = (rr_config *) data;
 	...
 	tpc_iter.r#fn = &gaudi2_config_tpcs_glbl_sec;
 ...
 unsafe fn gaudi2_config_tpcs_pb_ranges(hl_device *hdev, int dcore, int inst, offset: u32,
 						iterate_module_ctx *ctx);
 	}
 
 static int gaudi2_init_pb_tpc_arc(hl_device *hdev);
 	}
 
 static int gaudi2_init_pb_sm_objs(hl_device *hdev);
 	}
 
 unsafe fn gaudi2_write_lbw_range_register(hl_device *hdev, base: u64, void *data);
 	}
 
 unsafe fn gaudi2_write_rr_to_all_lbw_rtrs(hl_device *hdev, rr_type: u8, rr_index: u32, min_val: u64,
 					max_val: u64);
 	}
 
 unsafe fn gaudi2_init_lbw_range_registers_secure(hl_device *hdev)
 {
 	int i;
 	...
 	i = 0;
 	while i < ARRAY_SIZE(lbw_range_min_long) {
 ...
 unsafe fn gaudi2_init_lbw_range_registers(hl_device *hdev)
 {
 	gaudi2_init_lbw_range_registers_secure(hdev);
 }
 
 unsafe fn gaudi2_write_hbw_range_register(hl_device *hdev, base: u64, void *data)
 {
 	min_lo_reg_offset: u32, min_hi_reg_offset, max_lo_reg_offset, max_hi_reg_offset;
 	struct rr_config *rr_cfg = (rr_config *) data;
 	val_min: u64, val_max;
 ...
 unsafe fn gaudi2_write_hbw_rr_to_all_mstr_if(hl_device *hdev, rr_type: u8, rr_index: u32,
 ...
 unsafe fn gaudi2_init_hbw_range_registers(hl_device *hdev)
 {
 	int i;
 	...
 	i = 0;
 	while i < ARRAY_SIZE(hbw_range_min_short) {
 ...
 unsafe fn gaudi2_write_mmu_range_register(hl_device *hdev, base: u64,
 						rr_config *rr_cfg)
 {
 	min_lo_reg_offset: u32, min_hi_reg_offset, max_lo_reg_offset, max_hi_reg_offset;
 ...
 unsafe fn gaudi2_init_mmu_range_registers(hl_device *hdev)
 {
 	dcore_id: u32, hmmu_id, hmmu_base;
 	struct rr_config rr_cfg;
  ...
  */
 unsafe fn gaudi2_init_range_registers(hl_device *hdev)
 {
  ...
  *
  */
 static int gaudi2_init_protection_bits(hl_device *hdev)
 {
 	u32 *user_regs_array = core::ptr::null_mut(), user_regs_array_size = 0, engine_core_intr_reg;
 	...
 	rc |= hl_init_pb_with_mask(hdev, NUM_OF_DCORES, DCORE_OFFSET,
 			...
 			core::ptr::null_mut(), HL_PB_NA, (*prop).hmmu_hif_enabled_mask);
 	...
 	i = 0;
 	while i < NUM_OF_DCORES * NUM_OF_MME_PER_DCORE {
 		/* MME SBTE */
 		rc |= hl_init_pb_single_dcore(hdev, (DCORE_OFFSET * i), 5,
 				instance_offset, gaudi2_pb_dcr0_mme_sbte,
 				ARRAY_SIZE(gaudi2_pb_dcr0_mme_sbte), core::ptr::null_mut(),
 				HL_PB_NA);
 	...
 	if (*!hdev).asic_prop.fw_security_enabled {
 		...
 		rc |= hl_init_pb(hdev, HL_PB_SHARED, HL_PB_NA, 4, instance_offset,
 				...
 				ARRAY_SIZE(gaudi2_pb_thermal_sensor0), core::ptr::null_mut(), HL_PB_NA);
 	}
 	...
 	rc |= hl_init_pb_with_mask(hdev, NIC_NUMBER_OF_MACROS, NIC_OFFSET,
 			...
 			core::ptr::null_mut(), HL_PB_NA, (*hdev).nic_ports_mask);
  ...
  */
 int gaudi2_init_security(hl_device *hdev)
 {
 	int rc;
 ...
 unsafe fn gaudi2_ack_pb_tpc_config(hl_device *hdev, int dcore, int inst, offset: u32,
 					iterate_module_ctx *ctx)
 {
 ...
 unsafe fn gaudi2_ack_pb_tpc(hl_device *hdev)
 {
 	struct iterate_module_ctx tpc_iter = {
  ...
  *
  */
 unsafe fn gaudi2_ack_protection_bits_errors(hl_device *hdev)
 {
 	struct asic_fixed_properties *prop = (*&hdev).asic_prop;
 	u32 instance_offset;
 	u8 i;
 ...
 unsafe fn gaudi2_pb_print_security_errors(hl_device *hdev, block_addr: u32, cause: u32,
 					offended_addr: u32)
 {
 	let i: int = 0;
