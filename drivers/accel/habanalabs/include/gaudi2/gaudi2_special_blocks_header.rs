...
// C header dependencies and preprocessor context are supplied by the including
// translation unit. This macro preserves the original aggregate initializer.
macro_rules! GAUDI2_SPECIAL_BLOCKS {
    () => {
        [
