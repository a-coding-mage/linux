...
pub enum gaudi2_debug_stm_regs_index {
	GAUDI2_STM_FIRST = 0,
...
#[repr(C)]
#[derive(Copy, Clone, Debug, PartialEq, Eq)]
pub enum gaudi2_debug_etf_regs_index {
	GAUDI2_ETF_FIRST = 0,
...
#[repr(C)]
#[derive(Copy, Clone, Debug, PartialEq, Eq)]
pub enum gaudi2_debug_funnel_regs_index {
...
#[repr(C)]
#[derive(Copy, Clone, Debug, PartialEq, Eq)]
pub enum gaudi2_debug_bmon_regs_index {
	GAUDI2_BMON_FIRST = 0,
...
#[repr(C)]
#[derive(Copy, Clone, Debug, PartialEq, Eq)]
pub enum gaudi2_debug_spmu_regs_index {
	GAUDI2_SPMU_FIRST = 0,
