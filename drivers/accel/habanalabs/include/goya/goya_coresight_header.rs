...
pub enum goya_debug_stm_regs_index {
    GOYA_STM_FIRST = 0,
    GOYA_STM_CPU = GOYA_STM_FIRST as i32,
    ...
    GOYA_STM_TPC6_EML,
    GOYA_STM_TPC7_EML,
    GOYA_STM_LAST = GOYA_STM_TPC7_EML as i32,
}

#[repr(i32)]
#[derive(Copy, Clone, Debug, PartialEq, Eq)]
pub enum goya_debug_etf_regs_index {
    GOYA_ETF_FIRST = 0,
    GOYA_ETF_CPU_0 = GOYA_ETF_FIRST as i32,
    GOYA_ETF_CPU_1,
    GOYA_ETF_CPU_TRACE,
    ...
    GOYA_ETF_TPC6_EML,
    GOYA_ETF_TPC7_EML,
    GOYA_ETF_LAST = GOYA_ETF_TPC7_EML as i32,
}

#[repr(i32)]
#[derive(Copy, Clone, Debug, PartialEq, Eq)]
pub enum goya_debug_funnel_regs_index {
    GOYA_FUNNEL_FIRST = 0,
    GOYA_FUNNEL_CPU = GOYA_FUNNEL_FIRST as i32,
    ...
    GOYA_FUNNEL_LAST = GOYA_FUNNEL_TPC7_EML as i32,
}

#[repr(i32)]
#[derive(Copy, Clone, Debug, PartialEq, Eq)]
pub enum goya_debug_bmon_regs_index {
    GOYA_BMON_FIRST = 0,
    GOYA_BMON_CPU_RD = GOYA_BMON_FIRST as i32,
    GOYA_BMON_CPU_WR,
    ...
    GOYA_BMON_LAST = GOYA_BMON_TPC7_EML_3 as i32,
}

#[repr(i32)]
#[derive(Copy, Clone, Debug, PartialEq, Eq)]
pub enum goya_debug_spmu_regs_index {
    GOYA_SPMU_FIRST = 0,
    GOYA_SPMU_DMA_CH_0_CS = GOYA_SPMU_FIRST as i32,
    ...
    GOYA_SPMU_TPC6_EML,
    GOYA_SPMU_TPC7_EML,
    GOYA_SPMU_LAST = GOYA_SPMU_TPC7_EML as i32,
}
