...
extern "C" { pub fn ahci_dev_classify(_: *mut ata_port)->u32; pub fn ahci_fill_cmd_slot(_: *mut ahci_port_priv,_: u32,_: u32); pub fn ahci_save_initial_config(_: *mut device,_: *mut ahci_host_priv); pub fn ahci_init_controller(_: *mut ata_host); pub fn ahci_reset_controller(_: *mut ata_host)->i32; pub fn ahci_do_softreset(_: *mut ata_link,_: *mut u32,_: i32,_: usize,_: Option<unsafe extern "C" fn(*mut ata_link)->i32>)->i32; pub fn ahci_do_hardreset(_: *mut ata_link,_: *mut u32,_: usize,_: *mut bool)->i32; pub fn ahci_qc_issue(_: *mut ata_queued_cmd)->u32; pub fn ahci_stop_engine(_: *mut ata_port)->i32; pub fn ahci_start_fis_rx(_: *mut ata_port); pub fn ahci_start_engine(_: *mut ata_port); pub fn ahci_check_ready(_: *mut ata_link)->i32; pub fn ahci_kick_engine(_: *mut ata_port)->i32; pub fn ahci_port_resume(_: *mut ata_port)->i32; pub fn ahci_set_em_messages(_: *mut ahci_host_priv,_: *mut ata_port_info); pub fn ahci_reset_em(_: *mut ata_host)->i32; pub fn ahci_print_info(_: *mut ata_host,_: *const i8); pub fn ahci_host_activate(_: *mut ata_host,_: *const scsi_host_template)->i32; pub fn ahci_error_handler(_: *mut ata_port); pub fn ahci_handle_port_intr(_: *mut ata_host,_: u32)->u32; }
