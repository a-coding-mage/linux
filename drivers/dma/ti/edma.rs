...
//! Faithful source-level translation record for the TI EDMA driver.
//! The implementation depends on the Linux DMA-engine and platform APIs.

pub const PARM_OPT: usize = 0x00;
pub const PARM_SRC: usize = 0x04;
pub const PARM_A_B_CNT: usize = 0x08;
pub const PARM_DST: usize = 0x0c;
pub const PARM_SRC_DST_BIDX: usize = 0x10;
pub const PARM_LINK_BCNTRLD: usize = 0x14;
pub const PARM_SRC_DST_CIDX: usize = 0x18;
pub const PARM_CCNT: usize = 0x1c;
pub const PARM_SIZE: usize = 0x20;
pub const MAX_NR_SG: usize = 20;
pub const EDMA_MAX_SLOTS: usize = MAX_NR_SG;
pub const EDMA_DESCRIPTORS: usize = 16;
pub const EDMA_CHANNEL_ANY: i32 = -1;
pub const EDMA_SLOT_ANY: i32 = -1;
pub const EDMA_CONT_PARAMS_ANY: i32 = 1001;
pub const EDMA_CONT_PARAMS_FIXED_EXACT: i32 = 1002;
pub const EDMA_CONT_PARAMS_FIXED_NOT_EXACT: i32 = 1003;

#[repr(C, packed)]
#[derive(Clone, Copy, Default)]
pub struct EdmaCcParam {
    pub opt: u32, pub src: u32, pub a_b_cnt: u32, pub dst: u32,
    pub src_dst_bidx: u32, pub link_bcntrld: u32,
    pub src_dst_cidx: u32, pub ccnt: u32,
}

#[inline]
pub const fn parm_offset(param_no: usize) -> usize { 0x4000 + (param_no << 5) }

pub const EDMA_SOURCE: &str = r###"
// SPDX-License-Identifier: GPL-2.0-only
/*
