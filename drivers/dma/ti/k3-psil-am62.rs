...
static mut am62_src_ep_map: [psil_ep; 59] = [
    /* SAUL */
    ...
    /* CSI2RX */
    PSIL_CSI2RX!(0x4700), PSIL_CSI2RX!(0x4701), PSIL_CSI2RX!(0x4702), PSIL_CSI2RX!(0x4703),
    PSIL_CSI2RX!(0x4704), PSIL_CSI2RX!(0x4705), PSIL_CSI2RX!(0x4706), PSIL_CSI2RX!(0x4707),
    PSIL_CSI2RX!(0x4708), PSIL_CSI2RX!(0x4709), PSIL_CSI2RX!(0x470a), PSIL_CSI2RX!(0x470b),
    PSIL_CSI2RX!(0x470c), PSIL_CSI2RX!(0x470d), PSIL_CSI2RX!(0x470e), PSIL_CSI2RX!(0x470f),
    PSIL_CSI2RX!(0x4710), PSIL_CSI2RX!(0x4711), PSIL_CSI2RX!(0x4712), PSIL_CSI2RX!(0x4713),
    PSIL_CSI2RX!(0x4714), PSIL_CSI2RX!(0x4715), PSIL_CSI2RX!(0x4716), PSIL_CSI2RX!(0x4717),
    PSIL_CSI2RX!(0x4718), PSIL_CSI2RX!(0x4719), PSIL_CSI2RX!(0x471a), PSIL_CSI2RX!(0x471b),
    PSIL_CSI2RX!(0x471c), PSIL_CSI2RX!(0x471d), PSIL_CSI2RX!(0x471e), PSIL_CSI2RX!(0x471f),
];

/* PSI-L destination thread IDs, used for TX (DMA_MEM_TO_DEV) */
static mut am62_dst_ep_map: [psil_ep; 32] = [
    /* SAUL */
...
static mut am62_ep_map: psil_ep_map = psil_ep_map {
    name: "am62",
    src: am62_src_ep_map.as_ptr(),
    src_count: am62_src_ep_map.len(),
    dst: am62_dst_ep_map.as_ptr(),
    dst_count: am62_dst_ep_map.len(),
};
