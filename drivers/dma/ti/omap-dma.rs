// Faithful low-level Rust translation; Linux kernel dependencies are supplied externally.
#![allow(non_camel_case_types, non_snake_case, dead_code, unused_variables, unused_mut)]
// SPDX-License-Identifier: GPL-2.0-only
/*
 * OMAP DMAengine support
 */
// external Linux kernel dependency: #include <linux/cpu_pm.h>
// external Linux kernel dependency: #include <linux/delay.h>
// external Linux kernel dependency: #include <linux/dmaengine.h>
// external Linux kernel dependency: #include <linux/dma-mapping.h>
// external Linux kernel dependency: #include <linux/dmapool.h>
// external Linux kernel dependency: #include <linux/err.h>
// external Linux kernel dependency: #include <linux/init.h>
// external Linux kernel dependency: #include <linux/interrupt.h>
// external Linux kernel dependency: #include <linux/list.h>
// external Linux kernel dependency: #include <linux/module.h>
// external Linux kernel dependency: #include <linux/omap-dma.h>
// external Linux kernel dependency: #include <linux/platform_device.h>
// external Linux kernel dependency: #include <linux/slab.h>
// external Linux kernel dependency: #include <linux/spinlock.h>
// external Linux kernel dependency: #include <linux/of.h>
// external Linux kernel dependency: #include <linux/of_dma.h>

// external Linux kernel dependency: #include "../virt-dma.h"

const OMAP_SDMA_REQUESTS	127
const OMAP_SDMA_CHANNELS	32
...
const DESC_NXT_SV_REFRESH	(0x1 << 24)
const DESC_NXT_SV_REUSE	(0x2 << 24)
const DESC_NXT_DV_REFRESH	(0x1 << 26)
const DESC_NXT_DV_REUSE	(0x2 << 26)
const DESC_NTYPE_TYPE2	(0x2 << 29)
...
const OMAP_DMA_BUSWIDTHS	(BIT(DMA_SLAVE_BUSWIDTH_1_BYTE) | \
