...
extern "C" { pub fn fsl_edma_tx_chan_handler(_: *mut fsl_edma_chan); pub fn fsl_edma_disable_request(_: *mut fsl_edma_chan); pub fn fsl_edma_chan_mux(_: *mut fsl_edma_chan,_: u32,_: bool); pub fn fsl_edma_free_desc(_: *mut virt_dma_desc); pub fn fsl_edma_terminate_all(_: *mut dma_chan)->i32; pub fn fsl_edma_pause(_: *mut dma_chan)->i32; pub fn fsl_edma_resume(_: *mut dma_chan)->i32; pub fn fsl_edma_slave_config(_: *mut dma_chan,_: *mut dma_slave_config)->i32; pub fn fsl_edma_tx_status(_: *mut dma_chan,_: u32,_: *mut dma_tx_state)->dma_status; pub fn fsl_edma_prep_dma_cyclic(_: *mut dma_chan,_: u64,_: usize,_: usize,_: dma_transfer_direction,_: usize)->*mut dma_async_tx_descriptor; pub fn fsl_edma_prep_slave_sg(_: *mut dma_chan,_: *mut scatterlist,_: u32,_: dma_transfer_direction,_: usize,_: *mut core::ffi::c_void)->*mut dma_async_tx_descriptor; pub fn fsl_edma_prep_memcpy(_: *mut dma_chan,_: u64,_: u64,_: usize,_: usize)->*mut dma_async_tx_descriptor; pub fn fsl_edma_xfer_desc(_: *mut fsl_edma_chan); pub fn fsl_edma_issue_pending(_: *mut dma_chan); pub fn fsl_edma_alloc_chan_resources(_: *mut dma_chan)->i32; pub fn fsl_edma_free_chan_resources(_: *mut dma_chan); pub fn fsl_edma_cleanup_vchan(_: *mut dma_device); pub fn fsl_edma_setup_regs(_: *mut fsl_edma_engine); }
