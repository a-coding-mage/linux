...
extern "C" { fn readl(p:*mut u8)->u32; fn writel(v:u32,p:*mut u8); fn dma_cookie_assign(_: *mut dma_async_tx_descriptor)->i32; fn async_tx_ack(_: *mut dma_async_tx_descriptor); fn dma_cookie_complete(_: *mut dma_async_tx_descriptor); fn dma_cookie_status(_: *mut dma_chan,_: i32,_: *mut dma_tx_state)->dma_status; fn dma_set_residue(_: *mut dma_tx_state,_: u32); fn tasklet_schedule(_: *mut tasklet_struct); fn dma_pool_free(_: *mut dma_pool,_: *mut core::ffi::c_void,_: u64); fn dev_warn(_: *mut device,_: *const u8); fn dev_err(_: *mut device,_: *const u8); fn dev_dbg(_: *mut device,_: *const u8); fn spin_lock_irqsave(_: *mut spinlock_t,_: *mut usize); fn spin_unlock_irqrestore(_: *mut spinlock_t,_: usize); }
