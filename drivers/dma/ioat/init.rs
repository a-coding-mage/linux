...
extern "C" { fn complete(_: *mut completion); fn kzalloc(_:usize,_: u32)->*mut u8; fn kfree(_: *mut u8); fn memcmp(_: *const u8,_: *const u8,_: usize)->i32; fn init_completion(_: *mut completion); fn wait_for_completion_timeout(_: *mut completion, _: u64)->u64; fn msecs_to_jiffies(_:u64)->u64; fn dma_map_single(_: *mut device,_: *mut u8,_: usize,_: u32)->u64; fn dma_unmap_single(_: *mut device,_: u64,_: usize,_: u32); fn async_tx_ack(_: *mut dma_async_tx_descriptor); fn INIT_LIST_HEAD(_: *mut core::ffi::c_void); fn list_add_tail(_: *mut core::ffi::c_void,_: *mut core::ffi::c_void); fn dma_cookie_init(_: *mut dma_chan); fn container_of(_: *mut core::ffi::c_void, _: *mut dma_chan, _: core::ffi::c_void)->*mut dma_chan; fn readb(_: *mut u8)->u8; fn writeb(_:u8,_: *mut u8); fn pci_register_driver(_: *mut pci_driver)->i32; fn pci_unregister_driver(_: *mut pci_driver); }
