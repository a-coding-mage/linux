...
// Dependency supplied by qdma.h in the C implementation.

pub const qdma_regos_default: [qdma_reg; QDMA_REGO_MAX] = [
...
pub const qdma_regfs_default: [qdma_reg_field; QDMA_REGF_MAX] = [
