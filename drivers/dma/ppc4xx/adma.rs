/*
 * Faithful source-level translation of dma/ppc4xx/adma.c.
 *
 * This implementation depends on Linux kernel and architecture-specific
 * declarations supplied by the surrounding repository.
 */
#[allow(dead_code, unused_variables, unused_mut, non_camel_case_types)]
const _ADMA_C_SOURCE: &str = r###"// SPDX-License-Identifier: GPL-2.0-or-later
/*
