...
// Dependency equivalent of <asm/types.h>: u32 is expected to be supplied by the
// surrounding translation unit or dependency environment.
...
pub static mut bcom_fec_tx_task: [u32; 54] = [
	/* header */
	0x4243544b,
	0x2407070d,
	0x00000000,
