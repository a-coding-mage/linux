...
// dependency: include "dcn60_hubbub.h"
// dependency: include "dm_services.h"
// dependency: include "reg_helper.h"
...
unsafe fn hubbub60_perfmon_start_measuring_urgent_ramp_latency(
	...
	let slice_size =
			dc_fixpt_from_fraction((u64)params.refclk_mhz * params.t_win_ns, 3000);
	let threshold_bytes = dc_fixpt_div_int(
			dc_fixpt_from_int(params.bandwidth_mbps * params.t_win_ns),
			1000);

	u32 cvalue_0 = dc_fixpt_floor(dc_fixpt_mul_int(slice_size, 3));
	u32 cvalue_1 = dc_fixpt_floor(slice_size);
	u32 cvalue_2 = dc_fixpt_floor(dc_fixpt_mul_int(slice_size, 2));
	u32 cvalue_3 = dc_fixpt_floor(dc_fixpt_mul(
	...
	u64 cvalue = ((u64)cvalue_3 << 36) |
			((u64)cvalue_2 << 24) |
			((u64)cvalue_1 << 12) |
			((u64)cvalue_0);

	REG_SET(DC_PERFMON5_PERFMON_CVALUE_INT_MISC, 0, PERFMON_CVALUE_HI, (u32) (cvalue >> 32));
	REG_SET(DC_PERFMON5_PERFMON_CVALUE_LOW, 0, PERFMON_CVALUE_LOW, (u32) (cvalue & 0xFFFFFFFF));
