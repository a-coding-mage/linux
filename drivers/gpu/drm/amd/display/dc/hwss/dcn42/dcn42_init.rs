...
static DCN42_FUNCS: hw_sequencer_funcs = hw_sequencer_funcs {
...
static DCN42_PRIVATE_FUNCS: hwseq_private_funcs = hwseq_private_funcs {
...
pub unsafe fn dcn42_hw_sequencer_init_functions(dc: *mut dc) {
    (*dc).hwss = DCN42_FUNCS;
