...
static DCN60_FUNCS: hw_sequencer_funcs = hw_sequencer_funcs {
    ...
    enable_phantom_streams: None,
    disable_phantom_streams: None,
    update_visual_confirm_color: dcn10_update_visual_confirm_color,
    update_phantom_vp_position: None,
    update_dsc_pg: None,
    apply_update_flags_for_phantom: None,
...
static DCN60_PRIVATE_FUNCS: hwseq_private_funcs = hwseq_private_funcs {
    ...
    enable_power_gating_plane: None,
    hubp_pg_control: None,
    ...
    program_mall_pipe_config: None,
    update_mall_sel: None,
    calculate_dccg_k1_k2_values: None,
...
pub unsafe fn dcn60_hw_sequencer_init_functions(dc: *mut dc) {
    (*dc).hwss = DCN60_FUNCS;
