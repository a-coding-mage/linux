...
// Dependency preserved from C header: dcn401/dcn401_mpc.h

macro_rules! TO_DCN42_MPC {
    ($mpc_base:expr) => {{
        container_of($mpc_base, struct dcn42_mpc, base)
    }};
}

macro_rules! MPC_COMMON_MASK_SH_LIST_DCN42 {
    ($mask_sh:expr) => {{
...
macro_rules! MPC_RMCM_REG_LIST_DCN42 {
    ($inst:expr) => {{
