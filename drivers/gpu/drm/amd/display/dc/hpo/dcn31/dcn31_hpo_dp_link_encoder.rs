...
unsafe fn link_transmitter_control(enc3: *mut dcn31_hpo_dp_link_encoder, cntl: *mut bp_transmitter_control) -> bp_result { (*(*(*enc3).base.ctx).dc_bios).funcs.transmitter_control((*(*enc3).base.ctx).dc_bios, cntl) }
