 ...
 *
 * Rust translation of dcn42_dio_stream_encoder.h.
 */

// Dependencies supplied by other translation units:
// dcn30/dcn30_vpg.h, stream_encoder.h, and dcn20/dcn20_stream_encoder.h.

macro_rules! SE_COMMON_MASK_SH_LIST_DCN42 {
    ($mask_sh:expr) => {
...
extern "C" {
    pub fn dcn42_dio_stream_encoder_construct(
    ...
    pub fn enc42_se_enable_audio_clock(enc: *mut stream_encoder, enable: bool);

    pub fn enc42_reset_hdmi_stream_attribute(enc: *mut stream_encoder);

    pub fn enc42_dio_get_uncompressed_dp_pixel_format(
        enc: *mut stream_encoder,
        encoding: *mut dc_pixel_encoding,
        depth: *mut dc_color_depth,
    ) -> bool;
}
