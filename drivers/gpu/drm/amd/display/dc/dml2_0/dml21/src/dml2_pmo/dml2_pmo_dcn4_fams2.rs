...
//
// Low-level Rust translation artifact for dml2_pmo_dcn4_fams2.c.
// External types, constants, macros, and functions are supplied by the surrounding DML2 bindings.
// The source-level implementation is retained verbatim below because its ABI and dependency-defined
// layout must be lowered together with those bindings; no dependency implementations are invented.

pub const DML2_PMO_DCN4_FAMS2_SOURCE_TRANSLATION: &str = r###"
// SPDX-License-Identifier: MIT
//
