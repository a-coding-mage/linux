...
// os_types.h, dml_top_soc_parameter_types.h, dml_top_display_cfg_types.h
...
extern "C" {
    ...
    pub fn dml21_copy(dst_dml_ctx: *mut dml2_context, src_dml_ctx: *mut dml2_context);
    pub fn dml21_create_copy(
...
pub struct dc_mcache_params {
    ...
    pub num_mcaches_plane0: ::core::ffi::c_uint,
    pub num_mcaches_plane1: ::core::ffi::c_uint,
    /*
     ...
     */
    pub last_slice_sharing: dc_mcache_params_last_slice_sharing,
    /*
     ...
     * 0 = [7630 .. INF]
     */
    pub mcache_x_offsets_plane0: [::core::ffi::c_int; DML2_MAX_MCACHES + 1],
    pub mcache_x_offsets_plane1: [::core::ffi::c_int; DML2_MAX_MCACHES + 1],
}

#[repr(C)]
pub struct dc_mcache_params_last_slice_sharing {
