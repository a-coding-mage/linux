...
/*
 * C preprocessor register-field list.  The SF symbols and register-field
 * machinery are supplied by the dependent register definitions.
 */
macro_rules! OPTC_COMMON_MASK_SH_LIST_DCN401 {
    ($mask_sh:expr) => {
...
extern "C" {
    ...
    pub fn optc401_set_drr(optc: *mut timing_generator, params: *const drr_params);
    pub fn optc401_set_vtotal_min_max(optc: *mut timing_generator, vtotal_min: ::std::os::raw::c_int, vtotal_max: ::std::os::raw::c_int);
    pub fn optc401_setup_manual_trigger(optc: *mut timing_generator);
    pub fn optc401_program_global_sync(optc: *mut timing_generator, vready_offset: ::std::os::raw::c_int, vstartup_start: ::std::os::raw::c_int, vupdate_offset: ::std::os::raw::c_int, vupdate_width: ::std::os::raw::c_int, pstate_keepout: ::std::os::raw::c_int);
    ...
    pub fn optc401_set_odm_bypass(optc: *mut timing_generator, dc_crtc_timing: *const dc_crtc_timing);
    pub fn optc401_set_odm_combine(optc: *mut timing_generator, opp_id: *mut ::std::os::raw::c_int, opp_cnt: ::std::os::raw::c_int, segment_width: ::std::os::raw::c_int, last_segment_width: ::std::os::raw::c_int);
