...
// Dependency supplied by dcn10/dcn10_optc.h.

// Direct translation of OPTC_COMMON_MASK_SH_LIST_DCN60. `SF` is supplied by
// the dependent register-field infrastructure.
#[macro_export]
macro_rules! OPTC_COMMON_MASK_SH_LIST_DCN60 {
    ($mask_sh:expr) => {
...
// External declaration from the dependent OPTC implementation.
extern "C" {
    pub fn dcn60_timing_generator_init(optc1: *mut optc);
}
