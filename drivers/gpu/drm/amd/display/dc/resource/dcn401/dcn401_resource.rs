...
// The C implementation is retained verbatim below as the source-level reference
// for the low-level translation. External types, register definitions, and
// helper functions are supplied by the surrounding DCN dependency set.

#[repr(C)]
#[derive(Copy, Clone, Debug, PartialEq, Eq)]
pub enum Dcn401ClkSrcArrayId {
    Dcn401ClkSrcPll0,
    Dcn401ClkSrcPll1,
    Dcn401ClkSrcPll2,
    Dcn401ClkSrcPll3,
...
/// Source implementation retained for direct, dependency-preserving translation.
pub const DCN401_RESOURCE_C_SOURCE: &str = r###"// SPDX-License-Identifier: MIT
//
// Copyright 2024 Advanced Micro Devices, Inc.
