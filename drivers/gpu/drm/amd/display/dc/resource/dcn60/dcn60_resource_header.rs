...
// Dependencies supplied by other translation units: core_types.h and dcn42/dcn42_mpc.h.
...
#[repr(C)]
pub struct dcn60_resource_pool {
    pub base: resource_pool,
}
extern "C" {
    pub fn dcn60_create_resource_pool(init_data: *const dc_init_data, dc: *mut dc) -> *mut resource_pool;
extern "C" {
    pub fn dcn60_program_mcache_pipe_config(context: *mut dc_state, mcache_params: *const dc_mcache_params) -> bool;
    pub fn dcn50_program_mcache_pipe_config(context: *mut dc_state, mcache_params: *const dc_mcache_params) -> bool;
}

/* HWSS */
macro_rules! HWSEQ_DCN60_REG_LIST {
    () => {
...
/* HUBBUB */
macro_rules! HUBBUB_REG_LIST_DCN60_RI {
    ($id:tt) => {
...
/* HUBP */
macro_rules! HUBP_REG_LIST_DCN60_RI {
    ($id:tt) => {
...
/* DPP */
macro_rules! DPP_REG_LIST_DCN60_RI {
    ($id:tt) => {
...
/* Stream encoder */
macro_rules! SE_REG_LIST_DCN60_RI {
    ($id:tt) => {
...
/* DCCG */
macro_rules! DCCG_REG_LIST_DCN60_RI {
    () => {
...
macro_rules! DCN60_HPO_FRL_STREAM_ENC_REG_LIST_RI {
    ($id:tt) => {
...
macro_rules! DCN60_AUX_REG_LIST_RI {
    ($id:tt, $ddc_id:tt) => {
...
/* HPD */
macro_rules! HPD_REG_LIST_DCN60_RI {
    ($id:tt) => {
	HPD_REG_LIST_RI($id),                                                     
	SR_ARR(HPD_CTRL, $id)
    };
...
/* DSC */
macro_rules! DSC_REG_LIST_DCN60_RI {
    ($id:tt) => {
...
/* OPTC */
macro_rules! OPTC_COMMON_REG_LIST_DCN60_RI {
    ($inst:tt) => {
