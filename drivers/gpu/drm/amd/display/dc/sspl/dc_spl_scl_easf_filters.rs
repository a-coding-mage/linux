...
// C dependency: "spl_debug.h"
// C dependency: "dc_spl_filters.h"
// C dependency: "dc_spl_scl_filters.h"
// C dependency: "dc_spl_scl_easf_filters.h"
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_3tap_64p_ratio_0_30: [u16; 99] = [
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_3tap_64p_ratio_0_40: [u16; 99] = [
	0x0200, 0x0200, 0x0000,
	0x01F6, 0x0206, 0x0004,
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_3tap_64p_ratio_0_50: [u16; 99] = [
	0x0200, 0x0200, 0x0000,
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_3tap_64p_ratio_0_60: [u16; 99] = [
	0x0200, 0x0200, 0x0000,
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_3tap_64p_ratio_0_70: [u16; 99] = [
	0x0200, 0x0200, 0x0000,
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_3tap_64p_ratio_0_80: [u16; 99] = [
	0x0200, 0x0200, 0x0000,
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_3tap_64p_ratio_0_90: [u16; 99] = [
	0x0200, 0x0200, 0x0000,
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_3tap_64p_ratio_1_00: [u16; 99] = [
	0x0200, 0x0200, 0x0000,
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_4tap_64p_ratio_0_30: [u16; 132] = [
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_4tap_64p_ratio_0_40: [u16; 132] = [
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_4tap_64p_ratio_0_50: [u16; 132] = [
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_4tap_64p_ratio_0_60: [u16; 132] = [
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_4tap_64p_ratio_0_70: [u16; 132] = [
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_4tap_64p_ratio_0_80: [u16; 132] = [
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_4tap_64p_ratio_0_90: [u16; 132] = [
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_4tap_64p_ratio_1_00: [u16; 132] = [
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_6tap_64p_ratio_0_30: [u16; 198] = [
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_6tap_64p_ratio_0_40: [u16; 198] = [
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_6tap_64p_ratio_0_50: [u16; 198] = [
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_6tap_64p_ratio_0_60: [u16; 198] = [
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_6tap_64p_ratio_0_70: [u16; 198] = [
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_6tap_64p_ratio_0_80: [u16; 198] = [
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_6tap_64p_ratio_0_90: [u16; 198] = [
...
// <CoefQuant>		S1.10
//========================================================
const easf_filter_6tap_64p_ratio_1_00: [u16; 198] = [
...
const easf_filter_3tap_64p_ratio_0_30_s1_12: [u16; 99] = [
...
const easf_filter_3tap_64p_ratio_0_40_s1_12: [u16; 99] = [
0x0800, 0x0800, 0x0000,
0x07d8, 0x0818, 0x0010,
...
const easf_filter_3tap_64p_ratio_0_50_s1_12: [u16; 99] = [
0x0800, 0x0800, 0x0000,
...
const easf_filter_3tap_64p_ratio_0_60_s1_12: [u16; 99] = [
0x0800, 0x0800, 0x0000,
...
const easf_filter_3tap_64p_ratio_0_70_s1_12: [u16; 99] = [
0x0800, 0x0800, 0x0000,
...
const easf_filter_3tap_64p_ratio_0_80_s1_12: [u16; 99] = [
0x0800, 0x0800, 0x0000,
...
const easf_filter_3tap_64p_ratio_0_90_s1_12: [u16; 99] = [
0x0800, 0x0800, 0x0000,
...
const easf_filter_3tap_64p_ratio_1_00_s1_12: [u16; 99] = [
0x0800, 0x0800, 0x0000,
...
const easf_filter_4tap_64p_ratio_0_30_s1_12: [u16; 132] = [
...
const easf_filter_4tap_64p_ratio_0_40_s1_12: [u16; 132] = [
...
const easf_filter_4tap_64p_ratio_0_50_s1_12: [u16; 132] = [
...
const easf_filter_4tap_64p_ratio_0_60_s1_12: [u16; 132] = [
...
const easf_filter_4tap_64p_ratio_0_70_s1_12: [u16; 132] = [
...
const easf_filter_4tap_64p_ratio_0_80_s1_12: [u16; 132] = [
...
const easf_filter_4tap_64p_ratio_0_90_s1_12: [u16; 132] = [
...
const easf_filter_4tap_64p_ratio_1_00_s1_12: [u16; 132] = [
...
const easf_filter_6tap_64p_ratio_0_30_s1_12: [u16; 198] = [
...
const easf_filter_6tap_64p_ratio_0_40_s1_12: [u16; 198] = [
...
const easf_filter_6tap_64p_ratio_0_50_s1_12: [u16; 198] = [
...
const easf_filter_6tap_64p_ratio_0_60_s1_12: [u16; 198] = [
...
const easf_filter_6tap_64p_ratio_0_70_s1_12: [u16; 198] = [
...
const easf_filter_6tap_64p_ratio_0_80_s1_12: [u16; 198] = [
...
const easf_filter_6tap_64p_ratio_0_90_s1_12: [u16; 198] = [
...
const easf_filter_6tap_64p_ratio_1_00_s1_12: [u16; 198] = [
