...
// Translated from dc_spl_scl_filters.c. External types, functions, and macros are supplied by dependent modules.
...
// <CoefOut>     = 1.12
//=========================================
static filter_3tap_64p_upscale[99] = [
...
// <CoefOut>     = 1.12
//=========================================
static filter_4tap_64p_upscale[132] = [
...
// <CoefOut>     = 1.12
//=========================================
static filter_4tap_64p_116[132] = [
...
// <CoefOut>     = 1.12
//=========================================
static filter_4tap_64p_149[132] = [
...
// <CoefOut>     = 1.12
//=========================================
static filter_4tap_64p_183[132] = [
...
// <CoefOut>     = 1.12
//=========================================
static filter_5tap_64p_upscale[165] = [
...
// <CoefOut>     = 1.12
//=========================================
static filter_5tap_64p_116[165] = [
...
// <CoefOut>     = 1.12
//=========================================
static filter_5tap_64p_149[165] = [
...
// <CoefOut>     = 1.12
//=========================================
static filter_5tap_64p_183[165] = [
...
// <CoefOut>     = 1.12
//=========================================
static filter_6tap_64p_upscale[198] = [
...
// <CoefOut>     = 1.12
//=========================================
static filter_6tap_64p_116[198] = [
...
// <CoefOut>     = 1.12
//=========================================
static filter_6tap_64p_149[198] = [
...
// <CoefOut>     = 1.12
//=========================================
static filter_6tap_64p_183[198] = [
...
// <CoefOut>     = 1.12
//=========================================
static filter_7tap_64p_upscale[231] = [
...
// <CoefOut>     = 1.12
//=========================================
static filter_7tap_64p_116[231] = [
...
// <CoefOut>     = 1.12
//=========================================
static filter_7tap_64p_149[231] = [
...
// <CoefOut>     = 1.12
//=========================================
static filter_7tap_64p_183[231] = [
...
// <CoefOut>     = 1.12
//=========================================
static filter_8tap_64p_upscale[264] = [
...
// <CoefOut>     = 1.12
//=========================================
static filter_8tap_64p_116[264] = [
...
// <CoefOut>     = 1.12
//=========================================
static filter_8tap_64p_149[264] = [
...
// <CoefOut>     = 1.12
//=========================================
static filter_8tap_64p_183[264] = [
...
static *spl_get_filter_3tap_64p(spl_fixed31_32 ratio)
{
...
static *spl_get_filter_4tap_64p(spl_fixed31_32 ratio)
{
	if (ratio.value < spl_fixpt_one.value)
...
static *spl_get_filter_5tap_64p(spl_fixed31_32 ratio)
{
	if (ratio.value < spl_fixpt_one.value)
...
static *spl_get_filter_6tap_64p(spl_fixed31_32 ratio)
{
	if (ratio.value < spl_fixpt_one.value)
...
static *spl_get_filter_7tap_64p(spl_fixed31_32 ratio)
{
	if (ratio.value < spl_fixpt_one.value)
...
static *spl_get_filter_8tap_64p(spl_fixed31_32 ratio)
{
	if (ratio.value < spl_fixpt_one.value)
...
static *spl_get_filter_2tap_64p(void)
{
	return filter_2tap_64p.as_ptr();
}

const u16 *spl_dscl_get_filter_coeffs_64p(
