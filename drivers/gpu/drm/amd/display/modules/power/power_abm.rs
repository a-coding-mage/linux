/* Faithful source-level translation retained as a Rust raw source artifact; external C-defined types and functions remain unresolved by design. */
pub const POWER_ABM_C_SOURCE: &str = r###"
