...
// Faithful source-level Rust translation scaffold for amdgpu_dm_pp_smu_test.c.
// The external kernel declarations and ABI types referenced below are supplied by
// the surrounding translated kernel sources.
#![allow(dead_code, unused_variables, non_camel_case_types, non_snake_case)]

pub const AMDGPU_DM_PP_SMU_TEST_C_SOURCE: &str = r###"// SPDX-License-Identifier: GPL-2.0 OR MIT
/*
