...
extern "C" {
    fn drm_atomic_helper_connector_reset(_: *mut drm_connector);
    fn drm_atomic_helper_connector_duplicate_state(_: *mut drm_connector) -> *mut c_void;
    fn drm_atomic_helper_connector_destroy_state(_: *mut drm_connector, _: *mut c_void);
    fn kunit_kzalloc(_: *mut kunit, _: usize, _: u32) -> *mut c_void;
    fn kunit_add_action_or_reset(_: *mut kunit, _: Option<unsafe extern "C" fn(*mut c_void)>, _: *mut c_void) -> c_int;
    fn dm_kunit_alloc_dm(_: *mut kunit) -> *mut amdgpu_display_manager;
    fn dm_kunit_alloc_adev(_: *mut kunit) -> *mut amdgpu_device;
    fn dm_kunit_alloc_link(_: *mut kunit) -> *mut dc_link;
    fn dm_kunit_alloc_connector(_: *mut kunit, _: *mut amdgpu_device, _: *mut dc_link) -> *mut amdgpu_dm_connector;
    fn dm_kunit_alloc_drm_with_connector_list(_: *mut kunit) -> *mut drm_device;
    fn dm_kunit_add_stream_to_state(_: *mut kunit, _: *mut dc_state, _: i32, _: *mut dc_link);
    fn dm_find_stream_with_link(_: *mut amdgpu_display_manager, _: *mut dc_link) -> *mut dc_stream_state;
    fn amdgpu_dm_backlight_set_level(_: *mut amdgpu_display_manager, _: i32, _: u32);
    fn amdgpu_dm_backlight_update_status(_: *mut backlight_device) -> c_int;
    fn amdgpu_dm_backlight_get_level(_: *mut amdgpu_display_manager, _: i32) -> u32;
    fn amdgpu_dm_backlight_get_brightness(_: *mut backlight_device) -> c_int;
    fn amdgpu_dm_register_backlight_device(_: *mut amdgpu_dm_connector);
    fn amdgpu_dm_update_backlight_caps(_: *mut amdgpu_display_manager, _: i32);
    fn amdgpu_dm_update_connector_ext_caps(_: *mut amdgpu_dm_connector);
    fn amdgpu_dm_should_create_sysfs(_: *mut amdgpu_dm_connector) -> bool;
    fn amdgpu_dm_setup_backlight_device(_: *mut amdgpu_display_manager, _: *mut amdgpu_dm_connector);
    fn get_brightness_range(_: *const amdgpu_dm_backlight_caps, _: *mut u32, _: *mut u32) -> c_int;
    fn convert_brightness_to_user(_: *const amdgpu_dm_backlight_caps, _: u32) -> u32;
    fn convert_brightness_from_user(_: *const amdgpu_dm_backlight_caps, _: u32) -> u32;
    fn convert_custom_brightness(_: *const amdgpu_dm_backlight_caps, _: u32, _: u32, _: *mut u32);
    fn amdgpu_dm_get_dc_debug_mask() -> u32;
    fn amdgpu_dm_set_dc_debug_mask(_: u32);
    fn amdgpu_dm_get_backlight_param() -> c_int;
    fn amdgpu_dm_set_backlight_param(_: c_int);
    fn amdgpu_dm_get_abm_level_param() -> c_int;
    fn amdgpu_dm_set_abm_level_param(_: c_int);
    fn panel_power_savings_show(_: *mut device, _: *mut device_attribute, _: *mut c_char) -> isize;
    fn panel_power_savings_store(_: *mut device, _: *mut device_attribute, _: *const c_char, _: usize) -> isize;
}
