...
extern "C" { pub fn amdgpu_gmc_is_pdb0_enabled(_: *mut amdgpu_device)->bool; pub fn amdgpu_gmc_pdb0_alloc(_: *mut amdgpu_device)->i32; pub fn amdgpu_gmc_get_pde_for_bo(_: *mut amdgpu_bo,_: i32,_: *mut u64,_: *mut u64); pub fn amdgpu_gmc_set_pte_pde(_: *mut amdgpu_device,_: *mut core::ffi::c_void,_: u32,_: u64,_: u64)->i32; pub fn amdgpu_gmc_pd_addr(_: *mut amdgpu_bo)->u64; pub fn amdgpu_gmc_agp_addr(_: *mut ttm_buffer_object)->u64; }
extern "C" {
    pub fn amdgpu_gmc_sysvm_location(_: *mut amdgpu_device,_: *mut amdgpu_gmc); pub fn amdgpu_gmc_vram_location(_: *mut amdgpu_device,_: *mut amdgpu_gmc,_: u64); pub fn amdgpu_gmc_gart_location(_: *mut amdgpu_device,_: *mut amdgpu_gmc,_: amdgpu_gart_placement); pub fn amdgpu_gmc_agp_location(_: *mut amdgpu_device,_: *mut amdgpu_gmc); pub fn amdgpu_gmc_set_agp_default(_: *mut amdgpu_device,_: *mut amdgpu_gmc);
    pub fn amdgpu_gmc_filter_faults(_: *mut amdgpu_device,_: *mut amdgpu_ih_ring,_: u64,_: u16,_: u64)->bool; pub fn amdgpu_gmc_filter_faults_remove(_: *mut amdgpu_device,_: u64,_: u16);
    pub fn amdgpu_gmc_handle_retry_fault(_: *mut amdgpu_device,_: *mut amdgpu_iv_entry,_: u64,_: u32,_: u32,_: bool)->i32; pub fn amdgpu_gmc_ras_sw_init(_: *mut amdgpu_device)->i32; pub fn amdgpu_gmc_allocate_vm_inv_eng(_: *mut amdgpu_device)->i32;
    pub fn amdgpu_gmc_flush_gpu_tlb(_: *mut amdgpu_device,_: u32,_: u32,_: u32); pub fn amdgpu_gmc_flush_gpu_tlb_pasid(_: *mut amdgpu_device,_: u16,_: u32,_: bool,_: u32)->i32; pub fn amdgpu_gmc_fw_reg_write_reg_wait(_: *mut amdgpu_device,_: u32,_: u32,_: u32,_: u32,_: u32);
    pub fn amdgpu_gmc_tmz_set(_: *mut amdgpu_device); pub fn amdgpu_gmc_noretry_set(_: *mut amdgpu_device); pub fn amdgpu_gmc_set_vm_fault_masks(_: *mut amdgpu_device,_: i32,_: bool); pub fn amdgpu_gmc_init_vga_resv_regions(_: *mut amdgpu_device); pub fn amdgpu_gmc_init_pdb0(_: *mut amdgpu_device); pub fn amdgpu_gmc_vram_mc2pa(_: *mut amdgpu_device,_: u64)->u64; pub fn amdgpu_gmc_vram_pa(_: *mut amdgpu_device,_: *mut amdgpu_bo)->u64; pub fn amdgpu_gmc_vram_checking(_: *mut amdgpu_device)->i32; pub fn amdgpu_gmc_sysfs_init(_: *mut amdgpu_device)->i32; pub fn amdgpu_gmc_sysfs_fini(_: *mut amdgpu_device);
    pub fn amdgpu_gmc_get_nps_memranges(_: *mut amdgpu_device,_: *mut amdgpu_mem_partition_info,_: *mut u8)->i32; pub fn amdgpu_gmc_request_memory_partition(_: *mut amdgpu_device,_: i32)->i32; pub fn amdgpu_gmc_prepare_nps_mode_change(_: *mut amdgpu_device); pub fn amdgpu_gmc_need_reset_on_init(_: *mut amdgpu_device)->bool;
    pub fn amdgpu_gmc_get_vf_memory_partition(_: *mut amdgpu_device)->amdgpu_memory_partition; pub fn amdgpu_gmc_get_memory_partition(_: *mut amdgpu_device,_: *mut u32)->amdgpu_memory_partition; pub fn amdgpu_gmc_query_memory_partition(_: *mut amdgpu_device)->amdgpu_memory_partition; pub fn amdgpu_gmc_init_mem_ranges(_: *mut amdgpu_device)->i32; pub fn amdgpu_gmc_init_sw_mem_ranges(_: *mut amdgpu_device,_: *mut amdgpu_mem_partition_info); pub fn amdgpu_gmc_get_vram_info(_: *mut amdgpu_device,_: *mut i32,_: *mut i32,_: *mut i32)->i32; pub fn amdgpu_gmc_set_gart_size(_: *mut amdgpu_device,_: u64);
}
