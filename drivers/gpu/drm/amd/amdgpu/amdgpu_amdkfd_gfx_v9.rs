...
extern "C" { fn mutex_lock(_: *mut mutex); fn mutex_unlock(_: *mut mutex); fn soc15_grbm_select(_: *mut amdgpu_device,_: u32,_: u32,_: u32,_: u32,_: u32); fn amdgpu_in_reset(_: *mut amdgpu_device)->bool; fn cpu_relax(); fn usleep_range(_: u32,_: u32); fn amdgpu_ip_version(_: *mut amdgpu_device,_: u32,_: u32)->u32; fn amdgpu_amdkfd_is_kfd_vmid(_: *mut amdgpu_device,_: u32)->bool; }
