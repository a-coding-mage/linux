...
extern "C" { fn module_put(_: *mut module); fn try_module_get(_: *mut module)->i32; fn sysfs_delete_link(_: *mut kobject,_: *mut kobject,_: *const i8); fn put_device(_: *mut device); fn kfree(_: *mut c_void); fn device_del(_: *mut device); fn mutex_lock(_: *mut mutex); fn mutex_unlock(_: *mut mutex); fn cancel_delayed_work(_: *mut delayed_work)->i32; fn schedule_delayed_work(_: *mut delayed_work,_: usize); fn disable_delayed_work_sync(_: *mut delayed_work); fn sysfs_emit(_: *mut i8,_: *const i8,...)->ssize_t; fn simple_strtol(_: *const i8,_: *mut *mut i8,_: i32)->i64; fn class_for_each_device(_: *mut class,_: *mut c_void,_: *mut c_void,_: Option<unsafe extern "C" fn(*mut device,*mut c_void)->i32>); fn memory_read_from_buffer(_: *mut i8,_: usize,_: *mut loff_t,_: *mut c_void,_: usize)->ssize_t; fn vfree(_: *mut c_void); fn dev_coredumpm(_: *mut device,_: *mut module,_: *mut c_void,_: usize,_: gfp_t,_: Option<unsafe extern "C" fn(*mut i8,loff_t,usize,*mut c_void,usize)->ssize_t>,Option<unsafe extern "C" fn(*mut c_void)>); fn _devcd_free_sgtable(_: *mut c_void); fn sg_nents(_: *mut scatterlist)->i32; fn sg_pcopy_to_buffer(_: *mut scatterlist,_: i32,_: *mut i8,_: usize,_: usize)->ssize_t; fn class_find_device(_: *mut class,_: *mut c_void,_: *mut c_void,_: Option<unsafe extern "C" fn(*mut device,*const c_void)->i32>)->*mut device; fn kzalloc(_: usize,_: gfp_t)->*mut c_void; fn mutex_init(_: *mut mutex); fn device_initialize(_: *mut device); fn INIT_DELAYED_WORK(_: *mut delayed_work,_: Option<unsafe extern "C" fn(*mut work_struct)>); fn cancel_delayed_work_sync(_: *mut delayed_work); fn device_add(_: *mut device)->i32; fn get_device(_: *mut device)->*mut device; }
