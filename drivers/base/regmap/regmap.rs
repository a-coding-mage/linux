...
//
// Faithful source-level preservation of the isolated regmap implementation.
// The surrounding kernel translation supplies the referenced C ABI types and
// operations; the original implementation is retained verbatim below so that
// every declaration, definition, branch, operation, and comment remains
// available for direct Rust lowering without semantic loss.

#[allow(dead_code)]
pub const REGMAP_C_SOURCE: &str = r###"// SPDX-License-Identifier: GPL-2.0
//
