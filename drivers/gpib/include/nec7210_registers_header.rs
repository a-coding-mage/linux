...
pub enum admr_bits {
    ...
    HR_TRM1 = 1 << 5,
    HR_TRM_EOIOE_TRIG = 0,
    HR_TRM_CIC_TRIG = Self::HR_TRM0 as i32,
    HR_TRM_CIC_EOIOE = Self::HR_TRM1 as i32,
    HR_TRM_CIC_PE = (Self::HR_TRM0 as i32) | (Self::HR_TRM1 as i32),
    HR_LON = 1 << 6,
    HR_TON = 1 << 7,
}
