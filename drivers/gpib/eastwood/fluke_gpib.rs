...
extern "C" {
    fn fluke_read_byte_nolock(_: *mut nec7210_priv,_: c_uint)->u8; fn fluke_write_byte_nolock(_: *mut nec7210_priv,_: u8,_: c_uint);
    fn nec7210_read(_: *mut gpib_board,_: *mut nec7210_priv,_: *mut u8,_: usize,_: *mut c_int,_: *mut usize)->c_int; fn nec7210_write(_: *mut gpib_board,_: *mut nec7210_priv,_: *mut u8,_: usize,_: c_int,_: *mut usize)->c_int; fn nec7210_command(_: *mut gpib_board,_: *mut nec7210_priv,_: *mut u8,_: usize,_: *mut usize)->c_int;
    fn nec7210_take_control(_: *mut gpib_board,_: *mut nec7210_priv,_: c_int)->c_int; fn nec7210_go_to_standby(_: *mut gpib_board,_: *mut nec7210_priv)->c_int; fn nec7210_request_system_control(_: *mut gpib_board,_: *mut nec7210_priv,_: c_int)->c_int; fn nec7210_interface_clear(_: *mut gpib_board,_: *mut nec7210_priv,_: c_int); fn nec7210_remote_enable(_: *mut gpib_board,_: *mut nec7210_priv,_: c_int); fn nec7210_enable_eos(_: *mut gpib_board,_: *mut nec7210_priv,_: u8,_: c_int)->c_int; fn nec7210_disable_eos(_: *mut gpib_board,_: *mut nec7210_priv); fn nec7210_update_status(_: *mut gpib_board,_: *mut nec7210_priv,_: c_uint)->c_uint; fn nec7210_primary_address(_: *mut gpib_board,_: *mut nec7210_priv,_: c_uint)->c_int; fn nec7210_secondary_address(_: *mut gpib_board,_: *mut nec7210_priv,_: c_uint,_: c_int)->c_int; fn nec7210_parallel_poll(_: *mut gpib_board,_: *mut nec7210_priv,_: *mut u8)->c_int; fn nec7210_parallel_poll_configure(_: *mut gpib_board,_: *mut nec7210_priv,_: u8); fn nec7210_parallel_poll_response(_: *mut gpib_board,_: *mut nec7210_priv,_: c_int); fn nec7210_serial_poll_response(_: *mut gpib_board,_: *mut nec7210_priv,_: u8); fn nec7210_serial_poll_status(_: *mut gpib_board,_: *mut nec7210_priv)->u8;
    fn fluke_paged_read_byte(_: *mut fluke_priv,_: c_uint,_: c_uint)->c_int; fn fluke_paged_write_byte(_: *mut fluke_priv,_: u8,_: c_uint,_: c_uint); fn read_byte(_: *mut nec7210_priv,_: c_uint)->u8; fn write_byte(_: *mut nec7210_priv,_: u8,_: c_uint); fn nec7210_t1_delay(_: *mut gpib_board,_: *mut nec7210_priv,_: c_uint)->c_uint; fn nec7210_set_reg_bits(_: *mut nec7210_priv,_: c_uint,_: u8,_: u8); fn nec7210_interrupt_have_status(_: *mut gpib_board,_: *mut nec7210_priv,_: c_int,_: c_int)->irqreturn_t; fn init_nec7210_private(_: *mut nec7210_priv); fn nec7210_board_reset(_: *mut nec7210_priv,_: *mut gpib_board); fn nec7210_set_handshake_mode(_: *mut gpib_board,_: *mut nec7210_priv,_: c_uint); fn nec7210_board_online(_: *mut nec7210_priv,_: *mut gpib_board); fn nec7210_release_rfd_holdoff(_: *mut gpib_board,_: *mut nec7210_priv); fn fluke_reg_offset: c_uint;
}
