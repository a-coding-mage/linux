...
extern "C" {
    ...
    fn nec7210_t1_delay(_: *mut gpib_board,_: *mut nec7210_priv,_: u32)->u32; fn nec7210_set_handshake_mode(_: *mut gpib_board,_: *mut nec7210_priv,_: c_int); fn write_byte(_: *mut nec7210_priv,_: u16,_: u32)->u8; fn read_byte(_: *mut nec7210_priv,_: u32)->u8;
    fn nec7210_set_reg_bits(_: *mut nec7210_priv,_: u32,_: u32,_: u32); fn nec7210_interrupt(_: *mut gpib_board,_: *mut nec7210_priv); fn wake_up_interruptible(_: *mut c_void); fn push_gpib_event(_: *mut gpib_board,_: c_int);
    ...
    fn nec7210_read_data_in(_: *mut gpib_board,_: *mut nec7210_priv,_: *mut c_int); fn nec7210_take_control(_: *mut gpib_board,_: *mut nec7210_priv,_: c_int)->c_int; fn nec7210_go_to_standby(_: *mut gpib_board,_: *mut nec7210_priv)->c_int; fn nec7210_request_system_control(_: *mut gpib_board,_: *mut nec7210_priv,_: c_int)->c_int; fn nec7210_interface_clear(_: *mut gpib_board,_: *mut nec7210_priv,_: c_int); fn nec7210_remote_enable(_: *mut gpib_board,_: *mut nec7210_priv,_: c_int); fn nec7210_enable_eos(_: *mut gpib_board,_: *mut nec7210_priv,_: u8,_: c_int)->c_int; fn nec7210_disable_eos(_: *mut gpib_board,_: *mut nec7210_priv); fn nec7210_update_status_nolock(_: *mut gpib_board,_: *mut nec7210_priv); fn nec7210_primary_address(_: *mut gpib_board,_: *mut nec7210_priv,_: u32)->c_int; fn nec7210_secondary_address(_: *mut gpib_board,_: *mut nec7210_priv,_: u32,_: c_int)->c_int; fn nec7210_parallel_poll(_: *mut gpib_board,_: *mut nec7210_priv,_: *mut u8)->c_int; fn nec7210_parallel_poll_configure(_: *mut gpib_board,_: *mut nec7210_priv,_: u8); fn nec7210_parallel_poll_response(_: *mut gpib_board,_: *mut nec7210_priv,_: c_int); fn nec7210_serial_poll_response(_: *mut gpib_board,_: *mut nec7210_priv,_: u8); fn nec7210_serial_poll_status(_: *mut gpib_board,_: *mut nec7210_priv)->u8; fn nec7210_return_to_local(_: *mut gpib_board,_: *mut nec7210_priv); fn nec7210_board_reset(_: *mut nec7210_priv,_: *mut gpib_board); fn nec7210_board_online(_: *mut nec7210_priv,_: *mut gpib_board); fn init_nec7210_private(_: *mut nec7210_priv);
}
