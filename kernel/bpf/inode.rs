...
extern "C" { fn IS_ERR(p:*mut c_void)->bool;fn ERR_PTR(e:isize)->*mut c_void;fn PTR_ERR(p:*mut c_void)->c_int;fn WARN_ON_ONCE(x:c_int);fn bpf_prog_inc(_: *mut c_void);fn bpf_map_inc_with_uref(_: *mut c_void);fn bpf_link_inc(_: *mut c_void);fn bpf_prog_put(_: *mut c_void);fn bpf_map_put_with_uref(_: *mut c_void);fn bpf_link_put(_: *mut c_void);fn bpf_map_get_with_uref(_: u32)->*mut c_void;fn bpf_prog_get(_: u32)->*mut c_void;fn bpf_link_get_from_fd(_: u32)->*mut c_void;fn new_inode(_: *mut super_block)->*mut inode;fn get_next_ino()->u64;fn simple_inode_init_ts(_: *mut inode);fn inode_init_owner(_: *mut inode,_: *const inode,_: u32);fn d_make_persistent(_: *mut dentry,_: *mut inode);fn inode_set_mtime_to_ts(_: *mut inode,_: *mut c_void);fn inode_set_ctime_current(_: *mut inode)->*mut c_void;fn start_creating_user_path(_: c_int,_: *const c_char,_: *mut path,_: u32)->*mut dentry;fn end_creating_path(_: *mut path,_: *mut dentry);fn current_umask()->u32;fn security_path_mknod(_: *mut path,_: *mut dentry,_: u32,_: u32)->c_int;fn vfs_mkobj(_: *mut dentry,_: u32,_: unsafe fn(*mut dentry,u32,*mut c_void)->c_int,*mut c_void)->c_int; }
