...
extern "C" {
    ...
    fn trace_append_boot_param(_: *mut c_char,_: *const c_char,_: c_char,_: c_uint);
    fn disable_tracing_selftest(_: *const c_char);
    fn trace_probe_is_enabled(_: *mut trace_probe)->bool;
    fn trace_probe_name(_: *mut trace_probe)->*const c_char;
    fn trace_probe_group_name(_: *mut trace_probe)->*const c_char;
    ...
    fn trace_probe_event_call(_: *mut trace_probe)->*mut trace_event_call;
    fn trace_probe_register_event_call(_: *mut trace_probe)->c_int; fn trace_probe_unregister_event_call(_: *mut trace_probe)->c_int;
    fn trace_probe_match_command_args(_: *mut trace_probe,_: c_int,_: *const *const c_char)->bool;
    fn trace_probe_primary_from_call(_: *mut trace_event_call)->*mut trace_probe;
    fn trace_probe_append(_: *mut trace_probe,_: *mut trace_probe)->c_int;
    fn trace_probe_unlink(_: *mut trace_probe); fn trace_probe_compare_arg_type(_: *mut trace_probe,_: *mut trace_probe)->c_int;
    fn trace_probe_load_flag(_: *mut trace_probe)->c_uint; fn trace_probe_set_flag(_: *mut trace_probe,_: c_uint); fn trace_probe_clear_flag(_: *mut trace_probe,_: c_uint);
    fn traceprobe_parse_probe_arg(_: *mut trace_probe,_: c_int,_: *const c_char,_: *mut traceprobe_parse_context)->c_int;
    fn traceprobe_set_print_fmt(_: *mut trace_probe,_: c_int)->c_int;
    fn register_kprobe(_: *mut kprobe)->c_int; fn unregister_kprobe(_: *mut kprobe); fn register_kretprobe(_: *mut kretprobe)->c_int; fn unregister_kretprobe(_: *mut kretprobe);
    fn enable_kprobe(_: *mut kprobe)->c_int; fn disable_kprobe(_: *mut kprobe); fn enable_kretprobe(_: *mut kretprobe)->c_int; fn disable_kretprobe(_: *mut kretprobe);
    fn get_kretprobe(_: *mut kretprobe_instance)->*mut kretprobe; fn get_kretprobe_retaddr(_: *mut kretprobe_instance)->c_ulong;
    fn kallsyms_lookup_name(_: *const c_char)->c_ulong; fn kprobe_on_func_entry(_: *mut c_void,_: *const c_char,_: c_ulong)->c_int;
}
