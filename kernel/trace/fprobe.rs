...
extern "C" {
    ...
    fn ftrace_set_filter_ips(_: *mut ftrace_ops,_: *mut c_ulong,_: c_int,_: c_int,_: c_int)->c_int;
    ...
    fn ftrace_test_recursion_trylock(_: c_ulong,_: c_ulong)->c_int; fn ftrace_test_recursion_unlock(_: c_int);
    ...
    fn ftrace_location(_: c_ulong)->c_ulong; fn ftrace_regs_get_return_address(_: *mut ftrace_regs)->c_ulong; fn ftrace_regs_get_instruction_pointer(_: *mut ftrace_regs)->c_ulong;
    fn fgraph_reserve_data(_: c_int,_: usize)->*mut c_ulong; fn fgraph_retrieve_data(_: c_int,_: *mut c_int)->*mut c_void;
    fn glob_match(_: *const c_char,_: *const c_char)->bool; fn kallsyms_on_each_symbol(_: Option<unsafe extern "C" fn(*mut c_void,*const c_char,c_ulong)->c_int>,*mut c_void)->c_int;
    fn strcmp(_: *const c_char,_: *const c_char)->c_int; fn ftrace_lookup_symbols(_: *mut *const c_char,_: c_int,_: *mut c_ulong)->bool;
    fn register_module_notifier(_: *mut notifier_block)->c_int; fn module_kallsyms_on_each_symbol(_: *mut module,_: Option<unsafe extern "C" fn(*mut c_void,*const c_char,c_ulong)->c_int>,*mut c_void)->c_int;
    fn __module_text_address(_: c_ulong)->*mut module; fn try_module_get(_: *mut module)->bool; fn module_put(_: *mut module);
    fn within_module(_: c_ulong,_: *mut module)->bool;
    fn rhltable_init(_: *mut rhltable,_: *const rhashtable_params)->c_int;
}
