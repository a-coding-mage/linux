...
extern "C" {
    ...
    fn trace_buffer_lock_reserve(_: *mut trace_buffer,_: u32,_: usize,_: usize)->*mut ring_buffer_event;
    fn ring_buffer_event_data(_: *mut ring_buffer_event)->*mut hwlat_entry;
    fn trace_buffer_unlock_commit_nostack(_: *mut trace_buffer,_: *mut ring_buffer_event);
    fn tracing_gen_ctx()->usize; fn latency_fsnotify(_: *mut trace_array);
    fn trace_array_printk_buf(_: *mut trace_buffer,_: usize,_: *const c_char);
    fn cpumask_equal(_: *const cpumask,_: *const cpumask)->bool; fn cpus_read_lock(); fn cpus_read_unlock();
    fn cpumask_and(_: *mut cpumask,_: *const cpumask,_: *const cpumask); fn cpumask_next_wrap(_: c_int,_: *const cpumask)->c_int;
    fn raw_smp_processor_id()->c_int; fn cpumask_clear(_: *mut cpumask); fn cpumask_set_cpu(_: c_int,_: *mut cpumask);
    fn set_cpus_allowed_ptr(_: *mut task_struct,_: *const cpumask); fn kthread_should_stop()->bool;
    fn local_irq_disable(); fn local_irq_enable(); fn msleep_interruptible(_: u64)->c_int;
    fn mutex_lock(_: *mut mutex); fn mutex_unlock(_: *mut mutex); fn kthread_stop(_: *mut task_struct)->c_int;
    fn kthread_create(_: unsafe extern "C" fn(*mut c_void)->c_int,*mut c_void,*const c_char)->*mut task_struct;
    fn wake_up_process(_: *mut task_struct)->c_int; fn cpumask_first(_: *const cpumask)->c_int;
    fn kthread_run_on_cpu(_: unsafe extern "C" fn(*mut c_void)->c_int,*mut c_void,c_uint,*const c_char)->*mut task_struct;
    fn for_each_online_cpu(); fn for_each_cpu(); fn cpu_online(_: c_int)->bool; fn cpumask_test_cpu(_: c_int,_: *const cpumask)->bool;
    fn schedule_work_on(_: c_uint,_: *mut work_struct)->bool; fn cpuhp_setup_state(_: c_int,_: *const c_char,_: unsafe extern "C" fn(c_uint)->c_int,unsafe extern "C" fn(c_uint)->c_int)->c_int;
    fn seq_printf(_: *mut seq_file,_: *const c_char,...)->c_int; fn seq_puts(_: *mut seq_file,_: *const c_char)->c_int;
    fn seq_open(_: *mut file,_: *const c_void)->c_int; fn seq_read(); fn seq_lseek(); fn seq_release();
    fn copy_from_user(_: *mut c_void,_: *const c_void,_: usize)->usize; fn strstrip(_: *mut c_char)->*const c_char; fn strcmp(_: *const c_char,_: *const c_char)->c_int;
    fn tracing_init_dentry()->c_int; fn tracefs_create_dir(_: *const c_char,_: *mut dentry)->*mut dentry; fn tracefs_create_file(_: *const c_char,_: u32,_: *mut dentry,_: *mut c_void,_: *const c_void)->*mut dentry; fn trace_create_file(_: *const c_char,_: u32,_: *mut dentry,_: *mut c_void,_: *const file_operations)->*mut dentry; fn tracefs_remove(_: *mut dentry);
    fn register_tracer(_: *mut tracer)->c_int; fn tracer_tracing_is_on(_: *mut trace_array)->bool; fn mutex_init(_: *mut mutex);
}
