...
extern "C" {
    fn kzalloc_obj<T>() -> *mut T; fn kfree(p:*mut c_void); fn allocate_fgraph_ops(_: *mut trace_array,_: *mut ftrace_ops)->c_int; fn free_fgraph_ops(_: *mut trace_array);
    fn ftrace_create_filter_files(_: *mut ftrace_ops,_: *mut dentry); fn ftrace_destroy_filter_files(_: *mut ftrace_ops);
    fn register_ftrace_function(_: *mut ftrace_ops)->c_int; fn unregister_ftrace_function(_: *mut ftrace_ops)->c_int; fn register_ftrace_command(_: *mut ftrace_func_command)->c_int; fn unregister_ftrace_command(_: *mut ftrace_func_command);
    fn ftrace_init_array_ops(_: *mut trace_array,_: ftrace_func_t); fn ftrace_reset_array_ops(_: *mut trace_array); fn ftrace_test_recursion_trylock(_: usize,_: usize)->c_int; fn ftrace_test_recursion_unlock(_: c_int);
    fn tracing_gen_ctx()->u32; fn tracing_gen_ctx_dec()->u32; fn tracing_gen_ctx_flags(_: usize)->u32; fn trace_function(_: *mut trace_array,_: usize,_: usize,_: u32,_: *mut ftrace_regs); fn __trace_stack(_: *mut trace_array,_: u32,_: c_int);
    fn raw_smp_processor_id()->c_int; fn tracing_start_cmdline_record(); fn tracing_stop_cmdline_record(); fn tracing_reset_online_cpus(_: *mut trace_buffer); fn tracer_tracing_is_on(_: *mut trace_array)->bool; fn tracer_tracing_on(_: *mut trace_array); fn tracer_tracing_off(_: *mut trace_array); fn tracing_is_on()->bool; fn trace_last_func_repeats(_: *mut trace_array,_: *mut trace_func_repeats,_: u32);
    fn ring_buffer_time_stamp(_: *mut c_void)->u64; fn per_cpu_ptr(_: *mut c_void,_: c_int)->*mut trace_array_cpu; fn this_cpu_ptr(_: *mut trace_func_repeats)->*mut trace_func_repeats; fn alloc_percpu<T>() -> *mut T;
    fn ftrace_func_mapper_find_ip(_: *mut c_void,_: usize)->*mut c_void; fn allocate_ftrace_func_mapper()->*mut c_void; fn free_ftrace_func_mapper(_: *mut c_void,_: *mut c_void); fn ftrace_func_mapper_add_ip(_: *mut c_void,_: usize,_: *mut c_void)->c_int; fn ftrace_func_mapper_remove_ip(_: *mut c_void,_: usize);
    fn ftrace_dump(_: c_int); fn seq_printf(_: *mut seq_file,_: *const c_char,...); fn seq_puts(_: *mut seq_file,_: *const c_char); fn kstrtoul(_: *mut c_char,_: c_int,_: *mut usize)->c_int; fn strsep(_: *mut *mut c_char,_: *const c_char)->*mut c_char; fn strlen(_: *const c_char)->usize; fn strcmp(_: *const c_char,_: *const c_char)->c_int; fn register_ftrace_function_probe(_: *mut c_char,_: *mut trace_array,_: *mut ftrace_probe_ops,_: *mut c_void)->c_int; fn unregister_ftrace_function_probe_func(_: *mut c_char,_: *mut trace_array,_: *mut ftrace_probe_ops)->c_int; fn register_tracer(_: *mut tracer)->c_int;
}
