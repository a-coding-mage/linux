/* Faithful low-level Rust translation scaffold. External kernel symbols and exact representations are supplied by dependent modules. */
use core::ffi::c_void;
 
pub unsafe mod translated_source {
