...
extern "C" {
    ...
    fn kho_retrieve_subtree(_: *const c_char, _: *mut u64, _: *mut usize) -> c_int;
    fn phys_to_virt(_: u64) -> *mut c_void;
    fn kho_restore_free(_: *mut luo_ser);
    fn luo_session_setup_incoming(_: u64) -> c_int;
    fn luo_flb_setup_incoming(_: u64);
    fn luo_session_setup_outgoing(_: *mut u64);
    fn luo_flb_setup_outgoing(_: *mut u64) -> c_int;
    fn kho_alloc_preserve(_: usize) -> *mut luo_ser;
    fn kho_unpreserve_free(_: *mut luo_ser);
    fn kho_add_subtree(_: *const c_char, _: *mut luo_ser, _: usize) -> c_int;
    fn luo_session_serialize() -> c_int;
    fn luo_flb_serialize();
    fn luo_session_deserialize() -> c_int;
    fn luo_session_create(_: *const c_char, _: *mut *mut file) -> c_int;
    fn luo_session_retrieve(_: *const c_char, _: *mut *mut file) -> c_int;
    fn luo_ucmd_respond(_: *mut luo_ucmd, _: usize) -> c_int;
    fn get_unused_fd_flags(_: c_uint) -> c_int;
    fn put_unused_fd(_: c_int);
    fn fd_install(_: c_int, _: *mut file);
    fn fput(_: *mut file);
    fn misc_register(_: *mut miscdevice) -> c_int;
    fn atomic_cmpxchg(_: *mut atomic_t, _: c_int, _: c_int) -> c_int;
    fn atomic_set(_: *mut atomic_t, _: c_int);
    fn luo_restore_fail(_: *const c_char, ...);
}
