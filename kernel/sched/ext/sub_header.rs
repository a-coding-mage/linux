...
#[inline] pub unsafe fn scx_rescuee(rq: *mut rq) -> *mut task_struct { lockdep_assert_rq_held(rq); #[cfg(CONFIG_EXT_SUB_SCHED)] { if scx_has_subs() { return (*rq).scx.rescue.curr; } } core::ptr::null_mut() }
