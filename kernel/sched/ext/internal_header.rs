...
/*
 * Direct Rust translation record of sched/ext/internal.h.
 *
 * The original header is retained below as dependency-facing declarations and
 * documentation; C preprocessor directives and include-only material are
 * intentionally represented as comments because their definitions are supplied
