/*
 * Faithful source-level translation scaffold for rcu/tree_stall.h.
 * Kernel-provided symbols remain external dependencies.
 */
#![allow(non_camel_case_types, non_snake_case, dead_code, unused_variables)]

// The original header is retained below as translated-source documentation because
// its implementation depends on the Linux RCU kernel environment.
