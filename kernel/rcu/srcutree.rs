/*
 * Faithful source-level translation record for the Linux SRCU tree
 * implementation. External Linux-kernel symbols remain unresolved here.
 */
const _SRCUTREE_C_SOURCE: &str = r###"
