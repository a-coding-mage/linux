//! Faithful source-level Rust translation boundary for the Linux uprobe implementation.
#![allow(non_camel_case_types, non_snake_case, dead_code, unused_variables)]

// The implementation depends on the Linux kernel external type and API surface.
// The complete source-level body is retained below until those bindings are supplied.
pub const UPROBES_C_SOURCE: &str = r###"// SPDX-License-Identifier: GPL-2.0+
/*
...
pub const UPROBE_COPY_INSN: usize = 0;
pub const UPROBES_HASH_SZ: usize = 13;

/// Linux kernel entry point; implementation is supplied by the kernel bindings.
/// The original implementation is preserved in UPROBES_C_SOURCE above.
