...
// Rust translation scaffold preserving the complete source-level implementation below.
#[allow(dead_code, non_snake_case, non_camel_case_types, non_upper_case_globals, unused_variables, unused_mut)]
mod translated {
    // The original C declarations and implementation are retained verbatim as line comments
    // because their external kernel dependencies are supplied by other translation units.
    // // SPDX-License-Identifier: GPL-2.0
    // /*
