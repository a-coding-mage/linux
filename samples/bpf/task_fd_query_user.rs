...
extern "C" {
    ...
    fn snprintf(_: *mut i8, _: usize, _: *const i8, ...) -> i32; fn perror(_: *const i8); fn open(_: *const i8, _: i32, ...) -> i32; fn read(_: i32,_: *mut core::ffi::c_void,_: usize)->isize; fn close(_: i32)->i32; fn strtol(_: *const i8,_: *mut *mut i8,_: i32)->i64; fn strlen(_: *const i8)->usize; fn strcmp(_: *const i8,_: *const i8)->i32; fn write(_: i32,_: *const core::ffi::c_void,_: usize)->isize; fn getpid()->i32; fn __errno_location()->*mut i32;
    fn load_kallsyms()->i32; fn sys_perf_event_open(_: *const perf_event_attr,_: i32,_: i32,_: i32,_: u64)->i32; fn bpf_task_fd_query(_: i32,_: i32,_: u32,_: *mut i8,_: *mut u32,_: *mut u32,_: *mut u32,_: *mut u64,_: *mut u64)->i32; fn bpf_link__fd(_: *mut bpf_link)->i32; fn bpf_program__attach_perf_event(_: *mut bpf_program,_: i32)->*mut bpf_link; fn bpf_program__attach(_: *mut bpf_program)->*mut bpf_link; fn libbpf_get_error(_: *const core::ffi::c_void)->i64; fn bpf_link__destroy(_: *mut bpf_link); fn bpf_object__open_file(_: *const i8,_: *const core::ffi::c_void)->*mut bpf_object; fn bpf_object__load(_: *mut bpf_object)->i32; fn bpf_object__next_program(_: *mut bpf_object,_: *mut *mut bpf_program)->i32; fn bpf_object__close(_: *mut bpf_object);
}
