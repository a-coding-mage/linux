...
extern "C" { fn libbpf_num_possible_cpus()->u32; fn bpf_num_possible_cpus()->u32; fn bpf_map__fd(_: *mut bpf_map)->i32; fn bpf_program__fd(_: *mut bpf_program)->i32; fn bpf_program__name(_: *mut bpf_program)->*const i8; fn bpf_map__set_max_entries(_: *mut bpf_map,_: usize)->i32; fn bpf_xdp_attach(_: i32,_: i32,_: u32,_: *mut c_void)->i32; fn bpf_xdp_query_id(_: i32,_: u32,_: *mut u32)->i32; fn bpf_xdp_detach(_: i32,_: u32,_: *mut c_void)->i32; fn mmap(_: *mut c_void,_: usize,_: i32,_: i32,_: i32,_: isize)->*mut c_void; fn munmap(_: *mut c_void,_: usize)->i32; }
...
#[repr(C)] struct libc_timespec { tv_sec:i64,tv_nsec:i64 } extern "C" { fn clock_gettime(_: i32,_: *mut libc_timespec)->i32; }
...
extern "C" { fn libc_calloc(_: usize,_: usize)->*mut c_void; fn libc_free(_: *mut c_void); }
