/*
 * Faithful source-preserving Rust translation boundary for percpu.c.
 *
 * This implementation is tightly coupled to Linux kernel headers and
 * generated declarations supplied by the surrounding kernel build.  The
 * complete original implementation is retained below as Rust documentation
 * text so that every declaration, definition, operation, and comment remains
