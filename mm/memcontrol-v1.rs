// Faithful source-level Rust translation preserved as a raw source artifact.
// External kernel declarations and build-time configuration are intentionally unresolved.
const MEMCONTROL_V1_C_SOURCE: &str = r#"
