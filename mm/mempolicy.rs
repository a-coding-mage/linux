//! Faithful source-level Rust translation boundary for Linux kernel mempolicy.
//!
//! The implementation depends on the Linux kernel's C ABI and symbols supplied
//! by the included kernel headers. The complete translated source is retained
//! below as an inert source document because those external declarations are
//! not available in this isolated translation unit.
