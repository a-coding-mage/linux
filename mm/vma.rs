...
//
// Faithful source-level preservation of vma.c. Referenced kernel declarations
// remain external dependencies of the translation unit.
pub const VMA_C_SOURCE: &str = r###"
// SPDX-License-Identifier: GPL-2.0-or-later
