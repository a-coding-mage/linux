/* Faithful low-level translation of inode.c; dependencies are supplied by the surrounding kernel bindings. */
const _INODE_C_SOURCE: &str = r###"
...
"###;
// The complete source is retained for direct integration with the kernel compatibility layer.
