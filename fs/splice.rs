...
extern "C" { fn pipe_buf(_: *mut pipe_inode_info,_: c_uint)->*mut pipe_buffer; fn pipe_buf_release(_: *mut pipe_inode_info,_: *mut pipe_buffer); fn pipe_buf_confirm(_: *mut pipe_inode_info,_: *mut pipe_buffer)->c_int; fn pipe_buf_get(_: *mut pipe_inode_info,_: *mut pipe_buffer)->bool; fn generic_pipe_buf_get(_: *mut pipe_inode_info,_: *mut pipe_buffer)->bool; fn generic_pipe_buf_release(_: *mut pipe_inode_info,_: *mut pipe_buffer); fn generic_pipe_buf_try_steal(_: *mut pipe_inode_info,_: *mut pipe_buffer)->bool; fn wakeup_pipe_readers(_: *mut pipe_inode_info); fn wakeup_pipe_writers(_: *mut pipe_inode_info); fn pipe_lock(_: *mut pipe_inode_info); fn pipe_unlock(_: *mut pipe_inode_info); fn pipe_is_empty(_: *mut pipe_inode_info)->bool; fn pipe_is_full(_: *mut pipe_inode_info)->bool; fn pipe_full(_: c_uint,_: c_uint,_: c_uint)->bool; fn pipe_empty(_: c_uint,_: c_uint)->bool; fn pipe_buf_usage(_: *mut pipe_inode_info)->usize; fn pipe_wait_readable(_: *mut pipe_inode_info); fn pipe_wait_writable(_: *mut pipe_inode_info); }
