...
extern "C" {
    ...
    fn ovl_copy_up(_: *mut dentry)->c_int; fn ovl_want_write(_: *mut dentry)->c_int; fn ovl_drop_write(_: *mut dentry); fn ovl_new_inode(_: *mut super_block,_: umode_t,_: dev_t)->*mut inode; fn ovl_create_or_link(_: *mut dentry,_: *mut inode,_: *mut ovl_cattr,_: bool)->c_int;
    fn ovl_do_rmdir(_: *mut ovl_fs,_: *mut inode,_: *mut dentry)->c_int; fn ovl_do_unlink(_: *mut ovl_fs,_: *mut inode,_: *mut dentry)->c_int; fn ovl_do_whiteout(_: *mut ovl_fs,_: *mut inode,_: *mut dentry)->c_int; fn ovl_do_link(_: *mut ovl_fs,_: *mut dentry,_: *mut inode,_: *mut dentry)->c_int; fn ovl_do_create(_: *mut ovl_fs,_: *mut inode,_: *mut dentry,_: umode_t)->c_int; fn ovl_do_mkdir(_: *mut ovl_fs,_: *mut inode,_: *mut dentry,_: umode_t)->*mut dentry; fn ovl_do_mknod(_: *mut ovl_fs,_: *mut inode,_: *mut dentry,_: umode_t,_: dev_t)->c_int; fn ovl_do_symlink(_: *mut ovl_fs,_: *mut inode,_: *mut dentry,_: *const c_char)->c_int;
    fn dget(_: *mut dentry)->*mut dentry; fn dput(_: *mut dentry); fn d_drop(_: *mut dentry); fn iput(_: *mut inode); fn d_inode(_: *mut dentry)->*mut inode; fn ovl_dentry_upper(_: *mut dentry)->*mut dentry; fn ovl_workdir(_: *mut dentry)->*mut dentry; fn ovl_upper_mnt_idmap(_: *mut ovl_fs)->*mut mnt_idmap; fn ovl_cleanup(_: *mut ovl_fs,_: *mut dentry,_: *mut dentry)->c_int;
}
