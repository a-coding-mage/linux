/*
// Faithful source-level translation of jbd2/transaction.c.
...
// The implementation depends on the Linux kernel/JBD2 ABI and symbols supplied by other translation units.

extern "C" {
    pub fn jbd2_journal_init_transaction_cache() -> ::std::os::raw::c_int;
    pub fn jbd2_journal_destroy_transaction_cache();
    pub fn jbd2_journal_free_transaction(transaction: *mut ::std::ffi::c_void);
}
