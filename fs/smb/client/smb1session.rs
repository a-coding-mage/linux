...
extern "C" { fn small_smb_init_no_tc(_:u32, _:i32, _:*mut cifs_ses, _: *mut *mut c_void)->i32; fn cifs_small_buf_release(_: *mut c_void); fn free_rsp_buf(_:i32,_: *mut c_void); fn kmalloc(_:usize,_: i32)->*mut c_void; fn kfree_sensitive(_: *mut c_void); fn kfree(_: *mut c_void); fn SendReceive2(_:u32,_: *mut cifs_ses,_: *mut kvec,_: i32,_: *mut i32,_: i32,_: *mut kvec)->i32; fn cifs_select_sectype(_: *mut TCP_Server_Info,_: i32)->i32; fn setup_ntlmv2_rsp(_: *mut cifs_ses,_: *mut nls_table)->i32; fn cifs_server_lock(_: *mut TCP_Server_Info); fn cifs_server_unlock(_: *mut TCP_Server_Info); fn memzero_explicit(_: *mut c_void,_: usize); fn put_bcc(_: u16,_: *mut smb_hdr); fn get_bcc(_: *mut smb_hdr)->u16; fn pByteArea(_: *mut smb_hdr)->*mut i8; fn smb_EIO1(_: i32,_: u8)->i32; fn build_ntlmssp_negotiate_blob(_: *mut *mut u8, _: *mut u16, _: *mut cifs_ses, _: *mut TCP_Server_Info, _: *mut nls_table)->i32; fn build_ntlmssp_auth_blob(_: *mut *mut u8, _: *mut u16, _: *mut cifs_ses, _: *mut TCP_Server_Info, _: *mut nls_table)->i32; fn decode_ntlmssp_challenge(_: *mut i8,_: u16,_: *mut cifs_ses)->i32 }
