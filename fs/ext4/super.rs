...
/// Faithful source-level translation container for ext4/super.c.
///
/// The referenced Linux kernel types, functions, macros, and configuration
/// symbols remain external dependencies, as they are in the original source.
pub const EXT4_SUPER_C_SOURCE: &str = r########"
