...
// Faithful low-level Rust translation boundary for linux/fs/ext4/namei.c.
// Kernel-provided types, functions, constants, macros, and configuration
// symbols remain external dependencies of this translation.
//
// The original implementation is retained verbatim below so that all
// declarations, control flow, comments, and ABI-relevant details remain
// available while the surrounding kernel bindings are supplied by the target
// build.

pub const NAMEI_C_SOURCE: &str = r###"// SPDX-License-Identifier: GPL-2.0
/*
...
// The implementation requires the Linux kernel's generated bindings and
// configuration-selected declarations. Those dependencies are intentionally
// not recreated in this isolated translation pass.
