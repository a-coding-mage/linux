...
extern "C" { fn printk(fmt:*const c_char,...); fn nilfs_prepare_super(_: *mut super_block,_: c_int)->*mut *mut nilfs_super_block; fn nilfs_commit_super(_: *mut super_block,_: c_int)->c_int; fn nilfs_sync_super(_: *mut super_block,_: c_int)->c_int; fn nilfs_count_free_blocks(_: *mut the_nilfs,_: *mut u64)->c_int; fn nilfs_set_log_cursor(_: *mut nilfs_super_block,_: *mut the_nilfs); fn nilfs_test_opt(_: *mut the_nilfs,_: usize)->bool; fn nilfs_cleanup_super(_: *mut super_block)->c_int; fn nilfs_construct_segment(_: *mut super_block)->c_int; fn nilfs_flush_device(_: *mut the_nilfs)->c_int; fn nilfs_attach_checkpoint(_: *mut super_block,_: u64,_: c_int,_: *mut *mut nilfs_root)->c_int; fn nilfs_put_root(_: *mut nilfs_root); fn nilfs_find_or_create_root(_: *mut the_nilfs,_: u64)->*mut nilfs_root; fn nilfs_ifile_read(_: *mut super_block,_: *mut nilfs_root,_: u64,_: u32)->c_int; fn nilfs_iget(_: *mut super_block,_: *mut nilfs_root,_: u64)->*mut inode; fn nilfs_ilookup(_: *mut super_block,_: *mut nilfs_root,_: u64)->*mut inode; fn nilfs_lookup_root(_: *mut the_nilfs,_: u64)->*mut nilfs_root; fn nilfs_last_cno(_: *mut the_nilfs)->u64; fn nilfs_alloc_inode(_: *mut super_block)->*mut inode; fn alloc_inode_sb(_: *mut super_block,_: *mut kmem_cache,_: usize)->*mut nilfs_inode_info; fn kmem_cache_free(_: *mut kmem_cache,_: *mut nilfs_inode_info); }
