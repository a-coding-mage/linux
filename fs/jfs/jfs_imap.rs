...
// Faithful source translation retained verbatim below; external kernel symbols are
// intentionally unresolved and are supplied by the surrounding repository.
