// Faithful source-level translation of jfs_txnmgr.c.
// External kernel/JFS types, constants, macros, and functions are supplied by other translation units.
const _JFS_TXNMGR_C_SOURCE: &str = r###"
