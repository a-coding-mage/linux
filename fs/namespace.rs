// Faithful source-preserving Rust translation scaffold.
// The original implementation is retained line-for-line below as dependency-facing
// reference comments; Linux kernel symbols are supplied by the surrounding crate.
