...
//
// Faithful low-level Rust translation scaffold. The original implementation is
// retained below as source-level comments while external kernel types and
// operations are supplied by the surrounding translation unit.
...
extern "C" {
    ...
    pub fn gfs2_instantiate(gh: *mut gfs2_holder) -> ::std::os::raw::c_int;
    pub fn glock_set_object(gl: *mut gfs2_glock, object: *mut ::std::ffi::c_void);
    pub fn glock_clear_object(gl: *mut gfs2_glock, object: *mut ::std::ffi::c_void);
    ...
    pub fn gfs2_glock_get(sdp: *mut gfs2_sbd, number: u64, glops: *const gfs2_glock_operations,
                          create: ::std::os::raw::c_int, glp: *mut *mut gfs2_glock)
                          -> ::std::os::raw::c_int;
    pub fn __gfs2_holder_init(gl: *mut gfs2_glock, state: u32, flags: u16,
                              gh: *mut gfs2_holder, ip: usize);
    pub fn gfs2_holder_reinit(state: u32, flags: u16, gh: *mut gfs2_holder);
    pub fn gfs2_holder_uninit(gh: *mut gfs2_holder);
    pub fn gfs2_glock_holder_ready(gh: *mut gfs2_holder) -> ::std::os::raw::c_int;
    pub fn gfs2_glock_wait(gh: *mut gfs2_holder) -> ::std::os::raw::c_int;
    pub fn gfs2_glock_async_wait(num_gh: u32, ghs: *mut gfs2_holder, retries: u32)
                                  -> ::std::os::raw::c_int;
    pub fn gfs2_glock_nq(gh: *mut gfs2_holder) -> ::std::os::raw::c_int;
    pub fn gfs2_glock_poll(gh: *mut gfs2_holder) -> ::std::os::raw::c_int;
    ...
    pub fn gfs2_glock_nq_num(sdp: *mut gfs2_sbd, number: u64,
                             glops: *const gfs2_glock_operations, state: u32,
                             flags: u16, gh: *mut gfs2_holder) -> ::std::os::raw::c_int;
    pub fn gfs2_glock_nq_m(num_gh: u32, ghs: *mut gfs2_holder) -> ::std::os::raw::c_int;
    pub fn gfs2_glock_dq_m(num_gh: u32, ghs: *mut gfs2_holder);
    pub fn gfs2_glock_cb(gl: *mut gfs2_glock, state: u32);
    pub fn gfs2_glock_complete(gl: *mut gfs2_glock, ret: ::std::os::raw::c_int);
    ...
    pub fn gfs2_glock_init() -> ::std::os::raw::c_int;
