...
// Faithful source-level translation boundary for the isolated Linux kernel implementation.
// Referenced kernel types, globals, macros, and functions are supplied by other files.
/*
