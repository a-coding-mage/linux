//! Faithful Rust-side preservation of the Linux NFSv4 tracepoint header.
//!
//! The declarations below are retained verbatim as line comments because the
//! source is a kernel tracepoint DSL whose TRACE_EVENT machinery is supplied
//! by the surrounding kernel build, not by Rust. This keeps every field,
//! assignment, format string, conditional, and dependency visible for the
//! corresponding Rust tracepoint bindings.

#![allow(non_camel_case_types, non_snake_case, dead_code)]

/// Source-level tracepoint declarations preserved from nfs4trace.h.
pub mod source {
