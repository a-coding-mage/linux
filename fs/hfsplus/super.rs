...
extern "C" {
    fn hfsplus_inode_read_fork(_: *mut inode, _: *mut hfsplus_fork_raw); fn hfsplus_inode_write_fork(_: *mut inode,_: *mut hfsplus_fork_raw); fn iget_locked(_: *mut super_block,_: u64)->*mut inode; fn inode_state_read_once(_: *mut inode)->u32; fn hfs_find_init(_: *mut hfs_btree,_: *mut hfs_find_data)->i32; fn hfs_find_exit(_: *mut hfs_find_data); fn hfsplus_find_cat(_: *mut super_block,_: u64,_: *mut hfs_find_data)->i32; fn hfsplus_cat_read_inode(_: *mut inode,_: *mut hfs_find_data)->i32; fn iget_failed(_: *mut inode); fn unlock_new_inode(_: *mut inode); fn hfsplus_ext_write_extent(_: *mut inode)->i32; fn hfsplus_cat_write_inode(_: *mut inode)->i32; fn truncate_inode_pages_final(_: *mut address_space); fn clear_inode(_: *mut inode); fn iput(_: *mut inode); fn hfsplus_submit_bio(_: *mut super_block,_: u64,_: *mut core::ffi::c_void,_: *mut core::ffi::c_void,_: u32)->i32; fn filemap_write_and_wait(_: *mut address_space)->i32; fn hfs_btree_write(_: *mut hfs_btree)->i32; fn hfs_btree_close(_: *mut hfs_btree); fn hfsplus_read_wrapper(_: *mut super_block)->i32; fn hfs_btree_open(_: *mut super_block,_: u64)->*mut hfs_btree; fn hfsplus_new_inode(_: *mut super_block,_: *mut inode,_: u32)->*mut inode; fn hfsplus_create_cat(_: u64,_: *mut inode,_: *mut qstr,_: *mut inode)->i32; fn hfsplus_delete_cat(_: u64,_: *mut inode,_: *mut qstr); fn hfsplus_init_security(_: *mut inode,_: *mut inode,_: *mut qstr)->i32; fn hfsplus_mark_inode_dirty(_: *mut inode,_: u32); fn hfsplus_cat_build_key(_: *mut super_block,_: *mut core::ffi::c_void,_: u32,_: *const qstr)->i32; fn hfsplus_brec_read_cat(_: *mut hfs_find_data,_: *mut hfsplus_cat_entry)->i32; fn load_nls(_: *const i8)->*mut nls_table; fn load_nls_default()->*mut nls_table; fn unload_nls(_: *mut nls_table); fn sync_filesystem(_: *mut super_block); fn blkdev_issue_flush(_: *mut block_device); fn d_make_root(_: *mut inode)->*mut dentry; fn dput(_: *mut dentry); fn kill_block_super(_: *mut super_block); fn call_rcu(_: *mut rcu_head, _: *const core::ffi::c_void); fn register_filesystem(_: *mut file_system_type)->i32; fn unregister_filesystem(_: *mut file_system_type); fn rcu_barrier(); fn hfsplus_create_attr_tree_cache()->i32; fn hfsplus_destroy_attr_tree_cache(); fn kmem_cache_create(_: *const i8,_: usize,_: u32,_: u32,_: *const core::ffi::c_void)->*mut kmem_cache; fn kmem_cache_destroy(_: *mut kmem_cache); fn alloc_inode_sb(_: *mut super_block,_: *mut kmem_cache,_: u32)->*mut hfsplus_inode_info; fn kmem_cache_free(_: *mut kmem_cache,_: *mut hfsplus_inode_info); fn inode_init_once(_: *mut inode); fn get_tree_bdev(_: *mut fs_context, _: *const core::ffi::c_void)->i32; fn hfsplus_parse_param(); fn hfsplus_fill_defaults(_: *mut hfsplus_sb_info); fn hfsplus_show_options(); fn hfsp_now2mt()->u32; fn hfsplus_btree_lock_class(_: *mut hfs_btree)->*const core::ffi::c_void;
}
