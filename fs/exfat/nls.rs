...
// dependency: <linux/buffer_head.h>
// dependency: <linux/unaligned.h>

// dependency: "exfat_raw.h"
// dependency: "exfat_fs.h"

/* Upcase table macro */
const EXFAT_NUM_UPCASE: usize = 2918;
 ...
 */
static UNI_DEF_UPCASE: [u16; EXFAT_NUM_UPCASE] = [
		...
		u32 utbl_checksum)
{
	...
	upcase_table = kvcalloc(UTBL_COUNT, sizeof(u16), GFP_KERNEL);
	if (!upcase_table)
