// Translated from linux/fs/nls/nls_cp737.c.\n\n/*
...
static PAGE_UNI2CHARSET: [Option<&[u8]>; 39] = [
	Some(page00), None,   None,   Some(page03), None,   None,   None,   None,   
	None,   None,   None,   None,   None,   None,   None,   None,   
	None,   None,   None,   None,   None,   None,   None,   None,   
	None,   None,   None,   None,   None,   None,   None,   None,   
	Some(page20), None,   Some(page22), None,   None,   Some(page25), None,   None,   
};
...
unsafe fn uni2char(uni: u32, out: *mut u8, boundlen: i32)
{
	...
	if let Some(page) = uni2charset { if page[cl] != 0 { *out = page[cl]; } } else
	else { return -EINVAL; }
	return 1;\n}
...
static mut table: NlsTable = NlsTable { charset: b"cp737\\0".as_ptr(), uni2char: Some(uni2char), char2uni: Some(char2uni), charset2lower: CHARSET2LOWER.as_ptr(), charset2upper: CHARSET2UPPER.as_ptr() };

unsafe fn init_nls_cp737()
{
	return register_nls(&raw mut table);
}

unsafe fn exit_nls_cp737()
{
...
\n\n#[repr(C)]\nstruct NlsTable { charset: *const u8, uni2char: Option<unsafe fn(u32,*mut u8,i32)->i32>, char2uni: Option<unsafe fn(*const u8,i32,*mut u32)->i32>, charset2lower: *const u8, charset2upper: *const u8 }\nextern "C" { fn register_nls(table: *mut NlsTable) -> i32; fn unregister_nls(table: *mut NlsTable); }\n
