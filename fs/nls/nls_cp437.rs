...
unsafe fn uni2char(uni: u16, out: *mut u8, boundlen: i32) -> i32
{
	...
	let cl: usize = (uni & 0x00ff) as usize;
	let ch: usize = ((uni & 0xff00) >> 8) as usize;

	if (boundlen <= 0)
		return -ENAMETOOLONG;

	uni2charset = page_uni2charset[ch];
	if !uni2charset.is_null() && *uni2charset.add(cl)
...
unsafe fn char2uni(rawstring: *const u8, boundlen: i32, uni: *mut u16) -> i32
{
...
const MODULE_DESCRIPTION: &str = "NLS Codepage 437 (United States, Canada)";
const MODULE_LICENSE: &str = "Dual BSD/GPL";
