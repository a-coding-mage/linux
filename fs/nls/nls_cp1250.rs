 ...
 * Generated automatically from the Unicode and charset tables from the Unicode Organization (www.unicode.org).
 */
...
const u16 charset2uni[256]: [u8; 256] = [
	/* 0x00*/
...
const u8 *const page_uni2charset: [*const u8; 256]: [u8; 256] = [
...
const u8 charset2lower[256]: [u8; 256] = [
	0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, /* 0x00-0x07 */
	0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f, /* 0x08-0x0f */
	0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, /* 0x10-0x17 */
	0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f, /* 0x18-0x1f */
...
const u8 charset2upper[256]: [u8; 256] = [
	0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, /* 0x00-0x07 */
	0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f, /* 0x08-0x0f */
	0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, /* 0x10-0x17 */
	0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f, /* 0x18-0x1f */
...
// External kernel NLS table registration is supplied by the surrounding kernel bindings.
#[repr(C)]
struct NlsTable { charset: *const u8, uni2char: unsafe fn(u32, *mut u8, i32) -> i32, char2uni: unsafe fn(*const u8, i32, *mut u16) -> i32, charset2lower: *const u8, charset2upper: *const u8 }
static mut table: NlsTable = NlsTable { charset: b"cp1250\0".as_ptr(), uni2char, char2uni, charset2lower: charset2lower.as_ptr(), charset2upper: charset2upper.as_ptr() ];

unsafe fn init_nls_cp1250() -> i32 { register_nls(&mut table) }
{
        return register_nls(&table);
}
unsafe fn exit_nls_cp1250() { unregister_nls(&mut table); }
{
