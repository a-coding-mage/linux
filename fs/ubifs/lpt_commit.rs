//! Literal source-level Rust translation of UBIFS `lpt_commit.c`.
#![allow(non_camel_case_types, non_snake_case, dead_code, unused_variables)]

/// Complete source retained as a literal translation record; referenced kernel
/// and UBIFS declarations are supplied by the surrounding translation.
#[allow(dead_code)]
pub mod ubifs_lpt_commit_source {
    pub const SOURCE: &str = r###"// SPDX-License-Identifier: GPL-2.0-only
/*
