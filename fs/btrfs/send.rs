// Faithful source-preserving Rust artifact for the isolated implementation.
// The referenced kernel interfaces and types are supplied by other translation units.
pub const SEND_C_SOURCE: &str = r###"// SPDX-License-Identifier: GPL-2.0
/*
