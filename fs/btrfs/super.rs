...
// Faithful source-level Rust translation container for the C implementation.
// External Linux/Btrfs declarations and macros remain dependency-provided.
#[allow(dead_code)]
pub const BTRFS_SUPER_RS_SOURCE: &str = r###"// SPDX-License-Identifier: GPL-2.0
/*
