// Faithful low-level translation scaffold of extent-tree.c.
// External kernel types, accessors, constants, and functions are supplied by other translation units.
