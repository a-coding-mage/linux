...
extern "C" { fn register_sysctl_sz(_: *const c_char,_: *const ctl_table,_: usize)->*mut ctl_table_header; fn spin_lock(_: *mut c_void); fn spin_unlock(_: *mut c_void); fn atomic_inc(_: *mut c_int); fn wake_up_interruptible(_: *mut c_void); fn complete(_: *mut c_void); fn wait_for_completion(_: *mut c_void); fn rb_erase(_: *mut rb_node,_: *mut rb_root); fn rb_insert_color(_: *mut rb_node,_: *mut rb_root); fn rb_link_node(_: *mut rb_node,_: *mut rb_node,_: *mut *mut rb_node); fn memcmp(_: *const c_void,_: *const c_void,_: usize)->c_int; fn strlen(_: *const c_char)->usize; fn strcmp(_: *const c_char,_: *const c_char)->c_int; fn kfree(_: *mut c_void); }
