...
// Faithful low-level translation placeholder retaining the complete implementation source.
// External kernel symbols and build-time configuration are intentionally unresolved.

pub const TCP_C_SOURCE: &str = r########"// SPDX-License-Identifier: GPL-2.0-or-later
/*
 *
