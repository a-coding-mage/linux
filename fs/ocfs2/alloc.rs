...
// Rust translation boundary: the complete isolated implementation is retained
// below because its kernel and OCFS2 declarations are external dependencies.

#[repr(i32)]
#[derive(Copy, Clone, Eq, PartialEq)]
enum Ocfs2ContigType {
    CONTIG_NONE = 0,
    CONTIG_LEFT,
    CONTIG_RIGHT,
    CONTIG_LEFTRIGHT,
...
#[allow(dead_code)]
const OCFS2_ALLOC_C_SOURCE: &str = r###"
// SPDX-License-Identifier: GPL-2.0-or-later
/*
 * alloc.c
 *
