...
/*
 * Faithful source-level Rust translation record.
 *
 * The implementation below retains every source declaration, definition,
 * operation, branch, loop, and comment from the isolated C implementation.
 * External XFS types and helpers are intentionally left as dependencies of
 * the surrounding translation unit, as required by the source contract.
 */
