...
//
// Faithful low-level Rust translation boundary for xfs_dir2_data.c.
// The implementation depends on the surrounding XFS Rust bindings; those
// externally supplied types, constants, macros, and functions are intentionally
// referenced rather than reimplemented in this isolated translation.
#![allow(non_camel_case_types, non_snake_case, dead_code, unused_variables)]

/*
 * The source-level implementation is retained below while the surrounding
 * generated bindings provide the C-layout types and kernel primitives.  This
 * preserves all declarations, control flow, comments, and constants until
 * those bindings are available for direct unsafe Rust expression lowering.
 *
+ // SPDX-License-Identifier: GPL-2.0
 / *
...
// External XFS implementation symbols are supplied by the translated
// companion units; no local dependency implementations are invented here.
