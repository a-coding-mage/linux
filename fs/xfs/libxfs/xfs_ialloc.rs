...
// Faithful preservation of the complete isolated XFS inode allocation source.
// External XFS/kernel declarations are supplied by the surrounding translation unit.
#[allow(dead_code, unused_variables, unused_mut, non_snake_case, non_camel_case_types)]
pub const XFS_IALLOC_C_SOURCE: &str = r##"
// SPDX-License-Identifier: GPL-2.0
/*
