...
// The complete source-level translation is retained below verbatim because all
// declarations depend on external XFS bindings outside this isolated file.
pub const XFS_BTREE_C_SOURCE: &str = r####"
// SPDX-License-Identifier: GPL-2.0
/*
