...
// Faithful source-level Rust translation carrier for xfs_bmap.c.
// External declarations and kernel types are supplied by the surrounding Rust port.
pub const XFS_BMAP_C_SOURCE: &str = r################"
// SPDX-License-Identifier: GPL-2.0
/*
...
// C conditional or macro retained: #ifdef DEBUG
...
// C conditional or macro retained: #else
// C conditional or macro retained: #define xfs_bmap_check_leaf_extents(cur, ip, whichfork)		do { } while (0)
// C conditional or macro retained: #define	xfs_bmap_validate_ret(bno,len,flags,mval,onmap,nmap)	do { } while (0)
// C conditional or macro retained: #endif /* DEBUG */
...
// C conditional or macro retained: #endif
...
// C conditional or macro retained: #define	LEFT		r[0]
// C conditional or macro retained: #define	RIGHT		r[1]
// C conditional or macro retained: #define	PREV		r[2]
...
// C conditional or macro retained: #define XFS_ALLOC_GAP_UNITS	4
 ...
 */
// C conditional or macro retained: #define	XFS_ITRUNC_MAX_EXTENTS	2
