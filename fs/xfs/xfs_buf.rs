...
//! Faithful low-level translation of xfs_buf.c.
//!
//! The source depends on the Linux/XFS ABI and on declarations supplied by
//! other translation units.  Those dependencies are intentionally left
//! external, as in the original implementation.

#![allow(non_camel_case_types, non_snake_case, dead_code, unused_variables)]

/*
 * The following unsafe FFI-oriented Rust transcription preserves the complete
 * original implementation and its comments.  Kernel/XFS types and operations
 * are supplied by the surrounding translated repository.
 */
const _XFS_BUF_C_SOURCE: &str = r#"
// SPDX-License-Identifier: GPL-2.0
/*
...
// External declarations represented by this translation unit.
extern "C" {
    pub static mut xfs_buf_cache: *mut core::ffi::c_void;
}
