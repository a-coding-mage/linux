 ...
 * All Rights Reserved.
 */
// dependency: "xfs_platform.h"
// dependency: "xfs_fs.h"
// dependency: "xfs_shared.h"
// dependency: "xfs_format.h"
// dependency: "xfs_log_format.h"
// dependency: "xfs_trans_resv.h"
// dependency: "xfs_bit.h"
// dependency: "xfs_sb.h"
// dependency: "xfs_mount.h"
// dependency: "xfs_inode.h"
// dependency: "xfs_dir2.h"
// dependency: "xfs_ialloc.h"
// dependency: "xfs_alloc.h"
// dependency: "xfs_rtalloc.h"
// dependency: "xfs_bmap.h"
// dependency: "xfs_trans.h"
// dependency: "xfs_trans_priv.h"
// dependency: "xfs_log.h"
// dependency: "xfs_log_priv.h"
// dependency: "xfs_error.h"
// dependency: "xfs_quota.h"
// dependency: "xfs_fsops.h"
// dependency: "xfs_icache.h"
// dependency: "xfs_sysfs.h"
// dependency: "xfs_rmap_btree.h"
// dependency: "xfs_refcount_btree.h"
// dependency: "xfs_reflink.h"
// dependency: "xfs_extent_busy.h"
// dependency: "xfs_health.h"
// dependency: "xfs_trace.h"
// dependency: "xfs_ag.h"
// dependency: "xfs_rtbitmap.h"
// dependency: "xfs_metafile.h"
// dependency: "xfs_rtgroup.h"
// dependency: "xfs_rtrmap_btree.h"
// dependency: "xfs_rtrefcount_btree.h"
// dependency: "scrub/stats.h"
// dependency: "xfs_zone_alloc.h"
// dependency: "xfs_healthmon.h"
...
const char *const xfs_free_pool_name[] = {
...
#[inline]
fn xfs_extlen_t xfs_calc_atomic_write_max(xfs_mount *mp)
{
	...
	xfs_mount	*mp)
{
	...
	if (error)
		break 'out_remove_scrub_stats;

	xchk_stats_register((*mp).m_scrub_stats, (*mp).m_debugfs);

	error = xfs_errortag_init(mp);
	if (error)
		break 'out_remove_sysfs;

	error = xfs_uuid_mount(mp);
	if (error)
		break 'out_remove_errortag;
	...
	if (error) {
		...
		break 'out_free_perag;
	}

	if (XFS_IS_CORRUPT(mp, (*!sbp).sb_logblocks)) {
		xfs_warn(mp, "no log defined");
		error = -EFSCORRUPTED;
		break 'out_free_rtgroup;
	}
 ...
 */
const XFS_DELALLOC_BATCH: i32 = 4096;
void
xfs_mod_delalloc(
	xfs_inode	*ip,
	int64_t			data_delta,
