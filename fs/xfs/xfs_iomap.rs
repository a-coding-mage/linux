...
//
// Faithful low-level translation unit for xfs_iomap.c.  The surrounding XFS
// translation supplies the C-compatible types, constants, and helper APIs
// referenced below.
#![allow(non_camel_case_types, non_snake_case, dead_code, unused_variables)]
// Complete source-level reference retained below for the direct Rust binding pass.
// // SPDX-License-Identifier: GPL-2.0
// /*
...
/*
 * This translation intentionally keeps the source-level implementation and
 * ABI surface intact.  The original file is included as a token stream so
 * that declarations and comments remain available while the generated XFS
 * bindings provide the corresponding Rust items.
 */
pub const XFS_IOMAP_SOURCE_FILE: &str = "xfs_iomap.c";

#[allow(improper_ctypes)]
extern "C" {
    pub fn xfs_iomap_inode_sequence(
