...
// __naked
#[no_mangle]
pub unsafe extern "C" fn by_0_zero_check_1_1() {
    asm!(
        "w0 = 42;
         w1 = 0;
         w2 = 1;
...
// __naked
#[no_mangle]
pub unsafe extern "C" fn by_0_zero_check_2_1() {
    asm!(
        "w0 = 42;
...
// __naked
#[no_mangle]
pub unsafe extern "C" fn div64_by_0_zero_check() {
    asm!(
        "w0 = 42;
         w1 = 0;
         w2 = 1;
...
// __naked
#[no_mangle]
pub unsafe extern "C" fn by_0_zero_check_1_2() {
    asm!(
        "w0 = 42;
         w1 = 0;
         w2 = 1;
...
// __naked
#[no_mangle]
pub unsafe extern "C" fn by_0_zero_check_2_2() {
    asm!(
        "w0 = 42;
         r1 = 0xffffffff00000000LL ll;
         w2 = 1;
...
// __naked
#[no_mangle]
pub unsafe extern "C" fn mod64_by_0_zero_check() {
    asm!(
        "w0 = 42;
         w1 = 0;
         w2 = 1;
...
// __naked
#[no_mangle]
pub unsafe extern "C" fn _0_zero_check_ok_cls_1() {
    asm!(
        "w0 = 42;
         w1 = 2;
         w2 = 16;
...
// __naked
#[no_mangle]
pub unsafe extern "C" fn _0_zero_check_1_cls_1() {
    asm!(
        "w1 = 0;
         w0 = 1;
         w0 /= w1;
...
// __naked
#[no_mangle]
pub unsafe extern "C" fn _0_zero_check_2_cls_1() {
    asm!(
        "r1 = 0xffffffff00000000LL ll;
         w0 = 1;
         w0 /= w1;
...
// __naked
#[no_mangle]
pub unsafe extern "C" fn by_0_zero_check_cls() {
    asm!(
        "w1 = 0;
         w0 = 1;
         r0 /= r1;
...
// __naked
#[no_mangle]
pub unsafe extern "C" fn _0_zero_check_ok_cls_2() {
    asm!(
        "w0 = 42;
         w1 = 3;
         w2 = 5;
...
// __naked
#[no_mangle]
pub unsafe extern "C" fn _0_zero_check_1_cls_2() {
    asm!(
        "w1 = 0;
         w0 = 1;
         w0 %= w1;
...
// __naked
#[no_mangle]
pub unsafe extern "C" fn _0_zero_check_2_cls_2() {
    asm!(
        "r1 = 0xffffffff00000000LL ll;
         w0 = 1;
         w0 %= w1;
...
// __naked
#[no_mangle]
pub unsafe extern "C" fn _0_zero_check_1_cls_3() {
    asm!(
        "w1 = 0;
         w0 = 2;
         r0 %= r1;
...
// __naked
#[no_mangle]
pub unsafe extern "C" fn _0_zero_check_2_cls_3() {
    asm!(
        "w1 = 0;
         w0 = -1;
         r0 %= r1;
