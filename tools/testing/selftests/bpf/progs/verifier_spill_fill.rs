...
// Source-level Rust translation of verifier_spill_fill.c.
// C include dependencies preserved by reference: linux/bpf.h, bpf/bpf_helpers.h, bpf_misc.h, tools/include/linux/filter.h.
...
// SEC(".maps")
#[no_mangle]
pub static mut map_ringbuf: map_ringbuf_def = map_ringbuf_def { _private: [] };
...
unsafe extern "C" {
    ...
    fn bpf_dynptr_data(ptr: *mut bpf_dynptr, offset: u32, len: u32) -> *mut c_void;
    fn bpf_dynptr_from_mem(data: *mut c_void, len: u32, flags: u64, ptr: *mut bpf_dynptr) -> c_int;
}

// SEC(".data.single_byte_buf")
#[no_mangle]
pub static mut single_byte_buf: [u8; 1] = [0; 1];

// SEC(".data.two_byte_buf")
#[no_mangle]
pub static mut two_byte_buf: [u8; 2] = [0; 2];

static mut dptr_mem_buf: [u8; 16] = [0; 16];
...
// __retval(0)
#[no_mangle]
pub unsafe extern "C" fn uninit_u32_from_the_stack() -> () {
    // Translated inline eBPF assembly and operands from C:
    // "					\
    // 	w4 = 20;					\
    // 	*(u32*)(r10 - 8) = r4;				\
...
// __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn u16_offset_to_skb_data() -> () {
    // Translated inline eBPF assembly and operands from C:
    // "					\
    // 	r2 = *(u32*)(r1 + %[__sk_buff_data]
    unsafe { asm!("", options(nomem, nostack, preserves_flags)); }
...
#[no_mangle]
pub unsafe extern "C" fn u64_offset_to_skb_data() -> () {
    // Translated inline eBPF assembly and operands from C:
    // "					\
    // 	r2 = *(u32*)(r1 + %[__sk_buff_data]
    unsafe { asm!("", options(nomem, nostack, preserves_flags)); }
...
#[no_mangle]
pub unsafe extern "C" fn _6_offset_to_skb_data() -> () {
    // Translated inline eBPF assembly and operands from C:
    // "					\
    // 	r2 = *(u32*)(r1 + %[__sk_buff_data]
    unsafe { asm!("", options(nomem, nostack, preserves_flags)); }
...
// __failure __msg("invalid access to packet")
#[no_mangle]
pub unsafe extern "C" fn addr_offset_to_skb_data() -> () {
    // Translated inline eBPF assembly and operands from C:
    // "					\
    // 	r2 = *(u32*)(r1 + %[__sk_buff_data]
    unsafe { asm!("", options(nomem, nostack, preserves_flags)); }
...
// __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn scalar_offset_to_skb_data_2() -> () {
    // Translated inline eBPF assembly and operands from C:
    // "					\
    // 	r2 = *(u32*)(r1 + %[__sk_buff_data]
    unsafe { asm!("", options(nomem, nostack, preserves_flags)); }
...
// __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn and_then_at_fp_8() -> () {
    // Translated inline eBPF assembly and operands from C:
    // "					\
    // 	w4 = 4321;					\
    // 	*(u32*)(r10 - 4) = r4;				\
...
#[no_mangle]
pub unsafe extern "C" fn spill_32bit_of_64bit_fail() -> () {
    // Translated inline eBPF assembly and operands from C:
    // "					\
    // 	r6 = r1;					\
...
#[no_mangle]
pub unsafe extern "C" fn spill_16bit_of_32bit_fail() -> () {
    // Translated inline eBPF assembly and operands from C:
    // "					\
    // 	r6 = r1;					\
    // 	/* Roll one bit to force the verifier to track both branches. */\
...
#[no_mangle]
pub unsafe extern "C" fn spill_subregs_preserve_stack_zero() -> () {
    // Translated inline eBPF assembly and operands from C:
    // 
    // 		"call %[bpf_get_prandom_u32];"
    // 
...
#[no_mangle]
pub unsafe extern "C" fn partial_stack_load_preserves_zeros() -> () {
    // Translated inline eBPF assembly and operands from C:
    // 
...
#[no_mangle]
pub unsafe extern "C" fn partial_stack_load_preserves_partial_zeros() -> () {
    // Translated inline eBPF assembly and operands from C:
    // 
    // 		/* fp-4 is value zero */
...
// __msg("R2=0")
#[no_mangle]
pub unsafe extern "C" fn stack_load_preserves_mixed_zero_and_zero_spill() -> () {
    // Translated inline eBPF assembly and operands from C:
    // 
...
#[no_mangle]
pub unsafe extern "C" fn stack_load_preserves_const_precision() -> () {
    // Translated inline eBPF assembly and operands from C:
    // 
...
// __msg("14: R1=map_value(map=.data.two_byte_,ks=4,vs=2,imm=1) R2=1")
#[no_mangle]
pub unsafe extern "C" fn stack_load_preserves_const_precision_subreg() -> () {
    // Translated inline eBPF assembly and operands from C:
    // 
    // 		/* establish checkpoint with state that has no stack slots;
    // 		 * if we bubble up to this state without finding desired stack
...
// __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn spill_32bit_range_track() -> () {
    // Translated inline eBPF assembly and operands from C:
    // "					\
...
// __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn spill_64bit_of_64bit_ok() -> () {
    // Translated inline eBPF assembly and operands from C:
    // "					\
...
// __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn spill_32bit_of_32bit_ok() -> () {
    // Translated inline eBPF assembly and operands from C:
    // "					\
    // 	/* Roll one bit to make the register inexact. */\
    // 	call %[bpf_get_prandom_u32];			\
...
// __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn spill_16bit_of_16bit_ok() -> () {
    // Translated inline eBPF assembly and operands from C:
    // "					\
    // 	/* Roll one bit to make the register inexact. */\
    // 	call %[bpf_get_prandom_u32];			\
...
// __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn spill_8bit_of_8bit_ok() -> () {
    // Translated inline eBPF assembly and operands from C:
    // "					\
    // 	/* Roll one bit to make the register inexact. */\
    // 	call %[bpf_get_prandom_u32];			\
...
// __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn spill_unbounded() -> () {
    // Translated inline eBPF assembly and operands from C:
    // "					\
...
// __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn fill_32bit_after_spill_64bit() -> () {
    // Translated inline eBPF assembly and operands from C:
    // "					\
...
// __success __retval(0)
#[no_mangle]
pub unsafe extern "C" fn fill_32bit_after_spill_64bit_preserve_id() -> () {
    // Translated inline eBPF assembly and operands from C:
    // "					\
...
// __failure __msg("math between ctx pointer and 4294967295 is not allowed")
#[no_mangle]
pub unsafe extern "C" fn fill_32bit_after_spill_64bit_clear_id() -> () {
    // Translated inline eBPF assembly and operands from C:
    // "					\
    // 	r6 = r1;					\
    // 	/* Roll one bit to force the verifier to track both branches. */\
...
#[no_mangle]
pub unsafe extern "C" fn old_imprecise_scalar_vs_cur_stack_misc() -> () {
    // Translated inline eBPF assembly and operands from C:
    // 
...
// __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn old_precise_scalar_vs_cur_stack_misc() -> () {
    // Translated inline eBPF assembly and operands from C:
    // 
    // 	/* get a random value for branching */
    // 	"call %[bpf_ktime_get_ns];"
...
// __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn old_stack_misc_vs_cur_scalar() -> () {
    // Translated inline eBPF assembly and operands from C:
    // 
    // 	/* get a random value for branching */
    // 	"call %[bpf_ktime_get_ns];"
...
// __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn old_stack_misc_vs_cur_ctx_ptr() -> () {
    // Translated inline eBPF assembly and operands from C:
    // 
...
#[no_mangle]
pub unsafe extern "C" fn stack_noperfmon_reject_invalid_read() -> () {
    // Translated inline eBPF assembly and operands from C:
    // "					\
    // 	r2 = 1;						\
    // 	r6 = r10;					\
...
// __success_unpriv
#[no_mangle]
pub unsafe extern "C" fn stack_noperfmon_spill_32bit_onto_64bit_slot() -> () {
    // Translated inline eBPF assembly and operands from C:
    // "					\
    // 	r0 = 0;						\
    // 	*(u64 *)(r10 - 8) = r0;				\
...
// __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn old_imprecise_scalar32_vs_cur_stack_misc() -> () {
    // Translated inline eBPF assembly and operands from C:
    // 
    // 	/* get a random value for branching */
    // 	"call %[bpf_ktime_get_ns];"
...
// __success
#[no_mangle]
pub unsafe extern "C" fn var_off_write_over_scalar_spill() -> () {
    // Translated inline eBPF assembly and operands from C:
    // 
...
// __flag(BPF_F_TEST_STATE_FREQ)
#[no_mangle]
pub unsafe extern "C" fn partial_fill_from_cleaned_pointer_spill() -> () {
    // Translated inline eBPF assembly and operands from C:
    // "*(u64 *)(r10 - 8) = r1;"
    // 		      "goto +0;"
    // 		      "r0 = *(u32 *)(r10 - 4
...
// __success
#[no_mangle]
pub unsafe extern "C" fn spill_fill_ptr_to_tp_buffer() -> () {
    // Translated inline eBPF assembly and operands from C:
    // 
    // 	"r6 = *(u64*)(r1 + 0
    unsafe { asm!("", options(nomem, nostack, preserves_flags)); }
...
// __noinline
#[no_mangle]
pub unsafe extern "C" fn spill_fill_dynptr_subprog(dptr: *mut bpf_dynptr) -> c_int {
    // Translated inline eBPF assembly and operands from C:
    // "*(u64 *)(r10 - 8) = %[dptr];" /* spill the CONST_PTR_TO_DYNPTR argument */
    // 		      "%[dptr] = *(u64 *)(r10 - 8
    unsafe { asm!("", options(nomem, nostack, preserves_flags)); }
    let p: *mut c_long;
    unsafe { asm!("", inout("rdi") dptr => _, options(nostack)); }
    p = bpf_dynptr_data(dptr, 0, core::mem::size_of::<c_long>() as u32) as *mut c_long;
...
// __success
#[no_mangle]
pub unsafe extern "C" fn spill_fill_const_ptr_to_dynptr() -> c_int {
    let mut ptr = bpf_dynptr { _private: [] };
    bpf_dynptr_from_mem(dptr_mem_buf.as_mut_ptr() as *mut c_void, dptr_mem_buf.len() as u32, 0, &mut ptr);
    return spill_fill_dynptr_subprog(&mut ptr);
}
