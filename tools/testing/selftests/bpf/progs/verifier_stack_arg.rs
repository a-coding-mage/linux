...
/* The original C uses BPF helper/map declaration macros supplied by headers. */
#[link_section = ".maps"]
pub static mut map_hash_8b: map_hash_8b = map_hash_8b {
...
extern "C" {
    ...
    fn bpf_sk_lookup_tcp(ctx: *mut core::ffi::c_void, tuple: *mut core::ffi::c_void, len: i32, netns: u64, flags: u64) -> *mut core::ffi::c_void;
    fn bpf_sk_release(sk: *mut core::ffi::c_void) -> i64;
    fn bpf_skb_pull_data(skb: *mut core::ffi::c_void, len: u32) -> i64;
...
#[inline(never)]
#[used]
unsafe extern "C" fn subprog_6args(a: i32, b: i32, c: i32, d: i32, e: i32, f: i32) -> i32 {
    return a + b + c + d + e + f;
}

#[inline(never)]
#[used]
unsafe extern "C" fn subprog_7args(a: i32, b: i32, c: i32, d: i32, e: i32, f: i32, g: i32) -> i32 {
    return a + b + c + d + e + f + g;
}

#[inline(never)]
#[used]
unsafe extern "C" fn subprog_deref_arg6(a: i64, b: i64, c: i64, d: i64, e: i64, f: *mut i64) -> i64 {
    return *f;
}
...
pub unsafe extern "C" fn stack_arg_6args() {
    asm!(
        "r1 = 1;",
        "r2 = 2;",
        "r3 = 3;",
...
pub unsafe extern "C" fn stack_arg_two_subprogs() {
    asm!(
        "r1 = 1;",
        "r2 = 2;",
        "r3 = 3;",
...
pub unsafe extern "C" fn stack_arg_read_uninitialized() {
    asm!(
        "r0 = *(u64 *)(r11 + 8);",
        "r0 = 0;",
        "exit;",
...
pub unsafe extern "C" fn stack_arg_gap_at_minus8() {
    asm!(
        "r1 = 1;",
        "r2 = 2;",
        "r3 = 3;",
...
pub unsafe extern "C" fn stack_arg_pruning_type_mismatch() {
    asm!(
...
pub unsafe extern "C" fn stack_arg_release_ref() {
    asm!(
        "r6 = r1;",
        ...
        sizeof_bpf_sock_tuple = const core::mem::size_of::<bpf_sock_tuple>(),
        options(noreturn)
    );
}
...
/* __failure */
/* __msg("callee expects 6 args, stack arg1 is not initialized") */
pub unsafe extern "C" fn stack_arg_stale_pkt_ptr() {
    asm!(
        "r6 = r1;",
        ...
        "r0 = 0;",
        "exit;",
        bpf_skb_pull_data = sym bpf_skb_pull_data,
        __sk_buff_data = const core::mem::offset_of!(__sk_buff, data),
        __sk_buff_data_end = const core::mem::offset_of!(__sk_buff, data_end),
        options(noreturn)
    );
}
...
/* __failure */
/* __msg("R{{[0-9]}} invalid mem access 'scalar'") */
pub unsafe extern "C" fn stack_arg_null_propagation_fail() {
    asm!(
        "r1 = 0;",
        "*(u64 *)(r10 - 8) = r1;",
...
/* __failure */
/* __msg("callee expects 7 args, stack arg1 is not initialized") */
pub unsafe extern "C" fn stack_arg_missing_store_one_branch() {
    asm!(
        "call {bpf_get_prandom_u32};",
        "r1 = 1;",
        "r2 = 2;",
...
pub unsafe extern "C" fn stack_arg_shared_store() {
    asm!(
        "call {bpf_get_prandom_u32};",
        "r1 = 1;",
        "r2 = 2;",
...
pub unsafe extern "C" fn stack_arg_write_beyond_max() {
    asm!(
        "r1 = 1;",
        "r2 = 2;",
        "r3 = 3;",
...
pub unsafe extern "C" fn stack_arg_write_unused_slot() {
    asm!(
        "r1 = 1;",
        "r2 = 2;",
        "r3 = 3;",
...
/* __failure */
/* __msg("callee expects 7 args, stack arg1 is not initialized") */
pub unsafe extern "C" fn stack_arg_sequential_calls() {
    asm!(
        "r1 = 1;",
        "r2 = 2;",
        "r3 = 3;",
