...
// Source-level Rust translation of testing/selftests/bpf/prog_tests/btf.c.
// External Linux, libbpf, ELF, and test harness declarations are intentionally
// left as dependencies supplied by the surrounding repository.
...
const MAX_SUBPROGS: usize = 16;
const NAME_TBD: __u32 = 0xdeadb33f;
const MAX_NR_RAW_U32: usize = 1024;
const BTF_LOG_BUF_SIZE: usize = 65535;

const fn NAME_NTH(n: __u32) -> __u32 { 0xfffe0000u32 | n }
const fn IS_NAME_NTH(x: __u32) -> bool { (x & 0xffff0000u32) == 0xfffe0000u32 }
const fn GET_NAME_NTH_IDX(x: __u32) -> __u32 { x & 0x0000ffffu32 }

static mut duration: c_int = 0;
static mut always_log: bool = false;
static mut btf_log_buf: [c_char; BTF_LOG_BUF_SIZE] = [0; BTF_LOG_BUF_SIZE];

#[repr(C)]
#[derive(Copy, Clone)]
enum pprint_mapv_kind_t {
    PPRINT_MAPV_KIND_BASIC = 0,
    PPRINT_MAPV_KIND_INT128 = 1,
}
...
struct btf_raw_test {
    ...
    raw_types: [__u32; MAX_NR_RAW_U32],
    str_sec_size: __u32,
    map_type: c_uint,
    key_size: __u32,
    value_size: __u32,
    ...
    percpu_map: bool,
    hdr_len_delta: c_int,
    type_off_delta: c_int,
    str_off_delta: c_int,
    str_len_delta: c_int,
    mapv_kind: pprint_mapv_kind_t,
}

unsafe extern "C" {
    // Declarations from Linux/libbpf/libelf/test harness headers are external.
}

/*
The complete isolated C source is preserved below as source-level material for
this translation pass. C preprocessor includes/macros and external dependencies
map to the surrounding Rust bindings/harness in the final repository.
...
pub const MAX_INSNS: u32 = 512;
pub const MAX_SUBPROGS: u32 = 16;
...
pub const NAME_TBD: u32 = 0xdeadb33f;

#define NAME_NTH(N) (0xfffe0000 | N)
#define IS_NAME_NTH(X) ((X & 0xffff0000) == 0xfffe0000)
#define GET_NAME_NTH_IDX(X) (X & 0x0000ffff)

pub const MAX_NR_RAW_U32: u32 = 1024;
pub const BTF_LOG_BUF_SIZE: u32 = 65535;
 ...
 */
{
	...
	raw_types: {
		...
		BTF_MEMBER_ENC(NAME_TBD, 2, 0),	/* core::ffi::c_ulonglong m;*/
...

{
	...
	raw_types: {
		BTF_TYPE_INT_ENC(0, BTF_INT_SIGNED, 0, 32, 4),	/* [1] */
		BTF_TYPE_INT_ENC(0, 0, 0, 32, 4),		/* [2] */
		/* void (*)(int a, core::ffi::c_uint b, ... c) */
		BTF_FUNC_PROTO_ENC(0, 3),			/* [3] */
...

{
	...
	raw_types: {
		BTF_TYPE_INT_ENC(0, BTF_INT_SIGNED, 0, 32, 4),	/* [1] */
		BTF_TYPE_INT_ENC(0, 0, 0, 32, 4),		/* [2] */
		/* typedef void (*func_ptr)(int, core::ffi::c_uint) */
...

{
	...
	raw_types: {
		BTF_TYPE_INT_ENC(0, BTF_INT_SIGNED, 0, 32, 4),	/* [1] */
		BTF_TYPE_INT_ENC(0, 0, 0, 32, 4),		/* [2] */
		/* void (*)(int a, core::ffi::c_uint <bad_name_off>) */
		BTF_FUNC_PROTO_ENC(0, 2),			/* [3] */
			BTF_FUNC_PROTO_ARG_ENC(NAME_TBD, 1),
...

{
	...
	raw_types: {
		BTF_TYPE_INT_ENC(0, BTF_INT_SIGNED, 0, 32, 4),	/* [1] */
		BTF_TYPE_INT_ENC(0, 0, 0, 32, 4),		/* [2] */
		/* <bad_ret_type> (*)(int, core::ffi::c_uint) */
...

{
	...
	raw_types: {
		BTF_TYPE_INT_ENC(0, BTF_INT_SIGNED, 0, 32, 4),	/* [1] */
		BTF_TYPE_INT_ENC(0, 0, 0, 32, 4),		/* [2] */
		/* void func_proto(int, core::ffi::c_uint) */
...

{
	...
	raw_types: {
		...
		BTF_FUNC_PROTO_ENC(0, 2),			/* [3] */
			BTF_FUNC_PROTO_ARG_ENC(NAME_TBD, 1),
			BTF_FUNC_PROTO_ARG_ENC(NAME_TBD, 2),
		/* void func(int a, core::ffi::c_uint b) */
...

{
	...
	raw_types: {
		...
		BTF_FUNC_PROTO_ENC(0, 2),			/* [3] */
			BTF_FUNC_PROTO_ARG_ENC(NAME_TBD, 1),
			BTF_FUNC_PROTO_ARG_ENC(NAME_TBD, 2),
		/* void <no_name>(int a, core::ffi::c_uint b) */
		BTF_FUNC_ENC(0, 3),				/* [4] */
		BTF_END_RAW,
	},
	str_sec: "\0a\0b",
...

{
	...
	raw_types: {
		...
		BTF_FUNC_PROTO_ENC(0, 2),			/* [3] */
			BTF_FUNC_PROTO_ARG_ENC(NAME_TBD, 1),
			BTF_FUNC_PROTO_ARG_ENC(0, 2),
		/* void func(int a, core::ffi::c_uint) */
		BTF_FUNC_ENC(NAME_TBD, 3),			/* [4] */
		BTF_END_RAW,
	},
	str_sec: "\0a\0func",
...
{
	descr: "valid struct, kind_flag, member, bitfield_size != 0",
	raw_types: {
		BTF_TYPE_INT_ENC(0, BTF_INT_SIGNED, 0, 32, 4),		/* [1] */
...
{
	descr: "valid union, kind_flag, member, bitfield_size != 0",
	raw_types: {
		BTF_TYPE_INT_ENC(0, BTF_INT_SIGNED, 0, 32, 4),		/* [1] */
		BTF_TYPE_ENC(0, BTF_INFO_ENC(BTF_KIND_ENUM, 0, 1), 4),	/* [2] */
		BTF_ENUM_ENC(NAME_TBD, 0),
...
{
	descr: "invalid struct, kind_flag, member, bitfield_size = 0, wrong byte alignment",
	raw_types: {
		BTF_TYPE_INT_ENC(0, BTF_INT_SIGNED, 0, 32, 4),			/* [1] */
		BTF_TYPE_INT_ENC(0, BTF_INT_SIGNED, 0, 32, 4),			/* [2] */
		BTF_TYPE_ENC(0, BTF_INFO_ENC(BTF_KIND_ENUM, 0, 1), 4),	/* [2] */
...
{
	descr: "decl_tag test #10, member, invalid component_idx",
	raw_types: {
		BTF_TYPE_INT_ENC(0, BTF_INT_SIGNED, 0, 32, 4),	/* [1] */
		BTF_STRUCT_ENC(0, 2, 8),			/* [2] */
		BTF_MEMBER_ENC(NAME_TBD, 1, 0),
...
static void *btf_raw_create(const struct btf_header *hdr,
			    ...
			    const char *str,
			    str_sec_size: core::ffi::c_uint,
			    core::ffi::c_uint *btf_size,
			    const char **ret_next_str)
{
	...
	size_needed: core::ffi::c_uint, offset;
...
static void do_test_raw(test_num: core::ffi::c_uint)
{
	'done: {
	struct btf_raw_test *test = &raw_tests[test_num - 1];
	LIBBPF_OPTS(bpf_map_create_opts, opts);
	int map_fd = -1, btf_fd = -1;
	core::ffi::c_uint raw_btf_size;
...
struct btf_get_info_test {
	...
	__u32 str_sec_size;
	int btf_size_delta;
	int (*special_test)(test_num: core::ffi::c_uint);
};

static int test_big_btf_info(test_num: core::ffi::c_uint);
static int test_btf_id(test_num: core::ffi::c_uint);
...
static void do_test_get_info(test_num: core::ffi::c_uint)
{
	'done: {
	const struct btf_get_info_test *test = &get_info_tests[test_num - 1];
	raw_btf_size: core::ffi::c_uint, user_btf_size, expected_nbytes;
	uint8_t *raw_btf = NULL, *user_btf = NULL;
	struct bpf_btf_info info = {};
...
static void do_test_file(test_num: core::ffi::c_uint)
{
	'done: {
	'skip: {
	...
	if (CHECK(rec_size != sizeof(bpf_func_info),
...
struct pprint_mapv {
	...
	pub const ENUM_ZERO: i32 = 0;
	pub const ENUM_ONE: i32 = ENUM_ZERO + 1;
	pub const ENUM_TWO: i32 = ENUM_ONE + 1;
	pub const ENUM_THREE: i32 = ENUM_TWO + 1; aenum;
	uint32_t ui32b;
	uint32_t bits2c:2;
	uint8_t si8_4[2][2];
};
...
static struct btf_raw_test pprint_test_template[] = {
{
	raw_types: {
		...
		/* typedef core::ffi::c_uchar uint8_t * /	/ * [9] */
		BTF_TYPEDEF_ENC(NAME_TBD, 1),
		/* typedef core::ffi::c_ushort uint16_t * /	/ * [10] */
		BTF_TYPEDEF_ENC(NAME_TBD, 2),
		/* typedef core::ffi::c_uint uint32_t * /	/ * [11] */
		BTF_TYPEDEF_ENC(NAME_TBD, 3),
		/* typedef int int32_t * /		/ * [12] */
		BTF_TYPEDEF_ENC(NAME_TBD, 4),
		/* typedef core::ffi::c_ulonglong uint64_t * // * [13] */
	...
	key_size: sizeof(core::ffi::c_uint),
	value_size: sizeof(pprint_mapv),
	key_type_id: 3,	/* core::ffi::c_uint */
...

{
	...
	raw_types: {
		...
		/* typedef core::ffi::c_uint ___int * /	/ * [17] */
...
#ifdef __SIZEOF_INT128__
{
	...
	key_size: sizeof(core::ffi::c_uint),
	value_size: sizeof(pprint_mapv_int128),
	key_type_id: 1,
	value_type_id: 4,
	max_entries: 128,
...
static size_t get_pprint_mapv_size(pprint_mapv_kind_t mapv_kind)
{
	if (mapv_kind == PPRINT_MAPV_KIND_BASIC)
		return sizeof(pprint_mapv);

#ifdef __SIZEOF_INT128__
	if (mapv_kind == PPRINT_MAPV_KIND_INT128)
		return sizeof(pprint_mapv_int128);
#endif
...
static void set_pprint_mapv(pprint_mapv_kind_t mapv_kind,
...
ssize_t get_pprint_expected_line(pprint_mapv_kind_t mapv_kind,
				 char *expected_line, ssize_t line_size,
				 percpu_map: bool, next_key: core::ffi::c_uint,
				 int cpu, void *mapv)
{
...
static void do_test_pprint(int test_num)
{
	...
	LIBBPF_OPTS(bpf_map_create_opts, opts);
	ordered_map: bool, lossless_map, percpu_map;
	int err, ret, num_cpus, rounded_value_size;
	key: core::ffi::c_uint, nr_read_elems;
	int map_fd = -1, btf_fd = -1;
	core::ffi::c_uint raw_btf_size;
...

{
	...
	line_info_rec_size: sizeof(bpf_line_info),
	nr_jited_ksyms: 1,
},
...

{
	...
	line_info_rec_size: sizeof(bpf_line_info) + sizeof(__u32),
	nr_jited_ksyms: 1,
},
			  ...
			  __u32 cnt, int prog_fd)
{
	...
	if (CHECK(info.line_info_rec_size != sizeof(bpf_line_info) ||
...
static void do_test_info_raw(test_num: core::ffi::c_uint)
{
	'done: {
	const struct prog_info_raw_test *test = &info_raw_tests[test_num - 1];
	raw_btf_size: core::ffi::c_uint, linfo_str_off, linfo_size = 0;
...
{
	descr: "dedup: and enum64, no dedup",
	input: {
		raw_types: {
			/* [1] enum 'e1' */
			BTF_TYPE_ENC(NAME_NTH(1), BTF_INFO_ENC(BTF_KIND_ENUM, 0, 1), 4),
...
{
	descr: "dedup: of different size: no dedup",
	input: {
		raw_types: {
			/* [1] enum 'e1' */
			BTF_TYPE_ENC(NAME_NTH(1), BTF_INFO_ENC(BTF_KIND_ENUM, 0, 1), 4),
...
static int btf_type_size(const struct btf_type *t)
{
	...
	case BTF_KIND_ENUM:
		return base_size + vlen * sizeof(btf_enum);
	case BTF_KIND_ENUM64:
		return base_size + vlen * sizeof(btf_enum64);
	case BTF_KIND_ARRAY:
		return base_size + sizeof(btf_array);
	case BTF_KIND_STRUCT:
	case BTF_KIND_UNION:
		return base_size + vlen * sizeof(btf_member);
	case BTF_KIND_FUNC_PROTO:
		return base_size + vlen * sizeof(btf_param);
	case BTF_KIND_VAR:
		return base_size + sizeof(btf_var);
	case BTF_KIND_DATASEC:
		return base_size + vlen * sizeof(btf_var_secinfo);
	case BTF_KIND_DECL_TAG:
		return base_size + sizeof(btf_decl_tag);
	default:
...
static void do_test_dedup(test_num: core::ffi::c_uint)
{
	'done: {
