...
BpfTest {
    descr: "dead code: tail of main + func",
    insns: [
        BPF_MOV64_IMM!(BPF_REG_0, 7),
        BPF_JMP_IMM!(BPF_JGE, BPF_REG_0, 8, 1),
        BPF_EXIT_INSN!(),
...
BpfTest {
    descr: "dead code: tail of main + two functions",
    insns: [
        BPF_MOV64_IMM!(BPF_REG_0, 7),
        BPF_JMP_IMM!(BPF_JGE, BPF_REG_0, 8, 1),
        BPF_EXIT_INSN!(),
...
BpfTest {
    descr: "dead code: function in the middle and mid of another func",
    insns: [
...
BpfTest {
    descr: "dead code: middle of main before call",
    insns: [
...
BpfTest {
    descr: "dead code: start of a function",
    insns: [
        BPF_MOV64_IMM!(BPF_REG_1, 2),
        BPF_RAW_INSN!(BPF_JMP | BPF_CALL, 0, 1, 0, 1),
        BPF_EXIT_INSN!(),
...
BpfTest {
    descr: "dead code: zero extension",
    insns: [
