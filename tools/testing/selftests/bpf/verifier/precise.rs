...
Test {
    descr: "precise: cross frame pruning",
    insns: &[
...
Test {
    descr: "precise: ST zero to stack insn is supported",
    insns: &[
...
Test {
    descr: "precise: mark_chain_precision for ARG_CONST_ALLOC_SIZE_OR_ZERO",
    insns: &[
        BPF_LDX_MEM(BPF_W, BPF_REG_4, BPF_REG_1, offset_of!(xdp_md, ingress_ifindex)),
        BPF_LD_MAP_FD(BPF_REG_6, 0),
        BPF_MOV64_REG(BPF_REG_1, BPF_REG_6),
...
Test {
    descr: "precise: program doesn't prematurely prune branches",
    insns: &[
        BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 0, 0, BPF_FUNC_get_prandom_u32),
