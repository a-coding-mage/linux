BpfTest {
	descr: "atomic compare-and-exchange smoketest - 64bit",
	insns: [
		/* val = 3; */
...
BpfTest {
	descr: "atomic compare-and-exchange smoketest - 32bit",
	insns: [
		/* val = 3; */
...
BpfTest {
	descr: "Can't use cmpxchg on uninit src reg",
	insns: [
		BPF_ST_MEM!(BPF_DW, BPF_REG_10, -8, 3),
		BPF_MOV64_IMM!(BPF_REG_0, 3),
...
BpfTest {
	descr: "BPF_W cmpxchg should zero top 32 bits",
	insns: [
		/* r0 = U64_MAX; */
		BPF_MOV64_IMM!(BPF_REG_0, 0),
...
BpfTest {
	descr: "Dest pointer in r0 - succeed",
	insns: [
		/* r0 = &val */
		BPF_MOV64_REG!(BPF_REG_0, BPF_REG_10),
		/* val = r0; */
...
BpfTest {
	descr: "Dest pointer in r0 - succeed, check 2",
	insns: [
		/* r0 = &val */
		BPF_MOV64_REG!(BPF_REG_0, BPF_REG_10),
		/* val = r0; */
...
BpfTest {
	descr: "Dest pointer in r0 - succeed, check 3",
	insns: [
		/* r0 = &val */
		BPF_MOV64_REG!(BPF_REG_0, BPF_REG_10),
		/* val = r0; */
...
BpfTest {
	descr: "Dest pointer in r0 - succeed, check 4",
	insns: [
		/* r0 = &val */
...
BpfTest {
	descr: "Dest pointer in r0 - succeed, check 5",
	insns: [
		/* r0 = &val */
		BPF_MOV32_REG!(BPF_REG_0, BPF_REG_10),
		/* val = r0; */
