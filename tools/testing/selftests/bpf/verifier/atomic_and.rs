pub static ATOMIC_AND: &[Test] = &[
    Test {
        name: "BPF_ATOMIC_AND without fetch",
        insns: &[
            /* val = 0x110; */
    ...
    Test {
        name: "BPF_ATOMIC_AND with fetch",
        insns: &[
    ...
    Test {
        name: "BPF_ATOMIC_AND with fetch 32bit",
        insns: &[
            /* r0 = (s64) -1 */
            BPF_MOV64_IMM!(BPF_REG_0, 0),
    ...
    Test {
        name: "BPF_ATOMIC_AND with fetch - r0 as source reg",
        insns: &[
            /* val = 0x110; */
            BPF_ST_MEM!(BPF_DW, BPF_REG_10, -8, 0x110),
            /* old = atomic_fetch_and(&val, 0x011); */
