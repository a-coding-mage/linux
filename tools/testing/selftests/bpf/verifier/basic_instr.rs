// Source-level Rust translation of testing/selftests/bpf/verifier/basic_instr.c.
// External test harness types, constants, and BPF instruction constructors are
// provided by the surrounding verifier framework.

pub static BASIC_INSTR: &[BpfTest] = &[
    BpfTest {
        descr: "add+sub+mul",
        insns: &[
    ...
    BpfTest {
        descr: "rsh64 by 0 imm",
        insns: &[
            BPF_LD_IMM64(BPF_REG_0, 1),
            BPF_LD_IMM64(BPF_REG_1, 0x100000000_i64),
    ...
    BpfTest {
        descr: "invalid 64-bit BPF_END with BPF_TO_BE",
        insns: &[
