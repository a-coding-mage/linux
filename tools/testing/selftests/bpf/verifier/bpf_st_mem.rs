pub static BPF_ST_MEM_TESTS: &[VerifierTest] = &[
    VerifierTest {
        descr: "BPF_ST_MEM stack imm non-zero",
        insns: &[
    ...
    VerifierTest {
        descr: "BPF_ST_MEM stack imm zero",
        insns: &[
    ...
    VerifierTest {
        descr: "BPF_ST_MEM stack imm zero, variable offset",
        insns: &[
    ...
    VerifierTest {
        descr: "BPF_ST_MEM stack imm sign",
