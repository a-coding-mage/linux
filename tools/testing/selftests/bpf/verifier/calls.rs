...
Test {
	descr: "calls: invalid kfunc call not eliminated",
	insns: &[
...
Test {
	descr: "calls: invalid kfunc call unreachable",
	insns: &[
	BPF_MOV64_IMM(BPF_REG_0, 1),
...
Test {
	descr: "calls: invalid kfunc call: ptr_to_mem to struct with non-scalar",
	insns: &[
...
Test {
	descr: "calls: invalid kfunc call: ptr_to_mem to struct with nesting depth > 4",
	insns: &[
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_10),
	BPF_ALU64_IMM(BPF_ADD, BPF_REG_1, -8),
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, BPF_PSEUDO_KFUNC_CALL, 0, 0),
...
Test {
	descr: "calls: invalid kfunc call: ptr_to_mem to struct with FAM",
	insns: &[
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_10),
	BPF_ALU64_IMM(BPF_ADD, BPF_REG_1, -8),
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, BPF_PSEUDO_KFUNC_CALL, 0, 0),
...
Test {
	descr: "calls: invalid kfunc call: reg->type != PTR_TO_CTX",
	insns: &[
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_10),
	BPF_ALU64_IMM(BPF_ADD, BPF_REG_1, -8),
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, BPF_PSEUDO_KFUNC_CALL, 0, 0),
...
Test {
	descr: "calls: invalid kfunc call: void * not allowed in func proto without mem size arg",
	insns: &[
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_10),
	BPF_ALU64_IMM(BPF_ADD, BPF_REG_1, -8),
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, BPF_PSEUDO_KFUNC_CALL, 0, 0),
...
Test {
	descr: "calls: trigger reg2btf_ids[reg->type] for reg->type > __BPF_REG_TYPE_MAX",
	insns: &[
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_10),
	BPF_ALU64_IMM(BPF_ADD, BPF_REG_1, -8),
...
Test {
	descr: "calls: invalid kfunc call: reg->off must be zero when passed to release kfunc",
	insns: &[
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_10),
	BPF_ALU64_IMM(BPF_ADD, BPF_REG_1, -8),
	BPF_ST_MEM(BPF_DW, BPF_REG_1, 0, 0),
...
Test {
	descr: "calls: invalid kfunc call: don't match first member type when passed to release kfunc",
	insns: &[
	BPF_MOV64_IMM(BPF_REG_0, 0),
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, BPF_PSEUDO_KFUNC_CALL, 0, 0),
	BPF_JMP_IMM(BPF_JNE, BPF_REG_0, 0, 1),
...
Test {
	descr: "calls: invalid kfunc call: PTR_TO_BTF_ID with negative offset",
	insns: &[
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_10),
	BPF_ALU64_IMM(BPF_ADD, BPF_REG_1, -8),
	BPF_ST_MEM(BPF_DW, BPF_REG_1, 0, 0),
...
Test {
	descr: "calls: invalid kfunc call: PTR_TO_BTF_ID with variable offset",
	insns: &[
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_10),
	BPF_ALU64_IMM(BPF_ADD, BPF_REG_1, -8),
	BPF_ST_MEM(BPF_DW, BPF_REG_1, 0, 0),
...
Test {
	descr: "calls: invalid kfunc call: referenced arg needs refcounted PTR_TO_BTF_ID",
	insns: &[
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_10),
	BPF_ALU64_IMM(BPF_ADD, BPF_REG_1, -8),
	BPF_ST_MEM(BPF_DW, BPF_REG_1, 0, 0),
...
Test {
	descr: "calls: valid kfunc call: referenced arg needs refcounted PTR_TO_BTF_ID",
	insns: &[
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_10),
	BPF_ALU64_IMM(BPF_ADD, BPF_REG_1, -8),
	BPF_ST_MEM(BPF_DW, BPF_REG_1, 0, 0),
...
Test {
	descr: "calls: invalid kfunc call: must provide (attach_prog_fd, btf_id) pair when freplace",
	insns: &[
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, BPF_PSEUDO_KFUNC_CALL, 0, 0),
	BPF_EXIT_INSN(),
	],
...
Test {
	descr: "calls: not on unprivileged",
	insns: &[
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 2),
	BPF_MOV64_IMM(BPF_REG_0, 1),
	BPF_EXIT_INSN(),
...
Test {
	descr: "calls: div by 0 in subprog",
	insns: &[
	BPF_MOV64_REG(BPF_REG_6, BPF_REG_1),
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 8),
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_6),
	BPF_LDX_MEM(BPF_W, BPF_REG_1, BPF_REG_1,
		    offset_of!(__sk_buff, data_end)),
	BPF_MOV64_REG(BPF_REG_2, BPF_REG_0),
...
Test {
	descr: "calls: multiple ret types in subprog 1",
	insns: &[
	BPF_MOV64_REG(BPF_REG_6, BPF_REG_1),
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 8),
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_6),
...
Test {
	descr: "calls: multiple ret types in subprog 2",
	insns: &[
	BPF_MOV64_REG(BPF_REG_6, BPF_REG_1),
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 8),
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_6),
...
Test {
	descr: "calls: overlapping caller/callee",
	insns: &[
...
Test {
	descr: "calls: wrong recursive calls",
	insns: &[
...
Test {
	descr: "calls: conditional call",
	insns: &[
	BPF_LDX_MEM(BPF_W, BPF_REG_0, BPF_REG_1,
		    offset_of!(__sk_buff, mark)),
...
Test {
	descr: "calls: conditional call 2",
	insns: &[
	BPF_LDX_MEM(BPF_W, BPF_REG_0, BPF_REG_1,
		    offset_of!(__sk_buff, mark)),
	BPF_JMP_IMM(BPF_JEQ, BPF_REG_0, 0, 3),
...
Test {
	descr: "calls: conditional call 3",
	insns: &[
	BPF_LDX_MEM(BPF_W, BPF_REG_0, BPF_REG_1,
		    offset_of!(__sk_buff, mark)),
	BPF_JMP_IMM(BPF_JEQ, BPF_REG_0, 0, 3),
...
Test {
	descr: "calls: conditional call 4",
	insns: &[
	BPF_LDX_MEM(BPF_W, BPF_REG_0, BPF_REG_1,
		    offset_of!(__sk_buff, mark)),
	BPF_JMP_IMM(BPF_JEQ, BPF_REG_0, 0, 3),
...
Test {
	descr: "calls: conditional call 5",
	insns: &[
	BPF_LDX_MEM(BPF_W, BPF_REG_0, BPF_REG_1,
		    offset_of!(__sk_buff, mark)),
	BPF_JMP_IMM(BPF_JEQ, BPF_REG_0, 0, 3),
...
Test {
	descr: "calls: conditional call 6",
	insns: &[
	BPF_MOV64_REG(BPF_REG_6, BPF_REG_1),
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_6),
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 2),
...
Test {
	descr: "calls: using r0 returned by callee",
	insns: &[
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 1),
	BPF_EXIT_INSN(),
	BPF_MOV64_IMM(BPF_REG_0, 2),
...
Test {
	descr: "calls: using uninit r0 from callee",
	insns: &[
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 1),
	BPF_EXIT_INSN(),
	BPF_EXIT_INSN(),
...
Test {
	descr: "calls: callee is using r1",
	insns: &[
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 1),
	BPF_EXIT_INSN(),
	BPF_LDX_MEM(BPF_W, BPF_REG_0, BPF_REG_1,
		    offset_of!(__sk_buff, len)),
	BPF_EXIT_INSN(),
	],
...
Test {
	descr: "calls: callee using args1",
	insns: &[
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 1),
	BPF_EXIT_INSN(),
...
Test {
	descr: "calls: callee using wrong args2",
	insns: &[
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 1),
	BPF_EXIT_INSN(),
...
Test {
	descr: "calls: callee using two args",
	insns: &[
	BPF_MOV64_REG(BPF_REG_6, BPF_REG_1),
...
Test {
	descr: "calls: callee changing pkt pointers",
	insns: &[
	BPF_LDX_MEM(BPF_W, BPF_REG_6, BPF_REG_1, offset_of!(xdp_md, data)),
	BPF_LDX_MEM(BPF_W, BPF_REG_7, BPF_REG_1,
		    offset_of!(xdp_md, data_end)),
...
Test {
	descr: "calls: ptr null check in subprog",
	insns: &[
	BPF_ST_MEM(BPF_DW, BPF_REG_10, -8, 0),
	BPF_MOV64_REG(BPF_REG_2, BPF_REG_10),
	BPF_ALU64_IMM(BPF_ADD, BPF_REG_2, -8),
...
Test {
	descr: "calls: two calls with args",
	insns: &[
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 1),
	BPF_EXIT_INSN(),
	BPF_MOV64_REG(BPF_REG_6, BPF_REG_1),
...
Test {
	descr: "calls: calls with stack arith",
	insns: &[
	BPF_MOV64_REG(BPF_REG_2, BPF_REG_10),
...
Test {
	descr: "calls: calls with misaligned stack access",
	insns: &[
	BPF_MOV64_REG(BPF_REG_2, BPF_REG_10),
...
Test {
	descr: "calls: calls control flow, jump test",
	insns: &[
	BPF_MOV64_IMM(BPF_REG_0, 42),
...
Test {
	descr: "calls: calls control flow, jump test 2",
	insns: &[
	BPF_MOV64_IMM(BPF_REG_0, 42),
	BPF_JMP_IMM(BPF_JA, 0, 0, 2),
	BPF_MOV64_IMM(BPF_REG_0, 43),
...
Test {
	descr: "calls: two calls with bad jump",
	insns: &[
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 1),
	BPF_EXIT_INSN(),
	BPF_MOV64_REG(BPF_REG_6, BPF_REG_1),
...
Test {
	descr: "calls: recursive call. test1",
	insns: &[
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 1),
	BPF_EXIT_INSN(),
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, -1),
...
Test {
	descr: "calls: recursive call. test2",
	insns: &[
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 1),
	BPF_EXIT_INSN(),
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, -3),
...
Test {
	descr: "calls: jumping across function bodies. test1",
	insns: &[
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 2),
	BPF_MOV64_IMM(BPF_REG_0, 0),
	BPF_EXIT_INSN(),
...
Test {
	descr: "calls: jumping across function bodies. test2",
	insns: &[
	BPF_JMP_IMM(BPF_JEQ, BPF_REG_1, 0, 3),
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 2),
	BPF_MOV64_IMM(BPF_REG_0, 0),
...
Test {
	descr: "calls: call into middle of ld_imm64",
	insns: &[
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 3),
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 3),
	BPF_MOV64_IMM(BPF_REG_0, 0),
...
Test {
	descr: "calls: call into middle of other call",
	insns: &[
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 3),
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 3),
	BPF_MOV64_IMM(BPF_REG_0, 0),
...
Test {
	descr: "calls: subprog call with ld_abs in main prog",
	insns: &[
	BPF_MOV64_REG(BPF_REG_6, BPF_REG_1),
	BPF_LD_ABS(BPF_B, 0),
	BPF_LD_ABS(BPF_H, 0),
...
Test {
	descr: "calls: two calls with bad fallthrough",
	insns: &[
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 1),
	BPF_EXIT_INSN(),
	BPF_MOV64_REG(BPF_REG_6, BPF_REG_1),
...
Test {
	descr: "calls: two calls with stack read",
	insns: &[
	BPF_ST_MEM(BPF_DW, BPF_REG_10, -8, 0),
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_10),
	BPF_ALU64_IMM(BPF_ADD, BPF_REG_1, -8),
...
Test {
	descr: "calls: two calls with stack write",
	insns: &[
	/* main prog */
	BPF_ST_MEM(BPF_DW, BPF_REG_10, -8, 0),
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_10),
...
Test {
	descr: "calls: stack overflow using two frames (pre-call access)",
	insns: &[
	/* prog 1 */
...
Test {
	descr: "calls: stack overflow using two frames (post-call access)",
	insns: &[
	/* prog 1 */
	BPF_RAW_INSN(BPF_JMP|BPF_CALL, 0, 1, 0, 2),
	BPF_ST_MEM(BPF_B, BPF_REG_10, -300, 0),
...
Test {
	descr: "calls: stack depth check using three frames. test1",
	insns: &[
	/* main */
...
Test {
	descr: "calls: stack depth check using three frames. test2",
	insns: &[
	/* main */
	BPF_RAW_INSN(BPF_JMP|BPF_CALL, 0, 1, 0, 4), /* call A */
	BPF_RAW_INSN(BPF_JMP|BPF_CALL, 0, 1, 0, 5), /* call B */
...
Test {
	descr: "calls: stack depth check using three frames. test3",
	insns: &[
	/* main */
	BPF_MOV64_REG(BPF_REG_6, BPF_REG_1),
...
Test {
	descr: "calls: stack depth check using three frames. test4",
	/* void main(void) {
	 *   func1(0);
	 *   func1(1);
	 *   func2(1);
...
Test {
	descr: "calls: stack depth check using three frames. test5",
	insns: &[
	/* main */
...
Test {
	descr: "calls: stack depth check in dead code",
	insns: &[
	/* main */
	BPF_MOV64_IMM(BPF_REG_1, 0),
	BPF_RAW_INSN(BPF_JMP|BPF_CALL, 0, 1, 0, 1), /* call A */
...
Test {
	descr: "calls: spill into caller stack frame",
	insns: &[
	BPF_ST_MEM(BPF_DW, BPF_REG_10, -8, 0),
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_10),
	BPF_ALU64_IMM(BPF_ADD, BPF_REG_1, -8),
...
Test {
	descr: "calls: write into caller stack frame",
	insns: &[
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_10),
	BPF_ALU64_IMM(BPF_ADD, BPF_REG_1, -8),
	BPF_MOV64_REG(BPF_REG_6, BPF_REG_1),
...
Test {
	descr: "calls: write into callee stack frame",
	insns: &[
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 2),
...
Test {
	descr: "calls: two calls with stack write and void return",
	insns: &[
	/* main prog */
	BPF_ST_MEM(BPF_DW, BPF_REG_10, -8, 0),
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_10),
...
Test {
	descr: "calls: ambiguous return value",
	insns: &[
	BPF_MOV64_REG(BPF_REG_6, BPF_REG_1),
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 5),
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_0),
...
Test {
	descr: "calls: two calls that return map_value",
	insns: &[
	/* main prog */
...
Test {
	descr: "calls: two calls that return map_value with bool condition",
	insns: &[
	/* main prog */
	/* pass fp-16, fp-8 into a function */
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_10),
...
Test {
	descr: "calls: two calls that return map_value with incorrect bool check",
	insns: &[
	/* main prog */
	/* pass fp-16, fp-8 into a function */
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_10),
...
Test {
	descr: "calls: two calls that receive map_value via arg=ptr_stack_of_caller. test1",
	insns: &[
	/* main prog */
	/* pass fp-16, fp-8 into a function */
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_10),
...
Test {
	descr: "calls: two calls that receive map_value via arg=ptr_stack_of_caller. test2",
	insns: &[
	/* main prog */
	/* pass fp-16, fp-8 into a function */
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_10),
...
Test {
	descr: "calls: two jumps that receive map_value via arg=ptr_stack_of_jumper. test3",
	insns: &[
	/* main prog */
	/* pass fp-16, fp-8 into a function */
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_10),
...
Test {
	descr: "calls: two calls that receive map_value_ptr_or_null via arg. test1",
	insns: &[
	/* main prog */
	/* pass fp-16, fp-8 into a function */
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_10),
...
Test {
	descr: "calls: two calls that receive map_value_ptr_or_null via arg. test2",
	insns: &[
	/* main prog */
	/* pass fp-16, fp-8 into a function */
	BPF_MOV64_REG(BPF_REG_1, BPF_REG_10),
...
Test {
	descr: "calls: pkt_ptr spill into caller stack",
	insns: &[
...
Test {
	descr: "calls: pkt_ptr spill into caller stack 2",
	insns: &[
	BPF_MOV64_REG(BPF_REG_4, BPF_REG_10),
	BPF_ALU64_IMM(BPF_ADD, BPF_REG_4, -8),
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 3),
...
Test {
	descr: "calls: pkt_ptr spill into caller stack 3",
	insns: &[
	BPF_MOV64_REG(BPF_REG_4, BPF_REG_10),
	BPF_ALU64_IMM(BPF_ADD, BPF_REG_4, -8),
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 4),
...
Test {
	descr: "calls: pkt_ptr spill into caller stack 4",
	insns: &[
	BPF_MOV64_REG(BPF_REG_4, BPF_REG_10),
	BPF_ALU64_IMM(BPF_ADD, BPF_REG_4, -8),
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 4),
...
Test {
	descr: "calls: pkt_ptr spill into caller stack 5",
	insns: &[
	BPF_MOV64_REG(BPF_REG_4, BPF_REG_10),
	BPF_ALU64_IMM(BPF_ADD, BPF_REG_4, -8),
...
Test {
	descr: "calls: pkt_ptr spill into caller stack 6",
	insns: &[
	BPF_LDX_MEM(BPF_W, BPF_REG_2, BPF_REG_1,
		    offset_of!(__sk_buff, data_end)),
	BPF_MOV64_REG(BPF_REG_4, BPF_REG_10),
...
Test {
	descr: "calls: pkt_ptr spill into caller stack 7",
	insns: &[
	BPF_MOV64_IMM(BPF_REG_2, 0),
	BPF_MOV64_REG(BPF_REG_4, BPF_REG_10),
	BPF_ALU64_IMM(BPF_ADD, BPF_REG_4, -8),
...
Test {
	descr: "calls: pkt_ptr spill into caller stack 8",
	insns: &[
	BPF_LDX_MEM(BPF_W, BPF_REG_2, BPF_REG_1,
		    offset_of!(__sk_buff, data)),
	BPF_LDX_MEM(BPF_W, BPF_REG_3, BPF_REG_1,
...
Test {
	descr: "calls: pkt_ptr spill into caller stack 9",
	insns: &[
	BPF_LDX_MEM(BPF_W, BPF_REG_2, BPF_REG_1,
		    offset_of!(__sk_buff, data)),
	BPF_LDX_MEM(BPF_W, BPF_REG_3, BPF_REG_1,
...
Test {
	descr: "calls: caller stack init to zero or map_value_or_null",
	insns: &[
	BPF_MOV64_IMM(BPF_REG_0, 0),
...
Test {
	descr: "calls: stack init to zero and pruning",
	insns: &[
...
Test {
	descr: "calls: ctx read at start of subprog",
	insns: &[
	BPF_MOV64_REG(BPF_REG_6, BPF_REG_1),
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 1, 0, 5),
...
Test {
	descr: "calls: cross frame pruning",
	insns: &[
	/* r8 = !!random();
	 * call pruner()
	 * if (r8)
...
Test {
	descr: "calls: cross frame pruning - liveness propagation",
	insns: &[
	BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 0, 0, BPF_FUNC_get_prandom_u32),
	BPF_MOV64_IMM(BPF_REG_8, 0),
	BPF_JMP_IMM(BPF_JNE, BPF_REG_0, 0, 1),
 ...
 */
Test {
	descr: "calls: check_ids() across call boundary",
	insns: &[
	/* Function main() */
	BPF_ST_MEM(BPF_DW, BPF_REG_10, -8, 0),
