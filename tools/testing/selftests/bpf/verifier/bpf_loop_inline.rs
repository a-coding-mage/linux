...
// BTF_TYPE_INT_ENC, BTF_INT_SIGNED, BTF_PTR_ENC, BTF_FUNC_PROTO_ENC,
// BTF_FUNC_PROTO_ARG_ENC, BTF_FUNC_ENC, BTF_END_RAW, BPF_* instruction
// constructors/constants, Test, and bpf_fill_big_prog_with_loop_1 are supplied
// by the surrounding verifier test infrastructure.

pub const MAIN_TYPE: i32 = 6;
pub const CALLBACK_TYPE: i32 = 7;

/* can't use BPF_CALL_REL, jit_subprogs adjusts IMM & OFF
 * fields for pseudo calls
 */
macro_rules! PSEUDO_CALL_INSN {
    () => {
        BPF_RAW_INSN(
            BPF_JMP | BPF_CALL,
            0,
...
extern "C" {
    fn bpf_fill_big_prog_with_loop_1();
}

pub static BPF_LOOP_INLINE_TESTS: &[Test] = &[
    Test {
        name: "inline simple bpf_loop call",
        insns: &[
            /* main */
    ...
    Test {
        name: "don't inline bpf_loop call, flags non-zero",
        insns: &[
            /* main */
            BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 0, 0, BPF_FUNC_jiffies64),
    ...
    Test {
        name: "don't inline bpf_loop call, callback non-constant",
        insns: &[
            /* main */
            BPF_RAW_INSN(BPF_JMP | BPF_CALL, 0, 0, 0, BPF_FUNC_jiffies64),
        ...
        result: ACCEPT,
        runs: 0,
        func_info: &[(0, MAIN_TYPE), (14, CALLBACK_TYPE), (16, CALLBACK_TYPE)],
        func_info_cnt: 3,
        btf_strings: "\0int\0i\0ctx\0callback\0main\0",
        btf_types: &[
            /* 1: int   */ BTF_TYPE_INT_ENC(1, BTF_INT_SIGNED, 0, 32, 4),
    ...
    Test {
        name: "bpf_loop_inline and a dead func",
        insns: &[
            /* main */
        ...
        result: ACCEPT,
        runs: 0,
        func_info: &[(0, MAIN_TYPE), (10, CALLBACK_TYPE), (12, CALLBACK_TYPE)],
        func_info_cnt: 3,
        btf_strings: "\0int\0i\0ctx\0callback\0main\0",
        btf_types: &[
            /* 1: int   */ BTF_TYPE_INT_ENC(1, BTF_INT_SIGNED, 0, 32, 4),
    ...
    Test {
        name: "bpf_loop_inline stack locations for loop vars",
        insns: &[
            /* main */
        ...
        flags: F_NEEDS_JIT_ENABLED,
        result: ACCEPT,
        func_info: &[(0, MAIN_TYPE), (16, MAIN_TYPE), (25, CALLBACK_TYPE)],
        func_info_cnt: 3,
        btf_strings: "\0int\0i\0ctx\0callback\0main\0",
        btf_types: &[
            /* 1: int   */ BTF_TYPE_INT_ENC(1, BTF_INT_SIGNED, 0, 32, 4),
    ...
    Test {
        name: "inline bpf_loop call in a big program",
        insns: &[],
        fill_helper: Some(bpf_fill_big_prog_with_loop_1),
        expected_insns: &[PSEUDO_CALL_INSN!()],
        unexpected_insns: &[HELPER_CALL_INSN!()],
        result: ACCEPT,
        prog_type: BPF_PROG_TYPE_TRACEPOINT,
