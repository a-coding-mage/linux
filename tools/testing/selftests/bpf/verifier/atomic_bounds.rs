// Translated from testing/selftests/bpf/verifier/atomic_bounds.c.
// BPF instruction constructors and verifier result constants are provided
// by the surrounding verifier test harness.

BpfTest {
    descr: "BPF_ATOMIC bounds propagation, mem->reg",
    insns: &[
        /* a = 0; */
        /*
