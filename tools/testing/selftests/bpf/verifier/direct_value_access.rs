pub static DIRECT_VALUE_ACCESS: &[BpfTest] = &[
    BpfTest {
        descr: "direct map access, write test 1",
        insns: &[
    ...
    BpfTest {
        descr: "direct map access, write test 2",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
    ...
    BpfTest {
        descr: "direct map access, write test 3",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
            BPF_LD_MAP_VALUE(BPF_REG_1, 0, 8),
    ...
    BpfTest {
        descr: "direct map access, write test 4",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
    ...
    BpfTest {
        descr: "direct map access, write test 5",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
    ...
    BpfTest {
        descr: "direct map access, write test 6",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
            BPF_LD_MAP_VALUE(BPF_REG_1, 0, 40),
    ...
    BpfTest {
        descr: "direct map access, write test 7",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
    ...
    BpfTest {
        descr: "direct map access, write test 8",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
            BPF_LD_MAP_VALUE(BPF_REG_1, 0, 1),
    ...
    BpfTest {
        descr: "direct map access, write test 9",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
    ...
    BpfTest {
        descr: "direct map access, write test 10",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
    ...
    BpfTest {
        descr: "direct map access, write test 11",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
            BPF_LD_MAP_VALUE(BPF_REG_1, 0, 48),
            BPF_ST_MEM(BPF_B, BPF_REG_1, 0, 4),
    ...
    BpfTest {
        descr: "direct map access, write test 12",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
    ...
    BpfTest {
        descr: "direct map access, write test 13",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
    ...
    BpfTest {
        descr: "direct map access, write test 14",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
            BPF_LD_MAP_VALUE(BPF_REG_1, 0, 47),
    ...
    BpfTest {
        descr: "direct map access, write test 15",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
    ...
    BpfTest {
        descr: "direct map access, write test 16",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
            BPF_LD_MAP_VALUE(BPF_REG_1, 0, 46),
    ...
    BpfTest {
        descr: "direct map access, write test 17",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
            BPF_LD_MAP_VALUE(BPF_REG_1, 0, 46),
            BPF_LD_MAP_VALUE(BPF_REG_2, 0, 46),
    ...
    BpfTest {
        descr: "direct map access, write test 18",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
            BPF_LD_MAP_VALUE(BPF_REG_1, 0, 0),
    ...
    BpfTest {
        descr: "direct map access, write test 19",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
            BPF_LD_MAP_VALUE(BPF_REG_1, 0, 0),
    ...
    BpfTest {
        descr: "direct map access, write test 20",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
            BPF_LD_MAP_VALUE(BPF_REG_1, 0, 1),
            BPF_ST_MEM(BPF_B, BPF_REG_1, 0, 42),
    ...
    BpfTest {
        descr: "direct map access, invalid insn test 1",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
    ...
    BpfTest {
        descr: "direct map access, invalid insn test 2",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
    ...
    BpfTest {
        descr: "direct map access, invalid insn test 3",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
    ...
    BpfTest {
        descr: "direct map access, invalid insn test 4",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
            BPF_LD_IMM64_RAW_FULL(BPF_REG_1, BPF_PSEUDO_MAP_VALUE, 0, !0, 0, 47),
            BPF_EXIT_INSN(),
    ...
    BpfTest {
        descr: "direct map access, invalid insn test 5",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
            BPF_LD_IMM64_RAW_FULL(BPF_REG_1, BPF_PSEUDO_MAP_VALUE, !0, !0, 0, 47),
            BPF_EXIT_INSN(),
    ...
    BpfTest {
        descr: "direct map access, invalid insn test 6",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
    ...
    BpfTest {
        descr: "direct map access, invalid insn test 7",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
            BPF_LD_IMM64_RAW_FULL(BPF_REG_1, BPF_PSEUDO_MAP_FD, 0, !0, 0, 0),
            BPF_EXIT_INSN(),
    ...
    BpfTest {
        descr: "direct map access, invalid insn test 8",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
            BPF_LD_IMM64_RAW_FULL(BPF_REG_1, BPF_PSEUDO_MAP_FD, !0, !0, 0, 0),
            BPF_EXIT_INSN(),
    ...
    BpfTest {
        descr: "direct map access, invalid insn test 9",
        insns: &[
            BPF_MOV64_IMM(BPF_REG_0, 1),
