// Translated from testing/selftests/bpf/verifier/ctx_skb.c.
// External verifier harness items and BPF instruction constructors are expected to be supplied by the including Rust context.
translated_tests! {
{
