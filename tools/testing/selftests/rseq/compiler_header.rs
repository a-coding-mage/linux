 ...
 */
#[inline(always)]
pub unsafe fn rseq_after_asm_goto() {
    core::arch::asm!("", options(nostack, preserves_flags));
}

/* Combine two tokens. */
/*
 * C token pasting has no stable, direct Rust item-level equivalent. The
 * original macros were:
 *
 * #define RSEQ__COMBINE_TOKENS(_tokena, _tokenb) _tokena##_tokenb
 * #define RSEQ_COMBINE_TOKENS(_tokena, _tokenb) RSEQ__COMBINE_TOKENS(_tokena, _tokenb)
 */

/*
 * Original C/C++ conditional macro translation intent:
 *
 * #ifdef __cplusplus
 ...
 * #endif
 *
 * Rust does not provide a local macro equivalent to C __typeof__/_Generic or
