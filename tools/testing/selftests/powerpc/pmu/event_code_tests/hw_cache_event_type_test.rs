...
fn hw_cache_event_type_test() -> i32 {
    ...
    event_init_opts(&mut event, EventCode_1, PERF_TYPE_HW_CACHE, "event");
    ...
    /* Init the event to test hardware cache event */
    event_init_opts(&mut event, EventCode_2, PERF_TYPE_HW_CACHE, "event");
    ...
    /* Init the event to test hardware cache event */
    event_init_opts(&mut event, EventCode_3, PERF_TYPE_HW_CACHE, "event");
    ...
    /* Init the event to test hardware cache event */
    event_init_opts(&mut event, EventCode_4, PERF_TYPE_HW_CACHE, "event");
