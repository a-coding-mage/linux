...
// dependency include: <stdint.h>
// dependency include: <stdio.h>
// dependency include: <inttypes.h>
// dependency include: <stdbool.h>
// dependency include: <string.h>
// dependency include: <errno.h>
// dependency include: <unistd.h>
// dependency include: <arpa/inet.h>
// dependency include: <net/if.h>
// dependency include: <netinet/in.h>
// dependency include: <time.h>

// dependency include: <linux/ovpn.h>
// dependency include: <linux/types.h>
// dependency include: <linux/netlink.h>

// dependency include: <netlink/socket.h>
// dependency include: <netlink/netlink.h>
// dependency include: <netlink/genl/genl.h>
// dependency include: <netlink/genl/family.h>
// dependency include: <netlink/genl/ctrl.h>

// dependency include: <mbedtls/base64.h>
// dependency include: <mbedtls/error.h>

// dependency include: <sys/socket.h>

// dependency include: "kselftest.h"

/* defines to make checkpatch happy */
// C macro: strscpy strncpy
...
// C macro: KEY_LEN (256 / 8)
// C macro: NONCE_LEN 8

// C macro: PEER_ID_UNDEF 0x00FFFFFF
// C macro: MAX_PEERS 10
...
// C macro: RT_RCVBUF_SIZE (1024 * 4)

/* Open RTNL socket */
unsafe fn int ovpn_rt_socket(void)
{
...
unsafe fn int ovpn_rt_bind(int fd, uint32_t groups)
{
...
unsafe fn void usage(const char *cmd)
{
	fprintf(stderr,
...
unsafe fn int ovpn_send_tcp_data(int socket)
{
...
unsafe fn int ovpn_recv_tcp_data(int socket)
{
	uint8_t buf[1002];
	uint16_t len;
	int ret;
...
unsafe fn enum ovpn_cmd ovpn_parse_cmd(const char *cmd)
{
 ...
 */
unsafe fn void ovpn_waitbg(void)
{
	daemon(1, 1);
	pause();
}
...
pub unsafe fn main_c(int argc, char *argv[])
{
