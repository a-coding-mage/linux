...
// Translated from C implementation source. Dependencies originally included:
// <linux/compiler.h>, <linux/export.h>, <linux/list_sort.h>, <linux/list.h>
...
pub unsafe extern "C" fn list_sort(
    ...
    let mut list: *mut list_head = (*head).next;
    ...
    loop {
        ...
        if bits != 0 {
            let mut a: *mut list_head = *tail;
            let b: *mut list_head = (*a).prev;
    ...
    loop {
        let next: *mut list_head = (*pending).prev;
