 ...
 */
pub type libbpf_strict_mode = u32;

/* Turn on all supported strict features of libbpf to simulate libbpf
 * v1.0 behavior.
 * This will be the default behavior in libbpf v1.0.
 */
pub const LIBBPF_STRICT_ALL: libbpf_strict_mode = 0xffffffff;
 ...
 */
pub const LIBBPF_STRICT_NONE: libbpf_strict_mode = 0x00;
 ...
 * (positive) error code.
 */
pub const LIBBPF_STRICT_CLEAN_PTRS: libbpf_strict_mode = 0x01;
 ...
 * (positive) error code.
 */
pub const LIBBPF_STRICT_DIRECT_ERRS: libbpf_strict_mode = 0x02;
 ...
 * to be a program.
 */
pub const LIBBPF_STRICT_SEC_NAME: libbpf_strict_mode = 0x04;
 ...
 */
pub const LIBBPF_STRICT_NO_OBJECT_LIST: libbpf_strict_mode = 0x08;
 ...
 * operation.
 */
pub const LIBBPF_STRICT_AUTO_RLIMIT_MEMLOCK: libbpf_strict_mode = 0x10;

/*
 * Error out on any SEC("maps") map definition, which are deprecated
 * in favor of BTF-defined map definitions in SEC(".maps").
 */
pub const LIBBPF_STRICT_MAP_DEFINITIONS: libbpf_strict_mode = 0x20;

pub const __LIBBPF_STRICT_LAST: libbpf_strict_mode = 0x21;

unsafe extern "C" {
    pub fn libbpf_set_strict_mode(mode: libbpf_strict_mode) -> c_int;
}
 ...
 */
unsafe extern "C" {
    pub fn libbpf_get_error(ptr: *const c_void) -> c_long;
}
...
unsafe extern "C" {
    ...
    pub fn bpf_map__get_pin_path(map: *const bpf_map) -> *const c_char;
