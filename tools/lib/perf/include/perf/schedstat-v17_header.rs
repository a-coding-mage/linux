...
// Original C condition: #ifdef CPU_FIELD
#[cfg(feature = "CPU_FIELD")]
...
// Original C condition: #ifdef DOMAIN_FIELD
#[cfg(all(feature = "DOMAIN_FIELD", feature = "DOMAIN_CATEGORY"))]
DOMAIN_CATEGORY!(" <Category busy> ");
#[cfg(feature = "DOMAIN_FIELD")]
...
#[cfg(all(feature = "DOMAIN_FIELD", feature = "DERIVED_CNT_FIELD"))]
...
#[cfg(all(feature = "DOMAIN_FIELD", feature = "DERIVED_AVG_FIELD"))]
