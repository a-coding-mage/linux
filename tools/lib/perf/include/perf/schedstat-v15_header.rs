...
/* C header conditional: #ifdef CPU_FIELD */
CPU_FIELD!(u32, yld_count, "sched_yield() count",
    "%11u", false, yld_count, v15);
CPU_FIELD!(u32, array_exp, "Legacy counter can be ignored",
    "%11u", false, array_exp, v15);
CPU_FIELD!(u32, sched_count, "schedule() called",
    "%11u", false, sched_count, v15);
CPU_FIELD!(u32, sched_goidle, "schedule() left the processor idle",
    "%11u", true, sched_count, v15);
CPU_FIELD!(u32, ttwu_count, "try_to_wake_up() was called",
    "%11u", false, ttwu_count, v15);
CPU_FIELD!(u32, ttwu_local, "try_to_wake_up() was called to wake up the local cpu",
    "%11u", true, ttwu_count, v15);
CPU_FIELD!(u64, rq_cpu_time, "total runtime by tasks on this processor (in jiffies)",
    "%11llu", false, rq_cpu_time, v15);
CPU_FIELD!(u64, run_delay, "total waittime by tasks on this processor (in jiffies)",
    "%11llu", true, rq_cpu_time, v15);
CPU_FIELD!(u64, pcount, "total timeslices run on this cpu",
    "%11llu", false, pcount, v15);
/* End C header conditional: #endif */

/* C header conditional: #ifdef DOMAIN_FIELD */
/* C header conditional: #ifdef DOMAIN_CATEGORY */
DOMAIN_CATEGORY!(" <Category idle> ");
/* End C header conditional: #endif */
DOMAIN_FIELD!(u32, idle_lb_count,
    "load_balance() count on cpu idle", "%11u", true, v15);
DOMAIN_FIELD!(u32, idle_lb_balanced,
    "load_balance() found balanced on cpu idle", "%11u", true, v15);
DOMAIN_FIELD!(u32, idle_lb_failed,
    "load_balance() move task failed on cpu idle", "%11u", true, v15);
DOMAIN_FIELD!(u32, idle_lb_imbalance,
    "imbalance sum on cpu idle", "%11u", false, v15);
DOMAIN_FIELD!(u32, idle_lb_gained,
    "pull_task() count on cpu idle", "%11u", false, v15);
DOMAIN_FIELD!(u32, idle_lb_hot_gained,
    "pull_task() when target task was cache-hot on cpu idle", "%11u", false, v15);
DOMAIN_FIELD!(u32, idle_lb_nobusyq,
    "load_balance() failed to find busier queue on cpu idle", "%11u", true, v15);
DOMAIN_FIELD!(u32, idle_lb_nobusyg,
    "load_balance() failed to find busier group on cpu idle", "%11u", true, v15);
/* C header conditional: #ifdef DERIVED_CNT_FIELD */
...
/* End C header conditional: #endif */
/* C header conditional: #ifdef DERIVED_AVG_FIELD */
