...
pub struct prctl_mm_map {
    pub start_code: u64, /* code section bounds */
    pub end_code: u64,
    pub start_data: u64, /* data section bounds */
    pub end_data: u64,
    pub start_brk: u64, /* heap for brk() syscall */
    pub brk: u64,
    pub start_stack: u64, /* stack starts at */
    pub arg_start: u64, /* command line arguments bounds */
    pub arg_end: u64,
    pub env_start: u64, /* environment variables bounds */
    pub env_end: u64,
    pub auxv: *mut u64, /* auxiliary vector */
    pub auxv_size: u32, /* vector size */
    pub exe_fd: u32, /* /proc/$pid/exe link file */
}
 ...
 */
pub const PR_THP_DISABLE_EXCEPT_ADVISED: u32 = 1 << 1;
...
pub const PR_RSEQ_SLICE_EXTENSION: u32 = 79;
pub const PR_RSEQ_SLICE_EXTENSION_GET: u32 = 1;
pub const PR_RSEQ_SLICE_EXTENSION_SET: u32 = 2;
/*
 * Bits for RSEQ_SLICE_EXTENSION_GET/SET
 * PR_RSEQ_SLICE_EXT_ENABLE:	Enable
 */
pub const PR_RSEQ_SLICE_EXT_ENABLE: u32 = 0x01;
 ...
 */
pub const PR_GET_CFI: u32 = 80;
pub const PR_SET_CFI: u32 = 81;
/*
 * Forward-edge CFI variants (excluding ARM64 BTI, which has its own
 * prctl()s).
 */
pub const PR_CFI_BRANCH_LANDING_PADS: u32 = 0;
