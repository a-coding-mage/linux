...
/* Rust translation of include/uapi/linux/mount.h */
...
pub const OPEN_TREE_CLOEXEC: u32 = O_CLOEXEC as u32; /* Close the file on execve() */
...
pub struct statmount {
    ...
    pub str: [::core::ffi::c_char; 0], /* Variable size part containing strings */
}
...
pub struct mnt_id_req {
    pub size: __u32,
    pub u: mnt_id_req__bindgen_ty_1,
    pub mnt_id: __u64,
    pub param: __u64,
    pub mnt_ns_id: __u64,
}
