...
/* Depends on Linux ioctl request-construction helpers from <linux/ioctl.h>. */
...
pub const TCGETS2: u32 = _IOR::<termios2>(b'T', 0x2A);
pub const TCSETS2: u32 = _IOW::<termios2>(b'T', 0x2B);
pub const TCSETSW2: u32 = _IOW::<termios2>(b'T', 0x2C);
pub const TCSETSF2: u32 = _IOW::<termios2>(b'T', 0x2D);
pub const TIOCGRS485: u32 = 0x542E;
/* If TIOCSRS485 is not already defined by an architecture, use this value. */
pub const TIOCSRS485: u32 = 0x542F;
pub const TIOCGPTN: u32 = _IOR::<core::ffi::c_uint>(b'T', 0x30); /* Get Pty Number (of pty-mux device) */
pub const TIOCSPTLCK: u32 = _IOW::<core::ffi::c_int>(b'T', 0x31); /* Lock/unlock Pty */
pub const TIOCGDEV: u32 = _IOR::<core::ffi::c_uint>(b'T', 0x32); /* Get primary device node of /dev/console */
...
pub const TIOCSIG: u32 = _IOW::<core::ffi::c_int>(b'T', 0x36); /* pty: generate signal */
pub const TIOCVHANGUP: u32 = 0x5437;
pub const TIOCGPKT: u32 = _IOR::<core::ffi::c_int>(b'T', 0x38); /* Get packet mode state */
pub const TIOCGPTLCK: u32 = _IOR::<core::ffi::c_int>(b'T', 0x39); /* Get Pty lock state */
pub const TIOCGEXCL: u32 = _IOR::<core::ffi::c_int>(b'T', 0x40); /* Get exclusive mode state */
pub const TIOCGPTPEER: u32 = _IO(b'T', 0x41); /* Safely open the slave */
pub const TIOCGISO7816: u32 = _IOR::<serial_iso7816>(b'T', 0x42);
pub const TIOCSISO7816: u32 = _IOWR::<serial_iso7816>(b'T', 0x43);
 ...
 */
/* If FIOQSIZE is not already defined by an architecture, use this value. */
