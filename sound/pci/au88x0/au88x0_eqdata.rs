...
static asEqCoefsNormal: auxxEqCoeffSet_t = auxxEqCoeffSet_t {
    LeftCoefs: [
...
/* _rodatab60 */
static eq_gains_zero: [u16; 10] = [
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
];

/* _rodatab7c:  ProgramPipe */
static eq_gains_current: [u16; 12] = [
...
/* _rodatab78 */
static eq_states_zero: [u16; 2] = [0x0000, 0x0000];

static asEqOutStateZeros: [u16; 48] = [
