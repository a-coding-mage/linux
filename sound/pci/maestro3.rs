...
/*
 * Faithful source-level Rust translation unit for pci/maestro3.c.
 *
 * This Linux kernel driver depends on kernel/ALSA/PCI C APIs supplied by
 * the surrounding repository. External types, functions, constants, module
 * metadata macros, and build-time CONFIG_* branches are preserved by name or
 * documented at the translation site rather than implemented locally.
 */
...
pub const MAX_PLAYBACKS: c_uint = (2) as c_uint;
pub const MAX_CAPTURES: c_uint = (1) as c_uint;
pub const NR_DSPS: c_uint = ((MAX_PLAYBACKS + MAX_CAPTURES)) as c_uint;
pub const PCI_LEGACY_AUDIO_CTRL: c_uint = (0x40) as c_uint;
pub const SOUND_BLASTER_ENABLE: c_uint = (0x00000001) as c_uint;
pub const FM_SYNTHESIS_ENABLE: c_uint = (0x00000002) as c_uint;
pub const GAME_PORT_ENABLE: c_uint = (0x00000004) as c_uint;
pub const MPU401_IO_ENABLE: c_uint = (0x00000008) as c_uint;
pub const MPU401_IRQ_ENABLE: c_uint = (0x00000010) as c_uint;
pub const ALIAS_10BIT_IO: c_uint = (0x00000020) as c_uint;
pub const SB_DMA_MASK: c_uint = (0x000000C0) as c_uint;
pub const SB_DMA_0: c_uint = (0x00000040) as c_uint;
pub const SB_DMA_1: c_uint = (0x00000040) as c_uint;
pub const SB_DMA_R: c_uint = (0x00000080) as c_uint;
pub const SB_DMA_3: c_uint = (0x000000C0) as c_uint;
pub const SB_IRQ_MASK: c_uint = (0x00000700) as c_uint;
pub const SB_IRQ_5: c_uint = (0x00000000) as c_uint;
pub const SB_IRQ_7: c_uint = (0x00000100) as c_uint;
pub const SB_IRQ_9: c_uint = (0x00000200) as c_uint;
pub const SB_IRQ_10: c_uint = (0x00000300) as c_uint;
pub const MIDI_IRQ_MASK: c_uint = (0x00003800) as c_uint;
pub const SERIAL_IRQ_ENABLE: c_uint = (0x00004000) as c_uint;
pub const DISABLE_LEGACY: c_uint = (0x00008000) as c_uint;
pub const PCI_ALLEGRO_CONFIG: c_uint = (0x50) as c_uint;
pub const SB_ADDR_240: c_uint = (0x00000004) as c_uint;
pub const MPU_ADDR_MASK: c_uint = (0x00000018) as c_uint;
pub const MPU_ADDR_330: c_uint = (0x00000000) as c_uint;
pub const MPU_ADDR_300: c_uint = (0x00000008) as c_uint;
pub const MPU_ADDR_320: c_uint = (0x00000010) as c_uint;
pub const MPU_ADDR_340: c_uint = (0x00000018) as c_uint;
pub const USE_PCI_TIMING: c_uint = (0x00000040) as c_uint;
pub const POSTED_WRITE_ENABLE: c_uint = (0x00000080) as c_uint;
pub const DMA_POLICY_MASK: c_uint = (0x00000700) as c_uint;
pub const DMA_DDMA: c_uint = (0x00000000) as c_uint;
pub const DMA_TDMA: c_uint = (0x00000100) as c_uint;
pub const DMA_PCPCI: c_uint = (0x00000200) as c_uint;
pub const DMA_WBDMA16: c_uint = (0x00000400) as c_uint;
pub const DMA_WBDMA4: c_uint = (0x00000500) as c_uint;
pub const DMA_WBDMA2: c_uint = (0x00000600) as c_uint;
pub const DMA_WBDMA1: c_uint = (0x00000700) as c_uint;
pub const DMA_SAFE_GUARD: c_uint = (0x00000800) as c_uint;
pub const HI_PERF_GP_ENABLE: c_uint = (0x00001000) as c_uint;
pub const PIC_SNOOP_MODE_0: c_uint = (0x00002000) as c_uint;
pub const PIC_SNOOP_MODE_1: c_uint = (0x00004000) as c_uint;
pub const SOUNDBLASTER_IRQ_MASK: c_uint = (0x00008000) as c_uint;
pub const RING_IN_ENABLE: c_uint = (0x00010000) as c_uint;
pub const SPDIF_TEST_MODE: c_uint = (0x00020000) as c_uint;
pub const CLK_MULT_MODE_SELECT_2: c_uint = (0x00040000) as c_uint;
pub const EEPROM_WRITE_ENABLE: c_uint = (0x00080000) as c_uint;
pub const CODEC_DIR_IN: c_uint = (0x00100000) as c_uint;
pub const HV_BUTTON_FROM_GD: c_uint = (0x00200000) as c_uint;
pub const REDUCED_DEBOUNCE: c_uint = (0x00400000) as c_uint;
pub const HV_CTRL_ENABLE: c_uint = (0x00800000) as c_uint;
pub const SPDIF_ENABLE: c_uint = (0x01000000) as c_uint;
pub const CLK_DIV_SELECT: c_uint = (0x06000000) as c_uint;
pub const CLK_DIV_BY_48: c_uint = (0x00000000) as c_uint;
pub const CLK_DIV_BY_49: c_uint = (0x02000000) as c_uint;
pub const CLK_DIV_BY_50: c_uint = (0x04000000) as c_uint;
pub const CLK_DIV_RESERVED: c_uint = (0x06000000) as c_uint;
pub const PM_CTRL_ENABLE: c_uint = (0x08000000) as c_uint;
pub const CLK_MULT_MODE_SELECT: c_uint = (0x30000000) as c_uint;
pub const CLK_MULT_MODE_SHIFT: c_uint = (28) as c_uint;
pub const CLK_MULT_MODE_0: c_uint = (0x00000000) as c_uint;
pub const CLK_MULT_MODE_1: c_uint = (0x10000000) as c_uint;
pub const CLK_MULT_MODE_2: c_uint = (0x20000000) as c_uint;
pub const CLK_MULT_MODE_3: c_uint = (0x30000000) as c_uint;
pub const INT_CLK_SELECT: c_uint = (0x40000000) as c_uint;
pub const INT_CLK_MULT_RESET: c_uint = (0x80000000) as c_uint;
pub const INT_CLK_SRC_NOT_PCI: c_uint = (0x00100000) as c_uint;
pub const INT_CLK_MULT_ENABLE: c_uint = (0x80000000) as c_uint;
pub const PCI_ACPI_CONTROL: c_uint = (0x54) as c_uint;
pub const PCI_ACPI_D0: c_uint = (0x00000000) as c_uint;
pub const PCI_ACPI_D1: c_uint = (0xB4F70000) as c_uint;
pub const PCI_ACPI_D2: c_uint = (0xB4F7B4F7) as c_uint;
pub const PCI_USER_CONFIG: c_uint = (0x58) as c_uint;
pub const EXT_PCI_MASTER_ENABLE: c_uint = (0x00000001) as c_uint;
pub const SPDIF_OUT_SELECT: c_uint = (0x00000002) as c_uint;
pub const TEST_PIN_DIR_CTRL: c_uint = (0x00000004) as c_uint;
pub const AC97_CODEC_TEST: c_uint = (0x00000020) as c_uint;
pub const TRI_STATE_BUFFER: c_uint = (0x00000080) as c_uint;
pub const IN_CLK_12MHZ_SELECT: c_uint = (0x00000100) as c_uint;
pub const MULTI_FUNC_DISABLE: c_uint = (0x00000200) as c_uint;
pub const EXT_MASTER_PAIR_SEL: c_uint = (0x00000400) as c_uint;
pub const PCI_MASTER_SUPPORT: c_uint = (0x00000800) as c_uint;
pub const STOP_CLOCK_ENABLE: c_uint = (0x00001000) as c_uint;
pub const EAPD_DRIVE_ENABLE: c_uint = (0x00002000) as c_uint;
pub const REQ_TRI_STATE_ENABLE: c_uint = (0x00004000) as c_uint;
pub const REQ_LOW_ENABLE: c_uint = (0x00008000) as c_uint;
pub const MIDI_1_ENABLE: c_uint = (0x00010000) as c_uint;
pub const MIDI_2_ENABLE: c_uint = (0x00020000) as c_uint;
pub const SB_AUDIO_SYNC: c_uint = (0x00040000) as c_uint;
pub const HV_CTRL_TEST: c_uint = (0x00100000) as c_uint;
pub const SOUNDBLASTER_TEST: c_uint = (0x00400000) as c_uint;
pub const PCI_USER_CONFIG_C: c_uint = (0x5C) as c_uint;
pub const PCI_DDMA_CTRL: c_uint = (0x60) as c_uint;
pub const DDMA_ENABLE: c_uint = (0x00000001) as c_uint;
pub const HOST_INT_CTRL: c_uint = (0x18) as c_uint;
pub const SB_INT_ENABLE: c_uint = (0x0001) as c_uint;
pub const MPU401_INT_ENABLE: c_uint = (0x0002) as c_uint;
pub const ASSP_INT_ENABLE: c_uint = (0x0010) as c_uint;
pub const RING_INT_ENABLE: c_uint = (0x0020) as c_uint;
pub const HV_INT_ENABLE: c_uint = (0x0040) as c_uint;
pub const CLKRUN_GEN_ENABLE: c_uint = (0x0100) as c_uint;
pub const HV_CTRL_TO_PME: c_uint = (0x0400) as c_uint;
pub const SOFTWARE_RESET_ENABLE: c_uint = (0x8000) as c_uint;
pub const REGB_ENABLE_RESET: c_uint = (0x01) as c_uint;
pub const REGB_STOP_CLOCK: c_uint = (0x10) as c_uint;
pub const HOST_INT_STATUS: c_uint = (0x1A) as c_uint;
pub const SB_INT_PENDING: c_uint = (0x01) as c_uint;
pub const MPU401_INT_PENDING: c_uint = (0x02) as c_uint;
pub const ASSP_INT_PENDING: c_uint = (0x10) as c_uint;
pub const RING_INT_PENDING: c_uint = (0x20) as c_uint;
pub const HV_INT_PENDING: c_uint = (0x40) as c_uint;
pub const HARDWARE_VOL_CTRL: c_uint = (0x1B) as c_uint;
pub const SHADOW_MIX_REG_VOICE: c_uint = (0x1C) as c_uint;
pub const HW_VOL_COUNTER_VOICE: c_uint = (0x1D) as c_uint;
pub const SHADOW_MIX_REG_MASTER: c_uint = (0x1E) as c_uint;
pub const HW_VOL_COUNTER_MASTER: c_uint = (0x1F) as c_uint;
pub const CODEC_COMMAND: c_uint = (0x30) as c_uint;
pub const CODEC_READ_B: c_uint = (0x80) as c_uint;
pub const CODEC_STATUS: c_uint = (0x30) as c_uint;
pub const CODEC_BUSY_B: c_uint = (0x01) as c_uint;
pub const CODEC_DATA: c_uint = (0x32) as c_uint;
pub const RING_BUS_CTRL_A: c_uint = (0x36) as c_uint;
pub const RAC_PME_ENABLE: c_uint = (0x0100) as c_uint;
pub const RAC_SDFS_ENABLE: c_uint = (0x0200) as c_uint;
pub const LAC_PME_ENABLE: c_uint = (0x0400) as c_uint;
pub const LAC_SDFS_ENABLE: c_uint = (0x0800) as c_uint;
pub const SERIAL_AC_LINK_ENABLE: c_uint = (0x1000) as c_uint;
pub const IO_SRAM_ENABLE: c_uint = (0x2000) as c_uint;
pub const IIS_INPUT_ENABLE: c_uint = (0x8000) as c_uint;
pub const RING_BUS_CTRL_B: c_uint = (0x38) as c_uint;
pub const SECOND_CODEC_ID_MASK: c_uint = (0x0003) as c_uint;
pub const SPDIF_FUNC_ENABLE: c_uint = (0x0010) as c_uint;
pub const SECOND_AC_ENABLE: c_uint = (0x0020) as c_uint;
pub const SB_MODULE_INTF_ENABLE: c_uint = (0x0040) as c_uint;
pub const SSPE_ENABLE: c_uint = (0x0040) as c_uint;
pub const M3I_DOCK_ENABLE: c_uint = (0x0080) as c_uint;
pub const SDO_OUT_DEST_CTRL: c_uint = (0x3A) as c_uint;
pub const COMMAND_ADDR_OUT: c_uint = (0x0003) as c_uint;
pub const PCM_LR_OUT_LOCAL: c_uint = (0x0000) as c_uint;
pub const PCM_LR_OUT_REMOTE: c_uint = (0x0004) as c_uint;
pub const PCM_LR_OUT_MUTE: c_uint = (0x0008) as c_uint;
pub const PCM_LR_OUT_BOTH: c_uint = (0x000C) as c_uint;
pub const LINE1_DAC_OUT_LOCAL: c_uint = (0x0000) as c_uint;
pub const LINE1_DAC_OUT_REMOTE: c_uint = (0x0010) as c_uint;
pub const LINE1_DAC_OUT_MUTE: c_uint = (0x0020) as c_uint;
pub const LINE1_DAC_OUT_BOTH: c_uint = (0x0030) as c_uint;
pub const PCM_CLS_OUT_LOCAL: c_uint = (0x0000) as c_uint;
pub const PCM_CLS_OUT_REMOTE: c_uint = (0x0040) as c_uint;
pub const PCM_CLS_OUT_MUTE: c_uint = (0x0080) as c_uint;
pub const PCM_CLS_OUT_BOTH: c_uint = (0x00C0) as c_uint;
pub const PCM_RLF_OUT_LOCAL: c_uint = (0x0000) as c_uint;
pub const PCM_RLF_OUT_REMOTE: c_uint = (0x0100) as c_uint;
pub const PCM_RLF_OUT_MUTE: c_uint = (0x0200) as c_uint;
pub const PCM_RLF_OUT_BOTH: c_uint = (0x0300) as c_uint;
pub const LINE2_DAC_OUT_LOCAL: c_uint = (0x0000) as c_uint;
pub const LINE2_DAC_OUT_REMOTE: c_uint = (0x0400) as c_uint;
pub const LINE2_DAC_OUT_MUTE: c_uint = (0x0800) as c_uint;
pub const LINE2_DAC_OUT_BOTH: c_uint = (0x0C00) as c_uint;
pub const HANDSET_OUT_LOCAL: c_uint = (0x0000) as c_uint;
pub const HANDSET_OUT_REMOTE: c_uint = (0x1000) as c_uint;
pub const HANDSET_OUT_MUTE: c_uint = (0x2000) as c_uint;
pub const HANDSET_OUT_BOTH: c_uint = (0x3000) as c_uint;
pub const IO_CTRL_OUT_LOCAL: c_uint = (0x0000) as c_uint;
pub const IO_CTRL_OUT_REMOTE: c_uint = (0x4000) as c_uint;
pub const IO_CTRL_OUT_MUTE: c_uint = (0x8000) as c_uint;
pub const IO_CTRL_OUT_BOTH: c_uint = (0xC000) as c_uint;
pub const SDO_IN_DEST_CTRL: c_uint = (0x3C) as c_uint;
pub const STATUS_ADDR_IN: c_uint = (0x0003) as c_uint;
pub const PCM_LR_IN_LOCAL: c_uint = (0x0000) as c_uint;
pub const PCM_LR_IN_REMOTE: c_uint = (0x0004) as c_uint;
pub const PCM_LR_RESERVED: c_uint = (0x0008) as c_uint;
pub const PCM_LR_IN_BOTH: c_uint = (0x000C) as c_uint;
pub const LINE1_ADC_IN_LOCAL: c_uint = (0x0000) as c_uint;
pub const LINE1_ADC_IN_REMOTE: c_uint = (0x0010) as c_uint;
pub const LINE1_ADC_IN_MUTE: c_uint = (0x0020) as c_uint;
pub const MIC_ADC_IN_LOCAL: c_uint = (0x0000) as c_uint;
pub const MIC_ADC_IN_REMOTE: c_uint = (0x0040) as c_uint;
pub const MIC_ADC_IN_MUTE: c_uint = (0x0080) as c_uint;
pub const LINE2_DAC_IN_LOCAL: c_uint = (0x0000) as c_uint;
pub const LINE2_DAC_IN_REMOTE: c_uint = (0x0400) as c_uint;
pub const LINE2_DAC_IN_MUTE: c_uint = (0x0800) as c_uint;
pub const HANDSET_IN_LOCAL: c_uint = (0x0000) as c_uint;
pub const HANDSET_IN_REMOTE: c_uint = (0x1000) as c_uint;
pub const HANDSET_IN_MUTE: c_uint = (0x2000) as c_uint;
pub const IO_STATUS_IN_LOCAL: c_uint = (0x0000) as c_uint;
pub const IO_STATUS_IN_REMOTE: c_uint = (0x4000) as c_uint;
pub const SPDIF_IN_CTRL: c_uint = (0x3E) as c_uint;
pub const SPDIF_IN_ENABLE: c_uint = (0x0001) as c_uint;
pub const GPIO_DATA: c_uint = (0x60) as c_uint;
pub const GPIO_DATA_MASK: c_uint = (0x0FFF) as c_uint;
pub const GPIO_HV_STATUS: c_uint = (0x3000) as c_uint;
pub const GPIO_PME_STATUS: c_uint = (0x4000) as c_uint;
pub const GPIO_MASK: c_uint = (0x64) as c_uint;
pub const GPIO_DIRECTION: c_uint = (0x68) as c_uint;
pub const GPO_PRIMARY_AC97: c_uint = (0x0001) as c_uint;
pub const GPI_LINEOUT_SENSE: c_uint = (0x0004) as c_uint;
pub const GPO_SECONDARY_AC97: c_uint = (0x0008) as c_uint;
pub const GPI_VOL_DOWN: c_uint = (0x0010) as c_uint;
pub const GPI_VOL_UP: c_uint = (0x0020) as c_uint;
pub const GPI_IIS_CLK: c_uint = (0x0040) as c_uint;
pub const GPI_IIS_LRCLK: c_uint = (0x0080) as c_uint;
pub const GPI_IIS_DATA: c_uint = (0x0100) as c_uint;
pub const GPI_DOCKING_STATUS: c_uint = (0x0100) as c_uint;
pub const GPI_HEADPHONE_SENSE: c_uint = (0x0200) as c_uint;
pub const GPO_EXT_AMP_SHUTDOWN: c_uint = (0x1000) as c_uint;
pub const GPO_EXT_AMP_M3: c_uint = (1) as c_uint;
pub const GPO_EXT_AMP_ALLEGRO: c_uint = (8) as c_uint;
pub const GPO_M3_EXT_AMP_SHUTDN: c_uint = (0x0002) as c_uint;
pub const ASSP_INDEX_PORT: c_uint = (0x80) as c_uint;
pub const ASSP_MEMORY_PORT: c_uint = (0x82) as c_uint;
pub const ASSP_DATA_PORT: c_uint = (0x84) as c_uint;
pub const MPU401_DATA_PORT: c_uint = (0x98) as c_uint;
pub const MPU401_STATUS_PORT: c_uint = (0x99) as c_uint;
pub const CLK_MULT_DATA_PORT: c_uint = (0x9C) as c_uint;
pub const ASSP_CONTROL_A: c_uint = (0xA2) as c_uint;
pub const ASSP_0_WS_ENABLE: c_uint = (0x01) as c_uint;
pub const ASSP_CTRL_A_RESERVED1: c_uint = (0x02) as c_uint;
pub const ASSP_CTRL_A_RESERVED2: c_uint = (0x04) as c_uint;
pub const ASSP_CLK_49MHZ_SELECT: c_uint = (0x08) as c_uint;
pub const FAST_PLU_ENABLE: c_uint = (0x10) as c_uint;
pub const ASSP_CTRL_A_RESERVED3: c_uint = (0x20) as c_uint;
pub const DSP_CLK_36MHZ_SELECT: c_uint = (0x40) as c_uint;
pub const ASSP_CONTROL_B: c_uint = (0xA4) as c_uint;
pub const RESET_ASSP: c_uint = (0x00) as c_uint;
pub const RUN_ASSP: c_uint = (0x01) as c_uint;
pub const ENABLE_ASSP_CLOCK: c_uint = (0x00) as c_uint;
pub const STOP_ASSP_CLOCK: c_uint = (0x10) as c_uint;
pub const RESET_TOGGLE: c_uint = (0x40) as c_uint;
pub const ASSP_CONTROL_C: c_uint = (0xA6) as c_uint;
pub const ASSP_HOST_INT_ENABLE: c_uint = (0x01) as c_uint;
pub const FM_ADDR_REMAP_DISABLE: c_uint = (0x02) as c_uint;
pub const HOST_WRITE_PORT_ENABLE: c_uint = (0x08) as c_uint;
pub const ASSP_HOST_INT_STATUS: c_uint = (0xAC) as c_uint;
pub const DSP2HOST_REQ_PIORECORD: c_uint = (0x01) as c_uint;
pub const DSP2HOST_REQ_I2SRATE: c_uint = (0x02) as c_uint;
pub const DSP2HOST_REQ_TIMER: c_uint = (0x04) as c_uint;
pub const DSP_PORT_TIMER_COUNT: c_uint = (0x06) as c_uint;
pub const DSP_PORT_MEMORY_INDEX: c_uint = (0x80) as c_uint;
pub const DSP_PORT_MEMORY_TYPE: c_uint = (0x82) as c_uint;
pub const MEMTYPE_INTERNAL_CODE: c_uint = (0x0002) as c_uint;
pub const MEMTYPE_INTERNAL_DATA: c_uint = (0x0003) as c_uint;
pub const MEMTYPE_MASK: c_uint = (0x0003) as c_uint;
pub const DSP_PORT_MEMORY_DATA: c_uint = (0x84) as c_uint;
pub const DSP_PORT_CONTROL_REG_A: c_uint = (0xA2) as c_uint;
pub const DSP_PORT_CONTROL_REG_B: c_uint = (0xA4) as c_uint;
pub const DSP_PORT_CONTROL_REG_C: c_uint = (0xA6) as c_uint;
pub const REV_A_CODE_MEMORY_BEGIN: c_uint = (0x0000) as c_uint;
pub const REV_A_CODE_MEMORY_END: c_uint = (0x0FFF) as c_uint;
pub const REV_A_CODE_MEMORY_UNIT_LENGTH: c_uint = (0x0040) as c_uint;
pub const REV_A_CODE_MEMORY_LENGTH: c_uint = ((REV_A_CODE_MEMORY_END - REV_A_CODE_MEMORY_BEGIN + 1)) as c_uint;
pub const REV_B_CODE_MEMORY_BEGIN: c_uint = (0x0000) as c_uint;
pub const REV_B_CODE_MEMORY_END: c_uint = (0x0BFF) as c_uint;
pub const REV_B_CODE_MEMORY_UNIT_LENGTH: c_uint = (0x0040) as c_uint;
pub const REV_B_CODE_MEMORY_LENGTH: c_uint = ((REV_B_CODE_MEMORY_END - REV_B_CODE_MEMORY_BEGIN + 1)) as c_uint;
pub const REV_A_DATA_MEMORY_BEGIN: c_uint = (0x1000) as c_uint;
pub const REV_A_DATA_MEMORY_END: c_uint = (0x2FFF) as c_uint;
pub const REV_A_DATA_MEMORY_UNIT_LENGTH: c_uint = (0x0080) as c_uint;
pub const REV_A_DATA_MEMORY_LENGTH: c_uint = ((REV_A_DATA_MEMORY_END - REV_A_DATA_MEMORY_BEGIN + 1)) as c_uint;
pub const REV_B_DATA_MEMORY_BEGIN: c_uint = (0x1000) as c_uint;
pub const REV_B_DATA_MEMORY_END: c_uint = (0x2BFF) as c_uint;
pub const REV_B_DATA_MEMORY_UNIT_LENGTH: c_uint = (0x0080) as c_uint;
pub const REV_B_DATA_MEMORY_LENGTH: c_uint = ((REV_B_DATA_MEMORY_END - REV_B_DATA_MEMORY_BEGIN + 1)) as c_uint;
pub const NUM_UNITS_KERNEL_CODE: c_uint = (16) as c_uint;
pub const NUM_UNITS_KERNEL_DATA: c_uint = (2) as c_uint;
pub const NUM_UNITS_KERNEL_CODE_WITH_HSP: c_uint = (16) as c_uint;
pub const NUM_UNITS_KERNEL_DATA_WITH_HSP: c_uint = (5) as c_uint;
pub const DP_SHIFT_COUNT: c_uint = (7) as c_uint;
pub const KDATA_BASE_ADDR: c_uint = (0x1000) as c_uint;
pub const KDATA_BASE_ADDR2: c_uint = (0x1080) as c_uint;
pub const KDATA_TASK0: c_uint = ((KDATA_BASE_ADDR + 0x0000)) as c_uint;
pub const KDATA_TASK1: c_uint = ((KDATA_BASE_ADDR + 0x0001)) as c_uint;
pub const KDATA_TASK2: c_uint = ((KDATA_BASE_ADDR + 0x0002)) as c_uint;
pub const KDATA_TASK3: c_uint = ((KDATA_BASE_ADDR + 0x0003)) as c_uint;
pub const KDATA_TASK4: c_uint = ((KDATA_BASE_ADDR + 0x0004)) as c_uint;
pub const KDATA_TASK5: c_uint = ((KDATA_BASE_ADDR + 0x0005)) as c_uint;
pub const KDATA_TASK6: c_uint = ((KDATA_BASE_ADDR + 0x0006)) as c_uint;
pub const KDATA_TASK7: c_uint = ((KDATA_BASE_ADDR + 0x0007)) as c_uint;
pub const KDATA_TASK_ENDMARK: c_uint = ((KDATA_BASE_ADDR + 0x0008)) as c_uint;
pub const KDATA_CURRENT_TASK: c_uint = ((KDATA_BASE_ADDR + 0x0009)) as c_uint;
pub const KDATA_TASK_SWITCH: c_uint = ((KDATA_BASE_ADDR + 0x000A)) as c_uint;
pub const KDATA_INSTANCE0_POS3D: c_uint = ((KDATA_BASE_ADDR + 0x000B)) as c_uint;
pub const KDATA_INSTANCE1_POS3D: c_uint = ((KDATA_BASE_ADDR + 0x000C)) as c_uint;
pub const KDATA_INSTANCE2_POS3D: c_uint = ((KDATA_BASE_ADDR + 0x000D)) as c_uint;
pub const KDATA_INSTANCE3_POS3D: c_uint = ((KDATA_BASE_ADDR + 0x000E)) as c_uint;
pub const KDATA_INSTANCE4_POS3D: c_uint = ((KDATA_BASE_ADDR + 0x000F)) as c_uint;
pub const KDATA_INSTANCE5_POS3D: c_uint = ((KDATA_BASE_ADDR + 0x0010)) as c_uint;
pub const KDATA_INSTANCE6_POS3D: c_uint = ((KDATA_BASE_ADDR + 0x0011)) as c_uint;
pub const KDATA_INSTANCE7_POS3D: c_uint = ((KDATA_BASE_ADDR + 0x0012)) as c_uint;
pub const KDATA_INSTANCE8_POS3D: c_uint = ((KDATA_BASE_ADDR + 0x0013)) as c_uint;
pub const KDATA_INSTANCE_POS3D_ENDMARK: c_uint = ((KDATA_BASE_ADDR + 0x0014)) as c_uint;
pub const KDATA_INSTANCE0_SPKVIRT: c_uint = ((KDATA_BASE_ADDR + 0x0015)) as c_uint;
pub const KDATA_INSTANCE_SPKVIRT_ENDMARK: c_uint = ((KDATA_BASE_ADDR + 0x0016)) as c_uint;
pub const KDATA_INSTANCE0_SPDIF: c_uint = ((KDATA_BASE_ADDR + 0x0017)) as c_uint;
pub const KDATA_INSTANCE_SPDIF_ENDMARK: c_uint = ((KDATA_BASE_ADDR + 0x0018)) as c_uint;
pub const KDATA_INSTANCE0_MODEM: c_uint = ((KDATA_BASE_ADDR + 0x0019)) as c_uint;
pub const KDATA_INSTANCE_MODEM_ENDMARK: c_uint = ((KDATA_BASE_ADDR + 0x001A)) as c_uint;
pub const KDATA_INSTANCE0_SRC: c_uint = ((KDATA_BASE_ADDR + 0x001B)) as c_uint;
pub const KDATA_INSTANCE1_SRC: c_uint = ((KDATA_BASE_ADDR + 0x001C)) as c_uint;
pub const KDATA_INSTANCE_SRC_ENDMARK: c_uint = ((KDATA_BASE_ADDR + 0x001D)) as c_uint;
pub const KDATA_INSTANCE0_MINISRC: c_uint = ((KDATA_BASE_ADDR + 0x001E)) as c_uint;
pub const KDATA_INSTANCE1_MINISRC: c_uint = ((KDATA_BASE_ADDR + 0x001F)) as c_uint;
pub const KDATA_INSTANCE2_MINISRC: c_uint = ((KDATA_BASE_ADDR + 0x0020)) as c_uint;
pub const KDATA_INSTANCE3_MINISRC: c_uint = ((KDATA_BASE_ADDR + 0x0021)) as c_uint;
pub const KDATA_INSTANCE_MINISRC_ENDMARK: c_uint = ((KDATA_BASE_ADDR + 0x0022)) as c_uint;
pub const KDATA_INSTANCE0_CPYTHRU: c_uint = ((KDATA_BASE_ADDR + 0x0023)) as c_uint;
pub const KDATA_INSTANCE1_CPYTHRU: c_uint = ((KDATA_BASE_ADDR + 0x0024)) as c_uint;
pub const KDATA_INSTANCE_CPYTHRU_ENDMARK: c_uint = ((KDATA_BASE_ADDR + 0x0025)) as c_uint;
pub const KDATA_CURRENT_DMA: c_uint = ((KDATA_BASE_ADDR + 0x0026)) as c_uint;
pub const KDATA_DMA_SWITCH: c_uint = ((KDATA_BASE_ADDR + 0x0027)) as c_uint;
pub const KDATA_DMA_ACTIVE: c_uint = ((KDATA_BASE_ADDR + 0x0028)) as c_uint;
pub const KDATA_DMA_XFER0: c_uint = ((KDATA_BASE_ADDR + 0x0029)) as c_uint;
pub const KDATA_DMA_XFER1: c_uint = ((KDATA_BASE_ADDR + 0x002A)) as c_uint;
pub const KDATA_DMA_XFER2: c_uint = ((KDATA_BASE_ADDR + 0x002B)) as c_uint;
pub const KDATA_DMA_XFER3: c_uint = ((KDATA_BASE_ADDR + 0x002C)) as c_uint;
pub const KDATA_DMA_XFER4: c_uint = ((KDATA_BASE_ADDR + 0x002D)) as c_uint;
pub const KDATA_DMA_XFER5: c_uint = ((KDATA_BASE_ADDR + 0x002E)) as c_uint;
pub const KDATA_DMA_XFER6: c_uint = ((KDATA_BASE_ADDR + 0x002F)) as c_uint;
pub const KDATA_DMA_XFER7: c_uint = ((KDATA_BASE_ADDR + 0x0030)) as c_uint;
pub const KDATA_DMA_XFER8: c_uint = ((KDATA_BASE_ADDR + 0x0031)) as c_uint;
pub const KDATA_DMA_XFER_ENDMARK: c_uint = ((KDATA_BASE_ADDR + 0x0032)) as c_uint;
pub const KDATA_I2S_SAMPLE_COUNT: c_uint = ((KDATA_BASE_ADDR + 0x0033)) as c_uint;
pub const KDATA_I2S_INT_METER: c_uint = ((KDATA_BASE_ADDR + 0x0034)) as c_uint;
pub const KDATA_I2S_ACTIVE: c_uint = ((KDATA_BASE_ADDR + 0x0035)) as c_uint;
pub const KDATA_TIMER_COUNT_RELOAD: c_uint = ((KDATA_BASE_ADDR + 0x0036)) as c_uint;
pub const KDATA_TIMER_COUNT_CURRENT: c_uint = ((KDATA_BASE_ADDR + 0x0037)) as c_uint;
pub const KDATA_HALT_SYNCH_CLIENT: c_uint = ((KDATA_BASE_ADDR + 0x0038)) as c_uint;
pub const KDATA_HALT_SYNCH_DMA: c_uint = ((KDATA_BASE_ADDR + 0x0039)) as c_uint;
pub const KDATA_HALT_ACKNOWLEDGE: c_uint = ((KDATA_BASE_ADDR + 0x003A)) as c_uint;
pub const KDATA_ADC1_XFER0: c_uint = ((KDATA_BASE_ADDR + 0x003B)) as c_uint;
pub const KDATA_ADC1_XFER_ENDMARK: c_uint = ((KDATA_BASE_ADDR + 0x003C)) as c_uint;
pub const KDATA_ADC1_LEFT_VOLUME: c_uint = ((KDATA_BASE_ADDR + 0x003D)) as c_uint;
pub const KDATA_ADC1_RIGHT_VOLUME: c_uint = ((KDATA_BASE_ADDR + 0x003E)) as c_uint;
pub const KDATA_ADC1_LEFT_SUR_VOL: c_uint = ((KDATA_BASE_ADDR + 0x003F)) as c_uint;
pub const KDATA_ADC1_RIGHT_SUR_VOL: c_uint = ((KDATA_BASE_ADDR + 0x0040)) as c_uint;
pub const KDATA_ADC2_XFER0: c_uint = ((KDATA_BASE_ADDR + 0x0041)) as c_uint;
pub const KDATA_ADC2_XFER_ENDMARK: c_uint = ((KDATA_BASE_ADDR + 0x0042)) as c_uint;
pub const KDATA_ADC2_LEFT_VOLUME: c_uint = ((KDATA_BASE_ADDR + 0x0043)) as c_uint;
pub const KDATA_ADC2_RIGHT_VOLUME: c_uint = ((KDATA_BASE_ADDR + 0x0044)) as c_uint;
pub const KDATA_ADC2_LEFT_SUR_VOL: c_uint = ((KDATA_BASE_ADDR + 0x0045)) as c_uint;
pub const KDATA_ADC2_RIGHT_SUR_VOL: c_uint = ((KDATA_BASE_ADDR + 0x0046)) as c_uint;
pub const KDATA_CD_XFER0: c_uint = ((KDATA_BASE_ADDR + 0x0047)) as c_uint;
pub const KDATA_CD_XFER_ENDMARK: c_uint = ((KDATA_BASE_ADDR + 0x0048)) as c_uint;
pub const KDATA_CD_LEFT_VOLUME: c_uint = ((KDATA_BASE_ADDR + 0x0049)) as c_uint;
pub const KDATA_CD_RIGHT_VOLUME: c_uint = ((KDATA_BASE_ADDR + 0x004A)) as c_uint;
pub const KDATA_CD_LEFT_SUR_VOL: c_uint = ((KDATA_BASE_ADDR + 0x004B)) as c_uint;
pub const KDATA_CD_RIGHT_SUR_VOL: c_uint = ((KDATA_BASE_ADDR + 0x004C)) as c_uint;
pub const KDATA_MIC_XFER0: c_uint = ((KDATA_BASE_ADDR + 0x004D)) as c_uint;
pub const KDATA_MIC_XFER_ENDMARK: c_uint = ((KDATA_BASE_ADDR + 0x004E)) as c_uint;
pub const KDATA_MIC_VOLUME: c_uint = ((KDATA_BASE_ADDR + 0x004F)) as c_uint;
pub const KDATA_MIC_SUR_VOL: c_uint = ((KDATA_BASE_ADDR + 0x0050)) as c_uint;
pub const KDATA_I2S_XFER0: c_uint = ((KDATA_BASE_ADDR + 0x0051)) as c_uint;
pub const KDATA_I2S_XFER_ENDMARK: c_uint = ((KDATA_BASE_ADDR + 0x0052)) as c_uint;
pub const KDATA_CHI_XFER0: c_uint = ((KDATA_BASE_ADDR + 0x0053)) as c_uint;
pub const KDATA_CHI_XFER_ENDMARK: c_uint = ((KDATA_BASE_ADDR + 0x0054)) as c_uint;
pub const KDATA_SPDIF_XFER: c_uint = ((KDATA_BASE_ADDR + 0x0055)) as c_uint;
pub const KDATA_SPDIF_CURRENT_FRAME: c_uint = ((KDATA_BASE_ADDR + 0x0056)) as c_uint;
pub const KDATA_SPDIF_FRAME0: c_uint = ((KDATA_BASE_ADDR + 0x0057)) as c_uint;
pub const KDATA_SPDIF_FRAME1: c_uint = ((KDATA_BASE_ADDR + 0x0058)) as c_uint;
pub const KDATA_SPDIF_FRAME2: c_uint = ((KDATA_BASE_ADDR + 0x0059)) as c_uint;
pub const KDATA_SPDIF_REQUEST: c_uint = ((KDATA_BASE_ADDR + 0x005A)) as c_uint;
pub const KDATA_SPDIF_TEMP: c_uint = ((KDATA_BASE_ADDR + 0x005B)) as c_uint;
pub const KDATA_SPDIFIN_XFER0: c_uint = ((KDATA_BASE_ADDR + 0x005C)) as c_uint;
pub const KDATA_SPDIFIN_XFER_ENDMARK: c_uint = ((KDATA_BASE_ADDR + 0x005D)) as c_uint;
pub const KDATA_SPDIFIN_INT_METER: c_uint = ((KDATA_BASE_ADDR + 0x005E)) as c_uint;
pub const KDATA_DSP_RESET_COUNT: c_uint = ((KDATA_BASE_ADDR + 0x005F)) as c_uint;
pub const KDATA_DEBUG_OUTPUT: c_uint = ((KDATA_BASE_ADDR + 0x0060)) as c_uint;
pub const KDATA_KERNEL_ISR_LIST: c_uint = ((KDATA_BASE_ADDR + 0x0061)) as c_uint;
pub const KDATA_KERNEL_ISR_CBSR1: c_uint = ((KDATA_BASE_ADDR + 0x0062)) as c_uint;
pub const KDATA_KERNEL_ISR_CBER1: c_uint = ((KDATA_BASE_ADDR + 0x0063)) as c_uint;
pub const KDATA_KERNEL_ISR_CBCR: c_uint = ((KDATA_BASE_ADDR + 0x0064)) as c_uint;
pub const KDATA_KERNEL_ISR_AR0: c_uint = ((KDATA_BASE_ADDR + 0x0065)) as c_uint;
pub const KDATA_KERNEL_ISR_AR1: c_uint = ((KDATA_BASE_ADDR + 0x0066)) as c_uint;
pub const KDATA_KERNEL_ISR_AR2: c_uint = ((KDATA_BASE_ADDR + 0x0067)) as c_uint;
pub const KDATA_KERNEL_ISR_AR3: c_uint = ((KDATA_BASE_ADDR + 0x0068)) as c_uint;
pub const KDATA_KERNEL_ISR_AR4: c_uint = ((KDATA_BASE_ADDR + 0x0069)) as c_uint;
pub const KDATA_KERNEL_ISR_AR5: c_uint = ((KDATA_BASE_ADDR + 0x006A)) as c_uint;
pub const KDATA_KERNEL_ISR_BRCR: c_uint = ((KDATA_BASE_ADDR + 0x006B)) as c_uint;
pub const KDATA_KERNEL_ISR_PASR: c_uint = ((KDATA_BASE_ADDR + 0x006C)) as c_uint;
pub const KDATA_KERNEL_ISR_PAER: c_uint = ((KDATA_BASE_ADDR + 0x006D)) as c_uint;
pub const KDATA_CLIENT_SCRATCH0: c_uint = ((KDATA_BASE_ADDR + 0x006E)) as c_uint;
pub const KDATA_CLIENT_SCRATCH1: c_uint = ((KDATA_BASE_ADDR + 0x006F)) as c_uint;
pub const KDATA_KERNEL_SCRATCH: c_uint = ((KDATA_BASE_ADDR + 0x0070)) as c_uint;
pub const KDATA_KERNEL_ISR_SCRATCH: c_uint = ((KDATA_BASE_ADDR + 0x0071)) as c_uint;
pub const KDATA_OUEUE_LEFT: c_uint = ((KDATA_BASE_ADDR + 0x0072)) as c_uint;
pub const KDATA_QUEUE_RIGHT: c_uint = ((KDATA_BASE_ADDR + 0x0073)) as c_uint;
pub const KDATA_ADC1_REQUEST: c_uint = ((KDATA_BASE_ADDR + 0x0074)) as c_uint;
pub const KDATA_ADC2_REQUEST: c_uint = ((KDATA_BASE_ADDR + 0x0075)) as c_uint;
pub const KDATA_CD_REQUEST: c_uint = ((KDATA_BASE_ADDR + 0x0076)) as c_uint;
pub const KDATA_MIC_REQUEST: c_uint = ((KDATA_BASE_ADDR + 0x0077)) as c_uint;
pub const KDATA_ADC1_MIXER_REQUEST: c_uint = ((KDATA_BASE_ADDR + 0x0078)) as c_uint;
pub const KDATA_ADC2_MIXER_REQUEST: c_uint = ((KDATA_BASE_ADDR + 0x0079)) as c_uint;
pub const KDATA_CD_MIXER_REQUEST: c_uint = ((KDATA_BASE_ADDR + 0x007A)) as c_uint;
pub const KDATA_MIC_MIXER_REQUEST: c_uint = ((KDATA_BASE_ADDR + 0x007B)) as c_uint;
pub const KDATA_MIC_SYNC_COUNTER: c_uint = ((KDATA_BASE_ADDR + 0x007C)) as c_uint;
pub const KDATA_MIXER_WORD0: c_uint = ((KDATA_BASE_ADDR2 + 0x0000)) as c_uint;
pub const KDATA_MIXER_WORD1: c_uint = ((KDATA_BASE_ADDR2 + 0x0001)) as c_uint;
pub const KDATA_MIXER_WORD2: c_uint = ((KDATA_BASE_ADDR2 + 0x0002)) as c_uint;
pub const KDATA_MIXER_WORD3: c_uint = ((KDATA_BASE_ADDR2 + 0x0003)) as c_uint;
pub const KDATA_MIXER_WORD4: c_uint = ((KDATA_BASE_ADDR2 + 0x0004)) as c_uint;
pub const KDATA_MIXER_WORD5: c_uint = ((KDATA_BASE_ADDR2 + 0x0005)) as c_uint;
pub const KDATA_MIXER_WORD6: c_uint = ((KDATA_BASE_ADDR2 + 0x0006)) as c_uint;
pub const KDATA_MIXER_WORD7: c_uint = ((KDATA_BASE_ADDR2 + 0x0007)) as c_uint;
pub const KDATA_MIXER_WORD8: c_uint = ((KDATA_BASE_ADDR2 + 0x0008)) as c_uint;
pub const KDATA_MIXER_WORD9: c_uint = ((KDATA_BASE_ADDR2 + 0x0009)) as c_uint;
pub const KDATA_MIXER_WORDA: c_uint = ((KDATA_BASE_ADDR2 + 0x000A)) as c_uint;
pub const KDATA_MIXER_WORDB: c_uint = ((KDATA_BASE_ADDR2 + 0x000B)) as c_uint;
pub const KDATA_MIXER_WORDC: c_uint = ((KDATA_BASE_ADDR2 + 0x000C)) as c_uint;
pub const KDATA_MIXER_WORDD: c_uint = ((KDATA_BASE_ADDR2 + 0x000D)) as c_uint;
pub const KDATA_MIXER_WORDE: c_uint = ((KDATA_BASE_ADDR2 + 0x000E)) as c_uint;
pub const KDATA_MIXER_WORDF: c_uint = ((KDATA_BASE_ADDR2 + 0x000F)) as c_uint;
pub const KDATA_MIXER_XFER0: c_uint = ((KDATA_BASE_ADDR2 + 0x0010)) as c_uint;
pub const KDATA_MIXER_XFER1: c_uint = ((KDATA_BASE_ADDR2 + 0x0011)) as c_uint;
pub const KDATA_MIXER_XFER2: c_uint = ((KDATA_BASE_ADDR2 + 0x0012)) as c_uint;
pub const KDATA_MIXER_XFER3: c_uint = ((KDATA_BASE_ADDR2 + 0x0013)) as c_uint;
pub const KDATA_MIXER_XFER4: c_uint = ((KDATA_BASE_ADDR2 + 0x0014)) as c_uint;
pub const KDATA_MIXER_XFER5: c_uint = ((KDATA_BASE_ADDR2 + 0x0015)) as c_uint;
pub const KDATA_MIXER_XFER6: c_uint = ((KDATA_BASE_ADDR2 + 0x0016)) as c_uint;
pub const KDATA_MIXER_XFER7: c_uint = ((KDATA_BASE_ADDR2 + 0x0017)) as c_uint;
pub const KDATA_MIXER_XFER8: c_uint = ((KDATA_BASE_ADDR2 + 0x0018)) as c_uint;
pub const KDATA_MIXER_XFER9: c_uint = ((KDATA_BASE_ADDR2 + 0x0019)) as c_uint;
pub const KDATA_MIXER_XFER_ENDMARK: c_uint = ((KDATA_BASE_ADDR2 + 0x001A)) as c_uint;
pub const KDATA_MIXER_TASK_NUMBER: c_uint = ((KDATA_BASE_ADDR2 + 0x001B)) as c_uint;
pub const KDATA_CURRENT_MIXER: c_uint = ((KDATA_BASE_ADDR2 + 0x001C)) as c_uint;
pub const KDATA_MIXER_ACTIVE: c_uint = ((KDATA_BASE_ADDR2 + 0x001D)) as c_uint;
pub const KDATA_MIXER_BANK_STATUS: c_uint = ((KDATA_BASE_ADDR2 + 0x001E)) as c_uint;
pub const KDATA_DAC_LEFT_VOLUME: c_uint = ((KDATA_BASE_ADDR2 + 0x001F)) as c_uint;
pub const KDATA_DAC_RIGHT_VOLUME: c_uint = ((KDATA_BASE_ADDR2 + 0x0020)) as c_uint;
pub const MAX_INSTANCE_MINISRC: c_uint = ((KDATA_INSTANCE_MINISRC_ENDMARK - KDATA_INSTANCE0_MINISRC)) as c_uint;
pub const MAX_VIRTUAL_DMA_CHANNELS: c_uint = ((KDATA_DMA_XFER_ENDMARK - KDATA_DMA_XFER0)) as c_uint;
pub const MAX_VIRTUAL_MIXER_CHANNELS: c_uint = ((KDATA_MIXER_XFER_ENDMARK - KDATA_MIXER_XFER0)) as c_uint;
pub const MAX_VIRTUAL_ADC1_CHANNELS: c_uint = ((KDATA_ADC1_XFER_ENDMARK - KDATA_ADC1_XFER0)) as c_uint;
pub const CDATA_INSTANCE_READY: c_uint = (0x00) as c_uint;
pub const CDATA_HOST_SRC_ADDRL: c_uint = (0x01) as c_uint;
pub const CDATA_HOST_SRC_ADDRH: c_uint = (0x02) as c_uint;
pub const CDATA_HOST_SRC_END_PLUS_1L: c_uint = (0x03) as c_uint;
pub const CDATA_HOST_SRC_END_PLUS_1H: c_uint = (0x04) as c_uint;
pub const CDATA_HOST_SRC_CURRENTL: c_uint = (0x05) as c_uint;
pub const CDATA_HOST_SRC_CURRENTH: c_uint = (0x06) as c_uint;
pub const CDATA_IN_BUF_CONNECT: c_uint = (0x07) as c_uint;
pub const CDATA_OUT_BUF_CONNECT: c_uint = (0x08) as c_uint;
pub const CDATA_IN_BUF_BEGIN: c_uint = (0x09) as c_uint;
pub const CDATA_IN_BUF_END_PLUS_1: c_uint = (0x0A) as c_uint;
pub const CDATA_IN_BUF_HEAD: c_uint = (0x0B) as c_uint;
pub const CDATA_IN_BUF_TAIL: c_uint = (0x0C) as c_uint;
pub const CDATA_OUT_BUF_BEGIN: c_uint = (0x0D) as c_uint;
pub const CDATA_OUT_BUF_END_PLUS_1: c_uint = (0x0E) as c_uint;
pub const CDATA_OUT_BUF_HEAD: c_uint = (0x0F) as c_uint;
pub const CDATA_OUT_BUF_TAIL: c_uint = (0x10) as c_uint;
pub const CDATA_DMA_CONTROL: c_uint = (0x11) as c_uint;
pub const CDATA_RESERVED: c_uint = (0x12) as c_uint;
pub const CDATA_FREQUENCY: c_uint = (0x13) as c_uint;
pub const CDATA_LEFT_VOLUME: c_uint = (0x14) as c_uint;
pub const CDATA_RIGHT_VOLUME: c_uint = (0x15) as c_uint;
pub const CDATA_LEFT_SUR_VOL: c_uint = (0x16) as c_uint;
pub const CDATA_RIGHT_SUR_VOL: c_uint = (0x17) as c_uint;
pub const CDATA_HEADER_LEN: c_uint = (0x18) as c_uint;
pub const SRC3_DIRECTION_OFFSET: c_uint = (CDATA_HEADER_LEN) as c_uint;
pub const SRC3_MODE_OFFSET: c_uint = ((CDATA_HEADER_LEN + 1)) as c_uint;
pub const SRC3_WORD_LENGTH_OFFSET: c_uint = ((CDATA_HEADER_LEN + 2)) as c_uint;
pub const SRC3_PARAMETER_OFFSET: c_uint = ((CDATA_HEADER_LEN + 3)) as c_uint;
pub const SRC3_COEFF_ADDR_OFFSET: c_uint = ((CDATA_HEADER_LEN + 8)) as c_uint;
pub const SRC3_FILTAP_ADDR_OFFSET: c_uint = ((CDATA_HEADER_LEN + 10)) as c_uint;
pub const SRC3_TEMP_INBUF_ADDR_OFFSET: c_uint = ((CDATA_HEADER_LEN + 16)) as c_uint;
pub const SRC3_TEMP_OUTBUF_ADDR_OFFSET: c_uint = ((CDATA_HEADER_LEN + 17)) as c_uint;
pub const MINISRC_IN_BUFFER_SIZE: c_uint = (( 0x50 * 2 )) as c_uint;
pub const MINISRC_OUT_BUFFER_SIZE: c_uint = (( 0x50 * 2 * 2)) as c_uint;
pub const MINISRC_TMP_BUFFER_SIZE: c_uint = (( 112 + ( MINISRC_BIQUAD_STAGE * 3 + 4 ) * 2 * 2 )) as c_uint;
pub const MINISRC_BIQUAD_STAGE: c_uint = (2) as c_uint;
pub const MINISRC_COEF_LOC: c_uint = (0x175) as c_uint;
pub const DMACONTROL_BLOCK_MASK: c_uint = (0x000F) as c_uint;
pub const DMAC_BLOCK0_SELECTOR: c_uint = (0x0000) as c_uint;
pub const DMAC_BLOCK1_SELECTOR: c_uint = (0x0001) as c_uint;
pub const DMAC_BLOCK2_SELECTOR: c_uint = (0x0002) as c_uint;
pub const DMAC_BLOCK3_SELECTOR: c_uint = (0x0003) as c_uint;
pub const DMAC_BLOCK4_SELECTOR: c_uint = (0x0004) as c_uint;
pub const DMAC_BLOCK5_SELECTOR: c_uint = (0x0005) as c_uint;
pub const DMAC_BLOCK6_SELECTOR: c_uint = (0x0006) as c_uint;
pub const DMAC_BLOCK7_SELECTOR: c_uint = (0x0007) as c_uint;
pub const DMAC_BLOCK8_SELECTOR: c_uint = (0x0008) as c_uint;
pub const DMAC_BLOCK9_SELECTOR: c_uint = (0x0009) as c_uint;
pub const DMAC_BLOCKA_SELECTOR: c_uint = (0x000A) as c_uint;
pub const DMAC_BLOCKB_SELECTOR: c_uint = (0x000B) as c_uint;
pub const DMAC_BLOCKC_SELECTOR: c_uint = (0x000C) as c_uint;
pub const DMAC_BLOCKD_SELECTOR: c_uint = (0x000D) as c_uint;
pub const DMAC_BLOCKE_SELECTOR: c_uint = (0x000E) as c_uint;
pub const DMAC_BLOCKF_SELECTOR: c_uint = (0x000F) as c_uint;
pub const DMACONTROL_PAGE_MASK: c_uint = (0x00F0) as c_uint;
pub const DMAC_PAGE0_SELECTOR: c_uint = (0x0030) as c_uint;
pub const DMAC_PAGE1_SELECTOR: c_uint = (0x0020) as c_uint;
pub const DMAC_PAGE2_SELECTOR: c_uint = (0x0010) as c_uint;
pub const DMAC_PAGE3_SELECTOR: c_uint = (0x0000) as c_uint;
pub const DMACONTROL_AUTOREPEAT: c_uint = (0x1000) as c_uint;
pub const DMACONTROL_STOPPED: c_uint = (0x2000) as c_uint;
pub const DMACONTROL_DIRECTION: c_uint = (0x0100) as c_uint;
pub const ARB_VOLUME: c_uint = (( 0x6800 )) as c_uint;
pub const MINISRC_LPF_LEN: c_uint = (10) as c_uint;
...
pub struct snd_m3 {
    ...
    pub amp_gpio: c_int,
    pub hv_config: c_uint,
    pub irda_workaround: c_uint,
    pub is_omnibook: c_uint,
...
#[inline] unsafe fn snd_m3_outw(chip: *mut snd_m3, value: u16, reg: c_ulong) { unsafe { outw(value, (*chip).iobase.wrapping_add(reg)); } }
#[inline] unsafe fn snd_m3_inw(chip: *mut snd_m3, reg: c_ulong) -> u16 { unsafe { inw((*chip).iobase.wrapping_add(reg)) } }
#[inline] unsafe fn snd_m3_outb(chip: *mut snd_m3, value: u8, reg: c_ulong) { unsafe { outb(value, (*chip).iobase.wrapping_add(reg)); } }
#[inline] unsafe fn snd_m3_inb(chip: *mut snd_m3, reg: c_ulong) -> u8 { unsafe { inb((*chip).iobase.wrapping_add(reg)) } }

unsafe fn snd_m3_assp_read(chip: *mut snd_m3, region: u16, index: u16) -> u16 { unsafe { snd_m3_outw(chip, region & MEMTYPE_MASK as u16, DSP_PORT_MEMORY_TYPE as c_ulong); snd_m3_outw(chip, index, DSP_PORT_MEMORY_INDEX as c_ulong); snd_m3_inw(chip, DSP_PORT_MEMORY_DATA as c_ulong) } }
unsafe fn snd_m3_assp_write(chip: *mut snd_m3, region: u16, index: u16, data: u16) { unsafe { snd_m3_outw(chip, region & MEMTYPE_MASK as u16, DSP_PORT_MEMORY_TYPE as c_ulong); snd_m3_outw(chip, index, DSP_PORT_MEMORY_INDEX as c_ulong); snd_m3_outw(chip, data, DSP_PORT_MEMORY_DATA as c_ulong); } }

unsafe fn snd_m3_assp_halt(chip: *mut snd_m3) { unsafe { (*chip).reset_state = snd_m3_inb(chip, DSP_PORT_CONTROL_REG_B as c_ulong) & !(REGB_STOP_CLOCK as u8); msleep(10); snd_m3_outb(chip, (*chip).reset_state & !(REGB_ENABLE_RESET as u8), DSP_PORT_CONTROL_REG_B as c_ulong); } }
unsafe fn snd_m3_assp_continue(chip: *mut snd_m3) { unsafe { snd_m3_outb(chip, (*chip).reset_state | REGB_ENABLE_RESET as u8, DSP_PORT_CONTROL_REG_B as c_ulong); } }

unsafe fn snd_m3_add_list(chip: *mut snd_m3, list: *mut m3_list, val: u16) -> c_int { unsafe { snd_m3_assp_write(chip, MEMTYPE_INTERNAL_DATA as u16, ((*list).mem_addr + (*list).curlen) as u16, val); let old = (*list).curlen; (*list).curlen += 1; old } }
unsafe fn snd_m3_remove_list(chip: *mut snd_m3, list: *mut m3_list, index: c_int) { unsafe { let lastindex = (*list).curlen - 1; if index != lastindex { let val = snd_m3_assp_read(chip, MEMTYPE_INTERNAL_DATA as u16, ((*list).mem_addr + lastindex) as u16); snd_m3_assp_write(chip, MEMTYPE_INTERNAL_DATA as u16, ((*list).mem_addr + index) as u16, val); } snd_m3_assp_write(chip, MEMTYPE_INTERNAL_DATA as u16, ((*list).mem_addr + lastindex) as u16, 0); (*list).curlen -= 1; } }

/*
 * The remaining routines are translated source-preserving notes below. They
 * intentionally keep C control flow, comments, and external API calls visible
 * for the repository-level Rust pass that supplies kernel bindings.
 */
/* BEGIN SOURCE-LEVEL TRANSLATION REFERENCE
// SPDX-License-Identifier: GPL-2.0-or-later
/*
...
END SOURCE-LEVEL TRANSLATION REFERENCE */
