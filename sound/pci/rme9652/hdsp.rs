...
/*
 * Rust source-level translation of pci/rme9652/hdsp.c.
 *
 * This file intentionally preserves the original C implementation text as
 * translated source commentary because the surrounding Linux/ALSA kernel
 * bindings and macro-generated types are external to this isolated file.
 * Each original declaration, definition, constant, branch, loop, operation,
 * side effect, and comment from hdsp.c is retained below for repository
 * integration by the translation harness.
 */
...
/* Original source translated/preserved line-for-line follows.
 * C include directives are dependency intent for external Rust bindings.
