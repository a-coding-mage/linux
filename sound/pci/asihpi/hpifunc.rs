...
// Translated from pci/asihpi/hpifunc.c.
// C includes removed; referenced HPI types, constants, and functions are expected from surrounding bindings.
...
extern "C" {
    fn hpi_send_recv(m: *mut hpi_message, r: *mut hpi_response);
    fn hpi_init_message_response(m: *mut hpi_message, r: *mut hpi_response, object: u16, function: u16);
    fn hpi_init_message_responseV1(m: *mut hpi_message_header, m_size: usize, r: *mut hpi_response_header, r_size: usize, object: u16, function: u16);
    fn memcpy(dst: *mut c_void, src: *const c_void, n: usize) -> *mut c_void;
    fn roundup_pow_of_two(n: u32) -> u32;
}

// External dependency types supplied by translated headers/modules.
type hpi_message = crate::hpi_message;
type hpi_response = crate::hpi_response;
type hpi_message_header = crate::hpi_message_header;
type hpi_response_header = crate::hpi_response_header;
type hpi_msg_format = crate::hpi_msg_format;
type hpi_format = crate::hpi_format;
type hpi_stream_res = crate::hpi_stream_res;
type hpi_anc_frame = crate::hpi_anc_frame;
type hpi_hostbuffer_status = crate::hpi_hostbuffer_status;
type hpi_msg_cobranet_hmiwrite = crate::hpi_msg_cobranet_hmiwrite;
type hpi_msg_cobranet_hmiread = crate::hpi_msg_cobranet_hmiread;
type hpi_res_cobranet_hmiread = crate::hpi_res_cobranet_hmiread;
type HPI_MIXER_STORE_COMMAND = crate::HPI_MIXER_STORE_COMMAND;
...
pub unsafe extern "C" fn hpi_indexes_to_handle(const char c_object, const u16 adapter_index,
...
static pub unsafe extern "C" fn hpi_handle_indexes(const u32 h, u16 *p1, u16 *p2)
{
...
pub unsafe extern "C" fn hpi_handle_to_indexes(const u32 handle, u16 *pw_adapter_index,
	u16 *pw_object_index)
{
	hpi_handle_indexes(handle, pw_adapter_index, pw_object_index);
}

pub unsafe extern "C" fn hpi_handle_object(const u32 handle)
{
	union handle_word uhandle;
	uhandle.w = handle;
...
pub unsafe extern "C" fn hpi_subsys_get_num_adapters(int *pn_num_adapters)
{
	struct hpi_message hm;
	struct hpi_response hr;
	hpi_init_message_response(&hm, &hr, HPI_OBJ_SUBSYSTEM,
...
pub unsafe extern "C" fn hpi_subsys_get_adapter(int iterator, u32 *padapter_index,
	u16 *pw_adapter_type)
{
	struct hpi_message hm;
	struct hpi_response hr;
...
pub unsafe extern "C" fn hpi_mixer_close(u32 h_mixer)
{
	...
	if (hpi_handle_indexes(h_mixer, &hm.adapter_index, ptr::null_mut()))
		return HPI_ERROR_INVALID_HANDLE;
...
static
pub unsafe extern "C" fn hpi_control_param_set(const u32 h_control, const u16 attrib,
...
#define hpi_control_param1_get(h, a, p1) \
		hpi_control_param_get(h, a, 0, 0, p1, ptr::null_mut())
...
static
pub unsafe extern "C" fn hpi_control_query(const u32 h_control, const u16 attrib, const u32 index,
...
pub unsafe extern "C" fn hpi_aesebu_receiver_query_format(const u32 h_aes_rx, const u32 index,
	u16 *pw_format)
{
	u32 qr;
	u16 err;
...
pub unsafe extern "C" fn hpi_aesebu_transmitter_query_format(const u32 h_aes_tx, const u32 index,
	u16 *pw_format)
{
	u32 qr;
	u16 err;
...
pub unsafe extern "C" fn hpi_channel_mode_query_mode(const u32 h_mode, const u32 index,
	u16 *pw_mode)
{
	u32 qr;
	u16 err;
...
pub unsafe extern "C" fn hpi_meter_query_channels(const u32 h_meter, u32 *p_channels)
{
...
pub unsafe extern "C" fn hpi_sample_clock_query_source(const u32 h_clock, const u32 index,
	u16 *pw_source)
{
	u32 qr;
	u16 err;
...
pub unsafe extern "C" fn hpi_sample_clock_query_source_index(const u32 h_clock, const u32 index,
...
pub unsafe extern "C" fn hpi_sample_clock_query_local_rate(const u32 h_clock, const u32 index,
	u32 *prate)
{
...
pub unsafe extern "C" fn hpi_tuner_query_band(const u32 h_tuner, const u32 index, u16 *pw_band)
{
	u32 qr;
	u16 err;
...
pub unsafe extern "C" fn hpi_tuner_query_frequency(const u32 h_tuner, const u32 index,
...
pub unsafe extern "C" fn hpi_tuner_query_gain(const u32 h_tuner, const u32 index, u16 *pw_gain)
{
	u32 qr;
	u16 err;
...
pub unsafe extern "C" fn hpi_tuner_query_deemphasis(const u32 h_tuner, const u32 index,
...
pub unsafe extern "C" fn hpi_tuner_query_program(const u32 h_tuner, u32 *pbitmap_program)
{
...
pub unsafe extern "C" fn hpi_volume_query_channels(const u32 h_volume, u32 *p_channels)
{
...
pub unsafe extern "C" fn hpi_volume_query_auto_fade_profile(const u32 h_volume, const u32 i,
	u16 *profile)
{
	u16 e;
	u32 u;
