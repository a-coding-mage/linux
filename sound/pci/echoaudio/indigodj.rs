...
pub const ECHOCARD_INDIGO_DJ: bool = true;
pub const ECHOCARD_NAME: &[u8] = b"Indigo DJ\0";
...
pub const FW_INDIGO_DJ_DSP: u32 = 1;
...
pub static card_fw: [firmware; 2] = [
    ...
    firmware {
        size: 0,
        data: b"indigo_dj_dsp.fw\0".as_ptr(),
    },
];
...
/*
 * The C source includes the shared implementation files here:
 * "indigodj_dsp.c"
 * "echoaudio_dsp.c"
 * "echoaudio.c"
 */
