...
// C preprocessor configuration symbols from this translation unit.
pub const INDIGO_FAMILY: bool = true;
pub const ECHOCARD_INDIGO_DJX: bool = true;
pub const ECHOCARD_NAME: &[u8] = b"Indigo DJx\0";
...
/* Bus indexes */
pub const BX_ANALOG_OUT: u32 = 0; /* 4 */
pub const BX_DIGITAL_OUT: u32 = 4; /* 0 */
pub const BX_ANALOG_IN: u32 = 4; /* 0 */
 ...
 * <linux/module.h>, <linux/firmware.h>, <linux/io.h>, <linux/slab.h>,
...
pub const FW_INDIGO_DJX_DSP: usize = 1;
...
pub static CARD_FW: [firmware; 2] = [
    ...
    firmware {
        size: 0,
        data: b"indigo_djx_dsp.fw\0".as_ptr(),
    },
];
...
/*
 * Included C implementation units translated by their own repository outputs:
 * "indigodjx_dsp.c"
