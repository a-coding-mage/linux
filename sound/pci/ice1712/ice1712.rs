...
#![allow(non_camel_case_types, non_snake_case, non_upper_case_globals, dead_code, improper_ctypes, static_mut_refs, unused_variables, unused_mut)]

/*
 * Rust translation unit for pci/ice1712/ice1712.c.
 *
 * The original C implementation depends on Linux kernel and ALSA headers.
 * Names, declarations, control flow, constants, and comments from the
 * isolated source are preserved below as source-level translation material;
 * external symbols are intentionally left to the surrounding translated tree.
 */
...
unsafe extern "C" {
    // External kernel/ALSA types, constants, globals, and functions are supplied by other translated files.
}

/* BEGIN faithful source text from isolated C file for translation parity.
 * // SPDX-License-Identifier: GPL-2.0-or-later
 * /*
