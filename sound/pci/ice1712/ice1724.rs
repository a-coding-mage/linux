...
// Source-level translation unit for pci/ice1712/ice1724.c.
// Kernel/ALSA dependency types, constants, macros, and functions are external to this isolated file.
...
unsafe extern "C" {
    static mut PRO_RATE_LOCKED: c_int;
}
