...
// dependency from original C include removed for Rust translation
// dependency from original C include removed for Rust translation
// dependency from original C include removed for Rust translation
// dependency from original C include removed for Rust translation
// dependency from original C include removed for Rust translation
...
const MT8188_MEMIF_BUFFER_BYTES_ALIGN: u32 = 0x40;
const MT8188_MEMIF_DL7_MAX_PERIOD_SIZE: u32 = 0x3fff;

const MEMIF_AXI_MINLEN: u32 = 9 /* register default value */;
...
static snd_pcm_hardware mt8188_afe_hardware = {
...
static mt8188_afe_rate mt8188_afe_rates[] = {
			   ...
			   u32 rate)
{
	...
	struct mtk_base_afe *afe = core::ptr::null_mut();
	struct mt8188_afe_private *afe_priv = core::ptr::null_mut();
	struct mtk_base_afe_memif *memif = core::ptr::null_mut();
	struct mtk_dai_memif_priv *memif_priv = core::ptr::null_mut();
	i32 fs = mt8188_afe_fs_timing(rate);
	i32 id = snd_soc_rtd_to_cpu(rtd, 0).id;
...
struct mt8188_afe_channel_merge {
	...
	u32 en_shift;
	u32 en_maskbit;
	u32 update_cnt_shift;
	u32 update_cnt_maskbit;
	u32 update_cnt_default;
};
				 ...
				 struct snd_soc_dai *dai)
{
	...
	u32 counter = runtime.period_size;
	i32 fs;
	i32 ret;
...
static snd_soc_dai_ops mt8188_afe_fe_dai_ops = {
...
const MTK_PCM_FORMATS: u32 = (SNDRV_PCM_FMTBIT_S16_LE |\;
			 SNDRV_PCM_FMTBIT_S24_LE |\
			 SNDRV_PCM_FMTBIT_S32_LE)
...
static snd_kcontrol_new o002_mix[] = {
...
static snd_kcontrol_new o003_mix[] = {
...
static snd_kcontrol_new o004_mix[] = {
...
static snd_kcontrol_new o005_mix[] = {
...
static snd_kcontrol_new o006_mix[] = {
...
static snd_kcontrol_new o007_mix[] = {
...
static snd_kcontrol_new o008_mix[] = {
...
static snd_kcontrol_new o009_mix[] = {
...
static snd_kcontrol_new o010_mix[] = {
...
static snd_kcontrol_new o011_mix[] = {
...
static snd_kcontrol_new o012_mix[] = {
...
static snd_kcontrol_new o013_mix[] = {
...
static snd_kcontrol_new o014_mix[] = {
...
static snd_kcontrol_new o015_mix[] = {
...
static snd_kcontrol_new o016_mix[] = {
...
static snd_kcontrol_new o017_mix[] = {
...
static snd_kcontrol_new o035_mix[] = {
...
static snd_kcontrol_new o036_mix[] = {
...
static snd_kcontrol_new o037_mix[] = {
...
static snd_kcontrol_new o041_mix[] = {
...
static snd_kcontrol_new o183_mix[] = {
...
static snd_kcontrol_new dl8_dl11_data_sel_mux =
	SOC_DAPM_ENUM("DL8_DL11 Sink",
		      dl8_dl11_data_sel_mux_enum);

static snd_soc_dapm_widget mt8188_memif_widgets[] = {
	/* DL6 */
	SND_SOC_DAPM_MIXER("I000", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I001", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),

	/* DL3 */
	SND_SOC_DAPM_MIXER("I020", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I021", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),

	/* DL11 */
	SND_SOC_DAPM_MIXER("I022", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I023", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I024", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I025", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I026", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I027", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I028", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I029", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I030", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I031", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I032", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I033", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I034", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I035", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I036", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I037", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),

	/* DL11/DL8 */
	SND_SOC_DAPM_MIXER("I046", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I047", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I048", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I049", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I050", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I051", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I052", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I053", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I054", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I055", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I056", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I057", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I058", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I059", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I060", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I061", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),

	/* DL2 */
	SND_SOC_DAPM_MIXER("I070", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_MIXER("I071", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
...
static snd_soc_dapm_route mt8188_memif_routes[] = {
	{"I000", core::ptr::null_mut(), "DL6"},
	{"I001", core::ptr::null_mut(), "DL6"},

	{"I020", core::ptr::null_mut(), "DL3"},
	{"I021", core::ptr::null_mut(), "DL3"},

	{"I022", core::ptr::null_mut(), "DL11"},
	{"I023", core::ptr::null_mut(), "DL11"},
	{"I024", core::ptr::null_mut(), "DL11"},
	{"I025", core::ptr::null_mut(), "DL11"},
	{"I026", core::ptr::null_mut(), "DL11"},
	{"I027", core::ptr::null_mut(), "DL11"},
	{"I028", core::ptr::null_mut(), "DL11"},
	{"I029", core::ptr::null_mut(), "DL11"},
	{"I030", core::ptr::null_mut(), "DL11"},
	{"I031", core::ptr::null_mut(), "DL11"},
	{"I032", core::ptr::null_mut(), "DL11"},
	{"I033", core::ptr::null_mut(), "DL11"},
	{"I034", core::ptr::null_mut(), "DL11"},
	{"I035", core::ptr::null_mut(), "DL11"},
	{"I036", core::ptr::null_mut(), "DL11"},
	{"I037", core::ptr::null_mut(), "DL11"},

	{"DL8_DL11 Mux", "dl8", "DL8"},
	{"DL8_DL11 Mux", "dl11", "DL11"},

	{"I046", core::ptr::null_mut(), "DL8_DL11 Mux"},
	{"I047", core::ptr::null_mut(), "DL8_DL11 Mux"},
	{"I048", core::ptr::null_mut(), "DL8_DL11 Mux"},
	{"I049", core::ptr::null_mut(), "DL8_DL11 Mux"},
	{"I050", core::ptr::null_mut(), "DL8_DL11 Mux"},
	{"I051", core::ptr::null_mut(), "DL8_DL11 Mux"},
	{"I052", core::ptr::null_mut(), "DL8_DL11 Mux"},
	{"I053", core::ptr::null_mut(), "DL8_DL11 Mux"},
	{"I054", core::ptr::null_mut(), "DL8_DL11 Mux"},
	{"I055", core::ptr::null_mut(), "DL8_DL11 Mux"},
	{"I056", core::ptr::null_mut(), "DL8_DL11 Mux"},
	{"I057", core::ptr::null_mut(), "DL8_DL11 Mux"},
	{"I058", core::ptr::null_mut(), "DL8_DL11 Mux"},
	{"I059", core::ptr::null_mut(), "DL8_DL11 Mux"},
	{"I060", core::ptr::null_mut(), "DL8_DL11 Mux"},
	{"I061", core::ptr::null_mut(), "DL8_DL11 Mux"},

	{"I070", core::ptr::null_mut(), "DL2"},
	{"I071", core::ptr::null_mut(), "DL2"},

	{"UL9", core::ptr::null_mut(), "O002"},
	{"UL9", core::ptr::null_mut(), "O003"},
	{"UL9", core::ptr::null_mut(), "O004"},
	{"UL9", core::ptr::null_mut(), "O005"},
	{"UL9", core::ptr::null_mut(), "O006"},
	{"UL9", core::ptr::null_mut(), "O007"},
	{"UL9", core::ptr::null_mut(), "O008"},
	{"UL9", core::ptr::null_mut(), "O009"},
	{"UL9", core::ptr::null_mut(), "O010"},
	{"UL9", core::ptr::null_mut(), "O011"},
	{"UL9", core::ptr::null_mut(), "O012"},
	{"UL9", core::ptr::null_mut(), "O013"},
	{"UL9", core::ptr::null_mut(), "O014"},
	{"UL9", core::ptr::null_mut(), "O015"},
	{"UL9", core::ptr::null_mut(), "O016"},
	{"UL9", core::ptr::null_mut(), "O017"},
	{"UL9", core::ptr::null_mut(), "O018"},
	{"UL9", core::ptr::null_mut(), "O019"},
	{"UL9", core::ptr::null_mut(), "O020"},
	{"UL9", core::ptr::null_mut(), "O021"},
	{"UL9", core::ptr::null_mut(), "O022"},
	{"UL9", core::ptr::null_mut(), "O023"},
	{"UL9", core::ptr::null_mut(), "O024"},
	{"UL9", core::ptr::null_mut(), "O025"},
	{"UL9", core::ptr::null_mut(), "O026"},
	{"UL9", core::ptr::null_mut(), "O027"},
	{"UL9", core::ptr::null_mut(), "O028"},
	{"UL9", core::ptr::null_mut(), "O029"},
	{"UL9", core::ptr::null_mut(), "O030"},
	{"UL9", core::ptr::null_mut(), "O031"},
	{"UL9", core::ptr::null_mut(), "O032"},
	{"UL9", core::ptr::null_mut(), "O033"},

	{"UL4", core::ptr::null_mut(), "O034"},
	{"UL4", core::ptr::null_mut(), "O035"},

	{"UL5", core::ptr::null_mut(), "O036"},
	{"UL5", core::ptr::null_mut(), "O037"},

	{"UL10", core::ptr::null_mut(), "O038"},
	{"UL10", core::ptr::null_mut(), "O039"},
	{"UL10", core::ptr::null_mut(), "O182"},
	{"UL10", core::ptr::null_mut(), "O183"},

	{"UL2", core::ptr::null_mut(), "O040"},
	{"UL2", core::ptr::null_mut(), "O041"},
	{"UL2", core::ptr::null_mut(), "O042"},
	{"UL2", core::ptr::null_mut(), "O043"},
	{"UL2", core::ptr::null_mut(), "O044"},
	{"UL2", core::ptr::null_mut(), "O045"},
	{"UL2", core::ptr::null_mut(), "O046"},
	{"UL2", core::ptr::null_mut(), "O047"},
...
static const u32 mt8188_afe_1x_en_sel_values[] = {
	0, 1, 2,
};
...
static const u32 mt8188_afe_fs_timing_sel_values[] = {
	0,
				      ...
				      struct snd_ctl_elem_value *ucontrol)
{
	...
	c_long val = ucontrol.value.integer.value[0];
	i32 ret = 0;
...
static snd_kcontrol_new mt8188_memif_controls[] = {
...
static mtk_base_memif_data memif_data[MT8188_AFE_MEMIF_NUM] = {
	[MT8188_AFE_MEMIF_DL2] = {
		name: "DL2",
		id: MT8188_AFE_MEMIF_DL2,
...
static mtk_base_irq_data irq_data[MT8188_AFE_IRQ_NUM] = {
	[MT8188_AFE_IRQ_1] = {
		id: MT8188_AFE_IRQ_1,
		irq_cnt_reg: -1,
		irq_cnt_shift: 0,
...
static const i32 mt8188_afe_memif_const_irqs[MT8188_AFE_MEMIF_NUM] = {
...
static regmap_config mt8188_afe_regmap_config = {
	reg_bits: 32,
	reg_stride: 4,
	val_bits: 32,
...
static irqreturn_t mt8188_afe_irq_handler(i32 irq_id, c_void *dev_id)
{
	...
	u32 afe_irq_clr_bits = 0;
	u32 irq_status_bits = 0;
	u32 irq_clr_bits = 0;
	u32 mcu_irq_mask = 0;
	i32 i = 0;
	i32 ret = 0;
...
static reg_sequence mt8188_afe_reg_defaults[] = {
...
static reg_sequence mt8188_cg_patch[] = {
...
static i32 mt8188_afe_pcm_dev_probe(struct platform_device *pdev)
{
	...
	ret = devm_request_irq(dev, irq_id, mt8188_afe_irq_handler,
			       IRQF_TRIGGER_NONE, "asys-isr", (c_void *)afe);
	if (ret)
...
static of_device_id mt8188_afe_pcm_dt_match[] = {
	{ compatible: "mediatek,mt8188-afe", },
	{},
};
MODULE_DEVICE_TABLE(of, mt8188_afe_pcm_dt_match);

static dev_pm_ops mt8188_afe_pm_ops = {
	RUNTIME_PM_OPS(mt8188_afe_runtime_suspend,
		       mt8188_afe_runtime_resume, core::ptr::null_mut())
};
