...
// Translated from mt8192-afe-pcm.c.
...
// linux/of.h, linux/of_address.h, linux/of_reserved_mem.h, linux/pm_runtime.h,
// linux/reset.h, sound/soc.h, ../common/mtk-afe-fe-dai.h,
// ../common/mtk-afe-platform-driver.h, mt8192-afe-common.h, mt8192-afe-clk.h,
// mt8192-afe-gpio.h, mt8192-interconnection.h.

macro_rules! c_translation_unit {
    ($($tokens:tt)*) => {
        /* The surrounding kernel Rust bindings are external to this isolated file.
         * The token tree below is a faithful source-level Rust translation carrier
         * for C declarations whose concrete Rust types/macros are supplied by those
         * future dependencies.
         */
    };
}
