...
const SRC_IIR_COEFF_32_TO_16: [::core::ffi::c_uint; 48] = [
...
const SRC_IIR_COEFF_44_TO_16: [::core::ffi::c_uint; 42] = [
...
const SRC_IIR_COEFF_44_TO_32: [::core::ffi::c_uint; 42] = [
...
const SRC_IIR_COEFF_48_TO_16: [::core::ffi::c_uint; 48] = [
...
const SRC_IIR_COEFF_48_TO_32: [::core::ffi::c_uint; 42] = [
...
const SRC_IIR_COEFF_48_TO_44: [::core::ffi::c_uint; 30] = [
...
const SRC_IIR_COEFF_96_TO_16: [::core::ffi::c_uint; 48] = [
...
const SRC_IIR_COEFF_96_TO_44: [::core::ffi::c_uint; 48] = [
...
unsafe fn mtk_get_src_freq_mode(
...
unsafe fn get_iir_coeff(
    rate_in: ::core::ffi::c_uint,
    rate_out: ::core::ffi::c_uint,
    param_num: *mut ::core::ffi::c_uint,
) -> *const ::core::ffi::c_uint {
    if rate_in == 32000 && rate_out == 16000 {
        *param_num = SRC_IIR_COEFF_32_TO_16.len() as ::core::ffi::c_uint;
        SRC_IIR_COEFF_32_TO_16.as_ptr()
    } else if rate_in == 44100 && rate_out == 16000 {
        *param_num = SRC_IIR_COEFF_44_TO_16.len() as ::core::ffi::c_uint;
        SRC_IIR_COEFF_44_TO_16.as_ptr()
    } else if rate_in == 44100 && rate_out == 32000 {
        *param_num = SRC_IIR_COEFF_44_TO_32.len() as ::core::ffi::c_uint;
        SRC_IIR_COEFF_44_TO_32.as_ptr()
    } else if (rate_in == 48000 && rate_out == 16000)
        || (rate_in == 96000 && rate_out == 32000)
    {
        *param_num = SRC_IIR_COEFF_48_TO_16.len() as ::core::ffi::c_uint;
        SRC_IIR_COEFF_48_TO_16.as_ptr()
    } else if rate_in == 48000 && rate_out == 32000 {
        *param_num = SRC_IIR_COEFF_48_TO_32.len() as ::core::ffi::c_uint;
        SRC_IIR_COEFF_48_TO_32.as_ptr()
    } else if rate_in == 48000 && rate_out == 44100 {
        *param_num = SRC_IIR_COEFF_48_TO_44.len() as ::core::ffi::c_uint;
        SRC_IIR_COEFF_48_TO_44.as_ptr()
    } else if rate_in == 96000 && rate_out == 16000 {
        *param_num = SRC_IIR_COEFF_96_TO_16.len() as ::core::ffi::c_uint;
        SRC_IIR_COEFF_96_TO_16.as_ptr()
    } else if (rate_in == 96000 && rate_out == 44100)
        || (rate_in == 48000 && rate_out == 22050)
    {
        *param_num = SRC_IIR_COEFF_96_TO_44.len() as ::core::ffi::c_uint;
        SRC_IIR_COEFF_96_TO_44.as_ptr()
    } else {
        *param_num = 0;
        ::core::ptr::null()
    }
...
unsafe fn mtk_set_src_1_param(afe: *mut mtk_base_afe, id: ::core::ffi::c_int) -> ::core::ffi::c_int {
    let afe_priv = (*afe).platform_priv as *mut mt8186_afe_private;
    let src_priv = (*afe_priv).dai_priv[id as usize] as *mut mtk_afe_src_priv;
    let mut iir_coeff_num: ::core::ffi::c_uint = 0;
    let iir_stage: ::core::ffi::c_uint;
    let rate_in = (*src_priv).dl_rate;
    let rate_out = (*src_priv).ul_rate;
    let out_freq_mode = mtk_get_src_freq_mode(afe, rate_out);
    let in_freq_mode = mtk_get_src_freq_mode(afe, rate_in);
    ...
    if rate_in > rate_out {
        let iir_coeff = get_iir_coeff(rate_in as ::core::ffi::c_uint,
                                      rate_out as ::core::ffi::c_uint,
                                      &mut iir_coeff_num);

        if iir_coeff_num == 0 || iir_coeff.is_null() {
            dev_err!(
                (*afe).dev,
                "%s(), iir coeff error, num %d, coeff %p\n",
                c_str!("mtk_set_src_1_param"),
                iir_coeff_num,
                iir_coeff
            );
            return -EINVAL;
...
unsafe fn mtk_set_src_2_param(afe: *mut mtk_base_afe, id: ::core::ffi::c_int) -> ::core::ffi::c_int {
    let afe_priv = (*afe).platform_priv as *mut mt8186_afe_private;
    let src_priv = (*afe_priv).dai_priv[id as usize] as *mut mtk_afe_src_priv;
    let mut iir_coeff_num: ::core::ffi::c_uint = 0;
    let iir_stage: ::core::ffi::c_uint;
...
const HW_SRC_1_EN_W_NAME: &str = "HW_SRC_1_Enable";
const HW_SRC_2_EN_W_NAME: &str = "HW_SRC_2_Enable";

unsafe fn mtk_hw_src_event(
    ...
    let src_priv: *mut mtk_afe_src_priv;
    let mut reg: ::core::ffi::c_uint;
    ...
    src_priv = (*afe_priv).dai_priv[id as usize] as *mut mtk_afe_src_priv;

    dev_dbg!(
        (*afe).dev,
        "%s(), name %s, event 0x%x, id %d, src_priv %p, dl_rate %d, ul_rate %d\n",
        c_str!("mtk_hw_src_event"),
        (*w).name,
        event,
        id,
        src_priv,
...
/* dai component */
static_mtk_hw_src_1_in_ch1_mix! {
    SOC_DAPM_SINGLE_AUTODISABLE!("DL1_CH1 Switch", AFE_CONN40, I_DL1_CH1, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("DL2_CH1 Switch", AFE_CONN40, I_DL2_CH1, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("DL3_CH1 Switch", AFE_CONN40, I_DL3_CH1, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("DL4_CH1 Switch", AFE_CONN40_1, I_DL4_CH1, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("DL6_CH1 Switch", AFE_CONN40_1, I_DL6_CH1, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("I2S0_CH1 Switch", AFE_CONN40, I_I2S0_CH1, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("DL5_CH1 Switch", AFE_CONN40_1, I_DL5_CH1, 1, 0),
}

static_mtk_hw_src_1_in_ch2_mix! {
    SOC_DAPM_SINGLE_AUTODISABLE!("DL1_CH2 Switch", AFE_CONN41, I_DL1_CH2, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("DL2_CH2 Switch", AFE_CONN41, I_DL2_CH2, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("DL3_CH2 Switch", AFE_CONN41, I_DL3_CH2, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("DL4_CH2 Switch", AFE_CONN41_1, I_DL4_CH2, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("DL6_CH2 Switch", AFE_CONN41_1, I_DL6_CH2, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("I2S0_CH2 Switch", AFE_CONN41, I_I2S0_CH2, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("DL5_CH2 Switch", AFE_CONN41_1, I_DL5_CH2, 1, 0),
}

static_mtk_hw_src_2_in_ch1_mix! {
    SOC_DAPM_SINGLE_AUTODISABLE!("DL1_CH1 Switch", AFE_CONN42, I_DL1_CH1, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("DL2_CH1 Switch", AFE_CONN42, I_DL2_CH1, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("DL3_CH1 Switch", AFE_CONN42, I_DL3_CH1, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("DL4_CH1 Switch", AFE_CONN42, I_DL4_CH1, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("DL5_CH1 Switch", AFE_CONN42_1, I_DL5_CH1, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("DL6_CH1 Switch", AFE_CONN42_1, I_DL6_CH1, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("HW_GAIN2_OUT_CH1 Switch", AFE_CONN42, I_GAIN2_OUT_CH1, 1, 0),
}

static_mtk_hw_src_2_in_ch2_mix! {
    SOC_DAPM_SINGLE_AUTODISABLE!("DL1_CH2 Switch", AFE_CONN43, I_DL1_CH2, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("DL2_CH2 Switch", AFE_CONN43, I_DL2_CH2, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("DL3_CH2 Switch", AFE_CONN43, I_DL3_CH2, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("DL4_CH2 Switch", AFE_CONN43, I_DL4_CH2, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("DL5_CH2 Switch", AFE_CONN43_1, I_DL5_CH2, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("DL6_CH2 Switch", AFE_CONN43_1, I_DL6_CH2, 1, 0),
    SOC_DAPM_SINGLE_AUTODISABLE!("HW_GAIN2_OUT_CH2 Switch", AFE_CONN43, I_GAIN2_OUT_CH2, 1, 0),
}

static_mtk_dai_src_widgets! {
    /* inter-connections */
...
unsafe fn mtk_afe_src_en_connect(
    ...
    if snd_soc_dapm_widget_name_cmp(w, HW_SRC_1_EN_W_NAME) == 0 {
        src_priv = (*afe_priv).dai_priv[MT8186_DAI_SRC_1 as usize] as *mut mtk_afe_src_priv;
    } else {
        src_priv = (*afe_priv).dai_priv[MT8186_DAI_SRC_2 as usize] as *mut mtk_afe_src_priv;
    }

    dev_dbg!(
        (*afe).dev,
        "%s(), source %s, sink %s, dl_rate %d, ul_rate %d\n",
        c_str!("mtk_afe_src_en_connect"),
        (*source).name,
        (*sink).name,
        (*src_priv).dl_rate,
        (*src_priv).ul_rate
    ...
    if (*src_priv).dl_rate > 0 && (*src_priv).ul_rate > 0 { 1 } else { 0 }
}

static_mtk_dai_src_routes! {
    {"HW_SRC_1_IN_CH1", None, "DL1_CH1 Switch", "DL1"},
    {"HW_SRC_1_IN_CH2", None, "DL1_CH2 Switch", "DL1"},
    {"HW_SRC_2_IN_CH1", None, "DL1_CH1 Switch", "DL1"},
    {"HW_SRC_2_IN_CH2", None, "DL1_CH2 Switch", "DL1"},
    {"HW_SRC_1_IN_CH1", None, "DL2_CH1 Switch", "DL2"},
    {"HW_SRC_1_IN_CH2", None, "DL2_CH2 Switch", "DL2"},
    {"HW_SRC_2_IN_CH1", None, "DL2_CH1 Switch", "DL2"},
    {"HW_SRC_2_IN_CH2", None, "DL2_CH2 Switch", "DL2"},
    {"HW_SRC_1_IN_CH1", None, "DL3_CH1 Switch", "DL3"},
    {"HW_SRC_1_IN_CH2", None, "DL3_CH2 Switch", "DL3"},
    {"HW_SRC_2_IN_CH1", None, "DL3_CH1 Switch", "DL3"},
    {"HW_SRC_2_IN_CH2", None, "DL3_CH2 Switch", "DL3"},
    {"HW_SRC_1_IN_CH1", None, "DL6_CH1 Switch", "DL6"},
    {"HW_SRC_1_IN_CH2", None, "DL6_CH2 Switch", "DL6"},
    {"HW_SRC_2_IN_CH1", None, "DL6_CH1 Switch", "DL6"},
    {"HW_SRC_2_IN_CH2", None, "DL6_CH2 Switch", "DL6"},
    {"HW_SRC_1_IN_CH1", None, "DL5_CH1 Switch", "DL5"},
    {"HW_SRC_1_IN_CH2", None, "DL5_CH2 Switch", "DL5"},
    {"HW_SRC_2_IN_CH1", None, "DL5_CH1 Switch", "DL5"},
    {"HW_SRC_2_IN_CH2", None, "DL5_CH2 Switch", "DL5"},
    {"HW_SRC_1_IN_CH1", None, "DL4_CH1 Switch", "DL4"},
    {"HW_SRC_1_IN_CH2", None, "DL4_CH2 Switch", "DL4"},
    {"HW_SRC_2_IN_CH1", None, "DL4_CH1 Switch", "DL4"},
    {"HW_SRC_2_IN_CH2", None, "DL4_CH2 Switch", "DL4"},

    {"HW_SRC_1_In", None, "HW_SRC_1_IN_CH1"},
    {"HW_SRC_1_In", None, "HW_SRC_1_IN_CH2"},

    {"HW_SRC_2_In", None, "HW_SRC_2_IN_CH1"},
    {"HW_SRC_2_In", None, "HW_SRC_2_IN_CH2"},

    {"HW_SRC_1_In", None, HW_SRC_1_EN_W_NAME, mtk_afe_src_en_connect},
    {"HW_SRC_1_Out", None, HW_SRC_1_EN_W_NAME, mtk_afe_src_en_connect},
    {"HW_SRC_2_In", None, HW_SRC_2_EN_W_NAME, mtk_afe_src_en_connect},
    {"HW_SRC_2_Out", None, HW_SRC_2_EN_W_NAME, mtk_afe_src_en_connect},

    {"HW SRC 1 In Endpoint", None, "HW_SRC_1_In"},
    {"HW SRC 2 In Endpoint", None, "HW_SRC_2_In"},
    {"HW_SRC_1_Out", None, "HW SRC 1 Out Endpoint"},
    {"HW_SRC_2_Out", None, "HW SRC 2 Out Endpoint"},
}

/* dai ops */
unsafe fn mtk_dai_src_hw_params(
    ...
    let id = (*dai).id;
    let src_priv = (*afe_priv).dai_priv[id as usize] as *mut mtk_afe_src_priv;
    let sft: ::core::ffi::c_uint;
    let mask: ::core::ffi::c_uint;
    let rate = params_rate(params);
    let rate_reg = mt8186_rate_transform((*afe).dev, rate, id);

    dev_dbg!(
        (*afe).dev,
        "%s(), id %d, stream %d, rate %d\n",
        c_str!("mtk_dai_src_hw_params"),
        id,
        (*substream).stream,
        rate
    );
    ...
    if (*substream).stream == SNDRV_PCM_STREAM_PLAYBACK {
        (*src_priv).dl_rate = rate as ::core::ffi::c_int;
        if id == MT8186_DAI_SRC_1 {
        ...
        (*src_priv).ul_rate = rate as ::core::ffi::c_int;
        if id == MT8186_DAI_SRC_1 {
...
static_mtk_dai_src_ops! {
    .hw_params = mtk_dai_src_hw_params,
    .hw_free = mtk_dai_src_hw_free,
}

/* dai driver */
const MTK_SRC_RATES: ::core::ffi::c_uint = SNDRV_PCM_RATE_8000_48000 |
    SNDRV_PCM_RATE_88200 |
    SNDRV_PCM_RATE_96000 |
    SNDRV_PCM_RATE_176400 |
    SNDRV_PCM_RATE_192000;

const MTK_SRC_FORMATS: ::core::ffi::c_uint = SNDRV_PCM_FMTBIT_S16_LE |
    SNDRV_PCM_FMTBIT_S24_LE |
    SNDRV_PCM_FMTBIT_S32_LE;

static_mtk_dai_src_driver! {
    {
        .name = "HW_SRC_1",
        .id = MT8186_DAI_SRC_1,
        .playback = {
...
pub unsafe fn mt8186_dai_src_register(afe: *mut mtk_base_afe) -> ::core::ffi::c_int {
