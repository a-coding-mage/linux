...
// Rust translation dependency: <linux/cleanup.h>
// Rust translation dependency: <linux/module.h>
// Rust translation dependency: <linux/moduleparam.h>
// Rust translation dependency: <linux/device.h>
// Rust translation dependency: <linux/delay.h>
// Rust translation dependency: <linux/init.h>
// Rust translation dependency: <linux/pm.h>
// Rust translation dependency: <linux/pm_runtime.h>
// Rust translation dependency: <linux/regmap.h>
// Rust translation dependency: <sound/core.h>
// Rust translation dependency: <sound/pcm.h>
// Rust translation dependency: <sound/pcm_params.h>
// Rust translation dependency: <sound/soc.h>
// Rust translation dependency: <sound/tlv.h>

// Rust translation dependency: <linux/irqchip/irq-madera.h>
// Rust translation dependency: <linux/mfd/madera/core.h>
// Rust translation dependency: <linux/mfd/madera/registers.h>

// Rust translation dependency: "madera.h"
// Rust translation dependency: "wm_adsp.h"

pub const CS47L92_NUM_ADSP: usize = 1;
pub const CS47L92_MONO_OUTPUTS: usize = 3;

pub const DRV_NAME: &str = "cs47l92-codec";
...
static int cs47l92_put_demux(snd_kcontrol *kcontrol,
			     snd_ctl_elem_value *ucontrol)
{
	...
	ep_sel: core::ffi::c_uint, mux, change, cur;
	bool out_mono;
	int ret;
...
static int cs47l92_adsp_power_ev(snd_soc_dapm_widget *w,
...
static int cs47l92_outclk_ev(snd_soc_dapm_widget *w,
			     snd_kcontrol *kcontrol,
			     int event)
{
	struct snd_soc_component *component =
...
static core::ffi::c_uint cs47l92_aec_loopback_values[] = {
	0, 1, 2, 3, 4, 5, 8, 9
};
...
static int cs47l92_set_fll(snd_soc_component *component, int fll_id,
...
static int cs47l92_open(snd_soc_component *component,
...
static int cs47l92_component_probe(snd_soc_component *component)
{
	struct snd_soc_dapm_context *dapm = snd_soc_component_to_dapm(component);
	struct cs47l92 *cs47l92 = snd_soc_component_get_drvdata(component);
...
static void cs47l92_component_remove(snd_soc_component *component)
{
	struct cs47l92 *cs47l92 = snd_soc_component_get_drvdata(component);
	struct madera *madera = (*cs47l92).core.madera;
...
pub const CS47L92_DIG_VU: u32 = 0x0200;

static core::ffi::c_uint cs47l92_digital_vu[] = {
...
static int cs47l92_probe(platform_device *pdev)
{
	'error_core: {
	'error_dsp_irq: {
	'error_adsp: {
	...
	cs47l92 = devm_kzalloc((*&pdev).dev, sizeof(cs47l92), GFP_KERNEL);
	if (!cs47l92)
		return -ENOMEM;
	...
	(*cs47l92).core.adsp[0].cs_dsp.r#type = WMFW_ADSP2;
...
static void cs47l92_remove(platform_device *pdev)
{
