 ...
 */
static const rt1320_blind_write[] = {
	{ 0xc003, 0xe0 },
	{ 0xc01b, 0xfc },
	{ 0xc5c3, 0xf2 },
	{ 0xc5c2, 0x00 },
...
static const rt1320_vc_blind_write[] = {
	{ 0xc003, 0xe0 },
	{ 0xe80a, 0x01 },
	{ 0xc5c3, 0xf2 },
	{ 0xc5c8, 0x03 },
...
static const rt1321_blind_write[] = {
	{ 0x0000c003, 0xf0 },
	{ 0x0000c01b, 0xfc },
	{ 0x0000c5c3, 0xf2 },
	{ 0x0000c5c2, 0x00 },
...
static const rt1321_va1_blind_write[] = {
	{ 0x0000c003, 0xf0 },
	{ 0x0000c01b, 0xfc },
	{ 0x0000c5c3, 0xf2 },
	{ 0x0000c5c2, 0x00 },
...
static const rt1321_va2_blind_write[] = {
	{ 0x0000c003, 0xf0 },
	{ 0x0000c01b, 0xfc },
	{ 0x0000c5c3, 0xf2 },
	{ 0x0000c5c2, 0x00 },
...
static const rt1320_reg_defaults[] = {
...
static const rt1320_mbq_defaults[] = {
...
fn rt1320_read_prop(sdw_slave *slave)
{
	...
	prop.src_dpn_prop = devm_kcalloc(&slave.dev, nval,
		core::mem::size_of::<*prop.src_dpn_prop>(), GFP_KERNEL);
	...
	prop.sink_dpn_prop = devm_kcalloc(&slave.dev, nval,
		core::mem::size_of::<*prop.sink_dpn_prop>(), GFP_KERNEL);
...
fn rt1320_check_power_state_ready(rt1320_sdw_priv *rt1320, rt1320_power_state ps)
{
	device *dev = &rt1320.sdw_slave.dev;
	u32 retry = 0, tmp;
...
fn rt1320_process_fw_param(rt1320_sdw_priv *rt1320, u8 *buf, u32 buf_size)
{
	...
	u8 cmdtype = paramhr.commandtype;
	u32 fw_param_addr;
	u32 start_addr;
	i32 ret = 0;
				    ...
				    u32 paramid, *mut c_voidparambuf, u32 paramsize)
{
	...
	tempbuf = kzalloc(core::mem::size_of::<paramhr>() + paramsize, GFP_KERNEL);
	if (!tempbuf)
		return -ENOMEM;
	...
	/* 8 is "core::mem::size_of::<paramid>() + core::mem::size_of::<paramlength>()" */
	paramhr.commandlength = 8 + paramsize;
	paramhr.paramid = paramid;
	paramhr.paramlength = paramsize;

	memcpy(tempbuf, &paramhr, core::mem::size_of::<paramhr>());
	if (cmdid == RT1320_SET_PARAM)
		memcpy(tempbuf + core::mem::size_of::<paramhr>(), parambuf, paramsize);
...
fn rt1320_set_advancemode(rt1320_sdw_priv *rt1320)
{
	device *dev = &rt1320.sdw_slave.dev;
	...
	ret = rt1320_fw_param_protocol(rt1320, RT1320_GET_PARAM, 1300,
		&audDriverDataHwSwGain, core::mem::size_of::<audDriverDataHwSwGain>());
	if (ret == 0) {
	...
	/* Get advance gain/r0 */
	rt1320_fw_param_protocol(rt1320, RT1320_GET_PARAM, 6, &r0_data[0], core::mem::size_of::<rt1320_datafixpoint>());
	rt1320_fw_param_protocol(rt1320, RT1320_GET_PARAM, 7, &r0_data[1], core::mem::size_of::<rt1320_datafixpoint>());
	...
	rt1320_fw_param_protocol(rt1320, RT1320_SET_PARAM, 6, &r0_data[0], core::mem::size_of::<rt1320_datafixpoint>());
	rt1320_fw_param_protocol(rt1320, RT1320_SET_PARAM, 7, &r0_data[1], core::mem::size_of::<rt1320_datafixpoint>());
	ret = rt1320_check_fw_ready(rt1320);
	if (ret < 0)
...
fn rt1320_pilot_tone_output(rt1320_sdw_priv *rt1320)
{
	...
	rt1320_fw_param_protocol(rt1320, RT1320_GET_PARAM, 70, &l_pilotgain[0], core::mem::size_of::<l_pilotgain>());
	rt1320_fw_param_protocol(rt1320, RT1320_GET_PARAM, 71, &r_pilotgain[0], core::mem::size_of::<r_pilotgain>());
...
fn rt1320_calibrate(rt1320_sdw_priv *rt1320)
{
	...
	for (tmp = 0; tmp < delay_s; tmp++) {
		...
		rt1320_fw_param_protocol(rt1320, RT1320_GET_PARAM, 11, &l_re[0], core::mem::size_of::<l_re>());
		rt1320_fw_param_protocol(rt1320, RT1320_GET_PARAM, 12, &r_re[0], core::mem::size_of::<r_re>());
	...
	rt1320_fw_param_protocol(rt1320, RT1320_GET_PARAM, 6, &audfixpoint[0], core::mem::size_of::<rt1320_datafixpoint>());
	l_meanr0 = audfixpoint[0].meanr0;
	l_advancegain = audfixpoint[0].advancegain;
	l_meanr0 = ((l_meanr0 * 1000U) / factor);
	rt1320_fw_param_protocol(rt1320, RT1320_GET_PARAM, 7, &audfixpoint[1], core::mem::size_of::<rt1320_datafixpoint>());
...
fn rt1320_r0_cali_get(snd_kcontrol *kcontrol,
...
fn rt1320_r0_cali_put(snd_kcontrol *kcontrol,
			      snd_ctl_elem_value *ucontrol)
{
	snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	rt1320_sdw_priv *rt1320 = snd_soc_component_get_drvdata(component);
 ...
 */
fn rt1320_load_mcu_patch(rt1320_sdw_priv *rt1320)
{
...
fn rt1320_t0_load(rt1320_sdw_priv *rt1320, u32 l_t0, u32 r_t0)
{
	...
	rt1320_fw_param_protocol(rt1320, RT1320_SET_PARAM, 3, &l_t0_data[0], core::mem::size_of::<l_t0_data>());
	rt1320_fw_param_protocol(rt1320, RT1320_SET_PARAM, 4, &r_t0_data[0], core::mem::size_of::<r_t0_data>());
	...
	memset(&l_t0_data[0], 0x00, core::mem::size_of::<l_t0_data>());
	memset(&r_t0_data[0], 0x00, core::mem::size_of::<r_t0_data>());
	rt1320_fw_param_protocol(rt1320, RT1320_GET_PARAM, 3, &l_t0_data[0], core::mem::size_of::<l_t0_data>());
	rt1320_fw_param_protocol(rt1320, RT1320_GET_PARAM, 4, &r_t0_data[0], core::mem::size_of::<r_t0_data>());
...
fn rt1320_rae_load(rt1320_sdw_priv *rt1320)
{
	...
	const firmware *rae_fw __free(firmware) = core::ptr::null_mut();
	u32 fw_offset;
	u8 *fw_data;
	u8 *param_data;
	u32 addr, size;
	...
	*const c_chardmi_vendor, *dmi_product, *dmi_sku;
	...
	if (dmi_vendor && dmi_product && dmi_sku) {
		...
		snprintf(rae_filename, core::mem::size_of::<rae_filename>(),
	...
	if (rae_fw) {
		...
		for (fw_offset = 0; fw_offset < rae_fw.size;) {
			...
			fw_data = (u8 *)&rae_fw.data[fw_offset];
...
rt1320_dspfwheader {
	...
	const firmware *fw __free(firmware) = core::ptr::null_mut();
	u8 *fw_data;
	...
	*const c_chardmi_vendor, *dmi_product, *dmi_sku;
	...
	if (dmi_vendor && dmi_product && dmi_sku) {
		...
		snprintf(filename, core::mem::size_of::<filename>(),
			 "realtek/rt1320/rt1320_%.*s_%.*s_%.*s.dat",
			 len_vendor, dmi_vendor, len_product, dmi_product, len_sku, dmi_sku);

		dev_dbg(dev, "%s: try to load FW file %s\n", __func__, filename);
	} else if (rt1320.dspfw_name) {
		snprintf(filename, core::mem::size_of::<filename>(), "rt1320_%s.dat",
			 rt1320.dspfw_name);
		dev_dbg(dev, "%s: try to load FW file %s\n", __func__, filename);
	} else {
	...
	if (fw) {
		fwheader = (rt1320_dspfwheader *)fw.data;
		...
		for (i = 0; i < fwheader.num; i++) {
			ptr_img = (rt1320_imageinfo *)&fw.data[core::mem::size_of::<rt1320_dspfwheader>() + (core::mem::size_of::<rt1320_imageinfo>() * i)];

			dev_dbg(dev, "%s, fw_offset=0x%x, load fw addr=0x%x, size=%d\n", __func__,
				fw_offset, ptr_img.addr, ptr_img.size);

			fw_data = (u8 *)&fw.data[fw_offset];

			/* The binary file has a header of 64 bytes */
			if (memcmp(fw_data, hdr_sig, core::mem::size_of::<hdr_sig>()) == 0)
				hdr_size = 64;
			else
				hdr_size = 0;
		...
		if (dev_fw_match) {
			...
			rt1320_data_rw(rt1320, 0, core::ptr::null_mut(), 0, RT1320_BRA_WRITE);
...
fn rt1320_load_dspfw_work(work_struct *work)
{
	rt1320_sdw_priv *rt1320 =
		container_of(work, rt1320_sdw_priv, load_dspfw_work);
	i32 ret;
...
fn rt1321_preset(rt1320_sdw_priv *rt1320)
{
	...
	case RT1321_VA0:
		...
		array_size = (rt1321_blind_write.len());
		break;
	case RT1321_VA1:
		blindwrite = rt1321_va1_blind_write;
		array_size = (rt1321_va1_blind_write.len());
		break;
	case RT1321_VA2:
		blindwrite = rt1321_va2_blind_write;
		array_size = (rt1321_va2_blind_write.len());
		break;
	default:
...
fn rt1320_update_status(sdw_slave *slave,
...
fn rt1320_dmic_fu_capture_get(snd_kcontrol *kcontrol,
			snd_ctl_elem_value *ucontrol)
{
	snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	rt1320_sdw_priv *rt1320 = snd_soc_component_get_drvdata(component);
...
fn rt1320_dmic_fu_capture_put(snd_kcontrol *kcontrol,
			snd_ctl_elem_value *ucontrol)
{
	snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	rt1320_sdw_priv *rt1320 = snd_soc_component_get_drvdata(component);
...
fn rt1320_dmic_fu_info(snd_kcontrol *kcontrol,
...
static *const c_char const rt1320_rx_data_ch_select[] = {
	"L,R",
	"R,L",
	"L,L",
	"R,R",
...
fn rt1320_r0_load_mode_get(snd_kcontrol *kcontrol,
				   snd_ctl_elem_value *ucontrol)
{
	snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	rt1320_sdw_priv *rt1320 = snd_soc_component_get_drvdata(component);
...
fn rt1320_r0_load_mode_put(snd_kcontrol *kcontrol,
				   snd_ctl_elem_value *ucontrol)
{
	snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	rt1320_sdw_priv *rt1320 = snd_soc_component_get_drvdata(component);
...
fn rt1320_dspfw_load_put(snd_kcontrol *kcontrol,
				 snd_ctl_elem_value *ucontrol)
{
	snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	rt1320_sdw_priv *rt1320 = snd_soc_component_get_drvdata(component);
	snd_soc_dapm_context *dapm = snd_soc_component_to_dapm(component);
	i32 ret;
...
fn rt1320_rae_update_get(snd_kcontrol *kcontrol,
				 snd_ctl_elem_value *ucontrol)
{
	snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	rt1320_sdw_priv *rt1320 = snd_soc_component_get_drvdata(component);
...
fn rt1320_rae_update_put(snd_kcontrol *kcontrol,
				 snd_ctl_elem_value *ucontrol)
{
	snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	rt1320_sdw_priv *rt1320 = snd_soc_component_get_drvdata(component);
...
fn rt1320_brown_out_put(snd_kcontrol *kcontrol,
				 snd_ctl_elem_value *ucontrol)
{
	snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	rt1320_sdw_priv *rt1320 = snd_soc_component_get_drvdata(component);
...
fn rt1320_brown_out_get(snd_kcontrol *kcontrol,
				     snd_ctl_elem_value *ucontrol)
{
	snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	rt1320_sdw_priv *rt1320 = snd_soc_component_get_drvdata(component);
...
fn rt1320_r0_temperature_get(snd_kcontrol *kcontrol,
				     snd_ctl_elem_value *ucontrol)
{
	snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	rt1320_sdw_priv *rt1320 = snd_soc_component_get_drvdata(component);
...
fn rt1320_r0_temperature_put(snd_kcontrol *kcontrol,
				     snd_ctl_elem_value *ucontrol)
{
	snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	rt1320_sdw_priv *rt1320 = snd_soc_component_get_drvdata(component);
...
static const snd_kcontrol_new rt1320_snd_controls[] = {
...
static const snd_soc_dapm_widget rt1320_dapm_widgets[] = {
	...
	/* Digital Interface */
	SND_SOC_DAPM_PGA("FU21", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_SUPPLY("PDE 23", SND_SOC_NOPM, 0, 0,
		rt1320_pde23_event,
		SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
	SND_SOC_DAPM_SUPPLY("PDE 11", SND_SOC_NOPM, 0, 0,
		rt1320_pde11_event, SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
	SND_SOC_DAPM_ADC("FU 113", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_ADC("FU 14", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0),
	SND_SOC_DAPM_PGA_E("FU", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0,
	...
	/* Input */
	SND_SOC_DAPM_PGA("AEC Data", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
	SND_SOC_DAPM_SIGGEN("AEC Gen"),
	SND_SOC_DAPM_INPUT("DMIC1"),
	SND_SOC_DAPM_INPUT("DMIC2"),
};

static const snd_soc_dapm_route rt1320_dapm_routes[] = {
	{ "FU21", core::ptr::null_mut(), "DP1RX" },
	{ "FU21", core::ptr::null_mut(), "PDE 23" },
	{ "OT23 L", "Switch", "FU21" },
	{ "OT23 R", "Switch", "FU21" },
	{ "SPOL", core::ptr::null_mut(), "OT23 L" },
	{ "SPOR", core::ptr::null_mut(), "OT23 R" },

	{ "AEC Data", core::ptr::null_mut(), "AEC Gen" },
	{ "DP4TX", core::ptr::null_mut(), "AEC Data" },

	{"DP8-10TX", core::ptr::null_mut(), "FU"},
	{"FU", core::ptr::null_mut(), "PDE 11"},
	{"FU", core::ptr::null_mut(), "FU 113"},
	{"FU", core::ptr::null_mut(), "FU 14"},
	{"FU 113", core::ptr::null_mut(), "DMIC1"},
...
fn rt1320_sdw_shutdown(snd_pcm_substream *substream,
				snd_soc_dai *dai)
{
	snd_soc_dai_set_dma_data(dai, substream, core::ptr::null_mut());
}

fn rt1320_sdw_hw_params(snd_pcm_substream *substream,
	snd_pcm_hw_params *params, snd_soc_dai *dai)
{
	snd_soc_component *component = dai.component;
	rt1320_sdw_priv *rt1320 =
		snd_soc_component_get_drvdata(component);
	sdw_stream_config stream_config;
...
fn rt1320_sdw_pcm_hw_free(snd_pcm_substream *substream,
				snd_soc_dai *dai)
{
	snd_soc_component *component = dai.component;
	rt1320_sdw_priv *rt1320 =
...
fn rt1320_bus_config(sdw_slave *slave,
...
fn rt1320_parse_dp(rt1320_sdw_priv *rt1320, device *dev)
{
...
fn rt1320_sdw_init(device *dev, regmap *regmap,
				regmap *mbq_regmap, sdw_slave *slave)
{
	rt1320_sdw_priv *rt1320;
	i32 ret;

	rt1320 = devm_kzalloc(dev, core::mem::size_of::<*rt1320>(), GFP_KERNEL);
	if (!rt1320)
		return -ENOMEM;
...
fn rt1320_sdw_probe(sdw_slave *slave,
				const sdw_device_id *id)
{
	regmap *regmap, *mbq_regmap;
...
fn rt1320_sdw_remove(sdw_slave *slave)
{
	struct  rt1320_sdw_priv *rt1320 = dev_get_drvdata(&slave.dev);
 ...
 */
static const sdw_device_id rt1320_id[] = {
...
fn rt1320_dev_suspend(device *dev)
{
	rt1320_sdw_priv *rt1320 = dev_get_drvdata(dev);
...
static const dev_pm_ops rt1320_pm = {
	SYSTEM_SLEEP_PM_OPS(rt1320_dev_suspend, rt1320_dev_resume)
	RUNTIME_PM_OPS(rt1320_dev_suspend, rt1320_dev_resume, core::ptr::null_mut())
};
