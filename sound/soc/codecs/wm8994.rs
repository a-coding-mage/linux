...
// Faithful source-level Rust translation of isolated wm8994.c.
// External Linux/ALSA symbols, types, constants, and macros referenced here are supplied by the surrounding repository.
#![allow(non_camel_case_types, non_snake_case, non_upper_case_globals, dead_code, unused_variables, unused_mut, improper_ctypes)]

pub const WM1811_JACKDET_MODE_NONE: u16 = 0x0000;
pub const WM1811_JACKDET_MODE_JACK: u16 = 0x0100;
pub const WM1811_JACKDET_MODE_MIC: u16 = 0x0080;
pub const WM1811_JACKDET_MODE_AUDIO: u16 = 0x0180;

pub const WM8994_NUM_DRC: usize = 3;
pub const WM8994_NUM_EQ: usize = 3;
pub const FIXED_FLL_SIZE: u64 = ((1u64 << 16) * 10);
pub const WM8994_RATES: u32 = SNDRV_PCM_RATE_8000_96000;
pub const WM8994_FORMATS: u32 =
    SNDRV_PCM_FMTBIT_S16_LE | SNDRV_PCM_FMTBIT_S20_3LE |
    SNDRV_PCM_FMTBIT_S24_LE | SNDRV_PCM_FMTBIT_S32_LE;

#[repr(C)]
pub struct wm8994_reg_mask {
    pub reg: c_uint,
    pub mask: c_uint,
}
...
pub static mut wm8994_vu_bits: [wm8994_reg_mask; 22] = [
    wm8994_reg_mask { reg: WM8994_LEFT_LINE_INPUT_1_2_VOLUME, mask: WM8994_IN1_VU },
    wm8994_reg_mask { reg: WM8994_RIGHT_LINE_INPUT_1_2_VOLUME, mask: WM8994_IN1_VU },
    wm8994_reg_mask { reg: WM8994_LEFT_LINE_INPUT_3_4_VOLUME, mask: WM8994_IN2_VU },
    wm8994_reg_mask { reg: WM8994_RIGHT_LINE_INPUT_3_4_VOLUME, mask: WM8994_IN2_VU },
    wm8994_reg_mask { reg: WM8994_SPEAKER_VOLUME_LEFT, mask: WM8994_SPKOUT_VU },
    wm8994_reg_mask { reg: WM8994_SPEAKER_VOLUME_RIGHT, mask: WM8994_SPKOUT_VU },
    wm8994_reg_mask { reg: WM8994_LEFT_OUTPUT_VOLUME, mask: WM8994_HPOUT1_VU },
    wm8994_reg_mask { reg: WM8994_RIGHT_OUTPUT_VOLUME, mask: WM8994_HPOUT1_VU },
    wm8994_reg_mask { reg: WM8994_LEFT_OPGA_VOLUME, mask: WM8994_MIXOUT_VU },
    wm8994_reg_mask { reg: WM8994_RIGHT_OPGA_VOLUME, mask: WM8994_MIXOUT_VU },
    wm8994_reg_mask { reg: WM8994_AIF1_DAC1_LEFT_VOLUME, mask: WM8994_AIF1DAC1_VU },
    wm8994_reg_mask { reg: WM8994_AIF1_DAC1_RIGHT_VOLUME, mask: WM8994_AIF1DAC1_VU },
    wm8994_reg_mask { reg: WM8994_AIF2_DAC_LEFT_VOLUME, mask: WM8994_AIF2DAC_VU },
    wm8994_reg_mask { reg: WM8994_AIF2_DAC_RIGHT_VOLUME, mask: WM8994_AIF2DAC_VU },
    wm8994_reg_mask { reg: WM8994_AIF1_ADC1_LEFT_VOLUME, mask: WM8994_AIF1ADC1_VU },
    wm8994_reg_mask { reg: WM8994_AIF1_ADC1_RIGHT_VOLUME, mask: WM8994_AIF1ADC1_VU },
    wm8994_reg_mask { reg: WM8994_AIF2_ADC_LEFT_VOLUME, mask: WM8994_AIF2ADC_VU },
    wm8994_reg_mask { reg: WM8994_AIF2_ADC_RIGHT_VOLUME, mask: WM8994_AIF1ADC2_VU },
    wm8994_reg_mask { reg: WM8994_DAC1_LEFT_VOLUME, mask: WM8994_DAC1_VU },
    wm8994_reg_mask { reg: WM8994_DAC1_RIGHT_VOLUME, mask: WM8994_DAC1_VU },
    wm8994_reg_mask { reg: WM8994_DAC2_LEFT_VOLUME, mask: WM8994_DAC2_VU },
    wm8994_reg_mask { reg: WM8994_DAC2_RIGHT_VOLUME, mask: WM8994_DAC2_VU },
];

/* VU bitfields for ADC2, DAC2 not available on WM1811 */
pub static mut wm8994_adc2_dac2_vu_bits: [wm8994_reg_mask; 4] = [
    wm8994_reg_mask { reg: WM8994_AIF1_DAC2_LEFT_VOLUME, mask: WM8994_AIF1DAC2_VU },
    wm8994_reg_mask { reg: WM8994_AIF1_DAC2_RIGHT_VOLUME, mask: WM8994_AIF1DAC2_VU },
    wm8994_reg_mask { reg: WM8994_AIF1_ADC2_LEFT_VOLUME, mask: WM8994_AIF1ADC2_VU },
    wm8994_reg_mask { reg: WM8994_AIF1_ADC2_RIGHT_VOLUME, mask: WM8994_AIF1ADC2_VU },
];

pub static mut wm8994_drc_base: [c_int; WM8994_NUM_DRC] = [
    WM8994_AIF1_DRC1_1,
    WM8994_AIF1_DRC2_1,
    WM8994_AIF2_DRC_1,
];

pub static mut wm8994_retune_mobile_base: [c_int; WM8994_NUM_EQ] = [
    WM8994_AIF1_DAC1_EQ_GAINS_1,
    WM8994_AIF1_DAC2_EQ_GAINS_1,
    WM8994_AIF2_EQ_GAINS_1,
];

pub static mut opclk_divs: [c_int; 9] = [10, 20, 30, 40, 55, 60, 80, 120, 160];

#[repr(C)]
pub struct srs_entry {
    pub val: c_int,
    pub rate: c_int,
}

pub static mut srs: [srs_entry; 11] = [
    srs_entry { val: 0, rate: 8000 },
    srs_entry { val: 1, rate: 11025 },
    srs_entry { val: 2, rate: 12000 },
    srs_entry { val: 3, rate: 16000 },
    srs_entry { val: 4, rate: 22050 },
    srs_entry { val: 5, rate: 24000 },
    srs_entry { val: 6, rate: 32000 },
    srs_entry { val: 7, rate: 44100 },
    srs_entry { val: 8, rate: 48000 },
    srs_entry { val: 9, rate: 88200 },
    srs_entry { val: 10, rate: 96000 },
];

pub static mut fs_ratios: [c_int; 10] = [64, 128, 192, 256, 384, 512, 768, 1024, 1408, 1536];

pub static mut bclk_divs: [c_int; 22] = [
