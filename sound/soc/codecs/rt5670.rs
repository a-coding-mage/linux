...
// Rust translation of ./rt5670.c for ./soc/codecs/rt5670.rs.
// Dependency note: Linux/ALSA/regmap types, constants, and macro-expanded tables are supplied by surrounding translated files.
#![allow(non_camel_case_types, non_snake_case, non_upper_case_globals, dead_code, unused_variables, improper_ctypes)]

use core::ffi::{c_char, c_int, c_uint, c_ulong, c_void};

const fn BIT(n: c_uint) -> c_ulong { 1u64.wrapping_shl(n) as c_ulong }

pub const RT5670_GPIO1_IS_IRQ: c_ulong = BIT(0);
pub const RT5670_IN2_DIFF: c_ulong = BIT(1);
pub const RT5670_DMIC_EN: c_ulong = BIT(2);
pub const RT5670_DMIC1_IN2P: c_ulong = BIT(3);
pub const RT5670_DMIC1_GPIO6: c_ulong = BIT(4);
pub const RT5670_DMIC1_GPIO7: c_ulong = BIT(5);
pub const RT5670_DMIC2_INR: c_ulong = BIT(6);
pub const RT5670_DMIC2_GPIO8: c_ulong = BIT(7);
pub const RT5670_DMIC3_GPIO5: c_ulong = BIT(8);
pub const RT5670_JD_MODE1: c_ulong = BIT(9);
pub const RT5670_JD_MODE2: c_ulong = BIT(10);
pub const RT5670_JD_MODE3: c_ulong = BIT(11);
pub const RT5670_GPIO1_IS_EXT_SPK_EN: c_ulong = BIT(12);

pub static mut rt5670_quirk: c_ulong = 0;
pub static mut quirk_override: c_uint = 0;

pub const RT5670_DEVICE_ID: c_uint = 0x6271;
pub const RT5670_PR_RANGE_BASE: c_uint = 0xff + 1;
pub const RT5670_PR_SPACING: c_uint = 0x100;
pub const RT5670_PR_BASE: c_uint = RT5670_PR_RANGE_BASE + (0 * RT5670_PR_SPACING);
