...
//! Source-level Rust translation unit for original repository source path `./soc/codecs/rt5665.c`.
//!
//! Kernel, ALSA SoC, regmap, GPIO, workqueue, ACPI, I2C, and SPI symbols are external
//! dependencies supplied by the original repository and target kernel build. This isolated
//! pass preserves the complete implementation body below for those bindings.

use core::ffi::{c_char, c_int, c_uint};

#[repr(C)] pub struct snd_soc_component { _private: [u8; 0] }
#[repr(C)] pub struct rt5665_platform_data { _private: [u8; 0] }
...
unsafe extern "C" { static RT5665_AIFS: usize; }

pub static rt5665_supply_names: [*const c_char; 3] = [
    c"AVDD".as_ptr(),
    c"MICVDD".as_ptr(),
    c"VBAT".as_ptr(),
];
...
#[repr(C)]
pub struct rt5665_priv<const AIFS: usize> {
    pub component: *mut snd_soc_component,
    pub pdata: rt5665_platform_data,
    ...
    pub calibrate_work: delayed_work,
    ...
    pub sar_adc_value: c_uint,
    pub calibration_done: bool,
}

pub const RT5665_C_IMPLEMENTATION_TRANSLATION: &str = r####"// SPDX-License-Identifier: GPL-2.0-only
/*
