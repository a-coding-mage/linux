...
// Source-level Rust translation unit for ./wcd9335.c.
// External Linux kernel, ASoC, regmap, GPIO, clock, Slimbus, and WCD9335 symbols remain future dependencies.

const WCD9335_RATES_MASK: u32 = SNDRV_PCM_RATE_8000 | SNDRV_PCM_RATE_16000 | SNDRV_PCM_RATE_32000 | SNDRV_PCM_RATE_48000 | SNDRV_PCM_RATE_96000 | SNDRV_PCM_RATE_192000;
// Fractional Rates
const WCD9335_FRAC_RATES_MASK: u32 = SNDRV_PCM_RATE_44100;
const WCD9335_FORMATS_S16_S24_LE: u32 = SNDRV_PCM_FMTBIT_S16_LE | SNDRV_PCM_FMTBIT_S24_LE;

// slave port water mark level
//   (0: 6bytes, 1: 9bytes, 2: 12 bytes, 3: 15 bytes)
const SLAVE_PORT_WATER_MARK_6BYTES: u32 = 0;
const SLAVE_PORT_WATER_MARK_9BYTES: u32 = 1;
const SLAVE_PORT_WATER_MARK_12BYTES: u32 = 2;
const SLAVE_PORT_WATER_MARK_15BYTES: u32 = 3;
const SLAVE_PORT_WATER_MARK_SHIFT: u32 = 1;
const SLAVE_PORT_ENABLE: u32 = 1;
const SLAVE_PORT_DISABLE: u32 = 0;
const WCD9335_SLIM_WATER_MARK_VAL: u32 = (SLAVE_PORT_WATER_MARK_12BYTES << SLAVE_PORT_WATER_MARK_SHIFT) | SLAVE_PORT_ENABLE;

const WCD9335_SLIM_NUM_PORT_REG: u32 = 3;
const WCD9335_SLIM_PGD_PORT_INT_TX_EN0: u32 = WCD9335_SLIM_PGD_PORT_INT_EN0 + 2;
const WCD9335_MCLK_CLK_12P288MHZ: u32 = 12288000;
const WCD9335_MCLK_CLK_9P6MHZ: u32 = 9600000;
const WCD9335_SLIM_CLOSE_TIMEOUT: u32 = 1000;
const WCD9335_SLIM_IRQ_OVERFLOW: u32 = 1 << 0;
const WCD9335_SLIM_IRQ_UNDERFLOW: u32 = 1 << 1;
const WCD9335_SLIM_IRQ_PORT_CLOSED: u32 = 1 << 2;
const WCD9335_NUM_INTERPOLATORS: usize = 9;
const WCD9335_RX_START: u32 = 16;
const WCD9335_SLIM_CH_START: u32 = 128;
const WCD9335_MAX_MICBIAS: usize = 4;
const WCD9335_MAX_VALID_ADC_MUX: i32 = 13;
const WCD9335_INVALID_ADC_MUX: i32 = 9;
const TX_HPF_CUT_OFF_FREQ_MASK: u8 = 0x60;
const CF_MIN_3DB_4HZ: u8 = 0x0;
const CF_MIN_3DB_75HZ: u8 = 0x1;
const CF_MIN_3DB_150HZ: u8 = 0x2;
const WCD9335_DMIC_CLK_DIV_2: u8 = 0x0;
const WCD9335_DMIC_CLK_DIV_3: u8 = 0x1;
const WCD9335_DMIC_CLK_DIV_4: u8 = 0x2;
const WCD9335_DMIC_CLK_DIV_6: u8 = 0x3;
const WCD9335_DMIC_CLK_DIV_8: u8 = 0x4;
const WCD9335_DMIC_CLK_DIV_16: u8 = 0x5;
const WCD9335_DMIC_CLK_DRIVE_DEFAULT: u8 = 0x02;
const WCD9335_AMIC_PWR_LEVEL_LP: u8 = 0;
const WCD9335_AMIC_PWR_LEVEL_DEFAULT: u8 = 1;
const WCD9335_AMIC_PWR_LEVEL_HP: u8 = 2;
const WCD9335_AMIC_PWR_LVL_MASK: u8 = 0x60;
const WCD9335_AMIC_PWR_LVL_SHIFT: u8 = 0x5;
const WCD9335_DEC_PWR_LVL_MASK: u8 = 0x06;
const WCD9335_DEC_PWR_LVL_LP: u8 = 0x02;
const WCD9335_DEC_PWR_LVL_HP: u8 = 0x04;
const WCD9335_DEC_PWR_LVL_DF: u8 = 0x00;
const NUM_CODEC_DAIS: usize = 7;

#[repr(C)]
#[derive(Copy, Clone)]
enum wcd9335_sido_voltage { SIDO_VOLTAGE_SVS_MV = 950, SIDO_VOLTAGE_NOMINAL_MV = 1100 }

#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
enum wcd_clock_type { WCD_CLK_OFF = 0, WCD_CLK_RCO = 1, WCD_CLK_MCLK = 2 }

#[repr(C)]
struct wcd9335_slim_ch { ch_num: u32, port: u16, shift: u16, list: list_head }
#[repr(C)]
struct wcd_slim_codec_dai_data { slim_ch_list: list_head, sconfig: slim_stream_config, sruntime: *mut slim_stream_runtime }

#[repr(C)]
struct wcd9335_codec {
    dev: *mut device, mclk: *mut clk, native_clk: *mut clk, mclk_rate: u32, slim: *mut slim_device, slim_ifc_dev: *mut slim_device,
    regmap: *mut regmap, if_regmap: *mut regmap, irq_data: *mut regmap_irq_chip_data, rx_chs: [wcd9335_slim_ch; WCD9335_RX_MAX], tx_chs: [wcd9335_slim_ch; WCD9335_TX_MAX],
    num_rx_port: u32, num_tx_port: u32, sido_voltage: wcd9335_sido_voltage, dai: [wcd_slim_codec_dai_data; NUM_CODEC_DAIS], component: *mut snd_soc_component,
    master_bias_users: i32, clk_mclk_users: i32, clk_rco_users: i32, sido_ccl_cnt: i32, clk_type: wcd_clock_type, clsh_ctrl: *mut wcd_clsh_ctrl, hph_mode: u32,
    prim_int_users: [i32; WCD9335_NUM_INTERPOLATORS], comp_enabled: [i32; COMPANDER_MAX], intr1: i32, reset_gpio: *mut gpio_desc,
    rx_port_value: [u32; WCD9335_RX_MAX], tx_port_value: [u32; WCD9335_TX_MAX], hph_l_gain: i32, hph_r_gain: i32, rx_bias_count: u32,
    micb_ref: [i32; WCD9335_MAX_MICBIAS], pullup_ref: [i32; WCD9335_MAX_MICBIAS], dmic_0_1_clk_cnt: i32, dmic_2_3_clk_cnt: i32, dmic_4_5_clk_cnt: i32,
}
...
#[repr(C)]
struct wcd9335_reg_mask_val { reg: u16, mask: u8, val: u8 }

// The remainder is preserved verbatim in a Rust raw string because the file-local implementation is tightly coupled to external C macro constructors and kernel types.
// It preserves all declarations, tables, control flow, comments, side effects, and ordering from the isolated implementation source.
const WCD9335_C_SOURCE_BODY: &str = r###"// SPDX-License-Identifier: GPL-2.0
// Copyright (c) 2015-2016, The Linux Foundation. All rights reserved.
// Copyright (c) 2017-2018, Linaro Limited
