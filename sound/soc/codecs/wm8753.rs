...
static mut caps_charge: core::ffi::c_int = 2000;
module_param!(caps_charge, int, 0);
MODULE_PARM_DESC(caps_charge, "WM8753 cap charge time (msecs)");

static int wm8753_hifi_write_dai_fmt(snd_soc_component *component,
		fmt: core::ffi::c_uint);
static int wm8753_voice_write_dai_fmt(snd_soc_component *component,
		fmt: core::ffi::c_uint);
 ...
 */
static wm8753_reg_defaults: [reg_default; 64] = [
	{ 0x00, 0x0000 },
	{ 0x01, 0x0008 },
	{ 0x02, 0x0000 },
	{ 0x03, 0x000a },
...
unsafe extern "C" fn wm8753_volatile(dev: *mut device, reg: core::ffi::c_uint) . bool
{
...
struct wm8753_priv {
	regmap: *mut regmap,
	sysclk: core::ffi::c_uint,
	pcmclk: core::ffi::c_uint,

	voice_fmt: core::ffi::c_uint,
	hifi_fmt: core::ffi::c_uint,

	dai_func: core::ffi::c_int,
	charge_work: delayed_work,
};

macro_rules! wm8753_reset { (:expr) => { snd_soc_component_write(, WM8753_RESET, 0) } }

/*
 * WM8753 Controls
 */
static wm8753_base: [&str; 0] = ["Linear Control", "Adaptive Boost"];
static wm8753_base_filter: [&str; 0] =
	{"130Hz @ 48kHz", "200Hz @ 48kHz", "100Hz @ 16kHz", "400Hz @ 48kHz",
	"100Hz @ 8kHz", "200Hz @ 8kHz"};
static wm8753_treble: [&str; 0] = ["8kHz", "4kHz"];
static wm8753_alc_func: [&str; 0] = ["Off", "Right", "Left", "Stereo"];
static wm8753_ng_type: [&str; 0] = ["Constant PGA Gain", "Mute ADC Output"];
static wm8753_3d_func: [&str; 0] = ["Capture", "Playback"];
static wm8753_3d_uc: [&str; 0] = ["2.2kHz", "1.5kHz"];
static wm8753_3d_lc: [&str; 0] = ["200Hz", "500Hz"];
static wm8753_deemp: [&str; 0] = ["None", "32kHz", "44.1kHz", "48kHz"];
static wm8753_mono_mix: [&str; 0] = ["Stereo", "Left", "Right", "Mono"];
static wm8753_dac_phase: [&str; 0] = ["Non Inverted", "Inverted"];
static wm8753_line_mix: [&str; 0] = ["Line 1 + 2", "Line 1 - 2",
	"Line 1", "Line 2"];
static wm8753_mono_mux: [&str; 0] = ["Line Mix", "Rx Mix"];
static wm8753_right_mux: [&str; 0] = ["Line 2", "Rx Mix"];
static wm8753_left_mux: [&str; 0] = ["Line 1", "Rx Mix"];
static wm8753_rxmsel: [&str; 0] = ["RXP - RXN", "RXP + RXN", "RXP", "RXN"];
static wm8753_sidetone_mux: [&str; 0] = ["Left PGA", "Mic 1", "Mic 2",
	"Right PGA"];
static wm8753_mono2_src: [&str; 0] = ["Inverted Mono 1", "Left", "Right",
	"Left + Right"];
static wm8753_out3: [&str; 0] = ["VREF", "ROUT2", "Left + Right"];
static wm8753_out4: [&str; 0] = ["VREF", "Capture ST", "LOUT2"];
static wm8753_radcsel: [&str; 0] = ["PGA", "Line or RXP-RXN", "Sidetone"];
static wm8753_ladcsel: [&str; 0] = ["PGA", "Line or RXP-RXN", "Line"];
static wm8753_mono_adc: [&str; 0] = ["Stereo", "Analogue Mix Left",
	"Analogue Mix Right", "Digital Mono Mix"];
static wm8753_adc_hp: [&str; 0] = ["3.4Hz @ 48kHz", "82Hz @ 16k",
	"82Hz @ 8kHz", "170Hz @ 8kHz"];
static wm8753_adc_filter: [&str; 0] = ["HiFi", "Voice"];
static wm8753_mic_sel: [&str; 0] = ["Mic 1", "Mic 2", "Mic 3"];
static wm8753_dai_mode: [&str; 0] = ["DAI 0", "DAI 1", "DAI 2", "DAI 3"];
static wm8753_dat_sel: [&str; 0] = ["Stereo", "Left ADC", "Right ADC",
	"Channel Swap"];
static wm8753_rout2_phase: [&str; 0] = ["Non Inverted", "Inverted"];
...
static int wm8753_get_dai(snd_kcontrol *kcontrol,
...
static int wm8753_set_dai(snd_kcontrol *kcontrol,
	snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	struct wm8753_priv *wm8753 = snd_soc_component_get_drvdata(component);
...
SND_SOC_DAPM_PGA("Left Out 1", WM8753_PWR3, 8, 0, core::ptr::null_mut(), 0),
SND_SOC_DAPM_PGA("Left Out 2", WM8753_PWR3, 6, 0, core::ptr::null_mut(), 0),
...
SND_SOC_DAPM_PGA("Right Out 1", WM8753_PWR3, 7, 0, core::ptr::null_mut(), 0),
SND_SOC_DAPM_PGA("Right Out 2", WM8753_PWR3, 5, 0, core::ptr::null_mut(), 0),
...
SND_SOC_DAPM_PGA("Mono Out 1", WM8753_PWR3, 2, 0, core::ptr::null_mut(), 0),
SND_SOC_DAPM_PGA("Mono Out 2", WM8753_PWR3, 1, 0, core::ptr::null_mut(), 0),
SND_SOC_DAPM_DAC("Voice DAC", "Voice Playback", WM8753_PWR1, 4, 0),
SND_SOC_DAPM_OUTPUT("MONO1"),
SND_SOC_DAPM_MUX("Mono 2 Mux", SND_SOC_NOPM, 0, 0, &wm8753_mono2_controls),
SND_SOC_DAPM_OUTPUT("MONO2"),
SND_SOC_DAPM_MIXER("Out3 Left + Right", SND_SOC_NOPM, 0, 0, core::ptr::null_mut(), 0),
SND_SOC_DAPM_MUX("Out3 Mux", SND_SOC_NOPM, 0, 0, &wm8753_out3_controls),
SND_SOC_DAPM_PGA("Out 3", WM8753_PWR3, 4, 0, core::ptr::null_mut(), 0),
SND_SOC_DAPM_OUTPUT("OUT3"),
SND_SOC_DAPM_MUX("Out4 Mux", SND_SOC_NOPM, 0, 0, &wm8753_out4_controls),
SND_SOC_DAPM_PGA("Out 4", WM8753_PWR3, 3, 0, core::ptr::null_mut(), 0),
...
SND_SOC_DAPM_PGA("Left Capture Volume", WM8753_PWR2, 5, 0, core::ptr::null_mut(), 0),
SND_SOC_DAPM_PGA("Right Capture Volume", WM8753_PWR2, 4, 0, core::ptr::null_mut(), 0),
...
SND_SOC_DAPM_PGA("Mic 1 Volume", WM8753_PWR2, 8, 0, core::ptr::null_mut(), 0),
SND_SOC_DAPM_PGA("Mic 2 Volume", WM8753_PWR2, 7, 0, core::ptr::null_mut(), 0),
...
static const struct snd_soc_dapm_route wm8753_dapm_routes[] = [
	...
	/* left out */
	{"Left Out 1", core::ptr::null_mut(), "Left Mixer"},
	{"Left Out 2", core::ptr::null_mut(), "Left Mixer"},
	{"LOUT1", core::ptr::null_mut(), "Left Out 1"},
	{"LOUT2", core::ptr::null_mut(), "Left Out 2"},

	/* right out */
	{"Right Out 1", core::ptr::null_mut(), "Right Mixer"},
	{"Right Out 2", core::ptr::null_mut(), "Right Mixer"},
	{"ROUT1", core::ptr::null_mut(), "Right Out 1"},
	{"ROUT2", core::ptr::null_mut(), "Right Out 2"},

	/* mono 1 out */
	{"Mono Out 1", core::ptr::null_mut(), "Mono Mixer"},
	{"MONO1", core::ptr::null_mut(), "Mono Out 1"},
	...
	{"Mono Out 2", core::ptr::null_mut(), "Mono 2 Mux"},
	{"MONO2", core::ptr::null_mut(), "Mono Out 2"},

	/* out 3 */
	{"Out3 Left + Right", core::ptr::null_mut(), "Left Mixer"},
	{"Out3 Left + Right", core::ptr::null_mut(), "Right Mixer"},
	{"Out3 Mux", "VREF", "VREF"},
	{"Out3 Mux", "Left + Right", "Out3 Left + Right"},
	{"Out3 Mux", "ROUT2", "ROUT2"},
	{"Out 3", core::ptr::null_mut(), "Out3 Mux"},
	{"OUT3", core::ptr::null_mut(), "Out 3"},

	/* out 4 */
	{"Out4 Mux", "VREF", "VREF"},
	{"Out4 Mux", "Capture ST", "Playback Mixer"},
	{"Out4 Mux", "LOUT2", "LOUT2"},
	{"Out 4", core::ptr::null_mut(), "Out4 Mux"},
	{"OUT4", core::ptr::null_mut(), "Out 4"},
	...
	/* ADC */
	{"Left ADC", core::ptr::null_mut(), "Capture Left Mixer"},
	{"Right ADC", core::ptr::null_mut(), "Capture Right Mixer"},

	/* Left Capture Volume */
	{"Left Capture Volume", core::ptr::null_mut(), "ACIN"},

	/* Right Capture Volume */
	{"Right Capture Volume", core::ptr::null_mut(), "Mic 2 Volume"},
	...
	/* Mic 1 Volume */
	{"Mic 1 Volume", core::ptr::null_mut(), "MIC1N"},
	{"Mic 1 Volume", core::ptr::null_mut(), "Mic Selection Mux"},

	/* Mic 2 Volume */
	{"Mic 2 Volume", core::ptr::null_mut(), "MIC2N"},
	{"Mic 2 Volume", core::ptr::null_mut(), "MIC2"},
	...
	/* ACOP */
	{"ACOP", core::ptr::null_mut(), "ALC Mixer"},
];
...
pub const FIXED_PLL_SIZE: u32 = (1 << 22) * 10;

static void pll_factors(_pll_div *pll_div, target: core::ffi::c_uint,
	source: core::ffi::c_uint)
{
	u64 Kpart;
	core::ffi::c_uint K, Ndiv, Nmod;
	...
	if ((Ndiv < 6) || (Ndiv > 12))
		printk(c"\x014wm8753: unsupported N = %u\n".as_ptr(), Ndiv);

	pll_div.n = Ndiv;
	Nmod = target % source;
	Kpart = FIXED_PLL_SIZE * (core::ffi::c_longlong)Nmod;
...
static int wm8753_set_dai_pll(snd_soc_dai *codec_dai, int pll_id,
		int source, freq_in: core::ffi::c_uint, freq_out: core::ffi::c_uint)
{
	reg: u16, enable;
	int offset;
 ...
 */
static int wm8753_set_dai_sysclk(snd_soc_dai *codec_dai,
 ...
 */
static int wm8753_vdac_adc_set_dai_fmt(snd_soc_component *component,
		fmt: core::ffi::c_uint)
{
 ...
 */
static int wm8753_pcm_hw_params(snd_pcm_substream *substream,
 ...
 */
static int wm8753_pcm_set_dai_fmt(snd_soc_component *component,
		fmt: core::ffi::c_uint)
{
	voice: u16, ioctl;
...
static int wm8753_set_dai_clkdiv(snd_soc_dai *codec_dai,
		int div_id, int div)
{
	struct snd_soc_component *component = codec_dai.component;
	u16 reg;
 ...
 */
static int wm8753_hdac_set_dai_fmt(snd_soc_component *component,
		fmt: core::ffi::c_uint)
{
 ...
 */
static int wm8753_i2s_set_dai_fmt(snd_soc_component *component,
		fmt: core::ffi::c_uint)
{
	ioctl: u16, hifi;
 ...
 * Set PCM DAI bit size and sample rate.
 */
static int wm8753_i2s_hw_params(snd_pcm_substream *substream,
				snd_pcm_hw_params *params,
				snd_soc_dai *dai)
{
	struct snd_soc_component *component = dai.component;
	...
	if (coeff < 0) {
		printk(c"\x013wm8753 invalid MCLK or rate\n".as_ptr());
		return coeff;
	}
...
static int wm8753_mode1v_set_dai_fmt(snd_soc_component *component,
		fmt: core::ffi::c_uint)
{
	u16 clock;
...
static int wm8753_mode1h_set_dai_fmt(snd_soc_component *component,
		fmt: core::ffi::c_uint)
{
	return wm8753_hdac_set_dai_fmt(component, fmt);
}

static int wm8753_mode2_set_dai_fmt(snd_soc_component *component,
		fmt: core::ffi::c_uint)
{
	u16 clock;
...
static int wm8753_mode3_4_set_dai_fmt(snd_soc_component *component,
		fmt: core::ffi::c_uint)
{
	u16 clock;
...
static int wm8753_hifi_set_dai_fmt(snd_soc_dai *codec_dai,
		fmt: core::ffi::c_uint)
{
	struct snd_soc_component *component = codec_dai.component;
	struct wm8753_priv *wm8753 = snd_soc_component_get_drvdata(component);
...
static int wm8753_voice_set_dai_fmt(snd_soc_dai *codec_dai,
		fmt: core::ffi::c_uint)
{
	struct snd_soc_component *component = codec_dai.component;
	struct wm8753_priv *wm8753 = snd_soc_component_get_drvdata(component);
...
static int wm8753_mute(snd_soc_dai *dai, int mute, int direction)
{
	struct snd_soc_component *component = dai.component;
...
static void wm8753_charge_work(work_struct *work)
{
	struct wm8753_priv *wm8753 =
		container_of(work, wm8753_priv, charge_work.work);

	/* Set to 500k */
	regmap_update_bits(wm8753.regmap, WM8753_PWR1, 0x0180, 0x0100);
}

static int wm8753_set_bias_level(snd_soc_component *component,
...
static int wm8753_resume(snd_soc_component *component)
{
	struct wm8753_priv *wm8753 = snd_soc_component_get_drvdata(component);
...
static int wm8753_probe(snd_soc_component *component)
{
	struct wm8753_priv *wm8753 = snd_soc_component_get_drvdata(component);
	int ret;
...
static int wm8753_spi_probe(spi_device *spi)
{
	struct wm8753_priv *wm8753;
	int ret;

	wm8753 = devm_kzalloc(&spi.dev, sizeof(wm8753_priv),
			      GFP_KERNEL);
	if (wm8753 == core::ptr::null_mut())
		return -ENOMEM;
...
static int wm8753_i2c_probe(i2c_client *i2c)
{
	struct wm8753_priv *wm8753;
	int ret;

	wm8753 = devm_kzalloc(&i2c.dev, sizeof(wm8753_priv),
			      GFP_KERNEL);
	if (wm8753 == core::ptr::null_mut())
		return -ENOMEM;
...
static int __init wm8753_modinit(void)
{
	...
	if (ret != 0) {
		printk(c"\x013Failed to register wm8753 I2C driver: %d\n".as_ptr(),
		       ret);
	}
#endif
#if defined(CONFIG_SPI_MASTER)
	...
	if (ret != 0) {
		printk(c"\x013Failed to register wm8753 SPI driver: %d\n".as_ptr(),
		       ret);
	}
#endif
	return ret;
