...
pub static INIT_LIST: &[reg_sequence] = {
	{ 0x0000C000, 0x01},
	{ 0x0000F20D, 0x00},
	{ 0x0000F212, 0x3E},
	{ 0x0000C001, 0x02},
...
pub static RT1318_REG: &[reg_default] = {
	{ 0xc000, 0x00 },
	{ 0xc001, 0x43 },
	{ 0xc003, 0x22 },
	{ 0xc004, 0x44 },
...
pub unsafe extern "C" fn rt1318_volatile_register(dev: *mut device, reg: c_uint) -> bool
{
	switch (reg) {
	case 0xc000:
	case 0xc301:
...
pub unsafe extern "C" fn rt1318_readable_register(dev: *mut device, reg: c_uint) -> bool
{
	switch (reg) {
	case 0xc000 ... 0xc00f:
	case 0xc120 ... 0xc130:
...
pub unsafe extern "C" fn rt1318_dvol_put(*mut snd_kcontrolkcontrol,
...
pub unsafe extern "C" fn rt1318_dvol_get(*mut snd_kcontrolkcontrol,
		*mut snd_ctl_elem_valueucontrol)
{
	*mut snd_soc_componentcomponent = snd_kcontrol_chip(kcontrol);
	*mut rt1318_privrt1318 = snd_soc_component_get_drvdata(component);
...
static const struct snd_soc_dapm_widget rt1318_dapm_widgets[] = {
	...
	/* DACs */
	SND_SOC_DAPM_DAC_E("DAC", core::ptr::null_mut(), SND_SOC_NOPM, 0, 0,
...
pub unsafe extern "C" fn rt1318_probe(*mut snd_soc_componentcomponent)
{
	*mut rt1318_privrt1318 = snd_soc_component_get_drvdata(component);
...
pub unsafe extern "C" fn rt1318_remove(*mut snd_soc_componentcomponent)
{
	*mut rt1318_privrt1318 = snd_soc_component_get_drvdata(component);
...
#ifdef CONFIG_PM
pub unsafe extern "C" fn rt1318_suspend(*mut snd_soc_componentcomponent)
{
	*mut rt1318_privrt1318 = snd_soc_component_get_drvdata(component);
...
pub unsafe extern "C" fn rt1318_resume(*mut snd_soc_componentcomponent)
{
	*mut rt1318_privrt1318 = snd_soc_component_get_drvdata(component);
...
#else
#define rt1318_suspend core::ptr::null_mut()
#define rt1318_resume core::ptr::null_mut()
#endif
