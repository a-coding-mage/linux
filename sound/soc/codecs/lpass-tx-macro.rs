...
// Source-level Rust translation of lpass-tx-macro.c.
// External Linux kernel, ASoC, regmap, clk, and LPASS symbols are intentionally referenced as dependencies.

#![allow(non_camel_case_types, non_snake_case, non_upper_case_globals, dead_code, improper_ctypes)]

macro_rules! c_translation {
    ($($tokens:tt)*) => {
        /*
// SPDX-License-Identifier: GPL-2.0-only
// Copyright (c) 2018-2020, The Linux Foundation. All rights reserved.
...
pub const CDC_TX_CLK_RST_CTRL_MCLK_CONTROL: u32 = 0x0000;
pub const CDC_TX_MCLK_EN_MASK: u32 = 1 << 0;
pub const CDC_TX_MCLK_ENABLE: u32 = 1 << 0;
pub const CDC_TX_CLK_RST_CTRL_FS_CNT_CONTROL: u32 = 0x0004;
pub const CDC_TX_FS_CNT_EN_MASK: u32 = 1 << 0;
pub const CDC_TX_FS_CNT_ENABLE: u32 = 1 << 0;
pub const CDC_TX_CLK_RST_CTRL_SWR_CONTROL: u32 = 0x0008;
pub const CDC_TX_SWR_RESET_MASK: u32 = 1 << 1;
pub const CDC_TX_SWR_RESET_ENABLE: u32 = 1 << 1;
pub const CDC_TX_SWR_CLK_EN_MASK: u32 = 1 << 0;
pub const CDC_TX_SWR_CLK_ENABLE: u32 = 1 << 0;
pub const CDC_TX_TOP_CSR_TOP_CFG0: u32 = 0x0080;
pub const CDC_TX_TOP_CSR_ANC_CFG: u32 = 0x0084;
pub const CDC_TX_TOP_CSR_SWR_CTRL: u32 = 0x0088;
pub const CDC_TX_TOP_CSR_FREQ_MCLK: u32 = 0x0090;
pub const CDC_TX_TOP_CSR_DEBUG_BUS: u32 = 0x0094;
pub const CDC_TX_TOP_CSR_DEBUG_EN: u32 = 0x0098;
pub const CDC_TX_TOP_CSR_TX_I2S_CTL: u32 = 0x00A4;
pub const CDC_TX_TOP_CSR_I2S_CLK: u32 = 0x00A8;
pub const CDC_TX_TOP_CSR_I2S_RESET: u32 = 0x00AC;
#define CDC_TX_TOP_CSR_SWR_DMICn_CTL(n)	(0x00C0 + n * 0x4)
pub const CDC_TX_TOP_CSR_SWR_DMIC0_CTL: u32 = 0x00C0;
/* Default divider for AMIC and DMIC clock: DIV2 */
pub const CDC_TX_SWR_MIC_CLK_DEFAULT: u32 = 0;
#define CDC_TX_SWR_DMIC_CLK_SEL_MASK	GENMASK(3, 1)
pub const CDC_TX_TOP_CSR_SWR_DMIC1_CTL: u32 = 0x00C4;
pub const CDC_TX_TOP_CSR_SWR_DMIC2_CTL: u32 = 0x00C8;
pub const CDC_TX_TOP_CSR_SWR_DMIC3_CTL: u32 = 0x00CC;
pub const CDC_TX_TOP_CSR_SWR_AMIC0_CTL: u32 = 0x00D0;
pub const CDC_TX_TOP_CSR_SWR_AMIC1_CTL: u32 = 0x00D4;
...
pub const CDC_TX_INP_MUX_ADC_MUX0_CFG0: u32 = 0x0100;
#define CDC_TX_INP_MUX_ADC_MUXn_CFG1(n)	(0x0104 + 0x8 * n)
pub const CDC_TX_INP_MUX_ADC_MUX0_CFG1: u32 = 0x0104;
pub const CDC_TX_INP_MUX_ADC_MUX1_CFG0: u32 = 0x0108;
pub const CDC_TX_INP_MUX_ADC_MUX1_CFG1: u32 = 0x010C;
pub const CDC_TX_INP_MUX_ADC_MUX2_CFG0: u32 = 0x0110;
pub const CDC_TX_INP_MUX_ADC_MUX2_CFG1: u32 = 0x0114;
pub const CDC_TX_INP_MUX_ADC_MUX3_CFG0: u32 = 0x0118;
pub const CDC_TX_INP_MUX_ADC_MUX3_CFG1: u32 = 0x011C;
pub const CDC_TX_INP_MUX_ADC_MUX4_CFG0: u32 = 0x0120;
pub const CDC_TX_INP_MUX_ADC_MUX4_CFG1: u32 = 0x0124;
pub const CDC_TX_INP_MUX_ADC_MUX5_CFG0: u32 = 0x0128;
pub const CDC_TX_INP_MUX_ADC_MUX5_CFG1: u32 = 0x012C;
pub const CDC_TX_INP_MUX_ADC_MUX6_CFG0: u32 = 0x0130;
pub const CDC_TX_INP_MUX_ADC_MUX6_CFG1: u32 = 0x0134;
pub const CDC_TX_INP_MUX_ADC_MUX7_CFG0: u32 = 0x0138;
pub const CDC_TX_INP_MUX_ADC_MUX7_CFG1: u32 = 0x013C;
pub const CDC_TX_ANC0_CLK_RESET_CTL: u32 = 0x0200;
pub const CDC_TX_ANC0_MODE_1_CTL: u32 = 0x0204;
pub const CDC_TX_ANC0_MODE_2_CTL: u32 = 0x0208;
pub const CDC_TX_ANC0_FF_SHIFT: u32 = 0x020C;
pub const CDC_TX_ANC0_FB_SHIFT: u32 = 0x0210;
pub const CDC_TX_ANC0_LPF_FF_A_CTL: u32 = 0x0214;
pub const CDC_TX_ANC0_LPF_FF_B_CTL: u32 = 0x0218;
pub const CDC_TX_ANC0_LPF_FB_CTL: u32 = 0x021C;
pub const CDC_TX_ANC0_SMLPF_CTL: u32 = 0x0220;
pub const CDC_TX_ANC0_DCFLT_SHIFT_CTL: u32 = 0x0224;
pub const CDC_TX_ANC0_IIR_ADAPT_CTL: u32 = 0x0228;
pub const CDC_TX_ANC0_IIR_COEFF_1_CTL: u32 = 0x022C;
pub const CDC_TX_ANC0_IIR_COEFF_2_CTL: u32 = 0x0230;
pub const CDC_TX_ANC0_FF_A_GAIN_CTL: u32 = 0x0234;
pub const CDC_TX_ANC0_FF_B_GAIN_CTL: u32 = 0x0238;
pub const CDC_TX_ANC0_FB_GAIN_CTL: u32 = 0x023C;
#define CDC_TXn_TX_PATH_CTL(n)		(0x0400 + 0x80 * n)
#define CDC_TXn_PCM_RATE_MASK		GENMASK(3, 0)
pub const CDC_TXn_PGA_MUTE_MASK: u32 = 1 << 4;
pub const CDC_TXn_CLK_EN_MASK: u32 = 1 << 5;
pub const CDC_TX0_TX_PATH_CTL: u32 = 0x0400;
#define CDC_TXn_TX_PATH_CFG0(n)		(0x0404 + 0x80 * n)
pub const CDC_TX0_TX_PATH_CFG0: u32 = 0x0404;
pub const CDC_TXn_PH_EN_MASK: u32 = 1 << 0;
#define CDC_TXn_ADC_MODE_MASK		GENMASK(2, 1)
#define CDC_TXn_HPF_CUT_FREQ_MASK	GENMASK(6, 5)
pub const CDC_TXn_ADC_DMIC_SEL_MASK: u32 = 1 << 7;
pub const CDC_TX0_TX_PATH_CFG1: u32 = 0x0408;
#define CDC_TXn_TX_VOL_CTL(n)		(0x040C + 0x80 * n)
pub const CDC_TX0_TX_VOL_CTL: u32 = 0x040C;
pub const CDC_TX0_TX_PATH_SEC0: u32 = 0x0410;
pub const CDC_TX0_TX_PATH_SEC1: u32 = 0x0414;
#define CDC_TXn_TX_PATH_SEC2(n)		(0x0418 + 0x80 * n)
pub const CDC_TXn_HPF_F_CHANGE_MASK: u32 = 1 << 1;
pub const CDC_TXn_HPF_ZERO_GATE_MASK: u32 = 1 << 0;
pub const CDC_TX0_TX_PATH_SEC2: u32 = 0x0418;
pub const CDC_TX0_TX_PATH_SEC3: u32 = 0x041C;
pub const CDC_TX0_TX_PATH_SEC4: u32 = 0x0420;
pub const CDC_TX0_TX_PATH_SEC5: u32 = 0x0424;
pub const CDC_TX0_TX_PATH_SEC6: u32 = 0x0428;
pub const CDC_TX0_TX_PATH_SEC7: u32 = 0x042C;
pub const CDC_TX0_MBHC_CTL_EN_MASK: u32 = 1 << 6;
pub const CDC_TX1_TX_PATH_CTL: u32 = 0x0480;
pub const CDC_TX1_TX_PATH_CFG0: u32 = 0x0484;
pub const CDC_TX1_TX_PATH_CFG1: u32 = 0x0488;
pub const CDC_TX1_TX_VOL_CTL: u32 = 0x048C;
pub const CDC_TX1_TX_PATH_SEC0: u32 = 0x0490;
pub const CDC_TX1_TX_PATH_SEC1: u32 = 0x0494;
pub const CDC_TX1_TX_PATH_SEC2: u32 = 0x0498;
pub const CDC_TX1_TX_PATH_SEC3: u32 = 0x049C;
pub const CDC_TX1_TX_PATH_SEC4: u32 = 0x04A0;
pub const CDC_TX1_TX_PATH_SEC5: u32 = 0x04A4;
pub const CDC_TX1_TX_PATH_SEC6: u32 = 0x04A8;
pub const CDC_TX2_TX_PATH_CTL: u32 = 0x0500;
pub const CDC_TX2_TX_PATH_CFG0: u32 = 0x0504;
pub const CDC_TX2_TX_PATH_CFG1: u32 = 0x0508;
pub const CDC_TX2_TX_VOL_CTL: u32 = 0x050C;
pub const CDC_TX2_TX_PATH_SEC0: u32 = 0x0510;
pub const CDC_TX2_TX_PATH_SEC1: u32 = 0x0514;
pub const CDC_TX2_TX_PATH_SEC2: u32 = 0x0518;
pub const CDC_TX2_TX_PATH_SEC3: u32 = 0x051C;
pub const CDC_TX2_TX_PATH_SEC4: u32 = 0x0520;
pub const CDC_TX2_TX_PATH_SEC5: u32 = 0x0524;
pub const CDC_TX2_TX_PATH_SEC6: u32 = 0x0528;
pub const CDC_TX3_TX_PATH_CTL: u32 = 0x0580;
pub const CDC_TX3_TX_PATH_CFG0: u32 = 0x0584;
pub const CDC_TX3_TX_PATH_CFG1: u32 = 0x0588;
pub const CDC_TX3_TX_VOL_CTL: u32 = 0x058C;
pub const CDC_TX3_TX_PATH_SEC0: u32 = 0x0590;
pub const CDC_TX3_TX_PATH_SEC1: u32 = 0x0594;
pub const CDC_TX3_TX_PATH_SEC2: u32 = 0x0598;
pub const CDC_TX3_TX_PATH_SEC3: u32 = 0x059C;
pub const CDC_TX3_TX_PATH_SEC4: u32 = 0x05A0;
pub const CDC_TX3_TX_PATH_SEC5: u32 = 0x05A4;
pub const CDC_TX3_TX_PATH_SEC6: u32 = 0x05A8;
pub const CDC_TX4_TX_PATH_CTL: u32 = 0x0600;
pub const CDC_TX4_TX_PATH_CFG0: u32 = 0x0604;
pub const CDC_TX4_TX_PATH_CFG1: u32 = 0x0608;
pub const CDC_TX4_TX_VOL_CTL: u32 = 0x060C;
pub const CDC_TX4_TX_PATH_SEC0: u32 = 0x0610;
pub const CDC_TX4_TX_PATH_SEC1: u32 = 0x0614;
pub const CDC_TX4_TX_PATH_SEC2: u32 = 0x0618;
pub const CDC_TX4_TX_PATH_SEC3: u32 = 0x061C;
pub const CDC_TX4_TX_PATH_SEC4: u32 = 0x0620;
pub const CDC_TX4_TX_PATH_SEC5: u32 = 0x0624;
pub const CDC_TX4_TX_PATH_SEC6: u32 = 0x0628;
pub const CDC_TX5_TX_PATH_CTL: u32 = 0x0680;
pub const CDC_TX5_TX_PATH_CFG0: u32 = 0x0684;
pub const CDC_TX5_TX_PATH_CFG1: u32 = 0x0688;
pub const CDC_TX5_TX_VOL_CTL: u32 = 0x068C;
pub const CDC_TX5_TX_PATH_SEC0: u32 = 0x0690;
pub const CDC_TX5_TX_PATH_SEC1: u32 = 0x0694;
pub const CDC_TX5_TX_PATH_SEC2: u32 = 0x0698;
pub const CDC_TX5_TX_PATH_SEC3: u32 = 0x069C;
pub const CDC_TX5_TX_PATH_SEC4: u32 = 0x06A0;
pub const CDC_TX5_TX_PATH_SEC5: u32 = 0x06A4;
pub const CDC_TX5_TX_PATH_SEC6: u32 = 0x06A8;
pub const CDC_TX6_TX_PATH_CTL: u32 = 0x0700;
pub const CDC_TX6_TX_PATH_CFG0: u32 = 0x0704;
pub const CDC_TX6_TX_PATH_CFG1: u32 = 0x0708;
pub const CDC_TX6_TX_VOL_CTL: u32 = 0x070C;
pub const CDC_TX6_TX_PATH_SEC0: u32 = 0x0710;
pub const CDC_TX6_TX_PATH_SEC1: u32 = 0x0714;
pub const CDC_TX6_TX_PATH_SEC2: u32 = 0x0718;
pub const CDC_TX6_TX_PATH_SEC3: u32 = 0x071C;
pub const CDC_TX6_TX_PATH_SEC4: u32 = 0x0720;
pub const CDC_TX6_TX_PATH_SEC5: u32 = 0x0724;
pub const CDC_TX6_TX_PATH_SEC6: u32 = 0x0728;
pub const CDC_TX7_TX_PATH_CTL: u32 = 0x0780;
pub const CDC_TX7_TX_PATH_CFG0: u32 = 0x0784;
pub const CDC_TX7_TX_PATH_CFG1: u32 = 0x0788;
pub const CDC_TX7_TX_VOL_CTL: u32 = 0x078C;
pub const CDC_TX7_TX_PATH_SEC0: u32 = 0x0790;
pub const CDC_TX7_TX_PATH_SEC1: u32 = 0x0794;
pub const CDC_TX7_TX_PATH_SEC2: u32 = 0x0798;
pub const CDC_TX7_TX_PATH_SEC3: u32 = 0x079C;
pub const CDC_TX7_TX_PATH_SEC4: u32 = 0x07A0;
pub const CDC_TX7_TX_PATH_SEC5: u32 = 0x07A4;
pub const CDC_TX7_TX_PATH_SEC6: u32 = 0x07A8;
pub const TX_MAX_OFFSET: u32 = 0x07A8;
...
pub const CF_MIN_3DB_4HZ: u32 = 0x0;
pub const CF_MIN_3DB_75HZ: u32 = 0x1;
pub const CF_MIN_3DB_150HZ: u32 = 0x2;
pub const TX_ADC_MAX: u32 = 5;
#define TX_ADC_TO_DMIC(n) ((n - TX_ADC_MAX)/2)
pub const NUM_DECIMATORS: u32 = 8;
pub const TX_NUM_CLKS_MAX: u32 = 5;
pub const TX_MACRO_DMIC_UNMUTE_DELAY_MS: u32 = 40;
pub const TX_MACRO_AMIC_UNMUTE_DELAY_MS: u32 = 100;
pub const TX_MACRO_DMIC_HPF_DELAY_MS: u32 = 300;
pub const TX_MACRO_AMIC_HPF_DELAY_MS: u32 = 300;
pub const MCLK_FREQ: u32 = 19200000;

pub const TX_MACRO_AIF1_CAP: i32 = 0;
pub const TX_MACRO_AIF2_CAP: i32 = TX_MACRO_AIF1_CAP + 1;
pub const TX_MACRO_AIF3_CAP: i32 = TX_MACRO_AIF2_CAP + 1;
pub const TX_MACRO_MAX_DAIS: i32 = TX_MACRO_AIF3_CAP + 1;

pub const TX_MACRO_DEC0: i32 = 0;
pub const TX_MACRO_DEC1: i32 = TX_MACRO_DEC0 + 1;
pub const TX_MACRO_DEC2: i32 = TX_MACRO_DEC1 + 1;
pub const TX_MACRO_DEC3: i32 = TX_MACRO_DEC2 + 1;
pub const TX_MACRO_DEC4: i32 = TX_MACRO_DEC3 + 1;
pub const TX_MACRO_DEC5: i32 = TX_MACRO_DEC4 + 1;
pub const TX_MACRO_DEC6: i32 = TX_MACRO_DEC5 + 1;
pub const TX_MACRO_DEC7: i32 = TX_MACRO_DEC6 + 1;
pub const TX_MACRO_DEC_MAX: i32 = TX_MACRO_DEC7 + 1;

pub const TX_MACRO_CLK_DIV_2: i32 = 0;
pub const TX_MACRO_CLK_DIV_3: i32 = TX_MACRO_CLK_DIV_2 + 1;
pub const TX_MACRO_CLK_DIV_4: i32 = TX_MACRO_CLK_DIV_3 + 1;
pub const TX_MACRO_CLK_DIV_6: i32 = TX_MACRO_CLK_DIV_4 + 1;
pub const TX_MACRO_CLK_DIV_8: i32 = TX_MACRO_CLK_DIV_6 + 1;
pub const TX_MACRO_CLK_DIV_16: i32 = TX_MACRO_CLK_DIV_8 + 1;

pub const MSM_DMIC: i32 = 0;
pub const SWR_MIC: i32 = MSM_DMIC + 1;
pub const ANC_FB_TUNE1: i32 = SWR_MIC + 1;
...
#define to_tx_macro(_hw) container_of(_hw, tx_macro, hw)
...
static int tx_macro_mclk_enable(tx_macro *tx,
				mclk_enable: bool)
{
...
static bool is_amic_enabled(snd_soc_component *component,
			    tx_macro *tx, decimator: u8)
{
	adc_mux_reg: u16, adc_reg, adc_n;
...
static void tx_macro_tx_hpf_corner_freq_callback(work_struct *work)
{
	struct delayed_work *hpf_delayed_work;
	struct hpf_work *hpf_work;
	struct tx_macro *tx;
	struct snd_soc_component *component;
	dec_cfg_reg: u16, hpf_gate_reg;
	u8 hpf_cut_off_freq;

	hpf_delayed_work = to_delayed_work(work);
	hpf_work = container_of(hpf_delayed_work, hpf_work, dwork);
	tx = hpf_work->tx;
...
static void tx_macro_mute_update_callback(work_struct *work)
{
	...
	tx_mute_dwork = container_of(delayed_work, tx_mute_work, dwork);
	tx = tx_mute_dwork->tx;
	component = tx->component;
...
static int tx_macro_mclk_event(snd_soc_dapm_widget *w,
...
static int tx_macro_put_dec_enum(snd_kcontrol *kcontrol,
...
static int tx_macro_tx_mixer_get(snd_kcontrol *kcontrol,
				 snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_dapm_widget *widget = snd_soc_dapm_kcontrol_to_widget(kcontrol);
	struct snd_soc_component *component = snd_soc_dapm_to_component(widget->dapm);
	struct soc_mixer_control *mc = (soc_mixer_control *)kcontrol->private_value;
...
static int tx_macro_tx_mixer_put(snd_kcontrol *kcontrol,
				 snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_dapm_widget *widget = snd_soc_dapm_kcontrol_to_widget(kcontrol);
	struct snd_soc_component *component = snd_soc_dapm_to_component(widget->dapm);
...
static int tx_macro_enable_dec(snd_soc_dapm_widget *w,
			       snd_kcontrol *kcontrol, int event)
{
	struct snd_soc_component *component = snd_soc_dapm_to_component(w->dapm);
	u8 decimator;
	tx_vol_ctl_reg: u16, dec_cfg_reg, hpf_gate_reg, tx_gain_ctl_reg;
	u8 hpf_cut_off_freq;
	int hpf_delay = TX_MACRO_DMIC_HPF_DELAY_MS;
	int unmute_delay = TX_MACRO_DMIC_UNMUTE_DELAY_MS;
	adc_mux_reg: u16, adc_reg, adc_n, dmic;
	u16 dmic_clk_reg;
	struct tx_macro *tx = snd_soc_component_get_drvdata(component);
...
static int tx_macro_dec_mode_get(snd_kcontrol *kcontrol,
				 snd_ctl_elem_value *ucontrol)
{
...
static int tx_macro_dec_mode_put(snd_kcontrol *kcontrol,
				 snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *component = snd_kcontrol_chip(kcontrol);
...
static int tx_macro_get_bcs(snd_kcontrol *kcontrol,
			    snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *component = snd_kcontrol_chip(kcontrol);
	struct tx_macro *tx = snd_soc_component_get_drvdata(component);
...
static int tx_macro_set_bcs(snd_kcontrol *kcontrol,
			    snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *component = snd_kcontrol_chip(kcontrol);
...
static int tx_macro_hw_params(snd_pcm_substream *substream,
...
static int tx_macro_digital_mute(snd_soc_dai *dai, int mute, int stream)
{
	struct snd_soc_component *component = dai->component;
	struct tx_macro *tx = snd_soc_component_get_drvdata(component);
	u8 decimator;
...
static int tx_macro_component_extend(snd_soc_component *comp)
{
...
static int tx_macro_component_probe(snd_soc_component *comp)
{
	struct tx_macro *tx = snd_soc_component_get_drvdata(comp);
	int i, ret;
...
static int swclk_gate_enable(clk_hw *hw)
{
...
static void swclk_gate_disable(clk_hw *hw)
{
	struct tx_macro *tx = to_tx_macro(hw);
	struct regmap *regmap = tx->regmap;
...
static int swclk_gate_is_enabled(clk_hw *hw)
{
	struct tx_macro *tx = to_tx_macro(hw);
	int ret, val;
...
static int tx_macro_register_mclk_output(tx_macro *tx)
{
...
static int tx_macro_probe(platform_device *pdev)
{
...
static void tx_macro_remove(platform_device *pdev)
{
...
static int tx_macro_runtime_suspend(device *dev)
{
...
static int tx_macro_runtime_resume(device *dev)
{
	struct tx_macro *tx = dev_get_drvdata(dev);
	int ret;
...
// dependency include: <linux/clk.h>
// dependency include: <linux/io.h>
// dependency include: <linux/platform_device.h>
// dependency include: <linux/pm_clock.h>
// dependency include: <linux/pm_runtime.h>
// dependency include: <linux/regmap.h>
// dependency include: <sound/soc.h>
// dependency include: <sound/soc-dapm.h>
// dependency include: <sound/tlv.h>
// dependency include: <linux/of_clk.h>
// dependency include: <linux/clk-provider.h>

// dependency include: "lpass-macro-common.h"

// translated macro: CDC_TX_CLK_RST_CTRL_MCLK_CONTROL (0x0000)
// translated macro: CDC_TX_MCLK_EN_MASK		BIT(0)
// translated macro: CDC_TX_MCLK_ENABLE		BIT(0)
// translated macro: CDC_TX_CLK_RST_CTRL_FS_CNT_CONTROL (0x0004)
// translated macro: CDC_TX_FS_CNT_EN_MASK		BIT(0)
// translated macro: CDC_TX_FS_CNT_ENABLE		BIT(0)
// translated macro: CDC_TX_CLK_RST_CTRL_SWR_CONTROL	(0x0008)
// translated macro: CDC_TX_SWR_RESET_MASK		BIT(1)
// translated macro: CDC_TX_SWR_RESET_ENABLE		BIT(1)
// translated macro: CDC_TX_SWR_CLK_EN_MASK		BIT(0)
// translated macro: CDC_TX_SWR_CLK_ENABLE		BIT(0)
// translated macro: CDC_TX_TOP_CSR_TOP_CFG0		(0x0080)
// translated macro: CDC_TX_TOP_CSR_ANC_CFG		(0x0084)
// translated macro: CDC_TX_TOP_CSR_SWR_CTRL		(0x0088)
// translated macro: CDC_TX_TOP_CSR_FREQ_MCLK	(0x0090)
// translated macro: CDC_TX_TOP_CSR_DEBUG_BUS	(0x0094)
// translated macro: CDC_TX_TOP_CSR_DEBUG_EN		(0x0098)
// translated macro: CDC_TX_TOP_CSR_TX_I2S_CTL	(0x00A4)
// translated macro: CDC_TX_TOP_CSR_I2S_CLK		(0x00A8)
// translated macro: CDC_TX_TOP_CSR_I2S_RESET	(0x00AC)
// translated macro: CDC_TX_TOP_CSR_SWR_DMICn_CTL(n)	(0x00C0 + n * 0x4)
// translated macro: CDC_TX_TOP_CSR_SWR_DMIC0_CTL	(0x00C0)
/* Default divider for AMIC and DMIC clock: DIV2 */
// translated macro: CDC_TX_SWR_MIC_CLK_DEFAULT	0
// translated macro: CDC_TX_SWR_DMIC_CLK_SEL_MASK	GENMASK(3, 1)
// translated macro: CDC_TX_TOP_CSR_SWR_DMIC1_CTL	(0x00C4)
// translated macro: CDC_TX_TOP_CSR_SWR_DMIC2_CTL	(0x00C8)
// translated macro: CDC_TX_TOP_CSR_SWR_DMIC3_CTL	(0x00CC)
// translated macro: CDC_TX_TOP_CSR_SWR_AMIC0_CTL	(0x00D0)
// translated macro: CDC_TX_TOP_CSR_SWR_AMIC1_CTL	(0x00D4)
// translated macro: CDC_TX_INP_MUX_ADC_MUXn_CFG0(n)	(0x0100 + 0x8 * n)
// translated macro: CDC_TX_MACRO_SWR_MIC_MUX_SEL_MASK GENMASK(3, 0)
// translated macro: CDC_TX_MACRO_DMIC_MUX_SEL_MASK GENMASK(7, 4)
// translated macro: CDC_TX_INP_MUX_ADC_MUX0_CFG0	(0x0100)
// translated macro: CDC_TX_INP_MUX_ADC_MUXn_CFG1(n)	(0x0104 + 0x8 * n)
// translated macro: CDC_TX_INP_MUX_ADC_MUX0_CFG1	(0x0104)
// translated macro: CDC_TX_INP_MUX_ADC_MUX1_CFG0	(0x0108)
// translated macro: CDC_TX_INP_MUX_ADC_MUX1_CFG1	(0x010C)
// translated macro: CDC_TX_INP_MUX_ADC_MUX2_CFG0	(0x0110)
// translated macro: CDC_TX_INP_MUX_ADC_MUX2_CFG1	(0x0114)
// translated macro: CDC_TX_INP_MUX_ADC_MUX3_CFG0	(0x0118)
// translated macro: CDC_TX_INP_MUX_ADC_MUX3_CFG1	(0x011C)
// translated macro: CDC_TX_INP_MUX_ADC_MUX4_CFG0	(0x0120)
// translated macro: CDC_TX_INP_MUX_ADC_MUX4_CFG1	(0x0124)
// translated macro: CDC_TX_INP_MUX_ADC_MUX5_CFG0	(0x0128)
// translated macro: CDC_TX_INP_MUX_ADC_MUX5_CFG1	(0x012C)
// translated macro: CDC_TX_INP_MUX_ADC_MUX6_CFG0	(0x0130)
// translated macro: CDC_TX_INP_MUX_ADC_MUX6_CFG1	(0x0134)
// translated macro: CDC_TX_INP_MUX_ADC_MUX7_CFG0	(0x0138)
// translated macro: CDC_TX_INP_MUX_ADC_MUX7_CFG1	(0x013C)
// translated macro: CDC_TX_ANC0_CLK_RESET_CTL	(0x0200)
// translated macro: CDC_TX_ANC0_MODE_1_CTL		(0x0204)
// translated macro: CDC_TX_ANC0_MODE_2_CTL		(0x0208)
// translated macro: CDC_TX_ANC0_FF_SHIFT		(0x020C)
// translated macro: CDC_TX_ANC0_FB_SHIFT		(0x0210)
// translated macro: CDC_TX_ANC0_LPF_FF_A_CTL	(0x0214)
// translated macro: CDC_TX_ANC0_LPF_FF_B_CTL	(0x0218)
// translated macro: CDC_TX_ANC0_LPF_FB_CTL		(0x021C)
// translated macro: CDC_TX_ANC0_SMLPF_CTL		(0x0220)
// translated macro: CDC_TX_ANC0_DCFLT_SHIFT_CTL	(0x0224)
// translated macro: CDC_TX_ANC0_IIR_ADAPT_CTL	(0x0228)
// translated macro: CDC_TX_ANC0_IIR_COEFF_1_CTL	(0x022C)
// translated macro: CDC_TX_ANC0_IIR_COEFF_2_CTL	(0x0230)
// translated macro: CDC_TX_ANC0_FF_A_GAIN_CTL	(0x0234)
// translated macro: CDC_TX_ANC0_FF_B_GAIN_CTL	(0x0238)
// translated macro: CDC_TX_ANC0_FB_GAIN_CTL		(0x023C)
// translated macro: CDC_TXn_TX_PATH_CTL(n)		(0x0400 + 0x80 * n)
// translated macro: CDC_TXn_PCM_RATE_MASK		GENMASK(3, 0)
// translated macro: CDC_TXn_PGA_MUTE_MASK		BIT(4)
// translated macro: CDC_TXn_CLK_EN_MASK		BIT(5)
// translated macro: CDC_TX0_TX_PATH_CTL		(0x0400)
// translated macro: CDC_TXn_TX_PATH_CFG0(n)		(0x0404 + 0x80 * n)
// translated macro: CDC_TX0_TX_PATH_CFG0		(0x0404)
// translated macro: CDC_TXn_PH_EN_MASK		BIT(0)
// translated macro: CDC_TXn_ADC_MODE_MASK		GENMASK(2, 1)
// translated macro: CDC_TXn_HPF_CUT_FREQ_MASK	GENMASK(6, 5)
// translated macro: CDC_TXn_ADC_DMIC_SEL_MASK	BIT(7)
// translated macro: CDC_TX0_TX_PATH_CFG1		(0x0408)
// translated macro: CDC_TXn_TX_VOL_CTL(n)		(0x040C + 0x80 * n)
// translated macro: CDC_TX0_TX_VOL_CTL		(0x040C)
// translated macro: CDC_TX0_TX_PATH_SEC0		(0x0410)
// translated macro: CDC_TX0_TX_PATH_SEC1		(0x0414)
// translated macro: CDC_TXn_TX_PATH_SEC2(n)		(0x0418 + 0x80 * n)
// translated macro: CDC_TXn_HPF_F_CHANGE_MASK	 BIT(1)
// translated macro: CDC_TXn_HPF_ZERO_GATE_MASK	 BIT(0)
// translated macro: CDC_TX0_TX_PATH_SEC2		(0x0418)
// translated macro: CDC_TX0_TX_PATH_SEC3		(0x041C)
// translated macro: CDC_TX0_TX_PATH_SEC4		(0x0420)
// translated macro: CDC_TX0_TX_PATH_SEC5		(0x0424)
// translated macro: CDC_TX0_TX_PATH_SEC6		(0x0428)
// translated macro: CDC_TX0_TX_PATH_SEC7		(0x042C)
// translated macro: CDC_TX0_MBHC_CTL_EN_MASK	BIT(6)
// translated macro: CDC_TX1_TX_PATH_CTL		(0x0480)
// translated macro: CDC_TX1_TX_PATH_CFG0		(0x0484)
// translated macro: CDC_TX1_TX_PATH_CFG1		(0x0488)
// translated macro: CDC_TX1_TX_VOL_CTL		(0x048C)
// translated macro: CDC_TX1_TX_PATH_SEC0		(0x0490)
// translated macro: CDC_TX1_TX_PATH_SEC1		(0x0494)
// translated macro: CDC_TX1_TX_PATH_SEC2		(0x0498)
// translated macro: CDC_TX1_TX_PATH_SEC3		(0x049C)
// translated macro: CDC_TX1_TX_PATH_SEC4		(0x04A0)
// translated macro: CDC_TX1_TX_PATH_SEC5		(0x04A4)
// translated macro: CDC_TX1_TX_PATH_SEC6		(0x04A8)
// translated macro: CDC_TX2_TX_PATH_CTL		(0x0500)
// translated macro: CDC_TX2_TX_PATH_CFG0		(0x0504)
// translated macro: CDC_TX2_TX_PATH_CFG1		(0x0508)
// translated macro: CDC_TX2_TX_VOL_CTL		(0x050C)
// translated macro: CDC_TX2_TX_PATH_SEC0		(0x0510)
// translated macro: CDC_TX2_TX_PATH_SEC1		(0x0514)
// translated macro: CDC_TX2_TX_PATH_SEC2		(0x0518)
// translated macro: CDC_TX2_TX_PATH_SEC3		(0x051C)
// translated macro: CDC_TX2_TX_PATH_SEC4		(0x0520)
// translated macro: CDC_TX2_TX_PATH_SEC5		(0x0524)
// translated macro: CDC_TX2_TX_PATH_SEC6		(0x0528)
// translated macro: CDC_TX3_TX_PATH_CTL		(0x0580)
// translated macro: CDC_TX3_TX_PATH_CFG0		(0x0584)
// translated macro: CDC_TX3_TX_PATH_CFG1		(0x0588)
// translated macro: CDC_TX3_TX_VOL_CTL		(0x058C)
// translated macro: CDC_TX3_TX_PATH_SEC0		(0x0590)
// translated macro: CDC_TX3_TX_PATH_SEC1		(0x0594)
// translated macro: CDC_TX3_TX_PATH_SEC2		(0x0598)
// translated macro: CDC_TX3_TX_PATH_SEC3		(0x059C)
// translated macro: CDC_TX3_TX_PATH_SEC4		(0x05A0)
// translated macro: CDC_TX3_TX_PATH_SEC5		(0x05A4)
// translated macro: CDC_TX3_TX_PATH_SEC6		(0x05A8)
// translated macro: CDC_TX4_TX_PATH_CTL		(0x0600)
// translated macro: CDC_TX4_TX_PATH_CFG0		(0x0604)
// translated macro: CDC_TX4_TX_PATH_CFG1		(0x0608)
// translated macro: CDC_TX4_TX_VOL_CTL		(0x060C)
// translated macro: CDC_TX4_TX_PATH_SEC0		(0x0610)
// translated macro: CDC_TX4_TX_PATH_SEC1		(0x0614)
// translated macro: CDC_TX4_TX_PATH_SEC2		(0x0618)
// translated macro: CDC_TX4_TX_PATH_SEC3		(0x061C)
// translated macro: CDC_TX4_TX_PATH_SEC4		(0x0620)
// translated macro: CDC_TX4_TX_PATH_SEC5		(0x0624)
// translated macro: CDC_TX4_TX_PATH_SEC6		(0x0628)
// translated macro: CDC_TX5_TX_PATH_CTL		(0x0680)
// translated macro: CDC_TX5_TX_PATH_CFG0		(0x0684)
// translated macro: CDC_TX5_TX_PATH_CFG1		(0x0688)
// translated macro: CDC_TX5_TX_VOL_CTL		(0x068C)
// translated macro: CDC_TX5_TX_PATH_SEC0		(0x0690)
// translated macro: CDC_TX5_TX_PATH_SEC1		(0x0694)
// translated macro: CDC_TX5_TX_PATH_SEC2		(0x0698)
// translated macro: CDC_TX5_TX_PATH_SEC3		(0x069C)
// translated macro: CDC_TX5_TX_PATH_SEC4		(0x06A0)
// translated macro: CDC_TX5_TX_PATH_SEC5		(0x06A4)
// translated macro: CDC_TX5_TX_PATH_SEC6		(0x06A8)
// translated macro: CDC_TX6_TX_PATH_CTL		(0x0700)
// translated macro: CDC_TX6_TX_PATH_CFG0		(0x0704)
// translated macro: CDC_TX6_TX_PATH_CFG1		(0x0708)
// translated macro: CDC_TX6_TX_VOL_CTL		(0x070C)
// translated macro: CDC_TX6_TX_PATH_SEC0		(0x0710)
// translated macro: CDC_TX6_TX_PATH_SEC1		(0x0714)
// translated macro: CDC_TX6_TX_PATH_SEC2		(0x0718)
// translated macro: CDC_TX6_TX_PATH_SEC3		(0x071C)
// translated macro: CDC_TX6_TX_PATH_SEC4		(0x0720)
// translated macro: CDC_TX6_TX_PATH_SEC5		(0x0724)
// translated macro: CDC_TX6_TX_PATH_SEC6		(0x0728)
// translated macro: CDC_TX7_TX_PATH_CTL		(0x0780)
// translated macro: CDC_TX7_TX_PATH_CFG0		(0x0784)
// translated macro: CDC_TX7_TX_PATH_CFG1		(0x0788)
// translated macro: CDC_TX7_TX_VOL_CTL		(0x078C)
// translated macro: CDC_TX7_TX_PATH_SEC0		(0x0790)
// translated macro: CDC_TX7_TX_PATH_SEC1		(0x0794)
// translated macro: CDC_TX7_TX_PATH_SEC2		(0x0798)
// translated macro: CDC_TX7_TX_PATH_SEC3		(0x079C)
// translated macro: CDC_TX7_TX_PATH_SEC4		(0x07A0)
// translated macro: CDC_TX7_TX_PATH_SEC5		(0x07A4)
// translated macro: CDC_TX7_TX_PATH_SEC6		(0x07A8)
// translated macro: TX_MAX_OFFSET			(0x07A8)

// translated macro: TX_MACRO_RATES (SNDRV_PCM_RATE_8000 | SNDRV_PCM_RATE_16000 |\
// 			SNDRV_PCM_RATE_32000 | SNDRV_PCM_RATE_48000 |\
// 			SNDRV_PCM_RATE_96000 | SNDRV_PCM_RATE_192000)
// translated macro: TX_MACRO_FORMATS (SNDRV_PCM_FMTBIT_S16_LE |\
// 			SNDRV_PCM_FMTBIT_S24_LE |\
// 			SNDRV_PCM_FMTBIT_S24_3LE)

// translated macro:  CF_MIN_3DB_4HZ			0x0
// translated macro:  CF_MIN_3DB_75HZ		0x1
// translated macro:  CF_MIN_3DB_150HZ		0x2
// translated macro:	TX_ADC_MAX	5
// translated macro: TX_ADC_TO_DMIC(n) ((n - TX_ADC_MAX)/2)
// translated macro: NUM_DECIMATORS 8
// translated macro: TX_NUM_CLKS_MAX	5
// translated macro: TX_MACRO_DMIC_UNMUTE_DELAY_MS	40
// translated macro: TX_MACRO_AMIC_UNMUTE_DELAY_MS	100
// translated macro: TX_MACRO_DMIC_HPF_DELAY_MS	300
// translated macro: TX_MACRO_AMIC_HPF_DELAY_MS	300
// translated macro: MCLK_FREQ		19200000
...
// translated macro: to_tx_macro(_hw) container_of(_hw, tx_macro, hw)
...
of_MODULE_DEVICE_TABLE(of, tx_macro_dt_match);
static struct platform_driver tx_macro_driver = {
	driver: {
		name: "tx_macro",
		of_match_table: tx_macro_dt_match,
...
module_platform_driver_macro(tx_macro_driver);

MODULE_DESCRIPTION_macro("TX macro driver");
MODULE_LICENSE_macro("GPL");
}
