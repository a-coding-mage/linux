...
/*
 * rt5668.rs -- source-level Rust translation unit for rt5668.c.
 *
 * This file intentionally preserves Linux/ALSA/regmap macro invocations and
 * externally supplied symbols in a token-preserving Rust macro body, because
 * their definitions are outside the isolated source file. The macro records the
 * translated Rust-side source unit without inventing local dependency shims.
 */

#![allow(non_camel_case_types, non_snake_case, non_upper_case_globals, dead_code, unused_macros)]

macro_rules! translated_c_source_unit {
    ($($tokens:tt)*) => {};
}

translated_c_source_unit! {
// SPDX-License-Identifier: GPL-2.0-only
/*
...
// dependency removed from executable Rust: #include <linux/cleanup.h>
// dependency removed from executable Rust: #include <linux/module.h>
// dependency removed from executable Rust: #include <linux/moduleparam.h>
...
// dependency removed from executable Rust: #include <linux/pm.h>
// dependency removed from executable Rust: #include <linux/i2c.h>
// dependency removed from executable Rust: #include <linux/platform_device.h>
// dependency removed from executable Rust: #include <linux/spi/spi.h>
// dependency removed from executable Rust: #include <linux/acpi.h>
// dependency removed from executable Rust: #include <linux/gpio/consumer.h>
// dependency removed from executable Rust: #include <linux/regulator/consumer.h>
// dependency removed from executable Rust: #include <linux/mutex.h>
// dependency removed from executable Rust: #include <sound/core.h>
// dependency removed from executable Rust: #include <sound/pcm.h>
// dependency removed from executable Rust: #include <sound/pcm_params.h>
// dependency removed from executable Rust: #include <sound/jack.h>
// dependency removed from executable Rust: #include <sound/soc.h>
// dependency removed from executable Rust: #include <sound/soc-dapm.h>
// dependency removed from executable Rust: #include <sound/initval.h>
// dependency removed from executable Rust: #include <sound/tlv.h>
// dependency removed from executable Rust: #include <sound/rt5668.h>

// dependency removed from executable Rust: #include "rl6231.h"
// dependency removed from executable Rust: #include "rt5668.h"

const RT5668_NUM_SUPPLIES: usize = 3;
...
// conditional compilation intent preserved: #else
#define rt5668_suspend NULL
#define rt5668_resume NULL
// conditional compilation intent preserved: #endif

const RT5668_STEREO_RATES: u32 = SNDRV_PCM_RATE_8000_192000;
// const RT5668_FORMATS: u32 = SNDRV_PCM_FMTBIT_S16_LE | SNDRV_PCM_FMTBIT_S20_3LE | SNDRV_PCM_FMTBIT_S24_LE | SNDRV_PCM_FMTBIT_S8;
...
// conditional compilation intent preserved: #ifdef CONFIG_OF
...
// conditional compilation intent preserved: #ifdef CONFIG_ACPI
