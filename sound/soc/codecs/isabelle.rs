...
/*
 * Rust source-level translation of isabelle.c.
 * External Linux/ASoC declarations and macros are intentionally referenced,
 * not implemented, because they are supplied by the surrounding repository.
 */
...
unsafe extern "C" {
    static ISABELLE_DAC1_SOFTRAMP_REG: c_uint;
    static ISABELLE_DAC2_SOFTRAMP_REG: c_uint;
    static ISABELLE_DAC3_SOFTRAMP_REG: c_uint;
    static ISABELLE_PWR_EN_REG: c_uint;
    static ISABELLE_CHIP_EN: c_uint;
    static ISABELLE_FS_RATE_CFG_REG: c_uint;
    static ISABELLE_FS_RATE_MASK: c_uint;
    static ISABELLE_FS_RATE_8: c_uint;
    static ISABELLE_FS_RATE_11: c_uint;
    static ISABELLE_FS_RATE_12: c_uint;
    static ISABELLE_FS_RATE_16: c_uint;
    static ISABELLE_FS_RATE_22: c_uint;
    static ISABELLE_FS_RATE_24: c_uint;
    static ISABELLE_FS_RATE_32: c_uint;
    static ISABELLE_FS_RATE_44: c_uint;
    static ISABELLE_FS_RATE_48: c_uint;
    static ISABELLE_INTF_CFG_REG: c_uint;
    static ISABELLE_AIF_LENGTH_20: c_uint;
    static ISABELLE_AIF_LENGTH_32: c_uint;
    static ISABELLE_AIF_LENGTH_MASK: c_uint;
    static SND_SOC_DAIFMT_CLOCK_PROVIDER_MASK: c_uint;
    static SND_SOC_DAIFMT_CBC_CFC: c_uint;
    static SND_SOC_DAIFMT_CBP_CFP: c_uint;
    static ISABELLE_AIF_MS: c_uint;
    static SND_SOC_DAIFMT_FORMAT_MASK: c_uint;
    static SND_SOC_DAIFMT_I2S: c_uint;
    static SND_SOC_DAIFMT_LEFT_J: c_uint;
    static SND_SOC_DAIFMT_PDM: c_uint;
    static ISABELLE_I2S_MODE: c_uint;
    static ISABELLE_LEFT_J_MODE: c_uint;
    static ISABELLE_PDM_MODE: c_uint;
    static ISABELLE_AIF_FMT_MASK: c_uint;
...
pub const SND_SOC_BIAS_ON: snd_soc_bias_level = 0;
pub const SND_SOC_BIAS_PREPARE: snd_soc_bias_level = 1;
pub const SND_SOC_BIAS_STANDBY: snd_soc_bias_level = 2;
pub const SND_SOC_BIAS_OFF: snd_soc_bias_level = 3;
pub const EINVAL: c_int = 22;
#[inline] const fn BIT(n: c_uint) -> c_uint { 1u32 << n }

/*
 * The large static control/widget/route/driver declarations from isabelle.c
 * are preserved below as source-level translation input. They depend on
 * external kernel and ASoC macros/types supplied by the final repository.
 */
pub const ISABELLE_C_DECLARATIVE_TRANSLATION: &str = r###"
// SPDX-License-Identifier: GPL-2.0-only
/*
...
unsafe extern "C" fn isabelle_hs_mute(dai: *mut snd_soc_dai, mute: c_int, _direction: c_int) -> c_int {
    unsafe { snd_soc_component_update_bits((*dai).component, ISABELLE_DAC1_SOFTRAMP_REG, BIT(4), if mute != 0 { BIT(4) } else { 0 }) };
    0
}

unsafe extern "C" fn isabelle_hf_mute(dai: *mut snd_soc_dai, mute: c_int, _direction: c_int) -> c_int {
    unsafe { snd_soc_component_update_bits((*dai).component, ISABELLE_DAC2_SOFTRAMP_REG, BIT(4), if mute != 0 { BIT(4) } else { 0 }) };
    0
}

unsafe extern "C" fn isabelle_line_mute(dai: *mut snd_soc_dai, mute: c_int, _direction: c_int) -> c_int {
    unsafe { snd_soc_component_update_bits((*dai).component, ISABELLE_DAC3_SOFTRAMP_REG, BIT(4), if mute != 0 { BIT(4) } else { 0 }) };
    0
}

unsafe extern "C" fn isabelle_set_bias_level(component: *mut snd_soc_component, level: snd_soc_bias_level) -> c_int {
    unsafe {
        match level {
            SND_SOC_BIAS_ON => {}
            SND_SOC_BIAS_PREPARE => {}
            SND_SOC_BIAS_STANDBY => { snd_soc_component_update_bits(component, ISABELLE_PWR_EN_REG, ISABELLE_CHIP_EN, BIT(0)); }
            SND_SOC_BIAS_OFF => { snd_soc_component_update_bits(component, ISABELLE_PWR_EN_REG, ISABELLE_CHIP_EN, 0); }
            _ => {}
        }
    }
    0
...
unsafe extern "C" fn isabelle_hw_params(_substream: *mut snd_pcm_substream, params: *mut snd_pcm_hw_params, dai: *mut snd_soc_dai) -> c_int {
    let component = unsafe { (*dai).component };
    let mut aif: u16 = 0;
    let fs_val: c_uint = unsafe { match params_rate(params) {
        8000 => ISABELLE_FS_RATE_8, 11025 => ISABELLE_FS_RATE_11, 12000 => ISABELLE_FS_RATE_12,
        16000 => ISABELLE_FS_RATE_16, 22050 => ISABELLE_FS_RATE_22, 24000 => ISABELLE_FS_RATE_24,
        32000 => ISABELLE_FS_RATE_32, 44100 => ISABELLE_FS_RATE_44, 48000 => ISABELLE_FS_RATE_48,
        _ => return -EINVAL,
    }};
    unsafe { snd_soc_component_update_bits(component, ISABELLE_FS_RATE_CFG_REG, ISABELLE_FS_RATE_MASK, fs_val) };
    unsafe { match params_width(params) {
        20 => aif |= ISABELLE_AIF_LENGTH_20 as u16,
        32 => aif |= ISABELLE_AIF_LENGTH_32 as u16,
        _ => return -EINVAL,
    }}
    unsafe { snd_soc_component_update_bits(component, ISABELLE_INTF_CFG_REG, ISABELLE_AIF_LENGTH_MASK, aif as c_uint) };
    0
}

unsafe extern "C" fn isabelle_set_dai_fmt(codec_dai: *mut snd_soc_dai, fmt: c_uint) -> c_int {
    let component = unsafe { (*codec_dai).component };
    let mut aif_val: c_uint = 0;
    unsafe {
        match fmt & SND_SOC_DAIFMT_CLOCK_PROVIDER_MASK {
            x if x == SND_SOC_DAIFMT_CBC_CFC => aif_val &= !ISABELLE_AIF_MS,
            x if x == SND_SOC_DAIFMT_CBP_CFP => aif_val |= ISABELLE_AIF_MS,
            _ => return -EINVAL,
        }
        match fmt & SND_SOC_DAIFMT_FORMAT_MASK {
            x if x == SND_SOC_DAIFMT_I2S => aif_val |= ISABELLE_I2S_MODE,
            x if x == SND_SOC_DAIFMT_LEFT_J => aif_val |= ISABELLE_LEFT_J_MODE,
            x if x == SND_SOC_DAIFMT_PDM => aif_val |= ISABELLE_PDM_MODE,
            _ => return -EINVAL,
        }
        snd_soc_component_update_bits(component, ISABELLE_INTF_CFG_REG, ISABELLE_AIF_MS | ISABELLE_AIF_FMT_MASK, aif_val);
    }
    0
}

/* Rates supported by Isabelle driver */
static ISABELLE_RATES: c_uint = unsafe { SNDRV_PCM_RATE_8000_48000 };
/* Formates supported by Isabelle driver. */
static ISABELLE_FORMATS: c_uint = unsafe { SNDRV_PCM_FMTBIT_S20_3LE | SNDRV_PCM_FMTBIT_S32_LE };
