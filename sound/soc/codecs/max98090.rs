...
// Rust translation of soc/codecs/max98090.c.
...
static const struct snd_soc_dapm_widget max98090_dapm_widgets[] = {
	...
	SND_SOC_DAPM_SUPPLY("MICBIAS", M98090_REG_INPUT_ENABLE,
		M98090_MBEN_SHIFT, 0, null_mut!(), 0),
	SND_SOC_DAPM_SUPPLY("SHDN", M98090_REG_DEVICE_SHUTDOWN,
		M98090_SHDNN_SHIFT, 0, null_mut!(), 0),
	SND_SOC_DAPM_SUPPLY("SDIEN", M98090_REG_IO_CONFIGURATION,
		M98090_SDIEN_SHIFT, 0, null_mut!(), 0),
	SND_SOC_DAPM_SUPPLY("SDOEN", M98090_REG_IO_CONFIGURATION,
		M98090_SDOEN_SHIFT, 0, null_mut!(), 0),
	...
	SND_SOC_DAPM_SUPPLY("AHPF", M98090_REG_FILTER_CONFIG,
		M98090_AHPF_SHIFT, 0, null_mut!(), 0),
 ...
 */
	...
	SND_SOC_DAPM_PGA_E("MIC1 Input", M98090_REG_MIC1_INPUT_LEVEL,
		M98090_MIC_PA1EN_SHIFT, 0, null_mut!(), 0, max98090_micinput_event,
		SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_POST_PMD),

	SND_SOC_DAPM_PGA_E("MIC2 Input", M98090_REG_MIC2_INPUT_LEVEL,
		M98090_MIC_PA2EN_SHIFT, 0, null_mut!(), 0, max98090_micinput_event,
		SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_POST_PMD),
	...
	SND_SOC_DAPM_PGA("LINEA Input", M98090_REG_INPUT_ENABLE,
		M98090_LINEAEN_SHIFT, 0, null_mut!(), 0),
	SND_SOC_DAPM_PGA("LINEB Input", M98090_REG_INPUT_ENABLE,
		M98090_LINEBEN_SHIFT, 0, null_mut!(), 0),
	...
	SND_SOC_DAPM_ADC_E("ADCL", null_mut!(), M98090_REG_INPUT_ENABLE,
		M98090_ADLEN_SHIFT, 0, max98090_shdn_event,
		SND_SOC_DAPM_POST_PMU),
	SND_SOC_DAPM_ADC_E("ADCR", null_mut!(), M98090_REG_INPUT_ENABLE,
	...
	SND_SOC_DAPM_DAC("DACL", null_mut!(), M98090_REG_OUTPUT_ENABLE,
		M98090_DALEN_SHIFT, 0),
	SND_SOC_DAPM_DAC("DACR", null_mut!(), M98090_REG_OUTPUT_ENABLE,
...
static const struct snd_soc_dapm_widget max98091_dapm_widgets[] = {
	...
	SND_SOC_DAPM_SUPPLY("DMIC34_HPF", M98090_REG_FILTER_CONFIG,
		M98090_FLT_DMIC34HPF_SHIFT, 0, null_mut!(), 0),
...
static const struct snd_soc_dapm_route max98090_dapm_routes[] = {
	{"MIC1 Input", null_mut!(), "MIC1"},
	{"MIC2 Input", null_mut!(), "MIC2"},

	{"DMICL", null_mut!(), "DMICL_ENA"},
	{"DMICL", null_mut!(), "DMICR_ENA"},
	{"DMICR", null_mut!(), "DMICL_ENA"},
	{"DMICR", null_mut!(), "DMICR_ENA"},
	{"DMICL", null_mut!(), "AHPF"},
	{"DMICR", null_mut!(), "AHPF"},
	...
	{"MIC1 Input", null_mut!(), "MIC1 Mux"},
	{"MIC2 Input", null_mut!(), "MIC2 Mux"},
	...
	{"LINEA Input", null_mut!(), "LINEA Mixer"},
	{"LINEB Input", null_mut!(), "LINEB Mixer"},

	/* Inputs */
	{"ADCL", null_mut!(), "Left ADC Mixer"},
	{"ADCR", null_mut!(), "Right ADC Mixer"},
	{"ADCL", null_mut!(), "SHDN"},
	{"ADCR", null_mut!(), "SHDN"},
	...
	{"AIFOUTL", null_mut!(), "LBENL Mux"},
	{"AIFOUTR", null_mut!(), "LBENR Mux"},
	{"AIFOUTL", null_mut!(), "SHDN"},
	{"AIFOUTR", null_mut!(), "SHDN"},
	{"AIFOUTL", null_mut!(), "SDOEN"},
	{"AIFOUTR", null_mut!(), "SDOEN"},
	...
	{"DACL", null_mut!(), "LTENL Mux"},
	{"DACR", null_mut!(), "LTENR Mux"},

	{"STENL Mux", "Sidetone Left", "ADCL"},
	{"STENL Mux", "Sidetone Left", "DMICL"},
	{"STENR Mux", "Sidetone Right", "ADCR"},
	{"STENR Mux", "Sidetone Right", "DMICR"},
	{"DACL", null_mut!(), "STENL Mux"},
	{"DACR", null_mut!(), "STENR Mux"},

	{"AIFINL", null_mut!(), "SHDN"},
	{"AIFINR", null_mut!(), "SHDN"},
	{"AIFINL", null_mut!(), "SDIEN"},
	{"AIFINR", null_mut!(), "SDIEN"},
	{"DACL", null_mut!(), "SHDN"},
	{"DACR", null_mut!(), "SHDN"},
	 ...
	 */
	{"HP Left Out", null_mut!(), "DACL"},
	{"HP Left Out", null_mut!(), "MIXHPLSEL Mux"},
	 ...
	 * the DAC with an analog signal
	 */
	{"HP Right Out", null_mut!(), "DACR"},
	{"HP Right Out", null_mut!(), "MIXHPRSEL Mux"},

	{"SPK Left Out", null_mut!(), "Left Speaker Mixer"},
	{"SPK Right Out", null_mut!(), "Right Speaker Mixer"},
	{"RCV Left Out", null_mut!(), "Left Receiver Mixer"},

	{"LINMOD Mux", "Left and Right", "Right Receiver Mixer"},
	{"LINMOD Mux", "Left Only",  "Left Receiver Mixer"},
	{"RCV Right Out", null_mut!(), "LINMOD Mux"},

	{"HPL", null_mut!(), "HP Left Out"},
	{"HPR", null_mut!(), "HP Right Out"},
	{"SPKL", null_mut!(), "SPK Left Out"},
	{"SPKR", null_mut!(), "SPK Right Out"},
	{"RCVL", null_mut!(), "RCV Left Out"},
	{"RCVR", null_mut!(), "RCV Right Out"},
};

static const struct snd_soc_dapm_route max98091_dapm_routes[] = {
	/* DMIC inputs */
	{"DMIC3", null_mut!(), "DMIC3_ENA"},
	{"DMIC4", null_mut!(), "DMIC4_ENA"},
	{"DMIC3", null_mut!(), "DMIC34_HPF"},
	{"DMIC4", null_mut!(), "DMIC34_HPF"},

	{"DMIC M2 Mux", "Enable", "DMIC3"},
	{"DMIC M2 Mux", "Enable", "DMIC4"},

	{"AIFOUT2L", null_mut!(), "DMIC M2 Mux"},
	{"AIFOUT2R", null_mut!(), "DMIC M2 Mux"},
	{"AIFOUT2L", null_mut!(), "SHDN"},
	{"AIFOUT2R", null_mut!(), "SHDN"},
	{"AIFOUT2L", null_mut!(), "SDOEN"},
	{"AIFOUT2R", null_mut!(), "SDOEN"},
};
...
pub const MAX98090_RATES: _ = c_const!(SNDRV_PCM_RATE_8000_96000);
pub const MAX98090_FORMATS: _ = c_const!((SNDRV_PCM_FMTBIT_S16_LE | SNDRV_PCM_FMTBIT_S24_LE));
...
static int max98090_i2c_probe(struct i2c_client *i2c)
{
	...
	ret = devm_request_threaded_irq(&i2c->dev, i2c->irq, null_mut!(),
...
static const struct dev_pm_ops max98090_pm = {
	RUNTIME_PM_OPS(max98090_runtime_suspend, max98090_runtime_resume, null_mut!())
	SYSTEM_SLEEP_PM_OPS(null_mut!(), max98090_resume)
};

// C conditional: #ifdef CONFIG_OF
...
// C conditional: #ifdef CONFIG_ACPI
