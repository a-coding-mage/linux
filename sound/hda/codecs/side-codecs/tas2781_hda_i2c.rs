...
unsafe extern "C" {
    ...
    fn tasdevice_info_profile(_: *mut snd_kcontrol, _: *mut snd_ctl_elem_info) -> c_int;
    fn tasdevice_get_profile_id(_: *mut snd_kcontrol, _: *mut snd_ctl_elem_value) -> c_int;
    fn tasdevice_set_profile_id(_: *mut snd_kcontrol, _: *mut snd_ctl_elem_value) -> c_int;
    fn tasdevice_info_programs(_: *mut snd_kcontrol, _: *mut snd_ctl_elem_info) -> c_int;
    fn tasdevice_program_get(_: *mut snd_kcontrol, _: *mut snd_ctl_elem_value) -> c_int;
    fn tasdevice_program_put(_: *mut snd_kcontrol, _: *mut snd_ctl_elem_value) -> c_int;
    fn tasdevice_info_config(_: *mut snd_kcontrol, _: *mut snd_ctl_elem_info) -> c_int;
    fn tasdevice_config_get(_: *mut snd_kcontrol, _: *mut snd_ctl_elem_value) -> c_int;
    fn tasdevice_config_put(_: *mut snd_kcontrol, _: *mut snd_ctl_elem_value) -> c_int;
