...
#![allow(non_camel_case_types, non_snake_case, non_upper_case_globals, dead_code, improper_ctypes, unused_variables, unused_mut)]

use core::ffi::{c_char, c_int, c_uint};

pub type hda_nid_t = u16;

#[repr(C)] pub struct hda_codec { _private: [u8; 0] }
#[repr(C)] pub struct alc_spec { _private: [u8; 0] }
#[repr(C)] pub struct coef_fw { pub nid: hda_nid_t, pub idx: c_uint, pub mask: u16, pub val: c_uint }
#[repr(C)] pub struct hda_fixup { _private: [u8; 0] }
#[repr(C)] pub struct hda_jack_callback { pub nid: hda_nid_t }
...
#[repr(C)] pub struct alc_codec_rename_table { pub vendor_id: c_uint, pub coef_mask: u16, pub coef_bits: u16, pub name: *const c_char }
#[repr(C)] pub struct alc_codec_rename_pci_table { pub codec_vendor_id: c_uint, pub pci_subvendor: u16, pub pci_subdevice: u16, pub name: *const c_char }

pub const ALC_FIXUP_SKU_IGNORE: c_uint = 2;

unsafe extern "C" {
    fn snd_hda_codec_write(codec: *mut hda_codec, nid: hda_nid_t, flags: c_int, verb: c_uint, parm: c_uint) -> c_uint;
    fn snd_hda_codec_read(codec: *mut hda_codec, nid: hda_nid_t, flags: c_int, verb: c_uint, parm: c_uint) -> c_uint;
}

/* Original C source translated below as source-level context for unresolved external kernel dependencies.
// SPDX-License-Identifier: GPL-2.0-or-later
//
// Realtek HD-audio codec support code
//
