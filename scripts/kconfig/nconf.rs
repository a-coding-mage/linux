...
extern "C" {
    ...
    fn conf_write(_: *const c_char) -> c_int;
    fn conf_write_autoconf(_: c_int);
    fn conf_read(_: *const c_char) -> c_int;
    fn conf_parse(_: *mut c_char);
    fn conf_get_configname() -> *const c_char;
    fn conf_set_changed(_: c_int);
    fn conf_set_message_callback(_: Option<unsafe extern "C" fn(*const c_char)>);
    fn menu_get_prompt(_: *mut menu) -> *const c_char;
    fn menu_is_visible(_: *mut menu) -> c_int;
    fn sym_get_type(_: *mut symbol) -> c_int;
    fn sym_get_string_value(_: *mut symbol) -> *const c_char;
    fn sym_set_string_value(_: *mut symbol, _: *const c_char) -> c_int;
    fn sym_set_tristate_value(_: *mut symbol, _: c_int) -> c_int;
    fn sym_toggle_tristate_value(_: *mut symbol);
    fn sym_is_choice(_: *mut symbol) -> c_int;
    fn sym_is_changeable(_: *mut symbol) -> c_int;
    fn sym_calc_choice(_: *mut menu) -> *mut symbol;
    fn choice_set_value(_: *mut menu, _: *mut symbol);
    fn menu_get_ext_help(_: *mut menu, _: *mut c_void);
    fn show_help(_: *mut menu);
    fn conf(_: *mut menu);
    fn setup_windows();
    fn search_conf();
    fn conf_load();
