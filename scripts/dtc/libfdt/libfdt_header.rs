/* Rust translation of libfdt.h. External types and symbols are supplied by dependent files. */
#![allow(non_camel_case_types, non_snake_case, dead_code, improper_ctypes)]
use core::ffi::{c_char, c_int, c_void};

pub const FDT_FIRST_SUPPORTED_VERSION: u32 = 0x02;
pub const FDT_LAST_COMPATIBLE_VERSION: u32 = 0x10;
...
pub const FDT_CREATE_FLAG_NO_NAME_DEDUP: u32 = 0x1;

extern "C" {
    pub fn fdt_next_tag(fdt: *const c_void, offset: c_int, nextoffset: *mut c_int) -> u32;
    pub fn fdt_next_node(fdt: *const c_void, offset: c_int, depth: *mut c_int) -> c_int;
    pub fn fdt_first_subnode(fdt: *const c_void, offset: c_int) -> c_int;
    pub fn fdt_next_subnode(fdt: *const c_void, offset: c_int) -> c_int;
    pub fn fdt_header_size(fdt: *const c_void) -> usize;
    pub fn fdt_header_size_(version: u32) -> usize;
    pub fn fdt_check_header(fdt: *const c_void) -> c_int;
    pub fn fdt_move(fdt: *const c_void, buf: *mut c_void, bufsize: c_int) -> c_int;
    pub fn fdt_check_full(fdt: *const c_void, bufsize: usize) -> c_int;
    pub fn fdt_find_max_phandle(fdt: *const c_void, phandle: *mut u32) -> c_int;
    pub fn fdt_generate_phandle(fdt: *const c_void, phandle: *mut u32) -> c_int;
    pub fn fdt_num_mem_rsv(fdt: *const c_void) -> c_int;
    pub fn fdt_get_mem_rsv(fdt: *const c_void, n: c_int, address: *mut u64, size: *mut u64) -> c_int;
    pub fn fdt_subnode_offset_namelen(fdt: *const c_void, parentoffset: c_int, name: *const c_char, namelen: c_int) -> c_int;
    pub fn fdt_path_offset_namelen(fdt: *const c_void, path: *const c_char, namelen: c_int) -> c_int;
    ...
    pub fn fdt_get_path(fdt: *const c_void, nodeoffset: c_int, buf: char *, buflen: c_int) -> c_int;
    pub fn fdt_supernode_atdepth_offset(fdt: *const c_void, nodeoffset: c_int, supernodedepth: c_int, nodedepth: *mut c_int) -> c_int;
    pub fn fdt_node_depth(fdt: *const c_void, nodeoffset: c_int) -> c_int;
    pub fn fdt_parent_offset(fdt: *const c_void, nodeoffset: c_int) -> c_int;
    pub fn fdt_node_offset_by_prop_value(fdt: *const c_void, startoffset: c_int, propname: *const c_char, propval: *const c_void, proplen: c_int) -> c_int;
    pub fn fdt_node_offset_by_phandle(fdt: *const c_void, phandle: u32) -> c_int;
    pub fn fdt_node_check_compatible(fdt: *const c_void, nodeoffset: c_int, compatible: *const c_char) -> c_int;
    pub fn fdt_node_offset_by_compatible(fdt: *const c_void, startoffset: c_int, compatible: *const c_char) -> c_int;
    pub fn fdt_stringlist_contains(strlist: *const c_char, listlen: c_int, str: *const c_char) -> c_int;
    pub fn fdt_stringlist_count(fdt: *const c_void, nodeoffset: c_int, property: *const c_char) -> c_int;
    pub fn fdt_stringlist_search(fdt: *const c_void, nodeoffset: c_int, property: *const c_char, string: *const c_char) -> c_int;
    pub fn fdt_address_cells(fdt: *const c_void, nodeoffset: c_int) -> c_int;
    pub fn fdt_size_cells(fdt: *const c_void, nodeoffset: c_int) -> c_int;
    pub fn fdt_setprop_inplace_namelen_partial(fdt: *mut c_void, nodeoffset: c_int, name: *const c_char, namelen: c_int, idx: u32, val: *const c_void, len: c_int) -> c_int;
    pub fn fdt_setprop_inplace_u32(fdt: , nodeoffset: , name: , val: ) -> return;
    pub fn fdt_nop_property(fdt: *mut c_void, nodeoffset: c_int, name: *const c_char) -> c_int;
    pub fn fdt_nop_node(fdt: *mut c_void, nodeoffset: c_int) -> c_int;
    pub fn fdt_create_with_flags(buf: *mut c_void, bufsize: c_int, flags: u32) -> c_int;
    pub fn fdt_resize(fdt: *mut c_void, buf: *mut c_void, bufsize: c_int) -> c_int;
    pub fn fdt_add_reservemap_entry(fdt: *mut c_void, addr: u64, size: u64) -> c_int;
    pub fn fdt_finish_reservemap(fdt: *mut c_void) -> c_int;
    pub fn fdt_begin_node(fdt: *mut c_void, name: *const c_char) -> c_int;
    pub fn fdt_property(fdt: *mut c_void, name: *const c_char, val: *const c_void, len: c_int) -> c_int;
    pub fn fdt_property_u32(fdt: , name: , val: ) -> return;
    pub fn fdt_property_placeholder(fdt: *mut c_void, name: *const c_char, len: c_int, valp: *mut *mut c_void) -> c_int;
    pub fn fdt_end_node(fdt: *mut c_void) -> c_int;
    pub fn fdt_create_empty_tree(buf: *mut c_void, bufsize: c_int) -> c_int;
    pub fn fdt_open_into(fdt: *const c_void, buf: *mut c_void, bufsize: c_int) -> c_int;
    pub fn fdt_pack(fdt: *mut c_void) -> c_int;
    pub fn fdt_add_mem_rsv(fdt: *mut c_void, address: u64, size: u64) -> c_int;
    pub fn fdt_del_mem_rsv(fdt: *mut c_void, n: c_int) -> c_int;
    pub fn fdt_set_name(fdt: *mut c_void, nodeoffset: c_int, name: *const c_char) -> c_int;
    pub fn fdt_setprop_namelen(fdt: *mut c_void, nodeoffset: c_int, name: *const c_char, namelen: c_int, val: *const c_void, len: c_int) -> c_int;
    pub fn fdt_setprop_placeholder_namelen(fdt: *mut c_void, nodeoffset: c_int, name: *const c_char, namelen: c_int, len: c_int, prop_data: *mut *mut c_void) -> c_int;
    pub fn fdt_setprop_u32(fdt: , nodeoffset: , name: , val: ) -> return;
    pub fn fdt_appendprop(fdt: *mut c_void, nodeoffset: c_int, name: *const c_char, val: *const c_void, len: c_int) -> c_int;
    pub fn fdt_appendprop_u32(fdt: , nodeoffset: , name: , val: ) -> return;
    pub fn fdt_appendprop_addrrange(fdt: *mut c_void, parent: c_int, nodeoffset: c_int, name: *const c_char, addr: u64, size: u64) -> c_int;
    pub fn fdt_delprop(fdt: *mut c_void, nodeoffset: c_int, name: *const c_char) -> c_int;
    pub fn fdt_add_subnode_namelen(fdt: *mut c_void, parentoffset: c_int, name: *const c_char, namelen: c_int) -> c_int;
    pub fn fdt_del_node(fdt: *mut c_void, nodeoffset: c_int) -> c_int;
    pub fn fdt_overlay_apply(fdt: *mut c_void, fdto: *mut c_void) -> c_int;
    pub fn fdt_overlay_target_offset(fdt: *const c_void, fdto: *const c_void, fragment_offset: c_int, pathp: char const **) -> c_int;
}

/* Original header documentation and macro intent retained below for source-level fidelity.
